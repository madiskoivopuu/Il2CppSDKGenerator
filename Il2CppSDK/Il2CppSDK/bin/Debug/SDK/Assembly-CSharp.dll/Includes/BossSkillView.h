...
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> T& SkillPanels() {
	...
	template <typename T = uintptr_t> T& _videoPreviewView() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = float> T& _videoTooltipPressedTime() {
		return *(T*)((uintptr_t)this + 0x88);
	}
	template <typename T = Il2CppVector2> T& _tooltipPosition() {
	...
	template <typename T = void> T Init(Il2CppString* icon, Il2CppString* caption, Il2CppString* description, Il2CppString* chapter, Il2CppString* video, uintptr_t mainScroll, Il2CppArray<uintptr_t>* innerSkills, uintptr_t videoPreviewView) {
		return ((T (*)(BossSkillView*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, uintptr_t, Il2CppArray<uintptr_t>*, uintptr_t))(Il2CppBase() + 0x16CB6D8))(this, icon, caption, description, chapter, video, mainScroll, innerSkills, videoPreviewView);
	}
