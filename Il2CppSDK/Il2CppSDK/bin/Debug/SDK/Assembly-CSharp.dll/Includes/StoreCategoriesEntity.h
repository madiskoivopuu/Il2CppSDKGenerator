...
public: 
	...
	template <typename T = uintptr_t> T get_categoryEvents() {
	...
	template <typename T = uintptr_t> T get_categoryId() {
	...
	template <typename T = void> T AddCategoryType(uintptr_t newType) {
		return ((T (*)(StoreCategoriesEntity*, uintptr_t))(Il2CppBase() + 0x141C488))(this, newType);
	}
	template <typename T = void> T ReplaceCategoryType(uintptr_t newType) {
		return ((T (*)(StoreCategoriesEntity*, uintptr_t))(Il2CppBase() + 0x141C58C))(this, newType);
	}
