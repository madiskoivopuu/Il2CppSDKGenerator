...
class InvasionLobbyWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& DefaultMode() {
	...
	template <typename T = uintptr_t> T& _currentMode() {
	...
	template <typename T = void> T EnableMod(uintptr_t mode) {
		return ((T (*)(InvasionLobbyWindow*, uintptr_t))(Il2CppBase() + 0x146B988))(this, mode);
	}
