...
public: 
	...
	template <typename R = UIWindowsManager*> R& _manager() {
	 ...
	 ICollector1<NotificationEntity*>* GetTrigger(IContext1<NotificationEntity*>* context) {
		return ((ICollector1<NotificationEntity*>* (*)(OnNotificationSystem*, IContext1<NotificationEntity*>*))(Il2CppBase() + 0x11DCB20))(this, context);
	}
