...
public: 
	...
	template <typename R = uintptr_t> R& OnClick() {
	 ...
	 Action1Il2CppString*>*& OnClickWithParameter() {
		return *(Action1Il2CppString*>**)((uintptr_t)this + 0x50);
	}
	 Func2Il2CppString*, Il2CppString*>*& CaptionGetter() {
		return *(Func2Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0x58);
	}
