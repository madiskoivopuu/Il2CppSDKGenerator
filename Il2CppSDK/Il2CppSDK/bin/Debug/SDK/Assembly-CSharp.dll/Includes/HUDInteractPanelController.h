...
public: 
	...
	template <typename T = uintptr_t> T& _interactButton() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = uintptr_t> T& _fishingPanel() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = uintptr_t> T& _fishingButton() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = uintptr_t> T& _fishnetButton() {
	...
	template <typename T = void> T Bind(uintptr_t hudWindow) {
		return ((T (*)(HUDInteractPanelController*, uintptr_t))(Il2CppBase() + 0x14585DC))(this, hudWindow);
	}
