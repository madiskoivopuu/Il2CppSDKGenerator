...
public: 
	...
	template <typename R = bool> R& IsActiveShield() {
	 ...
	 IGroup1<GameEntity*>*& _vectorFieldEntities() {
		return *(IGroup1<GameEntity*>**)((uintptr_t)this + 0x2B0);
	}
	template <typename R = bool> R& IsBot() {
		return *(R*)((uintptr_t)this + 0x2B8);
	}
	 Action2<Il2CppString*, Il2CppString*>*& OnLeaveArene() {
		return *(Action2<Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0x2C0);
	}
	 Action1<ArmingData>*& OnUpdateArming() {
		return *(Action1<ArmingData>**)((uintptr_t)this + 0x2C8);
	}
	 Action2<int32_t, bool>*& TakeAllResultEvent() {
		return *(Action2<int32_t, bool>**)((uintptr_t)this + 0x2D0);
	}
	template <typename R = Il2CppArray<Action4<ArenaClientWorld*, Commands, uintptr_t, uintptr_t>*>*> static R& _arenaCommandsActions() {
	...
	template <typename R = GameContext*> R get_MainContext() {
	 ...
	 EntitiesWithPositionNear1<GameEntity*>* GetEntitiesWithPositionNear(float x, float y, float radius) {
		return ((EntitiesWithPositionNear1<GameEntity*>* (*)(ArenaClientWorld*, float, float, float))(Il2CppBase() + 0x1A1EBAC))(this, x, y, radius);
	}
	 EntitiesWithPositionNear1<GameEntity*>* GetTargetsWithPositionNear(float x, float y, float radius) {
		return ((EntitiesWithPositionNear1<GameEntity*>* (*)(ArenaClientWorld*, float, float, float))(Il2CppBase() + 0x1A1EBF8))(this, x, y, radius);
	}
	 EntitiesWithPositionNear1<GameEntity*>* GetObstaclesWithPositionNear(float x, float y, float radius) {
		return ((EntitiesWithPositionNear1<GameEntity*>* (*)(ArenaClientWorld*, float, float, float))(Il2CppBase() + 0x1A1EC44))(this, x, y, radius);
	}
	...
	template <typename R = uintptr_t> R Create(Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>* blueprints) {
		return ((R (*)(ArenaClientWorld*, Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*))(Il2CppBase() + 0x1A1F004))(this, blueprints);
	}
	...
	template <typename R = void> R add_OnUpdateArming(Action1<ArmingData>* value) {
		return ((R (*)(ArenaClientWorld*, Action1<ArmingData>*))(Il2CppBase() + 0x1A1F4E4))(this, value);
	}
	template <typename R = void> R remove_OnUpdateArming(Action1<ArmingData>* value) {
		return ((R (*)(ArenaClientWorld*, Action1<ArmingData>*))(Il2CppBase() + 0x1A1F588))(this, value);
	}
	template <typename R = void> R add_TakeAllResultEvent(Action2<int32_t, bool>* value) {
		return ((R (*)(ArenaClientWorld*, Action2<int32_t, bool>*))(Il2CppBase() + 0x1A1F62C))(this, value);
	}
	template <typename R = void> R remove_TakeAllResultEvent(Action2<int32_t, bool>* value) {
		return ((R (*)(ArenaClientWorld*, Action2<int32_t, bool>*))(Il2CppBase() + 0x1A1F6D0))(this, value);
	}
