...
public: 
	...
	template <typename R = void> R add_ShowWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIModalLayer*, Action1<IUIWindow*>*))(Il2CppBase() + 0x152D704))(this, value);
	}
	template <typename R = void> R remove_ShowWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIModalLayer*, Action1<IUIWindow*>*))(Il2CppBase() + 0x152D7A4))(this, value);
	}
	template <typename R = void> R add_CloseWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIModalLayer*, Action1<IUIWindow*>*))(Il2CppBase() + 0x152D844))(this, value);
	}
	template <typename R = void> R remove_CloseWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIModalLayer*, Action1<IUIWindow*>*))(Il2CppBase() + 0x152D8E4))(this, value);
	}
