...
public: 
	...
	template <typename T = void*> T& _fixedRotation() {
	...
	template <typename T = void*> T get_FixedRotation() {
		return ((T (*)(MinimapLabelView*))(Il2CppBase() + 0x12D36A8))(this);
	}
	template <typename T = void> T set_FixedRotation(void* value) {
		return ((T (*)(MinimapLabelView*, void*))(Il2CppBase() + 0x12D36B4))(this, value);
	}
