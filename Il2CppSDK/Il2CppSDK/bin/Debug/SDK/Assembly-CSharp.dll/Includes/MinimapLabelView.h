...
public: 
	...
	template <typename R = uintptr_t> R& _spriteRenderer() {
	 ...
	 Nullable1<uintptr_t>*& _fixedRotation() {
	...
	template <typename R = void> R set_AnticipatedSprite(uintptr_t value) {
	 ...
	 Nullable1<uintptr_t>* get_FixedRotation() {
		return ((Nullable1<uintptr_t>* (*)(MinimapLabelView*))(Il2CppBase() + 0x12D36A8))(this);
	}
	template <typename R = void> R set_FixedRotation(Nullable1<uintptr_t>* value) {
		return ((R (*)(MinimapLabelView*, Nullable1<uintptr_t>*))(Il2CppBase() + 0x12D36B4))(this, value);
	}
