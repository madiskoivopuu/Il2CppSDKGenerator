...
public: 
	...
	template <typename R = ArenaUnityWorld*> R& _world() {
	 ...
	 ICollector1ClanEntity*>* GetTrigger(IContext1ClanEntity*>* context) {
		return ((ICollector1ClanEntity*>* (*)(LeaveGridPositionSystem*, IContext1ClanEntity*>*))(Il2CppBase() + 0x142A19C))(this, context);
	}
