...
class FindGuildWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& NotFoundGuild() {
	...
	template <typename T = void> T OnReceiveGuildForInvite(uintptr_t errorCode, int64_t guildId) {
		return ((T (*)(FindGuildWindow*, uintptr_t, int64_t))(Il2CppBase() + 0x16951F8))(this, errorCode, guildId);
	}
