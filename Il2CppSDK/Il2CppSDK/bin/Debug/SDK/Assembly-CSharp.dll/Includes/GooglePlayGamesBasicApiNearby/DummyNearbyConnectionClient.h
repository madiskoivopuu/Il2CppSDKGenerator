...
public: 
	...
	template <typename R = void> R StartAdvertising(Il2CppString* name, Il2CppList<Il2CppString*>* appIdentifiers, Nullable1uintptr_t>* advertisingDuration, Action1GooglePlayGamesBasicApiNearby::AdvertisingResult*>* resultCallback, Action1GooglePlayGamesBasicApiNearby::ConnectionRequest*>* connectionRequestCallback) {
		return ((R (*)(DummyNearbyConnectionClient*, Il2CppString*, Il2CppList<Il2CppString*>*, Nullable1uintptr_t>*, Action1GooglePlayGamesBasicApiNearby::AdvertisingResult*>*, Action1GooglePlayGamesBasicApiNearby::ConnectionRequest*>*))(Il2CppBase() + 0x1306490))(this, name, appIdentifiers, advertisingDuration, resultCallback, connectionRequestCallback);
	}
	...
	template <typename R = void> R SendConnectionRequest(Il2CppString* name, Il2CppString* remoteEndpointId, Il2CppArray<uint8_t>* payload, Action1GooglePlayGamesBasicApiNearby::ConnectionResponse*>* responseCallback, GooglePlayGamesBasicApiNearby::IMessageListener* listener) {
		return ((R (*)(DummyNearbyConnectionClient*, Il2CppString*, Il2CppString*, Il2CppArray<uint8_t>*, Action1GooglePlayGamesBasicApiNearby::ConnectionResponse*>*, GooglePlayGamesBasicApiNearby::IMessageListener*))(Il2CppBase() + 0x130659C))(this, name, remoteEndpointId, payload, responseCallback, listener);
	}
	...
	template <typename R = void> R StartDiscovery(Il2CppString* serviceId, Nullable1uintptr_t>* advertisingTimeout, GooglePlayGamesBasicApiNearby::IDiscoveryListener* listener) {
		return ((R (*)(DummyNearbyConnectionClient*, Il2CppString*, Nullable1uintptr_t>*, GooglePlayGamesBasicApiNearby::IDiscoveryListener*))(Il2CppBase() + 0x1306734))(this, serviceId, advertisingTimeout, listener);
	}
