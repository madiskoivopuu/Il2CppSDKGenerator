...
public: 
	...
	template <typename R = int32_t> static R& MaxReliableMessagePayloadLength() {
	 ...
	 Action1<GooglePlayGamesBasicApiNearby::InitializationStatus>*& mInitializationCallback() {
		return *(Action1<GooglePlayGamesBasicApiNearby::InitializationStatus>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = int64_t> R get_LocalClientId() {
	 ...
	 Action1<GooglePlayGamesBasicApiNearby::InitializationStatus>* get_InitializationCallback() {
		return ((Action1<GooglePlayGamesBasicApiNearby::InitializationStatus>* (*)(NearbyConnectionConfiguration*))(Il2CppBase() + 0x13A8A44))(this);
	}
