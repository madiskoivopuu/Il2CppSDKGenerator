...
public: 
	...
	template <typename R = void> static R AddMagicDescription(GameEntity* avatar, Il2CppString* magicName, Il2CppList<Il2CppString*>* descriptions, Il2CppString* prefix, Il2CppString* color) {
	 ...
	 static ValueTuple2Il2CppString*, Il2CppArray<Il2CppString*>*>* GetEquipSetTooltip(GameEntity* avatar, Il2CppString* equipSetName) {
		return ((ValueTuple2Il2CppString*, Il2CppArray<Il2CppString*>*>* (*)(void *, GameEntity*, Il2CppString*))(Il2CppBase() + 0x1037CC0))(0, avatar, equipSetName);
	}
	...
	template <typename R = void> static R AddDurabilityDescriptions(GameEntity* avatar, InventorySlotEntity* slotEntity, ItemEntity* itemEntity, Il2CppList<Il2CppString*>* descriptions) {
	 ...
	 static ValueTuple2Il2CppString*, Il2CppString*>* GetPreviewForItemOrNull(GameEntity* avatar, ItemEntity* itemEntity) {
		return ((ValueTuple2Il2CppString*, Il2CppString*>* (*)(void *, GameEntity*, ItemEntity*))(Il2CppBase() + 0x103C6F8))(0, avatar, itemEntity);
	}
	...
	template <typename R = float> static R Median(IEnumerable1float>* source) {
		return ((R (*)(void *, IEnumerable1float>*))(Il2CppBase() + 0x103F6A0))(0, source);
	}
	template <typename R = double> static R Median_1(IEnumerable1int64_t>* source) {
		return ((R (*)(void *, IEnumerable1int64_t>*))(Il2CppBase() + 0x103F8A4))(0, source);
	}
