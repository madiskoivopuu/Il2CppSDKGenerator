...
public: 
	...
	template <typename T = void> T InitFromSource(EntityHideHelper* source) {
		return ((T (*)(EntityHideHelper*, EntityHideHelper*))(Il2CppBase() + 0x1372764))(this, source);
	}
	...
	template <typename T = void> T SetupSlotView(ItemEntity* item, int32_t slotIndex, bool hd) {
		return ((T (*)(EntityHideHelper*, ItemEntity*, int32_t, bool))(Il2CppBase() + 0x1372E5C))(this, item, slotIndex, hd);
	}
	template <typename T = void> T UpdateArmed(GameEntity* entity) {
		return ((T (*)(EntityHideHelper*, GameEntity*))(Il2CppBase() + 0x137307C))(this, entity);
	}
	template <typename T = void> T SetupToolView(ItemEntity* item) {
		return ((T (*)(EntityHideHelper*, ItemEntity*))(Il2CppBase() + 0x1373120))(this, item);
	}
	template <typename T = void> T SetMinimapIcon(GameEntity* entity, Il2CppString* iconName, bool directed) {
		return ((T (*)(EntityHideHelper*, GameEntity*, Il2CppString*, bool))(Il2CppBase() + 0x13731C4))(this, entity, iconName, directed);
	}
	...
	template <typename T = void> T Death(GameEntity* entity) {
		return ((T (*)(EntityHideHelper*, GameEntity*))(Il2CppBase() + 0x13734AC))(this, entity);
	}
	...
	template <typename T = void> T SetupGender(Gender* gender, bool hd) {
		return ((T (*)(EntityHideHelper*, Gender*, bool))(Il2CppBase() + 0x1373998))(this, gender, hd);
	}
	template <typename T = void> T Execute(GameEntity* entity, float deltaTime) {
		return ((T (*)(EntityHideHelper*, GameEntity*, float))(Il2CppBase() + 0x1373A44))(this, entity, deltaTime);
	}
	...
	template <typename T = void> T AddChild(HideHelper* child) {
		return ((T (*)(EntityHideHelper*, HideHelper*))(Il2CppBase() + 0x1373DC0))(this, child);
	}
	template <typename T = void> T RemoveChild(HideHelper* child) {
		return ((T (*)(EntityHideHelper*, HideHelper*))(Il2CppBase() + 0x1373E64))(this, child);
	}
