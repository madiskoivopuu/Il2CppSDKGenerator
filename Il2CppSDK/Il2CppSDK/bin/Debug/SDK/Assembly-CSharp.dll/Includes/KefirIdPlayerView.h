...
public: 
	...
	template <typename T = void> T Init(uintptr_t playerData, bool isSelected) {
		return ((T (*)(KefirIdPlayerView*, uintptr_t, bool))(Il2CppBase() + 0x14E9540))(this, playerData, isSelected);
	}
