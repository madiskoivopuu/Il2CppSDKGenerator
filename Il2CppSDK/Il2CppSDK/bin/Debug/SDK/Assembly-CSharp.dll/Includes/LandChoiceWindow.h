...
public: 
	...
	template <typename T = ValueTuple2bool, Il2CppString*>*> T CanAccept(DialogueEntity* dialogue) {
		return ((T (*)(LandChoiceWindow*, DialogueEntity*))(Il2CppBase() + 0x1428E50))(this, dialogue);
	}
