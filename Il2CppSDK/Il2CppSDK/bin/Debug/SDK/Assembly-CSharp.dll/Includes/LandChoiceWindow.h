...
public: 
	...
	template <typename R = void> R OnLandClick(int32_t index) {
	 ...
	 ValueTuple2<bool, Il2CppString*>* CanAccept(DialogueEntity* dialogue) {
		return ((ValueTuple2<bool, Il2CppString*>* (*)(LandChoiceWindow*, DialogueEntity*))(Il2CppBase() + 0x1428E50))(this, dialogue);
	}
