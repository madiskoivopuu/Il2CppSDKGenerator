...
class MountsInventoryContainer: ClickableItemsContainer
{
public: 
	...
	template <typename T = void> T add_OnSortButtonClick(void* value) {
		return ((T (*)(MountsInventoryContainer*, void*))(Il2CppBase() + 0x154D020))(this, value);
	}
	template <typename T = void> T remove_OnSortButtonClick(void* value) {
		return ((T (*)(MountsInventoryContainer*, void*))(Il2CppBase() + 0x154D0C0))(this, value);
	}
	template <typename T = void> T Bind(uintptr_t window, uintptr_t parentEntity, uintptr_t onDelete, void* onSort) {
		return ((T (*)(MountsInventoryContainer*, uintptr_t, uintptr_t, uintptr_t, void*))(Il2CppBase() + 0x154D160))(this, window, parentEntity, onDelete, onSort);
	}
	...
	template <typename T = void> T OnBeginScrollingEvent(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(MountsInventoryContainer*, uintptr_t, uintptr_t))(Il2CppBase() + 0x154FB80))(this, item, eventData);
	}
	template <typename T = void> T OnScrollingEvent(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(MountsInventoryContainer*, uintptr_t, uintptr_t))(Il2CppBase() + 0x154FBA8))(this, item, eventData);
	}
	template <typename T = void> T OnEndScrollingEvent(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(MountsInventoryContainer*, uintptr_t, uintptr_t))(Il2CppBase() + 0x154FBD0))(this, item, eventData);
	}
