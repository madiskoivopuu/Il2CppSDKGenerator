...
public: 
	...
	template <typename R = uintptr_t> R& OnDeleteButtonClick() {
	 ...
	 Action1InventorySlot*>*& OnSortButtonClick() {
		return *(Action1InventorySlot*>**)((uintptr_t)this + 0xF8);
	}
	...
	template <typename R = void> R add_OnSortButtonClick(Action1InventorySlot*>* value) {
		return ((R (*)(MountsInventoryContainer*, Action1InventorySlot*>*))(Il2CppBase() + 0x154D020))(this, value);
	}
	template <typename R = void> R remove_OnSortButtonClick(Action1InventorySlot*>* value) {
		return ((R (*)(MountsInventoryContainer*, Action1InventorySlot*>*))(Il2CppBase() + 0x154D0C0))(this, value);
	}
	template <typename R = void> R Bind(IMountsInventoryWindow* window, GameEntity* parentEntity, uintptr_t onDelete, Action1InventorySlot*>* onSort) {
		return ((R (*)(MountsInventoryContainer*, IMountsInventoryWindow*, GameEntity*, uintptr_t, Action1InventorySlot*>*))(Il2CppBase() + 0x154D160))(this, window, parentEntity, onDelete, onSort);
	}
	...
	template <typename R = IInventoryItem*> R GetItemById(int32_t id) {
	 ...
	 ValueTuple2bool, IInventoryItem*>* IsInventoryEmpty() {
		return ((ValueTuple2bool, IInventoryItem*>* (*)(MountsInventoryContainer*))(Il2CppBase() + 0x154F91C))(this);
	}
