...
public: 
	...
	template <typename R = int32_t> static R& _furnitureMaxAttempts() {
	 ...
	 Nullable1<int64_t>*& _waitResultTicks() {
		return *(Nullable1<int64_t>**)((uintptr_t)this + 0x160);
	}
	...
	template <typename R = void> R GetAllBordersCost(IDictionary2<Vec2, int32_t>* points, float x, float y, float initialX, float initialY) {
		return ((R (*)(BuilderWindow*, IDictionary2<Vec2, int32_t>*, float, float, float, float))(Il2CppBase() + 0x15AE094))(this, points, x, y, initialX, initialY);
	}
