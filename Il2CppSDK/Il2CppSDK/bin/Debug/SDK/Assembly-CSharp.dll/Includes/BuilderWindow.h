...
public: 
	...
	template <typename T = uintptr_t> T& RoofButton() {
	...
	template <typename T = uintptr_t> T& PlacingView() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = uintptr_t> T& BuildUpgradeView() {
		return *(T*)((uintptr_t)this + 0xF0);
	}
	template <typename T = uintptr_t> T& FurnitureSelectView() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = uintptr_t> T& BuilderClickHandler() {
		return *(T*)((uintptr_t)this + 0x100);
	}
	template <typename T = uintptr_t> T& BuilderCanPlace() {
		return *(T*)((uintptr_t)this + 0x108);
	}
	template <typename T = uintptr_t> T& BuilderContainer() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = uintptr_t> T& CurrentBuilderMode() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = uintptr_t> T& _currentBuildMethod() {
		return *(T*)((uintptr_t)this + 0x11C);
	}
	template <typename T = uintptr_t> T& _selectedBuilderItem() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = uintptr_t> T& _ghost() {
		return *(T*)((uintptr_t)this + 0x128);
	}
	template <typename T = uintptr_t> T& _currentBuildEntity() {
		return *(T*)((uintptr_t)this + 0x130);
	}
	template <typename T = bool> T& _isPlaceClick() {
		return *(T*)((uintptr_t)this + 0x138);
	}
	template <typename T = uintptr_t> T& _selectedEntity_Upgradable() {
		return *(T*)((uintptr_t)this + 0x140);
	}
	template <typename T = uintptr_t> T& _selectedFurniture() {
	...
	template <typename T = void*> T& _waitResultTicks() {
	...
	template <typename T = uintptr_t> T get_CurrentBuilderMode() {
		return ((T (*)(BuilderWindow*))(Il2CppBase() + 0x15A9720))(this);
	}
	template <typename T = void> T set_CurrentBuilderMode(uintptr_t value) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15A9728))(this, value);
	}
	...
	template <typename T = void> T OnBuildMethodChanged(uintptr_t method) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15AAE70))(this, method);
	}
	template <typename T = void> T OnUpdateDraw(float deltaTime) {
		return ((T (*)(BuilderWindow*, float))(Il2CppBase() + 0x15AAE7C))(this, deltaTime);
	}
	template <typename T = void> T OnPlaceClickHandler(Il2CppVector2 position) {
		return ((T (*)(BuilderWindow*, Il2CppVector2))(Il2CppBase() + 0x15AB320))(this, position);
	}
	template <typename T = void> T ProcessUpgradeBuild(Il2CppVector2 position) {
		return ((T (*)(BuilderWindow*, Il2CppVector2))(Il2CppBase() + 0x15AC160))(this, position);
	}
	template <typename T = void> T ProcessSelectFurniture(Il2CppVector2 position) {
		return ((T (*)(BuilderWindow*, Il2CppVector2))(Il2CppBase() + 0x15AC410))(this, position);
	}
	...
	template <typename T = void> T StartPlacing(uintptr_t buildEntity) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15AD854))(this, buildEntity);
	}
	...
	template <typename T = void> T GetAllBordersCost(void* points, float x, float y, float initialX, float initialY) {
		return ((T (*)(BuilderWindow*, void*, float, float, float, float))(Il2CppBase() + 0x15AE094))(this, points, x, y, initialX, initialY);
	}
	...
	template <typename T = void> T StartUpgrading(uintptr_t entity) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15AC814))(this, entity);
	}
	template <typename T = void> T SetBuildMode(uintptr_t currentMode) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15AB838))(this, currentMode);
	}
	...
	template <typename T = void> T SelectFurniture(uintptr_t entity) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15ACEFC))(this, entity);
	}
	...
	template <typename T = void> T CreateGhost(uintptr_t selectedFurniture, bool isPlaceClick) {
		return ((T (*)(BuilderWindow*, uintptr_t, bool))(Il2CppBase() + 0x15B04F8))(this, selectedFurniture, isPlaceClick);
	}
	template <typename T = void> T CreateGhost_1(uintptr_t buildEntity, uintptr_t position, bool isPlaceClick) {
		return ((T (*)(BuilderWindow*, uintptr_t, uintptr_t, bool))(Il2CppBase() + 0x15ADAA4))(this, buildEntity, position, isPlaceClick);
	}
	template <typename T = bool> T IsFurnitureNotEmpty(uintptr_t furniture) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15B0748))(this, furniture);
	}
	template <typename T = void> T UpdateSelector(uintptr_t target) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15AEEFC))(this, target);
	}
	template <typename T = void> T DestroySelector() {
		return ((T (*)(BuilderWindow*))(Il2CppBase() + 0x15AD474))(this);
	}
	template <typename T = void> T OnItemClick(uintptr_t item) {
		return ((T (*)(BuilderWindow*, uintptr_t))(Il2CppBase() + 0x15A8F9C))(this, item);
	}
	template <typename T = void> T SetSelectedVisible(uintptr_t entity, bool visible) {
		return ((T (*)(BuilderWindow*, uintptr_t, bool))(Il2CppBase() + 0x15AEAE4))(this, entity, visible);
	}
