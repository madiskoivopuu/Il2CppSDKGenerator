...
public: 
	...
	template <typename R = void> R Bind_1(IMountsInventoryWindow* window, GameEntity* entity, int32_t index, InventorySlot* slot, Action1<IInventoryItem*>* onArming) {
		return ((R (*)(TraderMountItem*, IMountsInventoryWindow*, GameEntity*, int32_t, InventorySlot*, Action1<IInventoryItem*>*))(Il2CppBase() + 0x150ED24))(this, window, entity, index, slot, onArming);
	}
