...
public: 
	...
	template <typename R = UIWindowsManager*> R& _manager() {
	 ...
	 ICollector1<ChatEntity*>* GetTrigger(IContext1<ChatEntity*>* context) {
		return ((ICollector1<ChatEntity*>* (*)(ChatOnMessageSystem*, IContext1<ChatEntity*>*))(Il2CppBase() + 0x17352E0))(this, context);
	}
