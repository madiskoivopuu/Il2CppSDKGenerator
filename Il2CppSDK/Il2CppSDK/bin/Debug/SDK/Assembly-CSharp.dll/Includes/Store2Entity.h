...
public: 
	...
	template <typename T = uintptr_t> static T& visibleComponent() {
	...
	template <typename T = uintptr_t> T get_countLeft() {
	...
	template <typename T = uintptr_t> T get_gachaProgress() {
	...
	template <typename T = uintptr_t> T get_storeDataId() {
