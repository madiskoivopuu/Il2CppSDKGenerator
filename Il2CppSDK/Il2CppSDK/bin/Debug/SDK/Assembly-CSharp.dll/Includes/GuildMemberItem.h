...
public: 
	...
	template <typename T = uintptr_t> T& WeeklyGuildPointsTooltip() {
	...
	template <typename T = void> T Init(uintptr_t window, int64_t playerId) {
		return ((T (*)(GuildMemberItem*, uintptr_t, int64_t))(Il2CppBase() + 0x1B36810))(this, window, playerId);
	}
