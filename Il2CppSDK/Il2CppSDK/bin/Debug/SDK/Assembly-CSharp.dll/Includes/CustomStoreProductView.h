...
public: 
	...
	template <typename R = CustomStoreProductPriceView*> R& Price2() {
	 ...
	 Action1CustomStoreProductView*>*& _onProductClicked() {
		return *(Action1CustomStoreProductView*>**)((uintptr_t)this + 0x150);
	}
	...
	template <typename R = void> R Init(Store2Entity* product, StoreCategory* storeCategory, Category* category, TooltipView* tooltipView, Action1CustomStoreProductView*>* onProductClicked, bool showUnlockFX) {
		return ((R (*)(CustomStoreProductView*, Store2Entity*, StoreCategory*, Category*, TooltipView*, Action1CustomStoreProductView*>*, bool))(Il2CppBase() + 0x1BD8DBC))(this, product, storeCategory, category, tooltipView, onProductClicked, showUnlockFX);
	}
