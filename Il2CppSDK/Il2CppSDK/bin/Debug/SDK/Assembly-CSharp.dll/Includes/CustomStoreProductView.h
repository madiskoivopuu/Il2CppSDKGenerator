...
public: 
	...
	template <typename T = CustomStoreProductPriceView*> T& Price1() {
		return *(T*)((uintptr_t)this + 0x138);
	}
	template <typename T = uintptr_t> T& Slash() {
		return *(T*)((uintptr_t)this + 0x140);
	}
	template <typename T = CustomStoreProductPriceView*> T& Price2() {
		return *(T*)((uintptr_t)this + 0x148);
	}
	template <typename T = Action1CustomStoreProductView*>*> T& _onProductClicked() {
	...
	template <typename T = void> T Init(Store2Entity* product, StoreCategory* storeCategory, Category* category, TooltipView* tooltipView, Action1CustomStoreProductView*>* onProductClicked, bool showUnlockFX) {
		return ((T (*)(CustomStoreProductView*, Store2Entity*, StoreCategory*, Category*, TooltipView*, Action1CustomStoreProductView*>*, bool))(Il2CppBase() + 0x1BD8DBC))(this, product, storeCategory, category, tooltipView, onProductClicked, showUnlockFX);
	}
