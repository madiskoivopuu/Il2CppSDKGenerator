...
public: 
	...
	template <typename R = Il2CppString*> static R NeedTransport(GameEntity* point, IEnumerable1<Il2CppString*>* availableTransports) {
		return ((R (*)(void *, GameEntity*, IEnumerable1<Il2CppString*>*))(Il2CppBase() + 0x1270B98))(0, point, availableTransports);
	}
