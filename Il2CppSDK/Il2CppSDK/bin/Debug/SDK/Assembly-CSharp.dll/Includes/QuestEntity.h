...
public: 
	...
	template <typename T = ActualComponent*> static T& actualComponent() {
	...
	template <typename T = NoStartedComponent*> static T& noStartedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = NotAutoCompleteComponent*> static T& notAutoCompleteComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = PremiumRewardedComponent*> static T& premiumRewardedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = ReplicatedComponent*> static T& replicatedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = RewardedComponent*> static T& rewardedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = TrackingComponent*> static T& trackingComponent() {
	...
	template <typename T = QuestDataEntity*> T get_Data() {
		return ((T (*)(QuestEntity*))(Il2CppBase() + 0x1C31C74))(this);
	}
	template <typename T = void> T AddData(Il2CppString* name, QuestDataEntity* data) {
		return ((T (*)(QuestEntity*, Il2CppString*, QuestDataEntity*))(Il2CppBase() + 0x1C31F5C))(this, name, data);
	}
	...
	template <typename T = CheckTimeComponent*> T get_checkTime() {
	...
	template <typename T = GeneratedRewardComponent*> T get_generatedReward() {
	...
	template <typename T = LastProgressComponent*> T get_lastProgress() {
	...
	template <typename T = ManualTrackingComponent*> T get_manualTracking() {
	...
	template <typename T = NextActiveTimeComponent*> T get_nextActiveTime() {
	...
	template <typename T = NotifiedComponent*> T get_notified() {
	...
	template <typename T = ProgressPerLocationComponent*> T get_progressPerLocation() {
	...
	template <typename T = QuestDataComponent*> T get_questData() {
	...
	template <typename T = void> T AddQuestData(Il2CppString* newName, QuestDataEntity* newDataEntity) {
		return ((T (*)(QuestEntity*, Il2CppString*, QuestDataEntity*))(Il2CppBase() + 0x1C34D54))(this, newName, newDataEntity);
	}
	template <typename T = void> T ReplaceQuestData(Il2CppString* newName, QuestDataEntity* newDataEntity) {
		return ((T (*)(QuestEntity*, Il2CppString*, QuestDataEntity*))(Il2CppBase() + 0x1C31F60))(this, newName, newDataEntity);
	}
	...
	template <typename T = RewardCoefComponent*> T get_rewardCoef() {
	...
	template <typename T = SourceItemComponent*> T get_sourceItem() {
