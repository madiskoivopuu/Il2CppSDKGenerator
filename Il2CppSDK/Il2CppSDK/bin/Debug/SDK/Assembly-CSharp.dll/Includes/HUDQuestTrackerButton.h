...
class HUDQuestTrackerButton: HUDButtonBaseCustomizable
{
public: 
	...
	template <typename T = uintptr_t> T& _synhroObject() {
	...
	template <typename T = void> T Bind(uintptr_t window) {
		return ((T (*)(HUDQuestTrackerButton*, uintptr_t))(Il2CppBase() + 0x127BA18))(this, window);
	}
