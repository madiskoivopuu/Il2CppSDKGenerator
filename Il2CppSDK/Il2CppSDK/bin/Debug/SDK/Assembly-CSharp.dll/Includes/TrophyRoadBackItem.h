...
public: 
	...
	template <typename T = void> T Bind(TrophyRoadWindow* window) {
		return ((T (*)(TrophyRoadBackItem*, TrophyRoadWindow*))(Il2CppBase() + 0x10125A4))(this, window);
	}
	template <typename T = void> T UpdateItem(uintptr_t positionVectror) {
		return ((T (*)(TrophyRoadBackItem*, uintptr_t))(Il2CppBase() + 0x10125AC))(this, positionVectror);
	}
