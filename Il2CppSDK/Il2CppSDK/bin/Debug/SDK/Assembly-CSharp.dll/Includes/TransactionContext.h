...
class TransactionContext: ToPlayerReplicatedContext1
{
public: 
	...
	template <typename T = uintptr_t> T GetEntityWithId(int32_t transactionId) {
		return ((T (*)(TransactionContext*, int32_t))(Il2CppBase() + 0x1515B68))(this, transactionId);
	}
	template <typename T = uintptr_t> T GetEntityWithTransactionId(Il2CppString* transactionId) {
	...
	template <typename T = void*> T GetEntitiesForPlayerWithType(int64_t playerId, uintptr_t type) {
		return ((T (*)(TransactionContext*, int64_t, uintptr_t))(Il2CppBase() + 0x1515DE0))(this, playerId, type);
	}
	template <typename T = void*> T GetClientEntitiesForPlayerWithType(int64_t playerId, uintptr_t type) {
		return ((T (*)(TransactionContext*, int64_t, uintptr_t))(Il2CppBase() + 0x1515ED4))(this, playerId, type);
	}
