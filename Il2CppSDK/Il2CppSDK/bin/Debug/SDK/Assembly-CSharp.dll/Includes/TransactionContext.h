...
public: 
	...
	template <typename R = TransactionEntity*> R GetEntityWithTransactionId(Il2CppString* transactionId) {
	 ...
	 HashSet1<TransactionEntity*>* GetEntitiesForPlayer(int64_t playerId) {
		return ((HashSet1<TransactionEntity*>* (*)(TransactionContext*, int64_t))(Il2CppBase() + 0x1515D20))(this, playerId);
	}
	 HashSet1<TransactionEntity*>* GetEntitiesForPlayerWithType(int64_t playerId, TransactionType type) {
		return ((HashSet1<TransactionEntity*>* (*)(TransactionContext*, int64_t, TransactionType))(Il2CppBase() + 0x1515DE0))(this, playerId, type);
	}
	 HashSet1<TransactionEntity*>* GetClientEntitiesForPlayerWithType(int64_t playerId, TransactionType type) {
		return ((HashSet1<TransactionEntity*>* (*)(TransactionContext*, int64_t, TransactionType))(Il2CppBase() + 0x1515ED4))(this, playerId, type);
	}
