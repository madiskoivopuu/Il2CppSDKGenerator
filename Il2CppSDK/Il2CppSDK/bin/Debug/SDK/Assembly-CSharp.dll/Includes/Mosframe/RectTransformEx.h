...
public: 
	...
	template <typename T = Il2CppVector2> static T getSize(uintptr_t self) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x139D078))(0, self);
	}
	template <typename T = void> static T setSize(uintptr_t self, Il2CppVector2 newSize) {
		return ((T (*)(void *, uintptr_t, Il2CppVector2))(Il2CppBase() + 0x139D0B8))(0, self, newSize);
	}
	...
	template <typename T = bool> static T inScreenRect(uintptr_t self, Il2CppVector2 screenPos) {
		return ((T (*)(void *, uintptr_t, Il2CppVector2))(Il2CppBase() + 0x139D4E4))(0, self, screenPos);
	}
	...
	template <typename T = Il2CppRect> static T getScreenRect(uintptr_t self) {
