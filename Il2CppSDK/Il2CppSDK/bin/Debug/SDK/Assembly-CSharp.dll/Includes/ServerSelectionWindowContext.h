...
public: 
	...
	template <typename R = ServerSelectionWindowMode*> R& ViewMode() {
	 ...
	 Action1Il2CppString*>*& OnChangeServer() {
	...
	template <typename R = ServerSelectionWindowMode*> R get_ViewMode() {
	 ...
	 Action1Il2CppString*>* get_OnChangeServer() {
		return ((Action1Il2CppString*>* (*)(ServerSelectionWindowContext*))(Il2CppBase() + 0x10CA028))(this);
	}
