...
class PlayerClassQuickSwitchWindow: UIWindow1
{
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& _selectedClassViews() {
	...
	template <typename T = void> T OnFilterButtonClick(uintptr_t filter) {
		return ((T (*)(PlayerClassQuickSwitchWindow*, uintptr_t))(Il2CppBase() + 0x1B69F24))(this, filter);
	}
	template <typename T = void> T CollectionFilter(Il2CppDictionary<Il2CppString*, uintptr_t>* classViews) {
		return ((T (*)(PlayerClassQuickSwitchWindow*, Il2CppDictionary<Il2CppString*, uintptr_t>*))(Il2CppBase() + 0x1B69FF8))(this, classViews);
	}
	template <typename T = int32_t> T ClassPriority(uintptr_t classEntity) {
		return ((T (*)(PlayerClassQuickSwitchWindow*, uintptr_t))(Il2CppBase() + 0x1B6A3C0))(this, classEntity);
	}
