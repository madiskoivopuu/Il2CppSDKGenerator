...
public: 
	...
	template <typename T = void> T Bind(uintptr_t window, Il2CppArray<uintptr_t>* pointValues, int32_t pointsOnInfinityStep) {
		return ((T (*)(BattlePassProgress*, uintptr_t, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x167CCAC))(this, window, pointValues, pointsOnInfinityStep);
	}
