...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1<ProtoTools::ErrorCodes>*& OnConnectionError() {
		return *(Action1<ProtoTools::ErrorCodes>**)((uintptr_t)this + 0xA0);
	}
	...
	template <typename R = Il2CppArray<uint8_t>*> R& _tokenKey() {
	 ...
	 IEnumerable1<ConfigurationVersion*>*& _serverCfgVersions() {
		return *(IEnumerable1<ConfigurationVersion*>**)((uintptr_t)this + 0xE0);
	}
	...
	template <typename R = DataBlueprints> R& _currentData() {
	 ...
	 Il2CppDictionary<ConfigurationType, Action3<int64_t, int64_t, ConfigurationType>*>*& _configurationActions() {
		return *(Il2CppDictionary<ConfigurationType, Action3<int64_t, int64_t, ConfigurationType>*>**)((uintptr_t)this + 0x120);
	}

	template <typename R = void> R add_OnConnectionError(Action1<ProtoTools::ErrorCodes>* value) {
		return ((R (*)(ConfigurationLS*, Action1<ProtoTools::ErrorCodes>*))(Il2CppBase() + 0x15E47AC))(this, value);
	}
	template <typename R = void> R remove_OnConnectionError(Action1<ProtoTools::ErrorCodes>* value) {
		return ((R (*)(ConfigurationLS*, Action1<ProtoTools::ErrorCodes>*))(Il2CppBase() + 0x15E484C))(this, value);
	}
	...
	template <typename R = void> R OnUserLogged(Il2CppString* adress, Il2CppString* coordinatorAddress, IEnumerable1<ConfigurationVersion*>* cfgVersions, int64_t userID, Il2CppArray<uint8_t>* token) {
		return ((R (*)(ConfigurationLS*, Il2CppString*, Il2CppString*, IEnumerable1<ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*))(Il2CppBase() + 0x15E4F1C))(this, adress, coordinatorAddress, cfgVersions, userID, token);
	}
	...
	template <typename R = uintptr_t> R LoadConfiguration(IEnumerable1<ConfigurationVersion*>* configs) {
		return ((R (*)(ConfigurationLS*, IEnumerable1<ConfigurationVersion*>*))(Il2CppBase() + 0x15E5E5C))(this, configs);
	}
