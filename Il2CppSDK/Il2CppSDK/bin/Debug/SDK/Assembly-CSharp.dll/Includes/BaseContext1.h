...
public: 
	...
	template <typename R = ICommonLogger*> R& _logger() {
	 ...
	 static Il2CppArray<ComponentKindTEntity>*>*& ComponentKinds() {
		return *(Il2CppArray<ComponentKindTEntity>*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = void> R set_ComponentTypes(Il2CppArray<uintptr_t>* value) {
	 ...
	 static Il2CppArray<ComponentKindTEntity>*>* get_ComponentKinds() {
		return ((Il2CppArray<ComponentKindTEntity>*>* (*)(void *))(Il2CppBase() + 0x0))(0);
	}
	template <typename R = void> static R set_ComponentKinds(Il2CppArray<ComponentKindTEntity>*>* value) {
		return ((R (*)(void *, Il2CppArray<ComponentKindTEntity>*>*))(Il2CppBase() + 0x0))(0, value);
	}
	...
	template <typename R = void> R DestroyEntities(IGroup1TEntity>* group) {
		return ((R (*)(BaseContext1*, IGroup1TEntity>*))(Il2CppBase() + 0x0))(this, group);
	}
	template <typename R = void> R DestroyEntities_1(IMatcher1TEntity>* matcher) {
		return ((R (*)(BaseContext1*, IMatcher1TEntity>*))(Il2CppBase() + 0x0))(this, matcher);
	}
	template <typename R = bool> R DestroyEntities_2(HashSet1TEntity>* entities, Predicate1TEntity>* predicate) {
		return ((R (*)(BaseContext1*, HashSet1TEntity>*, Predicate1TEntity>*))(Il2CppBase() + 0x0))(this, entities, predicate);
	}
