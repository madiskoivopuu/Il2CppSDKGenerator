...
public: 
	...
	template <typename R = int32_t> R& grade() {
	 ...
	 HashSet1<Il2CppString*>*& needResourcesResult() {
		return *(HashSet1<Il2CppString*>**)((uintptr_t)this + 0x278);
	}

	 HashSet1<Il2CppString*>* GetNeedResources() {
		return ((HashSet1<Il2CppString*>* (*)(ExtractorWindow*))(Il2CppBase() + 0x168BCF0))(this);
	}
	...
	template <typename R = bool> R ProcessMoveItem(IItem* item, Nullable1<int32_t>* toSlotId) {
		return ((R (*)(ExtractorWindow*, IItem*, Nullable1<int32_t>*))(Il2CppBase() + 0x168D12C))(this, item, toSlotId);
	}
