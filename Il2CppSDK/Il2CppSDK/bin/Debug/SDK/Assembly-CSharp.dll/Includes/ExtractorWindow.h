...
class ExtractorWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& RewardSlot() {
	...
	template <typename T = uintptr_t> T& UpgradeItemViewPrefab() {
	...
	template <typename T = uintptr_t> T& robbedSlotEntity() {
		return *(T*)((uintptr_t)this + 0x258);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& robberFakeResourceSlots() {
	...
	template <typename T = void*> T& needResourcesResult() {
	...
	template <typename T = void> T UpdateCloseTimer(uintptr_t target) {
		return ((T (*)(ExtractorWindow*, uintptr_t))(Il2CppBase() + 0x168CE88))(this, target);
	}
	template <typename T = void> T OnDoubleClick(uintptr_t item) {
		return ((T (*)(ExtractorWindow*, uintptr_t))(Il2CppBase() + 0x168D0AC))(this, item);
	}
	template <typename T = void> T OnDrop(uintptr_t item) {
		return ((T (*)(ExtractorWindow*, uintptr_t))(Il2CppBase() + 0x168DF18))(this, item);
	}
	...
	template <typename T = bool> T ProcessMoveItem(uintptr_t item, void* toSlotId) {
		return ((T (*)(ExtractorWindow*, uintptr_t, void*))(Il2CppBase() + 0x168D12C))(this, item, toSlotId);
	}
	...
	template <typename T = void> T UpdateRobberResourceUI(uintptr_t world, uintptr_t target, uintptr_t extractComponent, int32_t newResourceCount) {
		return ((T (*)(ExtractorWindow*, uintptr_t, uintptr_t, uintptr_t, int32_t))(Il2CppBase() + 0x1690194))(this, world, target, extractComponent, newResourceCount);
	}
	template <typename T = void> T UpdateInventory(uintptr_t world, uintptr_t target, bool sameClan, uintptr_t extractComponent) {
		return ((T (*)(ExtractorWindow*, uintptr_t, uintptr_t, bool, uintptr_t))(Il2CppBase() + 0x168C6FC))(this, world, target, sameClan, extractComponent);
	}
	template <typename T = void> T UpdateExtractOnWorkUI(uintptr_t world, uintptr_t target, uintptr_t extractComponent, bool sameClan) {
		return ((T (*)(ExtractorWindow*, uintptr_t, uintptr_t, uintptr_t, bool))(Il2CppBase() + 0x1690408))(this, world, target, extractComponent, sameClan);
	}
	template <typename T = void> T UpdateExtractOnFinishUI(uintptr_t world, uintptr_t target, uintptr_t extractComponent, bool sameClan) {
		return ((T (*)(ExtractorWindow*, uintptr_t, uintptr_t, uintptr_t, bool))(Il2CppBase() + 0x1690BBC))(this, world, target, extractComponent, sameClan);
	}
	template <typename T = void> T ShowExtractionPrepareUI(uintptr_t world, uintptr_t target, uintptr_t extractComponent, bool wasRobbed, bool sameClan) {
		return ((T (*)(ExtractorWindow*, uintptr_t, uintptr_t, uintptr_t, bool, bool))(Il2CppBase() + 0x1691090))(this, world, target, extractComponent, wasRobbed, sameClan);
	}
	...
	template <typename T = int32_t> T CalculateResourceCount(uintptr_t world, uintptr_t target) {
		return ((T (*)(ExtractorWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x168FF4C))(this, world, target);
	}
