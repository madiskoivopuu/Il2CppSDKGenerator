...
public: 
	...
	template <typename T = VipBonusComponent*> T get_vipBonus() {
	...
	template <typename T = void> T AddVipBonus(VipBonusType* newType, Il2CppString* newName, float newValue) {
		return ((T (*)(VIPEntity*, VipBonusType*, Il2CppString*, float))(Il2CppBase() + 0x15BFD68))(this, newType, newName, newValue);
	}
	template <typename T = void> T ReplaceVipBonus(VipBonusType* newType, Il2CppString* newName, float newValue) {
		return ((T (*)(VIPEntity*, VipBonusType*, Il2CppString*, float))(Il2CppBase() + 0x15BFE94))(this, newType, newName, newValue);
	}
	template <typename T = void> T RemoveVipBonus() {
		return ((T (*)(VIPEntity*))(Il2CppBase() + 0x15BFFC0))(this);
	}
	template <typename T = VipIdComponent*> T get_vipId() {
