...
public: 
	...
	template <typename T = CartRequirementsContainer*> T& RequirementsContainer() {
	...
	template <typename T = void> T CheckResourcesCollected(InventoryItem* item) {
		return ((T (*)(CartManagementWindow*, InventoryItem*))(Il2CppBase() + 0x15B7F50))(this, item);
	}
	...
	template <typename T = void> T OnDrop(IInventoryItem* item) {
		return ((T (*)(CartManagementWindow*, IInventoryItem*))(Il2CppBase() + 0x15B7F58))(this, item);
	}
	template <typename T = void> T OnDoubleClick(IInventoryItem* item) {
		return ((T (*)(CartManagementWindow*, IInventoryItem*))(Il2CppBase() + 0x15B84AC))(this, item);
	}
