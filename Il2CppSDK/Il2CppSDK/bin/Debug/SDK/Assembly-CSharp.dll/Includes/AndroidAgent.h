...
public: 
	...
	template <typename T = void> T SetWaterfallConfiguration(WaterfallConfiguration* waterfallConfiguration, AdFormat* adFormat) {
		return ((T (*)(AndroidAgent*, WaterfallConfiguration*, AdFormat*))(Il2CppBase() + 0x12A5350))(this, waterfallConfiguration, adFormat);
	}
	...
	template <typename T = void> T loadBanner(IronSourceBannerSize* size, IronSourceBannerPosition* position) {
		return ((T (*)(AndroidAgent*, IronSourceBannerSize*, IronSourceBannerPosition*))(Il2CppBase() + 0x12A82F0))(this, size, position);
	}
	template <typename T = void> T loadBanner_1(IronSourceBannerSize* size, IronSourceBannerPosition* position, Il2CppString* placementName) {
		return ((T (*)(AndroidAgent*, IronSourceBannerSize*, IronSourceBannerPosition*, Il2CppString*))(Il2CppBase() + 0x12A834C))(this, size, position, placementName);
	}
	...
	template <typename T = void> T setSegment(IronSourceSegment* segment) {
		return ((T (*)(AndroidAgent*, IronSourceSegment*))(Il2CppBase() + 0x12A89C8))(this, segment);
	}
