...
public: 
	...
	template <typename T = uintptr_t> T Enter(uintptr_t transition) {
		return ((T (*)(BaseState*, uintptr_t))(Il2CppBase() + 0x1670F34))(this, transition);
	}
	template <typename T = uintptr_t> T Exit(uintptr_t transition) {
		return ((T (*)(BaseState*, uintptr_t))(Il2CppBase() + 0x1670FAC))(this, transition);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(BaseState*, uintptr_t))(Il2CppBase() + 0x1671024))(this, stateMachine);
	}
