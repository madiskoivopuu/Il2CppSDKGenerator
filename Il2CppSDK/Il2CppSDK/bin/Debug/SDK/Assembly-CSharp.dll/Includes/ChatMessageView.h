...
public: 
	...
	template <typename T = void> T Init(uintptr_t messageColor, ChatEntity* entity) {
		return ((T (*)(ChatMessageView*, uintptr_t, ChatEntity*))(Il2CppBase() + 0x1734824))(this, messageColor, entity);
	}
