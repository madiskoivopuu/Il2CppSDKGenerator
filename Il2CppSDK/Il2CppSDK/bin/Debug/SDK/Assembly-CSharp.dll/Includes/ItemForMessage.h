...
public: 
	...
	template <typename T = TextMonoBehaviour*> T& _count() {
	...
	template <typename T = MessageWithItemsWindow*> T& _handler() {
	...
	template <typename T = Nullable1int64_t>*> T& _showGhostyEndTime() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = Nullable1int32_t>*> T& _currentCount() {
	...
	template <typename T = void> T Bind(MessageWithItemsWindow* handler, ItemEntity* item, int32_t count, Nullable1int64_t>* showGhostyEndTime) {
		return ((T (*)(ItemForMessage*, MessageWithItemsWindow*, ItemEntity*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x14C86C0))(this, handler, item, count, showGhostyEndTime);
	}
	template <typename T = void> T Bind_1(Icon* icon, int32_t count) {
		return ((T (*)(ItemForMessage*, Icon*, int32_t))(Il2CppBase() + 0x14C8BFC))(this, icon, count);
	}
	...
	template <typename T = void> T SetGrade(ItemEntity* item) {
		return ((T (*)(ItemForMessage*, ItemEntity*))(Il2CppBase() + 0x14C8DFC))(this, item);
	}
