...
public: 
	...
	template <typename R = Il2CppString*> R& _blueprint() {
	 ...
	 Nullable1int64_t>*& _showGhostyEndTime() {
		return *(Nullable1int64_t>**)((uintptr_t)this + 0x70);
	}
	 Nullable1int32_t>*& _currentCount() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0x80);
	}
	template <typename R = float> R& _countMultiplier() {
		return *(R*)((uintptr_t)this + 0x88);
	}

	template <typename R = void> R Bind(MessageWithItemsWindow* handler, ItemEntity* item, int32_t count, Nullable1int64_t>* showGhostyEndTime) {
		return ((R (*)(ItemForMessage*, MessageWithItemsWindow*, ItemEntity*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x14C86C0))(this, handler, item, count, showGhostyEndTime);
	}
