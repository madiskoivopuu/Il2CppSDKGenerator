...
public: 
	...
	template <typename T = void> T AddType(uintptr_t newValue) {
		return ((T (*)(RandomGroupEntity*, uintptr_t))(Il2CppBase() + 0x17127D4))(this, newValue);
	}
	template <typename T = void> T ReplaceType(uintptr_t newValue) {
		return ((T (*)(RandomGroupEntity*, uintptr_t))(Il2CppBase() + 0x17128D8))(this, newValue);
	}
	template <typename T = void> T RemoveType() {
		return ((T (*)(RandomGroupEntity*))(Il2CppBase() + 0x17129DC))(this);
	}
	template <typename T = uintptr_t> T get_useLimit() {
