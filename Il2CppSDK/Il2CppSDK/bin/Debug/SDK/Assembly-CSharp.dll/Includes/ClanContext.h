...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 PrimaryEntityIndex2<ClanEntity*, int64_t>*& _idIndex() {
		return *(PrimaryEntityIndex2<ClanEntity*, int64_t>**)((uintptr_t)this + 0xF8);
	}
	 PrimaryEntityIndex2<ClanEntity*, int64_t>*& _leaderIndex() {
		return *(PrimaryEntityIndex2<ClanEntity*, int64_t>**)((uintptr_t)this + 0x100);
	}
	 EntityIndex2<ClanEntity*, int64_t>*& _pvpIndex() {
		return *(EntityIndex2<ClanEntity*, int64_t>**)((uintptr_t)this + 0x108);
	}
	...
	template <typename R = ClanEntity*> R GetEntityWithLeaderId(int64_t id) {
	 ...
	 HashSet1<ClanEntity*>* GetEntitiesWithPvPId(int64_t pvpId) {
		return ((HashSet1<ClanEntity*>* (*)(ClanContext*, int64_t))(Il2CppBase() + 0x157F9BC))(this, pvpId);
	}
