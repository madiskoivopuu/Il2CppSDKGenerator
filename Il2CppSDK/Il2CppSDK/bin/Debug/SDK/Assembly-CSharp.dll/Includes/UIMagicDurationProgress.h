...
public: 
	...
	template <typename R = void> R UpdateProgress() {
	 ...
	 ValueTuple2float, float>* GetMagicProgress(MagicEntity* magic, int64_t now) {
		return ((ValueTuple2float, float>* (*)(UIMagicDurationProgress*, MagicEntity*, int64_t))(Il2CppBase() + 0x152D268))(this, magic, now);
	}
