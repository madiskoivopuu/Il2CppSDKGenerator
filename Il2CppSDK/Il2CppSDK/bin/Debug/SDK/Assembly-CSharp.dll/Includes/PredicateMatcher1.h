...
public: 
	...
	template <typename R = Il2CppArray<int32_t>*> R& _noneOfIndexes() {
	 ...
	 Il2CppDictionary<Il2CppString*, Predicate1TEntity>*>*& _predicateDict() {
		return *(Il2CppDictionary<Il2CppString*, Predicate1TEntity>*>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = bool> R& _isHashCached() {
	 ...
	 static HashSet1int32_t>*& _indexSetBufferThreadStatic() {
		return *(HashSet1int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = void> R set_componentNames(Il2CppArray<Il2CppString*>* value) {
	 ...
	 PredicateMatcher1TEntity>* AddPredicate(Il2CppString* name, Predicate1TEntity>* predicate) {
		return ((PredicateMatcher1TEntity>* (*)(PredicateMatcher1*, Il2CppString*, Predicate1TEntity>*))(Il2CppBase() + 0x0))(this, name, predicate);
	}
	...
	template <typename R = bool> static R EqualPredicates(Il2CppDictionary<Il2CppString*, Predicate1TEntity>*>* d1, Il2CppDictionary<Il2CppString*, Predicate1TEntity>*>* d2) {
		return ((R (*)(void *, Il2CppDictionary<Il2CppString*, Predicate1TEntity>*>*, Il2CppDictionary<Il2CppString*, Predicate1TEntity>*>*))(Il2CppBase() + 0x0))(0, d1, d2);
	}
	...
	template <typename R = int32_t> static R ApplyHash(int32_t hash, Il2CppArray<int32_t>* indexes, int32_t i1, int32_t i2) {
	 ...
	 static HashSet1int32_t>* get__indexSetBuffer() {
		return ((HashSet1int32_t>* (*)(void *))(Il2CppBase() + 0x0))(0);
	}
	...
	template <typename R = Il2CppArray<int32_t>*> static R DistinctIndexes(IList1int32_t>* indexes) {
		return ((R (*)(void *, IList1int32_t>*))(Il2CppBase() + 0x0))(0, indexes);
	}
