...
public: 
	...
	template <typename R = Il2CppString*> R& blueprint() {
	 ...
	 Action1<Il2CppString*>*& OnSelected() {
		return *(Action1<Il2CppString*>**)((uintptr_t)this + 0x40);
	}

	template <typename R = Il2CppString*> R get_Blueprint() {
		return ((R (*)(MountConstructorViewPool*))(Il2CppBase() + 0x1EAACC4))(this);
	}
	template <typename R = void> R add_OnSelected(Action1<Il2CppString*>* value) {
		return ((R (*)(MountConstructorViewPool*, Action1<Il2CppString*>*))(Il2CppBase() + 0x1EAACCC))(this, value);
	}
	template <typename R = void> R remove_OnSelected(Action1<Il2CppString*>* value) {
		return ((R (*)(MountConstructorViewPool*, Action1<Il2CppString*>*))(Il2CppBase() + 0x1EAAD6C))(this, value);
	}
