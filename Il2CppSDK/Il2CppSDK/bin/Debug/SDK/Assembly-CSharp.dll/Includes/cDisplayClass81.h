...
public: 
	...
	template <typename R = cDisplayClass80*> R& CS$8__locals1() {
		return *(R*)((uintptr_t)this + 0x28);
	}

	template <typename R = void> R OnBuyButtonClickb__1(int32_t successTransactionId) {
		return ((R (*)(cDisplayClass81*, int32_t))(Il2CppBase() + 0x10CF088))(this, successTransactionId);
	}
	template <typename R = void> R OnBuyButtonClickb__2(PurchaseError* error, int32_t intVal) {
		return ((R (*)(cDisplayClass81*, PurchaseError*, int32_t))(Il2CppBase() + 0x10CF248))(this, error, intVal);
	}
