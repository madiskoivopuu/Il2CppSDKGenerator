...
public: 
	...
	template <typename R = StoreProductContentSlotView*> R& ProductContentItemPrefab() {
	 ...
	 Action1<int64_t>*& _onProductClicked() {
		return *(Action1<int64_t>**)((uintptr_t)this + 0xE8);
	}
	...
	template <typename R = void> R Init(Store2Entity* product, StoreCategory storeCategory, Category category, Action1<int64_t>* onProductClicked) {
		return ((R (*)(StoreProductView*, Store2Entity*, StoreCategory, Category, Action1<int64_t>*))(Il2CppBase() + 0x1835308))(this, product, storeCategory, category, onProductClicked);
	}
