...
public: 
	...
	template <typename T = Nullable1Difficulty*>*> T& _difficulty() {
	...
	template <typename T = PlayerNameComparer*> static T& _playerNameComparer() {
	...
	template <typename T = Nullable1int32_t>*> T get_Id() {
	...
	template <typename T = void> T UpdateView(MapUnityWorld* world, GameEntity* entity) {
		return ((T (*)(MapLocationLabel*, MapUnityWorld*, GameEntity*))(Il2CppBase() + 0x12BC2CC))(this, world, entity);
	}
	template <typename T = void> T UpdateTimer(MapUnityWorld* world, GameEntity* entity, float time, int64_t now) {
		return ((T (*)(MapLocationLabel*, MapUnityWorld*, GameEntity*, float, int64_t))(Il2CppBase() + 0x12BD5FC))(this, world, entity, time, now);
	}
	template <typename T = void> T ShowPhase(MapUnityWorld* world, GameEntity* point, int64_t now) {
		return ((T (*)(MapLocationLabel*, MapUnityWorld*, GameEntity*, int64_t))(Il2CppBase() + 0x12BD8B4))(this, world, point, now);
	}
