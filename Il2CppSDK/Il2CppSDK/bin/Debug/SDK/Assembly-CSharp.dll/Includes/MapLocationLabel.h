...
public: 
	...
	template <typename R = uintptr_t> R& Clan() {
	 ...
	 Nullable1Difficulty*>*& _difficulty() {
		return *(Nullable1Difficulty*>**)((uintptr_t)this + 0x80);
	}
	...
	template <typename R = Il2CppString*> R& _phaseItemName() {
	 ...
	 Nullable1int32_t>* get_Id() {
		return ((Nullable1int32_t>* (*)(MapLocationLabel*))(Il2CppBase() + 0x12BBE54))(this);
	}
