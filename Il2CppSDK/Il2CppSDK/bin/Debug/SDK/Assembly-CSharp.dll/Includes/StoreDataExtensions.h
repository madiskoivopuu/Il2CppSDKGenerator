...
public: 
	...
	template <typename R = bool> static R HasFreePrice(Store2DataEntity* e) {
	 ...
	 static ValueTuple2<Price, Discount>* GetPriceAndDiscountWithIndex(Store2DataEntity* e, int32_t index) {
		return ((ValueTuple2<Price, Discount>* (*)(void *, Store2DataEntity*, int32_t))(Il2CppBase() + 0x1419024))(0, e, index);
	}
