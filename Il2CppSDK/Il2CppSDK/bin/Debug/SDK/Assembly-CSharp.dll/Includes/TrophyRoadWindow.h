...
public: 
	...
	template <typename T = DelayedButton*> T& BuildButton() {
	...
	template <typename T = TextMonoBehaviour*> T& BonusTextItemPrefab() {
	...
	template <typename T = Il2CppList<TextMonoBehaviour*>*> T& _bonuses() {
	...
	template <typename T = void> T ShowAccountInfo(TrophyRoadEntity* step, int32_t districtLevel) {
		return ((T (*)(TrophyRoadWindow*, TrophyRoadEntity*, int32_t))(Il2CppBase() + 0x102A59C))(this, step, districtLevel);
	}
	...
	template <typename T = void> T ShowBonuses(TrophyRoadEntity* step) {
		return ((T (*)(TrophyRoadWindow*, TrophyRoadEntity*))(Il2CppBase() + 0x102A060))(this, step);
	}
	template <typename T = void> T UpdateElderDialogue(TrophyRoadEntity* step, int32_t currentLevel) {
		return ((T (*)(TrophyRoadWindow*, TrophyRoadEntity*, int32_t))(Il2CppBase() + 0x102A800))(this, step, currentLevel);
	}
	template <typename T = void> T ShowPreview(TrophyRoadEntity* step, int32_t districtLevel) {
		return ((T (*)(TrophyRoadWindow*, TrophyRoadEntity*, int32_t))(Il2CppBase() + 0x102A548))(this, step, districtLevel);
	}
	template <typename T = void> T HidePreview() {
		return ((T (*)(TrophyRoadWindow*))(Il2CppBase() + 0x102B538))(this);
	}
	template <typename T = void> T SetAnimation(TrophyRoadEntity* step, bool isShow) {
		return ((T (*)(TrophyRoadWindow*, TrophyRoadEntity*, bool))(Il2CppBase() + 0x102B750))(this, step, isShow);
	}
	template <typename T = void> T CameraFollow(TrophyRoadEntity* step, bool reset) {
		return ((T (*)(TrophyRoadWindow*, TrophyRoadEntity*, bool))(Il2CppBase() + 0x102A948))(this, step, reset);
	}
