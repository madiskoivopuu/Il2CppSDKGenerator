...
public: 
	...
	template <typename T = void*> static T& _matcherPvPState() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> static T& _matcherSearchDuration() {
	...
	template <typename T = void*> static T get_PvPState() {
		return ((T (*)(void *))(Il2CppBase() + 0x11BE30C))(0);
	}
	template <typename T = void*> static T get_SearchDuration() {
