...
public: 
	...
	template <typename R = uintptr_t> R& OnClick() {
	 ...
	 Action1<int32_t>*& OnHoldRelease() {
		return *(Action1<int32_t>**)((uintptr_t)this + 0x70);
	}
	 Action1<int32_t>*& OnValueChanged() {
		return *(Action1<int32_t>**)((uintptr_t)this + 0x78);
	}
	...
	template <typename R = void> R Bind(Action1<int32_t>* onValueChanged, Action1<int32_t>* onHoldRelease, uintptr_t onClick, bool addListeners) {
		return ((R (*)(ButtonWithSliderOnHold*, Action1<int32_t>*, Action1<int32_t>*, uintptr_t, bool))(Il2CppBase() + 0x15B18CC))(this, onValueChanged, onHoldRelease, onClick, addListeners);
	}
