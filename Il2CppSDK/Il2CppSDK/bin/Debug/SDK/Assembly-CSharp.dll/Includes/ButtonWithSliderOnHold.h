...
public: 
	...
	template <typename T = Action1int32_t>*> T& OnHoldRelease() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = Action1int32_t>*> T& OnValueChanged() {
	...
	template <typename T = void> T Bind(Action1int32_t>* onValueChanged, Action1int32_t>* onHoldRelease, uintptr_t onClick, bool addListeners) {
		return ((T (*)(ButtonWithSliderOnHold*, Action1int32_t>*, Action1int32_t>*, uintptr_t, bool))(Il2CppBase() + 0x15B18CC))(this, onValueChanged, onHoldRelease, onClick, addListeners);
	}
