...
public: 
	...
	template <typename T = Nullable1int32_t>*> T& _fingerId() {
	...
	template <typename T = Predicate1uintptr_t>*> T& onPointerDown() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = Action1uintptr_t>*> T& onPointerUp() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = Action1uintptr_t>*> T& onDrag() {
