...
public: 
	...
	template <typename R = bool> R& IsPressed() {
	 ...
	 Nullable1int32_t>*& _fingerId() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0x1C);
	}
	...
	template <typename R = int32_t> R& _lastReleasedFrame() {
	 ...
	 Predicate1uintptr_t>*& onPointerDown() {
		return *(Predicate1uintptr_t>**)((uintptr_t)this + 0x30);
	}
	 Action1uintptr_t>*& onPointerUp() {
		return *(Action1uintptr_t>**)((uintptr_t)this + 0x38);
	}
	 Action1uintptr_t>*& onDrag() {
