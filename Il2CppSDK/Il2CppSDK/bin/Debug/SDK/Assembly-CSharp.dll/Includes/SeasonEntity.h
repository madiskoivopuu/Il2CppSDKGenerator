...
public: 
	...
	template <typename T = void> T AddCurrencyType(CurrencyType* newType) {
		return ((T (*)(SeasonEntity*, CurrencyType*))(Il2CppBase() + 0x135E25C))(this, newType);
	}
	template <typename T = void> T ReplaceCurrencyType(CurrencyType* newType) {
		return ((T (*)(SeasonEntity*, CurrencyType*))(Il2CppBase() + 0x135E360))(this, newType);
	}
	...
	template <typename T = void> T AddTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, CyclicTime* newCyclic) {
		return ((T (*)(SeasonEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, CyclicTime*))(Il2CppBase() + 0x135F624))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
	template <typename T = void> T ReplaceTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, CyclicTime* newCyclic) {
		return ((T (*)(SeasonEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, CyclicTime*))(Il2CppBase() + 0x135F770))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
