...
public: 
	...
	template <typename T = uintptr_t> static T& gachaComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& oldAmountComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = uintptr_t> static T& resettableComponent() {
	...
	template <typename T = uintptr_t> T get_addBonusCurrency() {
	...
	template <typename T = void> T AddAddBonusCurrency(uintptr_t newCurrency, int32_t newCount) {
		return ((T (*)(Store2DataEntity*, uintptr_t, int32_t))(Il2CppBase() + 0x140A6DC))(this, newCurrency, newCount);
	}
	template <typename T = void> T ReplaceAddBonusCurrency(uintptr_t newCurrency, int32_t newCount) {
		return ((T (*)(Store2DataEntity*, uintptr_t, int32_t))(Il2CppBase() + 0x140A7E4))(this, newCurrency, newCount);
	}
	template <typename T = void> T RemoveAddBonusCurrency() {
		return ((T (*)(Store2DataEntity*))(Il2CppBase() + 0x140A8EC))(this);
	}
	template <typename T = uintptr_t> T get_addVipPoints() {
	...
	template <typename T = uintptr_t> T get_additionalChances() {
	...
	template <typename T = uintptr_t> T get_bannerBackgroundImage() {
	...
	template <typename T = uintptr_t> T get_bannerNames() {
	...
	template <typename T = uintptr_t> T get_bannerPrefab() {
	...
	template <typename T = void> T AddBattlePassAddLevels(uintptr_t newCurrencyType, int32_t newAddLevels) {
		return ((T (*)(Store2DataEntity*, uintptr_t, int32_t))(Il2CppBase() + 0x140B700))(this, newCurrencyType, newAddLevels);
	}
	template <typename T = void> T ReplaceBattlePassAddLevels(uintptr_t newCurrencyType, int32_t newAddLevels) {
		return ((T (*)(Store2DataEntity*, uintptr_t, int32_t))(Il2CppBase() + 0x140B808))(this, newCurrencyType, newAddLevels);
	}
	...
	template <typename T = uintptr_t> T get_coinsPack() {
	...
	template <typename T = uintptr_t> T get_commingSoon() {
	...
	template <typename T = void> T AddConsumeType(uintptr_t newType) {
		return ((T (*)(Store2DataEntity*, uintptr_t))(Il2CppBase() + 0x140C664))(this, newType);
	}
	template <typename T = void> T ReplaceConsumeType(uintptr_t newType) {
		return ((T (*)(Store2DataEntity*, uintptr_t))(Il2CppBase() + 0x140C768))(this, newType);
	}
	...
	template <typename T = uintptr_t> T get_discount() {
	...
	template <typename T = uintptr_t> T get_expireTime() {
	...
	template <typename T = uintptr_t> T get_needExp() {
	...
	template <typename T = uintptr_t> T get_profit() {
	...
	template <typename T = uintptr_t> T get_purchaseMore() {
	...
	template <typename T = uintptr_t> T get_savingsPackType() {
	...
	template <typename T = void> T AddSavingsPackType(uintptr_t newType) {
		return ((T (*)(Store2DataEntity*, uintptr_t))(Il2CppBase() + 0x140ECE0))(this, newType);
	}
	template <typename T = void> T ReplaceSavingsPackType(uintptr_t newType) {
		return ((T (*)(Store2DataEntity*, uintptr_t))(Il2CppBase() + 0x140EDE4))(this, newType);
	}
	template <typename T = void> T RemoveSavingsPackType() {
		return ((T (*)(Store2DataEntity*))(Il2CppBase() + 0x140EEE8))(this);
	}
	template <typename T = uintptr_t> T get_showcasePriority() {
	...
	template <typename T = uintptr_t> T get_slotsRewards() {
	...
	template <typename T = uintptr_t> T get_soldOut() {
	...
	template <typename T = uintptr_t> T get_storeId() {
	...
	template <typename T = uintptr_t> T get_storeType() {
	...
	template <typename T = void> T AddStoreType(uintptr_t newType) {
		return ((T (*)(Store2DataEntity*, uintptr_t))(Il2CppBase() + 0x140F8F0))(this, newType);
	}
	template <typename T = void> T ReplaceStoreType(uintptr_t newType) {
		return ((T (*)(Store2DataEntity*, uintptr_t))(Il2CppBase() + 0x140F9F4))(this, newType);
	}
