...
public: 
	...
	template <typename T = LocalizationStringParser*> static T& _localizationStringParser() {
	...
	template <typename T = void> static T Init(ICommonLogger* logger) {
		return ((T (*)(void *, ICommonLogger*))(Il2CppBase() + 0x144318C))(0, logger);
	}
