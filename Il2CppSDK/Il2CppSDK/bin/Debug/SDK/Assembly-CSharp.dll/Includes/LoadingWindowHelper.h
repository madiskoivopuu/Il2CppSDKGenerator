...
public: 
	...
	template <typename R = LoadingWindow*> static R ShowLoading_1(UIWindowsManager* manager, bool isCyclic, Il2CppString* locationBlueprint, DescriptionComponent* descriptionComponent, bool showLore, Nullable1<ValueTuple2<int64_t, int64_t>*>* timer) {
		return ((R (*)(void *, UIWindowsManager*, bool, Il2CppString*, DescriptionComponent*, bool, Nullable1<ValueTuple2<int64_t, int64_t>*>*))(Il2CppBase() + 0x1435174))(0, manager, isCyclic, locationBlueprint, descriptionComponent, showLore, timer);
	}
