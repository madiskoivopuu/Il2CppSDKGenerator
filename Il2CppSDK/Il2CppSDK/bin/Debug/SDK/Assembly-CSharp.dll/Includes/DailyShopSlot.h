...
public: 
	...
	template <typename R = ItemEntity*> R& Item() {
	 ...
	 Action1<DailyShopSlot*>*& ClickEvent() {
		return *(Action1<DailyShopSlot*>**)((uintptr_t)this + 0xD0);
	}
	...
	template <typename R = int32_t> R& _count() {
	 ...
	 Nullable1<bool>*& _sold() {
		return *(Nullable1<bool>**)((uintptr_t)this + 0xF4);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1<DailyShopSlot*>* value) {
		return ((R (*)(DailyShopSlot*, Action1<DailyShopSlot*>*))(Il2CppBase() + 0x16479A8))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1<DailyShopSlot*>* value) {
		return ((R (*)(DailyShopSlot*, Action1<DailyShopSlot*>*))(Il2CppBase() + 0x1647A48))(this, value);
	}
