...
public: 
	...
	template <typename T = void*> T& _sold() {
	...
	template <typename T = void> T set_TooltipView(uintptr_t value) {
		return ((T (*)(DailyShopSlot*, uintptr_t))(Il2CppBase() + 0x1647990))(this, value);
	}
	...
	template <typename T = void> T set_Item(uintptr_t value) {
		return ((T (*)(DailyShopSlot*, uintptr_t))(Il2CppBase() + 0x16479A0))(this, value);
	}
	template <typename T = void> T add_ClickEvent(void* value) {
		return ((T (*)(DailyShopSlot*, void*))(Il2CppBase() + 0x16479A8))(this, value);
	}
	template <typename T = void> T remove_ClickEvent(void* value) {
		return ((T (*)(DailyShopSlot*, void*))(Il2CppBase() + 0x1647A48))(this, value);
	}
	...
	template <typename T = void> T Init(uintptr_t tooltip) {
		return ((T (*)(DailyShopSlot*, uintptr_t))(Il2CppBase() + 0x1647C50))(this, tooltip);
	}
	template <typename T = void> T UpdateView(uintptr_t account, uintptr_t slotEntity, bool sold, float tax, int32_t requiredLevel, int32_t slotIndex, int64_t resetTime) {
		return ((T (*)(DailyShopSlot*, uintptr_t, uintptr_t, bool, float, int32_t, int32_t, int64_t))(Il2CppBase() + 0x1647CA0))(this, account, slotEntity, sold, tax, requiredLevel, slotIndex, resetTime);
	}
