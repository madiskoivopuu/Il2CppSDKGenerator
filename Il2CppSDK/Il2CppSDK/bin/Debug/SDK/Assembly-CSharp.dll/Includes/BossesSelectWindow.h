...
public: 
	...
	template <typename T = Il2CppList<BossView*>*> T& _bossViews() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = BossView*> T& _bossViewPrefab() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = BossDetailView*> T& _bossDetailView() {
	...
	template <typename T = BossView*> T& _selectedView() {
		return *(T*)((uintptr_t)this + 0xD8);
	}
	template <typename T = BossView*> T& _activeView() {
	...
	template <typename T = void> T set_ClickableItems(Il2CppDictionary<int32_t, IClickable*>* value) {
		return ((T (*)(BossesSelectWindow*, Il2CppDictionary<int32_t, IClickable*>*))(Il2CppBase() + 0x16CF478))(this, value);
	}
	...
	template <typename T = void> T OnBossViewClick(BossView* bossView) {
		return ((T (*)(BossesSelectWindow*, BossView*))(Il2CppBase() + 0x16D05B0))(this, bossView);
	}
	template <typename T = void> T OnBossInfoViewClick(BossView* bossView) {
		return ((T (*)(BossesSelectWindow*, BossView*))(Il2CppBase() + 0x16D06FC))(this, bossView);
	}
	template <typename T = void> T OnFilterButtonClick(Nullable1Difficulty*>* filter) {
		return ((T (*)(BossesSelectWindow*, Nullable1Difficulty*>*))(Il2CppBase() + 0x16D07F8))(this, filter);
	}
	template <typename T = void> T OnSelectClick() {
		return ((T (*)(BossesSelectWindow*))(Il2CppBase() + 0x16D0A00))(this);
	}
	template <typename T = bool> T CanActivateBoss(GameEntity* avatar) {
		return ((T (*)(BossesSelectWindow*, GameEntity*))(Il2CppBase() + 0x16D0AB0))(this, avatar);
	}
	...
	template <typename T = bool> T OnLeftb__39_0(KeyValuePair2int32_t, IClickable*>* i) {
		return ((T (*)(BossesSelectWindow*, KeyValuePair2int32_t, IClickable*>*))(Il2CppBase() + 0x16D11B8))(this, i);
	}
	template <typename T = bool> T OnRightb__40_0(KeyValuePair2int32_t, IClickable*>* i) {
		return ((T (*)(BossesSelectWindow*, KeyValuePair2int32_t, IClickable*>*))(Il2CppBase() + 0x16D1290))(this, i);
	}
