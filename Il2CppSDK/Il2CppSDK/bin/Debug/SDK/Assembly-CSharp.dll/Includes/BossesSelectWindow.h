...
public: 
	...
	template <typename R = void> R OnFilterButtonClick(Nullable1<Difficulty>* filter) {
		return ((R (*)(BossesSelectWindow*, Nullable1<Difficulty>*))(Il2CppBase() + 0x16D07F8))(this, filter);
	}
	...
	template <typename R = bool> R OnLeftb__39_0(KeyValuePair2<int32_t, IClickable*>* i) {
		return ((R (*)(BossesSelectWindow*, KeyValuePair2<int32_t, IClickable*>*))(Il2CppBase() + 0x16D11B8))(this, i);
	}
	template <typename R = bool> R OnRightb__40_0(KeyValuePair2<int32_t, IClickable*>* i) {
		return ((R (*)(BossesSelectWindow*, KeyValuePair2<int32_t, IClickable*>*))(Il2CppBase() + 0x16D1290))(this, i);
	}
