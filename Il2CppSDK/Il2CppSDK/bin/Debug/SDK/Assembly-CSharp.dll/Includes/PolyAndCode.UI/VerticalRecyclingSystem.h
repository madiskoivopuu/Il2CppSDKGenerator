...
class VerticalRecyclingSystem: RecyclingSystem
{
public: 
	...
	template <typename T = Il2CppVector2> T OnValueChangedListener(Il2CppVector2 direction) {
		return ((T (*)(VerticalRecyclingSystem*, Il2CppVector2))(Il2CppBase() + 0x15C590C))(this, direction);
	}
	template <typename T = Il2CppVector2> T RecycleTopToBottom() {
		return ((T (*)(VerticalRecyclingSystem*))(Il2CppBase() + 0x15C5A50))(this);
	}
	template <typename T = Il2CppVector2> T RecycleBottomToTop() {
