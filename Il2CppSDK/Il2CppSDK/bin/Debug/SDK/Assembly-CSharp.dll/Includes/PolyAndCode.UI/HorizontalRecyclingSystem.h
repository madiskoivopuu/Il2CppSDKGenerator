...
public: 
	...
	template <typename T = uintptr_t> T OnValueChangedListener(uintptr_t direction) {
		return ((T (*)(HorizontalRecyclingSystem*, uintptr_t))(Il2CppBase() + 0x1C53FE8))(this, direction);
	}
	template <typename T = uintptr_t> T RecycleLeftToRight() {
		return ((T (*)(HorizontalRecyclingSystem*))(Il2CppBase() + 0x1C5412C))(this);
	}
	template <typename T = uintptr_t> T RecycleRightToleft() {
