...
public: 
	...
	template <typename T = RecyclingSystem*> T& _recyclingSystem() {
		return *(T*)((uintptr_t)this + 0x150);
	}
	template <typename T = uintptr_t> T& _prevAnchoredPos() {
	...
	template <typename T = void> T Initialize_1(IRecyclableScrollRectDataSource* dataSource) {
		return ((T (*)(RecyclableScrollRect*, IRecyclableScrollRectDataSource*))(Il2CppBase() + 0x139DB24))(this, dataSource);
	}
	template <typename T = void> T OnValueChangedListener(uintptr_t normalizedPos) {
		return ((T (*)(RecyclableScrollRect*, uintptr_t))(Il2CppBase() + 0x139DB50))(this, normalizedPos);
	}
	template <typename T = void> T ReloadData() {
		return ((T (*)(RecyclableScrollRect*))(Il2CppBase() + 0x139DBD4))(this);
	}
	template <typename T = void> T ReloadData_1(IRecyclableScrollRectDataSource* dataSource) {
		return ((T (*)(RecyclableScrollRect*, IRecyclableScrollRectDataSource*))(Il2CppBase() + 0x139DBDC))(this, dataSource);
	}
