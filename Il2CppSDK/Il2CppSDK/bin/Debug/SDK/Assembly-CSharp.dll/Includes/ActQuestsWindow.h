...
public: 
	...
	template <typename T = ActTabsController*> T& _tabsController() {
	...
	template <typename T = ActQuestView*> T& _mainQuestView() {
	...
	template <typename T = ActQuestView*> T& _questViewPrefab() {
		return *(T*)((uintptr_t)this + 0xC0);
	}
	template <typename T = Il2CppList<ActQuestView*>*> T& _questViews() {
	...
	template <typename T = void> T ShowAct(QuestDataEntity* actData) {
		return ((T (*)(ActQuestsWindow*, QuestDataEntity*))(Il2CppBase() + 0x18F3814))(this, actData);
	}
	template <typename T = bool> T TryShowQuest(QuestDataEntity* questData) {
		return ((T (*)(ActQuestsWindow*, QuestDataEntity*))(Il2CppBase() + 0x18F3EAC))(this, questData);
	}
	template <typename T = void> T InitQuestsInAct(QuestDataEntity* actData) {
		return ((T (*)(ActQuestsWindow*, QuestDataEntity*))(Il2CppBase() + 0x18F384C))(this, actData);
	}
	template <typename T = void> T OnTrackingClick(ActQuestView* questView) {
		return ((T (*)(ActQuestsWindow*, ActQuestView*))(Il2CppBase() + 0x18F3FFC))(this, questView);
	}
	template <typename T = void> T OnClaimClick(ActQuestView* questView) {
		return ((T (*)(ActQuestsWindow*, ActQuestView*))(Il2CppBase() + 0x18F4160))(this, questView);
	}
	template <typename T = bool> T ShowClaimQuestResult(Il2CppString* questName, GiveRewardResult* result) {
		return ((T (*)(ActQuestsWindow*, Il2CppString*, GiveRewardResult*))(Il2CppBase() + 0x18F42A4))(this, questName, result);
	}
