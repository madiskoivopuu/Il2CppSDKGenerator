...
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, Item*>*> T& Data() {
	...
	template <typename T = float> T GetValue_1(BaseChanceComponent* chanceComponent) {
		return ((T (*)(ChangeChancesComponent*, BaseChanceComponent*))(Il2CppBase() + 0x13EA060))(this, chanceComponent);
	}
