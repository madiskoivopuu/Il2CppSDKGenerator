...
public: 
	...
	template <typename R = bool> R& Cyclic() {
	 ...
	 Nullable1<ValueTuple2<int64_t, int64_t>*>*& Timer() {
		return *(Nullable1<ValueTuple2<int64_t, int64_t>*>**)((uintptr_t)this + 0x78);
	}
	...
	template <typename R = bool> R get_Cyclic() {
	 ...
	 Nullable1<ValueTuple2<int64_t, int64_t>*>* get_Timer() {
		return ((Nullable1<ValueTuple2<int64_t, int64_t>*>* (*)(LoadingWindowContext*))(Il2CppBase() + 0x115C4F0))(this);
	}
