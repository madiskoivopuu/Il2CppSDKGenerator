...
class TraderTypeItem: MountItem
{
public: 
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t entity, int32_t slotIndex, int32_t id) {
		return ((T (*)(TraderTypeItem*, uintptr_t, uintptr_t, int32_t, int32_t))(Il2CppBase() + 0x15111A4))(this, window, entity, slotIndex, id);
	}
	template <typename T = void> T Bind_1(uintptr_t window, uintptr_t entity, int32_t index, uintptr_t slot, void* onArming) {
		return ((T (*)(TraderTypeItem*, uintptr_t, uintptr_t, int32_t, uintptr_t, void*))(Il2CppBase() + 0x1511224))(this, window, entity, index, slot, onArming);
	}
