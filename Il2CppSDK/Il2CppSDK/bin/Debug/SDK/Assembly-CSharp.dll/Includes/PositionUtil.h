...
public: 
	...
	template <typename R = GameEntity*> static R GetNearestFromGroup(IPositionEntity* center, IGroup1GameEntity*>* group, Predicate1GameEntity*>* predicate) {
		return ((R (*)(void *, IPositionEntity*, IGroup1GameEntity*>*, Predicate1GameEntity*>*))(Il2CppBase() + 0x16D70C4))(0, center, group, predicate);
	}
	...
	template <typename R = bool> static R CheckCollision(ICommonContexts* world, EntitiesWithPositionNear1GameEntity*>* obstacles, float radius, Vec2* position, GameEntity* entity) {
		return ((R (*)(void *, ICommonContexts*, EntitiesWithPositionNear1GameEntity*>*, float, Vec2*, GameEntity*))(Il2CppBase() + 0x16D8CF0))(0, world, obstacles, radius, position, entity);
	}
	template <typename R = bool> static R CheckCollision_1(GameEntity* entity, ICommonContexts* world, EntitiesWithPositionNear1GameEntity*>* obstacles, Vec2* position) {
		return ((R (*)(void *, GameEntity*, ICommonContexts*, EntitiesWithPositionNear1GameEntity*>*, Vec2*))(Il2CppBase() + 0x16D9584))(0, entity, world, obstacles, position);
	}
	template <typename R = Vec2*> static R GetPushOutPosition(IArenaWorld* world, EntitiesWithPositionNear1GameEntity*>* obstacles, Vec2* startPosition, Vec2* position, float radius, bool checkWall, GameEntity* entity) {
		return ((R (*)(void *, IArenaWorld*, EntitiesWithPositionNear1GameEntity*>*, Vec2*, Vec2*, float, bool, GameEntity*))(Il2CppBase() + 0x16D96B0))(0, world, obstacles, startPosition, position, radius, checkWall, entity);
	}
	template <typename R = Vec2*> static R ReplacePushOutPosition(GameEntity* entity, IArenaWorld* world, EntitiesWithPositionNear1GameEntity*>* obstacles, Vec2* position, bool checkWall) {
		return ((R (*)(void *, GameEntity*, IArenaWorld*, EntitiesWithPositionNear1GameEntity*>*, Vec2*, bool))(Il2CppBase() + 0x16DA984))(0, entity, world, obstacles, position, checkWall);
	}
