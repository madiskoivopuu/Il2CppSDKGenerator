...
public: 
	...
	template <typename T = float> static T Evaluate(Ease* easeType, float time, float duration, float overshootOrAmplitude, float period) {
		return ((T (*)(void *, Ease*, float, float, float, float))(Il2CppBase() + 0x1A9A0E4))(0, easeType, time, duration, overshootOrAmplitude, period);
	}
