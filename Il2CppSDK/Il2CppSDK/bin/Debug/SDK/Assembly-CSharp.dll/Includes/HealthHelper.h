...
public: 
	...
	template <typename R = bool> static R IsAliveHealth(GameEntity* gameEntity) {
	 ...
	 static Nullable1<float>* GetHealth(GameEntity* gameEntity, Nullable1<float>* coef) {
		return ((Nullable1<float>* (*)(void *, GameEntity*, Nullable1<float>*))(Il2CppBase() + 0x128B4EC))(0, gameEntity, coef);
	}
	 static Nullable1<float>* GetMissingHealth(GameEntity* gameEntity) {
		return ((Nullable1<float>* (*)(void *, GameEntity*))(Il2CppBase() + 0x128B674))(0, gameEntity);
	}
