...
public: 
	...
	template <typename R = float> static R GetMasteryPointsBonus(VIPContext* ctx, int64_t playerId) {
	 ...
	 static ValueTuple2float, Il2CppString*>* GetAllSanctumsDamageBonus(VIPContext* ctx, int64_t playerId) {
		return ((ValueTuple2float, Il2CppString*>* (*)(void *, VIPContext*, int64_t))(Il2CppBase() + 0x15C070C))(0, ctx, playerId);
	}
	...
	template <typename R = float> static R GetDailyChestAdditionalEpicBonus(VIPContext* ctx, int64_t playerId) {
	 ...
	 static ValueTuple2float, Il2CppString*>* GetHealthBonusPercent(VIPContext* ctx, int64_t playerId) {
		return ((ValueTuple2float, Il2CppString*>* (*)(void *, VIPContext*, int64_t))(Il2CppBase() + 0x15C0948))(0, ctx, playerId);
	}
	 static ValueTuple2float, Il2CppString*>* GetHealthBonusConstant(VIPContext* ctx, int64_t playerId) {
		return ((ValueTuple2float, Il2CppString*>* (*)(void *, VIPContext*, int64_t))(Il2CppBase() + 0x15C0A1C))(0, ctx, playerId);
	}
