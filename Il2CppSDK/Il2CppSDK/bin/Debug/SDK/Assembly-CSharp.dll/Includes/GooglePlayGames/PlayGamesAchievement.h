...
public: 
	...
	template <typename T = ReportProgress*> T& mProgressCallback() {
	...
	template <typename T = void> T ReportProgress(Action1bool>* callback) {
		return ((T (*)(PlayGamesAchievement*, Action1bool>*))(Il2CppBase() + 0x16F95DC))(this, callback);
	}
