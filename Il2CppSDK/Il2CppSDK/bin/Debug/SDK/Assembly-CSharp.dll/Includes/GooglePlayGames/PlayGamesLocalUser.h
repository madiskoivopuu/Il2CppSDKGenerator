...
public: 
	...
	template <typename R = void> R Authenticate(Action1<bool>* callback) {
		return ((R (*)(PlayGamesLocalUser*, Action1<bool>*))(Il2CppBase() + 0x16FBFC8))(this, callback);
	}
	template <typename R = void> R Authenticate_1(Action2<bool, Il2CppString*>* callback) {
		return ((R (*)(PlayGamesLocalUser*, Action2<bool, Il2CppString*>*))(Il2CppBase() + 0x16FBFEC))(this, callback);
	}
	template <typename R = void> R Authenticate_2(Action1<bool>* callback, bool silent) {
		return ((R (*)(PlayGamesLocalUser*, Action1<bool>*, bool))(Il2CppBase() + 0x16FC010))(this, callback, silent);
	}
	template <typename R = void> R Authenticate_3(Action2<bool, Il2CppString*>* callback, bool silent) {
		return ((R (*)(PlayGamesLocalUser*, Action2<bool, Il2CppString*>*, bool))(Il2CppBase() + 0x16FC110))(this, callback, silent);
	}
	template <typename R = void> R LoadFriends(Action1<bool>* callback) {
		return ((R (*)(PlayGamesLocalUser*, Action1<bool>*))(Il2CppBase() + 0x16FC218))(this, callback);
	}
	...
	template <typename R = void> R GetStats(Action2<GooglePlayGamesBasicApi::CommonStatusCodes, GooglePlayGamesBasicApi::PlayerStats*>* callback) {
		return ((R (*)(PlayGamesLocalUser*, Action2<GooglePlayGamesBasicApi::CommonStatusCodes, GooglePlayGamesBasicApi::PlayerStats*>*))(Il2CppBase() + 0x16FCED4))(this, callback);
	}
