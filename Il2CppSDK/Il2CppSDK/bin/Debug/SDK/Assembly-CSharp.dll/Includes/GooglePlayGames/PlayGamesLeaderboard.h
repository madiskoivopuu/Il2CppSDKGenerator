...
public: 
	...
	template <typename T = Il2CppList<PlayGamesScore*>*> T& mScoreList() {
	...
	template <typename T = void> T LoadScores(Action1bool>* callback) {
		return ((T (*)(PlayGamesLeaderboard*, Action1bool>*))(Il2CppBase() + 0x16FB2E8))(this, callback);
	}
	...
	template <typename T = bool> T SetFromData(LeaderboardScoreData* data) {
		return ((T (*)(PlayGamesLeaderboard*, LeaderboardScoreData*))(Il2CppBase() + 0x16FBADC))(this, data);
	}
	...
	template <typename T = void> T SetLocalUserScore(PlayGamesScore* score) {
		return ((T (*)(PlayGamesLeaderboard*, PlayGamesScore*))(Il2CppBase() + 0x16FBE5C))(this, score);
	}
	template <typename T = int32_t> T AddScore(PlayGamesScore* score) {
		return ((T (*)(PlayGamesLeaderboard*, PlayGamesScore*))(Il2CppBase() + 0x16FBCF8))(this, score);
	}
