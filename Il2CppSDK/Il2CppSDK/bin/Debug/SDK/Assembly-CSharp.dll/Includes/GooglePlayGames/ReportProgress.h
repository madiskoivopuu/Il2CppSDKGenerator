...
public: 
	...
	template <typename T = void> T Invoke(Il2CppString* id, double progress, void* callback) {
		return ((T (*)(ReportProgress*, Il2CppString*, double, void*))(Il2CppBase() + 0x1197E7C))(this, id, progress, callback);
	}
	template <typename T = uintptr_t> T BeginInvoke(Il2CppString* id, double progress, void* callback, uintptr_t __callback, uintptr_t object) {
		return ((T (*)(ReportProgress*, Il2CppString*, double, void*, uintptr_t, uintptr_t))(Il2CppBase() + 0x119823C))(this, id, progress, callback, __callback, object);
	}
