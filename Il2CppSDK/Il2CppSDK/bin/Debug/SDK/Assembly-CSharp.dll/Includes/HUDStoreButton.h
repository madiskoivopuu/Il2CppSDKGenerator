...
public: 
	...
	template <typename T = void> T Bind(IHUDWindow* window) {
		return ((T (*)(HUDStoreButton*, IHUDWindow*))(Il2CppBase() + 0x127F884))(this, window);
	}
	...
	template <typename T = bool> static T UpdateCounterg__isTournamentMessage|4_0(MailEntity* e) {
		return ((T (*)(void *, MailEntity*))(Il2CppBase() + 0x1280078))(0, e);
	}
	template <typename T = bool> static T UpdateCounterg__isExpiredMessage|4_1(MailEntity* e, uintptr_t ) {
		return ((T (*)(void *, MailEntity*, uintptr_t))(Il2CppBase() + 0x12800D0))(0, e, );
	}
	template <typename T = bool> static T UpdateCounterg__isWindowMessage|4_2(MailEntity* e) {
		return ((T (*)(void *, MailEntity*))(Il2CppBase() + 0x128012C))(0, e);
	}
