...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static IAllOfMatcher1MailEntity*>*& _tournamentsMailsMatcher() {
		return *(IAllOfMatcher1MailEntity*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static IAllOfMatcher1MailEntity*>*& _guildJoinMailsMatcher() {
		return *(IAllOfMatcher1MailEntity*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 static IAllOfMatcher1MailEntity*>*& _windowDataMailsMatcher() {
		return *(IAllOfMatcher1MailEntity*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	...
	template <typename R = MailEntity*> static R GetGuildJoinResultMail(IMailContexts* world) {
	 ...
	 static IGroup1MailEntity*>* GetMailWithWindows(IMailContexts* world) {
		return ((IGroup1MailEntity*>* (*)(void *, IMailContexts*))(Il2CppBase() + 0x125C1D0))(0, world);
	}
