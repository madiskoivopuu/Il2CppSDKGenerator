...
class ConstructionWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& ConstructObject() {
	...
	template <typename T = void> T OnDrop(uintptr_t item) {
		return ((T (*)(ConstructionWindow*, uintptr_t))(Il2CppBase() + 0x15E9F9C))(this, item);
	}
	...
	template <typename T = void> T OnFinalizeResult(uintptr_t data) {
		return ((T (*)(ConstructionWindow*, uintptr_t))(Il2CppBase() + 0x15EAD80))(this, data);
	}
	template <typename T = void> T OnUpdateDraw(float deltaTime) {
		return ((T (*)(ConstructionWindow*, float))(Il2CppBase() + 0x15EAED4))(this, deltaTime);
	}
	template <typename T = bool> T CanFinalize(uintptr_t target) {
		return ((T (*)(ConstructionWindow*, uintptr_t))(Il2CppBase() + 0x15EAB0C))(this, target);
	}
