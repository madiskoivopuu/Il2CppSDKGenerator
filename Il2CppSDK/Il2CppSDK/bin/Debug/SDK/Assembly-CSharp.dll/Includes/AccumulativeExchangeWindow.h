...
public: 
	...
	template <typename T = StandartButton*> T& _sellBtn() {
		return *(T*)((uintptr_t)this + 0x170);
	}
	template <typename T = StandartButton*> T& _getRewardBtn() {
		return *(T*)((uintptr_t)this + 0x178);
	}
	template <typename T = StandartButton*> T& _speedUpBtn() {
		return *(T*)((uintptr_t)this + 0x180);
	}
	template <typename T = uintptr_t> T& _closeBtn() {
		return *(T*)((uintptr_t)this + 0x188);
	}
	template <typename T = TooltipTrigger*> T& _infoTrigger() {
	...
	template <typename T = Il2CppList<TooltipTrigger*>*> T& rewardsTooltipTriggers() {
	...
	template <typename T = TooltipTrigger*> T& _accumulativeRewardTrigger() {
	...
	template <typename T = InventorySlot*> T& _rewardSlot() {
	...
	template <typename T = void> T OnAnyTabClick(TabType* tabType) {
		return ((T (*)(AccumulativeExchangeWindow*, TabType*))(Il2CppBase() + 0x18E1EEC))(this, tabType);
	}
	template <typename T = void> T OnUpdateDraw(float deltaTime) {
		return ((T (*)(AccumulativeExchangeWindow*, float))(Il2CppBase() + 0x18E2214))(this, deltaTime);
	}
	template <typename T = void> T UpdateResultPanel(ICommonContexts* world, GameEntity* target) {
		return ((T (*)(AccumulativeExchangeWindow*, ICommonContexts*, GameEntity*))(Il2CppBase() + 0x18E1304))(this, world, target);
	}
	template <typename T = bool> T IsAnyRewards(GameEntity* target) {
		return ((T (*)(AccumulativeExchangeWindow*, GameEntity*))(Il2CppBase() + 0x18E3288))(this, target);
	}
	...
	template <typename T = void> T OnSelect(InventorySlotEntity* selectedInventory, InventorySlot* selectedSlot) {
		return ((T (*)(AccumulativeExchangeWindow*, InventorySlotEntity*, InventorySlot*))(Il2CppBase() + 0x18E4480))(this, selectedInventory, selectedSlot);
	}
	template <typename T = void> T OnDrop(IInventoryItem* item) {
		return ((T (*)(AccumulativeExchangeWindow*, IInventoryItem*))(Il2CppBase() + 0x18E4708))(this, item);
	}
	template <typename T = void> T OnDoubleClick(IInventoryItem* item) {
		return ((T (*)(AccumulativeExchangeWindow*, IInventoryItem*))(Il2CppBase() + 0x18E5784))(this, item);
	}
	template <typename T = void> T UpdateCurrentTab(InventorySlotEntity* slot) {
		return ((T (*)(AccumulativeExchangeWindow*, InventorySlotEntity*))(Il2CppBase() + 0x18E6010))(this, slot);
	}
	...
	template <typename T = bool> T IsItemInFilter(ItemEntity* entity) {
		return ((T (*)(AccumulativeExchangeWindow*, ItemEntity*))(Il2CppBase() + 0x18E4678))(this, entity);
	}
	...
	template <typename T = bool> T UpdateInventoryEntity(InventorySlotEntity* inventoryEntity) {
		return ((T (*)(AccumulativeExchangeWindow*, InventorySlotEntity*))(Il2CppBase() + 0x18E6014))(this, inventoryEntity);
	}
