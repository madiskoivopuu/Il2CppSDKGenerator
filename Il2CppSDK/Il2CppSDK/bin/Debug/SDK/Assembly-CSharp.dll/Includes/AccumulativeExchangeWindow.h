...
public: 
	...
	template <typename R = uintptr_t> R& _speedUpCheatBtn() {
	 ...
	 HashSet1<int32_t>*& _lockedSet() {
		return *(HashSet1<int32_t>**)((uintptr_t)this + 0x230);
	}
	...
	template <typename R = bool> R& _accumulativeRewardLastAccessible() {
	 ...
	 HashSet1<Il2CppString*>*& _needResources() {
		return *(HashSet1<Il2CppString*>**)((uintptr_t)this + 0x280);
	}

	 HashSet1<Il2CppString*>* GetNeedResources() {
		return ((HashSet1<Il2CppString*>* (*)(AccumulativeExchangeWindow*))(Il2CppBase() + 0x18DF970))(this);
	}
