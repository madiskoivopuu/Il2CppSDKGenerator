...
public: 
	...
	template <typename T = StandartButton*> T& ActionButton() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = TooltipTrigger*> T& RandomInfoTooltipTrigger() {
	...
	template <typename T = void> T InitRandomInfoTooltip(Store2DataEntity* storeData) {
		return ((T (*)(StoreGachaDetailedWindow*, Store2DataEntity*))(Il2CppBase() + 0x14214F8))(this, storeData);
	}
	template <typename T = bool> T IsGachaIAPBuyButtonActive(Store2DataEntity* store2Data) {
		return ((T (*)(StoreGachaDetailedWindow*, Store2DataEntity*))(Il2CppBase() + 0x1421B24))(this, store2Data);
	}
	...
	template <typename T = void> T AcquireDicedItems(Resource* baseRes, Il2CppList<Resource*>* additionalResList) {
		return ((T (*)(StoreGachaDetailedWindow*, Resource*, Il2CppList<Resource*>*))(Il2CppBase() + 0x1422EC0))(this, baseRes, additionalResList);
	}
