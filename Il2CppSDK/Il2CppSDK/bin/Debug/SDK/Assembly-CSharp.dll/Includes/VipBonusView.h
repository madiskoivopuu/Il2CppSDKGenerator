...
public: 
	...
	template <typename T = void> T Init(uintptr_t bonus, int32_t vipLevel, bool isVipLevelReached) {
		return ((T (*)(VipBonusView*, uintptr_t, int32_t, bool))(Il2CppBase() + 0x15CDC4C))(this, bonus, vipLevel, isVipLevelReached);
	}
