...
class MountsInventoryWindow: BaseMountsInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& _chooseMountButton() {
	...
	template <typename T = uintptr_t> T& _mountInfoPanel() {
	...
	template <typename T = void> T OnSelect(uintptr_t item) {
		return ((T (*)(MountsInventoryWindow*, uintptr_t))(Il2CppBase() + 0x1550728))(this, item);
	}
