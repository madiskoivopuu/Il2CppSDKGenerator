...
public: 
	...
	template <typename R = void> R add_ShowWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UISingleLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x152F5BC))(this, value);
	}
	template <typename R = void> R remove_ShowWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UISingleLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x152F65C))(this, value);
	}
	template <typename R = void> R add_CloseWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UISingleLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x152F6FC))(this, value);
	}
	template <typename R = void> R remove_CloseWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UISingleLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x152F79C))(this, value);
	}
