...
public: 
	...
	template <typename T = Il2CppDictionary<uintptr_t, Il2CppList<uintptr_t>*>*> T& _hotKeys() {
	...
	template <typename T = void> T Add(uintptr_t hotKey) {
		return ((T (*)(UIHotKeysManager*, uintptr_t))(Il2CppBase() + 0x152A9F4))(this, hotKey);
	}
	template <typename T = void> T Remove(uintptr_t hotKey) {
		return ((T (*)(UIHotKeysManager*, uintptr_t))(Il2CppBase() + 0x152ADA8))(this, hotKey);
	}
	template <typename T = void> T Update() {
		return ((T (*)(UIHotKeysManager*))(Il2CppBase() + 0x152AF2C))(this);
	}
	template <typename T = bool> T TryClickTo(uintptr_t hotKey) {
		return ((T (*)(UIHotKeysManager*, uintptr_t))(Il2CppBase() + 0x152B08C))(this, hotKey);
	}
