...
public: 
	...
	template <typename T = void> T AddBossOpenResources(CurrencyType* newPersonalReward, int32_t newPointsToOpenPortal, int32_t newSilverToProgress, Il2CppArray<uintptr_t>* newOpenPortalItems, Il2CppArray<uintptr_t>* newBosses) {
		return ((T (*)(IBossOpenResourcesEntity*, CurrencyType*, int32_t, int32_t, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x0))(this, newPersonalReward, newPointsToOpenPortal, newSilverToProgress, newOpenPortalItems, newBosses);
	}
