...
public: 
	...
	template <typename T = ActionType*> T& Action() {
	...
	template <typename T = InteractActionCondition*> T& Condition() {
	...
	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(InteractTemplate*, Il2CppObject*))(Il2CppBase() + 0x146A880))(this, targetObject);
	}
	...
	template <typename T = bool> T IsEqualsDefault(Il2CppObject* targetObject) {
		return ((T (*)(InteractTemplate*, Il2CppObject*))(Il2CppBase() + 0x146AE0C))(this, targetObject);
	}
