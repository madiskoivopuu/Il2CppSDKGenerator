...
public: 
	...
	template <typename R = PushNotificationGroupData*> R& NotificationGroupData() {
	 ...
	 Action1<PushNotificationGroupData*>*& OnPushNotifficationGroupStatusChanged() {
		return *(Action1<PushNotificationGroupData*>**)((uintptr_t)this + 0x20);
	}
	template <typename R = uintptr_t> R& _toggle() {
		return *(R*)((uintptr_t)this + 0x28);
	}

	template <typename R = void> R add_OnPushNotifficationGroupStatusChanged(Action1<PushNotificationGroupData*>* value) {
		return ((R (*)(PushNotifficationGroupHelper*, Action1<PushNotificationGroupData*>*))(Il2CppBase() + 0x11BA384))(this, value);
	}
	template <typename R = void> R remove_OnPushNotifficationGroupStatusChanged(Action1<PushNotificationGroupData*>* value) {
		return ((R (*)(PushNotifficationGroupHelper*, Action1<PushNotificationGroupData*>*))(Il2CppBase() + 0x11BA424))(this, value);
	}
