...
public: 
	...
	template <typename R = ICommonContexts*> R& _world() {
	 ...
	 PrimaryEntityIndex2EventEntity*, int32_t>*& _inventoryChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int32_t>**)((uintptr_t)this + 0xD8);
	}
	 PrimaryEntityIndex2EventEntity*, int64_t>*& _questTargetChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int64_t>**)((uintptr_t)this + 0xE0);
	}
	 PrimaryEntityIndex2EventEntity*, int64_t>*& _questsChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int64_t>**)((uintptr_t)this + 0xE8);
	}
	 PrimaryEntityIndex2EventEntity*, int64_t>*& _currencyChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int64_t>**)((uintptr_t)this + 0xF0);
	}
	 PrimaryEntityIndex2EventEntity*, int64_t>*& _playerGuildChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int64_t>**)((uintptr_t)this + 0xF8);
	}
	 PrimaryEntityIndex2EventEntity*, LongLong*>*& _guildQuestChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, LongLong*>**)((uintptr_t)this + 0x100);
	}
	 PrimaryEntityIndex2EventEntity*, IntLong*>*& _vipChangedIndex() {
		return *(PrimaryEntityIndex2EventEntity*, IntLong*>**)((uintptr_t)this + 0x108);
	}
	 EntityIndex2EventEntity*, Il2CppString*>*& _waveEventItemIndex() {
		return *(EntityIndex2EventEntity*, Il2CppString*>**)((uintptr_t)this + 0x110);
	}
	 PrimaryEntityIndex2EventEntity*, IntString*>*& _changeCooldownIndex() {
		return *(PrimaryEntityIndex2EventEntity*, IntString*>**)((uintptr_t)this + 0x118);
	}
	 PrimaryEntityIndex2EventEntity*, int64_t>*& _addExpIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int64_t>**)((uintptr_t)this + 0x120);
	}
	 PrimaryEntityIndex2EventEntity*, int64_t>*& _addPetExpIndex() {
		return *(PrimaryEntityIndex2EventEntity*, int64_t>**)((uintptr_t)this + 0x128);
	}

	 HashSet1EventEntity*>* GetEntitiesWithWaveEvent(Il2CppString* eventName) {
		return ((HashSet1EventEntity*>* (*)(EventContext*, Il2CppString*))(Il2CppBase() + 0x13850A8))(this, eventName);
	}
	...
	template <typename R = void> R DestroyAll(HashSet1EventEntity*>* eventEntities) {
		return ((R (*)(EventContext*, HashSet1EventEntity*>*))(Il2CppBase() + 0x13854D4))(this, eventEntities);
	}
