...
public: 
	...
	template <typename T = ActivateTournamentComponent*> static T& activateTournamentComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = AlwaysActualComponent*> static T& alwaysActualComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = DailyComponent*> static T& dailyComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = DailyProgressComponent*> static T& dailyProgressComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = EventComponent*> static T& eventComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = ManualTrackProhibitionComponent*> static T& manualTrackProhibitionComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = NotAutoCompleteComponent*> static T& notAutoCompleteComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = OfferComponent*> static T& offerComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = ShareableComponent*> static T& shareableComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = TargetSelfComponent*> static T& targetSelfComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = TriggerBuildOwnComponent*> static T& triggerBuildOwnComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x50);
	}
	template <typename T = TriggerCraftComponent*> static T& triggerCraftComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x58);
	}
	template <typename T = TriggerDamageComponent*> static T& triggerDamageComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x60);
	}
	template <typename T = TriggerDonateComponent*> static T& triggerDonateComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x68);
	}
	template <typename T = TriggerExitComponent*> static T& triggerExitComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x70);
	}
	template <typename T = TriggerFinalizeComponent*> static T& triggerFinalizeComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x78);
	}
	template <typename T = TriggerGameEventComponent*> static T& triggerGameEventComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x80);
	}
	template <typename T = TriggerHealComponent*> static T& triggerHealComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x88);
	}
	template <typename T = TriggerKillComponent*> static T& triggerKillComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x90);
	}
	template <typename T = TriggerLevelComponent*> static T& triggerLevelComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x98);
	}
	template <typename T = TriggerOwnComponent*> static T& triggerOwnComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA0);
	}
	template <typename T = TriggerQuestCompletedComponent*> static T& triggerQuestCompletedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA8);
	}
	template <typename T = TriggerSneakComponent*> static T& triggerSneakComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xB0);
	}
	template <typename T = TriggerSneakDamageComponent*> static T& triggerSneakDamageComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xB8);
	}
	template <typename T = TriggerUnlockComponent*> static T& triggerUnlockComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xC0);
	}
	template <typename T = TriggerUpLevelCapComponent*> static T& triggerUpLevelCapComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xC8);
	}
	template <typename T = TriggerUseComponent*> static T& triggerUseComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xD0);
	}
	template <typename T = TriggerVisitComponent*> static T& triggerVisitComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xD8);
	}
	template <typename T = TriggerVisitGlobalMapComponent*> static T& triggerVisitGlobalMapComponent() {
	...
	template <typename T = ActComponent*> T get_act() {
	...
	template <typename T = void> T AddActivateNotify(NotifyType* newType, Il2CppString* newIcon, Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newSound) {
		return ((T (*)(QuestDataEntity*, NotifyType*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C1C0D8))(this, newType, newIcon, newCaption, newText, newSound);
	}
	template <typename T = void> T ReplaceActivateNotify(NotifyType* newType, Il2CppString* newIcon, Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newSound) {
		return ((T (*)(QuestDataEntity*, NotifyType*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C1C240))(this, newType, newIcon, newCaption, newText, newSound);
	}
	template <typename T = void> T RemoveActivateNotify() {
		return ((T (*)(QuestDataEntity*))(Il2CppBase() + 0x1C1C3A8))(this);
	}
	template <typename T = ActivateQuestsComponent*> T get_activateQuests() {
	...
	template <typename T = ActiveLocationsComponent*> T get_activeLocations() {
	...
	template <typename T = AlertButtonComponent*> T get_alertButton() {
	...
	template <typename T = AliveConditionComponent*> T get_aliveCondition() {
	...
	template <typename T = void> T AddAnalytics(AnalyticsTypes* newType, Il2CppString* newParam) {
		return ((T (*)(QuestDataEntity*, AnalyticsTypes*, Il2CppString*))(Il2CppBase() + 0x1C1D5B8))(this, newType, newParam);
	}
	template <typename T = void> T ReplaceAnalytics(AnalyticsTypes* newType, Il2CppString* newParam) {
		return ((T (*)(QuestDataEntity*, AnalyticsTypes*, Il2CppString*))(Il2CppBase() + 0x1C1D6D4))(this, newType, newParam);
	}
	...
	template <typename T = AutoActivateComponent*> T get_autoActivate() {
	...
	template <typename T = CompleteChatNotifyComponent*> T get_completeChatNotify() {
	...
	template <typename T = CompleteCutsceneComponent*> T get_completeCutscene() {
	...
	template <typename T = void> T AddCompleteNotify(NotifyType* newType, Il2CppString* newIcon, Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newSound) {
		return ((T (*)(QuestDataEntity*, NotifyType*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C1E8E4))(this, newType, newIcon, newCaption, newText, newSound);
	}
	template <typename T = void> T ReplaceCompleteNotify(NotifyType* newType, Il2CppString* newIcon, Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newSound) {
		return ((T (*)(QuestDataEntity*, NotifyType*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C1EA4C))(this, newType, newIcon, newCaption, newText, newSound);
	}
	...
	template <typename T = DestroyOnRewardedComponent*> T get_destroyOnRewarded() {
	...
	template <typename T = FailNotifyComponent*> T get_failNotify() {
	...
	template <typename T = void> T AddFailNotify(NotifyType* newType, Il2CppString* newIcon, Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newSound) {
		return ((T (*)(QuestDataEntity*, NotifyType*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C1F800))(this, newType, newIcon, newCaption, newText, newSound);
	}
	template <typename T = void> T ReplaceFailNotify(NotifyType* newType, Il2CppString* newIcon, Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newSound) {
		return ((T (*)(QuestDataEntity*, NotifyType*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C1F968))(this, newType, newIcon, newCaption, newText, newSound);
	}
	template <typename T = void> T RemoveFailNotify() {
		return ((T (*)(QuestDataEntity*))(Il2CppBase() + 0x1C1FAD0))(this);
	}
	template <typename T = FinishOnCompletedComponent*> T get_finishOnCompleted() {
	...
	template <typename T = GetRewardQuestComponent*> T get_getRewardQuest() {
	...
	template <typename T = GuildQuestDescriptionComponent*> T get_guildQuestDescription() {
	...
	template <typename T = void> T AddGuildQuestDescription(GuildQuestDifficulty* newDifficulty, int32_t newMinGuildRankPoints, int32_t newMaxGuildRankPoints, Il2CppArray<uintptr_t>* newPlayerRewards) {
		return ((T (*)(QuestDataEntity*, GuildQuestDifficulty*, int32_t, int32_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1C203C8))(this, newDifficulty, newMinGuildRankPoints, newMaxGuildRankPoints, newPlayerRewards);
	}
	template <typename T = void> T ReplaceGuildQuestDescription(GuildQuestDifficulty* newDifficulty, int32_t newMinGuildRankPoints, int32_t newMaxGuildRankPoints, Il2CppArray<uintptr_t>* newPlayerRewards) {
		return ((T (*)(QuestDataEntity*, GuildQuestDifficulty*, int32_t, int32_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1C204F8))(this, newDifficulty, newMinGuildRankPoints, newMaxGuildRankPoints, newPlayerRewards);
	}
	...
	template <typename T = void> T AddItemCondition(bool newOrEmpty, Il2CppString* newName, Il2CppString* newTag, Il2CppArray<uintptr_t>* newAnyTags, Il2CppString* newNoTag, EquipmentType* newEquipmentType) {
		return ((T (*)(QuestDataEntity*, bool, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, EquipmentType*))(Il2CppBase() + 0x1C20CE0))(this, newOrEmpty, newName, newTag, newAnyTags, newNoTag, newEquipmentType);
	}
	template <typename T = void> T ReplaceItemCondition(bool newOrEmpty, Il2CppString* newName, Il2CppString* newTag, Il2CppArray<uintptr_t>* newAnyTags, Il2CppString* newNoTag, EquipmentType* newEquipmentType) {
		return ((T (*)(QuestDataEntity*, bool, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, EquipmentType*))(Il2CppBase() + 0x1C20E54))(this, newOrEmpty, newName, newTag, newAnyTags, newNoTag, newEquipmentType);
	}
	template <typename T = void> T RemoveItemCondition() {
		return ((T (*)(QuestDataEntity*))(Il2CppBase() + 0x1C20FC8))(this);
	}
	template <typename T = MagicsComponent*> T get_magics() {
	...
	template <typename T = MaxProgressComponent*> T get_maxProgress() {
	...
	template <typename T = MultiplierByConditionComponent*> T get_multiplierByCondition() {
	...
	template <typename T = MultiplierTagsComponent*> T get_multiplierTags() {
	...
	template <typename T = NoSaveableComponent*> T get_noSaveable() {
	...
	template <typename T = void> T AddOnCompletedActorMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(QuestDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1C22420))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceOnCompletedActorMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(QuestDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1C22588))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	...
	template <typename T = PortalQuestComponent*> T get_portalQuest() {
	...
	template <typename T = void> T AddPortalQuest(PortalQuestType* newType) {
		return ((T (*)(QuestDataEntity*, PortalQuestType*))(Il2CppBase() + 0x1C233A0))(this, newType);
	}
	template <typename T = void> T ReplacePortalQuest(PortalQuestType* newType) {
		return ((T (*)(QuestDataEntity*, PortalQuestType*))(Il2CppBase() + 0x1C234A4))(this, newType);
	}
	...
	template <typename T = void> T AddPositionTransaction(Ease* newEase, float newDuration, int64_t newStartTime, Vec2* newStartPosition, Vec2* newEndPosition) {
		return ((T (*)(QuestDataEntity*, Ease*, float, int64_t, Vec2*, Vec2*))(Il2CppBase() + 0x1C23648))(this, newEase, newDuration, newStartTime, newStartPosition, newEndPosition);
	}
	template <typename T = void> T ReplacePositionTransaction(Ease* newEase, float newDuration, int64_t newStartTime, Vec2* newStartPosition, Vec2* newEndPosition) {
		return ((T (*)(QuestDataEntity*, Ease*, float, int64_t, Vec2*, Vec2*))(Il2CppBase() + 0x1C2378C))(this, newEase, newDuration, newStartTime, newStartPosition, newEndPosition);
	}
	template <typename T = void> T RemovePositionTransaction() {
		return ((T (*)(QuestDataEntity*))(Il2CppBase() + 0x1C238D0))(this);
	}
	template <typename T = ProgressNotifyComponent*> T get_progressNotify() {
	...
	template <typename T = RewardByTimeComponent*> T get_rewardByTime() {
	...
	template <typename T = RewardComponent*> T get_reward() {
	...
	template <typename T = void> T AddReward(bool newAutomatic, bool newSendToMailOnEndTime, RewardRules* newRule, Il2CppArray<uintptr_t>* newResources, Il2CppArray<uintptr_t>* newPremiumResources, Il2CppArray<uintptr_t>* newMainServerResources, Il2CppString* newRandomGroup, Il2CppString* newPremiumRandomGroup) {
		return ((T (*)(QuestDataEntity*, bool, bool, RewardRules*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C24200))(this, newAutomatic, newSendToMailOnEndTime, newRule, newResources, newPremiumResources, newMainServerResources, newRandomGroup, newPremiumRandomGroup);
	}
	template <typename T = void> T ReplaceReward(bool newAutomatic, bool newSendToMailOnEndTime, RewardRules* newRule, Il2CppArray<uintptr_t>* newResources, Il2CppArray<uintptr_t>* newPremiumResources, Il2CppArray<uintptr_t>* newMainServerResources, Il2CppString* newRandomGroup, Il2CppString* newPremiumRandomGroup) {
		return ((T (*)(QuestDataEntity*, bool, bool, RewardRules*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1C2439C))(this, newAutomatic, newSendToMailOnEndTime, newRule, newResources, newPremiumResources, newMainServerResources, newRandomGroup, newPremiumRandomGroup);
	}
	...
	template <typename T = SkipPriceComponent*> T get_skipPrice() {
	...
	template <typename T = TargetMarkerComponent*> T get_targetMarker() {
	...
	template <typename T = TrackingSettingComponent*> T get_trackingSetting() {
	...
	template <typename T = void> T AddTrackingSetting(TrackingSlot* newSlot, bool newZeroOne, bool newWithoutMaxProgress, float newWeight, Il2CppString* newIcon) {
		return ((T (*)(QuestDataEntity*, TrackingSlot*, bool, bool, float, Il2CppString*))(Il2CppBase() + 0x1C25740))(this, newSlot, newZeroOne, newWithoutMaxProgress, newWeight, newIcon);
	}
	template <typename T = void> T ReplaceTrackingSetting(TrackingSlot* newSlot, bool newZeroOne, bool newWithoutMaxProgress, float newWeight, Il2CppString* newIcon) {
		return ((T (*)(QuestDataEntity*, TrackingSlot*, bool, bool, float, Il2CppString*))(Il2CppBase() + 0x1C2588C))(this, newSlot, newZeroOne, newWithoutMaxProgress, newWeight, newIcon);
	}
	template <typename T = void> T RemoveTrackingSetting() {
		return ((T (*)(QuestDataEntity*))(Il2CppBase() + 0x1C259D8))(this);
	}
	template <typename T = TriggerBuildComponent*> T get_triggerBuild() {
	...
	template <typename T = TriggerCurrencyComponent*> T get_triggerCurrency() {
	...
	template <typename T = void> T AddTriggerCurrency(CurrencyType* newType, bool newSpending) {
		return ((T (*)(QuestDataEntity*, CurrencyType*, bool))(Il2CppBase() + 0x1C25F70))(this, newType, newSpending);
	}
	template <typename T = void> T ReplaceTriggerCurrency(CurrencyType* newType, bool newSpending) {
		return ((T (*)(QuestDataEntity*, CurrencyType*, bool))(Il2CppBase() + 0x1C26080))(this, newType, newSpending);
	}
	...
	template <typename T = TriggerDeathComponent*> T get_triggerDeath() {
	...
	template <typename T = TriggerDistrictLevelComponent*> T get_triggerDistrictLevel() {
	...
	template <typename T = TriggerExtractComponent*> T get_triggerExtract() {
	...
	template <typename T = void> T AddTriggerExtract(RequestType* newType) {
		return ((T (*)(QuestDataEntity*, RequestType*))(Il2CppBase() + 0x1C26B14))(this, newType);
	}
	template <typename T = void> T ReplaceTriggerExtract(RequestType* newType) {
		return ((T (*)(QuestDataEntity*, RequestType*))(Il2CppBase() + 0x1C26C18))(this, newType);
	}
	...
	template <typename T = TriggerPickupComponent*> T get_triggerPickup() {
	...
	template <typename T = TriggerPlayerClassProgressComponent*> T get_triggerPlayerClassProgress() {
	...
	template <typename T = void> T AddTriggerPlayerClassProgress(PlayerClassProgress* newType) {
		return ((T (*)(QuestDataEntity*, PlayerClassProgress*))(Il2CppBase() + 0x1C27738))(this, newType);
	}
	template <typename T = void> T ReplaceTriggerPlayerClassProgress(PlayerClassProgress* newType) {
		return ((T (*)(QuestDataEntity*, PlayerClassProgress*))(Il2CppBase() + 0x1C2783C))(this, newType);
	}
	...
	template <typename T = TriggerSeasonEndComponent*> T get_triggerSeasonEnd() {
	...
	template <typename T = TriggerSeasonLevelComponent*> T get_triggerSeasonLevel() {
	...
	template <typename T = void> T AddWorldStatus(WorldStatusType* newType) {
		return ((T (*)(QuestDataEntity*, WorldStatusType*))(Il2CppBase() + 0x1C28868))(this, newType);
	}
	template <typename T = void> T ReplaceWorldStatus(WorldStatusType* newType) {
		return ((T (*)(QuestDataEntity*, WorldStatusType*))(Il2CppBase() + 0x1C2896C))(this, newType);
	}
