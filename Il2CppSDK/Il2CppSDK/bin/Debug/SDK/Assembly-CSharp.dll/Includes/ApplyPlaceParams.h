...
public: 
	...
	template <typename T = uintptr_t> T& SpawnerSource() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = uintptr_t> T& CenterSource() {
		return *(T*)((uintptr_t)this + 0x19);
	}
	template <typename T = uintptr_t> T& RotationSource() {
		return *(T*)((uintptr_t)this + 0x1A);
	}
	template <typename T = uintptr_t> T& MoveToSource() {
		return *(T*)((uintptr_t)this + 0x1B);
	}
	template <typename T = uintptr_t> T& WeaponSource() {
		return *(T*)((uintptr_t)this + 0x1C);
	}
	template <typename T = uintptr_t> T& BindTo() {
	...
	template <typename T = uintptr_t> static T& DefaultForAction() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& DefaultForMagic() {
