...
public: 
	...
	template <typename T = FavouriteComponent*> static T& favouriteComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = MuteComponent*> static T& muteComponent() {
	...
	template <typename T = ContactOnlineComponent*> T get_contactOnline() {
	...
	template <typename T = ContactViewComponent*> T get_contactView() {
	...
	template <typename T = void> T AddContactView(ChatContactView* newView) {
		return ((T (*)(ContactsEntity*, ChatContactView*))(Il2CppBase() + 0x15ED6EC))(this, newView);
	}
	template <typename T = void> T ReplaceContactView(ChatContactView* newView) {
		return ((T (*)(ContactsEntity*, ChatContactView*))(Il2CppBase() + 0x15ED800))(this, newView);
	}
	...
	template <typename T = Groups*> T get_groups() {
	...
	template <typename T = JidComponent*> T get_jid() {
	...
	template <typename T = LastOpenedChatComponent*> T get_lastOpenedChat() {
	...
	template <typename T = SubscriptionComponent*> T get_subscription() {
