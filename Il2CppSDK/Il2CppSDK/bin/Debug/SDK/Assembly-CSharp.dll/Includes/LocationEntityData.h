...
public: 
	...
	template <typename T = EntityBlueprint*> T& Blueprint() {
	...
	template <typename T = Nullable1int64_t>*> T& TicksTillReset() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = LocationType*> T& Type() {
		return *(T*)((uintptr_t)this + 0x58);
	}
	template <typename T = PortalsInfoData*> T& PortalData() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = GeneratorParams*> T& GeneratorParams() {
