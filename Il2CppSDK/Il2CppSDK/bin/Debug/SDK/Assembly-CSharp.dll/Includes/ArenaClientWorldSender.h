...
public: 
	...
	template <typename R = void> static R SendDeleteInventory(ICommonClientWorld* world, int32_t id, Nullable1int32_t>* count) {
		return ((R (*)(void *, ICommonClientWorld*, int32_t, Nullable1int32_t>*))(Il2CppBase() + 0x1A278E4))(0, world, id, count);
	}
	...
	template <typename R = void> static R SendCheatAddResource(ICommonClientWorld* world, Il2CppString* resourceName, int32_t count, Nullable1float>* durability) {
		return ((R (*)(void *, ICommonClientWorld*, Il2CppString*, int32_t, Nullable1float>*))(Il2CppBase() + 0x1A287C8))(0, world, resourceName, count, durability);
	}
	...
	template <typename R = void> static R SendToMailCheat(ICommonClientWorld* world, Il2CppString* resourceName, int32_t count, Nullable1float>* durability) {
		return ((R (*)(void *, ICommonClientWorld*, Il2CppString*, int32_t, Nullable1float>*))(Il2CppBase() + 0x1A287D0))(0, world, resourceName, count, durability);
	}
