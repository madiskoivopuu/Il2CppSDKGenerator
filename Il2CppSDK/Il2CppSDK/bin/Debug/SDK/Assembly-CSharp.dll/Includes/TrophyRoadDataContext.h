...
class TrophyRoadDataContext: DataContext1
{
public: 
	...
	template <typename T = uintptr_t> T& _questsData() {
	...
	template <typename T = uintptr_t> T get_Item(int32_t level) {
		return ((T (*)(TrophyRoadDataContext*, int32_t))(Il2CppBase() + 0x10156C0))(this, level);
	}
	template <typename T = uintptr_t> T get_Item_1(uintptr_t entity) {
		return ((T (*)(TrophyRoadDataContext*, uintptr_t))(Il2CppBase() + 0x1015820))(this, entity);
	}
	template <typename T = void> T AddEntityIndexes() {
		return ((T (*)(TrophyRoadDataContext*))(Il2CppBase() + 0x1015B80))(this);
	}
	template <typename T = uintptr_t> T GetEntityWithRequiredLevel(int32_t level) {
		return ((T (*)(TrophyRoadDataContext*, int32_t))(Il2CppBase() + 0x1015744))(this, level);
	}
	template <typename T = uintptr_t> T GetEntityWithRecipe(Il2CppString* recipe) {
	...
	template <typename T = void*> T GetEntitiesWithUniqueLookup(Il2CppString* uniqueLookup) {
	...
	template <typename T = void> T Fill(Il2CppDictionary<Il2CppString*, uintptr_t>* blueprints) {
		return ((T (*)(TrophyRoadDataContext*, Il2CppDictionary<Il2CppString*, uintptr_t>*))(Il2CppBase() + 0x1016840))(this, blueprints);
	}
