...
public: 
	...
	template <typename R = Il2CppString*> R GetCurrentQuestName(int32_t level, bool canBuild) {
	 ...
	 HashSet1<TrophyRoadEntity*>* GetEntitiesWithUniqueLookup(Il2CppString* uniqueLookup) {
		return ((HashSet1<TrophyRoadEntity*>* (*)(TrophyRoadDataContext*, Il2CppString*))(Il2CppBase() + 0x1016780))(this, uniqueLookup);
	}
