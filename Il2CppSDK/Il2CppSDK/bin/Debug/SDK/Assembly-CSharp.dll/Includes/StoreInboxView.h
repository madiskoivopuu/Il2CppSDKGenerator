...
public: 
	...
	template <typename T = StandartButton*> T& ClaimButton() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = StandartButton*> T& OpenButton() {
		return *(T*)((uintptr_t)this + 0x68);
	}
	template <typename T = StandartButton*> T& ReadButton() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = int64_t> T& _messageId() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = Action2int64_t, Action1Il2CppString*>*>*> T& _onOpenButtonClick() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = Action1int64_t>*> T& _onExpired() {
	...
	template <typename T = void> T Init(int64_t messageId, Action2int64_t, Action1Il2CppString*>*>* onOpenButtonClick, Action1int64_t>* onExpired, TooltipView* tooltip) {
		return ((T (*)(StoreInboxView*, int64_t, Action2int64_t, Action1Il2CppString*>*>*, Action1int64_t>*, TooltipView*))(Il2CppBase() + 0x14239E8))(this, messageId, onOpenButtonClick, onExpired, tooltip);
	}
	...
	template <typename T = void> T OnError(StandartButton* btn, Il2CppString* error) {
		return ((T (*)(StoreInboxView*, StandartButton*, Il2CppString*))(Il2CppBase() + 0x14248E8))(this, btn, error);
	}
