...
public: 
	...
	template <typename R = int64_t> R& _messageId() {
	 ...
	 Action2int64_t, Action1Il2CppString*>*>*& _onOpenButtonClick() {
		return *(Action2int64_t, Action1Il2CppString*>*>**)((uintptr_t)this + 0x80);
	}
	 Action1int64_t>*& _onExpired() {
		return *(Action1int64_t>**)((uintptr_t)this + 0x88);
	}
	...
	template <typename R = void> R Init(int64_t messageId, Action2int64_t, Action1Il2CppString*>*>* onOpenButtonClick, Action1int64_t>* onExpired, TooltipView* tooltip) {
		return ((R (*)(StoreInboxView*, int64_t, Action2int64_t, Action1Il2CppString*>*>*, Action1int64_t>*, TooltipView*))(Il2CppBase() + 0x14239E8))(this, messageId, onOpenButtonClick, onExpired, tooltip);
	}
