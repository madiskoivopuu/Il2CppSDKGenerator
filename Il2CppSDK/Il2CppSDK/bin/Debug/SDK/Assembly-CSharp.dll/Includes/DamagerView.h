...
public: 
	...
	template <typename T = ItemView*> T& _headSlot() {
		return *(T*)((uintptr_t)this + 0x68);
	}
	template <typename T = ItemView*> T& _chestSlot() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = ItemView*> T& _legsSlot() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = ItemView*> T& _feetSlot() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = ItemView*> T& _weaponSlot() {
		return *(T*)((uintptr_t)this + 0x88);
	}
	template <typename T = ItemView*> T& _backPackSlot() {
		return *(T*)((uintptr_t)this + 0x90);
	}
	template <typename T = ItemView*> T& _pocket1Slot() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = ItemView*> T& _pocket2Slot() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = ItemView*> T& _charmSlot() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = ItemView*> T& _classSlot() {
		return *(T*)((uintptr_t)this + 0xB0);
	}
	template <typename T = ItemView*> T& _petSlot() {
		return *(T*)((uintptr_t)this + 0xB8);
	}

	template <typename T = void> T Init(TooltipView* tooltip) {
		return ((T (*)(DamagerView*, TooltipView*))(Il2CppBase() + 0x164D8F0))(this, tooltip);
	}
	template <typename T = void> T Show(DamagerStat* damager) {
		return ((T (*)(DamagerView*, DamagerStat*))(Il2CppBase() + 0x164DA60))(this, damager);
	}
