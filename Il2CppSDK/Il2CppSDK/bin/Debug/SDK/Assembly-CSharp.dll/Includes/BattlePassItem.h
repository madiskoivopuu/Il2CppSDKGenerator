...
public: 
	...
	template <typename T = void> T add_OnClaimed(void* value) {
		return ((T (*)(BattlePassItem*, void*))(Il2CppBase() + 0x1679D38))(this, value);
	}
	template <typename T = void> T remove_OnClaimed(void* value) {
		return ((T (*)(BattlePassItem*, void*))(Il2CppBase() + 0x1679DD8))(this, value);
	}
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t item) {
		return ((T (*)(BattlePassItem*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1679534))(this, window, item);
	}
	template <typename T = void> T UpdateStepView(uintptr_t item) {
		return ((T (*)(BattlePassItem*, uintptr_t))(Il2CppBase() + 0x167A778))(this, item);
	}
	...
	template <typename T = void*> T GetRewardsCount() {
