...
public: 
	...
	template <typename R = bool> R& _isSpecialStep() {
	 ...
	 Action4Il2CppString*, Il2CppString*, int32_t, bool>*& OnClaimed() {
		return *(Action4Il2CppString*, Il2CppString*, int32_t, bool>**)((uintptr_t)this + 0xA0);
	}
	...
	template <typename R = void> R add_OnClaimed(Action4Il2CppString*, Il2CppString*, int32_t, bool>* value) {
		return ((R (*)(BattlePassItem*, Action4Il2CppString*, Il2CppString*, int32_t, bool>*))(Il2CppBase() + 0x1679D38))(this, value);
	}
	template <typename R = void> R remove_OnClaimed(Action4Il2CppString*, Il2CppString*, int32_t, bool>* value) {
		return ((R (*)(BattlePassItem*, Action4Il2CppString*, Il2CppString*, int32_t, bool>*))(Il2CppBase() + 0x1679DD8))(this, value);
	}
	...
	template <typename R = void> R UpdateReward(Il2CppArray<RewardResourceView*>* itemView, Il2CppArray<Resource*>* rewards, bool isPremium, bool isInit, Il2CppArray<MainServerRewardType*>* legendaryRewards) {
	 ...
	 ValueTuple3int32_t, bool, bool>* GetRewardsCount() {
		return ((ValueTuple3int32_t, bool, bool>* (*)(BattlePassItem*))(Il2CppBase() + 0x167AA08))(this);
	}
