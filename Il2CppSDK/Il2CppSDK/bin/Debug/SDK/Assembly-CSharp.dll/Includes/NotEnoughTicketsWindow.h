...
public: 
	...
	template <typename R = void> R OnShow() {
	 ...
	 ValueTuple2int32_t, Store2DataEntity*>* OnShowg__getBestStoreProduct|8_0(Il2CppList<Store2DataEntity*>* list) {
		return ((ValueTuple2int32_t, Store2DataEntity*>* (*)(NotEnoughTicketsWindow*, Il2CppList<Store2DataEntity*>*))(Il2CppBase() + 0x13B53C8))(this, list);
	}
