...
public: 
	...
	template <typename R = void> R Bind(MapUnityWorld* world, Action1GameEntity*>* onClick) {
		return ((R (*)(MapArrow*, MapUnityWorld*, Action1GameEntity*>*))(Il2CppBase() + 0x1267744))(this, world, onClick);
	}
