...
public: 
	...
	template <typename T = HashSet1BlueprintEntity*>*> T GetEntitiesWithCraft(Il2CppString* type) {
		return ((T (*)(BlueprintDataContext*, Il2CppString*))(Il2CppBase() + 0x16BD658))(this, type);
	}
	template <typename T = HashSet1BlueprintEntity*>*> T GetEntitiesWithCraft_1(Il2CppString* type, int32_t maxSlots) {
