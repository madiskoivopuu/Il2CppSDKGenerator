...
public: 
	...
	template <typename R = void> R ShowView(Il2CppString* prefabName, ProtoModels::WorldResourcesType resourceType, Nullable1<float>* angle) {
		return ((R (*)(PuppetRendererController*, Il2CppString*, ProtoModels::WorldResourcesType, Nullable1<float>*))(Il2CppBase() + 0x11B5F88))(this, prefabName, resourceType, angle);
	}
