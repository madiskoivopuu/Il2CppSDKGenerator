...
public: 
	...
	template <typename T = PuppetCameraController*> T& PuppetCamera() {
	...
	template <typename T = GameEntity*> T& PuppetEntity() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = GameEntity*> T& PuppetCameraEntity() {
	...
	template <typename T = PuppetCameraController*> T get_PuppetCamera() {
		return ((T (*)(PuppetRendererController*))(Il2CppBase() + 0x11B28AC))(this);
	}
	template <typename T = void> T set_PuppetCamera(PuppetCameraController* value) {
		return ((T (*)(PuppetRendererController*, PuppetCameraController*))(Il2CppBase() + 0x11B28B4))(this, value);
	}
	template <typename T = GameEntity*> T get_PuppetEntity() {
		return ((T (*)(PuppetRendererController*))(Il2CppBase() + 0x11B28BC))(this);
	}
	template <typename T = void> T set_PuppetEntity(GameEntity* value) {
		return ((T (*)(PuppetRendererController*, GameEntity*))(Il2CppBase() + 0x11B28C4))(this, value);
	}
	template <typename T = GameEntity*> T get_PuppetCameraEntity() {
		return ((T (*)(PuppetRendererController*))(Il2CppBase() + 0x11B28CC))(this);
	}
	template <typename T = void> T set_PuppetCameraEntity(GameEntity* value) {
		return ((T (*)(PuppetRendererController*, GameEntity*))(Il2CppBase() + 0x11B28D4))(this, value);
	}
	...
	template <typename T = void> T ShowPuppetPlayer(GameEntity* player, Il2CppString* lookup) {
		return ((T (*)(PuppetRendererController*, GameEntity*, Il2CppString*))(Il2CppBase() + 0x11B36D8))(this, player, lookup);
	}
	template <typename T = void> T ShowCurrentPuppet() {
		return ((T (*)(PuppetRendererController*))(Il2CppBase() + 0x11B3FF4))(this);
	}
	template <typename T = void> T ShowPuppetMount(GameEntity* player, ItemEntity* mount) {
		return ((T (*)(PuppetRendererController*, GameEntity*, ItemEntity*))(Il2CppBase() + 0x11B41F4))(this, player, mount);
	}
	template <typename T = void> T ShowPuppetPet(GameEntity* player, ItemEntity* pet) {
		return ((T (*)(PuppetRendererController*, GameEntity*, ItemEntity*))(Il2CppBase() + 0x11B4A78))(this, player, pet);
	}
	template <typename T = void> T ShowPuppetTrophy(GameEntity* target, ItemEntity* trophyItem) {
		return ((T (*)(PuppetRendererController*, GameEntity*, ItemEntity*))(Il2CppBase() + 0x11B527C))(this, target, trophyItem);
	}
	...
	template <typename T = void> T ShowPreviewPrefab(ItemEntity* item) {
		return ((T (*)(PuppetRendererController*, ItemEntity*))(Il2CppBase() + 0x11B627C))(this, item);
	}
	template <typename T = void> T ShowView(Il2CppString* prefabName, WorldResourcesType* resourceType, Nullable1float>* angle) {
		return ((T (*)(PuppetRendererController*, Il2CppString*, WorldResourcesType*, Nullable1float>*))(Il2CppBase() + 0x11B5F88))(this, prefabName, resourceType, angle);
	}
	...
	template <typename T = uintptr_t> T TryCreateView(Il2CppString* prefabName, WorldResourcesType* resourceType) {
		return ((T (*)(PuppetRendererController*, Il2CppString*, WorldResourcesType*))(Il2CppBase() + 0x11B62E8))(this, prefabName, resourceType);
	}
	...
	template <typename T = void> static T ChageRenderByClass(GameEntity* puppetEntity, Il2CppString* className) {
		return ((T (*)(void *, GameEntity*, Il2CppString*))(Il2CppBase() + 0x11B1D98))(0, puppetEntity, className);
	}
