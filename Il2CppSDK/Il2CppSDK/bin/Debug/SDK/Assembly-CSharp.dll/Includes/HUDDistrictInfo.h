...
public: 
	...
	template <typename T = uintptr_t> T& _districtNameText() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = uintptr_t> T& _districtOwnerText() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = void*> T& _districtOwnerId() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = void*> T& _districtLevel() {
		return *(T*)((uintptr_t)this + 0x58);
	}

	template <typename T = bool> T UpdateView(uintptr_t accountEntity, uintptr_t location) {
		return ((T (*)(HUDDistrictInfo*, uintptr_t, uintptr_t))(Il2CppBase() + 0x14516B4))(this, accountEntity, location);
	}
