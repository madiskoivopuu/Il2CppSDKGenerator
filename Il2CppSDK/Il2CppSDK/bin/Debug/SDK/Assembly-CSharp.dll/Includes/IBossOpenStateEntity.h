...
public: 
	...
	template <typename T = void> T AddBossOpenState(int32_t newOpenPortalProgress, bool newIsPortalOpen, Il2CppString* newCurrentOpenBoss, Il2CppList<uintptr_t>* newStates) {
		return ((T (*)(IBossOpenStateEntity*, int32_t, bool, Il2CppString*, Il2CppList<uintptr_t>*))(Il2CppBase() + 0x0))(this, newOpenPortalProgress, newIsPortalOpen, newCurrentOpenBoss, newStates);
	}
