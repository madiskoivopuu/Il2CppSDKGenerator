...
public: 
	...
	template <typename R = Il2CppArray<ItemDamageStatView*>*> R& _items() {
	 ...
	 Action1DamagerStatView*>*& ClickEvent() {
		return *(Action1DamagerStatView*>**)((uintptr_t)this + 0x58);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1DamagerStatView*>* value) {
		return ((R (*)(DamagerStatView*, Action1DamagerStatView*>*))(Il2CppBase() + 0x164CAD4))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1DamagerStatView*>* value) {
		return ((R (*)(DamagerStatView*, Action1DamagerStatView*>*))(Il2CppBase() + 0x164CB74))(this, value);
	}
