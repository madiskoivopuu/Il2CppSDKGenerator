...
public: 
	...
	template <typename T = Action1DamagerStatView*>*> T& ClickEvent() {
	...
	template <typename T = void> T add_ClickEvent(Action1DamagerStatView*>* value) {
		return ((T (*)(DamagerStatView*, Action1DamagerStatView*>*))(Il2CppBase() + 0x164CAD4))(this, value);
	}
	template <typename T = void> T remove_ClickEvent(Action1DamagerStatView*>* value) {
		return ((T (*)(DamagerStatView*, Action1DamagerStatView*>*))(Il2CppBase() + 0x164CB74))(this, value);
	}
	...
	template <typename T = void> T set_TooltipView(TooltipView* value) {
		return ((T (*)(DamagerStatView*, TooltipView*))(Il2CppBase() + 0x164CC1C))(this, value);
	}
	...
	template <typename T = void> T Show(Il2CppString* key, DamagerStat* damagerStat) {
		return ((T (*)(DamagerStatView*, Il2CppString*, DamagerStat*))(Il2CppBase() + 0x164CCD0))(this, key, damagerStat);
	}
