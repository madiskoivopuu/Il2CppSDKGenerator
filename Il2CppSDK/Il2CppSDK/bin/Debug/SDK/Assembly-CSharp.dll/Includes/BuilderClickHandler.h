...
public: 
	...
	template <typename R = bool> R& _wasDragged() {
	 ...
	 Action1<uintptr_t>*& OnClick() {
		return *(Action1<uintptr_t>**)((uintptr_t)this + 0x28);
	}

	template <typename R = void> R add_OnClick(Action1<uintptr_t>* value) {
		return ((R (*)(BuilderClickHandler*, Action1<uintptr_t>*))(Il2CppBase() + 0x15A731C))(this, value);
	}
	template <typename R = void> R remove_OnClick(Action1<uintptr_t>* value) {
		return ((R (*)(BuilderClickHandler*, Action1<uintptr_t>*))(Il2CppBase() + 0x15A73BC))(this, value);
	}
