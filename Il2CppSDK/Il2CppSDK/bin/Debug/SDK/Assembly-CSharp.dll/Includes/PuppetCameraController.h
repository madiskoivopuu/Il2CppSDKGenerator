...
public: 
	...
	template <typename T = Il2CppVector3> T& _defaultCameraRotation() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = Il2CppQuaternion> T& _defaultRotation() {
		return *(T*)((uintptr_t)this + 0x3C);
	}
	template <typename T = void*> T& _destenitionRotation() {
