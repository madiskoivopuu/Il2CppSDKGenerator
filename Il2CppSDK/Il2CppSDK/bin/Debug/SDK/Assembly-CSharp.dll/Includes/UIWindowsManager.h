...
public: 
	...
	template <typename R = void> R add_ShowWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindowsManager*, Action1<IUIWindow*>*))(Il2CppBase() + 0x1533644))(this, value);
	}
	template <typename R = void> R remove_ShowWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindowsManager*, Action1<IUIWindow*>*))(Il2CppBase() + 0x15336E4))(this, value);
	}
	template <typename R = void> R add_CloseWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindowsManager*, Action1<IUIWindow*>*))(Il2CppBase() + 0x1533784))(this, value);
	}
	template <typename R = void> R remove_CloseWindowEvent(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindowsManager*, Action1<IUIWindow*>*))(Il2CppBase() + 0x1533824))(this, value);
	}
	...
	template <typename R = IUIWindowsLayer*> R GetLayer(UIWindowsLayerType type) {
	 ...
	 IEnumerable1<IUIWindowsLayer*>* GetLayers() {
		return ((IEnumerable1<IUIWindowsLayer*>* (*)(UIWindowsManager*))(Il2CppBase() + 0x15340A4))(this);
	}
