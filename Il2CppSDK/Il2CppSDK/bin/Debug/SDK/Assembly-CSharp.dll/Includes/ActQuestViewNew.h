...
public: 
	...
	template <typename R = Il2CppString*> R& QuestName() {
	 ...
	 Action1ActQuestViewNew*>*& EventTrackingClick() {
		return *(Action1ActQuestViewNew*>**)((uintptr_t)this + 0x148);
	}
	 Action1ActQuestViewNew*>*& EventClaimClick() {
		return *(Action1ActQuestViewNew*>**)((uintptr_t)this + 0x150);
	}
	 Action1ActQuestViewNew*>*& EventSkipClick() {
		return *(Action1ActQuestViewNew*>**)((uintptr_t)this + 0x158);
	}
	 Func2QuestEntity*, ValueTuple2bool, bool>*>*& trackStatusGetter() {
		return *(Func2QuestEntity*, ValueTuple2bool, bool>*>**)((uintptr_t)this + 0x160);
	}
	...
	template <typename R = void> R add_EventTrackingClick(Action1ActQuestViewNew*>* value) {
		return ((R (*)(ActQuestViewNew*, Action1ActQuestViewNew*>*))(Il2CppBase() + 0x18E7AA4))(this, value);
	}
	template <typename R = void> R remove_EventTrackingClick(Action1ActQuestViewNew*>* value) {
		return ((R (*)(ActQuestViewNew*, Action1ActQuestViewNew*>*))(Il2CppBase() + 0x18E7D18))(this, value);
	}
	template <typename R = void> R add_EventClaimClick(Action1ActQuestViewNew*>* value) {
		return ((R (*)(ActQuestViewNew*, Action1ActQuestViewNew*>*))(Il2CppBase() + 0x18E7A00))(this, value);
	}
	template <typename R = void> R remove_EventClaimClick(Action1ActQuestViewNew*>* value) {
		return ((R (*)(ActQuestViewNew*, Action1ActQuestViewNew*>*))(Il2CppBase() + 0x18E7C74))(this, value);
	}
	template <typename R = void> R add_EventSkipClick(Action1ActQuestViewNew*>* value) {
		return ((R (*)(ActQuestViewNew*, Action1ActQuestViewNew*>*))(Il2CppBase() + 0x18EE394))(this, value);
	}
	template <typename R = void> R remove_EventSkipClick(Action1ActQuestViewNew*>* value) {
		return ((R (*)(ActQuestViewNew*, Action1ActQuestViewNew*>*))(Il2CppBase() + 0x18EE438))(this, value);
	}
	...
	template <typename R = void> R Init(QuestDataEntity* questData, Func2QuestEntity*, ValueTuple2bool, bool>*>* trackStatusGetter) {
		return ((R (*)(ActQuestViewNew*, QuestDataEntity*, Func2QuestEntity*, ValueTuple2bool, bool>*>*))(Il2CppBase() + 0x18E9114))(this, questData, trackStatusGetter);
	}
	template <typename R = void> R UpdateTrackBox(bool canBeChanged, bool manualTrackingEnabled, ValueTuple2bool, bool>* tuple) {
		return ((R (*)(ActQuestViewNew*, bool, bool, ValueTuple2bool, bool>*))(Il2CppBase() + 0x18F1490))(this, canBeChanged, manualTrackingEnabled, tuple);
	}
