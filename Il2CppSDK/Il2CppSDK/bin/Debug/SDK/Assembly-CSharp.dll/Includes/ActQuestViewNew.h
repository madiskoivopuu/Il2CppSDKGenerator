...
public: 
	...
	template <typename T = uintptr_t> T& _trackBox() {
	...
	template <typename T = void*> T& trackStatusGetter() {
	...
	template <typename T = void> T set_TooltipView(uintptr_t value) {
		return ((T (*)(ActQuestViewNew*, uintptr_t))(Il2CppBase() + 0x18EE32C))(this, value);
	}
	...
	template <typename T = void> T set_QuestData(uintptr_t value) {
		return ((T (*)(ActQuestViewNew*, uintptr_t))(Il2CppBase() + 0x18EE344))(this, value);
	}
	...
	template <typename T = void> T add_EventTrackingClick(void* value) {
		return ((T (*)(ActQuestViewNew*, void*))(Il2CppBase() + 0x18E7AA4))(this, value);
	}
	template <typename T = void> T remove_EventTrackingClick(void* value) {
		return ((T (*)(ActQuestViewNew*, void*))(Il2CppBase() + 0x18E7D18))(this, value);
	}
	template <typename T = void> T add_EventClaimClick(void* value) {
		return ((T (*)(ActQuestViewNew*, void*))(Il2CppBase() + 0x18E7A00))(this, value);
	}
	template <typename T = void> T remove_EventClaimClick(void* value) {
		return ((T (*)(ActQuestViewNew*, void*))(Il2CppBase() + 0x18E7C74))(this, value);
	}
	template <typename T = void> T add_EventSkipClick(void* value) {
		return ((T (*)(ActQuestViewNew*, void*))(Il2CppBase() + 0x18EE394))(this, value);
	}
	template <typename T = void> T remove_EventSkipClick(void* value) {
		return ((T (*)(ActQuestViewNew*, void*))(Il2CppBase() + 0x18EE438))(this, value);
	}
	...
	template <typename T = void> T Init(uintptr_t questData, void* trackStatusGetter) {
		return ((T (*)(ActQuestViewNew*, uintptr_t, void*))(Il2CppBase() + 0x18E9114))(this, questData, trackStatusGetter);
	}
	template <typename T = void> T UpdateTrackBox(bool canBeChanged, bool manualTrackingEnabled, void* tuple) {
		return ((T (*)(ActQuestViewNew*, bool, bool, void*))(Il2CppBase() + 0x18F1490))(this, canBeChanged, manualTrackingEnabled, tuple);
	}
	template <typename T = void> T ShowRequirements(uintptr_t avatar, uintptr_t questData) {
		return ((T (*)(ActQuestViewNew*, uintptr_t, uintptr_t))(Il2CppBase() + 0x18EFD90))(this, avatar, questData);
	}
	template <typename T = void> T ShowReward(uintptr_t quest, uintptr_t questData) {
		return ((T (*)(ActQuestViewNew*, uintptr_t, uintptr_t))(Il2CppBase() + 0x18EEFBC))(this, quest, questData);
	}
	template <typename T = void> T UpdateIcon(uintptr_t questData) {
		return ((T (*)(ActQuestViewNew*, uintptr_t))(Il2CppBase() + 0x18EE8F8))(this, questData);
	}
