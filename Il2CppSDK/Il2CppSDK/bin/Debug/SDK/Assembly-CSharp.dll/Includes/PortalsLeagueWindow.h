...
class PortalsLeagueWindow: BattlePassWindow
{
public: 
	...
	template <typename T = uintptr_t> T& LeagueTooltipView() {
	...
	template <typename T = uintptr_t> T& _currentLeagueTooltipTrigger() {
		return *(T*)((uintptr_t)this + 0x258);
	}
	template <typename T = uintptr_t> T& _tooltipLeaguePrefab() {
	...
	template <typename T = uintptr_t> T get_LeagueTooltipView() {
		return ((T (*)(PortalsLeagueWindow*))(Il2CppBase() + 0x1577D1C))(this);
	}
	template <typename T = void> T set_LeagueTooltipView(uintptr_t value) {
		return ((T (*)(PortalsLeagueWindow*, uintptr_t))(Il2CppBase() + 0x1577D24))(this, value);
	}
	...
	template <typename T = void> T InitItems(uintptr_t account) {
		return ((T (*)(PortalsLeagueWindow*, uintptr_t))(Il2CppBase() + 0x15780DC))(this, account);
	}
