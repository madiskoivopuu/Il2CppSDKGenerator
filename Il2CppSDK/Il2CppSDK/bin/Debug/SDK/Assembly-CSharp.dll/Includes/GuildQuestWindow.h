...
public: 
	...
	template <typename T = GuildQuestView*> T& _questView() {
	...
	template <typename T = GuildQuestPlayerView*> T& _playerViewPrefab() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = Il2CppList<GuildQuestPlayerView*>*> T& _playerViews() {
