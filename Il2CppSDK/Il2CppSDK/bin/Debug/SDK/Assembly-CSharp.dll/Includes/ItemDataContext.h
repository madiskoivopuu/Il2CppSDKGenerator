...
public: 
	...
	template <typename R = PlayerCosmeticsData*> R& PlayerCosmetics() {
	 ...
	 IReadOnlyDictionary2CurrencyType*, ValueTuple2int32_t, int32_t>*>*& MinMaxBpPoints() {
		return *(IReadOnlyDictionary2CurrencyType*, ValueTuple2int32_t, int32_t>*>**)((uintptr_t)this + 0x118);
	}
	...
	template <typename R = ActionDataContext*> R& _actionData() {
	 ...
	 EntityIndex2ItemEntity*, EquipmentType*>*& _equipmentIndex() {
		return *(EntityIndex2ItemEntity*, EquipmentType*>**)((uintptr_t)this + 0x138);
	}
	 EntityIndex2ItemEntity*, Il2CppString*>*& _tagsIndex() {
		return *(EntityIndex2ItemEntity*, Il2CppString*>**)((uintptr_t)this + 0x140);
	}
	 PrimaryEntityIndex2ItemEntity*, CurrencyType*>*& _currencyTypeIndex() {
		return *(PrimaryEntityIndex2ItemEntity*, CurrencyType*>**)((uintptr_t)this + 0x148);
	}
	 PrimaryEntityIndex2ItemEntity*, Il2CppString*>*& _shortNameIndex() {
		return *(PrimaryEntityIndex2ItemEntity*, Il2CppString*>**)((uintptr_t)this + 0x150);
	}
	 EntityIndex2ItemEntity*, CurrencyType*>*& _battleBassIndex() {
		return *(EntityIndex2ItemEntity*, CurrencyType*>**)((uintptr_t)this + 0x158);
	}
	 EntityIndex2ItemEntity*, Il2CppString*>*& _equipSetIndex() {
		return *(EntityIndex2ItemEntity*, Il2CppString*>**)((uintptr_t)this + 0x160);
	}
	 EntityIndex2ItemEntity*, PlayerClassType*>*& _playerClassTypeIndex() {
		return *(EntityIndex2ItemEntity*, PlayerClassType*>**)((uintptr_t)this + 0x168);
	}
	 EntityIndex2ItemEntity*, Il2CppString*>*& _classWithQuestIndex() {
		return *(EntityIndex2ItemEntity*, Il2CppString*>**)((uintptr_t)this + 0x170);
	}
	...
	template <typename R = void> R set_PlayerCosmetics(PlayerCosmeticsData* value) {
	 ...
	 IReadOnlyDictionary2CurrencyType*, ValueTuple2int32_t, int32_t>*>* get_MinMaxBpPoints() {
		return ((IReadOnlyDictionary2CurrencyType*, ValueTuple2int32_t, int32_t>*>* (*)(ItemDataContext*))(Il2CppBase() + 0x10EE7BC))(this);
	}
	template <typename R = void> R set_MinMaxBpPoints(IReadOnlyDictionary2CurrencyType*, ValueTuple2int32_t, int32_t>*>* value) {
		return ((R (*)(ItemDataContext*, IReadOnlyDictionary2CurrencyType*, ValueTuple2int32_t, int32_t>*>*))(Il2CppBase() + 0x10EE7C4))(this, value);
	}
	template <typename R = void> R AddEntityIndexes() {
		return ((R (*)(ItemDataContext*))(Il2CppBase() + 0x10EE9A8))(this);
	}
	 HashSet1ItemEntity*>* GetEntititesByEquipSet(Il2CppString* setName) {
		return ((HashSet1ItemEntity*>* (*)(ItemDataContext*, Il2CppString*))(Il2CppBase() + 0x10EF758))(this, setName);
	}
	 HashSet1ItemEntity*>* GetEntitiesWithEquipment(EquipmentType* Type) {
		return ((HashSet1ItemEntity*>* (*)(ItemDataContext*, EquipmentType*))(Il2CppBase() + 0x10EF7E0))(this, Type);
	}
	 HashSet1ItemEntity*>* GetEntitiesWithTag(Il2CppString* tag) {
		return ((HashSet1ItemEntity*>* (*)(ItemDataContext*, Il2CppString*))(Il2CppBase() + 0x10EF844))(this, tag);
	}
	template <typename R = ItemEntity*> R GetEntityWithCurrencyType(CurrencyType* type) {
	 ...
	 HashSet1ItemEntity*>* GetPlayerClassesByType(PlayerClassType* classType) {
		return ((HashSet1ItemEntity*>* (*)(ItemDataContext*, PlayerClassType*))(Il2CppBase() + 0x10EF90C))(this, classType);
	}
	 HashSet1ItemEntity*>* GetEntitiesWithBattlePassCurrencyType(CurrencyType* type) {
		return ((HashSet1ItemEntity*>* (*)(ItemDataContext*, CurrencyType*))(Il2CppBase() + 0x10EF970))(this, type);
	}
	...
	template <typename R = bool> R IsMorphed(Il2CppString* itemName) {
	 ...
	 ValueTuple3bool, Il2CppString*, Il2CppString*>* GetMorphingParts(Il2CppString* itemName) {
		return ((ValueTuple3bool, Il2CppString*, Il2CppString*>* (*)(ItemDataContext*, Il2CppString*))(Il2CppBase() + 0x10EFBD0))(this, itemName);
	}
	...
	template <typename R = int32_t> R GetExtraLevelCapByGiantStep(int32_t step) {
	 ...
	 HashSet1ItemEntity*>* GetClassesWithQuest(Il2CppString* name) {
		return ((HashSet1ItemEntity*>* (*)(ItemDataContext*, Il2CppString*))(Il2CppBase() + 0x10F5E28))(this, name);
	}
