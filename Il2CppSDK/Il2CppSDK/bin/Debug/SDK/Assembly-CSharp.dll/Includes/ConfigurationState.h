...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1<ProtoTools::ErrorCodes>*& OnConnectionError() {
		return *(Action1<ProtoTools::ErrorCodes>**)((uintptr_t)this + 0x30);
	}
	...
	template <typename R = DataBlueprints> R& _currentData() {
	 ...
	 Il2CppDictionary<ConfigurationType, Action3<int64_t, int64_t, ConfigurationType>*>*& _configurationActions() {
		return *(Il2CppDictionary<ConfigurationType, Action3<int64_t, int64_t, ConfigurationType>*>**)((uintptr_t)this + 0x90);
	}

	template <typename R = void> R add_OnConnectionError(Action1<ProtoTools::ErrorCodes>* value) {
		return ((R (*)(ConfigurationState*, Action1<ProtoTools::ErrorCodes>*))(Il2CppBase() + 0x15E5FF8))(this, value);
	}
	template <typename R = void> R remove_OnConnectionError(Action1<ProtoTools::ErrorCodes>* value) {
		return ((R (*)(ConfigurationState*, Action1<ProtoTools::ErrorCodes>*))(Il2CppBase() + 0x15E6098))(this, value);
	}
	...
	template <typename R = uintptr_t> R LoadConfiguration(IEnumerable1<ConfigurationVersion*>* configs) {
		return ((R (*)(ConfigurationState*, IEnumerable1<ConfigurationVersion*>*))(Il2CppBase() + 0x15E740C))(this, configs);
	}
