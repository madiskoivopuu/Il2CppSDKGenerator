...
public: 
	...
	template <typename R = int32_t> R& _entityId() {
	 ...
	 Nullable1bool>*& _isAvatar() {
		return *(Nullable1bool>**)((uintptr_t)this + 0x74);
	}
	...
	template <typename R = bool> R IsVisible(GameEntity* entity, HashSet1Il2CppString*>* visiblePoints) {
		return ((R (*)(MapPlayerLabel*, GameEntity*, HashSet1Il2CppString*>*))(Il2CppBase() + 0x12BF184))(this, entity, visiblePoints);
	}
	template <typename R = void> R UpdateView(GameEntity* entity, HashSet1Il2CppString*>* visiblePoints) {
		return ((R (*)(MapPlayerLabel*, GameEntity*, HashSet1Il2CppString*>*))(Il2CppBase() + 0x12BF29C))(this, entity, visiblePoints);
	}
