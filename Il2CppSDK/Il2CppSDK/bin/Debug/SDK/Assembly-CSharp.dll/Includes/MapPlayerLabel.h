...
public: 
	...
	template <typename T = Nullable1bool>*> T& _isAvatar() {
	...
	template <typename T = uintptr_t> T& _goRotation() {
	...
	template <typename T = bool> T IsVisible(GameEntity* entity, HashSet1Il2CppString*>* visiblePoints) {
		return ((T (*)(MapPlayerLabel*, GameEntity*, HashSet1Il2CppString*>*))(Il2CppBase() + 0x12BF184))(this, entity, visiblePoints);
	}
	template <typename T = void> T UpdateView(GameEntity* entity, HashSet1Il2CppString*>* visiblePoints) {
		return ((T (*)(MapPlayerLabel*, GameEntity*, HashSet1Il2CppString*>*))(Il2CppBase() + 0x12BF29C))(this, entity, visiblePoints);
	}
