...
public: 
	...
	template <typename R = void> R GetFurnitures(ICommonContexts* world, Il2CppString* conditionName, HashSet1<Il2CppString*>* result) {
		return ((R (*)(ConditionContext*, ICommonContexts*, Il2CppString*, HashSet1<Il2CppString*>*))(Il2CppBase() + 0x20ADF9C))(this, world, conditionName, result);
	}
