...
public: 
	...
	template <typename T = void*> static T GetVersionAndLanguages(Il2CppString* data) {
	...
	template <typename T = void*> static T Parse(uintptr_t reader, char delimiter, char qualifier) {
