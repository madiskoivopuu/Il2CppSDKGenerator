...
public: 
	...
	template <typename R = int32_t> R& _FreeCount() {
	 ...
	 IEqualityComparer1TKey>*& _Comparer() {
		return *(IEqualityComparer1TKey>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = bool> R TryGetValue(TKey key, uintptr_t* value) {
	 ...
	 ICollection1TKey>* get_Keys() {
		return ((ICollection1TKey>* (*)(SerializableDictionary2*))(Il2CppBase() + 0x0))(this);
	}
	 ICollection1TValue>* get_Values() {
		return ((ICollection1TValue>* (*)(SerializableDictionary2*))(Il2CppBase() + 0x0))(this);
	}
	template <typename R = void> R Add_1(KeyValuePair2TKey, TValue>* item) {
		return ((R (*)(SerializableDictionary2*, KeyValuePair2TKey, TValue>*))(Il2CppBase() + 0x0))(this, item);
	}
	template <typename R = bool> R Contains(KeyValuePair2TKey, TValue>* item) {
		return ((R (*)(SerializableDictionary2*, KeyValuePair2TKey, TValue>*))(Il2CppBase() + 0x0))(this, item);
	}
	template <typename R = void> R CopyTo(Il2CppArray<KeyValuePair2TKey, TValue>*>* array, int32_t index) {
		return ((R (*)(SerializableDictionary2*, Il2CppArray<KeyValuePair2TKey, TValue>*>*, int32_t))(Il2CppBase() + 0x0))(this, array, index);
	}
	template <typename R = bool> R get_IsReadOnly() {
		return ((R (*)(SerializableDictionary2*))(Il2CppBase() + 0x0))(this);
	}
	template <typename R = bool> R Remove_1(KeyValuePair2TKey, TValue>* item) {
		return ((R (*)(SerializableDictionary2*, KeyValuePair2TKey, TValue>*))(Il2CppBase() + 0x0))(this, item);
	}
	 EnumeratorTKey, TValue>* GetEnumerator() {
		return ((EnumeratorTKey, TValue>* (*)(SerializableDictionary2*))(Il2CppBase() + 0x0))(this);
	}
	template <typename R = uintptr_t> R System_Collections_IEnumerable_GetEnumerator() {
		return ((R (*)(SerializableDictionary2*))(Il2CppBase() + 0x0))(this);
	}
	 IEnumerator1KeyValuePair2TKey, TValue>*>* System_Collections_Generic_IEnumerableSystem_Collections_Generic_KeyValuePairTKey,TValue_GetEnumerator() {
		return ((IEnumerator1KeyValuePair2TKey, TValue>*>* (*)(SerializableDictionary2*))(Il2CppBase() + 0x0))(this);
	}
