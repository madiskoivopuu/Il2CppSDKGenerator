...
public: 
	...
	template <typename R = uintptr_t> R& _openButton() {
	 ...
	 Action1GuildQuestItemView*>*& OnOpenEvent() {
		return *(Action1GuildQuestItemView*>**)((uintptr_t)this + 0xB8);
	}
	 Action1GuildQuestItemView*>*& OnStartEvent() {
		return *(Action1GuildQuestItemView*>**)((uintptr_t)this + 0xC0);
	}
	...
	template <typename R = void> R add_OnOpenEvent(Action1GuildQuestItemView*>* value) {
		return ((R (*)(GuildQuestItemView*, Action1GuildQuestItemView*>*))(Il2CppBase() + 0x19361A4))(this, value);
	}
	template <typename R = void> R remove_OnOpenEvent(Action1GuildQuestItemView*>* value) {
		return ((R (*)(GuildQuestItemView*, Action1GuildQuestItemView*>*))(Il2CppBase() + 0x1936244))(this, value);
	}
	template <typename R = void> R add_OnStartEvent(Action1GuildQuestItemView*>* value) {
		return ((R (*)(GuildQuestItemView*, Action1GuildQuestItemView*>*))(Il2CppBase() + 0x19362E4))(this, value);
	}
	template <typename R = void> R remove_OnStartEvent(Action1GuildQuestItemView*>* value) {
		return ((R (*)(GuildQuestItemView*, Action1GuildQuestItemView*>*))(Il2CppBase() + 0x1936384))(this, value);
	}
