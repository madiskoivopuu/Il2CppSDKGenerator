...
public: 
	...
	template <typename R = GameContext*> R& map() {
	 ...
	 Action1Il2CppString*>*& OnEnterIntoLocation() {
		return *(Action1Il2CppString*>**)((uintptr_t)this + 0x2A0);
	}
	template <typename R = Il2CppArray<Action4MapClientWorld*, Commands*, uintptr_t, uintptr_t>*>*> static R& _mapCommandsActions() {
	...
	template <typename R = uintptr_t> R Create(Il2CppList<KeyValuePair2Il2CppString*, EntityBlueprint*>*>* blueprints) {
		return ((R (*)(MapClientWorld*, Il2CppList<KeyValuePair2Il2CppString*, EntityBlueprint*>*>*))(Il2CppBase() + 0x12694CC))(this, blueprints);
	}
