...
public: 
	...
	template <typename T = void> T add_ClickEvent(void* value) {
		return ((T (*)(ScoutingCard*, void*))(Il2CppBase() + 0x13589BC))(this, value);
	}
	template <typename T = void> T remove_ClickEvent(void* value) {
		return ((T (*)(ScoutingCard*, void*))(Il2CppBase() + 0x1358A5C))(this, value);
	}
	...
	template <typename T = void> T UpdateView(uintptr_t account, uintptr_t state, int64_t now) {
		return ((T (*)(ScoutingCard*, uintptr_t, uintptr_t, int64_t))(Il2CppBase() + 0x13592B8))(this, account, state, now);
	}
