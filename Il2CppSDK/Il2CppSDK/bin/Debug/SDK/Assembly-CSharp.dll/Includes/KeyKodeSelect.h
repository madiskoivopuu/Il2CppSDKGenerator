...
public: 
	...
	template <typename R = bool> R& isInit() {
	 ...
	 HashSet1<uintptr_t>*& keys() {
		return *(HashSet1<uintptr_t>**)((uintptr_t)this + 0x40);
	}
	 Action1<Il2CppArray<uintptr_t>*>*& OnOk() {
		return *(Action1<Il2CppArray<uintptr_t>*>**)((uintptr_t)this + 0x48);
	}

	template <typename R = void> R SelectKeys(Il2CppArray<uintptr_t>* current, Action1<Il2CppArray<uintptr_t>*>* onSelected) {
		return ((R (*)(KeyKodeSelect*, Il2CppArray<uintptr_t>*, Action1<Il2CppArray<uintptr_t>*>*))(Il2CppBase() + 0x14EA824))(this, current, onSelected);
	}
