...
public: 
	...
	template <typename T = void> T AddStatusBarView(StatusNameShow* newStatusNameShow, Il2CppString* newNameFormat, float newHPBarShowDuration, bool newDontShowInfo, bool newDontShowHealthCount, bool newShowDPS, Il2CppString* newHexColor) {
		return ((T (*)(IStatusBarViewEntity*, StatusNameShow*, Il2CppString*, float, bool, bool, bool, Il2CppString*))(Il2CppBase() + 0x0))(this, newStatusNameShow, newNameFormat, newHPBarShowDuration, newDontShowInfo, newDontShowHealthCount, newShowDPS, newHexColor);
	}
