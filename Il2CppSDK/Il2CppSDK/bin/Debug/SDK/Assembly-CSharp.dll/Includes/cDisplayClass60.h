...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action2<GooglePlayGamesBasicApi::ResponseStatus, GooglePlayGamesBasicApiVideo::VideoCaptureState*>*& callback() {
		return *(Action2<GooglePlayGamesBasicApi::ResponseStatus, GooglePlayGamesBasicApiVideo::VideoCaptureState*>**)((uintptr_t)this + 0x10);
	}
