...
public: 
	...
	template <typename T = ServerInfoContext*> T& _context() {
	...
	template <typename T = void> T Init(ServerInfoContext* context, Il2CppString* subregionName) {
		return ((T (*)(ServerView*, ServerInfoContext*, Il2CppString*))(Il2CppBase() + 0x1622C14))(this, context, subregionName);
	}
