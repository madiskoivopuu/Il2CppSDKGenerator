...
public: 
	...
	template <typename T = uintptr_t> T get_analyticEvent() {
	...
	template <typename T = void> T AddCurrencyType(uintptr_t newType) {
		return ((T (*)(TournamentEntity*, uintptr_t))(Il2CppBase() + 0x1500264))(this, newType);
	}
	template <typename T = void> T ReplaceCurrencyType(uintptr_t newType) {
		return ((T (*)(TournamentEntity*, uintptr_t))(Il2CppBase() + 0x1500368))(this, newType);
	}
	...
	template <typename T = uintptr_t> T get_foundPlayers() {
	...
	template <typename T = uintptr_t> T get_generatedPositionRewards() {
	...
	template <typename T = uintptr_t> T get_guaranteedRewards() {
	...
	template <typename T = uintptr_t> T get_historyTempBuff() {
	...
	template <typename T = uintptr_t> T get_maxPlayers() {
	...
	template <typename T = uintptr_t> T get_minPointsToReward() {
	...
	template <typename T = uintptr_t> T get_positionRewards() {
	...
	template <typename T = uintptr_t> T get_tournamentState() {
	...
	template <typename T = void> T AddTournamentState(uintptr_t newType) {
		return ((T (*)(TournamentEntity*, uintptr_t))(Il2CppBase() + 0x15030F8))(this, newType);
	}
	template <typename T = void> T ReplaceTournamentState(uintptr_t newType) {
		return ((T (*)(TournamentEntity*, uintptr_t))(Il2CppBase() + 0x15031FC))(this, newType);
	}
