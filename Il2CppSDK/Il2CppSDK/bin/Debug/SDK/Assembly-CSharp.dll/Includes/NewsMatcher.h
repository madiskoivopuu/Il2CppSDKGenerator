...
public: 
	...
	template <typename T = void*> static T& _matcherAvailablePlatform() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _matcherId() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> static T& _matcherInvalidationDate() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> static T& _matcherRead() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> static T& _matcherShowToNewPlayers() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = void*> static T& _matcherText() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = void*> static T& _matcherTitle() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}

	template <typename T = void*> static T get_AvailablePlatform() {
		return ((T (*)(void *))(Il2CppBase() + 0x13AF7F8))(0);
	}
	template <typename T = void*> static T get_Id() {
		return ((T (*)(void *))(Il2CppBase() + 0x13AE1A0))(0);
	}
	template <typename T = void*> static T get_InvalidationDate() {
		return ((T (*)(void *))(Il2CppBase() + 0x13AF978))(0);
	}
	template <typename T = void*> static T get_Read() {
		return ((T (*)(void *))(Il2CppBase() + 0x13AFB14))(0);
	}
	template <typename T = void*> static T get_ShowToNewPlayers() {
		return ((T (*)(void *))(Il2CppBase() + 0x13AFCB0))(0);
	}
	template <typename T = void*> static T get_Text() {
		return ((T (*)(void *))(Il2CppBase() + 0x13AFE4C))(0);
	}
	template <typename T = void*> static T get_Title() {
