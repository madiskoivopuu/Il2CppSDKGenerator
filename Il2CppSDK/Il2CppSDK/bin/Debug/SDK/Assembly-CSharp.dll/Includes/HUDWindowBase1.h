...
public: 
	...
	template <typename R = Il2CppString*> R& _shortModeKey() {
	 ...
	 Action1<bool>*& OnSwitchCustomizationMode() {
		return *(Action1<bool>**)((uintptr_t)this + 0x0);
	}
	 Action1<bool>*& OnSwitchShortMode() {
		return *(Action1<bool>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = void> R add_OnSwitchCustomizationMode(Action1<bool>* value) {
		return ((R (*)(HUDWindowBase1*, Action1<bool>*))(Il2CppBase() + 0x0))(this, value);
	}
