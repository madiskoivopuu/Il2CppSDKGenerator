...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 PrimaryEntityIndex2<InputEntity*, int64_t>*& _tickIndex() {
		return *(PrimaryEntityIndex2<InputEntity*, int64_t>**)((uintptr_t)this + 0xF8);
	}
	 IGroup1<InputEntity*>*& _velocityEntities() {
		return *(IGroup1<InputEntity*>**)((uintptr_t)this + 0x100);
	}

	 IGroup1<InputEntity*>* GetVelocityEntities() {
		return ((IGroup1<InputEntity*>* (*)(InputContext*))(Il2CppBase() + 0x1E45668))(this);
	}
