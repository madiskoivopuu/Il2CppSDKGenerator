...
class InputContext: BaseContext1
{
public: 
	...
	template <typename T = void*> T& _tickIndex() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = void*> T& _velocityEntities() {
		return *(T*)((uintptr_t)this + 0x100);
	}

	template <typename T = void*> T GetVelocityEntities() {
		return ((T (*)(InputContext*))(Il2CppBase() + 0x1E45668))(this);
	}
	template <typename T = uintptr_t> T GetEntityWithTick(int64_t value) {
		return ((T (*)(InputContext*, int64_t))(Il2CppBase() + 0x1E40FA8))(this, value);
	}
	template <typename T = uintptr_t> T CreateMoveEntity(int64_t now, int32_t parentId, float x, float y, int32_t moveToTargetId) {
	...
	template <typename T = uintptr_t> T get_attackButtonEntity() {
	...
	template <typename T = uintptr_t> T get_bannerButtonEntity() {
	...
	template <typename T = uintptr_t> T get_crouchButtonEntity() {
	...
	template <typename T = uintptr_t> T get_fishingButtonEntity() {
	...
	template <typename T = uintptr_t> T get_fishnetButtonEntity() {
	...
	template <typename T = uintptr_t> T get_horizontalAxisEntity() {
	...
	template <typename T = uintptr_t> T get_horizontalSkillShotEntity() {
	...
	template <typename T = uintptr_t> T get_hoverMouseEntity() {
	...
	template <typename T = uintptr_t> T get_interactButtonEntity() {
	...
	template <typename T = uintptr_t> T get_leftMouseEntity() {
	...
	template <typename T = uintptr_t> T get_mountButtonEntity() {
	...
	template <typename T = uintptr_t> T get_mountSkill1ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_mountSkill2ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_mountSkill3ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_pocket1ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_pocket2ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_pocket3ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_rightMouseEntity() {
	...
	template <typename T = uintptr_t> T get_skill1ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_skill2ButtonEntity() {
	...
	template <typename T = uintptr_t> T get_useButtonEntity() {
	...
	template <typename T = uintptr_t> T get_verticalAxisEntity() {
	...
	template <typename T = uintptr_t> T get_verticalSkillShotEntity() {
