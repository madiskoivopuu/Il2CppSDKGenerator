...
public: 
	...
	template <typename R = bool> R& HasNewDeactivatedRuneNotify() {
	 ...
	 Action1<PlayerClassView*>*& ClickEvent() {
		return *(Action1<PlayerClassView*>**)((uintptr_t)this + 0x168);
	}
	 Action2<PlayerClassView*, ActiveClassDetailsToggle>*& ClickDetailEvent() {
		return *(Action2<PlayerClassView*, ActiveClassDetailsToggle>**)((uintptr_t)this + 0x170);
	}
	 Action1<bool>*& OnSeenUpdated() {
		return *(Action1<bool>**)((uintptr_t)this + 0x178);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1<PlayerClassView*>* value) {
		return ((R (*)(PlayerClassView*, Action1<PlayerClassView*>*))(Il2CppBase() + 0x1B731F4))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1<PlayerClassView*>* value) {
		return ((R (*)(PlayerClassView*, Action1<PlayerClassView*>*))(Il2CppBase() + 0x1B75024))(this, value);
	}
	template <typename R = void> R add_ClickDetailEvent(Action2<PlayerClassView*, ActiveClassDetailsToggle>* value) {
		return ((R (*)(PlayerClassView*, Action2<PlayerClassView*, ActiveClassDetailsToggle>*))(Il2CppBase() + 0x1B750C8))(this, value);
	}
	template <typename R = void> R remove_ClickDetailEvent(Action2<PlayerClassView*, ActiveClassDetailsToggle>* value) {
		return ((R (*)(PlayerClassView*, Action2<PlayerClassView*, ActiveClassDetailsToggle>*))(Il2CppBase() + 0x1B7516C))(this, value);
	}
	template <typename R = void> R add_OnSeenUpdated(Action1<bool>* value) {
		return ((R (*)(PlayerClassView*, Action1<bool>*))(Il2CppBase() + 0x1B75210))(this, value);
	}
	template <typename R = void> R remove_OnSeenUpdated(Action1<bool>* value) {
		return ((R (*)(PlayerClassView*, Action1<bool>*))(Il2CppBase() + 0x1B752B4))(this, value);
	}
