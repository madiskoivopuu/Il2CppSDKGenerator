...
public: 
	...
	template <typename T = LocationEntity*> T& _worldParams() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = IArenaWorld*> T& _world() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = Il2CppArray<uintptr_t>*> T& _doorsAndWalls() {
	...
	template <typename T = uint16_t> T get_Item_1(Coord* coord) {
		return ((T (*)(DoorsAndWalls*, Coord*))(Il2CppBase() + 0x130333C))(this, coord);
	}
	...
	template <typename T = bool> T TryAdd(GameEntity* entity) {
		return ((T (*)(DoorsAndWalls*, GameEntity*))(Il2CppBase() + 0x13038B4))(this, entity);
	}
	template <typename T = bool> T TryAdd_1(float x, float y, GameEntity* entity) {
		return ((T (*)(DoorsAndWalls*, float, float, GameEntity*))(Il2CppBase() + 0x1303918))(this, x, y, entity);
	}
	...
	template <typename T = void> T SafeRemove(GameEntity* entity, bool door, bool removeComponent) {
		return ((T (*)(DoorsAndWalls*, GameEntity*, bool, bool))(Il2CppBase() + 0x1304760))(this, entity, door, removeComponent);
	}
	template <typename T = void> T AddEntity(GameEntity* entity) {
		return ((T (*)(DoorsAndWalls*, GameEntity*))(Il2CppBase() + 0x1304A68))(this, entity);
	}
	template <typename T = void> T RemoveEntity(GameEntity* entity) {
		return ((T (*)(DoorsAndWalls*, GameEntity*))(Il2CppBase() + 0x1304B04))(this, entity);
	}
	template <typename T = void> T SafeRemoveEntity(GameEntity* entity, bool removeComponent) {
		return ((T (*)(DoorsAndWalls*, GameEntity*, bool))(Il2CppBase() + 0x1304C28))(this, entity, removeComponent);
	}
