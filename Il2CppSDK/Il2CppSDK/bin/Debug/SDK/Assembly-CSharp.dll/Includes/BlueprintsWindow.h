...
public: 
	...
	template <typename T = DelayedButton*> T& CraftButton() {
		return *(T*)((uintptr_t)this + 0x90);
	}
	template <typename T = TextMonoBehaviour*> T& LevelRequired() {
	...
	template <typename T = TextMonoBehaviour*> T& PlacedText() {
	...
	template <typename T = BlueprintsContainer*> T& BlueprintsContainer() {
	...
	template <typename T = BlueprintItem*> T& _selectedBlueprintItem() {
	...
	template <typename T = TrophyRoadEntity*> T& _currentTRStep() {
	...
	template <typename T = void> T SetupCategories(HashSet1Il2CppString*>* categories) {
		return ((T (*)(BlueprintsWindow*, HashSet1Il2CppString*>*))(Il2CppBase() + 0x16C50CC))(this, categories);
	}
	...
	template <typename T = void> T OnBlueprintSelected(BlueprintItem* view, BlueprintEntity* entity) {
		return ((T (*)(BlueprintsWindow*, BlueprintItem*, BlueprintEntity*))(Il2CppBase() + 0x16C63CC))(this, view, entity);
	}
