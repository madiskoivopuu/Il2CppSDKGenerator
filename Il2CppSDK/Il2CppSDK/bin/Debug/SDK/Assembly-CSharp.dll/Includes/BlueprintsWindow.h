...
public: 
	...
	template <typename R = void> R SetupCategories(HashSet1Il2CppString*>* categories) {
		return ((R (*)(BlueprintsWindow*, HashSet1Il2CppString*>*))(Il2CppBase() + 0x16C50CC))(this, categories);
	}
