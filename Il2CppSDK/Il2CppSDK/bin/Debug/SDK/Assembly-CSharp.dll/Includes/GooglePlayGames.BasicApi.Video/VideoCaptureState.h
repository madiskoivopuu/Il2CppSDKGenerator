...
public: 
	...
	template <typename T = VideoCaptureMode*> T& mCaptureMode() {
		return *(T*)((uintptr_t)this + 0x14);
	}
	template <typename T = VideoQualityLevel*> T& mQualityLevel() {
	...
	template <typename T = VideoCaptureMode*> T get_CaptureMode() {
		return ((T (*)(VideoCaptureState*))(Il2CppBase() + 0x15C6F10))(this);
	}
	template <typename T = VideoQualityLevel*> T get_QualityLevel() {
