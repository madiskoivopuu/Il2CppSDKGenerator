...
public: 
	...
	template <typename R = uintptr_t> R& response() {
	 ...
	 Action1ProtoTools::ErrorCodes*>*& onError() {
		return *(Action1ProtoTools::ErrorCodes*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = double> R& start5__3() {
	 ...
	 TaskAwaiter1uintptr_t>*& u__1() {
		return *(TaskAwaiter1uintptr_t>**)((uintptr_t)this + 0x68);
	}
	 TaskAwaiter1Il2CppArray<uint8_t>*>*& u__2() {
		return *(TaskAwaiter1Il2CppArray<uint8_t>*>**)((uintptr_t)this + 0x70);
	}
