...
public: 
	...
	template <typename T = void> T Show(TooltipView* tooltipView, int32_t districtLevel) {
		return ((T (*)(CartProgressView*, TooltipView*, int32_t))(Il2CppBase() + 0x13E7AAC))(this, tooltipView, districtLevel);
	}
