...
public: 
	...
	template <typename T = void*> T& notifyFunc() {
	...
	template <typename T = void> T Bind(Il2CppString* categoryName, uintptr_t onSelect, void* notifyFunc) {
		return ((T (*)(QuestCategoryView*, Il2CppString*, uintptr_t, void*))(Il2CppBase() + 0x11C6CE4))(this, categoryName, onSelect, notifyFunc);
	}
