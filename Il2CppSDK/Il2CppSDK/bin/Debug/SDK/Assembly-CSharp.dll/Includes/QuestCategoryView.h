...
public: 
	...
	template <typename R = uintptr_t> R& notificationsText() {
	 ...
	 Func1ValueTuple2bool, Il2CppString*>*>*& notifyFunc() {
		return *(Func1ValueTuple2bool, Il2CppString*>*>**)((uintptr_t)this + 0x68);
	}
	...
	template <typename R = void> R Bind(Il2CppString* categoryName, uintptr_t onSelect, Func1ValueTuple2bool, Il2CppString*>*>* notifyFunc) {
		return ((R (*)(QuestCategoryView*, Il2CppString*, uintptr_t, Func1ValueTuple2bool, Il2CppString*>*>*))(Il2CppBase() + 0x11C6CE4))(this, categoryName, onSelect, notifyFunc);
	}
