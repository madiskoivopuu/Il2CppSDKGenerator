...
public: 
	...
	template <typename T = void> T Bind(GuildWindow* window) {
		return ((T (*)(GuildRecommendedPanel*, GuildWindow*))(Il2CppBase() + 0x193F860))(this, window);
	}
	template <typename T = void> T OnRecommendedGuildsResponse(Il2CppArray<uintptr_t>* ids, ErrorCodes* errorCode) {
		return ((T (*)(GuildRecommendedPanel*, Il2CppArray<uintptr_t>*, ErrorCodes*))(Il2CppBase() + 0x193F868))(this, ids, errorCode);
	}
	...
	template <typename T = bool> T NeedToUpdateRatingGuilds(uintptr_t* guilds) {
		return ((T (*)(GuildRecommendedPanel*, uintptr_t*))(Il2CppBase() + 0x193FED4))(this, guilds);
	}
