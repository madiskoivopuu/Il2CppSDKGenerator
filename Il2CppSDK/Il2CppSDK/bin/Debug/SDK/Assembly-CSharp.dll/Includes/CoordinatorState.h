...
public: 
	...
	template <typename R = void> R add_OnConnectionError(Action1ProtoTools::ErrorCodes*>* value) {
		return ((R (*)(CoordinatorState*, Action1ProtoTools::ErrorCodes*>*))(Il2CppBase() + 0x133C884))(this, value);
	}
	template <typename R = void> R remove_OnConnectionError(Action1ProtoTools::ErrorCodes*>* value) {
		return ((R (*)(CoordinatorState*, Action1ProtoTools::ErrorCodes*>*))(Il2CppBase() + 0x133C924))(this, value);
	}
