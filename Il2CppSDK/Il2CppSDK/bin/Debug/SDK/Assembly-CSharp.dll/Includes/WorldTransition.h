...
public: 
	...
	template <typename T = uintptr_t> T& ListenerUdpConfig() {
	...
	template <typename T = uintptr_t> T get_ListenerUdpConfig() {
		return ((T (*)(WorldTransition*))(Il2CppBase() + 0x1131410))(this);
	}
	template <typename T = void> T set_ListenerUdpConfig(uintptr_t value) {
		return ((T (*)(WorldTransition*, uintptr_t))(Il2CppBase() + 0x1131418))(this, value);
	}
