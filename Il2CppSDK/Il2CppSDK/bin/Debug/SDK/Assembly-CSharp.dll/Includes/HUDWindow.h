...
public: 
	...
	template <typename T = HUDPlayerPvPButton*> T& PlayerPvPButton() {
		return *(T*)((uintptr_t)this + 0x128);
	}
	template <typename T = HUDAutoModeButton*> T& AutoButton() {
	...
	template <typename T = HUDCustomizationButton*> T& _customizationButton() {
		return *(T*)((uintptr_t)this + 0x150);
	}
	template <typename T = HUDInventoryPanel*> T& _hudInventoryPanel() {
		return *(T*)((uintptr_t)this + 0x158);
	}
	template <typename T = HUDInventoryButton*> T& AttackButton() {
	...
	template <typename T = HUDInventoryButton*> T& Pocket1() {
		return *(T*)((uintptr_t)this + 0x178);
	}
	template <typename T = HUDInventoryButton*> T& Pocket2() {
		return *(T*)((uintptr_t)this + 0x180);
	}
	template <typename T = HUDInventoryButton*> T& Pocket3() {
		return *(T*)((uintptr_t)this + 0x188);
	}
	template <typename T = HUDInventoryButton*> T& Skill1() {
		return *(T*)((uintptr_t)this + 0x190);
	}
	template <typename T = HUDInventoryButton*> T& Skill2() {
		return *(T*)((uintptr_t)this + 0x198);
	}
	template <typename T = HUDInventoryButton*> T& Mount() {
		return *(T*)((uintptr_t)this + 0x1A0);
	}
	template <typename T = HUDInventoryButton*> T& MountSkill1() {
		return *(T*)((uintptr_t)this + 0x1A8);
	}
	template <typename T = HUDInventoryButton*> T& MountSkill2() {
		return *(T*)((uintptr_t)this + 0x1B0);
	}
	template <typename T = HUDInventoryButton*> T& MountSkill3() {
		return *(T*)((uintptr_t)this + 0x1B8);
	}
	template <typename T = HUDBuilderButton*> T& _builderButton() {
		return *(T*)((uintptr_t)this + 0x1C0);
	}
	template <typename T = HUDInteractPanelController*> T& InteractPanelController() {
		return *(T*)((uintptr_t)this + 0x1C8);
	}
	template <typename T = HUDCrouchButton*> T& CrouchButton() {
		return *(T*)((uintptr_t)this + 0x1D0);
	}
	template <typename T = SimpleJoystick*> T& Joystick() {
		return *(T*)((uintptr_t)this + 0x1D8);
	}
	template <typename T = SimpleJoystick*> T& SkillShot() {
		return *(T*)((uintptr_t)this + 0x1E0);
	}
	template <typename T = JoystickDPad*> T& D_Pad() {
		return *(T*)((uintptr_t)this + 0x1E8);
	}
	template <typename T = HUDEmojiButton*> T& _emojiButton() {
		return *(T*)((uintptr_t)this + 0x1F0);
	}
	template <typename T = EmojiPanelController*> T& _emojiPanel() {
		return *(T*)((uintptr_t)this + 0x1F8);
	}
	template <typename T = HUDBannerButton*> T& _bannerButton() {
	...
	template <typename T = MagicsStatus*> T& AvatarMagicsStatus() {
		return *(T*)((uintptr_t)this + 0x218);
	}
	template <typename T = MetabolismStatus*> T& AvatartMetabolismStatus() {
		return *(T*)((uintptr_t)this + 0x220);
	}
	template <typename T = HUDActorInfo*> T& EnemyInfo() {
		return *(T*)((uintptr_t)this + 0x228);
	}
	template <typename T = WavesEventStatus*> T& WavesEventStatus() {
		return *(T*)((uintptr_t)this + 0x230);
	}
	template <typename T = HUDBossTracker*> T& BossTracker() {
		return *(T*)((uintptr_t)this + 0x238);
	}
	template <typename T = HUDExperienceInfo*> T& _experienceInfo() {
		return *(T*)((uintptr_t)this + 0x240);
	}
	template <typename T = uintptr_t> T& ExpNotify() {
		return *(T*)((uintptr_t)this + 0x248);
	}
	template <typename T = HUDPetExperienceInfo*> T& _petExperienceInfo() {
		return *(T*)((uintptr_t)this + 0x250);
	}
	template <typename T = uintptr_t> T& PetExpNotify() {
		return *(T*)((uintptr_t)this + 0x258);
	}
	template <typename T = HUDMinimap*> T& Minimap() {
		return *(T*)((uintptr_t)this + 0x260);
	}
	template <typename T = HUDQuadInfo*> T& QuadInfo() {
		return *(T*)((uintptr_t)this + 0x268);
	}
	template <typename T = HUDDurabilityPuppet*> T& DurabilityPuppet() {
		return *(T*)((uintptr_t)this + 0x270);
	}
	template <typename T = HUDSelectTargetController*> T& TargetController() {
		return *(T*)((uintptr_t)this + 0x278);
	}
	template <typename T = PlayerClassesMenu*> T& _playerClassMenu() {
		return *(T*)((uintptr_t)this + 0x280);
	}
	template <typename T = HUDDistrictInfo*> T& DistrictInfo() {
	...
	template <typename T = Il2CppDictionary<Il2CppString*, IInputAxis*>*> T& _axes() {
		return *(T*)((uintptr_t)this + 0x2E0);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, IInputButton*>*> T& _buttons() {
	...
	template <typename T = Nullable1bool>*> T& _lastRiding() {
	...
	template <typename T = EmojiPanelController*> T get_EmojiPanel() {
	...
	template <typename T = void> T OnActionCreatedEvent(ActionEntity* actionEntity) {
		return ((T (*)(HUDWindow*, ActionEntity*))(Il2CppBase() + 0x1286980))(this, actionEntity);
	}
	...
	template <typename T = void> T UpdatePanelsState(int64_t now, AccountEntity* account, GameEntity* avatar) {
		return ((T (*)(HUDWindow*, int64_t, AccountEntity*, GameEntity*))(Il2CppBase() + 0x1288158))(this, now, account, avatar);
	}
	template <typename T = void> T UpdatePortals() {
		return ((T (*)(HUDWindow*))(Il2CppBase() + 0x1288614))(this);
	}
	template <typename T = void> T UpdateSkillsPanel(GameEntity* avatar) {
		return ((T (*)(HUDWindow*, GameEntity*))(Il2CppBase() + 0x12864DC))(this, avatar);
	}
	template <typename T = void> T UpdateMountSkills(GameEntity* avatar) {
		return ((T (*)(HUDWindow*, GameEntity*))(Il2CppBase() + 0x1288CEC))(this, avatar);
	}
	...
	template <typename T = void> T OnClickHoldedHandler(ItemEntity* item, float duration) {
		return ((T (*)(HUDWindow*, ItemEntity*, float))(Il2CppBase() + 0x128928C))(this, item, duration);
	}
	...
	template <typename T = void> T AddAxis(Il2CppString* axisName, IInputAxis* axis) {
		return ((T (*)(HUDWindow*, Il2CppString*, IInputAxis*))(Il2CppBase() + 0x12893C0))(this, axisName, axis);
	}
