...
public: 
	...
	template <typename R = void> static R ShowTextBubble(UIWindowsManager* manager, GameEntity* target, Il2CppString* text, Nullable1float>* lifeTime) {
		return ((R (*)(void *, UIWindowsManager*, GameEntity*, Il2CppString*, Nullable1float>*))(Il2CppBase() + 0x148BEF8))(0, manager, target, text, lifeTime);
	}
