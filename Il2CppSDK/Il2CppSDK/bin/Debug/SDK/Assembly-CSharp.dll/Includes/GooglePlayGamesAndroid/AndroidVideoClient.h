...
public: 
	...
	template <typename R = void> R GetCaptureCapabilities(Action2GooglePlayGamesBasicApi::ResponseStatus*, GooglePlayGamesBasicApiVideo::VideoCapabilities*>* callback) {
		return ((R (*)(AndroidVideoClient*, Action2GooglePlayGamesBasicApi::ResponseStatus*, GooglePlayGamesBasicApiVideo::VideoCapabilities*>*))(Il2CppBase() + 0x1889E0C))(this, callback);
	}
	...
	template <typename R = void> R GetCaptureState(Action2GooglePlayGamesBasicApi::ResponseStatus*, GooglePlayGamesBasicApiVideo::VideoCaptureState*>* callback) {
		return ((R (*)(AndroidVideoClient*, Action2GooglePlayGamesBasicApi::ResponseStatus*, GooglePlayGamesBasicApiVideo::VideoCaptureState*>*))(Il2CppBase() + 0x188A14C))(this, callback);
	}
	template <typename R = void> R IsCaptureAvailable(GooglePlayGamesBasicApi::VideoCaptureMode* captureMode, Action2GooglePlayGamesBasicApi::ResponseStatus*, bool>* callback) {
		return ((R (*)(AndroidVideoClient*, GooglePlayGamesBasicApi::VideoCaptureMode*, Action2GooglePlayGamesBasicApi::ResponseStatus*, bool>*))(Il2CppBase() + 0x188A484))(this, captureMode, callback);
	}
