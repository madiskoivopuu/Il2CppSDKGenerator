...
public: 
	...
	template <typename R = void> R StartAdvertising(Il2CppString* name, Il2CppList<Il2CppString*>* appIdentifiers, Nullable1<uintptr_t>* advertisingDuration, Action1<GooglePlayGamesBasicApiNearby::AdvertisingResult>* resultCallback, Action1<GooglePlayGamesBasicApiNearby::ConnectionRequest>* connectionRequestCallback) {
		return ((R (*)(AndroidNearbyConnectionClient*, Il2CppString*, Il2CppList<Il2CppString*>*, Nullable1<uintptr_t>*, Action1<GooglePlayGamesBasicApiNearby::AdvertisingResult>*, Action1<GooglePlayGamesBasicApiNearby::ConnectionRequest>*))(Il2CppBase() + 0x12B5280))(this, name, appIdentifiers, advertisingDuration, resultCallback, connectionRequestCallback);
	}
	...
	template <typename R = void> R SendConnectionRequest(Il2CppString* name, Il2CppString* remoteEndpointId, Il2CppArray<uint8_t>* payload, Action1<GooglePlayGamesBasicApiNearby::ConnectionResponse>* responseCallback, GooglePlayGamesBasicApiNearby::IMessageListener* listener) {
		return ((R (*)(AndroidNearbyConnectionClient*, Il2CppString*, Il2CppString*, Il2CppArray<uint8_t>*, Action1<GooglePlayGamesBasicApiNearby::ConnectionResponse>*, GooglePlayGamesBasicApiNearby::IMessageListener*))(Il2CppBase() + 0x12B6084))(this, name, remoteEndpointId, payload, responseCallback, listener);
	}
	...
	template <typename R = void> R StartDiscovery(Il2CppString* serviceId, Nullable1<uintptr_t>* advertisingDuration, GooglePlayGamesBasicApiNearby::IDiscoveryListener* listener) {
		return ((R (*)(AndroidNearbyConnectionClient*, Il2CppString*, Nullable1<uintptr_t>*, GooglePlayGamesBasicApiNearby::IDiscoveryListener*))(Il2CppBase() + 0x12B68F0))(this, serviceId, advertisingDuration, listener);
	}
