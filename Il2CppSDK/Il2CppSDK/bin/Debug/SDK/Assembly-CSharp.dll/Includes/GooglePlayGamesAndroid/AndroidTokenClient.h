...
public: 
	...
	template <typename R = void> R FetchTokens(bool silent, Action1<int32_t>* callback) {
		return ((R (*)(AndroidTokenClient*, bool, Action1<int32_t>*))(Il2CppBase() + 0x1887BAC))(this, silent, callback);
	}
	template <typename R = void> R RequestPermissions(Il2CppArray<Il2CppString*>* scopes, Action1<GooglePlayGamesBasicApi::SignInStatus>* callback) {
		return ((R (*)(AndroidTokenClient*, Il2CppArray<Il2CppString*>*, Action1<GooglePlayGamesBasicApi::SignInStatus>*))(Il2CppBase() + 0x1887CBC))(this, scopes, callback);
	}
	...
	template <typename R = void> R DoFetchToken(bool silent, Action1<int32_t>* callback) {
		return ((R (*)(AndroidTokenClient*, bool, Action1<int32_t>*))(Il2CppBase() + 0x188854C))(this, silent, callback);
	}
	...
	template <typename R = void> R GetAnotherServerAuthCode(bool reAuthenticateIfNeeded, Action1<Il2CppString*>* callback) {
		return ((R (*)(AndroidTokenClient*, bool, Action1<Il2CppString*>*))(Il2CppBase() + 0x1888FD0))(this, reAuthenticateIfNeeded, callback);
	}
	template <typename R = void> R DoGetAnotherServerAuthCode(bool reAuthenticateIfNeeded, Action1<Il2CppString*>* callback) {
		return ((R (*)(AndroidTokenClient*, bool, Action1<Il2CppString*>*))(Il2CppBase() + 0x18890E0))(this, reAuthenticateIfNeeded, callback);
	}
