...
public: 
	...
	template <typename R = Il2CppString*> R& _hudEmojiPanelTag() {
	 ...
	 Action1bool>*& _onSwitchSettings() {
		return *(Action1bool>**)((uintptr_t)this + 0xC0);
	}
	...
	template <typename R = Il2CppArray<Il2CppString*>*> R& _armingEmojis() {
	 ...
	 Nullable1int32_t>*& _newCount() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0xE0);
	}
	 Nullable1bool>*& _firstBanner() {
		return *(Nullable1bool>**)((uintptr_t)this + 0xE8);
	}

	template <typename R = void> R Awake() {
		return ((R (*)(EmojiPanelController*))(Il2CppBase() + 0x136C8D8))(this);
	}
	template <typename R = void> R Bind(HUDWindow* window, Action1bool>* onSwitchSettings) {
		return ((R (*)(EmojiPanelController*, HUDWindow*, Action1bool>*))(Il2CppBase() + 0x136C974))(this, window, onSwitchSettings);
	}
