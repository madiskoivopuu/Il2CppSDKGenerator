...
public: 
	...
	template <typename T = void> T CopyTo(uintptr_t targetObject) {
		return ((T (*)(BaseInventoryComponent*, uintptr_t))(Il2CppBase() + 0x166CF7C))(this, targetObject);
	}
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(BaseInventoryComponent*, uintptr_t))(Il2CppBase() + 0x166D030))(this, blueprintComponent);
	}
