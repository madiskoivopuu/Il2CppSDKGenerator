...
public: 
	...
	template <typename R = void> R Bind(PrerequisiteWindow* window, GameEntity* entity, Action1<ButtonHelper*>* onButtonClicked) {
		return ((R (*)(DungeonGradeButton*, PrerequisiteWindow*, GameEntity*, Action1<ButtonHelper*>*))(Il2CppBase() + 0x130D638))(this, window, entity, onButtonClicked);
	}
