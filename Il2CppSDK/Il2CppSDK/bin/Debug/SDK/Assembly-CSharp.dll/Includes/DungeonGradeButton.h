...
class DungeonGradeButton: ButtonHelper
{
public: 
	...
	template <typename T = Il2CppVector2> T& _centerPosition() {
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t entity, void* onButtonClicked) {
		return ((T (*)(DungeonGradeButton*, uintptr_t, uintptr_t, void*))(Il2CppBase() + 0x130D638))(this, window, entity, onButtonClicked);
	}
	...
	template <typename T = void> T OnOtherButtonPressed(uintptr_t button) {
		return ((T (*)(DungeonGradeButton*, uintptr_t))(Il2CppBase() + 0x130DA6C))(this, button);
	}
