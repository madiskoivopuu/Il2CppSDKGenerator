...
public: 
	...
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidUserName(Il2CppString* name) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x155ABF4))(0, name);
	}
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidClanName(Il2CppString* name) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x155AFB4))(0, name);
	}
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidGuildTag(Il2CppString* tag) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x155B17C))(0, tag);
	}
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidGuildName(Il2CppString* name) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x155B254))(0, name);
	}
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidGuildDescription(Il2CppString* desc) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x155B41C))(0, desc);
	}
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidGuildMessage(Il2CppString* message) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x155B634))(0, message);
	}
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidText(Il2CppString* text, int32_t minCount, int32_t maxCount, Il2CppArray<uintptr_t>* allowedSymbols) {
	...
	template <typename T = ValueTuple2Il2CppString*, NameError*>*> static T CheckValidText_1(Il2CppString* text, Il2CppArray<uintptr_t>* allowedSymbols) {
