...
public: 
	...
	template <typename R = ConditionContext*> R& _conditions() {
	 ...
	 EntityIndex2MagicDataEntity*, Il2CppString*>*& _withTagIndex() {
		return *(EntityIndex2MagicDataEntity*, Il2CppString*>**)((uintptr_t)this + 0x120);
	}

	template <typename R = void> R AddEntityIndexes() {
		return ((R (*)(MagicDataContext*))(Il2CppBase() + 0x120A488))(this);
	}
	 HashSet1MagicDataEntity*>* GetEntitiesWithTag(Il2CppString* tag) {
		return ((HashSet1MagicDataEntity*>* (*)(MagicDataContext*, Il2CppString*))(Il2CppBase() + 0x120A680))(this, tag);
	}
	template <typename R = MagicDataEntity*> R GetEntityWithBlueprintOrNull(Il2CppString* name) {
	 ...
	 ValueTuple3bool, Il2CppString*, Il2CppArray<Il2CppString*>*>* GetMorphingParts(Il2CppString* name) {
		return ((ValueTuple3bool, Il2CppString*, Il2CppArray<Il2CppString*>*>* (*)(MagicDataContext*, Il2CppString*))(Il2CppBase() + 0x120A7B0))(this, name);
	}
