...
class MagicDataContext: DataContext1
{
public: 
	...
	template <typename T = uintptr_t> T& _magicTriggerData() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = uintptr_t> T& _conditions() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = void*> T& _withTagIndex() {
	...
	template <typename T = uintptr_t> T MorphingMagic(uintptr_t baseMagic, Il2CppString* name, Il2CppArray<uintptr_t>* parameters) {
		return ((T (*)(MagicDataContext*, uintptr_t, Il2CppString*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x120A928))(this, baseMagic, name, parameters);
	}
	template <typename T = void> T CreateRuneMagic(uintptr_t magicData, Il2CppString* paramValue) {
		return ((T (*)(MagicDataContext*, uintptr_t, Il2CppString*))(Il2CppBase() + 0x120BA74))(this, magicData, paramValue);
	}
	template <typename T = void> T Fill(Il2CppDictionary<Il2CppString*, uintptr_t>* blueprints) {
		return ((T (*)(MagicDataContext*, Il2CppDictionary<Il2CppString*, uintptr_t>*))(Il2CppBase() + 0x120CDBC))(this, blueprints);
	}
