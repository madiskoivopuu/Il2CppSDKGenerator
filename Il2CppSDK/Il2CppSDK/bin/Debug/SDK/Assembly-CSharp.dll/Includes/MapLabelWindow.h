...
public: 
	...
	template <typename R = uintptr_t> R& PointSelectorPrefab() {
	 ...
	 HashSet1Il2CppString*>*& _visiblePoints() {
		return *(HashSet1Il2CppString*>**)((uintptr_t)this + 0x108);
	}
	...
	template <typename R = void> R AddElementsForArrow(HashSet1GameEntity*>* elementForArrow, bool players) {
		return ((R (*)(MapLabelWindow*, HashSet1GameEntity*>*, bool))(Il2CppBase() + 0x12753A4))(this, elementForArrow, players);
	}
