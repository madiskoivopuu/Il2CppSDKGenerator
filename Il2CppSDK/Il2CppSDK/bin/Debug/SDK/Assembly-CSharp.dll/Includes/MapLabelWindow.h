...
class MapLabelWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& AvatarLabel() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = uintptr_t> T& LocationLabelPrefab() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = uintptr_t> T& PlayerLabelPrefab() {
		return *(T*)((uintptr_t)this + 0xB0);
	}
	template <typename T = uintptr_t> T& PlayerArrowPrefab() {
		return *(T*)((uintptr_t)this + 0xB8);
	}
	template <typename T = uintptr_t> T& PointArrowPrefab() {
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _playerLabels() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _pointLabels() {
		return *(T*)((uintptr_t)this + 0xF0);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _playerArrows() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _pointArrows() {
		return *(T*)((uintptr_t)this + 0x100);
	}
	template <typename T = void*> T& _visiblePoints() {
	...
	template <typename T = uintptr_t> T& _selectedPoint() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = uintptr_t> T& _pointSelector() {
		return *(T*)((uintptr_t)this + 0x128);
	}
	template <typename T = uintptr_t> T& _locationWindow() {
		return *(T*)((uintptr_t)this + 0x130);
	}
	template <typename T = Il2CppVector3> T& _socialHubSelectorScale() {
		return *(T*)((uintptr_t)this + 0x138);
	}
	template <typename T = Il2CppVector3> T& _commonSelectorScale() {
		return *(T*)((uintptr_t)this + 0x144);
	}
	template <typename T = uintptr_t> static T& _arrowMarkerComparer() {
	...
	template <typename T = void> T AddElementsForArrow(void* elementForArrow, bool players) {
		return ((T (*)(MapLabelWindow*, void*, bool))(Il2CppBase() + 0x12753A4))(this, elementForArrow, players);
	}
	...
	template <typename T = void> T MoveToPoint(uintptr_t entity) {
		return ((T (*)(MapLabelWindow*, uintptr_t))(Il2CppBase() + 0x1276EA4))(this, entity);
	}
	...
	template <typename T = void> T SelectNextPoint(uintptr_t move) {
		return ((T (*)(MapLabelWindow*, uintptr_t))(Il2CppBase() + 0x1277040))(this, move);
	}
	template <typename T = bool> T IsFOWUnlocked(uintptr_t world, uintptr_t point) {
		return ((T (*)(MapLabelWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x12778BC))(this, world, point);
	}
