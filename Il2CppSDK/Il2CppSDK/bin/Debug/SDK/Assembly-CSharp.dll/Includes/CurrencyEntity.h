...
public: 
	...
	template <typename T = BattlePassCurrencyComponent*> static T& battlePassCurrencyComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = GlobalTourneyComponent*> static T& globalTourneyComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = ResetOnSeasonComponent*> static T& resetOnSeasonComponent() {
	...
	template <typename T = void> T AddCurrencyType(CurrencyType* newType) {
		return ((T (*)(CurrencyEntity*, CurrencyType*))(Il2CppBase() + 0x1BD0290))(this, newType);
	}
	template <typename T = void> T ReplaceCurrencyType(CurrencyType* newType) {
		return ((T (*)(CurrencyEntity*, CurrencyType*))(Il2CppBase() + 0x1BD0394))(this, newType);
	}
	...
	template <typename T = ItemsComponent*> T get_items() {
	...
	template <typename T = LimitedComponent*> T get_limited() {
	...
	template <typename T = void> T AddLimited(Nullable1int32_t>* newMin, Nullable1int32_t>* newMax) {
		return ((T (*)(CurrencyEntity*, Nullable1int32_t>*, Nullable1int32_t>*))(Il2CppBase() + 0x1BD0984))(this, newMin, newMax);
	}
	template <typename T = void> T ReplaceLimited(Nullable1int32_t>* newMin, Nullable1int32_t>* newMax) {
		return ((T (*)(CurrencyEntity*, Nullable1int32_t>*, Nullable1int32_t>*))(Il2CppBase() + 0x1BD0A8C))(this, newMin, newMax);
	}
