...
public: 
	...
	template <typename R = void> R AddLimited(Nullable1<int32_t>* newMin, Nullable1<int32_t>* newMax) {
		return ((R (*)(CurrencyEntity*, Nullable1<int32_t>*, Nullable1<int32_t>*))(Il2CppBase() + 0x1BD0984))(this, newMin, newMax);
	}
	template <typename R = void> R ReplaceLimited(Nullable1<int32_t>* newMin, Nullable1<int32_t>* newMax) {
		return ((R (*)(CurrencyEntity*, Nullable1<int32_t>*, Nullable1<int32_t>*))(Il2CppBase() + 0x1BD0A8C))(this, newMin, newMax);
	}
