...
public: 
	...
	template <typename T = void> static T SetIcon(uintptr_t image, IIconEntity* entity, Il2CppString* defaultIcon) {
		return ((T (*)(void *, uintptr_t, IIconEntity*, Il2CppString*))(Il2CppBase() + 0x1E3D1D8))(0, image, entity, defaultIcon);
	}
	...
	template <typename T = void> static T SetIcon_2(uintptr_t image, Icon* icon, Il2CppString* defaultIcon) {
		return ((T (*)(void *, uintptr_t, Icon*, Il2CppString*))(Il2CppBase() + 0x1E3D220))(0, image, icon, defaultIcon);
	}
