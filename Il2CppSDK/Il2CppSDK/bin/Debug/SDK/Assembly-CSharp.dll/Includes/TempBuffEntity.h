...
public: 
	...
	template <typename T = ServerLifeTimeComponent*> static T& serverLifeTimeComponent() {
	...
	template <typename T = void> T AddApplyTargetMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(TempBuffEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x16B0B08))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceApplyTargetMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(TempBuffEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x16B0C70))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	...
	template <typename T = void> T AddPositionTransaction(Ease* newEase, float newDuration, int64_t newStartTime, Vec2* newStartPosition, Vec2* newEndPosition) {
		return ((T (*)(TempBuffEntity*, Ease*, float, int64_t, Vec2*, Vec2*))(Il2CppBase() + 0x16B1D10))(this, newEase, newDuration, newStartTime, newStartPosition, newEndPosition);
	}
	template <typename T = void> T ReplacePositionTransaction(Ease* newEase, float newDuration, int64_t newStartTime, Vec2* newStartPosition, Vec2* newEndPosition) {
		return ((T (*)(TempBuffEntity*, Ease*, float, int64_t, Vec2*, Vec2*))(Il2CppBase() + 0x16B1E54))(this, newEase, newDuration, newStartTime, newStartPosition, newEndPosition);
	}
	...
	template <typename T = void> T AddTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, CyclicTime* newCyclic) {
		return ((T (*)(TempBuffEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, CyclicTime*))(Il2CppBase() + 0x16B26FC))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
	template <typename T = void> T ReplaceTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, CyclicTime* newCyclic) {
		return ((T (*)(TempBuffEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, CyclicTime*))(Il2CppBase() + 0x16B2848))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
	...
	template <typename T = void> T AddToolTip(ToolTipValue* newValue) {
		return ((T (*)(TempBuffEntity*, ToolTipValue*))(Il2CppBase() + 0x16B2A34))(this, newValue);
	}
	template <typename T = void> T ReplaceToolTip(ToolTipValue* newValue) {
		return ((T (*)(TempBuffEntity*, ToolTipValue*))(Il2CppBase() + 0x16B2B48))(this, newValue);
	}
	...
	template <typename T = VersionComponent*> T get_version() {
