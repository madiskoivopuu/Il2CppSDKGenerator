...
public: 
	...
	template <typename R = ManualQuestTrackerView*> R& 4__this() {
	 ...
	 Action1Content1Data*>*>*& onComplete() {
		return *(Action1Content1Data*>*>**)((uintptr_t)this + 0x30);
	}
	 TaskAwaiter1IAwaitable1Il2CppString*>*>*& u__1() {
		return *(TaskAwaiter1IAwaitable1Il2CppString*>*>**)((uintptr_t)this + 0x38);
	}
