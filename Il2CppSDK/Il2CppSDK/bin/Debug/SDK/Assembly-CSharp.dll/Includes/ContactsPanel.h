...
public: 
	...
	template <typename R = uintptr_t> R& RecentCounterText() {
	 ...
	 IGroup1ContactsEntity*>*& _unreadGroup() {
		return *(IGroup1ContactsEntity*>**)((uintptr_t)this + 0x58);
	}
	template <typename R = ContactsEntity*> R& _currentSelectedContact() {
		return *(R*)((uintptr_t)this + 0x60);
	}
	 Action1ContactsEntity*>*& _onContactSelected() {
		return *(Action1ContactsEntity*>**)((uintptr_t)this + 0x68);
	}
	...
	template <typename R = void> R Initialize(Action1ContactsEntity*>* onContactSelected) {
		return ((R (*)(ContactsPanel*, Action1ContactsEntity*>*))(Il2CppBase() + 0x15F0218))(this, onContactSelected);
	}
