...
public: 
	...
	template <typename T = uintptr_t> T& _loader() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = uintptr_t> T& _logger() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = uintptr_t> T& _analytics() {
	...
	template <typename T = void*> T& OnProgressChanged() {
	...
	template <typename T = void> T add_OnProgressChanged(void* value) {
		return ((T (*)(BaseLoaderStep*, void*))(Il2CppBase() + 0x166E0B8))(this, value);
	}
	template <typename T = void> T remove_OnProgressChanged(void* value) {
		return ((T (*)(BaseLoaderStep*, void*))(Il2CppBase() + 0x166E158))(this, value);
	}
	...
	template <typename T = void> T ShowOopsWindow(void* onClose) {
		return ((T (*)(BaseLoaderStep*, void*))(Il2CppBase() + 0x166ED7C))(this, onClose);
	}
