...
public: 
	...
	template <typename R = bool> R& IsStepCompleted() {
	 ...
	 Action3<int32_t, int32_t, float>*& OnProgressChanged() {
		return *(Action3<int32_t, int32_t, float>**)((uintptr_t)this + 0x90);
	}
	...
	template <typename R = void> R add_OnProgressChanged(Action3<int32_t, int32_t, float>* value) {
		return ((R (*)(BaseLoaderStep*, Action3<int32_t, int32_t, float>*))(Il2CppBase() + 0x166E0B8))(this, value);
	}
	template <typename R = void> R remove_OnProgressChanged(Action3<int32_t, int32_t, float>* value) {
		return ((R (*)(BaseLoaderStep*, Action3<int32_t, int32_t, float>*))(Il2CppBase() + 0x166E158))(this, value);
	}
	...
	template <typename R = void> R ShowOopsWindow(Action1<int32_t>* onClose) {
		return ((R (*)(BaseLoaderStep*, Action1<int32_t>*))(Il2CppBase() + 0x166ED7C))(this, onClose);
	}
