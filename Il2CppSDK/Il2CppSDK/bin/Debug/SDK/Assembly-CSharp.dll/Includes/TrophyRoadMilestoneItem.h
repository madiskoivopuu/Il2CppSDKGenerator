...
public: 
	...
	template <typename T = ContentSizeData*> T& _sizeData() {
	...
	template <typename T = void> T Bind(TrophyRoadWindow* window, TrophyRoadEntity* tropyRoadEntity) {
		return ((T (*)(TrophyRoadMilestoneItem*, TrophyRoadWindow*, TrophyRoadEntity*))(Il2CppBase() + 0x1028D68))(this, window, tropyRoadEntity);
	}
	template <typename T = void> T Init(int32_t level) {
		return ((T (*)(TrophyRoadMilestoneItem*, int32_t))(Il2CppBase() + 0x1028DD4))(this, level);
	}
	template <typename T = void> T UpdateItem(uintptr_t positionVectror) {
		return ((T (*)(TrophyRoadMilestoneItem*, uintptr_t))(Il2CppBase() + 0x1028EEC))(this, positionVectror);
	}
