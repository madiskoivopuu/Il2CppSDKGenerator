...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 ICollector1<TEntity>*& _collector() {
		return *(ICollector1<TEntity>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& _toStringCache() {
	 ...
	 ICollector1<TEntity>* GetTrigger(IContext1<TEntity>* context) {
		return ((ICollector1<TEntity>* (*)(ReactiveWhileSystem1*, IContext1<TEntity>*))(Il2CppBase() + 0x0))(this, context);
	}
