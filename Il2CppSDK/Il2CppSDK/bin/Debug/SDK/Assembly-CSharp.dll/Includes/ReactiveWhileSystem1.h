...
public: 
	...
	template <typename T = ICollector1uintptr_t>*> T& _collector() {
	...
	template <typename T = ICollector1uintptr_t>*> T GetTrigger(IContext1uintptr_t>* context) {
		return ((T (*)(ReactiveWhileSystem1*, IContext1uintptr_t>*))(Il2CppBase() + 0x0))(this, context);
	}
