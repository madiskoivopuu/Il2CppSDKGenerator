...
public: 
	...
	template <typename T = LocationModeButton*> T& _modeBtnPrefab() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = Il2CppList<LocationModeButton*>*> T& _modeBtns() {
	...
	template <typename T = TextMonoBehaviour*> T& _resetCooldownText() {
		return *(T*)((uintptr_t)this + 0x160);
	}
	template <typename T = uintptr_t> T& _raycastBlocker() {
		return *(T*)((uintptr_t)this + 0x168);
	}
	template <typename T = LocationMode*> T& _locationMode() {
	...
	template <typename T = void> T ShowMode(LocationModeButton* btn) {
		return ((T (*)(LocationCustomModeWindow*, LocationModeButton*))(Il2CppBase() + 0x17A1C2C))(this, btn);
	}
	template <typename T = void> T ShowLocation(LocationEntity* location) {
		return ((T (*)(LocationCustomModeWindow*, LocationEntity*))(Il2CppBase() + 0x17A1E0C))(this, location);
	}
	...
	template <typename T = void> T UpdateTimer(GameEntity* point, HashSet1LocationEntity*>* locations) {
		return ((T (*)(LocationCustomModeWindow*, GameEntity*, HashSet1LocationEntity*>*))(Il2CppBase() + 0x17A46DC))(this, point, locations);
	}
	template <typename T = void> T OnClickHoldedHandler(ItemEntity* item, float duration) {
		return ((T (*)(LocationCustomModeWindow*, ItemEntity*, float))(Il2CppBase() + 0x17A62C4))(this, item, duration);
	}
	template <typename T = void> T OnLocationResetResponse(LocationResetResponseData* response) {
		return ((T (*)(LocationCustomModeWindow*, LocationResetResponseData*))(Il2CppBase() + 0x17A6490))(this, response);
	}
