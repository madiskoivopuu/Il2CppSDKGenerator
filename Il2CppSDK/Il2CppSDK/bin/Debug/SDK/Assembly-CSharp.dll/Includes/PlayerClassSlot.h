...
public: 
	...
	template <typename R = ItemEntity*> R& ClassEntity() {
	 ...
	 Action1PlayerClassSlot*>*& ClickEvent() {
		return *(Action1PlayerClassSlot*>**)((uintptr_t)this + 0x78);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1PlayerClassSlot*>* value) {
		return ((R (*)(PlayerClassSlot*, Action1PlayerClassSlot*>*))(Il2CppBase() + 0x1B73B2C))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1PlayerClassSlot*>* value) {
		return ((R (*)(PlayerClassSlot*, Action1PlayerClassSlot*>*))(Il2CppBase() + 0x1B73BCC))(this, value);
	}
