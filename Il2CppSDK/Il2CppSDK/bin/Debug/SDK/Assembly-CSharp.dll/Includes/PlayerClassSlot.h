...
public: 
	...
	template <typename T = ItemEntity*> T& ClassEntity() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = Action1PlayerClassSlot*>*> T& ClickEvent() {
	...
	template <typename T = void> T set_ClassEntity(ItemEntity* value) {
		return ((T (*)(PlayerClassSlot*, ItemEntity*))(Il2CppBase() + 0x1B73B24))(this, value);
	}
	template <typename T = void> T add_ClickEvent(Action1PlayerClassSlot*>* value) {
		return ((T (*)(PlayerClassSlot*, Action1PlayerClassSlot*>*))(Il2CppBase() + 0x1B73B2C))(this, value);
	}
	template <typename T = void> T remove_ClickEvent(Action1PlayerClassSlot*>* value) {
		return ((T (*)(PlayerClassSlot*, Action1PlayerClassSlot*>*))(Il2CppBase() + 0x1B73BCC))(this, value);
	}
	...
	template <typename T = void> T Init(TooltipView* tooltipView) {
		return ((T (*)(PlayerClassSlot*, TooltipView*))(Il2CppBase() + 0x1B73DAC))(this, tooltipView);
	}
	...
	template <typename T = void> T UpdateView(GameEntity* avatar) {
		return ((T (*)(PlayerClassSlot*, GameEntity*))(Il2CppBase() + 0x1B73DD0))(this, avatar);
	}
