...
public: 
	...
	template <typename T = void*> static T& _matcherServerLifeTime() {
	...
	template <typename T = void*> static T& _matcherVersion() {
	...
	template <typename T = void*> static T get_ServerLifeTime() {
	...
	template <typename T = void*> static T get_Version() {
