...
public: 
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t panel, unsigned char cellId) {
		return ((T (*)(ClanManagementCell*, uintptr_t, uintptr_t, unsigned char))(Il2CppBase() + 0x158F7E4))(this, window, panel, cellId);
	}
	template <typename T = void*> T GetPlayer() {
