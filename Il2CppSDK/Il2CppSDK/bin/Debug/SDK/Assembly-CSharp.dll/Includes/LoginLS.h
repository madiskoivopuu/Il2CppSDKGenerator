...
public: 
	...
	template <typename R = LoginClientInfo*> R& _clientInfo() {
	 ...
	 static Action5Il2CppString*, Il2CppString*, IEnumerable1ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*>*& OnUserLogged() {
		return *(Action5Il2CppString*, Il2CppString*, IEnumerable1ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}

	template <typename R = bool> R get__canRepeat() {
		return ((R (*)(LoginLS*))(Il2CppBase() + 0x1729250))(this);
	}
	template <typename R = void> static R add_OnUserLogged(Action5Il2CppString*, Il2CppString*, IEnumerable1ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*>* value) {
		return ((R (*)(void *, Action5Il2CppString*, Il2CppString*, IEnumerable1ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*>*))(Il2CppBase() + 0x1729260))(0, value);
	}
	template <typename R = void> static R remove_OnUserLogged(Action5Il2CppString*, Il2CppString*, IEnumerable1ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*>* value) {
		return ((R (*)(void *, Action5Il2CppString*, Il2CppString*, IEnumerable1ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*>*))(Il2CppBase() + 0x172931C))(0, value);
	}
