...
public: 
	...
	template <typename T = void> T AddTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, uintptr_t newCyclic) {
		return ((T (*)(ITemporaryEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, uintptr_t))(Il2CppBase() + 0x0))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
