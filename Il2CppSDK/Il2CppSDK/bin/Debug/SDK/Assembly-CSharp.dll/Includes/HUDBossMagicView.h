...
public: 
	...
	template <typename T = uintptr_t> T& _magicTracker() {
	...
	template <typename T = void> T UpdateView(uintptr_t entity, uintptr_t magicTracker) {
		return ((T (*)(HUDBossMagicView*, uintptr_t, uintptr_t))(Il2CppBase() + 0x144C368))(this, entity, magicTracker);
	}
