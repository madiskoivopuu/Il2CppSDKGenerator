...
class BlueprintContext2 : public BaseContext1<uintptr_t>
{
public: 
	...
	template <typename T = void> T set_Data(DataContext1uintptr_t>* value) {
		return ((T (*)(BlueprintContext2*, DataContext1uintptr_t>*))(Il2CppBase() + 0x0))(this, value);
	}
	...
	template <typename T = uintptr_t> T CreateUsingBlueprint(Il2CppString* entityName, EntityBlueprint* entityData) {
		return ((T (*)(BlueprintContext2*, Il2CppString*, EntityBlueprint*))(Il2CppBase() + 0x0))(this, entityName, entityData);
	}
