...
public: 
	...
	template <typename T = MountTabButton*> T& TabPrefab() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = Il2CppList<MountTabButton*>*> T& Tabs() {
	...
	template <typename T = MountsGuideWindow*> T& _mountsGuideWindow() {
		return *(T*)((uintptr_t)this + 0x60);
	}

	template <typename T = void> T Init(MountsGuideWindow* mountsGuideWindow) {
		return ((T (*)(MountsGuideTabsController*, MountsGuideWindow*))(Il2CppBase() + 0x154A4AC))(this, mountsGuideWindow);
	}
	template <typename T = void> T OnMountTabClick(MountTabButton* tab) {
		return ((T (*)(MountsGuideTabsController*, MountTabButton*))(Il2CppBase() + 0x154AD8C))(this, tab);
	}
	...
	template <typename T = void> T ShowTab(MountTabButton* activeTab) {
		return ((T (*)(MountsGuideTabsController*, MountTabButton*))(Il2CppBase() + 0x154ABF0))(this, activeTab);
	}
