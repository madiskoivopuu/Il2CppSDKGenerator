...
public: 
	...
	template <typename T = void> T Bind(IPetsInventoryWindow* window, GameEntity* entity, int32_t index) {
		return ((T (*)(PetItemDragged*, IPetsInventoryWindow*, GameEntity*, int32_t))(Il2CppBase() + 0x16EC800))(this, window, entity, index);
	}
