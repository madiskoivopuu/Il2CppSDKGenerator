...
public: 
	...
	template <typename R = Il2CppObject*> R System_Collections_IEnumerator_get_Current() {
	 ...
	 IEnumerator1<uintptr_t>* System_Collections_Generic_IEnumerableNewtonsoft_Json_JsonConverter_GetEnumerator() {
		return ((IEnumerator1<uintptr_t>* (*)(GetTypesWithHelpAttributed8*))(Il2CppBase() + 0x1157174))(this);
	}
