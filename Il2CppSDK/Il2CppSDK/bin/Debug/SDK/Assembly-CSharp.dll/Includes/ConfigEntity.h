...
public: 
	...
	template <typename T = uintptr_t> T get_actorDamageModsCoef() {
	...
	template <typename T = uintptr_t> T get_canBlocked() {
	...
	template <typename T = uintptr_t> T get_canLifeSteal() {
	...
	template <typename T = uintptr_t> T get_canReflect() {
	...
	template <typename T = void> T AddConfigType(uintptr_t newValue) {
		return ((T (*)(ConfigEntity*, uintptr_t))(Il2CppBase() + 0x15D7AB4))(this, newValue);
	}
	template <typename T = void> T ReplaceConfigType(uintptr_t newValue) {
		return ((T (*)(ConfigEntity*, uintptr_t))(Il2CppBase() + 0x15D7BB8))(this, newValue);
	}
	...
	template <typename T = uintptr_t> T get_descriptionStats() {
	...
	template <typename T = uintptr_t> T get_formatString() {
	...
	template <typename T = uintptr_t> T get_groupName() {
	...
	template <typename T = uintptr_t> T get_interrupt() {
	...
	template <typename T = uintptr_t> T get_oscillation() {
	...
	template <typename T = void> T AddPlayerStatType(uintptr_t newValue) {
		return ((T (*)(ConfigEntity*, uintptr_t))(Il2CppBase() + 0x15DB3B4))(this, newValue);
	}
	template <typename T = void> T ReplacePlayerStatType(uintptr_t newValue) {
		return ((T (*)(ConfigEntity*, uintptr_t))(Il2CppBase() + 0x15DB4B8))(this, newValue);
	}
	...
	template <typename T = uintptr_t> T get_raiseSelfHitTrigger() {
	...
	template <typename T = uintptr_t> T get_raiseTargetHitTrigger() {
	...
	template <typename T = uintptr_t> T get_targetArmorCoef() {
	...
	template <typename T = uintptr_t> T get_targetMitigationCoef() {
	...
	template <typename T = uintptr_t> T get_useActorBonusVsTarget() {
