...
public: 
	...
	template <typename R = uintptr_t> R& RegionSprite() {
	 ...
	 Action1<ClanPlayerView*>*& _onClick() {
		return *(Action1<ClanPlayerView*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = void> R Init(int64_t inviteId, Action1<ClanPlayerView*>* onClick) {
		return ((R (*)(ClanPlayerView*, int64_t, Action1<ClanPlayerView*>*))(Il2CppBase() + 0x15896DC))(this, inviteId, onClick);
	}
