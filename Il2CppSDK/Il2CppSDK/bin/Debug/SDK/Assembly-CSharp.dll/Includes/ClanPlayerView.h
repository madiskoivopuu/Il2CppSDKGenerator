...
public: 
	...
	template <typename T = Action1ClanPlayerView*>*> T& _onClick() {
	...
	template <typename T = void> T Init(int64_t inviteId, Action1ClanPlayerView*>* onClick) {
		return ((T (*)(ClanPlayerView*, int64_t, Action1ClanPlayerView*>*))(Il2CppBase() + 0x15896DC))(this, inviteId, onClick);
	}
