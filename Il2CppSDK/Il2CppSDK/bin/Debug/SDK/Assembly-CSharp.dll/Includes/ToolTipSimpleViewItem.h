...
class ToolTipSimpleViewItem: ToolTipViewBase
{
public: 
	...
	template <typename T = void> T Bind(uintptr_t source, Il2CppString* caption, Il2CppArray<uintptr_t>* description) {
		return ((T (*)(ToolTipSimpleViewItem*, uintptr_t, Il2CppString*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x14F1F04))(this, source, caption, description);
	}
