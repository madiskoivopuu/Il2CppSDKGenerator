...
public: 
	...
	template <typename R = bool> R& _donate() {
	 ...
	 HashSet1int32_t>*& _lockedSet() {
		return *(HashSet1int32_t>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = ItemEntity*> R GetItemEntity() {
	 ...
	 ValueTuple2Il2CppString*, Il2CppArray<Il2CppString*>*>* GetHelpTitleAndText() {
		return ((ValueTuple2Il2CppString*, Il2CppArray<Il2CppString*>*>* (*)(BaseCupWindow1*))(Il2CppBase() + 0x0))(this);
	}
	...
	template <typename R = uintptr_t> R DonateProgressAnimation(ValueTuple2int32_t, float>* newProgress, ValueTuple2int32_t, float>* proc, ValueTuple2int32_t, float>* superProc) {
		return ((R (*)(BaseCupWindow1*, ValueTuple2int32_t, float>*, ValueTuple2int32_t, float>*, ValueTuple2int32_t, float>*))(Il2CppBase() + 0x0))(this, newProgress, proc, superProc);
	}
