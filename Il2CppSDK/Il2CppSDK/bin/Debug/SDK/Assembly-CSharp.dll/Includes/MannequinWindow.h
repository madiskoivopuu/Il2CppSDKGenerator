...
class MannequinWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& AvatarPuppetRenderer() {
	...
	template <typename T = void> T InitPuppetSlots(uintptr_t entity, Il2CppArray<uintptr_t>* slots) {
		return ((T (*)(MannequinWindow*, uintptr_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x12624E0))(this, entity, slots);
	}
	template <typename T = void> T UpdateCloseTimer(uintptr_t target) {
		return ((T (*)(MannequinWindow*, uintptr_t))(Il2CppBase() + 0x1262A50))(this, target);
	}
	...
	template <typename T = void> T OnDoubleClick(uintptr_t item) {
		return ((T (*)(MannequinWindow*, uintptr_t))(Il2CppBase() + 0x1263444))(this, item);
	}
	template <typename T = void> T OnBeginDrag(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(MannequinWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1263790))(this, item, eventData);
	}
	template <typename T = void> T OnEndDrag(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(MannequinWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1263A7C))(this, item, eventData);
	}
	template <typename T = void> T UpdatePuppetSlots(Il2CppArray<uintptr_t>* puppetSlots, uintptr_t item) {
		return ((T (*)(MannequinWindow*, Il2CppArray<uintptr_t>*, uintptr_t))(Il2CppBase() + 0x1263854))(this, puppetSlots, item);
	}
