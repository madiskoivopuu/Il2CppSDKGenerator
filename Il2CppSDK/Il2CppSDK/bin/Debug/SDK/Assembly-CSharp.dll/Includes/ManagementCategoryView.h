...
#include "QuestCategoryView" 

class ManagementCategoryView: QuestCategoryView
{
public: 
	...
	template <typename T = void> T Bind(Il2CppString* categoryName, uintptr_t onSelect, void* notifyFunc) {
		return ((T (*)(ManagementCategoryView*, Il2CppString*, uintptr_t, void*))(Il2CppBase() + 0x125FEFC))(this, categoryName, onSelect, notifyFunc);
	}
