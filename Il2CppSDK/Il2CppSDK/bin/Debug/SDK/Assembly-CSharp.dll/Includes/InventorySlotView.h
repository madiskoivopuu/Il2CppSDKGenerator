...
public: 
	...
	template <typename R = void> R set_Durability(Nullable1float>* value) {
		return ((R (*)(InventorySlotView*, Nullable1float>*))(Il2CppBase() + 0x123EE88))(this, value);
	}
	template <typename R = void> R set_DurabilityEquipped(Nullable1float>* value) {
		return ((R (*)(InventorySlotView*, Nullable1float>*))(Il2CppBase() + 0x123EF08))(this, value);
	}
