...
public: 
	...
	template <typename T = void> T OnSelectedInventoryChanged(InventorySlotEntity* selectedInventory) {
		return ((T (*)(CampBathWindow*, InventorySlotEntity*))(Il2CppBase() + 0x15B43DC))(this, selectedInventory);
	}
	template <typename T = bool> T CanFill(InventorySlotEntity* inventoryEntity) {
		return ((T (*)(CampBathWindow*, InventorySlotEntity*))(Il2CppBase() + 0x15B4438))(this, inventoryEntity);
	}
	...
	template <typename T = void> T OnDoubleClick(IInventoryItem* item) {
		return ((T (*)(CampBathWindow*, IInventoryItem*))(Il2CppBase() + 0x15B469C))(this, item);
	}
	template <typename T = void> T UpdateProgressBar(GameEntity* target) {
		return ((T (*)(CampBathWindow*, GameEntity*))(Il2CppBase() + 0x15B48EC))(this, target);
	}
