...
public: 
	...
	template <typename T = Il2CppArray<uintptr_t>*> static T ZipWithPass_1(void* entries, Il2CppString* password) {
		return ((T (*)(void *, void*, Il2CppString*))(Il2CppBase() + 0x1133640))(0, entries, password);
	}
