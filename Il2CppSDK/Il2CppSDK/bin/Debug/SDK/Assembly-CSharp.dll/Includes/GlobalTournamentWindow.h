...
class GlobalTournamentWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& SelfView() {
	...
	template <typename T = uintptr_t> T& GuaranteeResultView() {
	...
	template <typename T = void> T InitGuaranteedRewards(uintptr_t world, uintptr_t tournament) {
		return ((T (*)(GlobalTournamentWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x12DC208))(this, world, tournament);
	}
	...
	template <typename T = bool> T NeedToUpdateRating(Il2CppArray<uintptr_t>** playerEntities) {
		return ((T (*)(GlobalTournamentWindow*, Il2CppArray<uintptr_t>**))(Il2CppBase() + 0x12DC6EC))(this, playerEntities);
	}
	template <typename T = void> T OnGlobalTournamentsPlayersFound(uintptr_t code, Il2CppArray<uintptr_t>* playerIds) {
		return ((T (*)(GlobalTournamentWindow*, uintptr_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x12DDB78))(this, code, playerIds);
	}
