...
public: 
	...
	template <typename T = bool> T Equals(RuneSlotKey* other) {
		return ((T (*)(RuneSlotKey*, RuneSlotKey*))(Il2CppBase() + 0x111BEB4))(this, other);
	}
	template <typename T = bool> T Equals_1(Il2CppObject* obj) {
		return ((T (*)(RuneSlotKey*, Il2CppObject*))(Il2CppBase() + 0x111BEDC))(this, obj);
	}
