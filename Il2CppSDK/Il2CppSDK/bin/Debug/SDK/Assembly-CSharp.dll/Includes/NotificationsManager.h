...
public: 
	...
	template <typename T = uintptr_t> T& _service() {
	...
	template <typename T = void> T Awakeb__6_0(void* task) {
		return ((T (*)(NotificationsManager*, void*))(Il2CppBase() + 0x13BB16C))(this, task);
	}
