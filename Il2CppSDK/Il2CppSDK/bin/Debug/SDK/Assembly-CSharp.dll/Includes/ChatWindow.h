...
public: 
	...
	template <typename T = uintptr_t> T& ChatInputField() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = uintptr_t> T& OpenChatButton() {
	...
	template <typename T = Il2CppQuaternion> T& _openChatButtonRotation() {
		return *(T*)((uintptr_t)this + 0xD0);
	}
	template <typename T = Il2CppQuaternion> T& _closeChatButtonRotation() {
	...
	template <typename T = uintptr_t> T& channelPrefab() {
		return *(T*)((uintptr_t)this + 0x100);
	}
	template <typename T = uintptr_t> T& ContactsChannelPrefab() {
		return *(T*)((uintptr_t)this + 0x108);
	}
	template <typename T = uintptr_t> T& MessagesContainer() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = uintptr_t> T& MessagePrefab() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = uintptr_t> T& CaptionOnlineToggle() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = uintptr_t> T& ContactsPanel() {
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _channelViews() {
	...
	template <typename T = uintptr_t> T& _currentChannel() {
		return *(T*)((uintptr_t)this + 0x168);
	}
	template <typename T = uintptr_t> T& _currentSelectedDataChannel() {
	...
	template <typename T = void> T OnContactsChannelSelected(uintptr_t channel) {
		return ((T (*)(ChatWindow*, uintptr_t))(Il2CppBase() + 0x173904C))(this, channel);
	}
	template <typename T = void> T OnContactSelected(uintptr_t entity) {
		return ((T (*)(ChatWindow*, uintptr_t))(Il2CppBase() + 0x173AD70))(this, entity);
	}
	template <typename T = void> T OnChatChannelSelected(uintptr_t channel) {
		return ((T (*)(ChatWindow*, uintptr_t))(Il2CppBase() + 0x1739388))(this, channel);
	}
	template <typename T = void> T CreateBubble(uintptr_t e) {
		return ((T (*)(ChatWindow*, uintptr_t))(Il2CppBase() + 0x173B6E8))(this, e);
	}
	...
	template <typename T = void> T OnContactUpdate(uintptr_t e) {
		return ((T (*)(ChatWindow*, uintptr_t))(Il2CppBase() + 0x173C180))(this, e);
	}
	template <typename T = void> T OnNewMessage(uintptr_t e) {
		return ((T (*)(ChatWindow*, uintptr_t))(Il2CppBase() + 0x1735554))(this, e);
	}
