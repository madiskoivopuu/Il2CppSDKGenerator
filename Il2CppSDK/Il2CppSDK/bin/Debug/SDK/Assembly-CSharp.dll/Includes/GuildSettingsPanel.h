...
public: 
	...
	template <typename T = StandartButton*> T& SaveGuildButton() {
	...
	template <typename T = void> T Bind(UIWindow* window) {
		return ((T (*)(GuildSettingsPanel*, UIWindow*))(Il2CppBase() + 0x1941904))(this, window);
	}
	...
	template <typename T = bool> T CheckFieldValue(uintptr_t inputField, Il2CppString* defaultValue, Func2Il2CppString*, ValueTuple2Il2CppString*, NameError*>*>* checkFunk) {
		return ((T (*)(GuildSettingsPanel*, uintptr_t, Il2CppString*, Func2Il2CppString*, ValueTuple2Il2CppString*, NameError*>*>*))(Il2CppBase() + 0x1942724))(this, inputField, defaultValue, checkFunk);
	}
	...
	template <typename T = void> T OnUpdateGuildResponse(ErrorCodes* errorCode) {
		return ((T (*)(GuildSettingsPanel*, ErrorCodes*))(Il2CppBase() + 0x19432A4))(this, errorCode);
	}
