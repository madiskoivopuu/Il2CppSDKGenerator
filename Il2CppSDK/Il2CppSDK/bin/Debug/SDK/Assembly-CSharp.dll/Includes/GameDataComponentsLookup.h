...
public: 
	...
	template <typename T = int32_t> static T& AccumulativeExchange() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& ActivateOnLocationLocked() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& AddExpByGrade() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& AggroMeRadius() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& AIBattle() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& AIBattleTracker() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& AutoAttack() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& Bank() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& BoxCollision() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& BuildBlocker() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& ChestReward() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& CircleCollision() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& CollisionActive() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& CurrencyExchange() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& DailyShop() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& DailyTavern() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& DamageEffect() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& DefaultArming() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& DistrictLevelUpgrades() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& DungeonDifficulty() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& Exchange() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& Extract() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& Finalize() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& FindViewInScene() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& Fusion() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& GamePlace() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& GameSound() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& InfluenceByGrade() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& InteractCooldown() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& LootByGrade() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& Mannequin() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& MapPoint() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& OnGround() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& ProgressionExchange() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& SeasonPointsByGrade() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& ShieldTotem() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& SpawnEffect() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& StoreExperienceByGrade() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& VisualCollision() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& WallCollision() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = int32_t> static T& WorldType() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
