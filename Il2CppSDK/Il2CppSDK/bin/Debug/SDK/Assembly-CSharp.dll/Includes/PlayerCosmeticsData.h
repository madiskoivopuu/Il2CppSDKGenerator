...
public: 
	...
	template <typename T = uintptr_t> T& _dataContex() {
	...
	template <typename T = Il2CppArray<uintptr_t>*> T GetByEquipmentType(uintptr_t equipmentType) {
		return ((T (*)(PlayerCosmeticsData*, uintptr_t))(Il2CppBase() + 0x1563174))(this, equipmentType);
	}
	template <typename T = void*> T GetAvailableEmojis(uintptr_t account) {
		return ((T (*)(PlayerCosmeticsData*, uintptr_t))(Il2CppBase() + 0x1563238))(this, account);
	}
	template <typename T = void*> T GetAvailable(uintptr_t account, uintptr_t equipmentType) {
		return ((T (*)(PlayerCosmeticsData*, uintptr_t, uintptr_t))(Il2CppBase() + 0x15632CC))(this, account, equipmentType);
	}
