...
public: 
	...
	template <typename R = Il2CppArray<ItemEntity*>*> R GetByEquipmentType(EquipmentType equipmentType) {
	 ...
	 IEnumerable1<ItemEntity*>* GetAvailableEmojis(AccountEntity* account) {
		return ((IEnumerable1<ItemEntity*>* (*)(PlayerCosmeticsData*, AccountEntity*))(Il2CppBase() + 0x1563238))(this, account);
	}
	 IEnumerable1<ItemEntity*>* GetAvailable(AccountEntity* account, EquipmentType equipmentType) {
		return ((IEnumerable1<ItemEntity*>* (*)(PlayerCosmeticsData*, AccountEntity*, EquipmentType))(Il2CppBase() + 0x15632CC))(this, account, equipmentType);
	}
