...
public: 
	...
	template <typename R = bool> R& _disabled() {
	 ...
	 Action2Il2CppString*, bool>*& OnSelect() {
		return *(Action2Il2CppString*, bool>**)((uintptr_t)this + 0x80);
	}
	...
	template <typename R = void> R add_OnSelect(Action2Il2CppString*, bool>* value) {
		return ((R (*)(PlayerClassSwitchView*, Action2Il2CppString*, bool>*))(Il2CppBase() + 0x1B743AC))(this, value);
	}
	template <typename R = void> R remove_OnSelect(Action2Il2CppString*, bool>* value) {
		return ((R (*)(PlayerClassSwitchView*, Action2Il2CppString*, bool>*))(Il2CppBase() + 0x1B7444C))(this, value);
	}
	template <typename R = void> R Awake() {
		return ((R (*)(PlayerClassSwitchView*))(Il2CppBase() + 0x1B744EC))(this);
	}
	template <typename R = void> R Bind(IUIWindow* window, ItemEntity* classEntity, int64_t playerId, TooltipView* tooltipView, Action2Il2CppString*, bool>* onSelect, bool isSelected) {
		return ((R (*)(PlayerClassSwitchView*, IUIWindow*, ItemEntity*, int64_t, TooltipView*, Action2Il2CppString*, bool>*, bool))(Il2CppBase() + 0x1B695A0))(this, window, classEntity, playerId, tooltipView, onSelect, isSelected);
	}
