...
class TotemWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = void> T OnDoubleClick(uintptr_t item) {
		return ((T (*)(TotemWindow*, uintptr_t))(Il2CppBase() + 0x14FB688))(this, item);
	}
	...
	template <typename T = void> T OnSelectedInventoryChanged(uintptr_t selectedInventory) {
		return ((T (*)(TotemWindow*, uintptr_t))(Il2CppBase() + 0x14FB854))(this, selectedInventory);
	}
