...
class InventoryChestWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& _keySlot() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = uintptr_t> T& _openWithKeyButton() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = uintptr_t> T& _openWithoutKeyButton() {
	...
	template <typename T = void> T OnReceivedInventoryContainerResult(uintptr_t result) {
		return ((T (*)(InventoryChestWindow*, uintptr_t))(Il2CppBase() + 0x146E8A0))(this, result);
	}
