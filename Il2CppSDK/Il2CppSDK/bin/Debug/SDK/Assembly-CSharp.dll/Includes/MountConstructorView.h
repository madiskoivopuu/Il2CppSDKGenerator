...
public: 
	...
	template <typename R = void> R Bind(Icon icon, Il2CppString* name, Action1<Il2CppString*>* onSelect) {
		return ((R (*)(MountConstructorView*, Icon, Il2CppString*, Action1<Il2CppString*>*))(Il2CppBase() + 0x1EAAA28))(this, icon, name, onSelect);
	}
