...
public: 
	...
	template <typename T = void> T set_Status(uintptr_t value) {
		return ((T (*)(LeaderboardScoreData*, uintptr_t))(Il2CppBase() + 0x1429CE0))(this, value);
	}
	...
	template <typename T = int32_t> T AddScore(uintptr_t score) {
		return ((T (*)(LeaderboardScoreData*, uintptr_t))(Il2CppBase() + 0x1429D7C))(this, score);
	}
	...
	template <typename T = void> T set_PrevPageToken(uintptr_t value) {
		return ((T (*)(LeaderboardScoreData*, uintptr_t))(Il2CppBase() + 0x1429E04))(this, value);
	}
	...
	template <typename T = void> T set_NextPageToken(uintptr_t value) {
		return ((T (*)(LeaderboardScoreData*, uintptr_t))(Il2CppBase() + 0x1429E14))(this, value);
	}
