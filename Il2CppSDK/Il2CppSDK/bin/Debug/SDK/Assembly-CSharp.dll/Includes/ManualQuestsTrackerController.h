...
public: 
	...
	template <typename T = ManualQuestTrackerView*> T& _singleQuestViewPrefab() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = uintptr_t> T& _singleSeparator() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = ManualQuestTrackerView*> T& _dailyQuestViewPrefab() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = uintptr_t> T& _dailySeparator() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = ManualQuestTrackerView*> T& _questViewPrefab() {
	...
	template <typename T = Il2CppList<Slot1Data*>*>*> T& slots() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = QuestsSlotRoll*> T& slotRoll() {
	...
	template <typename T = Il2CppDictionary<int32_t, Content1Data*>*>*> T& contentPrefabs() {
	...
	template <typename T = void> T Init(IHUDWindow* window) {
		return ((T (*)(ManualQuestsTrackerController*, IHUDWindow*))(Il2CppBase() + 0x1265A8C))(this, window);
	}
	...
	template <typename T = void> T UpdateView(AccountEntity* accountEntity) {
		return ((T (*)(ManualQuestsTrackerController*, AccountEntity*))(Il2CppBase() + 0x126606C))(this, accountEntity);
	}
	...
	template <typename T = void> T UpdateQuestsNew(int64_t ownerId, Il2CppList<QuestEntity*>* currentQuests, uintptr_t bottom) {
		return ((T (*)(ManualQuestsTrackerController*, int64_t, Il2CppList<QuestEntity*>*, uintptr_t))(Il2CppBase() + 0x12668E0))(this, ownerId, currentQuests, bottom);
	}
	template <typename T = void> T OnClickQuest(ManualQuestTrackerView* view) {
		return ((T (*)(ManualQuestsTrackerController*, ManualQuestTrackerView*))(Il2CppBase() + 0x1266988))(this, view);
	}
