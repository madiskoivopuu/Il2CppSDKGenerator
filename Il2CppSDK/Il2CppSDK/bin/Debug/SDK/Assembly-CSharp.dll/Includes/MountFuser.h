...
public: 
	...
	template <typename R = Il2CppArray<ItemEntity*>*> R& _skillSlots() {
	 ...
	 HashSet1<Il2CppString*>*& _singleSkillGroups() {
		return *(HashSet1<Il2CppString*>**)((uintptr_t)this + 0x20);
	}
	...
	template <typename R = int32_t> R& CurrentPrice() {
	 ...
	 Nullable1<int32_t>*& InheritedTypeIndex() {
	...
	template <typename R = void> R set_CurrentPrice(int32_t value) {
	 ...
	 Nullable1<int32_t>* get_InheritedTypeIndex() {
		return ((Nullable1<int32_t>* (*)(MountFuser*))(Il2CppBase() + 0x1EAB808))(this);
	}
	template <typename R = void> R set_InheritedTypeIndex(Nullable1<int32_t>* value) {
		return ((R (*)(MountFuser*, Nullable1<int32_t>*))(Il2CppBase() + 0x1EAB810))(this, value);
	}
	...
	template <typename R = Result> R SelectInheritedType(Nullable1<int32_t>* slotIndex) {
		return ((R (*)(MountFuser*, Nullable1<int32_t>*))(Il2CppBase() + 0x1EACA74))(this, slotIndex);
	}
	...
	template <typename R = Result> R Fuse(ICommonContexts* world) {
	 ...
	 static ValueTuple2<ItemEntity*, Result>* ProcessFuse(ICommonContexts* world, int64_t playerId, IMountFuseSettings* settings, IList1<ItemEntity*>* slots, int32_t inheritedTypeIndex, Il2CppArray<int32_t>* selectedSkillSlots) {
		return ((ValueTuple2<ItemEntity*, Result>* (*)(void *, ICommonContexts*, int64_t, IMountFuseSettings*, IList1<ItemEntity*>*, int32_t, Il2CppArray<int32_t>*))(Il2CppBase() + 0x1EADA30))(0, world, playerId, settings, slots, inheritedTypeIndex, selectedSkillSlots);
	}
