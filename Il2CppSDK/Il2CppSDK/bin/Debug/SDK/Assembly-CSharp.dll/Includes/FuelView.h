...
public: 
	...
	template <typename T = uintptr_t> T& FuelItemPrefab() {
	...
	template <typename T = void> T Show(uintptr_t craftStation, uintptr_t fuel, uintptr_t tooltip) {
		return ((T (*)(FuelView*, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x15FEAD4))(this, craftStation, fuel, tooltip);
	}
