...
public: 
	...
	template <typename R = bool> static R IsBusyOrActionsBlocked(GameEntity* actor, ICommonContexts* world, int64_t now, Nullable1<ActionType>* ignore) {
		return ((R (*)(void *, GameEntity*, ICommonContexts*, int64_t, Nullable1<ActionType>*))(Il2CppBase() + 0x1DD2E90))(0, actor, world, now, ignore);
	}
	...
	template <typename R = bool> static R IsBusy(GameEntity* actor, ICommonContexts* world, int64_t now, Nullable1<ActionType>* ignore) {
		return ((R (*)(void *, GameEntity*, ICommonContexts*, int64_t, Nullable1<ActionType>*))(Il2CppBase() + 0x1DD2F78))(0, actor, world, now, ignore);
	}
	...
	template <typename R = bool> static R IsPlaceOwner(uintptr_t entity, ICommonContexts* world, GameEntity* target) {
	 ...
	 static ValueTuple4<InteractTemplate*, ItemEntity*, int32_t, float>* GetAction(ICommonContexts* world, GameEntity* entity, GameEntity* target, IInteractActionsEntity* interactEntity) {
		return ((ValueTuple4<InteractTemplate*, ItemEntity*, int32_t, float>* (*)(void *, ICommonContexts*, GameEntity*, GameEntity*, IInteractActionsEntity*))(Il2CppBase() + 0x1DD4570))(0, world, entity, target, interactEntity);
	}
	template <typename R = Il2CppString*> static R GetInteractIcon(ICommonContexts* world, GameEntity* entity, GameEntity* target) {
	 ...
	 static ValueTuple2<InventorySlotEntity*, ItemEntity*>* GetUseItem(ICommonContexts* world, GameEntity* entity, int32_t inventoryItemId) {
		return ((ValueTuple2<InventorySlotEntity*, ItemEntity*>* (*)(void *, ICommonContexts*, GameEntity*, int32_t))(Il2CppBase() + 0x1DD4910))(0, world, entity, inventoryItemId);
	}
	...
	template <typename R = ActionEntity*> static R CreateAction(ICommonContexts* world, ActionType actionType, ActionEntity* actionData, GameEntity* actor, GameEntity* target, ItemEntity* item, float durationCoef, int32_t inventoryItemId, float angle, int64_t startTime, float chance, Nullable1<int32_t>* sequenceValue) {
		return ((R (*)(void *, ICommonContexts*, ActionType, ActionEntity*, GameEntity*, GameEntity*, ItemEntity*, float, int32_t, float, int64_t, float, Nullable1<int32_t>*))(Il2CppBase() + 0x1DD5280))(0, world, actionType, actionData, actor, target, item, durationCoef, inventoryItemId, angle, startTime, chance, sequenceValue);
	}
	 static ValueTuple2<ActionBreakReasons, ActionEntity*>* StartAction(ICommonContexts* world, ActionType actionType, GameEntity* actor, GameEntity* target, IInteractActionsEntity* interactTarget, Il2CppString* itemName, int32_t inventoryItemId, float angle, int64_t startTime, float chance, Nullable1<int32_t>* sequenceValue, bool checkBreak) {
		return ((ValueTuple2<ActionBreakReasons, ActionEntity*>* (*)(void *, ICommonContexts*, ActionType, GameEntity*, GameEntity*, IInteractActionsEntity*, Il2CppString*, int32_t, float, int64_t, float, Nullable1<int32_t>*, bool))(Il2CppBase() + 0x1DD6054))(0, world, actionType, actor, target, interactTarget, itemName, inventoryItemId, angle, startTime, chance, sequenceValue, checkBreak);
	}
