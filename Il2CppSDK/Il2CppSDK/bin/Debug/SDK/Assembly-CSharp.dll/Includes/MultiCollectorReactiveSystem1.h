...
public: 
	...
	template <typename T = Il2CppArray<uintptr_t>*> T GetTriggers(IContext1uintptr_t>* context) {
		return ((T (*)(MultiCollectorReactiveSystem1*, IContext1uintptr_t>*))(Il2CppBase() + 0x0))(this, context);
	}
