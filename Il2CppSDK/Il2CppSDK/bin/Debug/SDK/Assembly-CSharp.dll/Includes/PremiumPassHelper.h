...
public: 
	...
	template <typename R = bool> static R HasPremiumPass(AccountEntity* account, Il2CppString* passName) {
	 ...
	 static ValueTuple2<bool, Il2CppString*>* HasPremiumPass_1(AccountEntity* account, ICommonContexts* world, CurrencyType currencyType) {
		return ((ValueTuple2<bool, Il2CppString*>* (*)(void *, AccountEntity*, ICommonContexts*, CurrencyType))(Il2CppBase() + 0x16E059C))(0, account, world, currencyType);
	}
	...
	template <typename R = int64_t> static R SetBattlePassLastActivityTime(AccountEntity* account, CurrencyType currencyType, int64_t time) {
	 ...
	 static ValueTuple2<int32_t, int32_t>* GetBattlePassSteps(AccountEntity* account, CurrencyType currencyType) {
		return ((ValueTuple2<int32_t, int32_t>* (*)(void *, AccountEntity*, CurrencyType))(Il2CppBase() + 0x16E0D70))(0, account, currencyType);
	}
