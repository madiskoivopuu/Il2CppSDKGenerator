...
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _skillsPanels() {
	...
	template <typename T = uintptr_t> T& VideoPreviewViewPrefab() {
		return *(T*)((uintptr_t)this + 0xC0);
	}
	template <typename T = uintptr_t> T& VideoPreviewViewInstance() {
		return *(T*)((uintptr_t)this + 0xC8);
	}
	template <typename T = uintptr_t> T& _window() {
		return *(T*)((uintptr_t)this + 0xD0);
	}
	template <typename T = uintptr_t> T& _bossEntity() {
	...
	template <typename T = uintptr_t> T get_VideoPreviewViewInstance() {
		return ((T (*)(BossDetailView*))(Il2CppBase() + 0x16C9D9C))(this);
	}
	template <typename T = void> T set_VideoPreviewViewInstance(uintptr_t value) {
		return ((T (*)(BossDetailView*, uintptr_t))(Il2CppBase() + 0x16C9DA4))(this, value);
	}
	template <typename T = void> T Init(uintptr_t window, uintptr_t tooltipView) {
		return ((T (*)(BossDetailView*, uintptr_t, uintptr_t))(Il2CppBase() + 0x16C9DAC))(this, window, tooltipView);
	}
	template <typename T = void> T InitVideoMenu() {
		return ((T (*)(BossDetailView*))(Il2CppBase() + 0x16C9F60))(this);
	}
	template <typename T = void> T Show(uintptr_t bossEntity, uintptr_t target) {
		return ((T (*)(BossDetailView*, uintptr_t, uintptr_t))(Il2CppBase() + 0x16CA140))(this, bossEntity, target);
	}
	template <typename T = void> T SetUpResourcesPanel(uintptr_t target) {
		return ((T (*)(BossDetailView*, uintptr_t))(Il2CppBase() + 0x16CAA78))(this, target);
	}
