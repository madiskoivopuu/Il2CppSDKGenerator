...
public: 
	...
	template <typename R = bool> static R RewardIsEmpty(QuestEntity* questEntity) {
	 ...
	 static ValueTuple2bool, bool>* IsQuestTrackedAndComplete(QuestEntity* questEntity) {
		return ((ValueTuple2bool, bool>* (*)(void *, QuestEntity*))(Il2CppBase() + 0x1C36A64))(0, questEntity);
	}
	 static ValueTuple2bool, bool>* IsUntrackableQuestTrackedAndComplete(QuestEntity* questEntity) {
		return ((ValueTuple2bool, bool>* (*)(void *, QuestEntity*))(Il2CppBase() + 0x1C36B24))(0, questEntity);
	}
