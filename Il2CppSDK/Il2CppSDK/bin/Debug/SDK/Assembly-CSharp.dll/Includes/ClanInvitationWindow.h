...
public: 
	...
	template <typename T = PlayerInviteView*> T& PlayerInvitePrefab() {
	...
	template <typename T = InviteComparer*> T& _inviteComparer() {
	...
	template <typename T = void> T OnPlayerNameClicked(PlayerNameView* view) {
		return ((T (*)(ClanInvitationWindow*, PlayerNameView*))(Il2CppBase() + 0x158BC4C))(this, view);
	}
