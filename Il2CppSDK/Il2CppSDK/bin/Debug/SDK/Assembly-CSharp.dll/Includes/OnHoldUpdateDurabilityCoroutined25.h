...
public: 
	...
	template <typename T = GameDataEntity*> T& targetData() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = HUDInteractButton*> T& 4__this() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = Il2CppArray<uintptr_t>*> T& requiredItems5__2() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = ValueTuple3InventorySlotEntity*, ItemEntity*, float>*> T& interactItem5__3() {
