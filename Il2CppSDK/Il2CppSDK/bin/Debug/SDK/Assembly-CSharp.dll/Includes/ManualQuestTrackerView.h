...
public: 
	...
	template <typename R = Il2CppString*> R& QuestName() {
	 ...
	 Action1<ManualQuestTrackerView*>*& OnClickEvent() {
		return *(Action1<ManualQuestTrackerView*>**)((uintptr_t)this + 0x88);
	}
	template <typename R = int32_t> R& _progress() {
		return *(R*)((uintptr_t)this + 0x90);
	}
	 Nullable1<bool>*& _completed() {
		return *(Nullable1<bool>**)((uintptr_t)this + 0x94);
	}
	...
	template <typename R = void> R add_OnClickEvent(Action1<ManualQuestTrackerView*>* value) {
		return ((R (*)(ManualQuestTrackerView*, Action1<ManualQuestTrackerView*>*))(Il2CppBase() + 0x12642F0))(this, value);
	}
	template <typename R = void> R remove_OnClickEvent(Action1<ManualQuestTrackerView*>* value) {
		return ((R (*)(ManualQuestTrackerView*, Action1<ManualQuestTrackerView*>*))(Il2CppBase() + 0x1264390))(this, value);
	}
	...
	template <typename R = void> R ShowNew_1(Action1<Content1<Data*>*>* onComplete) {
		return ((R (*)(ManualQuestTrackerView*, Action1<Content1<Data*>*>*))(Il2CppBase() + 0x1264F84))(this, onComplete);
	}
	template <typename R = void> R StartRemove_1(Action1<Content1<Data*>*>* onComplete) {
		return ((R (*)(ManualQuestTrackerView*, Action1<Content1<Data*>*>*))(Il2CppBase() + 0x1265084))(this, onComplete);
	}
