...
public: 
	...
	template <typename T = ClassInfoBase*> T& ClassSelectionHolder() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = ClassInfoBase*> T& CharacterCreationHolder() {
	...
	template <typename T = FaderBase*> T& Fader() {
		return *(T*)((uintptr_t)this + 0x158);
	}
	template <typename T = Gender*> T& _currentGender() {
		return *(T*)((uintptr_t)this + 0x160);
	}
	template <typename T = ItemEntity*> T& _currentHair() {
		return *(T*)((uintptr_t)this + 0x168);
	}
	template <typename T = ItemEntity*> T& _currentBeard() {
		return *(T*)((uintptr_t)this + 0x170);
	}
	template <typename T = ItemEntity*> T& _currentHairColor() {
		return *(T*)((uintptr_t)this + 0x178);
	}
	template <typename T = ItemEntity*> T& _currentSkinColor() {
		return *(T*)((uintptr_t)this + 0x180);
	}
	template <typename T = ItemEntity*> T& _currentFace() {
		return *(T*)((uintptr_t)this + 0x188);
	}
	template <typename T = Il2CppString*> T& _currentClassName() {
		return *(T*)((uintptr_t)this + 0x190);
	}
	template <typename T = Il2CppList<ItemEntity*>*> T& _hairs() {
		return *(T*)((uintptr_t)this + 0x198);
	}
	template <typename T = Il2CppList<ItemEntity*>*> T& _beards() {
		return *(T*)((uintptr_t)this + 0x1A0);
	}
	template <typename T = Il2CppList<ItemEntity*>*> T& _hairColors() {
		return *(T*)((uintptr_t)this + 0x1A8);
	}
	template <typename T = Il2CppList<ItemEntity*>*> T& _skinColors() {
		return *(T*)((uintptr_t)this + 0x1B0);
	}
	template <typename T = Il2CppList<ItemEntity*>*> T& _faces() {
		return *(T*)((uintptr_t)this + 0x1B8);
	}
	template <typename T = bool> T& _needToChangeQuality() {
		return *(T*)((uintptr_t)this + 0x1C0);
	}
	template <typename T = HashSet1ClientStartWindowEvent*>*> T& _wasSent() {
	...
	template <typename T = void> T UpdateCurrent(uintptr_t current, Il2CppList<ItemEntity*>* list, int32_t slotIndex) {
		return ((T (*)(CharacterCreationWindow*, uintptr_t, Il2CppList<ItemEntity*>*, int32_t))(Il2CppBase() + 0x13ED50C))(this, current, list, slotIndex);
	}
	...
	template <typename T = void> T OnClassClick(PuppetClassRendererController* puppetController) {
		return ((T (*)(CharacterCreationWindow*, PuppetClassRendererController*))(Il2CppBase() + 0x13EDC40))(this, puppetController);
	}
	...
	template <typename T = void> T OnNext(uintptr_t current, IList1ItemEntity*>* list, int32_t slotIndex) {
		return ((T (*)(CharacterCreationWindow*, uintptr_t, IList1ItemEntity*>*, int32_t))(Il2CppBase() + 0x13EE5A0))(this, current, list, slotIndex);
	}
	template <typename T = void> T OnPrev(uintptr_t current, Il2CppList<ItemEntity*>* list, int32_t slotIndex) {
		return ((T (*)(CharacterCreationWindow*, uintptr_t, Il2CppList<ItemEntity*>*, int32_t))(Il2CppBase() + 0x13EE85C))(this, current, list, slotIndex);
	}
	template <typename T = void> T OnClose() {
		return ((T (*)(CharacterCreationWindow*))(Il2CppBase() + 0x13EE9B8))(this);
	}
	template <typename T = void> T SendStat(ClientStartWindowEvent* windowEvent) {
		return ((T (*)(CharacterCreationWindow*, ClientStartWindowEvent*))(Il2CppBase() + 0x13ED42C))(this, windowEvent);
	}
