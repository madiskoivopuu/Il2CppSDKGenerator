...
public: 
	...
	template <typename R = bool> R& _needToChangeQuality() {
	 ...
	 HashSet1<ClientStartWindowEvent>*& _wasSent() {
		return *(HashSet1<ClientStartWindowEvent>**)((uintptr_t)this + 0x1C8);
	}
	...
	template <typename R = void> R OnNext(uintptr_t current, IList1<ItemEntity*>* list, int32_t slotIndex) {
		return ((R (*)(CharacterCreationWindow*, uintptr_t, IList1<ItemEntity*>*, int32_t))(Il2CppBase() + 0x13EE5A0))(this, current, list, slotIndex);
	}
