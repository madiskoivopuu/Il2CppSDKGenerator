...
public: 
	...
	template <typename T = MagicDescriptionItemView*> T& _itemViewPrefab() {
	...
	template <typename T = Il2CppList<MagicDescriptionItemView*>*> T& _itemViews() {
	...
	template <typename T = MagicDescriptionItemComparer*> static T& _magicDescriptionItemComparer() {
	...
	template <typename T = void> T Init(UIWindow* window) {
		return ((T (*)(HUDMagicsPanel*, UIWindow*))(Il2CppBase() + 0x145D458))(this, window);
	}
	template <typename T = void> T UpdateView(GameEntity* target) {
		return ((T (*)(HUDMagicsPanel*, GameEntity*))(Il2CppBase() + 0x145D688))(this, target);
	}
