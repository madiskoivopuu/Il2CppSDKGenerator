...
class HUDCustomizable: HUDCustomizableBase
{
public: 
	...
	template <typename T = uintptr_t> T& _initialState() {
	...
	template <typename T = void> T set_State(uintptr_t value) {
		return ((T (*)(HUDCustomizable*, uintptr_t))(Il2CppBase() + 0x144EE90))(this, value);
	}
	template <typename T = void> T Awake() {
		return ((T (*)(HUDCustomizable*))(Il2CppBase() + 0x1450890))(this);
	}
	template <typename T = void> T Bind(uintptr_t hudCustomizer) {
		return ((T (*)(HUDCustomizable*, uintptr_t))(Il2CppBase() + 0x144E43C))(this, hudCustomizer);
	}
