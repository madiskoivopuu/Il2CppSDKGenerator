...
public: 
	...
	template <typename T = AnimatorEventsProxy*> T& _proxy() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = void> T Init(HideHelper* hideHelper) {
		return ((T (*)(AnimatorEffects*, HideHelper*))(Il2CppBase() + 0x188D304))(this, hideHelper);
	}
	...
	template <typename T = void> T SpawnEffect(Effect* effect) {
		return ((T (*)(AnimatorEffects*, Effect*))(Il2CppBase() + 0x188D650))(this, effect);
	}
