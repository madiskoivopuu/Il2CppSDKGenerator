...
class CurrencyExchangeWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& _infoTooltipTrigger() {
	...
	template <typename T = uintptr_t> T& CurrencySlot() {
		return *(T*)((uintptr_t)this + 0x1D0);
	}
	template <typename T = uintptr_t> T& BuffSlot() {
	...
	template <typename T = void> T OnDoubleClick(uintptr_t item) {
		return ((T (*)(CurrencyExchangeWindow*, uintptr_t))(Il2CppBase() + 0x1BD2F74))(this, item);
	}
	template <typename T = void> T OnDrop(uintptr_t item) {
		return ((T (*)(CurrencyExchangeWindow*, uintptr_t))(Il2CppBase() + 0x1BD39F4))(this, item);
	}
	...
	template <typename T = bool> T UpdateInventoryEntity(uintptr_t inventoryEntity) {
		return ((T (*)(CurrencyExchangeWindow*, uintptr_t))(Il2CppBase() + 0x1BD439C))(this, inventoryEntity);
	}
