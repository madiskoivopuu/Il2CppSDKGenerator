...
public: 
	...
	template <typename R = float> R& InactivePercentAlpha() {
	 ...
	 Nullable1int32_t>*& _selectedExchangeSum() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0x1FC);
	}
	 Nullable1int32_t>*& _limit() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0x204);
	}
	...
	template <typename R = bool> R& _sendExchange() {
	 ...
	 HashSet1Il2CppString*>* GetNeedResources() {
		return ((HashSet1Il2CppString*>* (*)(CurrencyExchangeWindow*))(Il2CppBase() + 0x1BD12FC))(this);
	}
