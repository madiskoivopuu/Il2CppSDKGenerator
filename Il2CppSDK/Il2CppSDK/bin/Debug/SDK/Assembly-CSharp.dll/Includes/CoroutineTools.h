...
public: 
	...
	template <typename R = CoroutineWithIndex*> R WaitAndInvoke_1(float delay, Func1uintptr_t>* function, bool needAdditiveControl) {
		return ((R (*)(CoroutineTools*, float, Func1uintptr_t>*, bool))(Il2CppBase() + 0x0))(this, delay, function, needAdditiveControl);
	}
	...
	template <typename R = uintptr_t> R WaitAndInvokeCoroutine_1(float delay, Func1uintptr_t>* function, CoroutineWithIndex* coroutineObject) {
		return ((R (*)(CoroutineTools*, float, Func1uintptr_t>*, CoroutineWithIndex*))(Il2CppBase() + 0x0))(this, delay, function, coroutineObject);
	}
