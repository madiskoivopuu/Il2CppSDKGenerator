...
class TopNotificationView: NotificationView
{
public: 
	...
	template <typename T = void> T Show(uintptr_t window, Il2CppString* text, void* callback, bool redText) {
		return ((T (*)(TopNotificationView*, uintptr_t, Il2CppString*, void*, bool))(Il2CppBase() + 0x14F98EC))(this, window, text, callback, redText);
	}
