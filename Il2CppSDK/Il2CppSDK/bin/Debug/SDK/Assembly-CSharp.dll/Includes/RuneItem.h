...
public: 
	...
	template <typename T = uintptr_t> T& _runeItemEffect() {
	...
	template <typename T = void*> T& OnSlotEmpty() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = void*> T& OnSlotNotEmpty() {
		return *(T*)((uintptr_t)this + 0xF0);
	}
	template <typename T = void*> T& OnSlotChanged() {
	...
	template <typename T = void> T set_RuneItemState(uintptr_t value) {
		return ((T (*)(RuneItem*, uintptr_t))(Il2CppBase() + 0x134FA24))(this, value);
	}
	...
	template <typename T = void> T add_OnSlotEmpty(void* value) {
		return ((T (*)(RuneItem*, void*))(Il2CppBase() + 0x134FAC4))(this, value);
	}
	template <typename T = void> T remove_OnSlotEmpty(void* value) {
		return ((T (*)(RuneItem*, void*))(Il2CppBase() + 0x134FB64))(this, value);
	}
	template <typename T = void> T add_OnSlotNotEmpty(void* value) {
		return ((T (*)(RuneItem*, void*))(Il2CppBase() + 0x134FC04))(this, value);
	}
	template <typename T = void> T remove_OnSlotNotEmpty(void* value) {
		return ((T (*)(RuneItem*, void*))(Il2CppBase() + 0x134FCA4))(this, value);
	}
	template <typename T = void> T add_OnSlotChanged(void* value) {
		return ((T (*)(RuneItem*, void*))(Il2CppBase() + 0x134FD44))(this, value);
	}
	template <typename T = void> T remove_OnSlotChanged(void* value) {
		return ((T (*)(RuneItem*, void*))(Il2CppBase() + 0x134FDE4))(this, value);
	}
	template <typename T = void> T Bind(uintptr_t runePanel, uintptr_t entity, int32_t index, uintptr_t slot, Il2CppString* blueprint) {
		return ((T (*)(RuneItem*, uintptr_t, uintptr_t, int32_t, uintptr_t, Il2CppString*))(Il2CppBase() + 0x134FE84))(this, runePanel, entity, index, slot, blueprint);
	}
	...
	template <typename T = void> T SetIcon(uintptr_t item) {
		return ((T (*)(RuneItem*, uintptr_t))(Il2CppBase() + 0x1350658))(this, item);
	}
	...
	template <typename T = void> T ChangeSlot(uintptr_t slot) {
		return ((T (*)(RuneItem*, uintptr_t))(Il2CppBase() + 0x135187C))(this, slot);
	}
