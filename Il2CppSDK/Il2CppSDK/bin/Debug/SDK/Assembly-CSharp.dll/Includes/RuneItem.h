...
public: 
	...
	template <typename R = int32_t> R& _count() {
	 ...
	 IItemEventHandler1<RuneItem*>*& _handler() {
		return *(IItemEventHandler1<RuneItem*>**)((uintptr_t)this + 0xA0);
	}
	...
	template <typename R = float> R& _startDistanceToMergeRevert() {
	 ...
	 Action1<RuneItem*>*& OnSlotEmpty() {
		return *(Action1<RuneItem*>**)((uintptr_t)this + 0xE8);
	}
	 Action1<RuneItem*>*& OnSlotNotEmpty() {
		return *(Action1<RuneItem*>**)((uintptr_t)this + 0xF0);
	}
	 Action1<RuneItem*>*& OnSlotChanged() {
		return *(Action1<RuneItem*>**)((uintptr_t)this + 0xF8);
	}
	...
	template <typename R = void> R add_OnSlotEmpty(Action1<RuneItem*>* value) {
		return ((R (*)(RuneItem*, Action1<RuneItem*>*))(Il2CppBase() + 0x134FAC4))(this, value);
	}
	template <typename R = void> R remove_OnSlotEmpty(Action1<RuneItem*>* value) {
		return ((R (*)(RuneItem*, Action1<RuneItem*>*))(Il2CppBase() + 0x134FB64))(this, value);
	}
	template <typename R = void> R add_OnSlotNotEmpty(Action1<RuneItem*>* value) {
		return ((R (*)(RuneItem*, Action1<RuneItem*>*))(Il2CppBase() + 0x134FC04))(this, value);
	}
	template <typename R = void> R remove_OnSlotNotEmpty(Action1<RuneItem*>* value) {
		return ((R (*)(RuneItem*, Action1<RuneItem*>*))(Il2CppBase() + 0x134FCA4))(this, value);
	}
	template <typename R = void> R add_OnSlotChanged(Action1<RuneItem*>* value) {
		return ((R (*)(RuneItem*, Action1<RuneItem*>*))(Il2CppBase() + 0x134FD44))(this, value);
	}
	template <typename R = void> R remove_OnSlotChanged(Action1<RuneItem*>* value) {
		return ((R (*)(RuneItem*, Action1<RuneItem*>*))(Il2CppBase() + 0x134FDE4))(this, value);
	}
