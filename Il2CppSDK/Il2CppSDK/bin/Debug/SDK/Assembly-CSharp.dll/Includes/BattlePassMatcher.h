...
public: 
	...
	template <typename T = void*> static T& _matcherBattlePassView() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _matcherBlueprint() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> static T& _matcherClaimRewardOffset() {
	...
	template <typename T = void*> static T& _matcherPremiumAsOneTimeReward() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = void*> static T& _matcherReset() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = void*> static T& _matcherResetCurrency() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> static T& _matcherShowInHUD() {
	...
	template <typename T = void*> static T get_PremiumAsOneTimeReward() {
		return ((T (*)(void *))(Il2CppBase() + 0x167C22C))(0);
	}
	template <typename T = void*> static T get_Reset() {
		return ((T (*)(void *))(Il2CppBase() + 0x167C3C8))(0);
	}
	template <typename T = void*> static T get_ResetCurrency() {
		return ((T (*)(void *))(Il2CppBase() + 0x167C564))(0);
	}
	template <typename T = void*> static T get_ShowInHUD() {
