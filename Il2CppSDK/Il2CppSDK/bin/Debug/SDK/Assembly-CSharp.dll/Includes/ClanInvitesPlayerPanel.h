...
public: 
	...
	template <typename T = uintptr_t> T& IncomeInvitePrefab() {
	...
	template <typename T = uintptr_t> T& _selectedInvite() {
		return *(T*)((uintptr_t)this + 0x48);
	}

	template <typename T = void> T Bind(uintptr_t window) {
		return ((T (*)(ClanInvitesPlayerPanel*, uintptr_t))(Il2CppBase() + 0x158C374))(this, window);
	}
	...
	template <typename T = void> T OnInviteClicked(uintptr_t view) {
		return ((T (*)(ClanInvitesPlayerPanel*, uintptr_t))(Il2CppBase() + 0x158CC78))(this, view);
	}
