...
public: 
	...
	template <typename T = void> T FetchTokens(bool silent, Action1int32_t>* callback) {
		return ((T (*)(AndroidTokenClient*, bool, Action1int32_t>*))(Il2CppBase() + 0x1887BAC))(this, silent, callback);
	}
	template <typename T = void> T RequestPermissions(Il2CppArray<uintptr_t>* scopes, Action1SignInStatus*>* callback) {
		return ((T (*)(AndroidTokenClient*, Il2CppArray<uintptr_t>*, Action1SignInStatus*>*))(Il2CppBase() + 0x1887CBC))(this, scopes, callback);
	}
	...
	template <typename T = void> T DoFetchToken(bool silent, Action1int32_t>* callback) {
		return ((T (*)(AndroidTokenClient*, bool, Action1int32_t>*))(Il2CppBase() + 0x188854C))(this, silent, callback);
	}
	...
	template <typename T = void> T GetAnotherServerAuthCode(bool reAuthenticateIfNeeded, Action1Il2CppString*>* callback) {
		return ((T (*)(AndroidTokenClient*, bool, Action1Il2CppString*>*))(Il2CppBase() + 0x1888FD0))(this, reAuthenticateIfNeeded, callback);
	}
	template <typename T = void> T DoGetAnotherServerAuthCode(bool reAuthenticateIfNeeded, Action1Il2CppString*>* callback) {
		return ((T (*)(AndroidTokenClient*, bool, Action1Il2CppString*>*))(Il2CppBase() + 0x18890E0))(this, reAuthenticateIfNeeded, callback);
	}
