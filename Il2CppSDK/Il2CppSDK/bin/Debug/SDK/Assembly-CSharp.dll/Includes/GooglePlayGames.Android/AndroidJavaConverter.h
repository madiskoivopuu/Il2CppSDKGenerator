...
public: 
	...
	template <typename T = int32_t> static T ToLeaderboardVariantTimeSpan(LeaderboardTimeSpan* span) {
		return ((T (*)(void *, LeaderboardTimeSpan*))(Il2CppBase() + 0x12AF020))(0, span);
	}
	template <typename T = int32_t> static T ToLeaderboardVariantCollection(LeaderboardCollection* collection) {
		return ((T (*)(void *, LeaderboardCollection*))(Il2CppBase() + 0x12AF034))(0, collection);
	}
	template <typename T = int32_t> static T ToPageDirection(ScorePageDirection* direction) {
		return ((T (*)(void *, ScorePageDirection*))(Il2CppBase() + 0x12AF55C))(0, direction);
	}
	template <typename T = Player*> static T ToPlayer(uintptr_t player) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x12B3AAC))(0, player);
	}
	template <typename T = PlayerProfile*> static T ToPlayerProfile(uintptr_t player) {
	...
	template <typename T = FriendsListVisibilityStatus*> static T ToFriendsListVisibilityStatus(int32_t playerListVisibility) {
