...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1<GooglePlayGamesBasicApiNearby::ConnectionResponse>*& mResponseCallback() {
		return *(Action1<GooglePlayGamesBasicApiNearby::ConnectionResponse>**)((uintptr_t)this + 0x20);
	}
