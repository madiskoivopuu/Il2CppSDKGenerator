...
public: 
	...
	template <typename T = GuildMemberItem*> T& MemberItemPrefab() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = StandartButton*> T& InviteButton() {
	...
	template <typename T = void> T Bind(GuildWindow* window) {
		return ((T (*)(GuildMembersPanel*, GuildWindow*))(Il2CppBase() + 0x1B3847C))(this, window);
	}
