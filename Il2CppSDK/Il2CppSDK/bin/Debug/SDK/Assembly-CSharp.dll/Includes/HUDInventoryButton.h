...
public: 
	...
	template <typename R = InputEntity*> R& InputEntity() {
	 ...
	 static Il2CppDictionary<int32_t, Matcher1<InputEntity*>*>*& _matchers() {
		return *(Il2CppDictionary<int32_t, Matcher1<InputEntity*>*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = SimpleJoystick*> R& _skillShot() {
		return *(R*)((uintptr_t)this + 0x180);
	}
	 Nullable1<bool>*& _lastGameInputIsEnabled() {
		return *(Nullable1<bool>**)((uintptr_t)this + 0x188);
	}
	...
	template <typename R = void> R set_InputEntity(InputEntity* value) {
	 ...
	 static Matcher1<InputEntity*>* GetMatcher(int32_t componentIndex, Il2CppArray<Il2CppString*>* componentNames) {
		return ((Matcher1<InputEntity*>* (*)(void *, int32_t, Il2CppArray<Il2CppString*>*))(Il2CppBase() + 0x145895C))(0, componentIndex, componentNames);
	}
	...
	template <typename R = void> R SetActive(Nullable1<bool>* active, bool hard) {
		return ((R (*)(HUDInventoryButton*, Nullable1<bool>*, bool))(Il2CppBase() + 0x145A69C))(this, active, hard);
	}
	template <typename R = void> R OnUpdateDraw(float deltaTime) {
		return ((R (*)(HUDInventoryButton*, float))(Il2CppBase() + 0x145AC70))(this, deltaTime);
	}
	 ValueTuple3<bool, int32_t, bool>* GetNeedShowSkillShot(bool showMsg) {
		return ((ValueTuple3<bool, int32_t, bool>* (*)(HUDInventoryButton*, bool))(Il2CppBase() + 0x1459E64))(this, showMsg);
	}
