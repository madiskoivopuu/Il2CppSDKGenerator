...
public: 
	...
	template <typename T = uint8_t> T& Id() {
	...
	template <typename T = HashSet1int64_t>*> T& ClanIds() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(TeamComponent*, Il2CppObject*))(Il2CppBase() + 0x16AD314))(this, targetObject);
	}
