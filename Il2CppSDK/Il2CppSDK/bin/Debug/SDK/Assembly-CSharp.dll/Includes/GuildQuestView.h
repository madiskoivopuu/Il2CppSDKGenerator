...
public: 
	...
	template <typename T = Nullable1bool>*> T& _win() {
		return *(T*)((uintptr_t)this + 0x9E);
	}
	template <typename T = Nullable1bool>*> T& _lose() {
	...
	template <typename T = void> T set_QuestData(QuestDataEntity* value) {
		return ((T (*)(GuildQuestView*, QuestDataEntity*))(Il2CppBase() + 0x1937E00))(this, value);
	}
	template <typename T = void> T Init(QuestDataEntity* questData, TooltipView* tooltipView) {
		return ((T (*)(GuildQuestView*, QuestDataEntity*, TooltipView*))(Il2CppBase() + 0x1937E08))(this, questData, tooltipView);
	}
	template <typename T = void> T UpdateView(GuildQuestEntity* guildQuest) {
		return ((T (*)(GuildQuestView*, GuildQuestEntity*))(Il2CppBase() + 0x19380C0))(this, guildQuest);
	}
	template <typename T = void> T OnUpdateTime(GuildQuestEntity* guildQuest, int64_t now) {
		return ((T (*)(GuildQuestView*, GuildQuestEntity*, int64_t))(Il2CppBase() + 0x1938A40))(this, guildQuest, now);
	}
