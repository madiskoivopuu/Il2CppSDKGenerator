...
class LocationFarmWindow: UIWindow1
{
public: 
	...
	template <typename T = Il2CppVector3> T& ExperienceScaleAnim() {
	...
	template <typename T = uintptr_t> T& RewardResourceViewPrefab() {
	...
	template <typename T = uintptr_t> T& VipRewardResourceViewPrefab() {
	...
	template <typename T = void> T ShowResult(uintptr_t context) {
		return ((T (*)(LocationFarmWindow*, uintptr_t))(Il2CppBase() + 0x17B0D08))(this, context);
	}
	...
	template <typename T = void> T ShowResultg__InitResourceView|26_0(uintptr_t resource, int32_t index, uintptr_t prefab, uintptr_t container, uintptr_t ) {
		return ((T (*)(LocationFarmWindow*, uintptr_t, int32_t, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x17B183C))(this, resource, index, prefab, container, );
	}
