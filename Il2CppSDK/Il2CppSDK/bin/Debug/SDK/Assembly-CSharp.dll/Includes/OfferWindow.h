...
public: 
	...
	template <typename T = void> T ShowResources(uintptr_t storeEntity) {
		return ((T (*)(OfferWindow*, uintptr_t))(Il2CppBase() + 0x11D79DC))(this, storeEntity);
	}
