...
public: 
	...
	template <typename R = Il2CppArray<CanvasMeshRendererExposedParams*>*> R& _params() {
	 ...
	 Action1RuneItemEffect*>*& OnDeactivated() {
		return *(Action1RuneItemEffect*>**)((uintptr_t)this + 0x30);
	}
	...
	template <typename R = void> R add_OnDeactivated(Action1RuneItemEffect*>* value) {
		return ((R (*)(RuneItemEffect*, Action1RuneItemEffect*>*))(Il2CppBase() + 0x1353528))(this, value);
	}
	template <typename R = void> R remove_OnDeactivated(Action1RuneItemEffect*>* value) {
		return ((R (*)(RuneItemEffect*, Action1RuneItemEffect*>*))(Il2CppBase() + 0x13535C8))(this, value);
	}
