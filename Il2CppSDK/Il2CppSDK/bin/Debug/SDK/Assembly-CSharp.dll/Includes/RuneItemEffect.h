...
public: 
	...
	template <typename T = uintptr_t> T& _runeItemState() {
	...
	template <typename T = void*> T& OnDeactivated() {
	...
	template <typename T = void> T add_OnDeactivated(void* value) {
		return ((T (*)(RuneItemEffect*, void*))(Il2CppBase() + 0x1353528))(this, value);
	}
	template <typename T = void> T remove_OnDeactivated(void* value) {
		return ((T (*)(RuneItemEffect*, void*))(Il2CppBase() + 0x13535C8))(this, value);
	}
