...
public: 
	...
	template <typename R = float> R& _size() {
	 ...
	 Action1NotificationView*>*& _callback() {
		return *(Action1NotificationView*>**)((uintptr_t)this + 0x50);
	}
	template <typename R = uintptr_t> R& _redColor() {
		return *(R*)((uintptr_t)this + 0x58);
	}

	template <typename R = void> R Show(IUIWindow* window, Il2CppString* text, Action1NotificationView*>* callback, bool redText) {
		return ((R (*)(NotificationView*, IUIWindow*, Il2CppString*, Action1NotificationView*>*, bool))(Il2CppBase() + 0x13B9EB8))(this, window, text, callback, redText);
	}
