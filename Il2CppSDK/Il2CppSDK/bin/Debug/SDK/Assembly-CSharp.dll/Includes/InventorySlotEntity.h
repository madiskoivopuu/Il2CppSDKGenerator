...
public: 
	...
	template <typename T = BroadcastComponent*> static T& broadcastComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = ExternalInventory*> static T& externalInventoryComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = MountSlotComponent*> static T& mountSlotComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RuneSlotComponent*> static T& runeSlotComponent() {
	...
	template <typename T = DefaultItemComponent*> T get_defaultItem() {
	...
	template <typename T = DurabilityTickComponent*> T get_durabilityTick() {
	...
	template <typename T = void> T AddItemCondition(bool newOrEmpty, Il2CppString* newName, Il2CppString* newTag, Il2CppArray<uintptr_t>* newAnyTags, Il2CppString* newNoTag, EquipmentType* newEquipmentType) {
		return ((T (*)(InventorySlotEntity*, bool, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, EquipmentType*))(Il2CppBase() + 0x123B6E4))(this, newOrEmpty, newName, newTag, newAnyTags, newNoTag, newEquipmentType);
	}
	template <typename T = void> T ReplaceItemCondition(bool newOrEmpty, Il2CppString* newName, Il2CppString* newTag, Il2CppArray<uintptr_t>* newAnyTags, Il2CppString* newNoTag, EquipmentType* newEquipmentType) {
		return ((T (*)(InventorySlotEntity*, bool, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, EquipmentType*))(Il2CppBase() + 0x123B858))(this, newOrEmpty, newName, newTag, newAnyTags, newNoTag, newEquipmentType);
	}
	...
	template <typename T = PetSlotComponent*> T get_petSlot() {
	...
	template <typename T = void> T AddStack(Il2CppString* newResource, int32_t newCount, Nullable1int64_t>* newSignature) {
		return ((T (*)(InventorySlotEntity*, Il2CppString*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x123C944))(this, newResource, newCount, newSignature);
	}
	template <typename T = void> T ReplaceStack(Il2CppString* newResource, int32_t newCount, Nullable1int64_t>* newSignature) {
		return ((T (*)(InventorySlotEntity*, Il2CppString*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x1238214))(this, newResource, newCount, newSignature);
	}
