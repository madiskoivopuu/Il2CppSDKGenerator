...
public: 
	...
	template <typename R = void> R AddStack(Il2CppString* newResource, int32_t newCount, Nullable1int64_t>* newSignature) {
		return ((R (*)(InventorySlotEntity*, Il2CppString*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x123C944))(this, newResource, newCount, newSignature);
	}
	template <typename R = void> R ReplaceStack(Il2CppString* newResource, int32_t newCount, Nullable1int64_t>* newSignature) {
		return ((R (*)(InventorySlotEntity*, Il2CppString*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x1238214))(this, newResource, newCount, newSignature);
	}
