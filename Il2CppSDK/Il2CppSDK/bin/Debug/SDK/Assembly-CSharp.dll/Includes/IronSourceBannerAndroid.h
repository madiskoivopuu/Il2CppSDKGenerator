...
public: 
	...
	template <typename T = Action1IronSourceError*>*> T& OnBannerAdLoadFailed() {
	...
	template <typename T = void> T add_OnBannerAdLoadFailed(Action1IronSourceError*>* value) {
		return ((T (*)(IronSourceBannerAndroid*, Action1IronSourceError*>*))(Il2CppBase() + 0x124CD3C))(this, value);
	}
	template <typename T = void> T remove_OnBannerAdLoadFailed(Action1IronSourceError*>* value) {
		return ((T (*)(IronSourceBannerAndroid*, Action1IronSourceError*>*))(Il2CppBase() + 0x124CDDC))(this, value);
	}
