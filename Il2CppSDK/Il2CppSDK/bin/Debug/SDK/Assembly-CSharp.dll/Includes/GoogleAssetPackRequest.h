...
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, IAssetBundleRequest*>*> T& AssetBundleRequests() {
	...
	template <typename T = PlayAsyncOperation2int64_t, uintptr_t>*> T& _assetBundleSizeRequest() {
