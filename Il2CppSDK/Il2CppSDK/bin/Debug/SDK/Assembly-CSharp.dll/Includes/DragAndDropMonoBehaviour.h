...
public: 
	...
	template <typename R = int32_t> R& id() {
	 ...
	 Action2int32_t, uintptr_t>*& onBeginDrag() {
		return *(Action2int32_t, uintptr_t>**)((uintptr_t)this + 0x20);
	}
	 Action2int32_t, uintptr_t>*& onDrag() {
		return *(Action2int32_t, uintptr_t>**)((uintptr_t)this + 0x28);
	}
	 Action2int32_t, uintptr_t>*& onEndDrag() {
		return *(Action2int32_t, uintptr_t>**)((uintptr_t)this + 0x30);
	}
	 Action2int32_t, uintptr_t>*& onDrop() {
		return *(Action2int32_t, uintptr_t>**)((uintptr_t)this + 0x38);
	}
	 Action2int32_t, uintptr_t>*& onPointerDown() {
		return *(Action2int32_t, uintptr_t>**)((uintptr_t)this + 0x40);
	}
	 Action3bool, int32_t, float>*& OnClickHolded() {
		return *(Action3bool, int32_t, float>**)((uintptr_t)this + 0x48);
	}
	 Action1int32_t>*& onDoubleClick() {
		return *(Action1int32_t>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = float> R& _clickDelay() {
	 ...
	 Action3bool, int32_t, float>* get_OnClickHolded() {
		return ((Action3bool, int32_t, float>* (*)(DragAndDropMonoBehaviour*))(Il2CppBase() + 0x1304EE8))(this);
	}
	template <typename R = void> R set_OnClickHolded(Action3bool, int32_t, float>* value) {
		return ((R (*)(DragAndDropMonoBehaviour*, Action3bool, int32_t, float>*))(Il2CppBase() + 0x1304EF0))(this, value);
	}
