...
public: 
	...
	template <typename T = QuestDebugView*> T& _questViewPrefab() {
	...
	template <typename T = Il2CppList<QuestDebugView*>*> T& _quests() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = Il2CppList<QuestEntity*>*> T& _buffer() {
