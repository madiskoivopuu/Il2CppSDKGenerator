...
public: 
	...
	template <typename T = DestroyParentOnEndComponent*> static T& destroyParentOnEndComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = NeedFilterTargetsComponent*> static T& needFilterTargetsComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = UseSourceItem*> static T& useSourceItemComponent() {
	...
	template <typename T = ActionConditionComponent*> T get_actionCondition() {
	...
	template <typename T = void> T AddActionCondition(Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, ActionType* newType, ActionType* newNoType, Nullable1bool>* newInstant) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppString*, Il2CppString*, ActionType*, ActionType*, Nullable1bool>*))(Il2CppBase() + 0x1A36A58))(this, newName, newTag, newNoTag, newType, newNoType, newInstant);
	}
	template <typename T = void> T ReplaceActionCondition(Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, ActionType* newType, ActionType* newNoType, Nullable1bool>* newInstant) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppString*, Il2CppString*, ActionType*, ActionType*, Nullable1bool>*))(Il2CppBase() + 0x1A36BBC))(this, newName, newTag, newNoTag, newType, newNoType, newInstant);
	}
	...
	template <typename T = ActorTriggerConditionsComponent*> T get_actorTriggerConditions() {
	...
	template <typename T = void> T AddActorTriggerConditions(Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Nullable1float>* newHpCoefLess, Nullable1float>* newHpCoefMore) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<uintptr_t>*, Nullable1float>*, Nullable1float>*))(Il2CppBase() + 0x1A3628C))(this, newName, newNames, newHpCoefLess, newHpCoefMore);
	}
	template <typename T = void> T ReplaceActorTriggerConditions(Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Nullable1float>* newHpCoefLess, Nullable1float>* newHpCoefMore) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<uintptr_t>*, Nullable1float>*, Nullable1float>*))(Il2CppBase() + 0x1A37444))(this, newName, newNames, newHpCoefLess, newHpCoefMore);
	}
	...
	template <typename T = void> T AddApplyActorMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A37910))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceApplyActorMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A37A78))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	...
	template <typename T = void> T AddApplyLocationMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A37F88))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceApplyLocationMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A380F0))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	...
	template <typename T = ApplyOwnerMagicComponent*> T get_applyOwnerMagic() {
	...
	template <typename T = void> T AddApplyOwnerMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A38A9C))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceApplyOwnerMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A38C04))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	...
	template <typename T = void> T AddApplyPlace(ApplyPlaceParams* newParams, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, ApplyPlaceParams*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A38E0C))(this, newParams, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceApplyPlace(ApplyPlaceParams* newParams, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, ApplyPlaceParams*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A38F44))(this, newParams, newItems, newRandomCount);
	}
	template <typename T = void> T RemoveApplyPlace() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3907C))(this);
	}
	template <typename T = ApplyResourcesComponent*> T get_applyResources() {
	...
	template <typename T = void> T AddApplyResources(RecipientType* newRecipient, Il2CppString* newRandomGroup, Il2CppArray<uintptr_t>* newValues) {
		return ((T (*)(MagicTriggerDataEntity*, RecipientType*, Il2CppString*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1A3911C))(this, newRecipient, newRandomGroup, newValues);
	}
	template <typename T = void> T ReplaceApplyResources(RecipientType* newRecipient, Il2CppString* newRandomGroup, Il2CppArray<uintptr_t>* newValues) {
		return ((T (*)(MagicTriggerDataEntity*, RecipientType*, Il2CppString*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1A39254))(this, newRecipient, newRandomGroup, newValues);
	}
	...
	template <typename T = void> T AddApplyTargetMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A39420))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T ReplaceApplyTargetMagic(bool newIgnoreActorParent, MagicSource* newMagicSource, Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newItems, int32_t newRandomCount) {
		return ((T (*)(MagicTriggerDataEntity*, bool, MagicSource*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, int32_t))(Il2CppBase() + 0x1A39588))(this, newIgnoreActorParent, newMagicSource, newName, newNames, newItems, newRandomCount);
	}
	template <typename T = void> T RemoveApplyTargetMagic() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A396F0))(this);
	}
	template <typename T = ApplyTriggerComponent*> T get_applyTrigger() {
	...
	template <typename T = ChangeActorCooldownComponent*> T get_changeActorCooldown() {
	...
	template <typename T = ChangeDamageComponent*> T get_changeDamage() {
	...
	template <typename T = void> T AddChangeDamage(Nullable1float>* newCoef, Nullable1float>* newLifeSteal, DamageType* newAddDamageType) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*, Nullable1float>*, DamageType*))(Il2CppBase() + 0x1A3645C))(this, newCoef, newLifeSteal, newAddDamageType);
	}
	template <typename T = void> T ReplaceChangeDamage(Nullable1float>* newCoef, Nullable1float>* newLifeSteal, DamageType* newAddDamageType) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*, Nullable1float>*, DamageType*))(Il2CppBase() + 0x1A3A1F0))(this, newCoef, newLifeSteal, newAddDamageType);
	}
	...
	template <typename T = void> T AddChangeDurationByLostHp(DamageCondition* newDamageCondition, float newSecondsByPercent) {
		return ((T (*)(MagicTriggerDataEntity*, DamageCondition*, float))(Il2CppBase() + 0x1A3A3A8))(this, newDamageCondition, newSecondsByPercent);
	}
	template <typename T = void> T ReplaceChangeDurationByLostHp(DamageCondition* newDamageCondition, float newSecondsByPercent) {
		return ((T (*)(MagicTriggerDataEntity*, DamageCondition*, float))(Il2CppBase() + 0x1A3A4CC))(this, newDamageCondition, newSecondsByPercent);
	}
	template <typename T = void> T RemoveChangeDurationByLostHp() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3A5F0))(this);
	}
	template <typename T = ChangeHealComponent*> T get_changeHeal() {
	...
	template <typename T = void> T AddChangeHeal(Nullable1float>* newCoef) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*))(Il2CppBase() + 0x1A3A690))(this, newCoef);
	}
	template <typename T = void> T ReplaceChangeHeal(Nullable1float>* newCoef) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*))(Il2CppBase() + 0x1A3A794))(this, newCoef);
	}
	template <typename T = void> T RemoveChangeHeal() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3A898))(this);
	}
	template <typename T = ChangeMagicComponent*> T get_changeMagic() {
	...
	template <typename T = void> T AddChangeMagic(float newAddDuration, Nullable1float>* newDurationCoef, Nullable1float>* newDamageCoef, Il2CppArray<uintptr_t>* newAddChildren, bool newDispel) {
		return ((T (*)(MagicTriggerDataEntity*, float, Nullable1float>*, Nullable1float>*, Il2CppArray<uintptr_t>*, bool))(Il2CppBase() + 0x1A3A938))(this, newAddDuration, newDurationCoef, newDamageCoef, newAddChildren, newDispel);
	}
	template <typename T = void> T ReplaceChangeMagic(float newAddDuration, Nullable1float>* newDurationCoef, Nullable1float>* newDamageCoef, Il2CppArray<uintptr_t>* newAddChildren, bool newDispel) {
		return ((T (*)(MagicTriggerDataEntity*, float, Nullable1float>*, Nullable1float>*, Il2CppArray<uintptr_t>*, bool))(Il2CppBase() + 0x1A3AA80))(this, newAddDuration, newDurationCoef, newDamageCoef, newAddChildren, newDispel);
	}
	...
	template <typename T = DamageConditionComponent*> T get_damageCondition() {
	...
	template <typename T = void> T AddDamageCondition(DamageType* newIngoreDamageType, DamageType* newDamageType, float newMinBlocked, float newMinHpCoef, bool newUseActorBonusVsTarget, float newMinHpValue) {
		return ((T (*)(MagicTriggerDataEntity*, DamageType*, DamageType*, float, float, bool, float))(Il2CppBase() + 0x1A3B4B4))(this, newIngoreDamageType, newDamageType, newMinBlocked, newMinHpCoef, newUseActorBonusVsTarget, newMinHpValue);
	}
	template <typename T = void> T ReplaceDamageCondition(DamageType* newIngoreDamageType, DamageType* newDamageType, float newMinBlocked, float newMinHpCoef, bool newUseActorBonusVsTarget, float newMinHpValue) {
		return ((T (*)(MagicTriggerDataEntity*, DamageType*, DamageType*, float, float, bool, float))(Il2CppBase() + 0x1A3B5F4))(this, newIngoreDamageType, newDamageType, newMinBlocked, newMinHpCoef, newUseActorBonusVsTarget, newMinHpValue);
	}
	...
	template <typename T = DispelFromActorComponent*> T get_dispelFromActor() {
	...
	template <typename T = DispelFromTargetComponent*> T get_dispelFromTarget() {
	...
	template <typename T = DistributeDamageComponent*> T get_distributeDamage() {
	...
	template <typename T = void> T AddDistributeDamage(Nullable1float>* newCoef, TargetsSelector* newSelector, Il2CppArray<uintptr_t>* newHitEffects) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*, TargetsSelector*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1A3C108))(this, newCoef, newSelector, newHitEffects);
	}
	template <typename T = void> T ReplaceDistributeDamage(Nullable1float>* newCoef, TargetsSelector* newSelector, Il2CppArray<uintptr_t>* newHitEffects) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*, TargetsSelector*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1A3C240))(this, newCoef, newSelector, newHitEffects);
	}
	template <typename T = void> T RemoveDistributeDamage() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3C378))(this);
	}
	template <typename T = DistributeMagicComponent*> T get_distributeMagic() {
	...
	template <typename T = void> T AddDistributeMagic(Nullable1float>* newDurationCoef, Nullable1float>* newDamageCoef, TargetsSelector* newSelector) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*, Nullable1float>*, TargetsSelector*))(Il2CppBase() + 0x1A3C418))(this, newDurationCoef, newDamageCoef, newSelector);
	}
	template <typename T = void> T ReplaceDistributeMagic(Nullable1float>* newDurationCoef, Nullable1float>* newDamageCoef, TargetsSelector* newSelector) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1float>*, Nullable1float>*, TargetsSelector*))(Il2CppBase() + 0x1A3C540))(this, newDurationCoef, newDamageCoef, newSelector);
	}
	template <typename T = void> T RemoveDistributeMagic() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3C668))(this);
	}
	template <typename T = ExecuteGroupComponent*> T get_executeGroup() {
	...
	template <typename T = ItemConditionComponent*> T get_itemCondition() {
	...
	template <typename T = void> T AddItemCondition(bool newOrEmpty, Il2CppString* newName, Il2CppString* newTag, Il2CppArray<uintptr_t>* newAnyTags, Il2CppString* newNoTag, EquipmentType* newEquipmentType) {
		return ((T (*)(MagicTriggerDataEntity*, bool, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, EquipmentType*))(Il2CppBase() + 0x1A3CC98))(this, newOrEmpty, newName, newTag, newAnyTags, newNoTag, newEquipmentType);
	}
	template <typename T = void> T ReplaceItemCondition(bool newOrEmpty, Il2CppString* newName, Il2CppString* newTag, Il2CppArray<uintptr_t>* newAnyTags, Il2CppString* newNoTag, EquipmentType* newEquipmentType) {
		return ((T (*)(MagicTriggerDataEntity*, bool, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, EquipmentType*))(Il2CppBase() + 0x1A3CE0C))(this, newOrEmpty, newName, newTag, newAnyTags, newNoTag, newEquipmentType);
	}
	...
	template <typename T = void> T AddMagicCondition(Nullable1int32_t>* newMaxCount, Nullable1int32_t>* newMinCount, Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, bool newSourceOwns) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1int32_t>*, Nullable1int32_t>*, Il2CppString*, Il2CppString*, Il2CppString*, bool))(Il2CppBase() + 0x1A3D020))(this, newMaxCount, newMinCount, newName, newTag, newNoTag, newSourceOwns);
	}
	template <typename T = void> T ReplaceMagicCondition(Nullable1int32_t>* newMaxCount, Nullable1int32_t>* newMinCount, Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, bool newSourceOwns) {
		return ((T (*)(MagicTriggerDataEntity*, Nullable1int32_t>*, Nullable1int32_t>*, Il2CppString*, Il2CppString*, Il2CppString*, bool))(Il2CppBase() + 0x1A3D188))(this, newMaxCount, newMinCount, newName, newTag, newNoTag, newSourceOwns);
	}
	...
	template <typename T = void> T AddMagicTriggerType(MagicTriggerType* newValue) {
		return ((T (*)(MagicTriggerDataEntity*, MagicTriggerType*))(Il2CppBase() + 0x1A3D390))(this, newValue);
	}
	template <typename T = void> T ReplaceMagicTriggerType(MagicTriggerType* newValue) {
		return ((T (*)(MagicTriggerDataEntity*, MagicTriggerType*))(Il2CppBase() + 0x1A3D494))(this, newValue);
	}
	...
	template <typename T = void> T AddPlayerStatType(PlayerStatType* newValue) {
		return ((T (*)(MagicTriggerDataEntity*, PlayerStatType*))(Il2CppBase() + 0x1A3D90C))(this, newValue);
	}
	template <typename T = void> T ReplacePlayerStatType(PlayerStatType* newValue) {
		return ((T (*)(MagicTriggerDataEntity*, PlayerStatType*))(Il2CppBase() + 0x1A3DA10))(this, newValue);
	}
	template <typename T = void> T RemovePlayerStatType() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3DB14))(this);
	}
	template <typename T = ResetSkipCooldownComponent*> T get_resetSkipCooldown() {
	...
	template <typename T = void> T AddSplash(Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newSequence, Il2CppString* newActiveCondition, Il2CppString* newName, Il2CppArray<uintptr_t>* newList, TargetsSelector* newSelector) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, TargetsSelector*))(Il2CppBase() + 0x1A3E104))(this, newNames, newSequence, newActiveCondition, newName, newList, newSelector);
	}
	template <typename T = void> T ReplaceSplash(Il2CppArray<uintptr_t>* newNames, Il2CppArray<uintptr_t>* newSequence, Il2CppString* newActiveCondition, Il2CppString* newName, Il2CppArray<uintptr_t>* newList, TargetsSelector* newSelector) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, TargetsSelector*))(Il2CppBase() + 0x1A3E28C))(this, newNames, newSequence, newActiveCondition, newName, newList, newSelector);
	}
	template <typename T = void> T RemoveSplash() {
		return ((T (*)(MagicTriggerDataEntity*))(Il2CppBase() + 0x1A3E414))(this);
	}
	template <typename T = SplashDamageComponent*> T get_splashDamage() {
	...
	template <typename T = void> T AddSplashDamage(TargetsSelector* newSelector, Il2CppArray<uintptr_t>* newHitEffects, Il2CppArray<uintptr_t>* newHitMagics, float newDelay, Il2CppString* newName, float newMaxTargetPlayerHealthCoef, bool newIgnoreDamageCoef, DamageDependType* newDepend, float newMaxValue) {
		return ((T (*)(MagicTriggerDataEntity*, TargetsSelector*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, float, Il2CppString*, float, bool, DamageDependType*, float))(Il2CppBase() + 0x1A3E4B4))(this, newSelector, newHitEffects, newHitMagics, newDelay, newName, newMaxTargetPlayerHealthCoef, newIgnoreDamageCoef, newDepend, newMaxValue);
	}
	template <typename T = void> T ReplaceSplashDamage(TargetsSelector* newSelector, Il2CppArray<uintptr_t>* newHitEffects, Il2CppArray<uintptr_t>* newHitMagics, float newDelay, Il2CppString* newName, float newMaxTargetPlayerHealthCoef, bool newIgnoreDamageCoef, DamageDependType* newDepend, float newMaxValue) {
		return ((T (*)(MagicTriggerDataEntity*, TargetsSelector*, Il2CppArray<uintptr_t>*, Il2CppArray<uintptr_t>*, float, Il2CppString*, float, bool, DamageDependType*, float))(Il2CppBase() + 0x1A3E650))(this, newSelector, newHitEffects, newHitMagics, newDelay, newName, newMaxTargetPlayerHealthCoef, newIgnoreDamageCoef, newDepend, newMaxValue);
	}
	...
	template <typename T = TargetTriggerConditionsComponent*> T get_targetTriggerConditions() {
	...
	template <typename T = void> T AddTargetTriggerConditions(Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, RelationshipTypes* newRelationship, bool newIsAggroTarget, Nullable1float>* newHpCoefLess, Nullable1float>* newHpCoefMore, float newMinDistance, float newMaxDistance, Nullable1bool>* newIsTriggerOwner, Nullable1float>* newViewAngle) {
		return ((T (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<uintptr_t>*, RelationshipTypes*, bool, Nullable1float>*, Nullable1float>*, float, float, Nullable1bool>*, Nullable1float>*))(Il2CppBase() + 0x1A3EE04))(this, newName, newNames, newRelationship, newIsAggroTarget, newHpCoefLess, newHpCoefMore, newMinDistance, newMaxDistance, newIsTriggerOwner, newViewAngle);
	}
	template <typename T = void> T ReplaceTargetTriggerConditions(Il2CppString* newName, Il2CppArray<uintptr_t>* newNames, RelationshipTypes* newRelationship, bool newIsAggroTarget, Nullable1float>* newHpCoefLess, Nullable1float>* newHpCoefMore, float newMinDistance, float newMaxDistance, Nullable1bool>* newIsTriggerOwner, Nullable1float>* newViewAngle) {
