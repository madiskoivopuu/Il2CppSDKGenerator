...
public: 
	...
	template <typename R = void> R AddActionCondition(Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, ActionType newType, ActionType newNoType, Nullable1<bool>* newInstant) {
		return ((R (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppString*, Il2CppString*, ActionType, ActionType, Nullable1<bool>*))(Il2CppBase() + 0x1A36A58))(this, newName, newTag, newNoTag, newType, newNoType, newInstant);
	}
	template <typename R = void> R ReplaceActionCondition(Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, ActionType newType, ActionType newNoType, Nullable1<bool>* newInstant) {
		return ((R (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppString*, Il2CppString*, ActionType, ActionType, Nullable1<bool>*))(Il2CppBase() + 0x1A36BBC))(this, newName, newTag, newNoTag, newType, newNoType, newInstant);
	}
	...
	template <typename R = void> R AddActorTriggerConditions(Il2CppString* newName, Il2CppArray<Il2CppString*>* newNames, Nullable1<float>* newHpCoefLess, Nullable1<float>* newHpCoefMore) {
		return ((R (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<Il2CppString*>*, Nullable1<float>*, Nullable1<float>*))(Il2CppBase() + 0x1A3628C))(this, newName, newNames, newHpCoefLess, newHpCoefMore);
	}
	template <typename R = void> R ReplaceActorTriggerConditions(Il2CppString* newName, Il2CppArray<Il2CppString*>* newNames, Nullable1<float>* newHpCoefLess, Nullable1<float>* newHpCoefMore) {
		return ((R (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<Il2CppString*>*, Nullable1<float>*, Nullable1<float>*))(Il2CppBase() + 0x1A37444))(this, newName, newNames, newHpCoefLess, newHpCoefMore);
	}
	...
	template <typename R = void> R AddChangeDamage(Nullable1<float>* newCoef, Nullable1<float>* newLifeSteal, DamageType newAddDamageType) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*, Nullable1<float>*, DamageType))(Il2CppBase() + 0x1A3645C))(this, newCoef, newLifeSteal, newAddDamageType);
	}
	template <typename R = void> R ReplaceChangeDamage(Nullable1<float>* newCoef, Nullable1<float>* newLifeSteal, DamageType newAddDamageType) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*, Nullable1<float>*, DamageType))(Il2CppBase() + 0x1A3A1F0))(this, newCoef, newLifeSteal, newAddDamageType);
	}
	...
	template <typename R = void> R AddChangeHeal(Nullable1<float>* newCoef) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*))(Il2CppBase() + 0x1A3A690))(this, newCoef);
	}
	template <typename R = void> R ReplaceChangeHeal(Nullable1<float>* newCoef) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*))(Il2CppBase() + 0x1A3A794))(this, newCoef);
	}
	...
	template <typename R = void> R AddChangeMagic(float newAddDuration, Nullable1<float>* newDurationCoef, Nullable1<float>* newDamageCoef, Il2CppArray<Il2CppString*>* newAddChildren, bool newDispel) {
		return ((R (*)(MagicTriggerDataEntity*, float, Nullable1<float>*, Nullable1<float>*, Il2CppArray<Il2CppString*>*, bool))(Il2CppBase() + 0x1A3A938))(this, newAddDuration, newDurationCoef, newDamageCoef, newAddChildren, newDispel);
	}
	template <typename R = void> R ReplaceChangeMagic(float newAddDuration, Nullable1<float>* newDurationCoef, Nullable1<float>* newDamageCoef, Il2CppArray<Il2CppString*>* newAddChildren, bool newDispel) {
		return ((R (*)(MagicTriggerDataEntity*, float, Nullable1<float>*, Nullable1<float>*, Il2CppArray<Il2CppString*>*, bool))(Il2CppBase() + 0x1A3AA80))(this, newAddDuration, newDurationCoef, newDamageCoef, newAddChildren, newDispel);
	}
	...
	template <typename R = void> R AddDistributeDamage(Nullable1<float>* newCoef, TargetsSelector* newSelector, Il2CppArray<Il2CppString*>* newHitEffects) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*, TargetsSelector*, Il2CppArray<Il2CppString*>*))(Il2CppBase() + 0x1A3C108))(this, newCoef, newSelector, newHitEffects);
	}
	template <typename R = void> R ReplaceDistributeDamage(Nullable1<float>* newCoef, TargetsSelector* newSelector, Il2CppArray<Il2CppString*>* newHitEffects) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*, TargetsSelector*, Il2CppArray<Il2CppString*>*))(Il2CppBase() + 0x1A3C240))(this, newCoef, newSelector, newHitEffects);
	}
	...
	template <typename R = void> R AddDistributeMagic(Nullable1<float>* newDurationCoef, Nullable1<float>* newDamageCoef, TargetsSelector* newSelector) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*, Nullable1<float>*, TargetsSelector*))(Il2CppBase() + 0x1A3C418))(this, newDurationCoef, newDamageCoef, newSelector);
	}
	template <typename R = void> R ReplaceDistributeMagic(Nullable1<float>* newDurationCoef, Nullable1<float>* newDamageCoef, TargetsSelector* newSelector) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<float>*, Nullable1<float>*, TargetsSelector*))(Il2CppBase() + 0x1A3C540))(this, newDurationCoef, newDamageCoef, newSelector);
	}
	...
	template <typename R = void> R AddMagicCondition(Nullable1<int32_t>* newMaxCount, Nullable1<int32_t>* newMinCount, Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, bool newSourceOwns) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<int32_t>*, Nullable1<int32_t>*, Il2CppString*, Il2CppString*, Il2CppString*, bool))(Il2CppBase() + 0x1A3D020))(this, newMaxCount, newMinCount, newName, newTag, newNoTag, newSourceOwns);
	}
	template <typename R = void> R ReplaceMagicCondition(Nullable1<int32_t>* newMaxCount, Nullable1<int32_t>* newMinCount, Il2CppString* newName, Il2CppString* newTag, Il2CppString* newNoTag, bool newSourceOwns) {
		return ((R (*)(MagicTriggerDataEntity*, Nullable1<int32_t>*, Nullable1<int32_t>*, Il2CppString*, Il2CppString*, Il2CppString*, bool))(Il2CppBase() + 0x1A3D188))(this, newMaxCount, newMinCount, newName, newTag, newNoTag, newSourceOwns);
	}
	...
	template <typename R = void> R AddTargetTriggerConditions(Il2CppString* newName, Il2CppArray<Il2CppString*>* newNames, RelationshipTypes newRelationship, bool newIsAggroTarget, Nullable1<float>* newHpCoefLess, Nullable1<float>* newHpCoefMore, float newMinDistance, float newMaxDistance, Nullable1<bool>* newIsTriggerOwner, Nullable1<float>* newViewAngle) {
		return ((R (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<Il2CppString*>*, RelationshipTypes, bool, Nullable1<float>*, Nullable1<float>*, float, float, Nullable1<bool>*, Nullable1<float>*))(Il2CppBase() + 0x1A3EE04))(this, newName, newNames, newRelationship, newIsAggroTarget, newHpCoefLess, newHpCoefMore, newMinDistance, newMaxDistance, newIsTriggerOwner, newViewAngle);
	}
	template <typename R = void> R ReplaceTargetTriggerConditions(Il2CppString* newName, Il2CppArray<Il2CppString*>* newNames, RelationshipTypes newRelationship, bool newIsAggroTarget, Nullable1<float>* newHpCoefLess, Nullable1<float>* newHpCoefMore, float newMinDistance, float newMaxDistance, Nullable1<bool>* newIsTriggerOwner, Nullable1<float>* newViewAngle) {
		return ((R (*)(MagicTriggerDataEntity*, Il2CppString*, Il2CppArray<Il2CppString*>*, RelationshipTypes, bool, Nullable1<float>*, Nullable1<float>*, float, float, Nullable1<bool>*, Nullable1<float>*))(Il2CppBase() + 0x1A3EF88))(this, newName, newNames, newRelationship, newIsAggroTarget, newHpCoefLess, newHpCoefMore, newMinDistance, newMaxDistance, newIsTriggerOwner, newViewAngle);
	}
