...
public: 
	...
	template <typename R = bool> static R HasFreePriceInCategory(StoreCategory* category) {
	 ...
	 static Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>* GetStoreProductsForCategory(StoreCategory* category) {
		return ((Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>* (*)(void *, StoreCategory*))(Il2CppBase() + 0xE1DF60))(0, category);
	}
	template <typename R = void> static R FillStoreProductsForCategory(StoreCategory* category, Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>* result) {
		return ((R (*)(void *, StoreCategory*, Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>*))(Il2CppBase() + 0xE1DBF4))(0, category, result);
	}
	...
	template <typename R = Il2CppString*> static R GetIconName(Store2DataContext* context, Il2CppString* name) {
	 ...
	 static Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>* PrioritizeOrderedProducts(Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>* orderedProducts, Il2CppString* selectedCategory, StoreFillingType* fillingType) {
		return ((Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>* (*)(void *, Il2CppList<ValueTuple2Store2Entity*, Store2DataEntity*>*>*, Il2CppString*, StoreFillingType*))(Il2CppBase() + 0xE1E980))(0, orderedProducts, selectedCategory, fillingType);
	}
	...
	template <typename R = void> static R BuyProduct(int64_t productStoreId, Price* price, Action1int32_t>* onSuccess, Action2PurchaseError*, int32_t>* onFail) {
		return ((R (*)(void *, int64_t, Price*, Action1int32_t>*, Action2PurchaseError*, int32_t>*))(Il2CppBase() + 0xE1FE34))(0, productStoreId, price, onSuccess, onFail);
	}
	template <typename R = void> static R PurchaseWithCurrency(int64_t productStoreId, Price* price, Action1int32_t>* onSuccess, Action2PurchaseError*, int32_t>* onFail) {
		return ((R (*)(void *, int64_t, Price*, Action1int32_t>*, Action2PurchaseError*, int32_t>*))(Il2CppBase() + 0xE20328))(0, productStoreId, price, onSuccess, onFail);
	}
	template <typename R = void> static R PurchaseWithItem(int64_t productStoreId, Price* price, Action1int32_t>* onSuccess, Action2PurchaseError*, int32_t>* onFail) {
		return ((R (*)(void *, int64_t, Price*, Action1int32_t>*, Action2PurchaseError*, int32_t>*))(Il2CppBase() + 0xE20A30))(0, productStoreId, price, onSuccess, onFail);
	}
	template <typename R = void> static R PurchaseWithIAP(int64_t storeId, Price* price, Action1int32_t>* onSuccess, Action2PurchaseError*, int32_t>* onFail) {
		return ((R (*)(void *, int64_t, Price*, Action1int32_t>*, Action2PurchaseError*, int32_t>*))(Il2CppBase() + 0xE2127C))(0, storeId, price, onSuccess, onFail);
	}
