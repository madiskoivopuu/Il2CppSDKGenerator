...
public: 
	...
	template <typename R = ItemEntity*> R& ClassItem() {
	 ...
	 Action1<ClassTabButton*>*& ClickEvent() {
		return *(Action1<ClassTabButton*>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1<ClassTabButton*>* value) {
		return ((R (*)(ClassTabButton*, Action1<ClassTabButton*>*))(Il2CppBase() + 0x18F78D8))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1<ClassTabButton*>* value) {
		return ((R (*)(ClassTabButton*, Action1<ClassTabButton*>*))(Il2CppBase() + 0x18F7978))(this, value);
	}
