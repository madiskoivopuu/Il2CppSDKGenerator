...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 PrimaryEntityIndex2<ModifierEntity*, int32_t>*& EntityWithId() {
		return *(PrimaryEntityIndex2<ModifierEntity*, int32_t>**)((uintptr_t)this + 0xD0);
	}

	 PrimaryEntityIndex2<ModifierEntity*, int32_t>* get_EntityWithId() {
		return ((PrimaryEntityIndex2<ModifierEntity*, int32_t>* (*)(ModifierContext*))(Il2CppBase() + 0x1D7B57C))(this);
	}
	template <typename R = void> R set_EntityWithId(PrimaryEntityIndex2<ModifierEntity*, int32_t>* value) {
		return ((R (*)(ModifierContext*, PrimaryEntityIndex2<ModifierEntity*, int32_t>*))(Il2CppBase() + 0x1D7B584))(this, value);
	}
