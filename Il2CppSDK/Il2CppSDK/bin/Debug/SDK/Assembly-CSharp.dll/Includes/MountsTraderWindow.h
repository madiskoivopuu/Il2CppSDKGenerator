...
public: 
	...
	template <typename R = void> R AutoAddMount() {
	 ...
	 ValueTuple2bool, Il2CppArray<IInventoryItem*>*>* CanAutoAddMounts() {
		return ((ValueTuple2bool, Il2CppArray<IInventoryItem*>*>* (*)(MountsTraderWindow*))(Il2CppBase() + 0x1555A5C))(this);
	}
