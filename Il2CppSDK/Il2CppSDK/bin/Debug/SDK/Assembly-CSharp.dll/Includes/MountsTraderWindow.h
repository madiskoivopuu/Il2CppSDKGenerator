...
public: 
	...
	template <typename T = IInventoryItem*> T& _lastTraderItem() {
		return *(T*)((uintptr_t)this + 0x158);
	}
	template <typename T = BaseMountTradeStep*> T& _currentStep() {
	...
	template <typename T = MountFuser*> T get_MountFuser() {
	...
	template <typename T = BaseMountTradeStep*> T get_CurrentStep() {
		return ((T (*)(MountsTraderWindow*))(Il2CppBase() + 0x155163C))(this);
	}
	template <typename T = void> T set_CurrentStep(BaseMountTradeStep* value) {
		return ((T (*)(MountsTraderWindow*, BaseMountTradeStep*))(Il2CppBase() + 0x1551644))(this, value);
	}
	...
	template <typename T = Il2CppString*> T GetErrorStringKey(Result* result) {
		return ((T (*)(MountsTraderWindow*, Result*))(Il2CppBase() + 0x1552F70))(this, result);
	}
	template <typename T = void> T FuseMount() {
		return ((T (*)(MountsTraderWindow*))(Il2CppBase() + 0x1553004))(this);
	}
	template <typename T = void> T OnFuseFinished(FuseMountResultData* data) {
		return ((T (*)(MountsTraderWindow*, FuseMountResultData*))(Il2CppBase() + 0x1553408))(this, data);
	}
	template <typename T = uintptr_t> T WaitForInventory(IInventoryItem* inventoryItem, int32_t id) {
		return ((T (*)(MountsTraderWindow*, IInventoryItem*, int32_t))(Il2CppBase() + 0x1553CC0))(this, inventoryItem, id);
	}
	...
	template <typename T = void> T OnBeginDrag(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(MountsTraderWindow*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x15543CC))(this, item, eventData);
	}
	template <typename T = void> T OnDrop(IInventoryItem* item) {
		return ((T (*)(MountsTraderWindow*, IInventoryItem*))(Il2CppBase() + 0x1554454))(this, item);
	}
	template <typename T = void> T OnEndDrag(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(MountsTraderWindow*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x1554A14))(this, item, eventData);
	}
	...
	template <typename T = void> T OnDoubleClick(IInventoryItem* item) {
		return ((T (*)(MountsTraderWindow*, IInventoryItem*))(Il2CppBase() + 0x1554E80))(this, item);
	}
	...
	template <typename T = void> T OnSelect(IInventoryItem* item) {
		return ((T (*)(MountsTraderWindow*, IInventoryItem*))(Il2CppBase() + 0x155596C))(this, item);
	}
	...
	template <typename T = ValueTuple2bool, Il2CppArray<uintptr_t>*>*> T CanAutoAddMounts() {
