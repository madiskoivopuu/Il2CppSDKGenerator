...
class OccupationChoiceWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& _currentButton() {
	...
	template <typename T = void> T OnButtonClickedHandler(uintptr_t button) {
		return ((T (*)(OccupationChoiceWindow*, uintptr_t))(Il2CppBase() + 0x11D59D4))(this, button);
	}
	template <typename T = void> T DeselectOtherButton(uintptr_t button) {
		return ((T (*)(OccupationChoiceWindow*, uintptr_t))(Il2CppBase() + 0x11D59D8))(this, button);
	}
