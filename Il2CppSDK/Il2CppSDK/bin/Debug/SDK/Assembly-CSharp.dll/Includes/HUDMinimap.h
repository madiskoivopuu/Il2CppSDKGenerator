...
public: 
	...
	template <typename T = uintptr_t> T& _arrowPrefab() {
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _arrows() {
	...
	template <typename T = void> T UpdateView(uintptr_t window, uintptr_t avatar) {
		return ((T (*)(HUDMinimap*, uintptr_t, uintptr_t))(Il2CppBase() + 0x145E408))(this, window, avatar);
	}
	template <typename T = void> T DrawArrow(float angle, uintptr_t mode, uintptr_t arrowColor, bool notRotation, bool onBorder, bool ping) {
		return ((T (*)(HUDMinimap*, float, uintptr_t, uintptr_t, bool, bool, bool))(Il2CppBase() + 0x145F11C))(this, angle, mode, arrowColor, notRotation, onBorder, ping);
	}
	template <typename T = float> T GetAngle(uintptr_t e1, uintptr_t e2) {
		return ((T (*)(HUDMinimap*, uintptr_t, uintptr_t))(Il2CppBase() + 0x145F0C4))(this, e1, e2);
	}
