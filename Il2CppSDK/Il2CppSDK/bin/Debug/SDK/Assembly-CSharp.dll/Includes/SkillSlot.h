...
public: 
	...
	template <typename T = ISkillEventHandler*> T& _handler() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = SkillSelectWindow*> T& _window() {
	...
	template <typename T = void> T set_Item(ItemEntity* value) {
		return ((T (*)(SkillSlot*, ItemEntity*))(Il2CppBase() + 0x1482B7C))(this, value);
	}
	template <typename T = void> T Bind(SkillSelectWindow* window, ItemEntity* item, GameEntity* avatar) {
		return ((T (*)(SkillSlot*, SkillSelectWindow*, ItemEntity*, GameEntity*))(Il2CppBase() + 0x1481E08))(this, window, item, avatar);
	}
