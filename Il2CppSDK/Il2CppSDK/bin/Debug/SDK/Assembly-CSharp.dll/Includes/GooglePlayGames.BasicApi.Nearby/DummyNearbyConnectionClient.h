...
public: 
	...
	template <typename T = void> T StartAdvertising(Il2CppString* name, Il2CppList<Il2CppString*>* appIdentifiers, void* advertisingDuration, void* resultCallback, void* connectionRequestCallback) {
		return ((T (*)(DummyNearbyConnectionClient*, Il2CppString*, Il2CppList<Il2CppString*>*, void*, void*, void*))(Il2CppBase() + 0x1306490))(this, name, appIdentifiers, advertisingDuration, resultCallback, connectionRequestCallback);
	}
	...
	template <typename T = void> T SendConnectionRequest(Il2CppString* name, Il2CppString* remoteEndpointId, Il2CppArray<uintptr_t>* payload, void* responseCallback, uintptr_t listener) {
		return ((T (*)(DummyNearbyConnectionClient*, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, void*, uintptr_t))(Il2CppBase() + 0x130659C))(this, name, remoteEndpointId, payload, responseCallback, listener);
	}
	template <typename T = void> T AcceptConnectionRequest(Il2CppString* remoteEndpointId, Il2CppArray<uintptr_t>* payload, uintptr_t listener) {
		return ((T (*)(DummyNearbyConnectionClient*, Il2CppString*, Il2CppArray<uintptr_t>*, uintptr_t))(Il2CppBase() + 0x13066C0))(this, remoteEndpointId, payload, listener);
	}
	template <typename T = void> T StartDiscovery(Il2CppString* serviceId, void* advertisingTimeout, uintptr_t listener) {
		return ((T (*)(DummyNearbyConnectionClient*, Il2CppString*, void*, uintptr_t))(Il2CppBase() + 0x1306734))(this, serviceId, advertisingTimeout, listener);
	}
