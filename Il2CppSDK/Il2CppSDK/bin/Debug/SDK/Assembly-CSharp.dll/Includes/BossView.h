...
public: 
	...
	template <typename T = Action1BossView*>*> T& ClickEvent() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = Action1BossView*>*> T& ClickInfoEvent() {
	...
	template <typename T = void> T add_ClickEvent(Action1BossView*>* value) {
		return ((T (*)(BossView*, Action1BossView*>*))(Il2CppBase() + 0x16CDCA4))(this, value);
	}
	template <typename T = void> T remove_ClickEvent(Action1BossView*>* value) {
		return ((T (*)(BossView*, Action1BossView*>*))(Il2CppBase() + 0x16CDD44))(this, value);
	}
	template <typename T = void> T add_ClickInfoEvent(Action1BossView*>* value) {
		return ((T (*)(BossView*, Action1BossView*>*))(Il2CppBase() + 0x16CDDE4))(this, value);
	}
	template <typename T = void> T remove_ClickInfoEvent(Action1BossView*>* value) {
		return ((T (*)(BossView*, Action1BossView*>*))(Il2CppBase() + 0x16CDE84))(this, value);
	}
	...
	template <typename T = ItemEntity*> T get_BossEntity() {
	...
	template <typename T = void> T Init(UIWindow* window, int64_t playerId, ItemEntity* bossEntity, int32_t targetId, TooltipView* tooltipView) {
		return ((T (*)(BossView*, UIWindow*, int64_t, ItemEntity*, int32_t, TooltipView*))(Il2CppBase() + 0x16CE2A8))(this, window, playerId, bossEntity, targetId, tooltipView);
	}
	...
	template <typename T = void> T UpdateTimer(BossState* bossOpenState, BossOpenResourcesComponent* bossResources) {
		return ((T (*)(BossView*, BossState*, BossOpenResourcesComponent*))(Il2CppBase() + 0x16CE9F8))(this, bossOpenState, bossResources);
	}
	template <typename T = void> T UpdateBar(BossState* bossOpenState, BossOpenResourcesComponent* bossResources) {
		return ((T (*)(BossView*, BossState*, BossOpenResourcesComponent*))(Il2CppBase() + 0x16CED24))(this, bossOpenState, bossResources);
	}
	template <typename T = void> T UpdateLocked(BossOpenResourcesComponent* bossResources) {
		return ((T (*)(BossView*, BossOpenResourcesComponent*))(Il2CppBase() + 0x16CE6E4))(this, bossResources);
	}
