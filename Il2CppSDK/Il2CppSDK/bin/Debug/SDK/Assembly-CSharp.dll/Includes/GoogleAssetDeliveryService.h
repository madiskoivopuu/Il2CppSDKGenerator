...
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& _assetPackRequests() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& _staticAssetPackRequests() {
	...
	template <typename T = uintptr_t> T RequestAssetBundlePack(Il2CppString* packName, bool isStatic) {
		return ((T (*)(GoogleAssetDeliveryService*, Il2CppString*, bool))(Il2CppBase() + 0x12E0F48))(this, packName, isStatic);
	}
	template <typename T = uintptr_t> T RequestAssetBundlePacks(Il2CppArray<uintptr_t>* packNames, bool isStatic) {
