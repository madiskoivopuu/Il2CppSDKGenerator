...
public: 
	...
	template <typename T = IGroup1GameEntity*>*> T& _chests() {
	...
	template <typename T = ICollector1AccountEntity*>*> T GetTrigger(IContext1AccountEntity*>* context) {
		return ((T (*)(OnOffChestMarkerSystem*, IContext1AccountEntity*>*))(Il2CppBase() + 0x11DDA48))(this, context);
	}
	template <typename T = bool> T Filter(AccountEntity* entity) {
		return ((T (*)(OnOffChestMarkerSystem*, AccountEntity*))(Il2CppBase() + 0x11DDB14))(this, entity);
	}
	template <typename T = void> T Execute(Il2CppList<AccountEntity*>* entities) {
		return ((T (*)(OnOffChestMarkerSystem*, Il2CppList<AccountEntity*>*))(Il2CppBase() + 0x11DDB30))(this, entities);
	}
