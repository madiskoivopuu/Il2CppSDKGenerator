...
public: 
	...
	template <typename T = StandartButton*> T& _infoBtn() {
		return *(T*)((uintptr_t)this + 0x150);
	}
	template <typename T = StandartButton*> T& _donateBtn() {
	...
	template <typename T = RequiredResourcesView*> T& _requiredResourcesView() {
	...
	template <typename T = bool> T IsItemInBossRequiredResources(ItemEntity* entity) {
		return ((T (*)(OpenGuildBossesWindow*, ItemEntity*))(Il2CppBase() + 0x11DF1D0))(this, entity);
	}
	...
	template <typename T = void> T OnSelect(InventorySlotEntity* selectedInventory, InventorySlot* selectedSlot) {
		return ((T (*)(OpenGuildBossesWindow*, InventorySlotEntity*, InventorySlot*))(Il2CppBase() + 0x11DF828))(this, selectedInventory, selectedSlot);
	}
	template <typename T = void> T OnDrop(IInventoryItem* item) {
		return ((T (*)(OpenGuildBossesWindow*, IInventoryItem*))(Il2CppBase() + 0x11DFA18))(this, item);
	}
	template <typename T = void> T OnDoubleClick(IInventoryItem* item) {
		return ((T (*)(OpenGuildBossesWindow*, IInventoryItem*))(Il2CppBase() + 0x11E04A4))(this, item);
	}
	...
	template <typename T = float> T UpdateInventoryEntity(InventorySlotEntity* inventoryEntity, float silverCoef) {
		return ((T (*)(OpenGuildBossesWindow*, InventorySlotEntity*, float))(Il2CppBase() + 0x11E251C))(this, inventoryEntity, silverCoef);
	}
	...
	template <typename T = void> T OnDonationSuccess(BossOperationResultData* donationResult) {
		return ((T (*)(OpenGuildBossesWindow*, BossOperationResultData*))(Il2CppBase() + 0x11E2DFC))(this, donationResult);
	}
