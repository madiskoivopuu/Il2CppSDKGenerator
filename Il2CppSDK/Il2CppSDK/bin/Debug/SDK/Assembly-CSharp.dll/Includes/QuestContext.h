...
public: 
	...
	template <typename R = Il2CppString*> static R& IgnoreForQuestsTag() {
	 ...
	 PrimaryEntityIndex2QuestEntity*, int32_t>*& _idIndex() {
		return *(PrimaryEntityIndex2QuestEntity*, int32_t>**)((uintptr_t)this + 0x118);
	}
	 PrimaryEntityIndex2QuestEntity*, LongString*>*& _aliveNameIndex() {
		return *(PrimaryEntityIndex2QuestEntity*, LongString*>**)((uintptr_t)this + 0x120);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _alivesIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x128);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _actualIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x130);
	}
	 EntityIndex2QuestEntity*, LongString*>*& _aliveActIndex() {
		return *(EntityIndex2QuestEntity*, LongString*>**)((uintptr_t)this + 0x138);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _completedNotRewardedIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x140);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _completedNotFullRewardedIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x148);
	}
	 EntityIndex2QuestEntity*, IntLong*>*& _aliveTrackingIndex() {
		return *(EntityIndex2QuestEntity*, IntLong*>**)((uintptr_t)this + 0x150);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _aliveWithActiveConditionIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x158);
	}
	 EntityIndex2QuestEntity*, LongString*>*& _aliveTagIndex() {
		return *(EntityIndex2QuestEntity*, LongString*>**)((uintptr_t)this + 0x160);
	}
	 PrimaryEntityIndex2QuestEntity*, int64_t>*& _aliveTournamentIndex() {
		return *(PrimaryEntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x168);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _aliveActivateTournamentIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x170);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _aliveGuildQuestsIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x178);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _aliveTrackedQuestIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x180);
	}
	 EntityIndex2QuestEntity*, int64_t>*& _aliveEquipIndex() {
		return *(EntityIndex2QuestEntity*, int64_t>**)((uintptr_t)this + 0x188);
	}
	template <typename R = ICommonContexts*> R& _world() {
		return *(R*)((uintptr_t)this + 0x190);
	}
	 IGroup1QuestEntity*>*& _aliveActQuests() {
		return *(IGroup1QuestEntity*>**)((uintptr_t)this + 0x198);
	}
	 IGroup1QuestEntity*>*& _aliveWithTags() {
		return *(IGroup1QuestEntity*>**)((uintptr_t)this + 0x1A0);
	}
	 IGroup1QuestEntity*>*& _aliveActivateTournament() {
		return *(IGroup1QuestEntity*>**)((uintptr_t)this + 0x1A8);
	}
	 IGroup1QuestEntity*>*& _actualTargetMarker() {
		return *(IGroup1QuestEntity*>**)((uintptr_t)this + 0x1B0);
	}
	 IGroup1QuestEntity*>*& _aliveWithAliveCondition() {
		return *(IGroup1QuestEntity*>**)((uintptr_t)this + 0x1B8);
	}
	 IGroup1QuestEntity*>*& _aliveWithActiveCondition() {
		return *(IGroup1QuestEntity*>**)((uintptr_t)this + 0x1C0);
	}
	...
	template <typename R = QuestEntity*> R GetAliveQuest(int64_t owner, Il2CppString* name) {
	 ...
	 IGroup1QuestEntity*>* GetAliveActQuests() {
		return ((IGroup1QuestEntity*>* (*)(QuestContext*))(Il2CppBase() + 0x11C8EB4))(this);
	}
	 HashSet1QuestEntity*>* GetAliveActQuests_1(int64_t owner, Il2CppString* actName) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t, Il2CppString*))(Il2CppBase() + 0x11C9160))(this, owner, actName);
	}
	 HashSet1QuestEntity*>* GetAliveQuests(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11C9384))(this, owner);
	}
	 HashSet1QuestEntity*>* GetActualQuests(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11C9658))(this, owner);
	}
	 HashSet1QuestEntity*>* GetCompletedNotRewarded(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11C996C))(this, owner);
	}
	 HashSet1QuestEntity*>* GetCompletedNotFullRewarded(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11C9D54))(this, owner);
	}
	 HashSet1QuestEntity*>* GetAliveTracking(int64_t owner, TrackingSlot* slot) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t, TrackingSlot*))(Il2CppBase() + 0x11CA13C))(this, owner, slot);
	}
	 IGroup1QuestEntity*>* GetAliveWithTags() {
		return ((IGroup1QuestEntity*>* (*)(QuestContext*))(Il2CppBase() + 0x11CA590))(this);
	}
	 HashSet1QuestEntity*>* GetAliveWithTag(int64_t owner, Il2CppString* tag) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t, Il2CppString*))(Il2CppBase() + 0x11CA83C))(this, owner, tag);
	}
	template <typename R = QuestEntity*> R GetAliveTournament(int64_t owner) {
	 ...
	 IGroup1QuestEntity*>* GetAliveActivateTournament() {
		return ((IGroup1QuestEntity*>* (*)(QuestContext*))(Il2CppBase() + 0x11CAD74))(this);
	}
	 HashSet1QuestEntity*>* GetAliveActivateTournament_1(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11CB020))(this, owner);
	}
	 HashSet1QuestEntity*>* GetAliveGuildQuests(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11CB210))(this, owner);
	}
	 HashSet1QuestEntity*>* GetAliveEquipped(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11CB524))(this, owner);
	}
	 IGroup1QuestEntity*>* GetActualTargetMarker() {
		return ((IGroup1QuestEntity*>* (*)(QuestContext*))(Il2CppBase() + 0x11CB838))(this);
	}
	 IGroup1QuestEntity*>* GetAliveWithAliveCondition() {
		return ((IGroup1QuestEntity*>* (*)(QuestContext*))(Il2CppBase() + 0x11CBB74))(this);
	}
	template <typename R = QuestEntity*> R GetAliveGuildQuest(int64_t owner, int64_t guildQuestId) {
	 ...
	 IGroup1QuestEntity*>* GetAliveWithActiveCondition() {
		return ((IGroup1QuestEntity*>* (*)(QuestContext*))(Il2CppBase() + 0x11CBF5C))(this);
	}
	 HashSet1QuestEntity*>* GetAliveWithActiveCondition_1(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11CC318))(this, owner);
	}
	...
	template <typename R = void> R RemoveAllQuests(HashSet1QuestEntity*>* quests) {
		return ((R (*)(QuestContext*, HashSet1QuestEntity*>*))(Il2CppBase() + 0x11CDA74))(this, quests);
	}
	...
	template <typename R = QuestEntity*> R UpdateQuestFormData(UpdateQuestData* data) {
	 ...
	 Il2CppList<QuestEntity*>* GetQuestsToProgress(Il2CppArray<Il2CppString*>* tags, HashSet1QuestEntity*>* quests, int32_t triggerIndex, Il2CppList<QuestEntity*>* buffer, bool onlyShareable) {
		return ((Il2CppList<QuestEntity*>* (*)(QuestContext*, Il2CppArray<Il2CppString*>*, HashSet1QuestEntity*>*, int32_t, Il2CppList<QuestEntity*>*, bool))(Il2CppBase() + 0x11CE28C))(this, tags, quests, triggerIndex, buffer, onlyShareable);
	}
	...
	template <typename R = QuestEntity*> R CheatAddQuestProgress(int64_t ownerId, Il2CppString* questName, int32_t progress, int64_t now) {
	 ...
	 HashSet1QuestEntity*>* GetAliveTrackedQuests(int64_t owner) {
		return ((HashSet1QuestEntity*>* (*)(QuestContext*, int64_t))(Il2CppBase() + 0x11D2E78))(this, owner);
	}
