...
public: 
	...
	template <typename T = PlayerClassMenuBtn*> T& _buttonPrefab() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = uintptr_t> T& _emptyPanel() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = Il2CppList<PlayerClassMenuBtn*>*> T& _buttons() {
		return *(T*)((uintptr_t)this + 0x58);
	}
	template <typename T = ItemEntity*> T& _selectedClass() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = Il2CppString*> T& _className() {
		return *(T*)((uintptr_t)this + 0x68);
	}
	template <typename T = IHUDWindow*> T& _hudWindow() {
	...
	template <typename T = void> T Bind(IHUDWindow* hudWindow, uintptr_t onPlayerClassMenuOpen) {
		return ((T (*)(PlayerClassesMenu*, IHUDWindow*, uintptr_t))(Il2CppBase() + 0x1B758B0))(this, hudWindow, onPlayerClassMenuOpen);
	}
	...
	template <typename T = void> T OnSelected(PlayerClassMenuBtn* btn) {
		return ((T (*)(PlayerClassesMenu*, PlayerClassMenuBtn*))(Il2CppBase() + 0x1B76520))(this, btn);
	}
	template <typename T = void> T OnDeselectedEvent(PlayerClassMenuBtn* btn) {
		return ((T (*)(PlayerClassesMenu*, PlayerClassMenuBtn*))(Il2CppBase() + 0x1B7694C))(this, btn);
	}
	template <typename T = void> T OnSelectClassEvent(ItemEntity* classEntity) {
		return ((T (*)(PlayerClassesMenu*, ItemEntity*))(Il2CppBase() + 0x1B76568))(this, classEntity);
	}
