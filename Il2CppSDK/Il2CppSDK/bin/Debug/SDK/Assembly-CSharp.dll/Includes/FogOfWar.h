...
public: 
	...
	template <typename R = void> R Fill(Queue1<Coord>* next) {
		return ((R (*)(FogOfWar*, Queue1<Coord>*))(Il2CppBase() + 0x15F83C4))(this, next);
	}
	template <typename R = void> R Hide() {
		return ((R (*)(FogOfWar*))(Il2CppBase() + 0x15F90D0))(this);
	}
	 Nullable1<bool>* IsVisible(GameEntity* entity) {
		return ((Nullable1<bool>* (*)(FogOfWar*, GameEntity*))(Il2CppBase() + 0x15F92B8))(this, entity);
	}
