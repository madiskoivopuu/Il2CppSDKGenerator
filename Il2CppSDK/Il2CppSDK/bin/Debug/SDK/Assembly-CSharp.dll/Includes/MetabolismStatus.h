...
public: 
	...
	template <typename T = Nullable1int32_t>*> T& _hunger() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = Nullable1int32_t>*> T& _thirst() {
		return *(T*)((uintptr_t)this + 0x50);
	}

	template <typename T = void> T UpdateView(GameEntity* entity) {
		return ((T (*)(MetabolismStatus*, GameEntity*))(Il2CppBase() + 0x12D1D74))(this, entity);
	}
