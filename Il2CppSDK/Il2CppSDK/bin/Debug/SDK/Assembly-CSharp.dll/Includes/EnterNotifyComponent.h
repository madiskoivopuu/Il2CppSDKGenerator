...
public: 
	...
	template <typename T = EnterNotify*> T& OwnerNotify() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = EnterNotify*> T& ForeignNotify() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(EnterNotifyComponent*, Il2CppObject*))(Il2CppBase() + 0x13721E8))(this, targetObject);
	}
