...
public: 
	...
	template <typename T = TerritoryNames*> T& TerritoryNamesPrefab() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = uintptr_t> T& TerritoryBorderPrefab() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = TerritoryNames*> T& _territoryNames() {
	...
	template <typename T = void> T Bind(IUIWindow* window) {
		return ((T (*)(HUDQuadInfo*, IUIWindow*))(Il2CppBase() + 0x127AD0C))(this, window);
	}
	...
	template <typename T = Il2CppString*> T GetQuadName(AccountEntity* account, int32_t quadId) {
		return ((T (*)(HUDQuadInfo*, AccountEntity*, int32_t))(Il2CppBase() + 0x127B5F8))(this, account, quadId);
	}
