...
public: 
	...
	template <typename T = void> T AddCategoryType(StoreCategory* newType) {
		return ((T (*)(StoreSalesEntity*, StoreCategory*))(Il2CppBase() + 0x18400D0))(this, newType);
	}
	template <typename T = void> T ReplaceCategoryType(StoreCategory* newType) {
		return ((T (*)(StoreSalesEntity*, StoreCategory*))(Il2CppBase() + 0x18401D4))(this, newType);
	}
	...
	template <typename T = StoreSalesIdComponent*> T get_storeSalesId() {
	...
	template <typename T = WindowFrameComponent*> T get_windowFrame() {
