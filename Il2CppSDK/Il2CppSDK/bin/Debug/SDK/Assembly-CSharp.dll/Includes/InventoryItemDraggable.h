...
class InventoryItemDraggable: InventoryItem
{
public: 
	...
	template <typename T = void> T set_Slot(uintptr_t value) {
		return ((T (*)(InventoryItemDraggable*, uintptr_t))(Il2CppBase() + 0x1230F00))(this, value);
	}
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t entity, int32_t index, uintptr_t slot, uintptr_t handler) {
		return ((T (*)(InventoryItemDraggable*, uintptr_t, uintptr_t, int32_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x12311A0))(this, window, entity, index, slot, handler);
	}
	template <typename T = void> T Bind_1(uintptr_t window, uintptr_t entity, int32_t index) {
		return ((T (*)(InventoryItemDraggable*, uintptr_t, uintptr_t, int32_t))(Il2CppBase() + 0x123121C))(this, window, entity, index);
	}
