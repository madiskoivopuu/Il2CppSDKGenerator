...
public: 
	...
	template <typename T = bool> T Equals(IntString* other) {
		return ((T (*)(IntString*, IntString*))(Il2CppBase() + 0x14698E8))(this, other);
	}
	template <typename T = bool> T Equals_1(Il2CppObject* obj) {
		return ((T (*)(IntString*, Il2CppObject*))(Il2CppBase() + 0x146990C))(this, obj);
	}
