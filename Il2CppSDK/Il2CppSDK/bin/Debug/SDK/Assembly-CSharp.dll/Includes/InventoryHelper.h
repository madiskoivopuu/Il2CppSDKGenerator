...
public: 
	...
	template <typename R = bool> static R IsEnoughResources(GameEntity* entity, ICommonContexts* world, IEnumerable1Resource*>* resources, bool useExternalInventory) {
		return ((R (*)(void *, GameEntity*, ICommonContexts*, IEnumerable1Resource*>*, bool))(Il2CppBase() + 0x14722D8))(0, entity, world, resources, useExternalInventory);
	}
	...
	template <typename R = bool> static R IsEnoughResourcesAndCurrency(GameEntity* entity, ICommonContexts* world, IEnumerable1Resource*>* resources, bool useExternalInventory) {
		return ((R (*)(void *, GameEntity*, ICommonContexts*, IEnumerable1Resource*>*, bool))(Il2CppBase() + 0x1472850))(0, entity, world, resources, useExternalInventory);
	}
	...
	template <typename R = int32_t> static R ConsumeResources(GameEntity* entity, ICommonContexts* world, IEnumerable1Resource*>* resources, bool useExternalInventory) {
		return ((R (*)(void *, GameEntity*, ICommonContexts*, IEnumerable1Resource*>*, bool))(Il2CppBase() + 0x14730E0))(0, entity, world, resources, useExternalInventory);
	}
	...
	template <typename R = void> static R SetResource(InventorySlotEntity* inventoryEntity, ICommonContexts* world, ItemEntity* resourceItem, int32_t count, Nullable1int64_t>* signature, Nullable1float>* durabilityCoef) {
		return ((R (*)(void *, InventorySlotEntity*, ICommonContexts*, ItemEntity*, int32_t, Nullable1int64_t>*, Nullable1float>*))(Il2CppBase() + 0x1473534))(0, inventoryEntity, world, resourceItem, count, signature, durabilityCoef);
	}
	template <typename R = void> static R SetResource_1(InventorySlotEntity* inventoryEntity, ICommonContexts* world, Resource* resource, Nullable1int64_t>* signature) {
		return ((R (*)(void *, InventorySlotEntity*, ICommonContexts*, Resource*, Nullable1int64_t>*))(Il2CppBase() + 0x14738C8))(0, inventoryEntity, world, resource, signature);
	}
	template <typename R = void> static R ReplaceAndSignStack(InventorySlotEntity* slotEntity, Il2CppString* resource, int32_t count, Nullable1int64_t>* signature) {
		return ((R (*)(void *, InventorySlotEntity*, Il2CppString*, int32_t, Nullable1int64_t>*))(Il2CppBase() + 0x14739E0))(0, slotEntity, resource, count, signature);
	}
	...
	template <typename R = bool> static R SetItem(InventorySlotEntity* inventoryEntity, ItemEntity* item, int32_t count, Nullable1int64_t>* signature, Nullable1float>* durabilityCoef) {
		return ((R (*)(void *, InventorySlotEntity*, ItemEntity*, int32_t, Nullable1int64_t>*, Nullable1float>*))(Il2CppBase() + 0x1473694))(0, inventoryEntity, item, count, signature, durabilityCoef);
	}
	...
	template <typename R = int32_t> static R CanAddResource_2(ICommonContexts* world, int32_t parentId, ItemEntity* resourceItem, int32_t count, int32_t maxCount) {
	 ...
	 static ValueTuple2int32_t, int32_t>* CanAddResources(ICommonContexts* world, GameEntity* avatar, IEnumerable1Resource*>* addedResources) {
		return ((ValueTuple2int32_t, int32_t>* (*)(void *, ICommonContexts*, GameEntity*, IEnumerable1Resource*>*))(Il2CppBase() + 0x1475708))(0, world, avatar, addedResources);
	}
	...
	template <typename R = int32_t> static R GetNotEmptyInventoriesCount(InventorySlotContext* context, int32_t id) {
	 ...
	 static ValueTuple3InventorySlotEntity*, ItemEntity*, float>* GetInteractItem(ICommonContexts* world, GameEntity* actor, Il2CppArray<NameChance*>* requiredItems) {
		return ((ValueTuple3InventorySlotEntity*, ItemEntity*, float>* (*)(void *, ICommonContexts*, GameEntity*, Il2CppArray<NameChance*>*))(Il2CppBase() + 0x1476784))(0, world, actor, requiredItems);
	}
	template <typename R = bool> static R CanBlueprintCraft(ICommonContexts* world, GameEntity* entity, IEnumerable1Resource*>* resourcesToConsume, Il2CppString* name, int32_t count) {
		return ((R (*)(void *, ICommonContexts*, GameEntity*, IEnumerable1Resource*>*, Il2CppString*, int32_t))(Il2CppBase() + 0x1476DE8))(0, world, entity, resourcesToConsume, name, count);
	}
	...
	template <typename R = ItemEntity*> static R GetBackpackFromInventory(GameEntity* entity, ICommonContexts* world) {
	 ...
	 static ValueTuple3bool, int32_t, int32_t>* CanReplaceBackpack(GameEntity* entity, ICommonContexts* world, ItemEntity* newBackpack, int32_t moveCount) {
		return ((ValueTuple3bool, int32_t, int32_t>* (*)(void *, GameEntity*, ICommonContexts*, ItemEntity*, int32_t))(Il2CppBase() + 0x14798E4))(0, entity, world, newBackpack, moveCount);
	}
