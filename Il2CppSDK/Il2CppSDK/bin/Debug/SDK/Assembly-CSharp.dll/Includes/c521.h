...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static c521<T>*& 9() {
		return *(c521<T>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Func2<InventorySlotEntity*, int32_t>*& 9__52_0() {
		return *(Func2<InventorySlotEntity*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Func2<InventorySlotEntity*, int32_t>*& 9__52_1() {
		return *(Func2<InventorySlotEntity*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Func2<InventorySlotEntity*, int32_t>*& 9__52_2() {
		return *(Func2<InventorySlotEntity*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
