...
public: 
	...
	template <typename T = MountsGuideTabsController*> T& TabsController() {
	...
	template <typename T = TextMonoBehaviour*> T& Tenacity() {
		return *(T*)((uintptr_t)this + 0x90);
	}
	template <typename T = TextMonoBehaviour*> T& SlotsCount() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = TextMonoBehaviour*> T& MountSpeed() {
	...
	template <typename T = MountSkillInfo*> T& SkillPrefab() {
	...
	template <typename T = Il2CppDictionary<Il2CppString*, HashSet1Icon*>*>*> T& _mountsIcons() {
	...
	template <typename T = void> T ShowMountData(ItemEntity* mountData) {
		return ((T (*)(MountsGuideWindow*, ItemEntity*))(Il2CppBase() + 0x154B580))(this, mountData);
	}
