...
public: 
	...
	template <typename T = GameVersion*> static T& Version() {
	...
	template <typename T = DropOnDeath*> static T& DROP_ON_DEATH() {
	...
	template <typename T = Il2CppDictionary<Rarity*, Il2CppArray<uintptr_t>*>*> static T& SKIP_PRICES() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = Il2CppDictionary<Rarity*, Il2CppArray<uintptr_t>*>*> static T& SKIP_MOUNTS_PRICES() {
	...
	template <typename T = ConfigFromServer*> static T& FromServer() {
	...
	template <typename T = int32_t> static T GetSkipPrice(float floatSeconds, Rarity* rarity, SkipType* skipType) {
		return ((T (*)(void *, float, Rarity*, SkipType*))(Il2CppBase() + 0xE29618))(0, floatSeconds, rarity, skipType);
	}
	template <typename T = int32_t> static T GetRepairTaxSilver(ItemEntity* item) {
		return ((T (*)(void *, ItemEntity*))(Il2CppBase() + 0xE298E4))(0, item);
	}
	template <typename T = Il2CppString*> static T GetCupTag(PlayerClassProgress* progressType) {
		return ((T (*)(void *, PlayerClassProgress*))(Il2CppBase() + 0xE29A14))(0, progressType);
	}
	...
	template <typename T = int64_t> static T GetNextGuildTournamentTime(int64_t now, ConfigFromServer* configFromServer) {
		return ((T (*)(void *, int64_t, ConfigFromServer*))(Il2CppBase() + 0xE2A65C))(0, now, configFromServer);
	}
	template <typename T = int64_t> static T GetStartGuildTournamentTime(int64_t now, ConfigFromServer* configFromServer) {
		return ((T (*)(void *, int64_t, ConfigFromServer*))(Il2CppBase() + 0xE2A6DC))(0, now, configFromServer);
	}
	template <typename T = int64_t> static T GetNextRestGuildTournamentTime(int64_t now, ConfigFromServer* configFromServer) {
		return ((T (*)(void *, int64_t, ConfigFromServer*))(Il2CppBase() + 0xE2A75C))(0, now, configFromServer);
	}
