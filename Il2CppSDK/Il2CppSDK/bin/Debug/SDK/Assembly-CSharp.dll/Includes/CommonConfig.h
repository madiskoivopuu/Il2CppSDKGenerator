...
public: 
	...
	template <typename R = bool> static R& INVENTORY_DATA_COMPRESSION() {
	 ...
	 static Il2CppDictionary<Rarity*, Il2CppArray<ValueTuple2int32_t, int32_t>*>*>*& SKIP_PRICES() {
		return *(Il2CppDictionary<Rarity*, Il2CppArray<ValueTuple2int32_t, int32_t>*>*>**)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	 static Il2CppDictionary<Rarity*, Il2CppArray<ValueTuple2int32_t, int32_t>*>*>*& SKIP_MOUNTS_PRICES() {
		return *(Il2CppDictionary<Rarity*, Il2CppArray<ValueTuple2int32_t, int32_t>*>*>**)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
