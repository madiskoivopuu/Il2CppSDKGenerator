...
public: 
	...
	template <typename R = int32_t> R& _currentStackCount() {
	 ...
	 Nullable1bool>*& _selectedItemHasCooldown() {
		return *(Nullable1bool>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = void> R add_OnBeginScrolling(Action2IInventoryItem*, uintptr_t>* value) {
		return ((R (*)(BaseInventoryWindow1*, Action2IInventoryItem*, uintptr_t>*))(Il2CppBase() + 0x0))(this, value);
	}
