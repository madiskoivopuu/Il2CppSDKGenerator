...
public: 
	...
	template <typename T = bool> static T op_Equality(CategoryEvent* a, CategoryEvent* b) {
		return ((T (*)(void *, CategoryEvent*, CategoryEvent*))(Il2CppBase() + 0x13E8BC0))(0, a, b);
	}
	template <typename T = bool> static T op_Inequality(CategoryEvent* a, CategoryEvent* b) {
		return ((T (*)(void *, CategoryEvent*, CategoryEvent*))(Il2CppBase() + 0x13E8C5C))(0, a, b);
	}
	template <typename T = bool> T Equals(CategoryEvent* other) {
		return ((T (*)(CategoryEvent*, CategoryEvent*))(Il2CppBase() + 0x13E8BEC))(this, other);
	}
	template <typename T = bool> T Equals_1(Il2CppObject* obj) {
		return ((T (*)(CategoryEvent*, Il2CppObject*))(Il2CppBase() + 0x13E8C98))(this, obj);
	}
