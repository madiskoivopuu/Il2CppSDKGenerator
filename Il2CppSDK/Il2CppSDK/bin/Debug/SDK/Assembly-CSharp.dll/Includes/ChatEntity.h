...
public: 
	...
	template <typename T = uintptr_t> static T& chatComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& groupChatComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}

	template <typename T = uintptr_t> T get_channels() {
	...
	template <typename T = uintptr_t> T get_from() {
	...
	template <typename T = uintptr_t> T get_guildBossName() {
	...
	template <typename T = uintptr_t> T get_guildDailyMessage() {
	...
	template <typename T = uintptr_t> T get_guildEventType() {
	...
	template <typename T = void> T AddGuildEventType(uintptr_t newValue) {
		return ((T (*)(ChatEntity*, uintptr_t))(Il2CppBase() + 0x13F42D0))(this, newValue);
	}
	template <typename T = void> T ReplaceGuildEventType(uintptr_t newValue) {
		return ((T (*)(ChatEntity*, uintptr_t))(Il2CppBase() + 0x13F43D4))(this, newValue);
	}
	template <typename T = void> T RemoveGuildEventType() {
		return ((T (*)(ChatEntity*))(Il2CppBase() + 0x13F44D8))(this);
	}
	template <typename T = uintptr_t> T get_guildPlayerName() {
	...
	template <typename T = uintptr_t> T get_guildQuestName() {
	...
	template <typename T = uintptr_t> T get_guildRandomMessage() {
	...
	template <typename T = void> T AddGuildRole(uintptr_t newType) {
		return ((T (*)(ChatEntity*, uintptr_t))(Il2CppBase() + 0x13F4DD0))(this, newType);
	}
	template <typename T = void> T ReplaceGuildRole(uintptr_t newType) {
		return ((T (*)(ChatEntity*, uintptr_t))(Il2CppBase() + 0x13F4ED4))(this, newType);
	}
	template <typename T = void> T RemoveGuildRole() {
		return ((T (*)(ChatEntity*))(Il2CppBase() + 0x13F4FD8))(this);
	}
	template <typename T = uintptr_t> T get_guildWeeklyRank() {
	...
	template <typename T = uintptr_t> T get_messageView() {
	...
	template <typename T = void> T AddMessageView(uintptr_t newView) {
		return ((T (*)(ChatEntity*, uintptr_t))(Il2CppBase() + 0x13F5320))(this, newView);
	}
	template <typename T = void> T ReplaceMessageView(uintptr_t newView) {
		return ((T (*)(ChatEntity*, uintptr_t))(Il2CppBase() + 0x13F5434))(this, newView);
	}
	...
	template <typename T = uintptr_t> T get_to() {
