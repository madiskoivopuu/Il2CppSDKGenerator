...
public: 
	...
	template <typename R = View*> R& _currentView() {
	 ...
	 Action1ActTabButton*>*& ClickEvent() {
		return *(Action1ActTabButton*>**)((uintptr_t)this + 0x40);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1ActTabButton*>* value) {
		return ((R (*)(ActTabButton*, Action1ActTabButton*>*))(Il2CppBase() + 0x18F553C))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1ActTabButton*>* value) {
		return ((R (*)(ActTabButton*, Action1ActTabButton*>*))(Il2CppBase() + 0x18F55DC))(this, value);
	}
