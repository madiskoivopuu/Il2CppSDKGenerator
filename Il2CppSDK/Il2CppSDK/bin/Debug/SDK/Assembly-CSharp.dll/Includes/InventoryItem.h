...
class InventoryItem: TextImageMonoBehaviour
{
public: 
	...
	template <typename T = uintptr_t> T& Grade() {
	...
	template <typename T = uintptr_t> T& _defaultItem() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = void*> T& ResourceChanged() {
	...
	template <typename T = void*> T& _durability() {
	...
	template <typename T = void> T add_ResourceChanged(void* value) {
		return ((T (*)(InventoryItem*, void*))(Il2CppBase() + 0x147B47C))(this, value);
	}
	template <typename T = void> T remove_ResourceChanged(void* value) {
		return ((T (*)(InventoryItem*, void*))(Il2CppBase() + 0x147B51C))(this, value);
	}
	template <typename T = uintptr_t> T get_DefaultItem() {
		return ((T (*)(InventoryItem*))(Il2CppBase() + 0x147B5BC))(this);
	}
	template <typename T = void> T set_DefaultItem(uintptr_t value) {
		return ((T (*)(InventoryItem*, uintptr_t))(Il2CppBase() + 0x147B5C4))(this, value);
	}
	...
	template <typename T = void> T set_Item(uintptr_t value) {
		return ((T (*)(InventoryItem*, uintptr_t))(Il2CppBase() + 0x147B618))(this, value);
	}
	...
	template <typename T = void> T set_Window(uintptr_t value) {
		return ((T (*)(InventoryItem*, uintptr_t))(Il2CppBase() + 0x147B6B8))(this, value);
	}
	template <typename T = void> T Clean() {
		return ((T (*)(InventoryItem*))(Il2CppBase() + 0x147B6C8))(this);
	}
	template <typename T = void> T Bind(uintptr_t window, uintptr_t entity, int32_t index, uintptr_t defaultItem) {
		return ((T (*)(InventoryItem*, uintptr_t, uintptr_t, int32_t, uintptr_t))(Il2CppBase() + 0x147BA38))(this, window, entity, index, defaultItem);
	}
	template <typename T = void> T Bind_1(uintptr_t window, uintptr_t entity, int32_t index) {
		return ((T (*)(InventoryItem*, uintptr_t, uintptr_t, int32_t))(Il2CppBase() + 0x147BA74))(this, window, entity, index);
	}
	...
	template <typename T = void> T SetActive(void* active, bool hard) {
		return ((T (*)(InventoryItem*, void*, bool))(Il2CppBase() + 0x147CB14))(this, active, hard);
	}
	...
	template <typename T = void> T OnUpdateCancel(uintptr_t activeMagic) {
		return ((T (*)(InventoryItem*, uintptr_t))(Il2CppBase() + 0x147CE64))(this, activeMagic);
	}
