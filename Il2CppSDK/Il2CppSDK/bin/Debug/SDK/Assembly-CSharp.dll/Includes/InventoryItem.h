...
public: 
	...
	template <typename R = ItemEntity*> R& _defaultItem() {
	 ...
	 Action1InventoryItem*>*& ResourceChanged() {
		return *(Action1InventoryItem*>**)((uintptr_t)this + 0xF0);
	}
	 Nullable1int32_t>*& _count() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0xF8);
	}
	template <typename R = int32_t> R& _maxCount() {
		return *(R*)((uintptr_t)this + 0x100);
	}
	 Nullable1float>*& _durability() {
		return *(Nullable1float>**)((uintptr_t)this + 0x104);
	}
	...
	template <typename R = void> R add_ResourceChanged(Action1InventoryItem*>* value) {
		return ((R (*)(InventoryItem*, Action1InventoryItem*>*))(Il2CppBase() + 0x147B47C))(this, value);
	}
	template <typename R = void> R remove_ResourceChanged(Action1InventoryItem*>* value) {
		return ((R (*)(InventoryItem*, Action1InventoryItem*>*))(Il2CppBase() + 0x147B51C))(this, value);
	}
	...
	template <typename R = void> R SetActive(Nullable1bool>* active, bool hard) {
		return ((R (*)(InventoryItem*, Nullable1bool>*, bool))(Il2CppBase() + 0x147CB14))(this, active, hard);
	}
