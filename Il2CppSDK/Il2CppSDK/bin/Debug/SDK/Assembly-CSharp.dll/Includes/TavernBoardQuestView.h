...
public: 
	...
	template <typename R = Il2CppArray<RewardResourceView*>*> R& _rewardViews() {
	 ...
	 Action1<TavernBoardQuestView*>*& OnClaimClickEvent() {
		return *(Action1<TavernBoardQuestView*>**)((uintptr_t)this + 0x48);
	}
	...
	template <typename R = void> R add_OnClaimClickEvent(Action1<TavernBoardQuestView*>* value) {
		return ((R (*)(TavernBoardQuestView*, Action1<TavernBoardQuestView*>*))(Il2CppBase() + 0x16AA15C))(this, value);
	}
	template <typename R = void> R remove_OnClaimClickEvent(Action1<TavernBoardQuestView*>* value) {
		return ((R (*)(TavernBoardQuestView*, Action1<TavernBoardQuestView*>*))(Il2CppBase() + 0x16AA1FC))(this, value);
	}
	...
	template <typename R = void> R UpdateView(GameEntity* avatar, GameEntity* target) {
	 ...
	 ValueTuple2<Il2CppString*, int64_t>* UpdateStatus(GameEntity* avatar, GameEntity* target) {
		return ((ValueTuple2<Il2CppString*, int64_t>* (*)(TavernBoardQuestView*, GameEntity*, GameEntity*))(Il2CppBase() + 0x16AAD88))(this, avatar, target);
	}
