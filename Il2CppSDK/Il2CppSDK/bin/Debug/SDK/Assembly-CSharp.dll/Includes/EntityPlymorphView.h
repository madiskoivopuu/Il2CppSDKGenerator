...
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _others() {
	...
	template <typename T = void> T set_Base(uintptr_t value) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1374574))(this, value);
	}
	...
	template <typename T = void> T AddPolymorphView(uintptr_t polymorphView) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1374790))(this, polymorphView);
	}
	...
	template <typename T = void> T set_Position(Il2CppVector3 value) {
		return ((T (*)(EntityPlymorphView*, Il2CppVector3))(Il2CppBase() + 0x1374B04))(this, value);
	}
	...
	template <typename T = void> T set_LocalScale(Il2CppVector3 value) {
		return ((T (*)(EntityPlymorphView*, Il2CppVector3))(Il2CppBase() + 0x1374CBC))(this, value);
	}
	...
	template <typename T = uintptr_t> T get_Sounds() {
	...
	template <typename T = void> T SetMinimapIcon(uintptr_t entity, Il2CppString* iconName, bool directed) {
		return ((T (*)(EntityPlymorphView*, uintptr_t, Il2CppString*, bool))(Il2CppBase() + 0x13769DC))(this, entity, iconName, directed);
	}
	...
	template <typename T = void> T Death(uintptr_t entity) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1376A00))(this, entity);
	}
	...
	template <typename T = void> T Execute(uintptr_t entity, float deltaTime) {
		return ((T (*)(EntityPlymorphView*, uintptr_t, float))(Il2CppBase() + 0x1376E90))(this, entity, deltaTime);
	}
	...
	template <typename T = void> T SetupGender(uintptr_t gender, bool hd) {
		return ((T (*)(EntityPlymorphView*, uintptr_t, bool))(Il2CppBase() + 0x137776C))(this, gender, hd);
	}
	template <typename T = void> T SetupSlotView(uintptr_t item, int32_t slotIndex, bool hd) {
		return ((T (*)(EntityPlymorphView*, uintptr_t, int32_t, bool))(Il2CppBase() + 0x13778B8))(this, item, slotIndex, hd);
	}
	...
	template <typename T = void> T UpdateArmed(uintptr_t entity) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1377A38))(this, entity);
	}
	template <typename T = void> T SetupToolView(uintptr_t item) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1377A48))(this, item);
	}
	...
	template <typename T = void> T AddChild(uintptr_t child) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1377CF8))(this, child);
	}
	template <typename T = void> T RemoveChild(uintptr_t child) {
		return ((T (*)(EntityPlymorphView*, uintptr_t))(Il2CppBase() + 0x1377D08))(this, child);
	}
