...
public: 
	...
	template <typename R = void> R TryEnterDistrict(bool popular) {
	 ...
	 ValueTuple2bool, Il2CppString*>* CheckEnterLocation(GameEntity* avatar, GameEntity* point, LocationEntity* location) {
		return ((ValueTuple2bool, Il2CppString*>* (*)(LocationHubEnterWindow*, GameEntity*, GameEntity*, LocationEntity*))(Il2CppBase() + 0x17B38F8))(this, avatar, point, location);
	}
