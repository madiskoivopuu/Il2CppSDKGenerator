...
public: 
	...
	template <typename T = ValueTuple2bool, Il2CppString*>*> T CheckEnterLocation(GameEntity* avatar, GameEntity* point, LocationEntity* location) {
		return ((T (*)(LocationHubEnterWindow*, GameEntity*, GameEntity*, LocationEntity*))(Il2CppBase() + 0x17B38F8))(this, avatar, point, location);
	}
