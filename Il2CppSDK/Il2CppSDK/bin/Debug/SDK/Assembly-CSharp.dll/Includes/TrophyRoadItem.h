...
public: 
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t tropyRoadEntity, int32_t currentLevel, bool forceResourcesFull, bool changeSelection) {
		return ((T (*)(TrophyRoadItem*, uintptr_t, uintptr_t, int32_t, bool, bool))(Il2CppBase() + 0x1022C78))(this, window, tropyRoadEntity, currentLevel, forceResourcesFull, changeSelection);
	}
	...
	template <typename T = void> T OnChangeSelection(uintptr_t item) {
		return ((T (*)(TrophyRoadItem*, uintptr_t))(Il2CppBase() + 0x1023044))(this, item);
	}
