...
public: 
	...
	template <typename T = void> T SetWaterfallConfiguration(uintptr_t waterfallConfiguration, uintptr_t adFormat) {
		return ((T (*)(UnsupportedPlatformAgent*, uintptr_t, uintptr_t))(Il2CppBase() + 0x153B91C))(this, waterfallConfiguration, adFormat);
	}
	...
	template <typename T = void> T loadBanner(uintptr_t size, uintptr_t position) {
		return ((T (*)(UnsupportedPlatformAgent*, uintptr_t, uintptr_t))(Il2CppBase() + 0x153BA28))(this, size, position);
	}
	template <typename T = void> T loadBanner_1(uintptr_t size, uintptr_t position, Il2CppString* placementName) {
		return ((T (*)(UnsupportedPlatformAgent*, uintptr_t, uintptr_t, Il2CppString*))(Il2CppBase() + 0x153BA2C))(this, size, position, placementName);
	}
	...
	template <typename T = void> T setSegment(uintptr_t segment) {
		return ((T (*)(UnsupportedPlatformAgent*, uintptr_t))(Il2CppBase() + 0x153BA44))(this, segment);
	}
