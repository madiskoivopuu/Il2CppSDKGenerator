...
public: 
	...
	template <typename R = Il2CppString*> static R GetLureName(ICommonContexts* world, GameEntity* target, Il2CppString* lureTag) {
	 ...
	 static Nullable1float>* GetFishingOscillationValue(ICommonContexts* world, ActionEntity* actionEntity, Il2CppString* name, int64_t time) {
		return ((Nullable1float>* (*)(void *, ICommonContexts*, ActionEntity*, Il2CppString*, int64_t))(Il2CppBase() + 0x1699EF4))(0, world, actionEntity, name, time);
	}
