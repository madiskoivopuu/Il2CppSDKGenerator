...
public: 
	...
	template <typename T = Action1GuildTabButton*>*> T& _onButtonClicked() {
	...
	template <typename T = void> T Bind(uintptr_t panel, uintptr_t offBackground, Action1GuildTabButton*>* onClicked) {
		return ((T (*)(GuildTabButton*, uintptr_t, uintptr_t, Action1GuildTabButton*>*))(Il2CppBase() + 0x194565C))(this, panel, offBackground, onClicked);
	}
