...
public: 
	...
	template <typename R = uintptr_t> R& Panel() {
	 ...
	 Action1GuildTabButton*>*& _onButtonClicked() {
		return *(Action1GuildTabButton*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = void> R Bind(uintptr_t panel, uintptr_t offBackground, Action1GuildTabButton*>* onClicked) {
		return ((R (*)(GuildTabButton*, uintptr_t, uintptr_t, Action1GuildTabButton*>*))(Il2CppBase() + 0x194565C))(this, panel, offBackground, onClicked);
	}
