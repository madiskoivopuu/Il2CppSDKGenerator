...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1GooglePlayGamesBasicApiNearby::INearbyConnectionClient*>*& callback() {
		return *(Action1GooglePlayGamesBasicApiNearby::INearbyConnectionClient*>**)((uintptr_t)this + 0x10);
	}
