...
public: 
	...
	template <typename R = ItemEntity*> R& Item() {
	 ...
	 Action1ItemView*>*& ClickEvent() {
		return *(Action1ItemView*>**)((uintptr_t)this + 0x70);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1ItemView*>* value) {
		return ((R (*)(ItemView*, Action1ItemView*>*))(Il2CppBase() + 0x14E0B1C))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1ItemView*>* value) {
		return ((R (*)(ItemView*, Action1ItemView*>*))(Il2CppBase() + 0x14E0BBC))(this, value);
	}
