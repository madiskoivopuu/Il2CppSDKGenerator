...
public: 
	...
	template <typename T = Il2CppDictionary<int32_t, Stack1uintptr_t>*>*> T& contentPool() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = IFactory2uintptr_t, uintptr_t>*> T& factory() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	...
	template <typename T = uintptr_t> T Pop_1(Stack1uintptr_t>* stack, uintptr_t data, uintptr_t parent) {
		return ((T (*)(PolymorphMonoObjectPool2*, Stack1uintptr_t>*, uintptr_t, uintptr_t))(Il2CppBase() + 0x0))(this, stack, data, parent);
	}
	...
	template <typename T = void> T Pool_1(Stack1uintptr_t>* stack, uintptr_t poolable) {
		return ((T (*)(PolymorphMonoObjectPool2*, Stack1uintptr_t>*, uintptr_t))(Il2CppBase() + 0x0))(this, stack, poolable);
	}
