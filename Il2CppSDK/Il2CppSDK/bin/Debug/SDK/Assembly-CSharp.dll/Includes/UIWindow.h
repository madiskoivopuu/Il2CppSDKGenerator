...
public: 
	...
	template <typename R = IUIWindowsLayer*> R& Layer() {
	 ...
	 Action1<IUIWindow*>*& Closed() {
		return *(Action1<IUIWindow*>**)((uintptr_t)this + 0x48);
	}
	 Action1<IUIWindow*>*& Showed() {
		return *(Action1<IUIWindow*>**)((uintptr_t)this + 0x50);
	}
	 Action1<float>*& OnInput() {
		return *(Action1<float>**)((uintptr_t)this + 0x58);
	}
	 Action1<float>*& OnDraw() {
		return *(Action1<float>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = void> R add_Closed(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindow*, Action1<IUIWindow*>*))(Il2CppBase() + 0x153297C))(this, value);
	}
	template <typename R = void> R remove_Closed(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindow*, Action1<IUIWindow*>*))(Il2CppBase() + 0x1532A1C))(this, value);
	}
	template <typename R = void> R add_Showed(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindow*, Action1<IUIWindow*>*))(Il2CppBase() + 0x1532ABC))(this, value);
	}
	template <typename R = void> R remove_Showed(Action1<IUIWindow*>* value) {
		return ((R (*)(UIWindow*, Action1<IUIWindow*>*))(Il2CppBase() + 0x1532B5C))(this, value);
	}
	template <typename R = void> R add_OnInput(Action1<float>* value) {
		return ((R (*)(UIWindow*, Action1<float>*))(Il2CppBase() + 0x1532BFC))(this, value);
	}
	template <typename R = void> R remove_OnInput(Action1<float>* value) {
		return ((R (*)(UIWindow*, Action1<float>*))(Il2CppBase() + 0x1532C9C))(this, value);
	}
	template <typename R = void> R add_OnDraw(Action1<float>* value) {
		return ((R (*)(UIWindow*, Action1<float>*))(Il2CppBase() + 0x1532D3C))(this, value);
	}
	template <typename R = void> R remove_OnDraw(Action1<float>* value) {
		return ((R (*)(UIWindow*, Action1<float>*))(Il2CppBase() + 0x1532DDC))(this, value);
	}
