...
public: 
	...
	template <typename T = void> T CopyTo(uintptr_t targetObject) {
		return ((T (*)(PatrolComponent*, uintptr_t))(Il2CppBase() + 0x11E9CA4))(this, targetObject);
	}
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(PatrolComponent*, uintptr_t))(Il2CppBase() + 0x11E9D58))(this, blueprintComponent);
	}
