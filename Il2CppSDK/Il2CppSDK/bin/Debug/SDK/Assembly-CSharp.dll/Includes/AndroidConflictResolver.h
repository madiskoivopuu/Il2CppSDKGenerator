...
public: 
	...
	template <typename T = uintptr_t> T& mAndroidSavedGameClient() {
	...
	template <typename T = void> T ResolveConflict(uintptr_t chosenMetadata, uintptr_t metadataUpdate, Il2CppArray<uintptr_t>* updatedData) {
		return ((T (*)(AndroidConflictResolver*, uintptr_t, uintptr_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1145AF8))(this, chosenMetadata, metadataUpdate, updatedData);
	}
	template <typename T = void> T ChooseMetadata(uintptr_t chosenMetadata) {
		return ((T (*)(AndroidConflictResolver*, uintptr_t))(Il2CppBase() + 0x1146518))(this, chosenMetadata);
	}
