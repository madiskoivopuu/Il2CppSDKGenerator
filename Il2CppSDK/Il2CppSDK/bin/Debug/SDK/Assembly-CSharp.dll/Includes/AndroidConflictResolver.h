...
public: 
	...
	template <typename R = GooglePlayGamesAndroid::AndroidSnapshotMetadata*> R& mUnmerged() {
	 ...
	 Action2<GooglePlayGamesBasicApiSavedGame::SavedGameRequestStatus, GooglePlayGamesBasicApiSavedGame::ISavedGameMetadata*>*& mCompleteCallback() {
		return *(Action2<GooglePlayGamesBasicApiSavedGame::SavedGameRequestStatus, GooglePlayGamesBasicApiSavedGame::ISavedGameMetadata*>**)((uintptr_t)this + 0x30);
	}
