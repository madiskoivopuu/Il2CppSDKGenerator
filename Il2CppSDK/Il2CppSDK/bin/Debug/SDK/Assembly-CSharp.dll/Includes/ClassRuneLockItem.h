...
public: 
	...
	template <typename T = uintptr_t> T& _shLevelText() {
	...
	template <typename T = void> T Bind(uintptr_t runePanel, int32_t Index, int32_t firstLockedLevel, bool isClassLocked) {
		return ((T (*)(ClassRuneLockItem*, uintptr_t, int32_t, int32_t, bool))(Il2CppBase() + 0x159C950))(this, runePanel, Index, firstLockedLevel, isClassLocked);
	}
