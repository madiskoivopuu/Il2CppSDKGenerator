...
public: 
	...
	template <typename R = void> R Bind(Icon icon, Il2CppString* innerName, Il2CppString* localizationName, uintptr_t onclick, Action1<Il2CppString*>* onclickWithParameter, Func2<Il2CppString*, Il2CppString*>* captionGetter, int32_t rarity) {
		return ((R (*)(ButtonCheatView*, Icon, Il2CppString*, Il2CppString*, uintptr_t, Action1<Il2CppString*>*, Func2<Il2CppString*, Il2CppString*>*, int32_t))(Il2CppBase() + 0x15B1090))(this, icon, innerName, localizationName, onclick, onclickWithParameter, captionGetter, rarity);
	}
