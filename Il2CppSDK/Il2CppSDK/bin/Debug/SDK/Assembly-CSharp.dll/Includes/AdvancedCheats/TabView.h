...
public: 
	...
	template <typename T = TextMonoBehaviour*> T& text() {
	...
	template <typename T = TabView*> static T& selected() {
	...
	template <typename T = void> T Bind(Il2CppString* tabName, Action1Il2CppString*>* onSelect) {
		return ((T (*)(TabView*, Il2CppString*, Action1Il2CppString*>*))(Il2CppBase() + 0x16A3258))(this, tabName, onSelect);
	}
