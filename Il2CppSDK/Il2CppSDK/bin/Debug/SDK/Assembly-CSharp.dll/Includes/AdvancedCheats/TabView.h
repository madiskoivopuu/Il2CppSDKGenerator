...
public: 
	...
	template <typename R = void> R Bind(Il2CppString* tabName, Action1<Il2CppString*>* onSelect) {
		return ((R (*)(TabView*, Il2CppString*, Action1<Il2CppString*>*))(Il2CppBase() + 0x16A3258))(this, tabName, onSelect);
	}
