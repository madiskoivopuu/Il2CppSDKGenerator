...
public: 
	...
	template <typename R = ButtonCheatInfo*> static R CreateCustomCheatInfo(Il2CppString* cheatName, uintptr_t action, Action1<Il2CppString*>* actionWithParameter, Il2CppString* iconName, bool hideOnMap, bool hideOnArena, Func2<Il2CppString*, Il2CppString*>* captionGetter) {
		return ((R (*)(void *, Il2CppString*, uintptr_t, Action1<Il2CppString*>*, Il2CppString*, bool, bool, Func2<Il2CppString*, Il2CppString*>*))(Il2CppBase() + 0x129B224))(0, cheatName, action, actionWithParameter, iconName, hideOnMap, hideOnArena, captionGetter);
	}
	...
	template <typename R = ToggleCheatInfo*> static R CreateToggleCheatInfo(Il2CppString* cheatName, Func1<bool>* getter, Action1<bool>* setter, bool hideOnMap, bool hideOnArena) {
		return ((R (*)(void *, Il2CppString*, Func1<bool>*, Action1<bool>*, bool, bool))(Il2CppBase() + 0x129B88C))(0, cheatName, getter, setter, hideOnMap, hideOnArena);
	}
