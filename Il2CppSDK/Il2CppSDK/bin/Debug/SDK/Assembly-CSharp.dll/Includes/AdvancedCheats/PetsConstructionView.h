...
#include "../AdvancedCheats/CustomTabContentView" 
namespace AdvancedCheats {

class PetsConstructionView: CustomTabContentView
{
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _petItems() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _skill1Items() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _skill2Items() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _skill3Items() {
	...
	template <typename T = uintptr_t> T GetCurrentPet() {
	...
	template <typename T = void> T InitSkills(Il2CppList<uintptr_t>* items, int32_t slotIndex) {
		return ((T (*)(PetsConstructionView*, Il2CppList<uintptr_t>*, int32_t))(Il2CppBase() + 0x16F1ED4))(this, items, slotIndex);
	}
