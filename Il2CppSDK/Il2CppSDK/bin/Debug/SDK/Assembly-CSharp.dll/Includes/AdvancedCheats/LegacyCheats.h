...
public: 
	...
	template <typename T = uintptr_t> T& DoubleSend() {
	...
	template <typename T = void> T OnShow(uintptr_t window) {
		return ((T (*)(LegacyCheats*, uintptr_t))(Il2CppBase() + 0x142B424))(this, window);
	}
	...
	template <typename T = void> T ParceResourceStringAndSend(Il2CppString* inputFieldText, void* onParce) {
		return ((T (*)(LegacyCheats*, Il2CppString*, void*))(Il2CppBase() + 0x142B49C))(this, inputFieldText, onParce);
	}
