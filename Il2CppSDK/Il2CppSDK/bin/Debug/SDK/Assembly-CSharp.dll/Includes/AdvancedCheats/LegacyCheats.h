...
public: 
	...
	template <typename R = void> R ParceResourceStringAndSend(Il2CppString* inputFieldText, Action3Il2CppString*, int32_t, Nullable1float>*>* onParce) {
		return ((R (*)(LegacyCheats*, Il2CppString*, Action3Il2CppString*, int32_t, Nullable1float>*>*))(Il2CppBase() + 0x142B49C))(this, inputFieldText, onParce);
	}
