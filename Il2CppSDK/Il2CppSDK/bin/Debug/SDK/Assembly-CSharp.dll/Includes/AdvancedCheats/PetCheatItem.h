...
public: 
	...
	template <typename R = void> R Bind(ItemEntity* item, Action1Il2CppString*>* onClick) {
		return ((R (*)(PetCheatItem*, ItemEntity*, Action1Il2CppString*>*))(Il2CppBase() + 0x11EB434))(this, item, onClick);
	}
