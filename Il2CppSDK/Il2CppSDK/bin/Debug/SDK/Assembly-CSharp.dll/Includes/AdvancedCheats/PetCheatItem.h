...
public: 
	...
	template <typename T = void> T Bind(ItemEntity* item, Action1Il2CppString*>* onClick) {
		return ((T (*)(PetCheatItem*, ItemEntity*, Action1Il2CppString*>*))(Il2CppBase() + 0x11EB434))(this, item, onClick);
	}
