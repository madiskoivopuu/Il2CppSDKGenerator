...
public: 
	...
	template <typename R = int32_t> R Showb__10_1(ValueTuple2<ItemEntity*, int32_t>* item1, ValueTuple2<ItemEntity*, int32_t>* item2) {
		return ((R (*)(TournamentRewardsView*, ValueTuple2<ItemEntity*, int32_t>*, ValueTuple2<ItemEntity*, int32_t>*))(Il2CppBase() + 0x150B4A4))(this, item1, item2);
	}
