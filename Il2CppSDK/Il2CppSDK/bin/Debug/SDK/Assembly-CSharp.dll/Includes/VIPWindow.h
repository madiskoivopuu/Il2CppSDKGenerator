...
public: 
	...
	template <typename T = VipLevelView*> T& VipLevelPrefab() {
	...
	template <typename T = StandartButton*> T& OpenVIPDailyChestButton() {
	...
	template <typename T = void> T ShowStoreCategory(StoreCategory* category) {
		return ((T (*)(VIPWindow*, StoreCategory*))(Il2CppBase() + 0x15C2AB0))(this, category);
	}
