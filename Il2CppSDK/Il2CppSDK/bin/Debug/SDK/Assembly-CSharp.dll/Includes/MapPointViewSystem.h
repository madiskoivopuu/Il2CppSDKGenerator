...
public: 
	...
	template <typename T = IGroup1GameEntity*>*> T& _pointLabels() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = IGroup1GameEntity*>*> T& _activeTargets() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = IGroup1GameEntity*>*> T& _phasesPoints() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = IGroup1GameEntity*>*> T& _lobbyPoints() {
