...
public: 
	...
	template <typename R = void> R Init(int64_t inviteId, Action2bool, GuildApplicationPlayerItem*>* onToggleChanged) {
		return ((R (*)(GuildApplicationPlayerItem*, int64_t, Action2bool, GuildApplicationPlayerItem*>*))(Il2CppBase() + 0x12E3AA4))(this, inviteId, onToggleChanged);
	}
