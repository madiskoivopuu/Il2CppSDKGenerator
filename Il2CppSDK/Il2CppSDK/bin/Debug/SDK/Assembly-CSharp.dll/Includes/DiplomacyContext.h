...
public: 
	...
	template <typename R = DiplomacyEntity*> R GetEntityWithId(int64_t Value) {
	 ...
	 HashSet1DiplomacyEntity*>* GetEntitiesWithFromClanId(int64_t Value) {
		return ((HashSet1DiplomacyEntity*>* (*)(DiplomacyContext*, int64_t))(Il2CppBase() + 0x12FD970))(this, Value);
	}
	 HashSet1DiplomacyEntity*>* GetEntitiesWithToClanId(int64_t Value) {
		return ((HashSet1DiplomacyEntity*>* (*)(DiplomacyContext*, int64_t))(Il2CppBase() + 0x12FDA30))(this, Value);
	}
	template <typename R = DiplomacyEntity*> R GetEntityWithClansId(int64_t Value1, int64_t Value2) {
	 ...
	 HashSet1DiplomacyEntity*>* GetEntitiesWithPvPId(int64_t Value) {
		return ((HashSet1DiplomacyEntity*>* (*)(DiplomacyContext*, int64_t))(Il2CppBase() + 0x12FDC00))(this, Value);
	}
