...
public: 
	...
	template <typename T = uintptr_t> T get_BuildEntity() {
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t buildEntity, uintptr_t tooltipView) {
		return ((T (*)(BuilderEntityView*, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x15A8450))(this, window, buildEntity, tooltipView);
	}
