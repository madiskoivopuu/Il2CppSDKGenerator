...
public: 
	...
	template <typename R = Il2CppString*> R& QuestName() {
	 ...
	 Action1ActQuestView*>*& EventTrackingClick() {
		return *(Action1ActQuestView*>**)((uintptr_t)this + 0xE0);
	}
	 Action1ActQuestView*>*& EventClaimClick() {
		return *(Action1ActQuestView*>**)((uintptr_t)this + 0xE8);
	}
	 Action1ActQuestView*>*& EventSkipClick() {
		return *(Action1ActQuestView*>**)((uintptr_t)this + 0xF0);
	}
	...
	template <typename R = void> R add_EventTrackingClick(Action1ActQuestView*>* value) {
		return ((R (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAB50))(this, value);
	}
	template <typename R = void> R remove_EventTrackingClick(Action1ActQuestView*>* value) {
		return ((R (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EABF0))(this, value);
	}
	template <typename R = void> R add_EventClaimClick(Action1ActQuestView*>* value) {
		return ((R (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAC90))(this, value);
	}
	template <typename R = void> R remove_EventClaimClick(Action1ActQuestView*>* value) {
		return ((R (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAD30))(this, value);
	}
	template <typename R = void> R add_EventSkipClick(Action1ActQuestView*>* value) {
		return ((R (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EADD0))(this, value);
	}
	template <typename R = void> R remove_EventSkipClick(Action1ActQuestView*>* value) {
		return ((R (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAE70))(this, value);
	}
