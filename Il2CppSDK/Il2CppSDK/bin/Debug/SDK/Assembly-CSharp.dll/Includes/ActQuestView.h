...
public: 
	...
	template <typename T = Action1ActQuestView*>*> T& EventTrackingClick() {
		return *(T*)((uintptr_t)this + 0xE0);
	}
	template <typename T = Action1ActQuestView*>*> T& EventClaimClick() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = Action1ActQuestView*>*> T& EventSkipClick() {
	...
	template <typename T = void> T set_TooltipView(TooltipView* value) {
		return ((T (*)(ActQuestView*, TooltipView*))(Il2CppBase() + 0x18EAB08))(this, value);
	}
	...
	template <typename T = void> T set_QuestData(QuestDataEntity* value) {
		return ((T (*)(ActQuestView*, QuestDataEntity*))(Il2CppBase() + 0x18EAB18))(this, value);
	}
	...
	template <typename T = void> T add_EventTrackingClick(Action1ActQuestView*>* value) {
		return ((T (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAB50))(this, value);
	}
	template <typename T = void> T remove_EventTrackingClick(Action1ActQuestView*>* value) {
		return ((T (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EABF0))(this, value);
	}
	template <typename T = void> T add_EventClaimClick(Action1ActQuestView*>* value) {
		return ((T (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAC90))(this, value);
	}
	template <typename T = void> T remove_EventClaimClick(Action1ActQuestView*>* value) {
		return ((T (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAD30))(this, value);
	}
	template <typename T = void> T add_EventSkipClick(Action1ActQuestView*>* value) {
		return ((T (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EADD0))(this, value);
	}
	template <typename T = void> T remove_EventSkipClick(Action1ActQuestView*>* value) {
		return ((T (*)(ActQuestView*, Action1ActQuestView*>*))(Il2CppBase() + 0x18EAE70))(this, value);
	}
	...
	template <typename T = void> T Init(QuestDataEntity* questData) {
		return ((T (*)(ActQuestView*, QuestDataEntity*))(Il2CppBase() + 0x18EB268))(this, questData);
	}
	template <typename T = void> T ShowRequirements(GameEntity* avatar, QuestDataEntity* questData) {
		return ((T (*)(ActQuestView*, GameEntity*, QuestDataEntity*))(Il2CppBase() + 0x18EB894))(this, avatar, questData);
	}
	template <typename T = void> T ShowReward(QuestEntity* quest, QuestDataEntity* questData) {
		return ((T (*)(ActQuestView*, QuestEntity*, QuestDataEntity*))(Il2CppBase() + 0x18EC894))(this, quest, questData);
	}
