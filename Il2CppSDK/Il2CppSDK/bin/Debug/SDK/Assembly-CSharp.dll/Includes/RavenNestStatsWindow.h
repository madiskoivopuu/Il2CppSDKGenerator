...
class RavenNestStatsWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& _statPrefab() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _stats() {
	...
	template <typename T = void> T ShowStats(uintptr_t ravenNestStats) {
		return ((T (*)(RavenNestStatsWindow*, uintptr_t))(Il2CppBase() + 0x1392CA0))(this, ravenNestStats);
	}
	template <typename T = uintptr_t> T GetStatView(int32_t index) {
