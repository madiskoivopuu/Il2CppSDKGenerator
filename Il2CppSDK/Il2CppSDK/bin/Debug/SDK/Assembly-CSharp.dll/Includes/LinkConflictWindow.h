...
class LinkConflictWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& LocalUser() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = uintptr_t> T& ConflictedUser() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = uintptr_t> T& _selectedUser() {
	...
	template <typename T = void> T OnAccountInfoSelected(uintptr_t accountInfoView) {
		return ((T (*)(LinkConflictWindow*, uintptr_t))(Il2CppBase() + 0x142D27C))(this, accountInfoView);
	}
