...
public: 
	...
	template <typename T = void*> static T& _matcherCategoryEvents() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _matcherCategoryId() {
	...
	template <typename T = void*> static T get_CategoryEvents() {
		return ((T (*)(void *))(Il2CppBase() + 0x141CC14))(0);
	}
	template <typename T = void*> static T get_CategoryId() {
