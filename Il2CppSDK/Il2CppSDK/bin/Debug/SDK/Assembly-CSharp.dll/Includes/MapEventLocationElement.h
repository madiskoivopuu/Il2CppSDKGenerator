...
public: 
	...
	template <typename R = Il2CppString*> R& pointBlueprint() {
	 ...
	 Action2int32_t, Il2CppString*>*& OnPointRemoved() {
		return *(Action2int32_t, Il2CppString*>**)((uintptr_t)this + 0x80);
	}
	...
	template <typename R = void> R Bind(UIWindow* window, GameEntity* point, uintptr_t container, Action2int32_t, Il2CppString*>* onPointRemoved) {
		return ((R (*)(MapEventLocationElement*, UIWindow*, GameEntity*, uintptr_t, Action2int32_t, Il2CppString*>*))(Il2CppBase() + 0x126C330))(this, window, point, container, onPointRemoved);
	}
