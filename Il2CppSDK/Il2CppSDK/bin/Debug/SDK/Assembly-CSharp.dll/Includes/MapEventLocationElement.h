...
public: 
	...
	template <typename T = Action2int32_t, Il2CppString*>*> T& OnPointRemoved() {
	...
	template <typename T = void> T Bind(UIWindow* window, GameEntity* point, uintptr_t container, Action2int32_t, Il2CppString*>* onPointRemoved) {
		return ((T (*)(MapEventLocationElement*, UIWindow*, GameEntity*, uintptr_t, Action2int32_t, Il2CppString*>*))(Il2CppBase() + 0x126C330))(this, window, point, container, onPointRemoved);
	}
	template <typename T = void> T OnDisable() {
		return ((T (*)(MapEventLocationElement*))(Il2CppBase() + 0x126C750))(this);
	}
	template <typename T = void> T SetUpView(GameEntity* point) {
		return ((T (*)(MapEventLocationElement*, GameEntity*))(Il2CppBase() + 0x126C464))(this, point);
	}
