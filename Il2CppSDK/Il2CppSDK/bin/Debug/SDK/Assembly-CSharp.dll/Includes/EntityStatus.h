...
public: 
	...
	template <typename R = TimerBehaviour*> R& TimerStatus() {
	 ...
	 Nullable1bool>*& LastPlayerKillStatus() {
		return *(Nullable1bool>**)((uintptr_t)this + 0x98);
	}
	...
	template <typename R = int32_t> R& _pauseDuration() {
	 ...
	 Queue1uintptr_t>*& _msgBuffer() {
		return *(Queue1uintptr_t>**)((uintptr_t)this + 0xA8);
	}
	 Queue1int32_t>*& _offsetsBuffer() {
		return *(Queue1int32_t>**)((uintptr_t)this + 0xB0);
	}
	...
	template <typename R = void> R ShowTextBubble(TextBubble* textBubblePrefab, Il2CppString* text, Nullable1float>* lifeTime) {
		return ((R (*)(EntityStatus*, TextBubble*, Il2CppString*, Nullable1float>*))(Il2CppBase() + 0x1379360))(this, textBubblePrefab, text, lifeTime);
	}
	template <typename R = void> R ShowModifierNotification(TextImageMonoBehaviour* ModifierNotificationPrefab, Il2CppString* text, Nullable1uintptr_t>* color, Il2CppString* iconPath) {
		return ((R (*)(EntityStatus*, TextImageMonoBehaviour*, Il2CppString*, Nullable1uintptr_t>*, Il2CppString*))(Il2CppBase() + 0x137951C))(this, ModifierNotificationPrefab, text, color, iconPath);
	}
