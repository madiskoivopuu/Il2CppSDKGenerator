...
public: 
	...
	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(ExtractComponent*, Il2CppObject*))(Il2CppBase() + 0x168AA38))(this, targetObject);
	}
	template <typename T = int32_t> T GetCurrentSlotCount(GameEntity* entity) {
		return ((T (*)(ExtractComponent*, GameEntity*))(Il2CppBase() + 0x168AB48))(this, entity);
	}
