...
public: 
	...
	template <typename T = void*> T& PlaceOwnerId() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = void*> T& MountInventoryId() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = void*> T& ParentId() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = void*> T& HealthCoef() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = void*> T& MaxHealthCoef() {
	...
	template <typename T = void*> T& GroupChildId() {
		return *(T*)((uintptr_t)this + 0xA4);
	}
	template <typename T = void*> T& Bind() {
