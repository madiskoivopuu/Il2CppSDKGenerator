...
public: 
	...
	template <typename T = Il2CppString*> T GetProgressQuest(uintptr_t classPoints) {
		return ((T (*)(PlayerClassDescriptionComponent*, uintptr_t))(Il2CppBase() + 0x17047DC))(this, classPoints);
	}
	template <typename T = void> T CopyTo(uintptr_t targetObject) {
		return ((T (*)(PlayerClassDescriptionComponent*, uintptr_t))(Il2CppBase() + 0x170480C))(this, targetObject);
	}
