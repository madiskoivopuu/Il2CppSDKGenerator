...
public: 
	...
	template <typename T = Il2CppVector2> T& _newAnchoredPosition() {
	...
	template <typename T = void> T OnScroll(Il2CppVector2 pos) {
		return ((T (*)(UIInfiniteScroll*, Il2CppVector2))(Il2CppBase() + 0x1535B38))(this, pos);
	}
