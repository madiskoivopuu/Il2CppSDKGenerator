...
public: 
	...
	template <typename R = LoginClientInfo> R& _clientInfo() {
	 ...
	 ConcurrentDictionary2<Il2CppString*, int64_t>*& _lastVisited() {
		return *(ConcurrentDictionary2<Il2CppString*, int64_t>**)((uintptr_t)this + 0x110);
	}
	...
	template <typename R = Config*> R& _config() {
	 ...
	 static Action2<PlatformAuthData, LoginClientInfo>*& OnServerDefined() {
		return *(Action2<PlatformAuthData, LoginClientInfo>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}

	template <typename R = void> static R add_OnServerDefined(Action2<PlatformAuthData, LoginClientInfo>* value) {
		return ((R (*)(void *, Action2<PlatformAuthData, LoginClientInfo>*))(Il2CppBase() + 0xEB7454))(0, value);
	}
	template <typename R = void> static R remove_OnServerDefined(Action2<PlatformAuthData, LoginClientInfo>* value) {
		return ((R (*)(void *, Action2<PlatformAuthData, LoginClientInfo>*))(Il2CppBase() + 0xEB7510))(0, value);
	}
