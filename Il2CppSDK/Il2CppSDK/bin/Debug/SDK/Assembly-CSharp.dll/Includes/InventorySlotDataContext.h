...
public: 
	...
	template <typename R = Il2CppString*> static R& DEFAULT_RUNE_SLOT() {
	 ...
	 EntityIndex2InventorySlotEntity*, Il2CppString*>*& _tagIndex() {
		return *(EntityIndex2InventorySlotEntity*, Il2CppString*>**)((uintptr_t)this + 0x110);
	}
	 PrimaryEntityIndex2InventorySlotEntity*, Il2CppString*>*& _petTypeIndex() {
		return *(PrimaryEntityIndex2InventorySlotEntity*, Il2CppString*>**)((uintptr_t)this + 0x118);
	}
	 IGroup1InventorySlotEntity*>*& _petSlots() {
		return *(IGroup1InventorySlotEntity*>**)((uintptr_t)this + 0x120);
	}

	template <typename R = void> R AddEntityIndexes() {
		return ((R (*)(InventorySlotDataContext*))(Il2CppBase() + 0x1239D58))(this);
	}
	 HashSet1InventorySlotEntity*>* GetEntitiesWithTag(Il2CppString* tag) {
		return ((HashSet1InventorySlotEntity*>* (*)(InventorySlotDataContext*, Il2CppString*))(Il2CppBase() + 0x123A244))(this, tag);
	}
	template <typename R = InventorySlotEntity*> R GetPetSlot(Il2CppString* petType) {
	 ...
	 IGroup1InventorySlotEntity*>* GetPetSlots() {
		return ((IGroup1InventorySlotEntity*>* (*)(InventorySlotDataContext*))(Il2CppBase() + 0x123A330))(this);
	}
