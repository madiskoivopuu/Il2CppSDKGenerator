...
public: 
	...
	template <typename T = uintptr_t> static T& membersStartRaidComponent() {
	...
	template <typename T = uintptr_t> T get_cell0LockTime() {
	...
	template <typename T = uintptr_t> T get_cell1LockTime() {
	...
	template <typename T = uintptr_t> T get_cell2LockTime() {
	...
	template <typename T = uintptr_t> T get_cell3LockTime() {
	...
	template <typename T = uintptr_t> T get_clanPersonalEntities() {
	...
	template <typename T = uintptr_t> T get_locationGrade() {
	...
	template <typename T = uintptr_t> T get_lockTimeBuilder() {
	...
	template <typename T = uintptr_t> T get_lockTime() {
	...
	template <typename T = uintptr_t> T get_lockTimeDiplomacy() {
	...
	template <typename T = uintptr_t> T get_pvpGroupClans() {
	...
	template <typename T = uintptr_t> T get_scoutState() {
	...
	template <typename T = uintptr_t> T get_shield() {
	...
	template <typename T = uintptr_t> T get_statueState() {
