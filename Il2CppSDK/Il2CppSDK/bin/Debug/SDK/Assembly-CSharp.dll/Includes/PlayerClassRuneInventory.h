...
public: 
	...
	template <typename R = IInventoryItem*> R& _fromItem() {
	 ...
	 Nullable1<int32_t>*& _messageId() {
		return *(Nullable1<int32_t>**)((uintptr_t)this + 0xA0);
	}
	...
	template <typename R = Il2CppString*> R& _isMergeRulesNotifiedKey() {
	 ...
	 Action2<RuneItem*, uintptr_t>*& OnBeginScrolling() {
		return *(Action2<RuneItem*, uintptr_t>**)((uintptr_t)this + 0x110);
	}
	 Action2<RuneItem*, uintptr_t>*& OnScrolling() {
		return *(Action2<RuneItem*, uintptr_t>**)((uintptr_t)this + 0x118);
	}
	 Action2<RuneItem*, uintptr_t>*& OnEndScrolling() {
		return *(Action2<RuneItem*, uintptr_t>**)((uintptr_t)this + 0x120);
	}
	...
	template <typename R = void> R add_OnBeginScrolling(Action2<RuneItem*, uintptr_t>* value) {
		return ((R (*)(PlayerClassRuneInventory*, Action2<RuneItem*, uintptr_t>*))(Il2CppBase() + 0x1B6AC18))(this, value);
	}
	template <typename R = void> R remove_OnBeginScrolling(Action2<RuneItem*, uintptr_t>* value) {
		return ((R (*)(PlayerClassRuneInventory*, Action2<RuneItem*, uintptr_t>*))(Il2CppBase() + 0x1B6ACBC))(this, value);
	}
	template <typename R = void> R add_OnScrolling(Action2<RuneItem*, uintptr_t>* value) {
		return ((R (*)(PlayerClassRuneInventory*, Action2<RuneItem*, uintptr_t>*))(Il2CppBase() + 0x1B6AD60))(this, value);
	}
	template <typename R = void> R remove_OnScrolling(Action2<RuneItem*, uintptr_t>* value) {
		return ((R (*)(PlayerClassRuneInventory*, Action2<RuneItem*, uintptr_t>*))(Il2CppBase() + 0x1B6AE04))(this, value);
	}
	template <typename R = void> R add_OnEndScrolling(Action2<RuneItem*, uintptr_t>* value) {
		return ((R (*)(PlayerClassRuneInventory*, Action2<RuneItem*, uintptr_t>*))(Il2CppBase() + 0x1B6AEA8))(this, value);
	}
	template <typename R = void> R remove_OnEndScrolling(Action2<RuneItem*, uintptr_t>* value) {
		return ((R (*)(PlayerClassRuneInventory*, Action2<RuneItem*, uintptr_t>*))(Il2CppBase() + 0x1B6AF4C))(this, value);
	}
	...
	template <typename R = void> R ChangeRunesDialogue(ItemEntity* rune1, int32_t count1, Nullable1<int64_t>* endTime1, ItemEntity* rune2, int32_t count2, Nullable1<int64_t>* endTime2, Il2CppString* caption, Il2CppString* description, Il2CppString* buttonCancelText, Il2CppString* buttonSuccessText, uintptr_t onSuccess) {
		return ((R (*)(PlayerClassRuneInventory*, ItemEntity*, int32_t, Nullable1<int64_t>*, ItemEntity*, int32_t, Nullable1<int64_t>*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, uintptr_t))(Il2CppBase() + 0x1B6C190))(this, rune1, count1, endTime1, rune2, count2, endTime2, caption, description, buttonCancelText, buttonSuccessText, onSuccess);
	}
