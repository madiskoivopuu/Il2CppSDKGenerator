...
public: 
	...
	template <typename R = AudioTrack*> R& currentTrack() {
	 ...
	 Il2CppList<KeyValuePair2uintptr_t, float>*>*& fadingSoundSources() {
		return *(Il2CppList<KeyValuePair2uintptr_t, float>*>**)((uintptr_t)this + 0x58);
	}
	...
	template <typename R = void> R AddAmbientThemes(IEnumerable1Il2CppString*>* themeNames) {
		return ((R (*)(AudioManager*, IEnumerable1Il2CppString*>*))(Il2CppBase() + 0x1A60D90))(this, themeNames);
	}
	template <typename R = void> R RemoveAmbientThemes(IEnumerable1Il2CppString*>* themeNames) {
		return ((R (*)(AudioManager*, IEnumerable1Il2CppString*>*))(Il2CppBase() + 0x1A61420))(this, themeNames);
	}
