...
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& themes() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& loopSounds() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = uintptr_t> T& currentTheme() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = uintptr_t> T& currentTrack() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& soundSources() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = Il2CppList<void*>*> T& fadingSoundSources() {
	...
	template <typename T = uintptr_t> T& defaultParameters() {
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _loopsToPlay() {
		return *(T*)((uintptr_t)this + 0xD8);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _loopsToRemove() {
		return *(T*)((uintptr_t)this + 0xE0);
	}
	template <typename T = int32_t> static T& LoopsToPlay() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& MaxDistanceLoop() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = uintptr_t> T& _loopSoundComparer() {
	...
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& currentAmbientSources() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& fadingInAmbientSources() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& fadingOutAmbientSources() {
	...
	template <typename T = uintptr_t> static T get_FastInstance() {
	...
	template <typename T = void> T OnMusicSettingsChange(uintptr_t sender, float value) {
		return ((T (*)(AudioManager*, uintptr_t, float))(Il2CppBase() + 0x1A601B8))(this, sender, value);
	}
	template <typename T = void> T OnSoundSettingsChange(uintptr_t sender, float value) {
		return ((T (*)(AudioManager*, uintptr_t, float))(Il2CppBase() + 0x1A60240))(this, sender, value);
	}
	template <typename T = void> T CreateSoundPool() {
		return ((T (*)(AudioManager*))(Il2CppBase() + 0x1A5FE00))(this);
	}
	template <typename T = uintptr_t> T LoopSound(Il2CppString* sound, uintptr_t parentTransform, Il2CppString* tag) {
		return ((T (*)(AudioManager*, Il2CppString*, uintptr_t, Il2CppString*))(Il2CppBase() + 0x1A5C238))(this, sound, parentTransform, tag);
	}
	template <typename T = bool> T StopLoop(uintptr_t entity) {
		return ((T (*)(AudioManager*, uintptr_t))(Il2CppBase() + 0x1A5C6B8))(this, entity);
	}
	template <typename T = bool> T StopLoop_1(uintptr_t loopSound) {
		return ((T (*)(AudioManager*, uintptr_t))(Il2CppBase() + 0x1A5C344))(this, loopSound);
	}
	...
	template <typename T = float> T PlaySound_1(Il2CppString* sound, Il2CppVector3 position, Il2CppString* tag) {
		return ((T (*)(AudioManager*, Il2CppString*, Il2CppVector3, Il2CppString*))(Il2CppBase() + 0x1A5C094))(this, sound, position, tag);
	}
	...
	template <typename T = float> T PlaySound_2(Il2CppString* sound, Il2CppVector3 position, Il2CppString* tag, uintptr_t* id) {
		return ((T (*)(AudioManager*, Il2CppString*, Il2CppVector3, Il2CppString*, uintptr_t*))(Il2CppBase() + 0x1A608A8))(this, sound, position, tag, id);
	}
	template <typename T = float> T PlaySound_3(Il2CppString* sound, Il2CppVector3 position, uintptr_t* id) {
		return ((T (*)(AudioManager*, Il2CppString*, Il2CppVector3, uintptr_t*))(Il2CppBase() + 0x1A5F2C4))(this, sound, position, id);
	}
	...
	template <typename T = void> T UpdateSoundPosition(Il2CppVector3 position, uint32_t id) {
		return ((T (*)(AudioManager*, Il2CppVector3, uint32_t))(Il2CppBase() + 0x1A5F908))(this, position, id);
	}
	...
	template <typename T = void> T AddAmbientThemes(void* themeNames) {
		return ((T (*)(AudioManager*, void*))(Il2CppBase() + 0x1A60D90))(this, themeNames);
	}
	template <typename T = void> T RemoveAmbientThemes(void* themeNames) {
		return ((T (*)(AudioManager*, void*))(Il2CppBase() + 0x1A61420))(this, themeNames);
	}
