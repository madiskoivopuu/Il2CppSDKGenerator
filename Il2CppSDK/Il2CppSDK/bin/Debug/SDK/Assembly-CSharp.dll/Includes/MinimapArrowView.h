...
public: 
	...
	template <typename T = uintptr_t> T& _arrowMode() {
	...
	template <typename T = void> T SetIcon(uintptr_t arrowMode, uintptr_t color, bool onBorder, bool notRotation, bool ping) {
		return ((T (*)(MinimapArrowView*, uintptr_t, uintptr_t, bool, bool, bool))(Il2CppBase() + 0x12D2A20))(this, arrowMode, color, onBorder, notRotation, ping);
	}
