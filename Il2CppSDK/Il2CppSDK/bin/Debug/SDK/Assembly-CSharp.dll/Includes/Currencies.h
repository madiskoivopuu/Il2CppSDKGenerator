...
public: 
	...
	template <typename T = int32_t> T get_Item(CurrencyType* currencyType) {
		return ((T (*)(Currencies*, CurrencyType*))(Il2CppBase() + 0x1BCDC44))(this, currencyType);
	}
	template <typename T = void> T set_Item(CurrencyType* currencyType, int32_t value) {
		return ((T (*)(Currencies*, CurrencyType*, int32_t))(Il2CppBase() + 0x1BCDD20))(this, currencyType, value);
	}
	...
	template <typename T = bool> T Equals(Currencies* other) {
		return ((T (*)(Currencies*, Currencies*))(Il2CppBase() + 0x1BCDE54))(this, other);
	}
	template <typename T = bool> T Equals_1(Il2CppObject* obj) {
		return ((T (*)(Currencies*, Il2CppObject*))(Il2CppBase() + 0x1BCDFD0))(this, obj);
	}
	template <typename T = int32_t> T GetHashCode() {
		return ((T (*)(Currencies*))(Il2CppBase() + 0x1BCE06C))(this);
	}
	template <typename T = bool> static T op_Equality(Currencies* c1, Currencies* c2) {
		return ((T (*)(void *, Currencies*, Currencies*))(Il2CppBase() + 0x1BCE108))(0, c1, c2);
	}
	template <typename T = bool> static T op_Inequality(Currencies* c1, Currencies* c2) {
		return ((T (*)(void *, Currencies*, Currencies*))(Il2CppBase() + 0x1BCE148))(0, c1, c2);
	}
	template <typename T = Currencies*> static T op_Subtraction(Currencies* c1, Currencies* c2) {
		return ((T (*)(void *, Currencies*, Currencies*))(Il2CppBase() + 0x1BCE18C))(0, c1, c2);
	}
	template <typename T = Currencies*> static T op_Addition(Currencies* c1, Currencies* c2) {
		return ((T (*)(void *, Currencies*, Currencies*))(Il2CppBase() + 0x1BCE1EC))(0, c1, c2);
	}
	template <typename T = Currencies*> static T op_Multiply(Currencies* c, int32_t i) {
		return ((T (*)(void *, Currencies*, int32_t))(Il2CppBase() + 0x1BCE24C))(0, c, i);
	}
