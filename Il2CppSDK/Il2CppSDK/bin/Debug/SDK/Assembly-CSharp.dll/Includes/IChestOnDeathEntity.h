...
public: 
	...
	template <typename T = void> T AddChestOnDeath(float newChance, Il2CppString* newRandomGroup, Il2CppString* newCorpse, Il2CppString* newPersonalCorpse, bool newFromInventory, bool newDrop, uintptr_t newAdditionalPersonalDrop) {
		return ((T (*)(IChestOnDeathEntity*, float, Il2CppString*, Il2CppString*, Il2CppString*, bool, bool, uintptr_t))(Il2CppBase() + 0x0))(this, newChance, newRandomGroup, newCorpse, newPersonalCorpse, newFromInventory, newDrop, newAdditionalPersonalDrop);
	}
