...
public: 
	...
	template <typename T = void> T SetWaterfallConfiguration(uintptr_t waterfallConfiguration, uintptr_t adFormat) {
		return ((T (*)(IronSourceIAgent*, uintptr_t, uintptr_t))(Il2CppBase() + 0x0))(this, waterfallConfiguration, adFormat);
	}
	...
	template <typename T = uintptr_t> T getPlacementInfo(Il2CppString* name) {
	...
	template <typename T = void> T loadBanner(uintptr_t size, uintptr_t position) {
		return ((T (*)(IronSourceIAgent*, uintptr_t, uintptr_t))(Il2CppBase() + 0x0))(this, size, position);
	}
	template <typename T = void> T loadBanner_1(uintptr_t size, uintptr_t position, Il2CppString* placementName) {
		return ((T (*)(IronSourceIAgent*, uintptr_t, uintptr_t, Il2CppString*))(Il2CppBase() + 0x0))(this, size, position, placementName);
	}
	...
	template <typename T = void> T setSegment(uintptr_t segment) {
		return ((T (*)(IronSourceIAgent*, uintptr_t))(Il2CppBase() + 0x0))(this, segment);
	}
