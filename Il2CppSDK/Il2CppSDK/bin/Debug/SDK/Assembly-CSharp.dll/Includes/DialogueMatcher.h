...
public: 
	...
	template <typename T = void*> static T& _matcherButton() {
	...
	template <typename T = void*> static T& _matcherGetQuest() {
	...
	template <typename T = void*> static T& _matcherLog() {
	...
	template <typename T = void*> static T& _matcherNextDialogue() {
	...
	template <typename T = void*> static T& _matcherRewardQuest() {
	...
	template <typename T = void*> static T& _matcherTriptych() {
	...
	template <typename T = void*> static T& _matcherWindow() {
	...
	template <typename T = void*> static T get_Button() {
	...
	template <typename T = void*> static T get_GetQuest() {
	...
	template <typename T = void*> static T get_Log() {
	...
	template <typename T = void*> static T get_NextDialogue() {
	...
	template <typename T = void*> static T get_RewardQuest() {
	...
	template <typename T = void*> static T get_Triptych() {
	...
	template <typename T = void*> static T get_Window() {
