...
public: 
	...
	template <typename T = VipBonusesComponent*> T get_vipBonuses() {
	...
	template <typename T = VipDataIdComponent*> T get_vipDataId() {
	...
	template <typename T = VipLevelComponent*> T get_vipLevel() {
