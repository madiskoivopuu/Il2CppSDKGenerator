...
public: 
	...
	template <typename R = float> static R& SneakCooldown() {
	 ...
	 PrimaryEntityIndex2<CooldownEntity*, IntString>*& _targetNameIndex() {
		return *(PrimaryEntityIndex2<CooldownEntity*, IntString>**)((uintptr_t)this + 0xD0);
	}
	 EntityIndex2<CooldownEntity*, int32_t>*& _targetIndex() {
		return *(EntityIndex2<CooldownEntity*, int32_t>**)((uintptr_t)this + 0xD8);
	}
	...
	template <typename R = CooldownEntity*> R GetActiveCooldown_1(int32_t targetId, Il2CppArray<NameFloat>* values) {
	 ...
	 HashSet1<CooldownEntity*>* GetEntitiesForTarget(int32_t targetId) {
		return ((HashSet1<CooldownEntity*>* (*)(CooldownContext*, int32_t))(Il2CppBase() + 0x1335D30))(this, targetId);
	}
	...
	template <typename R = void> R Remove(HashSet1<CooldownEntity*>* cooldowns) {
		return ((R (*)(CooldownContext*, HashSet1<CooldownEntity*>*))(Il2CppBase() + 0x1337318))(this, cooldowns);
	}
