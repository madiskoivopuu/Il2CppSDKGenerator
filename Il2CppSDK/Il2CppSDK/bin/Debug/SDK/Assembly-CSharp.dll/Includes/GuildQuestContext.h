...
public: 
	...
	template <typename T = GuildQuestEntity*> T GetEntityWithId(int64_t id) {
		return ((T (*)(GuildQuestContext*, int64_t))(Il2CppBase() + 0x1932FE4))(this, id);
	}
	template <typename T = HashSet1GuildQuestEntity*>*> T GetEntitiesWithGuild(int64_t guildId) {
		return ((T (*)(GuildQuestContext*, int64_t))(Il2CppBase() + 0x19330C0))(this, guildId);
	}
	template <typename T = GuildQuestEntity*> T GetActualWithQuest(int64_t guildId, Il2CppString* questName, int64_t now) {
		return ((T (*)(GuildQuestContext*, int64_t, Il2CppString*, int64_t))(Il2CppBase() + 0x1933180))(this, guildId, questName, now);
	}
	template <typename T = GuildQuestEntity*> T GetActive(int64_t guildId) {
		return ((T (*)(GuildQuestContext*, int64_t))(Il2CppBase() + 0x1933484))(this, guildId);
	}
	template <typename T = GuildQuestEntity*> T get_Item(int64_t id) {
		return ((T (*)(GuildQuestContext*, int64_t))(Il2CppBase() + 0x1933640))(this, id);
	}
	template <typename T = GuildQuestEntity*> T CreateEntityWithId(int64_t id) {
