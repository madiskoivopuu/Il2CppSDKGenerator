...
public: 
	...
	template <typename R = GuildQuestEntity*> R GetEntityWithId(int64_t id) {
	 ...
	 HashSet1<GuildQuestEntity*>* GetEntitiesWithGuild(int64_t guildId) {
		return ((HashSet1<GuildQuestEntity*>* (*)(GuildQuestContext*, int64_t))(Il2CppBase() + 0x19330C0))(this, guildId);
	}
