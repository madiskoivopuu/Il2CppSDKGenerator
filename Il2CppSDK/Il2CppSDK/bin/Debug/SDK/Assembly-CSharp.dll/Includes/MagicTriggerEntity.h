...
public: 
	...
	template <typename T = MagicTriggerDataEntity*> T get_Data() {
		return ((T (*)(MagicTriggerEntity*))(Il2CppBase() + 0x1A31E3C))(this);
	}
	template <typename T = void> T AddData(Il2CppString* name, MagicTriggerDataEntity* data) {
		return ((T (*)(MagicTriggerEntity*, Il2CppString*, MagicTriggerDataEntity*))(Il2CppBase() + 0x1A442C4))(this, name, data);
	}
	...
	template <typename T = MagicTriggerDataComponent*> T get_magicTriggerData() {
	...
	template <typename T = void> T AddMagicTriggerData(Il2CppString* newName, MagicTriggerDataEntity* newDataEntity) {
		return ((T (*)(MagicTriggerEntity*, Il2CppString*, MagicTriggerDataEntity*))(Il2CppBase() + 0x1A450F0))(this, newName, newDataEntity);
	}
	template <typename T = void> T ReplaceMagicTriggerData(Il2CppString* newName, MagicTriggerDataEntity* newDataEntity) {
		return ((T (*)(MagicTriggerEntity*, Il2CppString*, MagicTriggerDataEntity*))(Il2CppBase() + 0x1A442C8))(this, newName, newDataEntity);
	}
	...
	template <typename T = ResetSkipTimeComponent*> T get_resetSkipTime() {
