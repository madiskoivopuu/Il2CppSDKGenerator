...
public: 
	...
	template <typename R = int32_t> R& _initialSize() {
	 ...
	 ValueCollection<int32_t, InventoryItemDraggable*>* get_Items() {
		return ((ValueCollection<int32_t, InventoryItemDraggable*>* (*)(InventoryContainer*))(Il2CppBase() + 0x146EEB8))(this);
	}
