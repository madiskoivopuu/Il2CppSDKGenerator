...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1GooglePlayGamesBasicApi::SignInStatus*>*& callback() {
		return *(Action1GooglePlayGamesBasicApi::SignInStatus*>**)((uintptr_t)this + 0x10);
	}
	template <typename R = GooglePlayGames::PlayGamesPlatform*> R& 4__this() {
		return *(R*)((uintptr_t)this + 0x18);
	}
	 Action1GooglePlayGamesBasicApi::SignInStatus*>*& 9__5() {
		return *(Action1GooglePlayGamesBasicApi::SignInStatus*>**)((uintptr_t)this + 0x20);
	}
