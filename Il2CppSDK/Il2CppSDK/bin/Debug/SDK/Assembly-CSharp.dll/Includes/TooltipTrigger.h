...
public: 
	...
	template <typename T = Il2CppVector3> T& _mousePosition() {
	...
	template <typename T = void> T Init(Il2CppString* itemName, uintptr_t tooltip) {
		return ((T (*)(TooltipTrigger*, Il2CppString*, uintptr_t))(Il2CppBase() + 0x14F6054))(this, itemName, tooltip);
	}
	template <typename T = void> T Init_1(Il2CppString* title, Il2CppString* text, uintptr_t tooltip, bool needLocalize, float durationToShow) {
		return ((T (*)(TooltipTrigger*, Il2CppString*, Il2CppString*, uintptr_t, bool, float))(Il2CppBase() + 0x14F6098))(this, title, text, tooltip, needLocalize, durationToShow);
	}
	template <typename T = void> T Init_2(Il2CppString* itemName, uintptr_t tooltip, Il2CppString* warningLine) {
		return ((T (*)(TooltipTrigger*, Il2CppString*, uintptr_t, Il2CppString*))(Il2CppBase() + 0x14F6124))(this, itemName, tooltip, warningLine);
	}
