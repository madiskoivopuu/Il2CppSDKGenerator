...
public: 
	...
	template <typename R = bool> R& _isAnyPlayerUnlockedPortal() {
	 ...
	 Action1ButtonHelper*>*& OnDifficultySelected() {
		return *(Action1ButtonHelper*>**)((uintptr_t)this + 0x1B8);
	}
	 Action2int32_t, uintptr_t>*& OnConfirm() {
		return *(Action2int32_t, uintptr_t>**)((uintptr_t)this + 0x1C0);
	}
	...
	template <typename R = void> R add_OnDifficultySelected(Action1ButtonHelper*>* value) {
		return ((R (*)(PrerequisiteWindow*, Action1ButtonHelper*>*))(Il2CppBase() + 0x16E16A0))(this, value);
	}
	template <typename R = void> R remove_OnDifficultySelected(Action1ButtonHelper*>* value) {
		return ((R (*)(PrerequisiteWindow*, Action1ButtonHelper*>*))(Il2CppBase() + 0x16E1744))(this, value);
	}
	template <typename R = void> R add_OnConfirm(Action2int32_t, uintptr_t>* value) {
		return ((R (*)(PrerequisiteWindow*, Action2int32_t, uintptr_t>*))(Il2CppBase() + 0x16E17E8))(this, value);
	}
	template <typename R = void> R remove_OnConfirm(Action2int32_t, uintptr_t>* value) {
		return ((R (*)(PrerequisiteWindow*, Action2int32_t, uintptr_t>*))(Il2CppBase() + 0x16E188C))(this, value);
	}
