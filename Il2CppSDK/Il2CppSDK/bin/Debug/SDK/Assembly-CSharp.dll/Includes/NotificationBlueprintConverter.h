...
public: 
	...
	template <typename T = void> T WriteJson(uintptr_t writer, uintptr_t value, uintptr_t serializer) {
		return ((T (*)(NotificationBlueprintConverter*, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x13B8414))(this, writer, value, serializer);
	}
	template <typename T = uintptr_t> T ReadJson(uintptr_t reader, uintptr_t objectType, uintptr_t existingValue, uintptr_t serializer) {
		return ((T (*)(NotificationBlueprintConverter*, uintptr_t, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x13B8454))(this, reader, objectType, existingValue, serializer);
	}
