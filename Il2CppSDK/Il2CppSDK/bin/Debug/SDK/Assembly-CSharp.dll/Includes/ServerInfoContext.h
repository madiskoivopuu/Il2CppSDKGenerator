...
public: 
	...
	template <typename R = ServerInfoEntity*> R GetEntityWithSubregion(Il2CppString* subregion) {
	 ...
	 HashSet1<ServerInfoEntity*>* GetEntitiesRegion(Il2CppString* name) {
		return ((HashSet1<ServerInfoEntity*>* (*)(ServerInfoContext*, Il2CppString*))(Il2CppBase() + 0x161C804))(this, name);
	}
