...
public: 
	...
	template <typename R = Il2CppString*> static R& CHANGE_DAMAGE_COEF() {
	 ...
	 EntityIndex2<MagicTriggerDataEntity*, Il2CppString*>*& _tagsIndex() {
		return *(EntityIndex2<MagicTriggerDataEntity*, Il2CppString*>**)((uintptr_t)this + 0x110);
	}
	 EntityIndex2<MagicTriggerDataEntity*, Il2CppString*>*& _targetMagicTagsIndex() {
		return *(EntityIndex2<MagicTriggerDataEntity*, Il2CppString*>**)((uintptr_t)this + 0x118);
	}
	 EntityIndex2<MagicTriggerDataEntity*, Il2CppString*>*& _targetMagicNameIndex() {
		return *(EntityIndex2<MagicTriggerDataEntity*, Il2CppString*>**)((uintptr_t)this + 0x120);
	}

	template <typename R = void> R AddEntityIndexes() {
		return ((R (*)(MagicTriggerDataContext*))(Il2CppBase() + 0x1A35444))(this);
	}
	 HashSet1<MagicTriggerDataEntity*>* GetEntitiesWithTag(Il2CppString* tag) {
		return ((HashSet1<MagicTriggerDataEntity*>* (*)(MagicTriggerDataContext*, Il2CppString*))(Il2CppBase() + 0x1A35BDC))(this, tag);
	}
	 HashSet1<MagicTriggerDataEntity*>* GetEntitiesWithTargetMagicTags(Il2CppString* tag) {
		return ((HashSet1<MagicTriggerDataEntity*>* (*)(MagicTriggerDataContext*, Il2CppString*))(Il2CppBase() + 0x1A35C40))(this, tag);
	}
	 HashSet1<MagicTriggerDataEntity*>* GetEntitiesWithTargetMagicName(Il2CppString* name) {
		return ((HashSet1<MagicTriggerDataEntity*>* (*)(MagicTriggerDataContext*, Il2CppString*))(Il2CppBase() + 0x1A35CA4))(this, name);
	}
	template <typename R = MagicTriggerDataEntity*> R GetEntityWithBlueprintOrNull(Il2CppString* name) {
	 ...
	 ValueTuple3<bool, Il2CppString*, Il2CppArray<Il2CppString*>*>* GetMorphingParts(Il2CppString* name) {
		return ((ValueTuple3<bool, Il2CppString*, Il2CppArray<Il2CppString*>*>* (*)(MagicTriggerDataContext*, Il2CppString*))(Il2CppBase() + 0x1A35DD4))(this, name);
	}
