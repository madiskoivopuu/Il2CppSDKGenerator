...
class BaseWorldInitLS: BaseLoaderStep
{
public: 
	...
	template <typename T = uintptr_t> T& _udpConfig() {
	...
	template <typename T = uintptr_t> T& _randomManager() {
	...
	template <typename T = uintptr_t> T& _staticBundleRequest() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = uintptr_t> T& _bundleRequest() {
	...
	template <typename T = bool> T CheckIsWorldNotEmpty(uintptr_t World) {
		return ((T (*)(BaseWorldInitLS*, uintptr_t))(Il2CppBase() + 0x16720E8))(this, World);
	}
	template <typename T = void> T OnConnectedToCoordinator(bool connectToGlobalMap, uintptr_t udpConfig, int64_t userID, int64_t sessionID, int64_t worldID, Il2CppString* sceneName, uintptr_t resourcesType) {
		return ((T (*)(BaseWorldInitLS*, bool, uintptr_t, int64_t, int64_t, int64_t, Il2CppString*, uintptr_t))(Il2CppBase() + 0x16724B4))(this, connectToGlobalMap, udpConfig, userID, sessionID, worldID, sceneName, resourcesType);
	}
	...
	template <typename T = uintptr_t> T SceneLoad(uintptr_t world) {
		return ((T (*)(BaseWorldInitLS*, uintptr_t))(Il2CppBase() + 0x1673534))(this, world);
	}
	template <typename T = uintptr_t> T LoadAssetBundle(uintptr_t world) {
		return ((T (*)(BaseWorldInitLS*, uintptr_t))(Il2CppBase() + 0x16735C8))(this, world);
	}
