...
public: 
	...
	template <typename T = uintptr_t> T GetEntityHighlightPosition(GameEntity* targetEntity, bool interact) {
		return ((T (*)(HighlightSystem*, GameEntity*, bool))(Il2CppBase() + 0x1C44FE4))(this, targetEntity, interact);
	}
