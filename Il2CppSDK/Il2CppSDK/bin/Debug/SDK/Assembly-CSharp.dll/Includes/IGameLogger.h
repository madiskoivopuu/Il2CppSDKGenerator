...
public: 
	...
	template <typename R = void> R WriteAccount(int64_t worldId, int64_t userId, bool isGlobaMap, int32_t evt, Il2CppString* desc, Il2CppArray<KeyValuePair2Il2CppString*, int32_t>*>* items) {
		return ((R (*)(IGameLogger*, int64_t, int64_t, bool, int32_t, Il2CppString*, Il2CppArray<KeyValuePair2Il2CppString*, int32_t>*>*))(Il2CppBase() + 0x0))(this, worldId, userId, isGlobaMap, evt, desc, items);
	}
	template <typename R = void> R WriteWorld(int64_t worldId, int64_t userId, bool isGlobaMap, int32_t evt, Il2CppString* desc, Il2CppArray<KeyValuePair2Il2CppString*, int32_t>*>* items) {
		return ((R (*)(IGameLogger*, int64_t, int64_t, bool, int32_t, Il2CppString*, Il2CppArray<KeyValuePair2Il2CppString*, int32_t>*>*))(Il2CppBase() + 0x0))(this, worldId, userId, isGlobaMap, evt, desc, items);
	}
