...
public: 
	...
	template <typename R = TextMonoBehaviour*> R& AddXPPrefab() {
	 ...
	 Nullable1<bool>*& _avatarInPlayerKillMode() {
		return *(Nullable1<bool>**)((uintptr_t)this + 0x168);
	}
	...
	template <typename R = StatusNameShow> R& _locationStatusNameShow() {
	 ...
	 IGroup1<GameEntity*>*& _timerEntities() {
		return *(IGroup1<GameEntity*>**)((uintptr_t)this + 0x170);
	}
	...
	template <typename R = void> R ShowModifierNotification(int32_t entityId, Il2CppString* text, Nullable1<uintptr_t>* color, Il2CppString* iconPath) {
		return ((R (*)(StatusWindow*, int32_t, Il2CppString*, Nullable1<uintptr_t>*, Il2CppString*))(Il2CppBase() + 0x1495788))(this, entityId, text, color, iconPath);
	}
	...
	template <typename R = void> R ShowTextBubble(GameEntity* entity, Il2CppString* text, Nullable1<float>* lifeTime) {
		return ((R (*)(StatusWindow*, GameEntity*, Il2CppString*, Nullable1<float>*))(Il2CppBase() + 0x14960D8))(this, entity, text, lifeTime);
	}
