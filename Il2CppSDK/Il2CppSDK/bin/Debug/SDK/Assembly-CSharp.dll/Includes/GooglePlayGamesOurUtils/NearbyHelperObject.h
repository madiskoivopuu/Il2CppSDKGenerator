...
public: 
	...
	template <typename R = double> static R ToSeconds(Nullable1<uintptr_t>* span) {
		return ((R (*)(void *, Nullable1<uintptr_t>*))(Il2CppBase() + 0x13A8C44))(0, span);
	}
	template <typename R = void> static R StartAdvertisingTimer(Nullable1<uintptr_t>* span) {
		return ((R (*)(void *, Nullable1<uintptr_t>*))(Il2CppBase() + 0x13A8D00))(0, span);
	}
	template <typename R = void> static R StartDiscoveryTimer(Nullable1<uintptr_t>* span) {
		return ((R (*)(void *, Nullable1<uintptr_t>*))(Il2CppBase() + 0x13A8D80))(0, span);
	}
