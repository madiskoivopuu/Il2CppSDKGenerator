...
public: 
	...
	template <typename R = bool> static R& sQueueEmpty() {
	 ...
	 static Il2CppList<Action1<bool>*>*& sPauseCallbackList() {
		return *(Il2CppList<Action1<bool>*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 static Il2CppList<Action1<bool>*>*& sFocusCallbackList() {
		return *(Il2CppList<Action1<bool>*>**)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	...
	template <typename R = void> static R AddFocusCallback(Action1<bool>* callback) {
		return ((R (*)(void *, Action1<bool>*))(Il2CppBase() + 0x16FAE20))(0, callback);
	}
	template <typename R = bool> static R RemoveFocusCallback(Action1<bool>* callback) {
		return ((R (*)(void *, Action1<bool>*))(Il2CppBase() + 0x16FAF04))(0, callback);
	}
	template <typename R = void> static R AddPauseCallback(Action1<bool>* callback) {
		return ((R (*)(void *, Action1<bool>*))(Il2CppBase() + 0x16FAF90))(0, callback);
	}
	template <typename R = bool> static R RemovePauseCallback(Action1<bool>* callback) {
		return ((R (*)(void *, Action1<bool>*))(Il2CppBase() + 0x16FB074))(0, callback);
	}
