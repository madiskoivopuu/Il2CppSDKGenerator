...
class GoToCityWindow: UIWindow1
{
public: 
	...
	template <typename T = void> T OnButtonClickedHandler(uintptr_t goToButton) {
		return ((T (*)(GoToCityWindow*, uintptr_t))(Il2CppBase() + 0x12DFC54))(this, goToButton);
	}
	template <typename T = void> T DeselectOtherButton(uintptr_t goToButton) {
		return ((T (*)(GoToCityWindow*, uintptr_t))(Il2CppBase() + 0x12DFD08))(this, goToButton);
	}
