...
public: 
	...
	template <typename T = void*> T& _onClicked() {
	...
	template <typename T = uintptr_t> T get_BindedEntity() {
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t entity, void* onClicked, uintptr_t avatar, uintptr_t currentStep, bool notSeen, uintptr_t tooltipView) {
		return ((T (*)(BlueprintItem*, uintptr_t, uintptr_t, void*, uintptr_t, uintptr_t, bool, uintptr_t))(Il2CppBase() + 0x16C0098))(this, window, entity, onClicked, avatar, currentStep, notSeen, tooltipView);
	}
