...
public: 
	...
	template <typename R = uintptr_t> R& RectTransform() {
	 ...
	 Action2BlueprintItem*, BlueprintEntity*>*& _onClicked() {
		return *(Action2BlueprintItem*, BlueprintEntity*>**)((uintptr_t)this + 0x90);
	}
	...
	template <typename R = void> R Bind(IUIWindow* window, BlueprintEntity* entity, Action2BlueprintItem*, BlueprintEntity*>* onClicked, GameEntity* avatar, TrophyRoadEntity* currentStep, bool notSeen, TooltipView* tooltipView) {
		return ((R (*)(BlueprintItem*, IUIWindow*, BlueprintEntity*, Action2BlueprintItem*, BlueprintEntity*>*, GameEntity*, TrophyRoadEntity*, bool, TooltipView*))(Il2CppBase() + 0x16C0098))(this, window, entity, onClicked, avatar, currentStep, notSeen, tooltipView);
	}
	...
	template <typename R = void> R UpdateItem() {
	 ...
	 ValueTuple2Il2CppString*, Il2CppArray<Il2CppString*>*>* GetTitleAndText() {
		return ((ValueTuple2Il2CppString*, Il2CppArray<Il2CppString*>*>* (*)(BlueprintItem*))(Il2CppBase() + 0x16C09B4))(this);
	}
