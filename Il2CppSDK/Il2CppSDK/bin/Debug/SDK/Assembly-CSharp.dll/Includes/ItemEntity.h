...
public: 
	...
	template <typename R = void> R AddAIUse(int32_t newAttackCount, float newDelay, float newPeriod, float newDistance, Nullable1<int32_t>* newUseCount, bool newOnlyOnBorder, Il2CppString* newActorCondition, Il2CppString* newTargetCondition, TargetsSelector* newSelector) {
		return ((R (*)(ItemEntity*, int32_t, float, float, float, Nullable1<int32_t>*, bool, Il2CppString*, Il2CppString*, TargetsSelector*))(Il2CppBase() + 0x10F611C))(this, newAttackCount, newDelay, newPeriod, newDistance, newUseCount, newOnlyOnBorder, newActorCondition, newTargetCondition, newSelector);
	}
	template <typename R = void> R ReplaceAIUse(int32_t newAttackCount, float newDelay, float newPeriod, float newDistance, Nullable1<int32_t>* newUseCount, bool newOnlyOnBorder, Il2CppString* newActorCondition, Il2CppString* newTargetCondition, TargetsSelector* newSelector) {
		return ((R (*)(ItemEntity*, int32_t, float, float, float, Nullable1<int32_t>*, bool, Il2CppString*, Il2CppString*, TargetsSelector*))(Il2CppBase() + 0x10F62A8))(this, newAttackCount, newDelay, newPeriod, newDistance, newUseCount, newOnlyOnBorder, newActorCondition, newTargetCondition, newSelector);
	}
	...
	template <typename R = void> R AddEquipQuest(Il2CppString* newName, Nullable1<int32_t>* newActiveSlotIndex) {
		return ((R (*)(ItemEntity*, Il2CppString*, Nullable1<int32_t>*))(Il2CppBase() + 0x1103098))(this, newName, newActiveSlotIndex);
	}
	template <typename R = void> R ReplaceEquipQuest(Il2CppString* newName, Nullable1<int32_t>* newActiveSlotIndex) {
		return ((R (*)(ItemEntity*, Il2CppString*, Nullable1<int32_t>*))(Il2CppBase() + 0x11031B4))(this, newName, newActiveSlotIndex);
	}
	...
	template <typename R = void> R AddGhostyRuneDescription(Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newDisabledText, Nullable1<Icon>* newIcon, float newLifeTime) {
		return ((R (*)(ItemEntity*, Il2CppString*, Il2CppString*, Il2CppString*, Nullable1<Icon>*, float))(Il2CppBase() + 0x11053B8))(this, newCaption, newText, newDisabledText, newIcon, newLifeTime);
	}
	template <typename R = void> R ReplaceGhostyRuneDescription(Il2CppString* newCaption, Il2CppString* newText, Il2CppString* newDisabledText, Nullable1<Icon>* newIcon, float newLifeTime) {
		return ((R (*)(ItemEntity*, Il2CppString*, Il2CppString*, Il2CppString*, Nullable1<Icon>*, float))(Il2CppBase() + 0x1105530))(this, newCaption, newText, newDisabledText, newIcon, newLifeTime);
	}
	...
	template <typename R = void> R AddPreviewPrefab(Il2CppString* newPreviewName, Il2CppString* newPrefabName, Il2CppString* newBlueprint, ProtoModels::WorldResourcesType newResourceType, Nullable1<float>* newAngle) {
		return ((R (*)(ItemEntity*, Il2CppString*, Il2CppString*, Il2CppString*, ProtoModels::WorldResourcesType, Nullable1<float>*))(Il2CppBase() + 0x110D724))(this, newPreviewName, newPrefabName, newBlueprint, newResourceType, newAngle);
	}
	template <typename R = void> R ReplacePreviewPrefab(Il2CppString* newPreviewName, Il2CppString* newPrefabName, Il2CppString* newBlueprint, ProtoModels::WorldResourcesType newResourceType, Nullable1<float>* newAngle) {
		return ((R (*)(ItemEntity*, Il2CppString*, Il2CppString*, Il2CppString*, ProtoModels::WorldResourcesType, Nullable1<float>*))(Il2CppBase() + 0x110D880))(this, newPreviewName, newPrefabName, newBlueprint, newResourceType, newAngle);
	}
