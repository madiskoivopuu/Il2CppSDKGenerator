...
public: 
	...
	template <typename T = FBResolution*> static T get_CurrentScreenResolution() {
		return ((T (*)(void *))(Il2CppBase() + 0x1626288))(0);
	}
	template <typename T = void> static T set_CurrentScreenResolution(FBResolution* value) {
		return ((T (*)(void *, FBResolution*))(Il2CppBase() + 0x162631C))(0, value);
	}
	...
	template <typename T = uint8_t> static T GetAutoDetectedQuality() {
