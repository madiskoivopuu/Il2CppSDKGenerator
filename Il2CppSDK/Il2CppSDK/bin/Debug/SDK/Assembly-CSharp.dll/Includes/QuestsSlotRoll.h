...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1ManualQuestTrackerView*>*& onClickAction() {
		return *(Action1ManualQuestTrackerView*>**)((uintptr_t)this + 0x40);
	}
	...
	template <typename R = Data*> R GetData(Action1ManualQuestTrackerView*>* onClickAction, QuestEntity* quest, int64_t now) {
		return ((R (*)(QuestsSlotRoll*, Action1ManualQuestTrackerView*>*, QuestEntity*, int64_t))(Il2CppBase() + 0x1709E84))(this, onClickAction, quest, now);
	}
