...
public: 
	...
	template <typename T = Il2CppArray<uintptr_t>*> T GetDayPool(GuildQuestDifficulty* difficulty, int64_t now) {
		return ((T (*)(GuildQuestWeekPool*, GuildQuestDifficulty*, int64_t))(Il2CppBase() + 0x1938C9C))(this, difficulty, now);
	}
	...
	template <typename T = void> T _ctorg__GenerateQuests|13_0(GuildQuestDifficulty* difficulty, uintptr_t , uintptr_t ) {
		return ((T (*)(GuildQuestWeekPool*, GuildQuestDifficulty*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1938F50))(this, difficulty, , );
	}
