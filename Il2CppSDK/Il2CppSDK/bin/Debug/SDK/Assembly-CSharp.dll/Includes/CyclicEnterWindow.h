...
public: 
	...
	template <typename T = StandartButton*> T& _acceptButton() {
		return *(T*)((uintptr_t)this + 0xC8);
	}
	template <typename T = StandartButton*> T& _recreateButton() {
	...
	template <typename T = RequestType*> T& _lastRequestType() {
	...
	template <typename T = void> T OnCycleResponse(CyclicResponseData* data) {
		return ((T (*)(CyclicEnterWindow*, CyclicResponseData*))(Il2CppBase() + 0x1641614))(this, data);
	}
	template <typename T = void> T ShowRegisterChar() {
		return ((T (*)(CyclicEnterWindow*))(Il2CppBase() + 0x16421C8))(this);
	}
	template <typename T = void> T ShowChangeServer(CyclicResponseData* data) {
		return ((T (*)(CyclicEnterWindow*, CyclicResponseData*))(Il2CppBase() + 0x1643B5C))(this, data);
	}
	template <typename T = void> T ShowChangeParent(CyclicResponseData* data) {
		return ((T (*)(CyclicEnterWindow*, CyclicResponseData*))(Il2CppBase() + 0x1642934))(this, data);
	}
	template <typename T = void> T ShowChangeParentConfirm(CyclicResponseData* data) {
		return ((T (*)(CyclicEnterWindow*, CyclicResponseData*))(Il2CppBase() + 0x16444A8))(this, data);
	}
	template <typename T = void> T SendCycleRequest(RequestType* requestType) {
		return ((T (*)(CyclicEnterWindow*, RequestType*))(Il2CppBase() + 0x1641284))(this, requestType);
	}
