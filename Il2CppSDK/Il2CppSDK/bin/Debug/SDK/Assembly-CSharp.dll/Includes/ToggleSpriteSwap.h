...
public: 
	...
	template <typename R = void> R add_onValueChanged(Action1<bool>* value) {
		return ((R (*)(ToggleSpriteSwap*, Action1<bool>*))(Il2CppBase() + 0x14F1BEC))(this, value);
	}
	template <typename R = void> R remove_onValueChanged(Action1<bool>* value) {
		return ((R (*)(ToggleSpriteSwap*, Action1<bool>*))(Il2CppBase() + 0x14F1C8C))(this, value);
	}
