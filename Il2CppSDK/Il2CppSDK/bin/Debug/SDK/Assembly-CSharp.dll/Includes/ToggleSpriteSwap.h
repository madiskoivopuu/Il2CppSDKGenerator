...
public: 
	...
	template <typename T = void> T add_onValueChanged(void* value) {
		return ((T (*)(ToggleSpriteSwap*, void*))(Il2CppBase() + 0x14F1BEC))(this, value);
	}
	template <typename T = void> T remove_onValueChanged(void* value) {
		return ((T (*)(ToggleSpriteSwap*, void*))(Il2CppBase() + 0x14F1C8C))(this, value);
	}
