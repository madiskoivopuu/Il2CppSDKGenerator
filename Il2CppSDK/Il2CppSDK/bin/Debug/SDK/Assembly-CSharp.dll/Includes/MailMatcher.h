...
public: 
	...
	template <typename T = void*> static T& _matcherFromCyclic() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = void*> static T& _matcherGuildJoinResult() {
	...
	template <typename T = void*> static T& _matcherSender() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> static T& _matcherStack() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = void*> static T& _matcherSupportMessage() {
	...
	template <typename T = void*> static T& _matcherTournamentPosition() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x70);
	}
	template <typename T = void*> static T& _matcherWindowData() {
	...
	template <typename T = void*> static T get_FromCyclic() {
		return ((T (*)(void *))(Il2CppBase() + 0x125DC38))(0);
	}
	template <typename T = void*> static T get_GuildJoinResult() {
	...
	template <typename T = void*> static T get_TournamentPosition() {
		return ((T (*)(void *))(Il2CppBase() + 0x125C4D0))(0);
	}
	template <typename T = void*> static T get_WindowData() {
