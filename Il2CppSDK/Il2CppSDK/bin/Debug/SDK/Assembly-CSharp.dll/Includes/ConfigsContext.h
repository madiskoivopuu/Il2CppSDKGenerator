...
public: 
	...
	template <typename R = Il2CppString*> static R& REFLECT_DMG() {
	 ...
	 EntityIndex2<ConfigEntity*, ConfigType>*& _configTypeIndex() {
		return *(EntityIndex2<ConfigEntity*, ConfigType>**)((uintptr_t)this + 0x110);
	}
	 PrimaryEntityIndex2<ConfigEntity*, PlayerStatType>*& _playerStatsIndex() {
		return *(PrimaryEntityIndex2<ConfigEntity*, PlayerStatType>**)((uintptr_t)this + 0x118);
	}
	 PrimaryEntityIndex2<ConfigEntity*, IntInt>*& _gradeIndex() {
		return *(PrimaryEntityIndex2<ConfigEntity*, IntInt>**)((uintptr_t)this + 0x120);
	}
