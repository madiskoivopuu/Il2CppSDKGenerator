...
class ConfigsContext: DataContext1
{
public: 
	...
	template <typename T = void*> T& _configTypeIndex() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = void*> T& _playerStatsIndex() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = void*> T& _gradeIndex() {
	...
	template <typename T = void> T Fill(Il2CppDictionary<Il2CppString*, uintptr_t>* blueprints) {
		return ((T (*)(ConfigsContext*, Il2CppDictionary<Il2CppString*, uintptr_t>*))(Il2CppBase() + 0x15E3C7C))(this, blueprints);
	}
	template <typename T = uintptr_t> T GetPlayerStatConfig(uintptr_t statType) {
		return ((T (*)(ConfigsContext*, uintptr_t))(Il2CppBase() + 0x15E4208))(this, statType);
	}
	template <typename T = uintptr_t> T GetFontanelGrade(int32_t grade) {
