...
public: 
	...
	template <typename T = void> T Init(GuildWindow* window, int64_t inviteId, uintptr_t acceptAction, uintptr_t deleteAction) {
		return ((T (*)(GuildInviteItem*, GuildWindow*, int64_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x1B2F0F8))(this, window, inviteId, acceptAction, deleteAction);
	}
