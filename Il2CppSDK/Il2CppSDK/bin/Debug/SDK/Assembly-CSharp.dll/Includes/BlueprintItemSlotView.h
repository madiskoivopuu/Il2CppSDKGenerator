...
class BlueprintItemSlotView: TextImageMonoBehaviour
{
public: 
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t tooltip, uintptr_t resource) {
		return ((T (*)(BlueprintItemSlotView*, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x16C0F2C))(this, window, tooltip, resource);
	}
