...
public: 
	...
	template <typename T = uintptr_t> T& _resourceView() {
	...
	template <typename T = void> T Bind(uintptr_t reward, uintptr_t progressImage, uintptr_t tooltipView, int32_t previousValue, int32_t nextValue) {
		return ((T (*)(ProgressionExchangeRewardView*, uintptr_t, uintptr_t, uintptr_t, int32_t, int32_t))(Il2CppBase() + 0x16E5740))(this, reward, progressImage, tooltipView, previousValue, nextValue);
	}
