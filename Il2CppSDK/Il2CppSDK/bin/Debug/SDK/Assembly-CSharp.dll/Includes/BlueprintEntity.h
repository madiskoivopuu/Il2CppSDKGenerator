...
public: 
	...
	template <typename T = void> T AddPrefab(Il2CppString* newName, Il2CppString* newFemaleName, bool newHidden, uintptr_t newResourceType) {
		return ((T (*)(BlueprintEntity*, Il2CppString*, Il2CppString*, bool, uintptr_t))(Il2CppBase() + 0x16BF7C4))(this, newName, newFemaleName, newHidden, newResourceType);
	}
	template <typename T = void> T ReplacePrefab(Il2CppString* newName, Il2CppString* newFemaleName, bool newHidden, uintptr_t newResourceType) {
		return ((T (*)(BlueprintEntity*, Il2CppString*, Il2CppString*, bool, uintptr_t))(Il2CppBase() + 0x16BF908))(this, newName, newFemaleName, newHidden, newResourceType);
	}
