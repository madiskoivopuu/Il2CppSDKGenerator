...
public: 
	...
	template <typename T = uintptr_t> T& MinimapLabel() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = uintptr_t> T& animator() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = void*> T& _hasAnimator() {
	...
	template <typename T = Il2CppDictionary<uintptr_t, void*>*> T& _colors() {
	...
	template <typename T = uintptr_t> T& _weaponRenderer() {
		return *(T*)((uintptr_t)this + 0x130);
	}
	template <typename T = uintptr_t> T& _secondWeaponRenderer() {
		return *(T*)((uintptr_t)this + 0x148);
	}
	template <typename T = uintptr_t> T& _petRenderer() {
		return *(T*)((uintptr_t)this + 0x160);
	}
	template <typename T = bool> T& _showClothes() {
		return *(T*)((uintptr_t)this + 0x178);
	}
	template <typename T = uintptr_t> T& _clothesRenderer() {
		return *(T*)((uintptr_t)this + 0x180);
	}
	template <typename T = uintptr_t> T& _bulletRenderer() {
		return *(T*)((uintptr_t)this + 0x198);
	}
	template <typename T = uintptr_t> T& _toolRenderer() {
	...
	template <typename T = Il2CppList<void*>*> T& _effects() {
		return *(T*)((uintptr_t)this + 0x1D8);
	}
	template <typename T = void*> T& _toolFxs() {
	...
	template <typename T = Il2CppRect> static T UV_Rect(int32_t x, int32_t y, int32_t width, int32_t height) {
	...
	template <typename T = void> T Execute(uintptr_t entity, float deltaTime) {
		return ((T (*)(HideHelper*, uintptr_t, float))(Il2CppBase() + 0x1C3C858))(this, entity, deltaTime);
	}
	...
	template <typename T = void> T SetupToolMaterials(uintptr_t view, bool switchShader, bool active) {
		return ((T (*)(HideHelper*, uintptr_t, bool, bool))(Il2CppBase() + 0x1C3DEA4))(this, view, switchShader, active);
	}
	...
	template <typename T = void> T InitFromSource(uintptr_t source) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C3E578))(this, source);
	}
	template <typename T = void> T Death(uintptr_t entity) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C3F250))(this, entity);
	}
	...
	template <typename T = void*> T GetColorByPriority() {
	...
	template <typename T = void> T set_Gender(uintptr_t value) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C404F8))(this, value);
	}
	template <typename T = void> T SetupGender(uintptr_t gender, bool hd) {
		return ((T (*)(HideHelper*, uintptr_t, bool))(Il2CppBase() + 0x1C40500))(this, gender, hd);
	}
	template <typename T = void> T SetupView(uintptr_t slotIndex, uintptr_t item, bool hd) {
		return ((T (*)(HideHelper*, uintptr_t, uintptr_t, bool))(Il2CppBase() + 0x1C40C94))(this, slotIndex, item, hd);
	}
	...
	template <typename T = uintptr_t> T CreateItem(uintptr_t item, bool tool) {
		return ((T (*)(HideHelper*, uintptr_t, bool))(Il2CppBase() + 0x1C41988))(this, item, tool);
	}
	template <typename T = uintptr_t> T CreateItem_1(uintptr_t item, Il2CppString* prefabName, uintptr_t resourcesType, Il2CppString* socketName, bool dontCheckHD) {
		return ((T (*)(HideHelper*, uintptr_t, Il2CppString*, uintptr_t, Il2CppString*, bool))(Il2CppBase() + 0x1C41ADC))(this, item, prefabName, resourcesType, socketName, dontCheckHD);
	}
	template <typename T = void> T SetupToolView(uintptr_t item) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C41F74))(this, item);
	}
	template <typename T = void> T SetupClothesView(uintptr_t item) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C40BE4))(this, item);
	}
	template <typename T = void> T SetupPetView(uintptr_t item) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C4203C))(this, item);
	}
	template <typename T = void> T UpdateArmed(uintptr_t entity) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C3DFFC))(this, entity);
	}
	template <typename T = void> T SetupWeaponView(uintptr_t item) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C42204))(this, item);
	}
	...
	template <typename T = void> T AddChild(uintptr_t child) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C3F028))(this, child);
	}
	...
	template <typename T = void> T RemoveChild(uintptr_t child) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C428B8))(this, child);
	}
	template <typename T = void> T CombineTextures(uintptr_t entity, Il2CppString* textureName, uintptr_t targetTexture) {
		return ((T (*)(HideHelper*, uintptr_t, Il2CppString*, uintptr_t))(Il2CppBase() + 0x1C429D4))(this, entity, textureName, targetTexture);
	}
	template <typename T = void> T ApplySetupView(uintptr_t entity) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C3D018))(this, entity);
	}
	template <typename T = void> T SetupHairColor(uintptr_t colorEntity) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C42E40))(this, colorEntity);
	}
	template <typename T = void> T SetupSkinColor(uintptr_t colorEntity) {
		return ((T (*)(HideHelper*, uintptr_t))(Il2CppBase() + 0x1C42F40))(this, colorEntity);
	}
