...
public: 
	...
	template <typename R = uintptr_t> R& animator() {
	 ...
	 Nullable1<bool>*& _hasAnimator() {
		return *(Nullable1<bool>**)((uintptr_t)this + 0xA8);
	}
	...
	template <typename R = bool> R& _isMinimapHide() {
	 ...
	 Il2CppDictionary<uintptr_t, ValueTuple2<int32_t, int32_t>*>*& _colors() {
		return *(Il2CppDictionary<uintptr_t, ValueTuple2<int32_t, int32_t>*>**)((uintptr_t)this + 0x118);
	}
	...
	template <typename R = bool> R& _showBullet() {
	 ...
	 Il2CppList<ValueTuple2<Il2CppString*, uintptr_t>*>*& _effects() {
		return *(Il2CppList<ValueTuple2<Il2CppString*, uintptr_t>*>**)((uintptr_t)this + 0x1D8);
	}
	 HashSet1<Il2CppString*>*& _toolFxs() {
		return *(HashSet1<Il2CppString*>**)((uintptr_t)this + 0x1E0);
	}
	...
	template <typename R = void> R SetMinimapHide(bool isMinimapHide) {
	 ...
	 ValueTuple2<uintptr_t, int32_t>* GetColorByPriority() {
		return ((ValueTuple2<uintptr_t, int32_t>* (*)(HideHelper*))(Il2CppBase() + 0x1C3F864))(this);
	}
