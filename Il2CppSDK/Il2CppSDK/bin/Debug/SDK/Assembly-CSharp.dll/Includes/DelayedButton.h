...
public: 
	...
	template <typename R = bool> R& _interactableOnFinish() {
	 ...
	 Func1bool>*& _onStart() {
		return *(Func1bool>**)((uintptr_t)this + 0x120);
	}
	 Action1float>*& _onProgress() {
		return *(Action1float>**)((uintptr_t)this + 0x128);
	}
	...
	template <typename R = void> R Bind(IUIWindow* window, float delay, uintptr_t progressImage, uintptr_t countLabel, Func1bool>* onStart, Action1float>* onProgress, uintptr_t onFinish, bool interactableOnFinish) {
		return ((R (*)(DelayedButton*, IUIWindow*, float, uintptr_t, uintptr_t, Func1bool>*, Action1float>*, uintptr_t, bool))(Il2CppBase() + 0xEB8398))(this, window, delay, progressImage, countLabel, onStart, onProgress, onFinish, interactableOnFinish);
	}
