...
public: 
	...
	template <typename T = void*> T& _onStart() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = void*> T& _onProgress() {
	...
	template <typename T = void> T Bind(uintptr_t window, float delay, uintptr_t progressImage, uintptr_t countLabel, void* onStart, void* onProgress, uintptr_t onFinish, bool interactableOnFinish) {
		return ((T (*)(DelayedButton*, uintptr_t, float, uintptr_t, uintptr_t, void*, void*, uintptr_t, bool))(Il2CppBase() + 0xEB8398))(this, window, delay, progressImage, countLabel, onStart, onProgress, onFinish, interactableOnFinish);
	}
