...
public: 
	...
	template <typename T = uintptr_t> T& TooltipProxy() {
	...
	template <typename T = void*> T& _oldPowerValue() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = void*> T& _oldAttackDamage() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = void*> T& _oldArmor() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = void*> T& _oldAttackSpeed() {
		return *(T*)((uintptr_t)this + 0x128);
	}
	template <typename T = void*> T& _oldMoveSpeed() {
		return *(T*)((uintptr_t)this + 0x130);
	}
	template <typename T = Il2CppString*> T& _oldName() {
		return *(T*)((uintptr_t)this + 0x138);
	}
	template <typename T = void*> T& _oldLvl() {
	...
	template <typename T = void*> T& _oldHealPrediction() {
	...
	template <typename T = void> T Init(uintptr_t tooltip) {
		return ((T (*)(HUDActorInfo*, uintptr_t))(Il2CppBase() + 0x14487E8))(this, tooltip);
	}
	template <typename T = void> T Draw(uintptr_t actor) {
		return ((T (*)(HUDActorInfo*, uintptr_t))(Il2CppBase() + 0x144889C))(this, actor);
	}
