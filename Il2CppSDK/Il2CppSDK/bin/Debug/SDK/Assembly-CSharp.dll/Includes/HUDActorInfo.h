...
public: 
	...
	template <typename R = int32_t> R& _oldThirstValue() {
	 ...
	 Nullable1<float>*& _oldPowerValue() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x110);
	}
	 Nullable1<float>*& _oldAttackDamage() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x118);
	}
	 Nullable1<float>*& _oldArmor() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x120);
	}
	 Nullable1<float>*& _oldAttackSpeed() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x128);
	}
	 Nullable1<float>*& _oldMoveSpeed() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x130);
	}
	template <typename R = Il2CppString*> R& _oldName() {
		return *(R*)((uintptr_t)this + 0x138);
	}
	 Nullable1<int32_t>*& _oldLvl() {
		return *(Nullable1<int32_t>**)((uintptr_t)this + 0x140);
	}
	...
	template <typename R = Il2CppString*> R& _oldMountName() {
	 ...
	 Nullable1<float>*& _oldHpCoef() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x158);
	}
	 Nullable1<float>*& _oldMaxHealth() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x160);
	}
	 Nullable1<float>*& _oldHealth() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x168);
	}
	 Nullable1<float>*& _oldShield() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x170);
	}
	 Nullable1<float>*& _oldHealPrediction() {
		return *(Nullable1<float>**)((uintptr_t)this + 0x178);
	}
