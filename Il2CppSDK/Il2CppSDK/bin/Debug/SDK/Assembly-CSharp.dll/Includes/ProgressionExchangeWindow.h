...
class ProgressionExchangeWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& _useButton() {
	...
	template <typename T = uintptr_t> T& requiredResourcesView() {
	...
	template <typename T = void> T OnAnyTabClick(uintptr_t tabType) {
		return ((T (*)(ProgressionExchangeWindow*, uintptr_t))(Il2CppBase() + 0x16E7574))(this, tabType);
	}
	...
	template <typename T = void> T OnSelect(uintptr_t selectedInventory, uintptr_t selectedSlot) {
		return ((T (*)(ProgressionExchangeWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x16E9840))(this, selectedInventory, selectedSlot);
	}
	template <typename T = void> T OnDrop(uintptr_t item) {
		return ((T (*)(ProgressionExchangeWindow*, uintptr_t))(Il2CppBase() + 0x16E9AD4))(this, item);
	}
	template <typename T = void> T OnDoubleClick(uintptr_t item) {
		return ((T (*)(ProgressionExchangeWindow*, uintptr_t))(Il2CppBase() + 0x16EA508))(this, item);
	}
	template <typename T = bool> T IsItemInFilter(uintptr_t entity) {
		return ((T (*)(ProgressionExchangeWindow*, uintptr_t))(Il2CppBase() + 0x16E9A44))(this, entity);
	}
	...
	template <typename T = bool> T UpdateInventoryEntity(uintptr_t inventoryEntity) {
		return ((T (*)(ProgressionExchangeWindow*, uintptr_t))(Il2CppBase() + 0x16EA978))(this, inventoryEntity);
	}
