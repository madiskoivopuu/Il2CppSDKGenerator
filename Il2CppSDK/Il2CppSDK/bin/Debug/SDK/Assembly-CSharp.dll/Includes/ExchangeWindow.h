...
public: 
	...
	template <typename R = uintptr_t> R& _bpCompleteColor() {
	 ...
	 HashSet1<int32_t>*& _lockedSet() {
		return *(HashSet1<int32_t>**)((uintptr_t)this + 0x1E8);
	}
	 Nullable1<int32_t>*& _selectedExchangeSum() {
		return *(Nullable1<int32_t>**)((uintptr_t)this + 0x1F0);
	}
	 Nullable1<int32_t>*& _limit() {
		return *(Nullable1<int32_t>**)((uintptr_t)this + 0x1F8);
	}
	...
	template <typename R = bool> R& _sendExchange() {
	 ...
	 HashSet1<Il2CppString*>* GetNeedResources() {
		return ((HashSet1<Il2CppString*>* (*)(ExchangeWindow*))(Il2CppBase() + 0x17951F4))(this);
	}
