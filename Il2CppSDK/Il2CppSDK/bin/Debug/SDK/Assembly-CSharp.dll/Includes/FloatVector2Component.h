...
#include "TypeVector2Component`1" 

class FloatVector2Component: TypeVector2Component1
{
public: 
	...
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(FloatVector2Component*, uintptr_t))(Il2CppBase() + 0x15F76EC))(this, blueprintComponent);
	}
