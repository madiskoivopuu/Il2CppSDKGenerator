...
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> T& BuilderEntityViews() {
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t tooltipView) {
		return ((T (*)(BuilderContainer*, uintptr_t, uintptr_t))(Il2CppBase() + 0x15A7FD4))(this, window, tooltipView);
	}
