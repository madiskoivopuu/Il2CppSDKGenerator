...
public: 
	...
	template <typename T = void> T Show(ItemEntity* playerClass, TooltipView* tooltipView) {
		return ((T (*)(ClassProgressInfoPopup*, ItemEntity*, TooltipView*))(Il2CppBase() + 0x159A45C))(this, playerClass, tooltipView);
	}
