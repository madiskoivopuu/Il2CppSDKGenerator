...
class CustomStoreWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& CurrencyPrefab() {
	...
	template <typename T = uintptr_t> T& ProductViewX2VPrefab() {
		return *(T*)((uintptr_t)this + 0x128);
	}
	template <typename T = uintptr_t> T& ProductViewX2HPrefab() {
	...
	template <typename T = uintptr_t> T& ButtonUpdateStore() {
		return *(T*)((uintptr_t)this + 0x150);
	}
	template <typename T = uintptr_t> T& ButtonPrice1() {
		return *(T*)((uintptr_t)this + 0x158);
	}
	template <typename T = uintptr_t> T& ButtonPrice2() {
		return *(T*)((uintptr_t)this + 0x160);
	}
	template <typename T = uintptr_t> T& ButtonBuyMore() {
	...
	template <typename T = Il2CppDictionary<Il2CppString*, uintptr_t>*> T& CurrenciesItemsViews() {
	...
	template <typename T = void> T FillCategory(uintptr_t category) {
		return ((T (*)(CustomStoreWindow*, uintptr_t))(Il2CppBase() + 0x1637404))(this, category);
	}
	template <typename T = void> T printList(Il2CppList<void*>* list) {
		return ((T (*)(CustomStoreWindow*, Il2CppList<void*>*))(Il2CppBase() + 0x1637970))(this, list);
	}
	template <typename T = void> T FillProducts(uintptr_t storeCategory, Il2CppList<void*>* prioritized) {
		return ((T (*)(CustomStoreWindow*, uintptr_t, Il2CppList<void*>*))(Il2CppBase() + 0x1637BC4))(this, storeCategory, prioritized);
	}
	template <typename T = void> T OnProductClickedAction(uintptr_t productView, int32_t priorityIndex, bool needSendAnalyticsEvent) {
		return ((T (*)(CustomStoreWindow*, uintptr_t, int32_t, bool))(Il2CppBase() + 0x1639178))(this, productView, priorityIndex, needSendAnalyticsEvent);
	}
	...
	template <typename T = uintptr_t> T GetPriceButtonWithIndex(int32_t index) {
