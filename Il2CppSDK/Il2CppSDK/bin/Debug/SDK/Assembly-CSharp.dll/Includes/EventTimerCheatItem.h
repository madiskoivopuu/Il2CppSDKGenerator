...
public: 
	...
	template <typename T = ImageMonoBehaviour*> T& _icon() {
	...
	template <typename T = ItemForMessage*> T& _itemPrefab() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = Il2CppString*> T& _empty() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = Il2CppList<ItemForMessage*>*> T& _items() {
	...
	template <typename T = void> T Bind(int32_t index, Il2CppString* typePreffix, Il2CppString* name, int64_t startTime, int64_t endTime, Icon* icon, Il2CppArray<uintptr_t>* resources) {
		return ((T (*)(EventTimerCheatItem*, int32_t, Il2CppString*, Il2CppString*, int64_t, int64_t, Icon*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1791934))(this, index, typePreffix, name, startTime, endTime, icon, resources);
	}
