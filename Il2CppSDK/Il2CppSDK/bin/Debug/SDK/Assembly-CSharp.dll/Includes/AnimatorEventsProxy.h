...
public: 
	...
	template <typename T = void*> T& _listeners() {
	...
	template <typename T = void> T AddListener(uintptr_t listener) {
		return ((T (*)(AnimatorEventsProxy*, uintptr_t))(Il2CppBase() + 0x188D46C))(this, listener);
	}
	template <typename T = void> T RemoveListener(uintptr_t listener) {
		return ((T (*)(AnimatorEventsProxy*, uintptr_t))(Il2CppBase() + 0x188D8F8))(this, listener);
	}
