...
public: 
	...
	template <typename T = void> T Init(UIWindow* window, ChatEntity* entity) {
		return ((T (*)(GuildNewsView*, UIWindow*, ChatEntity*))(Il2CppBase() + 0x1B3AEB0))(this, window, entity);
	}
	...
	template <typename T = uintptr_t> T GetEventIcon(GuildEventType* type) {
		return ((T (*)(GuildNewsView*, GuildEventType*))(Il2CppBase() + 0x1B3B1F8))(this, type);
	}
