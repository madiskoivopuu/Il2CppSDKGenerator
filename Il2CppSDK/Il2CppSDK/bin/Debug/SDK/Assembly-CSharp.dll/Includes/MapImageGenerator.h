...
public: 
	...
	template <typename T = ClientDataContexts*> T& _contexts() {
	...
	template <typename T = void> T OnLocation(EntityBlueprint* location) {
		return ((T (*)(MapImageGenerator*, EntityBlueprint*))(Il2CppBase() + 0x1272FD8))(this, location);
	}
	...
	template <typename T = EntityBlueprint*> static T ParseEntity(Il2CppString* jsonString, Il2CppArray<uintptr_t>* componentNames, Il2CppArray<uintptr_t>* componentTypes) {
