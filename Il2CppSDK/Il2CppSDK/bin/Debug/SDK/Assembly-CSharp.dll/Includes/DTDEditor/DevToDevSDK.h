...
public: 
	...
	template <typename T = void> T InitializeAnalytics(DTDPlatform* platform) {
		return ((T (*)(DevToDevSDK*, DTDPlatform*))(Il2CppBase() + 0xEC1F08))(this, platform);
	}
	...
	template <typename T = void> T Startb__10_2(IDictionary2Il2CppString*, Il2CppString*>* pushData) {
		return ((T (*)(DevToDevSDK*, IDictionary2Il2CppString*, Il2CppString*>*))(Il2CppBase() + 0xEC22C4))(this, pushData);
	}
