...
public: 
	...
	template <typename T = DTDEditorWindow*> T& ActiveWindow() {
	...
	template <typename T = DTDPlatform*> T& ActivePlatform() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = Il2CppList<DTDCredentials*>*> T& Credentials() {
	...
	template <typename T = DTDEditorWindow*> T get_ActiveWindow() {
		return ((T (*)(DTDEditorModel*))(Il2CppBase() + 0x1646F68))(this);
	}
	template <typename T = void> T set_ActiveWindow(DTDEditorWindow* value) {
		return ((T (*)(DTDEditorModel*, DTDEditorWindow*))(Il2CppBase() + 0x1646F70))(this, value);
	}
	...
	template <typename T = DTDPlatform*> T get_ActivePlatform() {
		return ((T (*)(DTDEditorModel*))(Il2CppBase() + 0x1646FB4))(this);
	}
	template <typename T = void> T set_ActivePlatform(DTDPlatform* value) {
		return ((T (*)(DTDEditorModel*, DTDPlatform*))(Il2CppBase() + 0x1646FBC))(this, value);
	}
	template <typename T = Il2CppList<DTDCredentials*>*> T get_Credentials() {
		return ((T (*)(DTDEditorModel*))(Il2CppBase() + 0x1646FC4))(this);
	}
	template <typename T = void> T set_Credentials(Il2CppList<DTDCredentials*>* value) {
		return ((T (*)(DTDEditorModel*, Il2CppList<DTDCredentials*>*))(Il2CppBase() + 0x1646FCC))(this, value);
	}
