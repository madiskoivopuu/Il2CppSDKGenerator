...
public: 
	...
	template <typename T = RegionView*> T& RegionPrefab() {
	...
	template <typename T = void> T RefreshStatusb__22_0(ErrorCodes* code, Il2CppString* codeMessage, Il2CppString* regionName, Il2CppString* url, Il2CppArray<uintptr_t>* regionList) {
		return ((T (*)(ServerSelectionWindow*, ErrorCodes*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x1622894))(this, code, codeMessage, regionName, url, regionList);
	}
