...
public: 
	...
	template <typename R = bool> R& _selected() {
	 ...
	 Action1<LocationModeButton*>*& ClickEvent() {
		return *(Action1<LocationModeButton*>**)((uintptr_t)this + 0xB0);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1<LocationModeButton*>* value) {
		return ((R (*)(LocationModeButton*, Action1<LocationModeButton*>*))(Il2CppBase() + 0x17A105C))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1<LocationModeButton*>* value) {
		return ((R (*)(LocationModeButton*, Action1<LocationModeButton*>*))(Il2CppBase() + 0x17BA4D8))(this, value);
	}
