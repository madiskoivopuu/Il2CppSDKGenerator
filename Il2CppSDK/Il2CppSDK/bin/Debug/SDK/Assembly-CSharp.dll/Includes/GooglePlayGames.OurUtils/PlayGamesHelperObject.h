...
public: 
	...
	template <typename T = PlayGamesHelperObject*> static T& instance() {
	...
	template <typename T = Il2CppList<Action1bool>*>*> static T& sPauseCallbackList() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = Il2CppList<Action1bool>*>*> static T& sFocusCallbackList() {
	...
	template <typename T = void> static T AddFocusCallback(Action1bool>* callback) {
		return ((T (*)(void *, Action1bool>*))(Il2CppBase() + 0x16FAE20))(0, callback);
	}
	template <typename T = bool> static T RemoveFocusCallback(Action1bool>* callback) {
		return ((T (*)(void *, Action1bool>*))(Il2CppBase() + 0x16FAF04))(0, callback);
	}
	template <typename T = void> static T AddPauseCallback(Action1bool>* callback) {
		return ((T (*)(void *, Action1bool>*))(Il2CppBase() + 0x16FAF90))(0, callback);
	}
	template <typename T = bool> static T RemovePauseCallback(Action1bool>* callback) {
		return ((T (*)(void *, Action1bool>*))(Il2CppBase() + 0x16FB074))(0, callback);
	}
