...
public: 
	...
	template <typename R = void> R AddEntityIndexes() {
	 ...
	 HashSet1HintEntity*>* GetEntitiesWithLocation(Il2CppString* Name) {
		return ((HashSet1HintEntity*>* (*)(HintDataContext*, Il2CppString*))(Il2CppBase() + 0x1C46280))(this, Name);
	}
	 HashSet1HintEntity*>* GetNonSpecificEntities() {
		return ((HashSet1HintEntity*>* (*)(HintDataContext*))(Il2CppBase() + 0x1C46340))(this);
	}
