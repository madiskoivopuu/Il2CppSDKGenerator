...
public: 
	...
	template <typename T = uintptr_t> T& EntityName() {
	...
	template <typename T = void*> T& _power() {
	...
	template <typename T = void> T UpdateView(uintptr_t entity, uintptr_t show) {
		return ((T (*)(StatusNameDecorator*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1490EF4))(this, entity, show);
	}
