...
public: 
	...
	template <typename R = IUIWindow*> R& Current() {
	 ...
	 Stack1IUIWindowContext*>*& _stack() {
		return *(Stack1IUIWindowContext*>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = void> R add_ShowWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UIStackLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x1530478))(this, value);
	}
	template <typename R = void> R remove_ShowWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UIStackLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x1530518))(this, value);
	}
	template <typename R = void> R add_CloseWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UIStackLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x15305B8))(this, value);
	}
	template <typename R = void> R remove_CloseWindowEvent(Action1IUIWindow*>* value) {
		return ((R (*)(UIStackLayer*, Action1IUIWindow*>*))(Il2CppBase() + 0x1530658))(this, value);
	}
