...
public: 
	...
	template <typename T = uintptr_t> T& _statGroupPrefab() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = uintptr_t> T& _statViewPrefab() {
	...
	template <typename T = void> T Init(uintptr_t tooltipView) {
		return ((T (*)(PlayerStatsPanel*, uintptr_t))(Il2CppBase() + 0x1572CBC))(this, tooltipView);
	}
	template <typename T = void> T UpdateView(uintptr_t avatar) {
		return ((T (*)(PlayerStatsPanel*, uintptr_t))(Il2CppBase() + 0x15735BC))(this, avatar);
	}
