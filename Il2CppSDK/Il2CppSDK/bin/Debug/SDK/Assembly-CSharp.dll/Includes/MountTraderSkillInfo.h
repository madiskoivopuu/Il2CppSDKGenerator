...
public: 
	...
	template <typename R = Il2CppString*> R& _tempErrorString() {
	 ...
	 Action1<MountTraderSkillInfo*>*& OnSkillClick() {
		return *(Action1<MountTraderSkillInfo*>**)((uintptr_t)this + 0xF8);
	}
	...
	template <typename R = void> R add_OnSkillClick(Action1<MountTraderSkillInfo*>* value) {
		return ((R (*)(MountTraderSkillInfo*, Action1<MountTraderSkillInfo*>*))(Il2CppBase() + 0x1549B7C))(this, value);
	}
	template <typename R = void> R remove_OnSkillClick(Action1<MountTraderSkillInfo*>* value) {
		return ((R (*)(MountTraderSkillInfo*, Action1<MountTraderSkillInfo*>*))(Il2CppBase() + 0x1549C1C))(this, value);
	}
