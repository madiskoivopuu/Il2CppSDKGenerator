...
#include "MountSkillInfo" 

class MountTraderSkillInfo: MountSkillInfo
{
public: 
	...
	template <typename T = void> T add_OnSkillClick(void* value) {
		return ((T (*)(MountTraderSkillInfo*, void*))(Il2CppBase() + 0x1549B7C))(this, value);
	}
	template <typename T = void> T remove_OnSkillClick(void* value) {
		return ((T (*)(MountTraderSkillInfo*, void*))(Il2CppBase() + 0x1549C1C))(this, value);
	}
	template <typename T = void> T Bind(uintptr_t source, Il2CppString* blueprint, Il2CppString* errorString, bool canBeSelected) {
		return ((T (*)(MountTraderSkillInfo*, uintptr_t, Il2CppString*, Il2CppString*, bool))(Il2CppBase() + 0x1549CBC))(this, source, blueprint, errorString, canBeSelected);
	}
	template <typename T = void> T Show(uintptr_t item, int32_t index, bool isRandom, bool isNew) {
		return ((T (*)(MountTraderSkillInfo*, uintptr_t, int32_t, bool, bool))(Il2CppBase() + 0x1549D10))(this, item, index, isRandom, isNew);
	}
	template <typename T = void> T Show_1(uintptr_t item, int32_t index) {
		return ((T (*)(MountTraderSkillInfo*, uintptr_t, int32_t))(Il2CppBase() + 0x154A188))(this, item, index);
	}
