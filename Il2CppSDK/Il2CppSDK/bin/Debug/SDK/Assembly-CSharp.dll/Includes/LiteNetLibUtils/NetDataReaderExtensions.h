...
public: 
	...
	template <typename R = void> static R PutStruct_1(uintptr_t writer, Nullable1<uintptr_t>* structValue) {
		return ((R (*)(void *, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(0, writer, structValue);
	}
	...
	template <typename R = void> static R PutMappedStrings_2(uintptr_t writer, HashSet1<Il2CppString*>* values) {
		return ((R (*)(void *, uintptr_t, HashSet1<Il2CppString*>*))(Il2CppBase() + 0x13AAF70))(0, writer, values);
	}
