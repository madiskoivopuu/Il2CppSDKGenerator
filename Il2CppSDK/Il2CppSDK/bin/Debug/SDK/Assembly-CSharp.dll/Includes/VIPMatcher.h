...
public: 
	...
	template <typename T = void*> static T& _matcherVipBonus() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> static T& _matcherVipId() {
	...
	template <typename T = void*> static T get_VipBonus() {
		return ((T (*)(void *))(Il2CppBase() + 0x15BC440))(0);
	}
	template <typename T = void*> static T get_VipId() {
