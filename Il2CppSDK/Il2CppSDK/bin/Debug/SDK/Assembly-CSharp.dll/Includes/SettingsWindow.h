...
class SettingsWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& ConnectToKefirButton() {
	...
	template <typename T = uintptr_t> T& _cachedCameraHelper() {
	...
	template <typename T = uintptr_t> T get_CameraHelper() {
