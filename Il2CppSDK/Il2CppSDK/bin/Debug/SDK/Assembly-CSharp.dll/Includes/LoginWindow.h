...
public: 
	...
	template <typename R = Il2CppString*> R& _gamecenterId() {
	 ...
	 Action2PlatformAuthData*, LoginClientInfo*>*& OnPlatformAuthenticated() {
		return *(Action2PlatformAuthData*, LoginClientInfo*>**)((uintptr_t)this + 0x110);
	}

	template <typename R = ICommonLogger*> R get__logger() {
		return ((R (*)(LoginWindow*))(Il2CppBase() + 0x1730280))(this);
	}
	template <typename R = void> R add_OnPlatformAuthenticated(Action2PlatformAuthData*, LoginClientInfo*>* value) {
		return ((R (*)(LoginWindow*, Action2PlatformAuthData*, LoginClientInfo*>*))(Il2CppBase() + 0x17302CC))(this, value);
	}
	template <typename R = void> R remove_OnPlatformAuthenticated(Action2PlatformAuthData*, LoginClientInfo*>* value) {
		return ((R (*)(LoginWindow*, Action2PlatformAuthData*, LoginClientInfo*>*))(Il2CppBase() + 0x1730370))(this, value);
	}
	...
	template <typename R = void> R LoginAndroidb__30_1(Task1uintptr_t>* task) {
		return ((R (*)(LoginWindow*, Task1uintptr_t>*))(Il2CppBase() + 0x17317BC))(this, task);
	}
