...
public: 
	...
	template <typename T = RegionInfo*> T& _region() {
	...
	template <typename T = Action2PlatformAuthData*, LoginClientInfo*>*> T& OnPlatformAuthenticated() {
	...
	template <typename T = void> T add_OnPlatformAuthenticated(Action2PlatformAuthData*, LoginClientInfo*>* value) {
		return ((T (*)(LoginWindow*, Action2PlatformAuthData*, LoginClientInfo*>*))(Il2CppBase() + 0x17302CC))(this, value);
	}
	template <typename T = void> T remove_OnPlatformAuthenticated(Action2PlatformAuthData*, LoginClientInfo*>* value) {
		return ((T (*)(LoginWindow*, Action2PlatformAuthData*, LoginClientInfo*>*))(Il2CppBase() + 0x1730370))(this, value);
	}
	template <typename T = LoginClientInfo*> static T get__clientInfo() {
	...
	template <typename T = void> T LoginAndroidb__30_1(Task1uintptr_t>* task) {
		return ((T (*)(LoginWindow*, Task1uintptr_t>*))(Il2CppBase() + 0x17317BC))(this, task);
	}
