...
public: 
	...
	template <typename T = PlayerClassSlot*> T& ClassSlot() {
		return *(T*)((uintptr_t)this + 0x160);
	}
	template <typename T = uintptr_t> T& ClassSkillsPanel() {
		return *(T*)((uintptr_t)this + 0x168);
	}
	template <typename T = PlayerMountSlot*> T& MountSlot() {
		return *(T*)((uintptr_t)this + 0x170);
	}
	template <typename T = uintptr_t> T& MountSkillsPanel() {
		return *(T*)((uintptr_t)this + 0x178);
	}
	template <typename T = PlayerPetSlot*> T& PetSlot() {
	...
	template <typename T = InventoryItemDraggable*> T& SkillItemPrefab() {
		return *(T*)((uintptr_t)this + 0x198);
	}
	template <typename T = PuppetRendererController*> T& PuppetRenderer() {
	...
	template <typename T = PlayerStatsPanel*> T& PlayerStatsPanel() {
	...
	template <typename T = TextMonoBehaviour*> T& NewCosmetics() {
	...
	template <typename T = void> T OnClickClassSlot(PlayerClassSlot* slot) {
		return ((T (*)(InventoryWindow*, PlayerClassSlot*))(Il2CppBase() + 0x1240080))(this, slot);
	}
	template <typename T = void> T OnClickMountSlot(PlayerMountSlot* slot) {
		return ((T (*)(InventoryWindow*, PlayerMountSlot*))(Il2CppBase() + 0x12400CC))(this, slot);
	}
	template <typename T = void> T OnClickPetSlot(PlayerPetSlot* slot) {
		return ((T (*)(InventoryWindow*, PlayerPetSlot*))(Il2CppBase() + 0x1240114))(this, slot);
	}
	...
	template <typename T = void> T OnBeginDrag(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(InventoryWindow*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x1241854))(this, item, eventData);
	}
	template <typename T = void> T OnEndDrag(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(InventoryWindow*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x1241B20))(this, item, eventData);
	}
	template <typename T = void> T UpdatePuppetSlots(ItemEntity* item) {
		return ((T (*)(InventoryWindow*, ItemEntity*))(Il2CppBase() + 0x12418FC))(this, item);
	}
