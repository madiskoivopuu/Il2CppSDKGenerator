...
public: 
	...
	template <typename R = GuildInviteEntity*> R GetEntityWithId(int64_t id) {
	 ...
	 HashSet1GuildInviteEntity*>* GetToPlayerEntities(int64_t toPlayerId) {
		return ((HashSet1GuildInviteEntity*>* (*)(GuildInviteContext*, int64_t))(Il2CppBase() + 0x1B2C3D0))(this, toPlayerId);
	}
	 HashSet1GuildInviteEntity*>* GetFromPlayerEntities(int64_t fromPlayerId) {
		return ((HashSet1GuildInviteEntity*>* (*)(GuildInviteContext*, int64_t))(Il2CppBase() + 0x1B27F9C))(this, fromPlayerId);
	}
	 HashSet1GuildInviteEntity*>* GetToGuildEntities(int64_t toGuildId) {
		return ((HashSet1GuildInviteEntity*>* (*)(GuildInviteContext*, int64_t))(Il2CppBase() + 0x1B2C490))(this, toGuildId);
	}
	 HashSet1GuildInviteEntity*>* GetFromGuildEntities(int64_t fromGuildId) {
		return ((HashSet1GuildInviteEntity*>* (*)(GuildInviteContext*, int64_t))(Il2CppBase() + 0x1B2C550))(this, fromGuildId);
	}
