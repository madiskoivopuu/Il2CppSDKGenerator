...
#include "StoreCategoriesEntity.h" 
...
public: 
	...
	template <typename R = StoreCategoriesEntity*> R GetEntityWithCategoryType(StoreCategory type) {
	 ...
	 HashSet1<StoreCategoriesEntity*>* GetEntitiesForPlayer(int64_t playerId) {
		return ((HashSet1<StoreCategoriesEntity*>* (*)(StoreCategoriesContext*, int64_t))(Il2CppBase() + 0x141BB18))(this, playerId);
	}
