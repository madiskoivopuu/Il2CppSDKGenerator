...
public: 
	...
	template <typename T = float> T AxisDist(int32_t aAxis, Il2CppVector3 a, Il2CppVector3 b) {
		return ((T (*)(TreeSettings*, int32_t, Il2CppVector3, Il2CppVector3))(Il2CppBase() + 0x10C2A48))(this, aAxis, a, b);
	}
