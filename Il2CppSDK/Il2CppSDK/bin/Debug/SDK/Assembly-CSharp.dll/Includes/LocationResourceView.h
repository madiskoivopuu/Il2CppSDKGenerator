...
public: 
	...
	template <typename T = void> T set_ItemRarity(uintptr_t value) {
		return ((T (*)(LocationResourceView*, uintptr_t))(Il2CppBase() + 0x171E7CC))(this, value);
	}
	template <typename T = void> T Init(uintptr_t resource, Il2CppString* resourceIconName, int32_t resourcesCount, uintptr_t tooltip) {
		return ((T (*)(LocationResourceView*, uintptr_t, Il2CppString*, int32_t, uintptr_t))(Il2CppBase() + 0x171E8A0))(this, resource, resourceIconName, resourcesCount, tooltip);
	}
