...
public: 
	...
	template <typename T = void> T SetUserCurrency(int64_t userID, CurrencyType* currency, int32_t newValue) {
		return ((T (*)(IServerTestSystem*, int64_t, CurrencyType*, int32_t))(Il2CppBase() + 0x0))(this, userID, currency, newValue);
	}
	template <typename T = bool> T CheckUserCurrency(int64_t userID, CurrencyType* currency, int32_t checkValue) {
		return ((T (*)(IServerTestSystem*, int64_t, CurrencyType*, int32_t))(Il2CppBase() + 0x0))(this, userID, currency, checkValue);
	}
	template <typename T = void> T TestBuyProductByCoins(int64_t userID, TestProductInfo* product) {
		return ((T (*)(IServerTestSystem*, int64_t, TestProductInfo*))(Il2CppBase() + 0x0))(this, userID, product);
	}
