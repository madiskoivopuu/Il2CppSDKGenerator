...
public: 
	...
	template <typename T = void> T SetUserCurrency(int64_t userID, uintptr_t currency, int32_t newValue) {
		return ((T (*)(EmptyServerTestSystem*, int64_t, uintptr_t, int32_t))(Il2CppBase() + 0x1370300))(this, userID, currency, newValue);
	}
	template <typename T = bool> T CheckUserCurrency(int64_t userID, uintptr_t currency, int32_t checkValue) {
		return ((T (*)(EmptyServerTestSystem*, int64_t, uintptr_t, int32_t))(Il2CppBase() + 0x1370304))(this, userID, currency, checkValue);
	}
	template <typename T = void> T TestBuyProductByCoins(int64_t userID, uintptr_t product) {
		return ((T (*)(EmptyServerTestSystem*, int64_t, uintptr_t))(Il2CppBase() + 0x137030C))(this, userID, product);
	}
