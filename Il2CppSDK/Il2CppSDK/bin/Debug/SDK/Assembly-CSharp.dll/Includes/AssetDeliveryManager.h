...
public: 
	...
	template <typename T = uintptr_t> static T& AssetDeliveryService() {
	...
	template <typename T = uintptr_t> static T get_AssetDeliveryService() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A5975C))(0);
	}
	template <typename T = uintptr_t> static T DownloadAssetBundlePack(Il2CppString* packName, bool isStatic) {
		return ((T (*)(void *, Il2CppString*, bool))(Il2CppBase() + 0x1A59838))(0, packName, isStatic);
	}
	template <typename T = uintptr_t> static T DownloadAssetBundlePacks(Il2CppArray<uintptr_t>* packNames, bool isStatic) {
	...
	template <typename T = uintptr_t> static T GetAssetFromResourcesOrAssetBundle(Il2CppString* assetName, uintptr_t resourcesType) {
		return ((T (*)(void *, Il2CppString*, uintptr_t))(Il2CppBase() + 0x0))(0, assetName, resourcesType);
	}
