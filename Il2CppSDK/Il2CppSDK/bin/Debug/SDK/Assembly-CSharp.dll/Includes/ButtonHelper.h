...
public: 
	...
	template <typename T = void> T add_OnButtonClicked(void* value) {
		return ((T (*)(ButtonHelper*, void*))(Il2CppBase() + 0x15B15D8))(this, value);
	}
	template <typename T = void> T remove_OnButtonClicked(void* value) {
		return ((T (*)(ButtonHelper*, void*))(Il2CppBase() + 0x15B1678))(this, value);
	}
