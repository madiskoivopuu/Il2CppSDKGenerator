...
public: 
	...
	template <typename R = bool> R& IsLocked() {
	 ...
	 Action1<ButtonHelper*>*& OnButtonClicked() {
		return *(Action1<ButtonHelper*>**)((uintptr_t)this + 0x30);
	}
	...
	template <typename R = void> R add_OnButtonClicked(Action1<ButtonHelper*>* value) {
		return ((R (*)(ButtonHelper*, Action1<ButtonHelper*>*))(Il2CppBase() + 0x15B15D8))(this, value);
	}
	template <typename R = void> R remove_OnButtonClicked(Action1<ButtonHelper*>* value) {
		return ((R (*)(ButtonHelper*, Action1<ButtonHelper*>*))(Il2CppBase() + 0x15B1678))(this, value);
	}
