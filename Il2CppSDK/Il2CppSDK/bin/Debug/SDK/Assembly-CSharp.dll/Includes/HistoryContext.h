...
public: 
	...
	template <typename R = float> R& PlayerRecordLifeTime() {
	 ...
	 PrimaryEntityIndex2<HistoryEntity*, int32_t>*& _idIndex() {
		return *(PrimaryEntityIndex2<HistoryEntity*, int32_t>**)((uintptr_t)this + 0x100);
	}
	 PrimaryEntityIndex2<HistoryEntity*, int32_t>*& _actionIndex() {
		return *(PrimaryEntityIndex2<HistoryEntity*, int32_t>**)((uintptr_t)this + 0x108);
	}
	 EntityIndex2<HistoryEntity*, int32_t>*& _targetIndex() {
		return *(EntityIndex2<HistoryEntity*, int32_t>**)((uintptr_t)this + 0x110);
	}
	 PrimaryEntityIndex2<HistoryEntity*, IntLong>*& _damageSumIndex() {
		return *(PrimaryEntityIndex2<HistoryEntity*, IntLong>**)((uintptr_t)this + 0x118);
	}
	 EntityIndex2<HistoryEntity*, int64_t>*& _damageToPlayerIndex() {
		return *(EntityIndex2<HistoryEntity*, int64_t>**)((uintptr_t)this + 0x120);
	}
	 EntityIndex2<HistoryEntity*, int64_t>*& _playerDeathIndex() {
		return *(EntityIndex2<HistoryEntity*, int64_t>**)((uintptr_t)this + 0x128);
	}
	 EntityIndex2<HistoryEntity*, int64_t>*& _healToPlayerIndex() {
		return *(EntityIndex2<HistoryEntity*, int64_t>**)((uintptr_t)this + 0x130);
	}
	 EntityIndex2<HistoryEntity*, int32_t>*& _damageInBattleIndex() {
		return *(EntityIndex2<HistoryEntity*, int32_t>**)((uintptr_t)this + 0x138);
	}
	 EntityIndex2<HistoryEntity*, int32_t>*& _damageToTargetIndex() {
		return *(EntityIndex2<HistoryEntity*, int32_t>**)((uintptr_t)this + 0x140);
	}
	 EntityIndex2<HistoryEntity*, int32_t>*& _healToTargetIndex() {
		return *(EntityIndex2<HistoryEntity*, int32_t>**)((uintptr_t)this + 0x148);
	}
	...
	template <typename R = HistoryEntity*> R GetDamageSumToTarget(int32_t targetId, int64_t actorPlayerId) {
	 ...
	 HashSet1<HistoryEntity*>* GetDamagesToPlayer(int64_t playerId) {
		return ((HashSet1<HistoryEntity*>* (*)(HistoryContext*, int64_t))(Il2CppBase() + 0x1C4B3BC))(this, playerId);
	}
	 HashSet1<HistoryEntity*>* GetPlayerDeath(int64_t playerId) {
		return ((HashSet1<HistoryEntity*>* (*)(HistoryContext*, int64_t))(Il2CppBase() + 0x1C4B420))(this, playerId);
	}
	 HashSet1<HistoryEntity*>* GetHealsToPlayer(int64_t playerId) {
		return ((HashSet1<HistoryEntity*>* (*)(HistoryContext*, int64_t))(Il2CppBase() + 0x1C4B484))(this, playerId);
	}
	 HashSet1<HistoryEntity*>* GetDamagesInBattle(int32_t battleId) {
		return ((HashSet1<HistoryEntity*>* (*)(HistoryContext*, int32_t))(Il2CppBase() + 0x1C4B4E8))(this, battleId);
	}
	 HashSet1<HistoryEntity*>* GetDamagesToTarget(int32_t id) {
		return ((HashSet1<HistoryEntity*>* (*)(HistoryContext*, int32_t))(Il2CppBase() + 0x1C4B54C))(this, id);
	}
	 HashSet1<HistoryEntity*>* GetHealsToTarget(int32_t id) {
		return ((HashSet1<HistoryEntity*>* (*)(HistoryContext*, int32_t))(Il2CppBase() + 0x1C4B5B0))(this, id);
	}
	...
	template <typename R = void> R DestroyAll(HashSet1<HistoryEntity*>* records, Predicate1<HistoryEntity*>* predicate) {
		return ((R (*)(HistoryContext*, HashSet1<HistoryEntity*>*, Predicate1<HistoryEntity*>*))(Il2CppBase() + 0x1C4EC24))(this, records, predicate);
	}
