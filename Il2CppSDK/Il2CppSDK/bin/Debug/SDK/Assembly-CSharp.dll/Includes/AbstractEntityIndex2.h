...
public: 
	...
	template <typename R = Il2CppString*> R& name() {
	 ...
	 Func3<TEntity, uintptr_t, TKey>*& _getKey() {
		return *(Func3<TEntity, uintptr_t, TKey>**)((uintptr_t)this + 0x0);
	}
	 Func3<TEntity, uintptr_t, Il2CppArray<TKey>*>*& _getKeys() {
		return *(Func3<TEntity, uintptr_t, Il2CppArray<TKey>*>**)((uintptr_t)this + 0x0);
	}
	 TryGetKeyDelegate2<TEntity, TKey>*& _tryGetKey() {
		return *(TryGetKeyDelegate2<TEntity, TKey>**)((uintptr_t)this + 0x0);
	}
	 TryGetKeysDelegate2<TEntity, TKey>*& _tryGetKeys() {
		return *(TryGetKeysDelegate2<TEntity, TKey>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = void> R IndexEntities(IGroup1<TEntity>* group) {
		return ((R (*)(AbstractEntityIndex2*, IGroup1<TEntity>*))(Il2CppBase() + 0x0))(this, group);
	}
	template <typename R = void> R OnEntityAdded(IGroup1<TEntity>* group, TEntity entity, int32_t index, uintptr_t component) {
		return ((R (*)(AbstractEntityIndex2*, IGroup1<TEntity>*, TEntity, int32_t, uintptr_t))(Il2CppBase() + 0x0))(this, group, entity, index, component);
	}
