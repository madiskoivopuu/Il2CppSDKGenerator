...
public: 
	...
	template <typename T = PushNotificationGroupName*> T& GroupNameEnum() {
	...
	template <typename T = PushNotificationGroupData*> T Clone() {
		return ((T (*)(PushNotificationGroupData*))(Il2CppBase() + 0x11BAA60))(this);
	}
	template <typename T = void> T Update(PushNotificationGroupData* groupData) {
		return ((T (*)(PushNotificationGroupData*, PushNotificationGroupData*))(Il2CppBase() + 0x11BA7B0))(this, groupData);
	}
