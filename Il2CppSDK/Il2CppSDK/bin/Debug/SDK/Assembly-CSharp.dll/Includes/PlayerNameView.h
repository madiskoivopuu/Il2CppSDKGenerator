...
public: 
	...
	template <typename T = void> T Init(uintptr_t window, int64_t inviteId) {
		return ((T (*)(PlayerNameView*, uintptr_t, int64_t))(Il2CppBase() + 0x156C7A8))(this, window, inviteId);
	}
	template <typename T = void> T Init_1(uintptr_t window, int64_t playerId) {
		return ((T (*)(PlayerNameView*, uintptr_t, int64_t))(Il2CppBase() + 0x156CC08))(this, window, playerId);
	}
