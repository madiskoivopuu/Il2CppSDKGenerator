...
public: 
	...
	template <typename R = int32_t> static R& MAX_RUNE_GRADE() {
	 ...
	 static Il2CppDictionary<int32_t, ValueTuple2int32_t, int32_t>*>*& RuneSlotsAndPriceByGrade() {
		return *(Il2CppDictionary<int32_t, ValueTuple2int32_t, int32_t>*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}

	 static ValueTuple3bool, int32_t, int32_t>* GetRuneInventorySlotsAndPriceByGrade(int32_t grade) {
		return ((ValueTuple3bool, int32_t, int32_t>* (*)(void *, int32_t))(Il2CppBase() + 0x11AA4BC))(0, grade);
	}
	...
	template <typename R = Il2CppString*> static R GetActiveClassRune(AccountEntity* account, PlayerClassType* classType, int32_t index, int64_t now) {
	 ...
	 static ValueTuple2int32_t, int32_t>* GetClassRunesCount(AccountEntity* account, PlayerClassType* classType, int64_t now) {
		return ((ValueTuple2int32_t, int32_t>* (*)(void *, AccountEntity*, PlayerClassType*, int64_t))(Il2CppBase() + 0x11AA74C))(0, account, classType, now);
	}
	...
	template <typename R = Il2CppString*> static R GetMergedRune(ICommonContexts* world, Il2CppString* blueprint) {
	 ...
	 static ValueTuple4bool, Il2CppString*, Il2CppString*, int32_t>* GetRuneInfo(ICommonContexts* world, Il2CppString* runeBlueprint) {
		return ((ValueTuple4bool, Il2CppString*, Il2CppString*, int32_t>* (*)(void *, ICommonContexts*, Il2CppString*))(Il2CppBase() + 0x11AB4F4))(0, world, runeBlueprint);
	}
