...
class GuildApplicationsDialog: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& ApplicationPlayerItemPrefab() {
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _selectedItems() {
	...
	template <typename T = void> T OnPlayerToggleChanged(bool isSelected, uintptr_t playerItem) {
		return ((T (*)(GuildApplicationsDialog*, bool, uintptr_t))(Il2CppBase() + 0x12E4E98))(this, isSelected, playerItem);
	}
