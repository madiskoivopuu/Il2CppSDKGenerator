...
public: 
	...
	template <typename T = uintptr_t> T& AnimatorEffects() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = uintptr_t> T& DestroyHelper() {
	...
	template <typename T = void> T Setup(uintptr_t hideHelper) {
		return ((T (*)(ToolView*, uintptr_t))(Il2CppBase() + 0x14F374C))(this, hideHelper);
	}
