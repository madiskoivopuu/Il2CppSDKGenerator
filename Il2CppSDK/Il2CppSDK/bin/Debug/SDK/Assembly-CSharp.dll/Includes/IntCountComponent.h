...
public: 
	...
	template <typename T = void> T CopyTo(uintptr_t targetObject) {
		return ((T (*)(IntCountComponent*, uintptr_t))(Il2CppBase() + 0x1468F68))(this, targetObject);
	}
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(IntCountComponent*, uintptr_t))(Il2CppBase() + 0x1468FFC))(this, blueprintComponent);
	}
