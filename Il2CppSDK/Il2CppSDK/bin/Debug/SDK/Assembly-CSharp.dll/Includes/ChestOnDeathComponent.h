...
public: 
	...
	template <typename T = uintptr_t> T& AdditionalPersonalDrop() {
		return *(T*)((uintptr_t)this + 0x38);
	}

	template <typename T = void> T CopyTo(uintptr_t targetObject) {
		return ((T (*)(ChestOnDeathComponent*, uintptr_t))(Il2CppBase() + 0x17404D8))(this, targetObject);
	}
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(ChestOnDeathComponent*, uintptr_t))(Il2CppBase() + 0x17405B8))(this, blueprintComponent);
	}
