...
public: 
	...
	template <typename T = uintptr_t> T& DebugSystem() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = uintptr_t> T& Default() {
	...
	template <typename T = uintptr_t> T GetSystem() {
		return ((T (*)(ViewRectSettings*))(Il2CppBase() + 0x15CD59C))(this);
	}
	template <typename T = uintptr_t> T GetViewRect(float acpect) {
