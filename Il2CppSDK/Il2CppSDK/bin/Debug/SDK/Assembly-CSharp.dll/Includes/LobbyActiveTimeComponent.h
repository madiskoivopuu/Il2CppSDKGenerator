...
public: 
	...
	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(LobbyActiveTimeComponent*, Il2CppObject*))(Il2CppBase() + 0x1435FE4))(this, targetObject);
	}
	template <typename T = ValueTuple3bool, int64_t, bool>*> T GetState(ICommonContexts* world) {
		return ((T (*)(LobbyActiveTimeComponent*, ICommonContexts*))(Il2CppBase() + 0x14360D4))(this, world);
	}
