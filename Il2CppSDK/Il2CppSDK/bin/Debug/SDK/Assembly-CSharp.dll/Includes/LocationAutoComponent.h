...
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, Attempt*>*> T& Attempts() {
		return *(T*)((uintptr_t)this + 0x10);
	}

	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(LocationAutoComponent*, Il2CppObject*))(Il2CppBase() + 0x179C5AC))(this, targetObject);
	}
