...
#include "ImageButtonMonoBehaviour" 

class HUDInteractButton: ImageButtonMonoBehaviour
{
public: 
	...
	template <typename T = uintptr_t> T& _previousTarget() {
	...
	template <typename T = void> T Bind(uintptr_t window) {
		return ((T (*)(HUDInteractButton*, uintptr_t))(Il2CppBase() + 0x1456AE8))(this, window);
	}
	...
	template <typename T = void> T UpdateDurabilityIndicator(uintptr_t target) {
		return ((T (*)(HUDInteractButton*, uintptr_t))(Il2CppBase() + 0x1458280))(this, target);
	}
	template <typename T = void> T UpdateMiningDurability(uintptr_t targetData) {
		return ((T (*)(HUDInteractButton*, uintptr_t))(Il2CppBase() + 0x1456FC0))(this, targetData);
	}
	template <typename T = uintptr_t> T OnHoldUpdateDurabilityCoroutine(uintptr_t targetData) {
		return ((T (*)(HUDInteractButton*, uintptr_t))(Il2CppBase() + 0x1458538))(this, targetData);
	}
