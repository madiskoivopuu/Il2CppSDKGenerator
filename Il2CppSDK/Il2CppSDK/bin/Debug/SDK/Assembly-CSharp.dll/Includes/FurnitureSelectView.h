...
public: 
	...
	template <typename T = TextMonoBehaviour*> T& WarningPanel() {
	...
	template <typename T = GameEntity*> T& _selectedEntity() {
	...
	template <typename T = void> T Init(BuilderWindow* builderWindow) {
		return ((T (*)(FurnitureSelectView*, BuilderWindow*))(Il2CppBase() + 0x15FF6A4))(this, builderWindow);
	}
	template <typename T = void> T Show(GameEntity* selectedEntity) {
		return ((T (*)(FurnitureSelectView*, GameEntity*))(Il2CppBase() + 0x15FF6AC))(this, selectedEntity);
	}
