...
public: 
	...
	template <typename R = bool> R& _forceUpdate() {
	 ...
	 Action1IInventoryItem*>*& OnArming() {
		return *(Action1IInventoryItem*>**)((uintptr_t)this + 0xA8);
	}
	...
	template <typename R = void> R add_OnArming(Action1IInventoryItem*>* value) {
		return ((R (*)(MountItem*, Action1IInventoryItem*>*))(Il2CppBase() + 0x1546A84))(this, value);
	}
	template <typename R = void> R remove_OnArming(Action1IInventoryItem*>* value) {
		return ((R (*)(MountItem*, Action1IInventoryItem*>*))(Il2CppBase() + 0x1546B24))(this, value);
	}
	template <typename R = void> R Bind(IMountsInventoryWindow* window, GameEntity* entity, int32_t index, InventorySlot* slot, Action1IInventoryItem*>* onArming) {
		return ((R (*)(MountItem*, IMountsInventoryWindow*, GameEntity*, int32_t, InventorySlot*, Action1IInventoryItem*>*))(Il2CppBase() + 0x1546BC4))(this, window, entity, index, slot, onArming);
	}
