...
public: 
	...
	template <typename T = void> T add_OnArming(void* value) {
		return ((T (*)(MountItem*, void*))(Il2CppBase() + 0x1546A84))(this, value);
	}
	template <typename T = void> T remove_OnArming(void* value) {
		return ((T (*)(MountItem*, void*))(Il2CppBase() + 0x1546B24))(this, value);
	}
	template <typename T = void> T Bind(uintptr_t window, uintptr_t entity, int32_t index, uintptr_t slot, void* onArming) {
		return ((T (*)(MountItem*, uintptr_t, uintptr_t, int32_t, uintptr_t, void*))(Il2CppBase() + 0x1546BC4))(this, window, entity, index, slot, onArming);
	}
	...
	template <typename T = void> T ChangeSlot(uintptr_t slot) {
		return ((T (*)(MountItem*, uintptr_t))(Il2CppBase() + 0x1547D20))(this, slot);
	}
