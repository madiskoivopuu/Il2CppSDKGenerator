...
public: 
	...
	template <typename R = Store2Entity*> R GetEntityWithId(int64_t id) {
	 ...
	 HashSet1<Store2Entity*>* GetEntitiesForPlayer(int64_t playerId) {
		return ((HashSet1<Store2Entity*>* (*)(Store2Context*, int64_t))(Il2CppBase() + 0x1406A48))(this, playerId);
	}
