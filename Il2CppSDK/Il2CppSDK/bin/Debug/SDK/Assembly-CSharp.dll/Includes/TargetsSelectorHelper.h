...
public: 
	...
	template <typename R = int32_t> static R SelectTargets(IArenaWorld* world, TargetsSelector* selector, GameEntity* actor, Il2CppList<GameEntity*>* result, Nullable1<int32_t>* overrideMaxCount) {
		return ((R (*)(void *, IArenaWorld*, TargetsSelector*, GameEntity*, Il2CppList<GameEntity*>*, Nullable1<int32_t>*))(Il2CppBase() + 0x16A6D70))(0, world, selector, actor, result, overrideMaxCount);
	}
	...
	template <typename R = int32_t> static R ProcessTargets(IArenaWorld* world, TargetsSelector* selector, GameEntity* actor, GameEntity* center, float centerRotation, int32_t actorId, IClanGuildEntity* source, ITargetProcessor* processor, Nullable1<int32_t>* overrideMaxCount) {
		return ((R (*)(void *, IArenaWorld*, TargetsSelector*, GameEntity*, GameEntity*, float, int32_t, IClanGuildEntity*, ITargetProcessor*, Nullable1<int32_t>*))(Il2CppBase() + 0x16A6F54))(0, world, selector, actor, center, centerRotation, actorId, source, processor, overrideMaxCount);
	}
