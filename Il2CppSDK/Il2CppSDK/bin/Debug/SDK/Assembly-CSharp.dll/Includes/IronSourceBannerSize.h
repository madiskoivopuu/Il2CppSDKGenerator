...
public: 
	...
	template <typename T = IronSourceBannerSize*> static T& BANNER() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = IronSourceBannerSize*> static T& LARGE() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = IronSourceBannerSize*> static T& RECTANGLE() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = IronSourceBannerSize*> static T& SMART() {
