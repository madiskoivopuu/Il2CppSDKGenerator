...
public: 
	...
	template <typename R = int32_t> R& _skillsCount() {
	 ...
	 Action3<int32_t, int32_t, bool>*& OnSkillClick() {
		return *(Action3<int32_t, int32_t, bool>**)((uintptr_t)this + 0xD8);
	}
	...
	template <typename R = void> R add_OnSkillClick(Action3<int32_t, int32_t, bool>* value) {
		return ((R (*)(TraderSkillItem*, Action3<int32_t, int32_t, bool>*))(Il2CppBase() + 0x151019C))(this, value);
	}
	template <typename R = void> R remove_OnSkillClick(Action3<int32_t, int32_t, bool>* value) {
		return ((R (*)(TraderSkillItem*, Action3<int32_t, int32_t, bool>*))(Il2CppBase() + 0x151023C))(this, value);
	}
	template <typename R = void> R Bind(MountsTraderWindow* window, GameEntity* entity, int32_t slotIndex, int32_t id, Action3<int32_t, int32_t, bool>* onSkillClick) {
		return ((R (*)(TraderSkillItem*, MountsTraderWindow*, GameEntity*, int32_t, int32_t, Action3<int32_t, int32_t, bool>*))(Il2CppBase() + 0x15102DC))(this, window, entity, slotIndex, id, onSkillClick);
	}
	template <typename R = void> R Bind_1(IMountsInventoryWindow* window, GameEntity* entity, int32_t index, InventorySlot* slot, Action1<IInventoryItem*>* onArming) {
		return ((R (*)(TraderSkillItem*, IMountsInventoryWindow*, GameEntity*, int32_t, InventorySlot*, Action1<IInventoryItem*>*))(Il2CppBase() + 0x1510380))(this, window, entity, index, slot, onArming);
	}
