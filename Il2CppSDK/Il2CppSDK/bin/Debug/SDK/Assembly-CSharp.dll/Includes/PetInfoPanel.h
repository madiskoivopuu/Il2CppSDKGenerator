...
public: 
	...
	template <typename T = uintptr_t> T& _petExperience() {
	...
	template <typename T = void> T Show(uintptr_t window, uintptr_t pet) {
		return ((T (*)(PetInfoPanel*, uintptr_t, uintptr_t))(Il2CppBase() + 0x11ECD70))(this, window, pet);
	}
