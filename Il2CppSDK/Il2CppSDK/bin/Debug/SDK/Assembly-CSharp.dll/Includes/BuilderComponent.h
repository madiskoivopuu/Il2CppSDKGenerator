...
public: 
	...
	template <typename T = unsigned char> T& SizeX() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = unsigned char> T& SizeY() {
	...
	template <typename T = uintptr_t> T& BuilderMode() {
	...
	template <typename T = void> T CopyTo(uintptr_t targetObject) {
		return ((T (*)(BuilderComponent*, uintptr_t))(Il2CppBase() + 0x15A7E64))(this, targetObject);
	}
