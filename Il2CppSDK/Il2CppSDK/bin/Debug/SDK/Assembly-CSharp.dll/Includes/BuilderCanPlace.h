...
public: 
	...
	template <typename R = GameEntity*> R& _lastEntity() {
	 ...
	 Nullable1<uint8_t>*& _orientition() {
		return *(Nullable1<uint8_t>**)((uintptr_t)this + 0x38);
	}
	...
	template <typename R = bool> R UpdateCanPlace(GameEntity* ghost, GameDataEntity* buildEntity, BuilderWindow* builderWindow, bool move) {
	 ...
	 static ValueTuple2<int32_t, int32_t>* GetPlacedCount(Il2CppString* blueprint, GameEntity* ghost) {
		return ((ValueTuple2<int32_t, int32_t>* (*)(void *, Il2CppString*, GameEntity*))(Il2CppBase() + 0x15A5844))(0, blueprint, ghost);
	}
