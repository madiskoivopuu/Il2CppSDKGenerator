...
class SeasonDataContext: DataContext1
{
public: 
	...
	template <typename T = uintptr_t> T GetEntityWithOrder(int32_t order) {
	...
	template <typename T = void> T Fill(Il2CppDictionary<Il2CppString*, uintptr_t>* blueprints) {
		return ((T (*)(SeasonDataContext*, Il2CppDictionary<Il2CppString*, uintptr_t>*))(Il2CppBase() + 0x135DCCC))(this, blueprints);
	}
