...
public: 
	...
	template <typename T = Il2CppDictionary<Il2CppString*, HashSet1uintptr_t>*>*> T& _index() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	...
	template <typename T = HashSet1uintptr_t>*> T GetEntities(Il2CppString* dataName) {
	...
	template <typename T = void> T OnEntityAdded(IGroup1uintptr_t>* group, uintptr_t entity, int32_t index, uintptr_t component) {
		return ((T (*)(DataEntityIndex2*, IGroup1uintptr_t>*, uintptr_t, int32_t, uintptr_t))(Il2CppBase() + 0x0))(this, group, entity, index, component);
	}
