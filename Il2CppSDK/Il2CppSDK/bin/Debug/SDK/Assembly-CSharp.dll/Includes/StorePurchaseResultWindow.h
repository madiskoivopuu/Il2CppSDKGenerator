...
class StorePurchaseResultWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& ContentItemPrefab() {
	...
	template <typename T = Il2CppList<uintptr_t>*> static T OnShowg__getUnlockedCurrenciesForSavingsPack|17_2(uintptr_t ) {
