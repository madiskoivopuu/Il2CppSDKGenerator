...
public: 
	...
	template <typename R = void> R AddActivationState(Nullable1int64_t>* newTime) {
		return ((R (*)(MagicEntity*, Nullable1int64_t>*))(Il2CppBase() + 0x1ACF510))(this, newTime);
	}
	template <typename R = void> R ReplaceActivationState(Nullable1int64_t>* newTime) {
		return ((R (*)(MagicEntity*, Nullable1int64_t>*))(Il2CppBase() + 0x1ACF618))(this, newTime);
	}
