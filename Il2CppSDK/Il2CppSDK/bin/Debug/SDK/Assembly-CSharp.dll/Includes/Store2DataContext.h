...
public: 
	...
	template <typename R = Store2DataEntity*> R GetEntityWithBlueprint(Il2CppString* blueprintName) {
	 ...
	 HashSet1<Store2DataEntity*>* GetEntitiesWithSavingsPackType(SavingsPackType type) {
		return ((HashSet1<Store2DataEntity*>* (*)(Store2DataContext*, SavingsPackType))(Il2CppBase() + 0x1409E58))(this, type);
	}
