...
public: 
	...
	template <typename T = void> T Show(uintptr_t classEntity, uintptr_t tooltipView) {
		return ((T (*)(ClassInfoBase*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1599C64))(this, classEntity, tooltipView);
	}
