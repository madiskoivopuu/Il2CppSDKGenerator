...
public: 
	...
	template <typename T = uintptr_t> T& AutoAttempts() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = uintptr_t> T& Cooldown() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = uintptr_t> T& AutoName() {
	...
	template <typename T = void> T Bind(uintptr_t window, Il2CppString* pointName) {
		return ((T (*)(AutoFarmView*, uintptr_t, Il2CppString*))(Il2CppBase() + 0x1A62DF8))(this, window, pointName);
	}
