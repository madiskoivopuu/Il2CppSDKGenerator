...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 PrimaryEntityIndex2<LocationEntity*, int32_t>*& _idIndex() {
		return *(PrimaryEntityIndex2<LocationEntity*, int32_t>**)((uintptr_t)this + 0xF8);
	}
	 EntityIndex2<LocationEntity*, Il2CppString*>*& _pointIndex() {
		return *(EntityIndex2<LocationEntity*, Il2CppString*>**)((uintptr_t)this + 0x100);
	}
	...
	template <typename R = LocationEntity*> R GetEntityWithId(int32_t id) {
	 ...
	 HashSet1<LocationEntity*>* GetEntitiesWithPoint(Il2CppString* pointName) {
		return ((HashSet1<LocationEntity*>* (*)(LocationContext*, Il2CppString*))(Il2CppBase() + 0x17A02FC))(this, pointName);
	}
