...
public: 
	...
	template <typename T = PvPStateComponent*> T get_pvPState() {
	...
	template <typename T = void> T AddPvPState(PvPState* newType) {
		return ((T (*)(PvPEntity*, PvPState*))(Il2CppBase() + 0x11BD854))(this, newType);
	}
	template <typename T = void> T ReplacePvPState(PvPState* newType) {
		return ((T (*)(PvPEntity*, PvPState*))(Il2CppBase() + 0x11BD958))(this, newType);
	}
	template <typename T = void> T RemovePvPState() {
		return ((T (*)(PvPEntity*))(Il2CppBase() + 0x11BDA5C))(this);
	}
	template <typename T = SearchDurationComponent*> T get_searchDuration() {
