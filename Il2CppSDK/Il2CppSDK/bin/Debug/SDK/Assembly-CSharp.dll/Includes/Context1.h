...
public: 
	...
	template <typename R = Il2CppArray<Stack1<uintptr_t>*>*> R& _componentPools() {
		return *(R*)((uintptr_t)this + 0x0);
	}
	template <typename R = uintptr_t> R& _contextInfo() {
		return *(R*)((uintptr_t)this + 0x0);
	}
	 Func2<uintptr_t, uintptr_t>*& _aercFactory() {
		return *(Func2<uintptr_t, uintptr_t>**)((uintptr_t)this + 0x0);
	}
	 Func1<TEntity>*& _entityFactory() {
		return *(Func1<TEntity>**)((uintptr_t)this + 0x0);
	}
	 HashSet1<TEntity>*& _entities() {
		return *(HashSet1<TEntity>**)((uintptr_t)this + 0x0);
	}
	 Stack1<TEntity>*& _reusableEntities() {
		return *(Stack1<TEntity>**)((uintptr_t)this + 0x0);
	}
	 HashSet1<TEntity>*& _retainedEntities() {
		return *(HashSet1<TEntity>**)((uintptr_t)this + 0x0);
	}
	 Il2CppDictionary<IMatcher1<TEntity>*, IGroup1<TEntity>*>*& _groups() {
		return *(Il2CppDictionary<IMatcher1<TEntity>*, IGroup1<TEntity>*>**)((uintptr_t)this + 0x0);
	}
	 Il2CppArray<Il2CppList<IGroup1<TEntity>*>*>*& _groupsForIndex() {
		return *(Il2CppArray<Il2CppList<IGroup1<TEntity>*>*>**)((uintptr_t)this + 0x0);
	}
	 ObjectPool1<Il2CppList<GroupChanged1<TEntity>*>*>*& _groupChangedListPool() {
		return *(ObjectPool1<Il2CppList<GroupChanged1<TEntity>*>*>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = Il2CppArray<Stack1<uintptr_t>*>*> R get_componentPools() {
		return ((R (*)(Context1*))(Il2CppBase() + 0x0))(this);
	}
	...
	template <typename R = int32_t> R get_retainedEntitiesCount() {
	 ...
	 IReadOnlyDictionary2<Il2CppString*, uintptr_t>* get_EntityIndices() {
		return ((IReadOnlyDictionary2<Il2CppString*, uintptr_t>* (*)(Context1*))(Il2CppBase() + 0x0))(this);
	}
	...
	template <typename R = bool> R HasEntity(TEntity entity) {
	 ...
	 IGroup1<TEntity>* GetGroup(IMatcher1<TEntity>* matcher) {
		return ((IGroup1<TEntity>* (*)(Context1*, IMatcher1<TEntity>*))(Il2CppBase() + 0x0))(this, matcher);
	}
