...
public: 
	...
	template <typename T = Func2uintptr_t, uintptr_t>*> T& _aercFactory() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = Func1uintptr_t>*> T& _entityFactory() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = HashSet1uintptr_t>*> T& _entities() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = Stack1uintptr_t>*> T& _reusableEntities() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = HashSet1uintptr_t>*> T& _retainedEntities() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = Il2CppDictionary<IMatcher1uintptr_t>*, IGroup1uintptr_t>*>*> T& _groups() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = Il2CppArray<uintptr_t>*> T& _groupsForIndex() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = ObjectPool1Il2CppList<GroupChanged1uintptr_t>*>*>*> T& _groupChangedListPool() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	...
	template <typename T = IReadOnlyDictionary2Il2CppString*, uintptr_t>*> T get_EntityIndices() {
		return ((T (*)(Context1*))(Il2CppBase() + 0x0))(this);
	}
	...
	template <typename T = IGroup1uintptr_t>*> T GetGroup(IMatcher1uintptr_t>* matcher) {
		return ((T (*)(Context1*, IMatcher1uintptr_t>*))(Il2CppBase() + 0x0))(this, matcher);
	}
