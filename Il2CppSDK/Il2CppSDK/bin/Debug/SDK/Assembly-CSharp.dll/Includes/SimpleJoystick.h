...
public: 
	...
	template <typename R = uintptr_t> R& _oldPosition() {
	 ...
	 Nullable1int32_t>*& FingerId() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0xB8);
	}
	...
	template <typename R = void> R Reset() {
	 ...
	 Nullable1int32_t>* get_FingerId() {
		return ((Nullable1int32_t>* (*)(SimpleJoystick*))(Il2CppBase() + 0x1480408))(this);
	}
	template <typename R = void> R set_FingerId(Nullable1int32_t>* value) {
		return ((R (*)(SimpleJoystick*, Nullable1int32_t>*))(Il2CppBase() + 0x1480410))(this, value);
	}
