...
public: 
	...
	template <typename T = uintptr_t> T& _initialStickPosition() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = uintptr_t> T& _intermediateStickPosition() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = uintptr_t> T& _initialBasePosition() {
	...
	template <typename T = VirtualAxis*> T& HorizintalAxis() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = VirtualAxis*> T& VerticalAxis() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = uintptr_t> T& _oldPosition() {
		return *(T*)((uintptr_t)this + 0xB0);
	}
	template <typename T = Nullable1int32_t>*> T& FingerId() {
	...
	template <typename T = Nullable1int32_t>*> T get_FingerId() {
		return ((T (*)(SimpleJoystick*))(Il2CppBase() + 0x1480408))(this);
	}
	template <typename T = void> T set_FingerId(Nullable1int32_t>* value) {
		return ((T (*)(SimpleJoystick*, Nullable1int32_t>*))(Il2CppBase() + 0x1480410))(this, value);
	}
