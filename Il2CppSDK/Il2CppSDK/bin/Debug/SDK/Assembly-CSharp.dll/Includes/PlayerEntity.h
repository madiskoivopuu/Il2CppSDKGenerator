...
public: 
	...
	template <typename T = OnlineComponent*> static T& onlineComponent() {
	...
	template <typename T = void> T AddCell(uint8_t newId) {
		return ((T (*)(PlayerEntity*, uint8_t))(Il2CppBase() + 0x15644CC))(this, newId);
	}
	template <typename T = void> T ReplaceCell(uint8_t newId) {
		return ((T (*)(PlayerEntity*, uint8_t))(Il2CppBase() + 0x15645D0))(this, newId);
	}
	...
	template <typename T = DailyTournamentsComponent*> T get_dailyTournaments() {
	...
	template <typename T = GlobalTournamentPointsComponent*> T get_globalTournamentPoints() {
	...
	template <typename T = void> T AddGuildRole(GuildRole* newType) {
		return ((T (*)(PlayerEntity*, GuildRole*))(Il2CppBase() + 0x1565BB4))(this, newType);
	}
	template <typename T = void> T ReplaceGuildRole(GuildRole* newType) {
		return ((T (*)(PlayerEntity*, GuildRole*))(Il2CppBase() + 0x1565CB8))(this, newType);
	}
	...
	template <typename T = LastLoginComponent*> T get_lastLogin() {
	...
	template <typename T = WeeklyGuildPointsComponent*> T get_weeklyGuildPoints() {
