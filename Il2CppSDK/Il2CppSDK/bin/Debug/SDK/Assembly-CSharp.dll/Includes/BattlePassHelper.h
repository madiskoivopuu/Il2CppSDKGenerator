...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static ValueTuple2<int64_t, int64_t>* GetBattlePassTimers(ICommonContexts* world, BattlePassEntity* battlePass) {
		return ((ValueTuple2<int64_t, int64_t>* (*)(void *, ICommonContexts*, BattlePassEntity*))(Il2CppBase() + 0x1677D60))(0, world, battlePass);
	}
	 static ValueTuple3<bool, bool, int32_t>* GetBattlePassLimit(ICommonContexts* world, CurrencyType currencyType) {
		return ((ValueTuple3<bool, bool, int32_t>* (*)(void *, ICommonContexts*, CurrencyType))(Il2CppBase() + 0x167803C))(0, world, currencyType);
	}
	...
	template <typename R = Il2CppString*> static R GetBpAnalyticsEventName(ICommonContexts* world, CurrencyType currencyType) {
	 ...
	 static ValueTuple2<int32_t, int32_t>* GetBattlePassMinMaxSteps(ICommonContexts* world, CurrencyType currencyType) {
		return ((ValueTuple2<int32_t, int32_t>* (*)(void *, ICommonContexts*, CurrencyType))(Il2CppBase() + 0x1678E5C))(0, world, currencyType);
	}
