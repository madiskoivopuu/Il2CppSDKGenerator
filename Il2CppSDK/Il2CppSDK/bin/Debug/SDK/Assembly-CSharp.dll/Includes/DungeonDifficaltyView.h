...
public: 
	...
	template <typename R = int32_t> R& _modIndex() {
	 ...
	 Action1<int32_t>*& _onClick() {
		return *(Action1<int32_t>**)((uintptr_t)this + 0xB0);
	}
	...
	template <typename R = void> R Bind(UIWindow* window, GameEntity* target, Difficulty difficulty, int32_t initialInventoryIndex, int32_t modIndex, Action1<int32_t>* onClick) {
		return ((R (*)(DungeonDifficaltyView*, UIWindow*, GameEntity*, Difficulty, int32_t, int32_t, Action1<int32_t>*))(Il2CppBase() + 0x1306AB0))(this, window, target, difficulty, initialInventoryIndex, modIndex, onClick);
	}
