...
public: 
	...
	template <typename T = RewardResourceView*> T& MagicItem() {
	...
	template <typename T = Action1int32_t>*> T& _onClick() {
	...
	template <typename T = void> T Bind(UIWindow* window, GameEntity* target, Difficulty* difficulty, int32_t initialInventoryIndex, int32_t modIndex, Action1int32_t>* onClick) {
		return ((T (*)(DungeonDifficaltyView*, UIWindow*, GameEntity*, Difficulty*, int32_t, int32_t, Action1int32_t>*))(Il2CppBase() + 0x1306AB0))(this, window, target, difficulty, initialInventoryIndex, modIndex, onClick);
	}
	...
	template <typename T = void> T SetMagic(ArenaUnityWorld* world) {
		return ((T (*)(DungeonDifficaltyView*, ArenaUnityWorld*))(Il2CppBase() + 0x1307148))(this, world);
	}
