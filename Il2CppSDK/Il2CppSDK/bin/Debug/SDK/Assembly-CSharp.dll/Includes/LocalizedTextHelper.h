...
public: 
	...
	template <typename R = void> static R SetLocalizedFunc(uintptr_t text, Func1Il2CppString*>* func) {
		return ((R (*)(void *, uintptr_t, Func1Il2CppString*>*))(Il2CppBase() + 0x179B9AC))(0, text, func);
	}
	template <typename R = void> static R SetLocalizedTime(uintptr_t text, Nullable1Time*>* time, Il2CppString* key) {
		return ((R (*)(void *, uintptr_t, Nullable1Time*>*, Il2CppString*))(Il2CppBase() + 0x179BB34))(0, text, time, key);
	}
