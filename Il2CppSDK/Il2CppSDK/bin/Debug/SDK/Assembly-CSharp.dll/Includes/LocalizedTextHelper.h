...
public: 
	...
	template <typename T = void> static T SetLocalizedFunc(uintptr_t text, Func1Il2CppString*>* func) {
		return ((T (*)(void *, uintptr_t, Func1Il2CppString*>*))(Il2CppBase() + 0x179B9AC))(0, text, func);
	}
	template <typename T = void> static T SetLocalizedTime(uintptr_t text, Nullable1Time*>* time, Il2CppString* key) {
		return ((T (*)(void *, uintptr_t, Nullable1Time*>*, Il2CppString*))(Il2CppBase() + 0x179BB34))(0, text, time, key);
	}
