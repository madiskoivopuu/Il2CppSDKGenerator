...
class UIWindowsLayerType
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "UIWindowsLayerType"));
	}
	...
	template <typename T = uintptr_t> static T& HUDNotifications() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& MapEvents() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = uintptr_t> static T& Modal() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& Notifications() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& ModalOverNotifications() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& Cutscene() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = uintptr_t> static T& TopModal() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& Await() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& AdvancedCheats() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
