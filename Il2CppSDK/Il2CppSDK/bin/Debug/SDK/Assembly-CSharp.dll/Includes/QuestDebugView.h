...
public: 
	...
	template <typename T = void> T UpdateView(QuestEntity* questEntity) {
		return ((T (*)(QuestDebugView*, QuestEntity*))(Il2CppBase() + 0x1C317CC))(this, questEntity);
	}
	template <typename T = Il2CppString*> T GetStatus(QuestEntity* questEntity) {
		return ((T (*)(QuestDebugView*, QuestEntity*))(Il2CppBase() + 0x1C31CBC))(this, questEntity);
	}
