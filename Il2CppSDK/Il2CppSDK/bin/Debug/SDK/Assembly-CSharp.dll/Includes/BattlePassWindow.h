...
public: 
	...
	template <typename T = BattlePassItem*> T& _bpItemPrefab() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = Il2CppList<BattlePassItem*>*> T& _bpItems() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = BattlePassInfinityItem*> T& _bpInfinityItem() {
	...
	template <typename T = HUDStorePanelUniversal*> T& _storePanel() {
		return *(T*)((uintptr_t)this + 0x140);
	}
	template <typename T = BattlePassProgress*> T& _progressBar() {
		return *(T*)((uintptr_t)this + 0x148);
	}
	template <typename T = BattlePassNextPrizeItem*> T& _bpBestItemPrefab() {
	...
	template <typename T = BattlePassWindowState*> T& State() {
	...
	template <typename T = BattlePassWindowState*> T get_State() {
		return ((T (*)(BattlePassWindow*))(Il2CppBase() + 0x167D328))(this);
	}
	template <typename T = void> T set_State(BattlePassWindowState* value) {
		return ((T (*)(BattlePassWindow*, BattlePassWindowState*))(Il2CppBase() + 0x167D330))(this, value);
	}
	...
	template <typename T = void> T InitItems(AccountEntity* account) {
		return ((T (*)(BattlePassWindow*, AccountEntity*))(Il2CppBase() + 0x167F400))(this, account);
	}
	template <typename T = void> T UpdateBestItemsPositions(uintptr_t value) {
		return ((T (*)(BattlePassWindow*, uintptr_t))(Il2CppBase() + 0x1680590))(this, value);
	}
	template <typename T = void> T UpdateManualBP(AccountEntity* account) {
		return ((T (*)(BattlePassWindow*, AccountEntity*))(Il2CppBase() + 0x1680794))(this, account);
	}
	template <typename T = void> T AddBestResources(BattlePassItem* bpItem, ItemEntity* entity) {
		return ((T (*)(BattlePassWindow*, BattlePassItem*, ItemEntity*))(Il2CppBase() + 0x16801B8))(this, bpItem, entity);
	}
	...
	template <typename T = bool> T CheckPremium(AccountEntity* account, bool isInit) {
		return ((T (*)(BattlePassWindow*, AccountEntity*, bool))(Il2CppBase() + 0x16816D0))(this, account, isInit);
	}
	template <typename T = void> T UpdateStatePrioritized() {
		return ((T (*)(BattlePassWindow*))(Il2CppBase() + 0x1681CD0))(this);
	}
	template <typename T = bool> T CheckLevel(AccountEntity* account) {
		return ((T (*)(BattlePassWindow*, AccountEntity*))(Il2CppBase() + 0x1681ECC))(this, account);
	}
	template <typename T = bool> T CheckProgress(AccountEntity* account) {
		return ((T (*)(BattlePassWindow*, AccountEntity*))(Il2CppBase() + 0x168211C))(this, account);
	}
	...
	template <typename T = bool> T CheckClaimedSteps(AccountEntity* account) {
		return ((T (*)(BattlePassWindow*, AccountEntity*))(Il2CppBase() + 0x16831D8))(this, account);
	}
	template <typename T = bool> T CalculateRewardsCount(AccountEntity* account) {
		return ((T (*)(BattlePassWindow*, AccountEntity*))(Il2CppBase() + 0x1683270))(this, account);
	}
