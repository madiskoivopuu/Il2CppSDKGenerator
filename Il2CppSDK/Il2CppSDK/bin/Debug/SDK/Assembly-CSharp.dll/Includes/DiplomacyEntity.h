...
public: 
	...
	template <typename T = uintptr_t> static T& acceptedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& discardedComponent() {
	...
	template <typename T = uintptr_t> T get_diplomacy() {
