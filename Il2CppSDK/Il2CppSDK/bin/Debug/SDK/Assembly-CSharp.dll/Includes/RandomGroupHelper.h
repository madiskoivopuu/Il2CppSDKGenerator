...
public: 
	...
	template <typename R = Il2CppString*> static R GetItem(ICommonContexts* world, Il2CppString* randomGroupName, GameEntity* target, AccountEntity* targetAccount, GameEntity* source, Predicate1<RGItem*>* condition, bool use) {
		return ((R (*)(void *, ICommonContexts*, Il2CppString*, GameEntity*, AccountEntity*, GameEntity*, Predicate1<RGItem*>*, bool))(Il2CppBase() + 0x1715C64))(0, world, randomGroupName, target, targetAccount, source, condition, use);
	}
