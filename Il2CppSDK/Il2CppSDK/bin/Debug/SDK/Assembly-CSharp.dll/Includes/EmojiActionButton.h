...
public: 
	...
	template <typename T = Action1EmojiActionButton*>*> T& SelectedEvent() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = Action1EmojiActionButton*>*> T& DeselectedEvent() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = Action1EmojiActionButton*>*> T& ClickEvent() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = Action2EmojiActionButton*, EmojiSlotElement*>*> T& SlotChangedEvent() {
	...
	template <typename T = LocalizedText*> T& _localizedText() {
	...
	template <typename T = UIWindow*> T& _uiWindow() {
	...
	template <typename T = EmojiSlotElement*> T& _currentSlot() {
	...
	template <typename T = void> T add_SelectedEvent(Action1EmojiActionButton*>* value) {
		return ((T (*)(EmojiActionButton*, Action1EmojiActionButton*>*))(Il2CppBase() + 0x136AD74))(this, value);
	}
	template <typename T = void> T remove_SelectedEvent(Action1EmojiActionButton*>* value) {
		return ((T (*)(EmojiActionButton*, Action1EmojiActionButton*>*))(Il2CppBase() + 0x136AE14))(this, value);
	}
	template <typename T = void> T add_DeselectedEvent(Action1EmojiActionButton*>* value) {
		return ((T (*)(EmojiActionButton*, Action1EmojiActionButton*>*))(Il2CppBase() + 0x136AEB4))(this, value);
	}
	template <typename T = void> T remove_DeselectedEvent(Action1EmojiActionButton*>* value) {
		return ((T (*)(EmojiActionButton*, Action1EmojiActionButton*>*))(Il2CppBase() + 0x136AF54))(this, value);
	}
	template <typename T = void> T add_ClickEvent(Action1EmojiActionButton*>* value) {
		return ((T (*)(EmojiActionButton*, Action1EmojiActionButton*>*))(Il2CppBase() + 0x136AFF4))(this, value);
	}
	template <typename T = void> T remove_ClickEvent(Action1EmojiActionButton*>* value) {
		return ((T (*)(EmojiActionButton*, Action1EmojiActionButton*>*))(Il2CppBase() + 0x136B094))(this, value);
	}
	template <typename T = void> T add_SlotChangedEvent(Action2EmojiActionButton*, EmojiSlotElement*>* value) {
		return ((T (*)(EmojiActionButton*, Action2EmojiActionButton*, EmojiSlotElement*>*))(Il2CppBase() + 0x136B134))(this, value);
	}
	template <typename T = void> T remove_SlotChangedEvent(Action2EmojiActionButton*, EmojiSlotElement*>* value) {
		return ((T (*)(EmojiActionButton*, Action2EmojiActionButton*, EmojiSlotElement*>*))(Il2CppBase() + 0x136B1D4))(this, value);
	}
	...
	template <typename T = void> T set_TooltipView(TooltipView* value) {
		return ((T (*)(EmojiActionButton*, TooltipView*))(Il2CppBase() + 0x136B28C))(this, value);
	}
	...
	template <typename T = void> T RaiseSlotChanging(EmojiSlotElement* emojiSlotElement, bool withEvent) {
		return ((T (*)(EmojiActionButton*, EmojiSlotElement*, bool))(Il2CppBase() + 0x136C83C))(this, emojiSlotElement, withEvent);
	}
