...
public: 
	...
	template <typename T = Nullable1float>*> T& MinDurability() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = Nullable1float>*> T& MaxDurability() {
		return *(T*)((uintptr_t)this + 0x58);
	}

	template <typename T = bool> T IsValid(ICommonContexts* world, AccountEntity* account, GameEntity* avatar, GameEntity* source) {
		return ((T (*)(RGItem*, ICommonContexts*, AccountEntity*, GameEntity*, GameEntity*))(Il2CppBase() + 0x10BF2E8))(this, world, account, avatar, source);
	}
