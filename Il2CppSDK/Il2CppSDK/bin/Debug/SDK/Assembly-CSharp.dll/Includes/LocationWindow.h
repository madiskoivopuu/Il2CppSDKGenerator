...
public: 
	...
	template <typename R = void> R ShowClassicLocationInfo(GameEntity* point, HashSet1LocationEntity*>* locations) {
		return ((R (*)(LocationWindow*, GameEntity*, HashSet1LocationEntity*>*))(Il2CppBase() + 0x1721800))(this, point, locations);
	}
	 static ValueTuple5bool, bool, bool, Il2CppString*, bool>* CheckMoveEnter(GameEntity* point, GameEntity* avatar, bool hasDummy) {
		return ((ValueTuple5bool, bool, bool, Il2CppString*, bool>* (*)(void *, GameEntity*, GameEntity*, bool))(Il2CppBase() + 0x17232D8))(0, point, avatar, hasDummy);
	}
	template <typename R = void> R ShowPointInfo(GameEntity* point, HashSet1LocationEntity*>* locations) {
		return ((R (*)(LocationWindow*, GameEntity*, HashSet1LocationEntity*>*))(Il2CppBase() + 0x171FC50))(this, point, locations);
	}
	...
	template <typename R = void> R UpdateTimer(GameEntity* point, HashSet1LocationEntity*>* locations) {
		return ((R (*)(LocationWindow*, GameEntity*, HashSet1LocationEntity*>*))(Il2CppBase() + 0x172448C))(this, point, locations);
	}
