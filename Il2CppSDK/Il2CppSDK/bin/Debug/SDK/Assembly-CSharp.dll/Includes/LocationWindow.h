...
class LocationWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& AutoFarmView() {
	...
	template <typename T = uintptr_t> T& CantTravelPanel() {
	...
	template <typename T = uintptr_t> T& CantEnterPanel() {
		return *(T*)((uintptr_t)this + 0x168);
	}
	template <typename T = uintptr_t> T& NeedQuests() {
	...
	template <typename T = uintptr_t> T& LocationResourceViewPrefab() {
		return *(T*)((uintptr_t)this + 0x1B0);
	}
	template <typename T = uintptr_t> T& _tooltipViewPrefab() {
	...
	template <typename T = void> T ShowClassicLocationInfo(uintptr_t point, void* locations) {
		return ((T (*)(LocationWindow*, uintptr_t, void*))(Il2CppBase() + 0x1721800))(this, point, locations);
	}
	template <typename T = void*> static T CheckMoveEnter(uintptr_t point, uintptr_t avatar, bool hasDummy) {
		return ((T (*)(void *, uintptr_t, uintptr_t, bool))(Il2CppBase() + 0x17232D8))(0, point, avatar, hasDummy);
	}
	template <typename T = void> T ShowPointInfo(uintptr_t point, void* locations) {
		return ((T (*)(LocationWindow*, uintptr_t, void*))(Il2CppBase() + 0x171FC50))(this, point, locations);
	}
	...
	template <typename T = void> T OnClickHoldedHandler(uintptr_t item, float duration) {
		return ((T (*)(LocationWindow*, uintptr_t, float))(Il2CppBase() + 0x1724A80))(this, item, duration);
	}
	...
	template <typename T = void> T UpdateActionButtons(uintptr_t point) {
		return ((T (*)(LocationWindow*, uintptr_t))(Il2CppBase() + 0x1722644))(this, point);
	}
	...
	template <typename T = void> T UpdateTimer(uintptr_t point, void* locations) {
		return ((T (*)(LocationWindow*, uintptr_t, void*))(Il2CppBase() + 0x172448C))(this, point, locations);
	}
