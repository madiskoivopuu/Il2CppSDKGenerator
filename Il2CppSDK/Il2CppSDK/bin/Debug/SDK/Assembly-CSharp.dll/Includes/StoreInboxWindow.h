...
class StoreInboxWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& DVInboxScroll() {
	...
	template <typename T = uintptr_t> T& SortToggle() {
		return *(T*)((uintptr_t)this + 0xF0);
	}
	template <typename T = uintptr_t> T& _currentMailFilter() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = uintptr_t> static T& Data() {
	...
	template <typename T = void> T OnFilterValueChanged(uintptr_t filter, bool isOn) {
		return ((T (*)(StoreInboxWindow*, uintptr_t, bool))(Il2CppBase() + 0x1425754))(this, filter, isOn);
	}
	...
	template <typename T = void> T OnStoreInboxItemClicked(int64_t messageId, void* onError) {
		return ((T (*)(StoreInboxWindow*, int64_t, void*))(Il2CppBase() + 0x1426248))(this, messageId, onError);
	}
	...
	template <typename T = bool> T GetFilteredMailEntitiesg__isNotFiltered|33_7(uintptr_t e) {
		return ((T (*)(StoreInboxWindow*, uintptr_t))(Il2CppBase() + 0x1427310))(this, e);
	}
	template <typename T = void*> T OnCategoryClickb__34_0(uintptr_t e, int32_t i) {
		return ((T (*)(StoreInboxWindow*, uintptr_t, int32_t))(Il2CppBase() + 0x1427904))(this, e, i);
	}
