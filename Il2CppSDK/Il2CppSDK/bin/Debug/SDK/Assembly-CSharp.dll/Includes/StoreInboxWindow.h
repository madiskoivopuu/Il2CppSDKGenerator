...
public: 
	...
	template <typename R = void> R OnStoreInboxItemClicked(int64_t messageId, Action1Il2CppString*>* onError) {
		return ((R (*)(StoreInboxWindow*, int64_t, Action1Il2CppString*>*))(Il2CppBase() + 0x1426248))(this, messageId, onError);
	}
	...
	template <typename R = bool> R GetFilteredMailEntitiesg__isNotFiltered|33_7(MailEntity* e) {
	 ...
	 KeyValuePair2int32_t, MessageData*>* OnCategoryClickb__34_0(MailEntity* e, int32_t i) {
		return ((KeyValuePair2int32_t, MessageData*>* (*)(StoreInboxWindow*, MailEntity*, int32_t))(Il2CppBase() + 0x1427904))(this, e, i);
	}
