...
public: 
	...
	template <typename R = void> R AddDynamicGrade(DynamicGradeType newType, int32_t newOffset, Nullable1<int32_t>* newMax) {
		return ((R (*)(LocationEntity*, DynamicGradeType, int32_t, Nullable1<int32_t>*))(Il2CppBase() + 0x17A92F0))(this, newType, newOffset, newMax);
	}
	template <typename R = void> R ReplaceDynamicGrade(DynamicGradeType newType, int32_t newOffset, Nullable1<int32_t>* newMax) {
		return ((R (*)(LocationEntity*, DynamicGradeType, int32_t, Nullable1<int32_t>*))(Il2CppBase() + 0x17A9408))(this, newType, newOffset, newMax);
	}
	...
	template <typename R = void> R AddLocationMode(LocationMode newType, Il2CppString* newCaption, Il2CppString* newDescription, Il2CppString* newIcon, Nullable1<int32_t>* newDifficultyIndex, Nullable1<int32_t>* newLootIndex, Il2CppString* newPvPName) {
		return ((R (*)(LocationEntity*, LocationMode, Il2CppString*, Il2CppString*, Il2CppString*, Nullable1<int32_t>*, Nullable1<int32_t>*, Il2CppString*))(Il2CppBase() + 0x17ABC24))(this, newType, newCaption, newDescription, newIcon, newDifficultyIndex, newLootIndex, newPvPName);
	}
	template <typename R = void> R ReplaceLocationMode(LocationMode newType, Il2CppString* newCaption, Il2CppString* newDescription, Il2CppString* newIcon, Nullable1<int32_t>* newDifficultyIndex, Nullable1<int32_t>* newLootIndex, Il2CppString* newPvPName) {
		return ((R (*)(LocationEntity*, LocationMode, Il2CppString*, Il2CppString*, Il2CppString*, Nullable1<int32_t>*, Nullable1<int32_t>*, Il2CppString*))(Il2CppBase() + 0x17ABDA0))(this, newType, newCaption, newDescription, newIcon, newDifficultyIndex, newLootIndex, newPvPName);
	}
	...
	template <typename R = void> R AddLocationRules(StatusNameShow newStatusNameShow, bool newKillOnTimeout, Il2CppString* newKillOnTimeoutCondition, Nullable1<float>* newArmorDurabilityDecreaseCoef, Nullable1<float>* newWeaponDurabilityDecreaseCoef, Nullable1<float>* newOnDeathDurabilityDecreaseCoef, bool newPersonalCorpse, bool newRespawnOnArena, SpawnTypes newSpawnType, bool newShowChangeHealthOnlyForPlayer) {
		return ((R (*)(LocationEntity*, StatusNameShow, bool, Il2CppString*, Nullable1<float>*, Nullable1<float>*, Nullable1<float>*, bool, bool, SpawnTypes, bool))(Il2CppBase() + 0x17ABFBC))(this, newStatusNameShow, newKillOnTimeout, newKillOnTimeoutCondition, newArmorDurabilityDecreaseCoef, newWeaponDurabilityDecreaseCoef, newOnDeathDurabilityDecreaseCoef, newPersonalCorpse, newRespawnOnArena, newSpawnType, newShowChangeHealthOnlyForPlayer);
	}
	template <typename R = void> R ReplaceLocationRules(StatusNameShow newStatusNameShow, bool newKillOnTimeout, Il2CppString* newKillOnTimeoutCondition, Nullable1<float>* newArmorDurabilityDecreaseCoef, Nullable1<float>* newWeaponDurabilityDecreaseCoef, Nullable1<float>* newOnDeathDurabilityDecreaseCoef, bool newPersonalCorpse, bool newRespawnOnArena, SpawnTypes newSpawnType, bool newShowChangeHealthOnlyForPlayer) {
	...
	template <typename R = void> R AddLocationStat(HashSet1<int64_t>* newVisits, HashSet1<int64_t>* newPkOn, HashSet1<LongLong>* newPvPKills) {
		return ((R (*)(LocationEntity*, HashSet1<int64_t>*, HashSet1<int64_t>*, HashSet1<LongLong>*))(Il2CppBase() + 0x17AC37C))(this, newVisits, newPkOn, newPvPKills);
	}
	template <typename R = void> R ReplaceLocationStat(HashSet1<int64_t>* newVisits, HashSet1<int64_t>* newPkOn, HashSet1<LongLong>* newPvPKills) {
		return ((R (*)(LocationEntity*, HashSet1<int64_t>*, HashSet1<int64_t>*, HashSet1<LongLong>*))(Il2CppBase() + 0x17AC4C0))(this, newVisits, newPkOn, newPvPKills);
	}
