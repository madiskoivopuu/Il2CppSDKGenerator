...
public: 
	...
	template <typename T = BorderOffsetComponent*> static T& borderOffsetComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = ClanLockedComponent*> static T& clanLockedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = DontShowLeaveGridComponent*> static T& dontShowLeaveGridComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = DummyComponent*> static T& dummyComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = GuildLockedComponent*> static T& guildLockedComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = HUDTimerComponent*> static T& hUDTimerComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = OneCellComponent*> static T& oneCellComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = WithoutBorderComponent*> static T& withoutBorderComponent() {
	...
	template <typename T = AdditionalSceneComponent*> T get_additionalScene() {
	...
	template <typename T = AdditiveSceneComponent*> T get_additiveScene() {
	...
	template <typename T = AmbientComponent*> T get_ambient() {
	...
	template <typename T = AudioComponent*> T get_audio() {
	...
	template <typename T = BiomeComponent*> T get_biome() {
	...
	template <typename T = ChanceEnemyIncomeComponent*> T get_chanceEnemyIncome() {
	...
	template <typename T = CurrentPhaseComponent*> T get_currentPhase() {
	...
	template <typename T = void> T AddDifficulty(Difficulty* newType) {
		return ((T (*)(LocationEntity*, Difficulty*))(Il2CppBase() + 0x17A8B58))(this, newType);
	}
	template <typename T = void> T ReplaceDifficulty(Difficulty* newType) {
		return ((T (*)(LocationEntity*, Difficulty*))(Il2CppBase() + 0x17A8C5C))(this, newType);
	}
	template <typename T = void> T RemoveDifficulty() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17A8D60))(this);
	}
	template <typename T = DisconnectTimeoutComponent*> T get_disconnectTimeout() {
	...
	template <typename T = DynamicGradeComponent*> T get_dynamicGrade() {
	...
	template <typename T = void> T AddDynamicGrade(DynamicGradeType* newType, int32_t newOffset, Nullable1int32_t>* newMax) {
		return ((T (*)(LocationEntity*, DynamicGradeType*, int32_t, Nullable1int32_t>*))(Il2CppBase() + 0x17A92F0))(this, newType, newOffset, newMax);
	}
	template <typename T = void> T ReplaceDynamicGrade(DynamicGradeType* newType, int32_t newOffset, Nullable1int32_t>* newMax) {
		return ((T (*)(LocationEntity*, DynamicGradeType*, int32_t, Nullable1int32_t>*))(Il2CppBase() + 0x17A9408))(this, newType, newOffset, newMax);
	}
	...
	template <typename T = EnergyPriceComponent*> T get_energyPrice() {
	...
	template <typename T = EnterMagicComponent*> T get_enterMagic() {
	...
	template <typename T = EnterNotifyComponent*> T get_enterNotify() {
	...
	template <typename T = void> T AddEnterNotify(EnterNotify* newOwnerNotify, EnterNotify* newForeignNotify) {
		return ((T (*)(LocationEntity*, EnterNotify*, EnterNotify*))(Il2CppBase() + 0x17AA168))(this, newOwnerNotify, newForeignNotify);
	}
	template <typename T = void> T ReplaceEnterNotify(EnterNotify* newOwnerNotify, EnterNotify* newForeignNotify) {
		return ((T (*)(LocationEntity*, EnterNotify*, EnterNotify*))(Il2CppBase() + 0x17AA2C0))(this, newOwnerNotify, newForeignNotify);
	}
	template <typename T = void> T RemoveEnterNotify() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17AA418))(this);
	}
	template <typename T = ExitConditionComponent*> T get_exitCondition() {
	...
	template <typename T = FogOfWarComponent*> T get_fogOfWar() {
	...
	template <typename T = void> T AddFogOfWar(Il2CppString* newPrefabName, WorldResourcesType* newResourceType) {
		return ((T (*)(LocationEntity*, Il2CppString*, WorldResourcesType*))(Il2CppBase() + 0x17AA7F8))(this, newPrefabName, newResourceType);
	}
	template <typename T = void> T ReplaceFogOfWar(Il2CppString* newPrefabName, WorldResourcesType* newResourceType) {
		return ((T (*)(LocationEntity*, Il2CppString*, WorldResourcesType*))(Il2CppBase() + 0x17AA914))(this, newPrefabName, newResourceType);
	}
	template <typename T = void> T RemoveFogOfWar() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17AAA30))(this);
	}
	template <typename T = GeneratorParamsComponent*> T get_generatorParams() {
	...
	template <typename T = void> T AddGeneratorParams(GeneratorParams* newValue) {
		return ((T (*)(LocationEntity*, GeneratorParams*))(Il2CppBase() + 0x17AAAD0))(this, newValue);
	}
	template <typename T = void> T ReplaceGeneratorParams(GeneratorParams* newValue) {
		return ((T (*)(LocationEntity*, GeneratorParams*))(Il2CppBase() + 0x17AABE4))(this, newValue);
	}
	...
	template <typename T = GroundComponent*> T get_ground() {
	...
	template <typename T = LightingComponent*> T get_lighting() {
	...
	template <typename T = LocationModeComponent*> T get_locationMode() {
	...
	template <typename T = void> T AddLocationMode(LocationMode* newType, Il2CppString* newCaption, Il2CppString* newDescription, Il2CppString* newIcon, Nullable1int32_t>* newDifficultyIndex, Nullable1int32_t>* newLootIndex, Il2CppString* newPvPName) {
		return ((T (*)(LocationEntity*, LocationMode*, Il2CppString*, Il2CppString*, Il2CppString*, Nullable1int32_t>*, Nullable1int32_t>*, Il2CppString*))(Il2CppBase() + 0x17ABC24))(this, newType, newCaption, newDescription, newIcon, newDifficultyIndex, newLootIndex, newPvPName);
	}
	template <typename T = void> T ReplaceLocationMode(LocationMode* newType, Il2CppString* newCaption, Il2CppString* newDescription, Il2CppString* newIcon, Nullable1int32_t>* newDifficultyIndex, Nullable1int32_t>* newLootIndex, Il2CppString* newPvPName) {
		return ((T (*)(LocationEntity*, LocationMode*, Il2CppString*, Il2CppString*, Il2CppString*, Nullable1int32_t>*, Nullable1int32_t>*, Il2CppString*))(Il2CppBase() + 0x17ABDA0))(this, newType, newCaption, newDescription, newIcon, newDifficultyIndex, newLootIndex, newPvPName);
	}
	template <typename T = void> T RemoveLocationMode() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17ABF1C))(this);
	}
	template <typename T = LocationRulesComponent*> T get_locationRules() {
	...
	template <typename T = void> T AddLocationRules(StatusNameShow* newStatusNameShow, bool newKillOnTimeout, Il2CppString* newKillOnTimeoutCondition, Nullable1float>* newArmorDurabilityDecreaseCoef, Nullable1float>* newWeaponDurabilityDecreaseCoef, Nullable1float>* newOnDeathDurabilityDecreaseCoef, bool newPersonalCorpse, bool newRespawnOnArena, SpawnTypes* newSpawnType, bool newShowChangeHealthOnlyForPlayer) {
		return ((T (*)(LocationEntity*, StatusNameShow*, bool, Il2CppString*, Nullable1float>*, Nullable1float>*, Nullable1float>*, bool, bool, SpawnTypes*, bool))(Il2CppBase() + 0x17ABFBC))(this, newStatusNameShow, newKillOnTimeout, newKillOnTimeoutCondition, newArmorDurabilityDecreaseCoef, newWeaponDurabilityDecreaseCoef, newOnDeathDurabilityDecreaseCoef, newPersonalCorpse, newRespawnOnArena, newSpawnType, newShowChangeHealthOnlyForPlayer);
	}
	template <typename T = void> T ReplaceLocationRules(StatusNameShow* newStatusNameShow, bool newKillOnTimeout, Il2CppString* newKillOnTimeoutCondition, Nullable1float>* newArmorDurabilityDecreaseCoef, Nullable1float>* newWeaponDurabilityDecreaseCoef, Nullable1float>* newOnDeathDurabilityDecreaseCoef, bool newPersonalCorpse, bool newRespawnOnArena, SpawnTypes* newSpawnType, bool newShowChangeHealthOnlyForPlayer) {
	...
	template <typename T = LocationStatComponent*> T get_locationStat() {
	...
	template <typename T = void> T AddLocationStat(HashSet1int64_t>* newVisits, HashSet1int64_t>* newPkOn, HashSet1LongLong*>* newPvPKills) {
		return ((T (*)(LocationEntity*, HashSet1int64_t>*, HashSet1int64_t>*, HashSet1LongLong*>*))(Il2CppBase() + 0x17AC37C))(this, newVisits, newPkOn, newPvPKills);
	}
	template <typename T = void> T ReplaceLocationStat(HashSet1int64_t>* newVisits, HashSet1int64_t>* newPkOn, HashSet1LongLong*>* newPvPKills) {
		return ((T (*)(LocationEntity*, HashSet1int64_t>*, HashSet1int64_t>*, HashSet1LongLong*>*))(Il2CppBase() + 0x17AC4C0))(this, newVisits, newPkOn, newPvPKills);
	}
	template <typename T = void> T RemoveLocationStat() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17AC604))(this);
	}
	template <typename T = LocationTypeComponent*> T get_locationType() {
	...
	template <typename T = void> T AddLocationType(LocationType* newType) {
		return ((T (*)(LocationEntity*, LocationType*))(Il2CppBase() + 0x17AC6A4))(this, newType);
	}
	template <typename T = void> T ReplaceLocationType(LocationType* newType) {
		return ((T (*)(LocationEntity*, LocationType*))(Il2CppBase() + 0x17AC7A8))(this, newType);
	}
	...
	template <typename T = OwnerAudioComponent*> T get_ownerAudio() {
	...
	template <typename T = PlayroomComponent*> T get_playroom() {
	...
	template <typename T = PortalInfoComponent*> T get_portalInfo() {
	...
	template <typename T = void> T AddPortalInfo(LobbyType* newType, int32_t newPortalsRank, Il2CppArray<uintptr_t>* newPlayers) {
		return ((T (*)(LocationEntity*, LobbyType*, int32_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x17ADA98))(this, newType, newPortalsRank, newPlayers);
	}
	template <typename T = void> T ReplacePortalInfo(LobbyType* newType, int32_t newPortalsRank, Il2CppArray<uintptr_t>* newPlayers) {
		return ((T (*)(LocationEntity*, LobbyType*, int32_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x17ADBC0))(this, newType, newPortalsRank, newPlayers);
	}
	template <typename T = void> T RemovePortalInfo() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17ADCE8))(this);
	}
	template <typename T = PvpModeComponent*> T get_pvpMode() {
	...
	template <typename T = void> T AddPvpMode(PvpMode* newType) {
		return ((T (*)(LocationEntity*, PvpMode*))(Il2CppBase() + 0x17ADCF4))(this, newType);
	}
	template <typename T = void> T ReplacePvpMode(PvpMode* newType) {
		return ((T (*)(LocationEntity*, PvpMode*))(Il2CppBase() + 0x17ADDF8))(this, newType);
	}
	template <typename T = void> T RemovePvpMode() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17ADEFC))(this);
	}
	template <typename T = QuadOwnerComponent*> T get_quadOwner() {
	...
	template <typename T = RaidMatchingTimeout*> T get_raidMatchingTimeout() {
	...
	template <typename T = RelationshipComponent*> T get_relationship() {
	...
	template <typename T = void> T AddRelationship(RelationshipRules* newType) {
		return ((T (*)(LocationEntity*, RelationshipRules*))(Il2CppBase() + 0x17AE7E4))(this, newType);
	}
	template <typename T = void> T ReplaceRelationship(RelationshipRules* newType) {
		return ((T (*)(LocationEntity*, RelationshipRules*))(Il2CppBase() + 0x17AE8E8))(this, newType);
	}
	template <typename T = void> T RemoveRelationship() {
		return ((T (*)(LocationEntity*))(Il2CppBase() + 0x17AE9EC))(this);
	}
	template <typename T = RequiredItemsComponent*> T get_requiredItems() {
	...
	template <typename T = SceneComponent*> T get_scene() {
	...
	template <typename T = SizeComponent*> T get_size() {
	...
	template <typename T = StaticSaveComponent*> T get_staticSave() {
	...
	template <typename T = TimeOutExitMapComponent*> T get_timeOutExitMap() {
	...
	template <typename T = TimeOutExitMapPvpComponent*> T get_timeOutExitMapPvp() {
	...
	template <typename T = VisualTextComponent*> T get_visualText() {
	...
	template <typename T = void> T AddWorldType(WorldType* newType) {
		return ((T (*)(LocationEntity*, WorldType*))(Il2CppBase() + 0x17B083C))(this, newType);
	}
	template <typename T = void> T ReplaceWorldType(WorldType* newType) {
		return ((T (*)(LocationEntity*, WorldType*))(Il2CppBase() + 0x17B0940))(this, newType);
	}
