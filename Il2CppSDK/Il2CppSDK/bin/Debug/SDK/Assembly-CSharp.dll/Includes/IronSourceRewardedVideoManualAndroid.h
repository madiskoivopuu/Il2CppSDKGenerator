...
public: 
	...
	template <typename T = Action1IronSourceError*>*> T& OnRewardedVideoAdLoadFailed() {
	...
	template <typename T = void> T add_OnRewardedVideoAdLoadFailed(Action1IronSourceError*>* value) {
		return ((T (*)(IronSourceRewardedVideoManualAndroid*, Action1IronSourceError*>*))(Il2CppBase() + 0x10E4BB4))(this, value);
	}
	template <typename T = void> T remove_OnRewardedVideoAdLoadFailed(Action1IronSourceError*>* value) {
		return ((T (*)(IronSourceRewardedVideoManualAndroid*, Action1IronSourceError*>*))(Il2CppBase() + 0x10E4C54))(this, value);
	}
