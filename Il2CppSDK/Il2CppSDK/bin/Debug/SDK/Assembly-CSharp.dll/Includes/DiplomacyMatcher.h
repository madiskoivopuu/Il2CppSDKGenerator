...
public: 
	...
	template <typename T = void*> static T& _matcherAccepted() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _matcherDiplomacy() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> static T& _matcherDiscarded() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> static T& _matcherFromClan() {
	...
	template <typename T = void*> static T& _matcherToClan() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}

	template <typename T = void*> static T get_Accepted() {
		return ((T (*)(void *))(Il2CppBase() + 0x12FEF24))(0);
	}
	template <typename T = void*> static T get_Diplomacy() {
		return ((T (*)(void *))(Il2CppBase() + 0x12FD1A8))(0);
	}
	template <typename T = void*> static T get_Discarded() {
		return ((T (*)(void *))(Il2CppBase() + 0x12FF0A4))(0);
	}
	template <typename T = void*> static T get_FromClan() {
	...
	template <typename T = void*> static T get_ToClan() {
