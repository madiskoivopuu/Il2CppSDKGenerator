...
public: 
	...
	template <typename T = IronSourceIAgent*> T& _platformAgent() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = IronSource*> static T& _instance() {
	...
	template <typename T = IronSource*> static T get_Agent() {
	...
	template <typename T = void> T SetWaterfallConfiguration(WaterfallConfiguration* waterfallConfiguration, AdFormat* adFormat) {
		return ((T (*)(IronSource*, WaterfallConfiguration*, AdFormat*))(Il2CppBase() + 0x1249074))(this, waterfallConfiguration, adFormat);
	}
	...
	template <typename T = void> T loadBanner(IronSourceBannerSize* size, IronSourceBannerPosition* position) {
		return ((T (*)(IronSource*, IronSourceBannerSize*, IronSourceBannerPosition*))(Il2CppBase() + 0x124ADD0))(this, size, position);
	}
	template <typename T = void> T loadBanner_1(IronSourceBannerSize* size, IronSourceBannerPosition* position, Il2CppString* placementName) {
		return ((T (*)(IronSource*, IronSourceBannerSize*, IronSourceBannerPosition*, Il2CppString*))(Il2CppBase() + 0x124AE98))(this, size, position, placementName);
	}
	...
	template <typename T = void> T setSegment(IronSourceSegment* segment) {
		return ((T (*)(IronSource*, IronSourceSegment*))(Il2CppBase() + 0x124B240))(this, segment);
	}
