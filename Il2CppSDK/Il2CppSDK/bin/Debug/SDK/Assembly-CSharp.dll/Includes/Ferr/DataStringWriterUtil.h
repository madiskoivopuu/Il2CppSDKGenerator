...
public: 
	...
	template <typename T = DataStringType*> T& _type() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = uintptr_t> T& _builder() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = HashSet1Il2CppString*>*> T& _names() {
	...
	template <typename T = void> T Data(IToFromDataString* aData) {
		return ((T (*)(DataStringWriterUtil*, IToFromDataString*))(Il2CppBase() + 0xEB1A6C))(this, aData);
	}
	template <typename T = void> T Data_1(Il2CppString* aName, IToFromDataString* aData) {
		return ((T (*)(DataStringWriterUtil*, Il2CppString*, IToFromDataString*))(Il2CppBase() + 0xEB1B90))(this, aName, aData);
	}
