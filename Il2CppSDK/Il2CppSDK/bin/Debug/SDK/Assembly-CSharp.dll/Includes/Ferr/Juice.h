...
public: 
	...
	template <typename T = Juice*> static T& instance() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = Il2CppList<JuiceData*>*> T& list() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = Il2CppList<JuiceDataColor*>*> T& listColor() {
	...
	template <typename T = Juice*> static T get_Instance() {
		return ((T (*)(void *))(Il2CppBase() + 0x14E6ACC))(0);
	}
	template <typename T = Juice*> static T Create() {
	...
	template <typename T = void> static T Add(uintptr_t aTransform, JuiceType* aType, uintptr_t aCurve, float aStart, float aEnd, float aDuration, bool aRelative, uintptr_t aCallback) {
		return ((T (*)(void *, uintptr_t, JuiceType*, uintptr_t, float, float, float, bool, uintptr_t))(Il2CppBase() + 0x14E7F0C))(0, aTransform, aType, aCurve, aStart, aEnd, aDuration, aRelative, aCallback);
	}
	...
	template <typename T = void> static T Scale_1(uintptr_t aTransform, uintptr_t aCurve, uintptr_t aStart, uintptr_t aEnd, float aDuration, bool aRelative, uintptr_t aCallback) {
		return ((T (*)(void *, uintptr_t, uintptr_t, uintptr_t, uintptr_t, float, bool, uintptr_t))(Il2CppBase() + 0x14E8118))(0, aTransform, aCurve, aStart, aEnd, aDuration, aRelative, aCallback);
	}
	template <typename T = void> static T Rotate(uintptr_t aTransform, uintptr_t aCurve, uintptr_t aStart, uintptr_t aEnd, float aDuration, bool aRelative, uintptr_t aCallback) {
		return ((T (*)(void *, uintptr_t, uintptr_t, uintptr_t, uintptr_t, float, bool, uintptr_t))(Il2CppBase() + 0x14E8238))(0, aTransform, aCurve, aStart, aEnd, aDuration, aRelative, aCallback);
	}
	template <typename T = void> static T Translate(uintptr_t aTransform, uintptr_t aCurve, uintptr_t aStart, uintptr_t aEnd, float aDuration, bool aRelative, uintptr_t aCallback) {
		return ((T (*)(void *, uintptr_t, uintptr_t, uintptr_t, uintptr_t, float, bool, uintptr_t))(Il2CppBase() + 0x14E8358))(0, aTransform, aCurve, aStart, aEnd, aDuration, aRelative, aCallback);
	}
	template <typename T = void> static T TranslateLocal(uintptr_t aTransform, uintptr_t aCurve, uintptr_t aStart, uintptr_t aEnd, float aDuration, bool aRelative, uintptr_t aCallback) {
		return ((T (*)(void *, uintptr_t, uintptr_t, uintptr_t, uintptr_t, float, bool, uintptr_t))(Il2CppBase() + 0x14E850C))(0, aTransform, aCurve, aStart, aEnd, aDuration, aRelative, aCallback);
	}
