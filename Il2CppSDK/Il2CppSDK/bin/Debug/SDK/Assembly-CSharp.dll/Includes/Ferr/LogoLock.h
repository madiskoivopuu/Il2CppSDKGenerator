...
public: 
	...
	template <typename T = LockPosition*> T& mLockHorizontal() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = LockPosition*> T& mLockVertical() {
	...
	template <typename T = uintptr_t> static T GetLockPosition(uintptr_t aCam, LockPosition* aHLock, LockPosition* aVLock, float aPadding) {
		return ((T (*)(void *, uintptr_t, LockPosition*, LockPosition*, float))(Il2CppBase() + 0x1731E14))(0, aCam, aHLock, aVLock, aPadding);
	}
	template <typename T = uintptr_t> static T GetViewSizeAtDistance(float aDist, uintptr_t aCamera) {
