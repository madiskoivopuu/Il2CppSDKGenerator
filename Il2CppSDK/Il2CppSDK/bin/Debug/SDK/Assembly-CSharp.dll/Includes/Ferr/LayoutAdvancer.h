...
public: 
	...
	template <typename T = uintptr_t> T& mPos() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = Direction*> T& mDirection() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = uintptr_t> T& mPrevious() {
		return *(T*)((uintptr_t)this + 0x1C);
	}
	template <typename T = uintptr_t> T& mPrevPos() {
	...
	template <typename T = Direction*> T get_Dir() {
		return ((T (*)(LayoutAdvancer*))(Il2CppBase() + 0x1429958))(this);
	}
	template <typename T = void> T Step(uintptr_t aSize) {
		return ((T (*)(LayoutAdvancer*, uintptr_t))(Il2CppBase() + 0x14299B0))(this, aSize);
	}
	template <typename T = void> T Step_1(float aX, float aY) {
		return ((T (*)(LayoutAdvancer*, float, float))(Il2CppBase() + 0x14299F4))(this, aX, aY);
	}
	template <typename T = uintptr_t> T GetRect() {
		return ((T (*)(LayoutAdvancer*))(Il2CppBase() + 0x1429A38))(this);
	}
	template <typename T = uintptr_t> T GetRect_1(float aOverrideDir) {
		return ((T (*)(LayoutAdvancer*, float))(Il2CppBase() + 0x1429A70))(this, aOverrideDir);
	}
	template <typename T = uintptr_t> T GetRect_2(float aOverrideWidth, float aOverrideHeight) {
		return ((T (*)(LayoutAdvancer*, float, float))(Il2CppBase() + 0x1429AD4))(this, aOverrideWidth, aOverrideHeight);
	}
	template <typename T = uintptr_t> T GetRectPad(float aPaddingX, float aPaddingY) {
		return ((T (*)(LayoutAdvancer*, float, float))(Il2CppBase() + 0x1429B10))(this, aPaddingX, aPaddingY);
	}
	template <typename T = uintptr_t> T GetRectPad_1(float aPadding) {
