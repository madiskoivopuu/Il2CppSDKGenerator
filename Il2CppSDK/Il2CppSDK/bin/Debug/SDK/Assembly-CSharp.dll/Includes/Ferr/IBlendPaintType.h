...
public: 
	...
	template <typename T = uintptr_t> T get_CursorHotspot() {
		return ((T (*)(IBlendPaintType*))(Il2CppBase() + 0x0))(this);
	}
	...
	template <typename T = void> T PaintObjectsBegin(Il2CppList<uintptr_t>* aObjects, uintptr_t aHit, Nullable1uintptr_t>* aPreviousHit) {
		return ((T (*)(IBlendPaintType*, Il2CppList<uintptr_t>*, uintptr_t, Nullable1uintptr_t>*))(Il2CppBase() + 0x0))(this, aObjects, aHit, aPreviousHit);
	}
	template <typename T = void> T PaintObjects(Il2CppList<uintptr_t>* aObjects, uintptr_t aHit, Nullable1uintptr_t>* aPreviousHit) {
		return ((T (*)(IBlendPaintType*, Il2CppList<uintptr_t>*, uintptr_t, Nullable1uintptr_t>*))(Il2CppBase() + 0x0))(this, aObjects, aHit, aPreviousHit);
	}
	template <typename T = void> T PaintObjectsEnd(Il2CppList<uintptr_t>* aObjects, uintptr_t aHit, Nullable1uintptr_t>* aPreviousHit) {
		return ((T (*)(IBlendPaintType*, Il2CppList<uintptr_t>*, uintptr_t, Nullable1uintptr_t>*))(Il2CppBase() + 0x0))(this, aObjects, aHit, aPreviousHit);
	}
	template <typename T = void> T PaintBegin(uintptr_t aObject, uintptr_t aHit, Nullable1uintptr_t>* aPreviousHit) {
		return ((T (*)(IBlendPaintType*, uintptr_t, uintptr_t, Nullable1uintptr_t>*))(Il2CppBase() + 0x0))(this, aObject, aHit, aPreviousHit);
	}
	template <typename T = void> T Paint(uintptr_t aObject, uintptr_t aHit, Nullable1uintptr_t>* aPreviousHit) {
		return ((T (*)(IBlendPaintType*, uintptr_t, uintptr_t, Nullable1uintptr_t>*))(Il2CppBase() + 0x0))(this, aObject, aHit, aPreviousHit);
	}
	template <typename T = void> T PaintEnd(uintptr_t aObject, uintptr_t aHit, Nullable1uintptr_t>* aPreviousHit) {
		return ((T (*)(IBlendPaintType*, uintptr_t, uintptr_t, Nullable1uintptr_t>*))(Il2CppBase() + 0x0))(this, aObject, aHit, aPreviousHit);
	}
	template <typename T = float> T GetPointInfluence(uintptr_t aObjScale, uintptr_t aHitPt, uintptr_t aHitDirection, uintptr_t aVert, uintptr_t aVertNormal) {
		return ((T (*)(IBlendPaintType*, uintptr_t, uintptr_t, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x0))(this, aObjScale, aHitPt, aHitDirection, aVert, aVertNormal);
	}
