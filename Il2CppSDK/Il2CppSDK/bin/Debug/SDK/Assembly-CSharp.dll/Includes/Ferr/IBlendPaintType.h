...
public: 
	...
	template <typename R = void> R PaintObjectsBegin(Il2CppList<uintptr_t>* aObjects, uintptr_t aHit, Nullable1<uintptr_t>* aPreviousHit) {
		return ((R (*)(IBlendPaintType*, Il2CppList<uintptr_t>*, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(this, aObjects, aHit, aPreviousHit);
	}
	template <typename R = void> R PaintObjects(Il2CppList<uintptr_t>* aObjects, uintptr_t aHit, Nullable1<uintptr_t>* aPreviousHit) {
		return ((R (*)(IBlendPaintType*, Il2CppList<uintptr_t>*, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(this, aObjects, aHit, aPreviousHit);
	}
	template <typename R = void> R PaintObjectsEnd(Il2CppList<uintptr_t>* aObjects, uintptr_t aHit, Nullable1<uintptr_t>* aPreviousHit) {
		return ((R (*)(IBlendPaintType*, Il2CppList<uintptr_t>*, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(this, aObjects, aHit, aPreviousHit);
	}
	template <typename R = void> R PaintBegin(uintptr_t aObject, uintptr_t aHit, Nullable1<uintptr_t>* aPreviousHit) {
		return ((R (*)(IBlendPaintType*, uintptr_t, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(this, aObject, aHit, aPreviousHit);
	}
	template <typename R = void> R Paint(uintptr_t aObject, uintptr_t aHit, Nullable1<uintptr_t>* aPreviousHit) {
		return ((R (*)(IBlendPaintType*, uintptr_t, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(this, aObject, aHit, aPreviousHit);
	}
	template <typename R = void> R PaintEnd(uintptr_t aObject, uintptr_t aHit, Nullable1<uintptr_t>* aPreviousHit) {
		return ((R (*)(IBlendPaintType*, uintptr_t, uintptr_t, Nullable1<uintptr_t>*))(Il2CppBase() + 0x0))(this, aObject, aHit, aPreviousHit);
	}
