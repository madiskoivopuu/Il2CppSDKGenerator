...
public: 
	...
	template <typename T = Il2CppVector3> T& magnitude() {
	...
	template <typename T = void> static T Shake(Il2CppVector3 aMagnitude, float aDuration) {
		return ((T (*)(void *, Il2CppVector3, float))(Il2CppBase() + 0x15B330C))(0, aMagnitude, aDuration);
	}
