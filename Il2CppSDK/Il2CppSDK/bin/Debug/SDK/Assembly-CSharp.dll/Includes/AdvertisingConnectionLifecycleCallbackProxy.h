...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Action1<GooglePlayGamesBasicApiNearby::AdvertisingResult>*& mResultCallback() {
		return *(Action1<GooglePlayGamesBasicApiNearby::AdvertisingResult>**)((uintptr_t)this + 0x20);
	}
	 Action1<GooglePlayGamesBasicApiNearby::ConnectionRequest>*& mConnectionRequestCallback() {
		return *(Action1<GooglePlayGamesBasicApiNearby::ConnectionRequest>**)((uintptr_t)this + 0x28);
	}
