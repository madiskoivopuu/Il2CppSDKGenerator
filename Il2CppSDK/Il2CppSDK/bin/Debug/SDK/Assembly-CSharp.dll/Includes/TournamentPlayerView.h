...
public: 
	...
	template <typename T = RewardResourceView*> T& PrizePrefab() {
	...
	template <typename T = void> T Bind(UIWindow* window, int64_t tournamentId, int32_t position, int64_t playerId, TooltipView* tooltip) {
		return ((T (*)(TournamentPlayerView*, UIWindow*, int64_t, int32_t, int64_t, TooltipView*))(Il2CppBase() + 0x150950C))(this, window, tournamentId, position, playerId, tooltip);
	}
