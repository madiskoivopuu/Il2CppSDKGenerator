...
public: 
	...
	template <typename R = bool> R& WasStoreUpdated() {
	 ...
	 Nullable1<bool>*& WasSendWorld() {
		return *(Nullable1<bool>**)((uintptr_t)this + 0x28B);
	}
	...
	template <typename R = bool> R& WasDeadWhenLoad() {
	 ...
	 Action1<Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*>*& OnWorldCreate() {
		return *(Action1<Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*>**)((uintptr_t)this + 0x290);
	}
	 static Nullable1<int64_t>*& ServerClientTimeDelta() {
		return *(Nullable1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = Il2CppString*> static R& BugreportUrl() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename R = Il2CppArray<Action4<BaseClientWorld*, Commands, uintptr_t, uintptr_t>*>*> static R& _baseCommandsActions() {
	...
	template <typename R = uintptr_t> R Create(Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>* blueprints) {
		return ((R (*)(BaseClientWorld*, Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*))(Il2CppBase() + 0x0))(this, blueprints);
	}
	...
	template <typename R = void> R set_WasStoreUpdated(bool value) {
	 ...
	 Nullable1<bool>* get_WasSendWorld() {
		return ((Nullable1<bool>* (*)(BaseClientWorld*))(Il2CppBase() + 0xFBF88C))(this);
	}
	template <typename R = void> R set_WasSendWorld(Nullable1<bool>* value) {
		return ((R (*)(BaseClientWorld*, Nullable1<bool>*))(Il2CppBase() + 0xFBF898))(this, value);
	}
	...
	template <typename R = void> R add_OnWorldCreate(Action1<Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*>* value) {
		return ((R (*)(BaseClientWorld*, Action1<Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*>*))(Il2CppBase() + 0xFBF8CC))(this, value);
	}
	template <typename R = void> R remove_OnWorldCreate(Action1<Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*>* value) {
		return ((R (*)(BaseClientWorld*, Action1<Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*>*))(Il2CppBase() + 0xFBF970))(this, value);
	}
	...
	template <typename R = void> R OnUpdateWorldCmd(Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>* blueprints) {
		return ((R (*)(BaseClientWorld*, Il2CppList<KeyValuePair2<Il2CppString*, EntityBlueprint*>*>*))(Il2CppBase() + 0xFC8844))(this, blueprints);
	}
