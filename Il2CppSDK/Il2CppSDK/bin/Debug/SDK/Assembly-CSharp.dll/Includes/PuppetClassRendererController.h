...
public: 
	...
	template <typename R = uint32_t> R& _soundId() {
	 ...
	 Action1PuppetClassRendererController*>*& _onClick() {
		return *(Action1PuppetClassRendererController*>**)((uintptr_t)this + 0x90);
	}
	template <typename R = Il2CppString*> R& Blueprint() {
		return *(R*)((uintptr_t)this + 0x98);
	}

	template <typename R = void> R add__onClick(Action1PuppetClassRendererController*>* value) {
		return ((R (*)(PuppetClassRendererController*, Action1PuppetClassRendererController*>*))(Il2CppBase() + 0x11B1484))(this, value);
	}
	template <typename R = void> R remove__onClick(Action1PuppetClassRendererController*>* value) {
		return ((R (*)(PuppetClassRendererController*, Action1PuppetClassRendererController*>*))(Il2CppBase() + 0x11B1524))(this, value);
	}
	...
	template <typename R = void> R ShowPuppet(Il2CppString* className, float centerOffset, float angle, Action1PuppetClassRendererController*>* OnClick) {
		return ((R (*)(PuppetClassRendererController*, Il2CppString*, float, float, Action1PuppetClassRendererController*>*))(Il2CppBase() + 0x11B15D4))(this, className, centerOffset, angle, OnClick);
	}
