...
public: 
	...
	template <typename T = Il2CppVector3> T& _puppetPosition() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = Il2CppVector3> T& _hlOffset() {
		return *(T*)((uintptr_t)this + 0x34);
	}
	template <typename T = bool> T& _randomizeAnimation() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = uintptr_t> T& _puppetEntity() {
	...
	template <typename T = void> T add__onClick(void* value) {
		return ((T (*)(PuppetClassRendererController*, void*))(Il2CppBase() + 0x11B1484))(this, value);
	}
	template <typename T = void> T remove__onClick(void* value) {
		return ((T (*)(PuppetClassRendererController*, void*))(Il2CppBase() + 0x11B1524))(this, value);
	}
	...
	template <typename T = void> T ShowPuppet(Il2CppString* className, float centerOffset, float angle, void* OnClick) {
		return ((T (*)(PuppetClassRendererController*, Il2CppString*, float, float, void*))(Il2CppBase() + 0x11B15D4))(this, className, centerOffset, angle, OnClick);
	}
	...
	template <typename T = void> T OnOtherClick(uintptr_t controller) {
		return ((T (*)(PuppetClassRendererController*, uintptr_t))(Il2CppBase() + 0x11B2688))(this, controller);
	}
