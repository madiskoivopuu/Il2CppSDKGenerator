...
public: 
	...
	template <typename T = void> T ShowCurrencyPrice(CurrencyType* currency, int32_t price, Il2CppString* buttonNameLocKey) {
		return ((T (*)(StandartButton*, CurrencyType*, int32_t, Il2CppString*))(Il2CppBase() + 0x1489AF0))(this, currency, price, buttonNameLocKey);
	}
	...
	template <typename T = void> T ShowPrice(Price* price, Discount* discount, bool needShowAd) {
		return ((T (*)(StandartButton*, Price*, Discount*, bool))(Il2CppBase() + 0x1489CC0))(this, price, discount, needShowAd);
	}
