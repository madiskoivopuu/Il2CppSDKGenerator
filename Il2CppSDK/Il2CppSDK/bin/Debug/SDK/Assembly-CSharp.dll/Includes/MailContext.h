...
class MailContext: ToPlayerReplicatedContext1
{
public: 
	...
	template <typename T = uintptr_t> T GetEntityWithMessageId(int64_t id) {
		return ((T (*)(MailContext*, int64_t))(Il2CppBase() + 0x1A4C6E4))(this, id);
	}
	template <typename T = void*> T GetEntitiesWithStack(Il2CppString* name) {
