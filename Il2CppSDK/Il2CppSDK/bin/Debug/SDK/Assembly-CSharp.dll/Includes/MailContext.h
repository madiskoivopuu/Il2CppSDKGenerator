...
public: 
	...
	template <typename R = MailEntity*> R GetEntityWithMessageId(int64_t id) {
	 ...
	 HashSet1<MailEntity*>* GetEntitiesWithStack(Il2CppString* name) {
		return ((HashSet1<MailEntity*>* (*)(MailContext*, Il2CppString*))(Il2CppBase() + 0x1A4C7C0))(this, name);
	}
	 HashSet1<MailEntity*>* GetEntitiesForPlayer(int64_t playerId) {
		return ((HashSet1<MailEntity*>* (*)(MailContext*, int64_t))(Il2CppBase() + 0x1A4C880))(this, playerId);
	}
