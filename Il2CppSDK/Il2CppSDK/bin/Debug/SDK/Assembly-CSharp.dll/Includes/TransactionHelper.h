...
public: 
	...
	template <typename R = bool> static R CreateClientTransaction(ICommonClientWorld* world, TransactionType type) {
	 ...
	 static ValueTuple2<Il2CppString*, Il2CppString*>* GetAnalyticsData(TransactionEntity* transaction, Il2CppString* originalLabel, Il2CppString* originalSublabel) {
		return ((ValueTuple2<Il2CppString*, Il2CppString*>* (*)(void *, TransactionEntity*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x151E1CC))(0, transaction, originalLabel, originalSublabel);
	}
