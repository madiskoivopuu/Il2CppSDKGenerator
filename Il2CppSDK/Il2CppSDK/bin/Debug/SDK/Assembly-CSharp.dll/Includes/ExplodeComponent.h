...
public: 
	...
	template <typename T = ExplodeType*> T& Type() {
		return *(T*)((uintptr_t)this + 0x18);
	}

	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(ExplodeComponent*, Il2CppObject*))(Il2CppBase() + 0x1685498))(this, targetObject);
	}
	template <typename T = bool> T IsEqualsDefault(Il2CppObject* blueprintComponent) {
		return ((T (*)(ExplodeComponent*, Il2CppObject*))(Il2CppBase() + 0x168553C))(this, blueprintComponent);
	}
