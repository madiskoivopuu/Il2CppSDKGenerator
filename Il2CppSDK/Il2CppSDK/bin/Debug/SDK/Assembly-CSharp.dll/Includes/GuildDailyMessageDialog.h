...
class GuildDailyMessageDialog: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& View01() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = uintptr_t> T& View02() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = uintptr_t> T& View03() {
		return *(T*)((uintptr_t)this + 0x88);
	}
	template <typename T = uintptr_t> T& View04() {
	...
	template <typename T = uintptr_t> T& _selectedType() {
	...
	template <typename T = void> T OnTypeClicked(unsigned char type) {
		return ((T (*)(GuildDailyMessageDialog*, unsigned char))(Il2CppBase() + 0x12EC9A0))(this, type);
	}
	...
	template <typename T = uintptr_t> T getDailyMessageTypeView(unsigned char type) {
		return ((T (*)(GuildDailyMessageDialog*, unsigned char))(Il2CppBase() + 0x12EC550))(this, type);
	}
