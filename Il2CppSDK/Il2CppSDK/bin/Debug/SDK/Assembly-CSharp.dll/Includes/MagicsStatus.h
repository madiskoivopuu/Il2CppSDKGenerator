...
public: 
	...
	template <typename R = int32_t> R& _activeCount() {
	 ...
	 HashSet1<Il2CppString*>*& _currentIconIds() {
		return *(HashSet1<Il2CppString*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = void> R OnDisable() {
	 ...
	 ValueTuple2<float, int64_t>* GetMagicProgress(GameEntity* entity, MagicEntity* magic, int64_t now) {
		return ((ValueTuple2<float, int64_t>* (*)(MagicsStatus*, GameEntity*, MagicEntity*, int64_t))(Il2CppBase() + 0x1A48C3C))(this, entity, magic, now);
	}
