...
public: 
	...
	template <typename T = StandartButton*> T& ApplyBtn() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = uintptr_t> T& ApplyBtnText() {
		return *(T*)((uintptr_t)this + 0x88);
	}
	template <typename T = StandartButton*> T& ClearBtn() {
	...
	template <typename T = GuildFindPlayerItem*> T& GuildPlayerInfo() {
	...
	template <typename T = void> T OnReceivePlayerForInvite(ErrorCodes* code, int64_t playerId) {
		return ((T (*)(FindPlayerGuildWindow*, ErrorCodes*, int64_t))(Il2CppBase() + 0x1696C64))(this, code, playerId);
	}
