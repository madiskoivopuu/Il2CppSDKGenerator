...
public: 
	...
	template <typename T = KilledComponent*> static T& killedComponent() {
	...
	template <typename T = ActorPlayerIdComponent*> T get_actorPlayerId() {
	...
	template <typename T = BattleStatisticComponent*> T get_battleStatistic() {
	...
	template <typename T = void> T AddBattleStatistic(BattleStatistic* newValue) {
		return ((T (*)(HistoryEntity*, BattleStatistic*))(Il2CppBase() + 0x1C4CD5C))(this, newValue);
	}
	template <typename T = void> T ReplaceBattleStatistic(BattleStatistic* newValue) {
		return ((T (*)(HistoryEntity*, BattleStatistic*))(Il2CppBase() + 0x1C509A0))(this, newValue);
	}
	...
	template <typename T = void> T AddDamageResult(DamageResultParams* newParams) {
		return ((T (*)(HistoryEntity*, DamageResultParams*))(Il2CppBase() + 0x1C4DAE4))(this, newParams);
	}
	template <typename T = void> T ReplaceDamageResult(DamageResultParams* newParams) {
		return ((T (*)(HistoryEntity*, DamageResultParams*))(Il2CppBase() + 0x1C50BE8))(this, newParams);
	}
	...
	template <typename T = void> T AddDamageStat(DamageStatType* newType, int32_t newId, Il2CppString* newName, Il2CppString* newBlueprint, Il2CppString* newClanName, Il2CppString* newGuildTag, Il2CppString* newClass, int64_t newPlayerId, Il2CppString* newItem, int32_t newBattleId) {
		return ((T (*)(HistoryEntity*, DamageStatType*, int32_t, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, int64_t, Il2CppString*, int32_t))(Il2CppBase() + 0x1C50D2C))(this, newType, newId, newName, newBlueprint, newClanName, newGuildTag, newClass, newPlayerId, newItem, newBattleId);
	}
	template <typename T = void> T ReplaceDamageStat(DamageStatType* newType, int32_t newId, Il2CppString* newName, Il2CppString* newBlueprint, Il2CppString* newClanName, Il2CppString* newGuildTag, Il2CppString* newClass, int64_t newPlayerId, Il2CppString* newItem, int32_t newBattleId) {
		return ((T (*)(HistoryEntity*, DamageStatType*, int32_t, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, Il2CppString*, int64_t, Il2CppString*, int32_t))(Il2CppBase() + 0x1C50EF0))(this, newType, newId, newName, newBlueprint, newClanName, newGuildTag, newClass, newPlayerId, newItem, newBattleId);
	}
	template <typename T = void> T RemoveDamageStat() {
		return ((T (*)(HistoryEntity*))(Il2CppBase() + 0x1C510B4))(this);
	}
	template <typename T = DamageSumComponent*> T get_damageSum() {
	...
	template <typename T = FishingStatisticComponent*> T get_fishingStatistic() {
	...
	template <typename T = void> T AddFishingStatistic(FishingStatistic* newValue) {
		return ((T (*)(HistoryEntity*, FishingStatistic*))(Il2CppBase() + 0x1C4C214))(this, newValue);
	}
	template <typename T = void> T ReplaceFishingStatistic(FishingStatistic* newValue) {
		return ((T (*)(HistoryEntity*, FishingStatistic*))(Il2CppBase() + 0x1C51310))(this, newValue);
	}
	...
	template <typename T = void> T AddHealResult(HealResultParams* newParams) {
		return ((T (*)(HistoryEntity*, HealResultParams*))(Il2CppBase() + 0x1C4EB1C))(this, newParams);
	}
	template <typename T = void> T ReplaceHealResult(HealResultParams* newParams) {
		return ((T (*)(HistoryEntity*, HealResultParams*))(Il2CppBase() + 0x1C5143C))(this, newParams);
	}
	...
	template <typename T = TargetPlayerIdComponent*> T get_targetPlayerId() {
