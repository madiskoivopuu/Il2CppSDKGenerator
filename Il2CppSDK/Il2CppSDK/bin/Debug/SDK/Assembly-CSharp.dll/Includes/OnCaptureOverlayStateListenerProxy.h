...
public: 
	...
	template <typename T = CaptureOverlayStateListener*> T& mListener() {
	...
	template <typename T = VideoCaptureOverlayState*> static T FromVideoCaptureOverlayState(int32_t overlayState) {
