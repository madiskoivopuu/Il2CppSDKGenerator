...
public: 
	...
	template <typename R = Il2CppString*> static R& InvasionPvE() {
	 ...
	 IGroup1<LobbyEntity*>*& _lobbyWithType() {
		return *(IGroup1<LobbyEntity*>**)((uintptr_t)this + 0x110);
	}
	...
	template <typename R = int32_t> R GetPrisonsLosePoints_1(ConfigFromServer config, float winPoints) {
	 ...
	 ValueTuple2<float, float>* GetLobbyRules(ICommonContexts* contexts, int32_t portalPoints, int32_t playerCount) {
		return ((ValueTuple2<float, float>* (*)(LobbyDataContext*, ICommonContexts*, int32_t, int32_t))(Il2CppBase() + 0x14394BC))(this, contexts, portalPoints, playerCount);
	}
	template <typename R = LobbyEntity*> R GetCurrentLobbyForPoints(ICommonContexts* contexts, int32_t portalPoints) {
	 ...
	 ValueTuple2<LobbyEntity*, LobbyEntity*>* GetCurrentAndNextLobbyForPoints(ICommonContexts* contexts, int32_t portalPoints) {
		return ((ValueTuple2<LobbyEntity*, LobbyEntity*>* (*)(LobbyDataContext*, ICommonContexts*, int32_t))(Il2CppBase() + 0x1439868))(this, contexts, portalPoints);
	}
