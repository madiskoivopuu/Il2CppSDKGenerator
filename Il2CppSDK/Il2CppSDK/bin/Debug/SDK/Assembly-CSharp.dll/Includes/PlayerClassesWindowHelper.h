...
public: 
	...
	template <typename R = PlayerClassesWindow*> static R ShowSelectPlayerClass(UIWindowsManager* manager, Il2CppString* current, PlayerClassProgress* selectType, Action1Il2CppString*>* callback) {
		return ((R (*)(void *, UIWindowsManager*, Il2CppString*, PlayerClassProgress*, Action1Il2CppString*>*))(Il2CppBase() + 0x1560360))(0, manager, current, selectType, callback);
	}
