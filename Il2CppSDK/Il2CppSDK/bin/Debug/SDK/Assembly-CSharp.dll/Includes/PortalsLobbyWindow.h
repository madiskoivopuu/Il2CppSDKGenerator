...
class PortalsLobbyWindow: UIWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& WaitingButton() {
	...
	template <typename T = uintptr_t> T& SoloPlayerView() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = uintptr_t> T& SoloDifficultyTooltipTrigger() {
	...
	template <typename T = uintptr_t> T& FamilyDifficultyTooltipTrigger() {
	...
	template <typename T = uintptr_t> T& WinTooltipTrigger() {
		return *(T*)((uintptr_t)this + 0x190);
	}
	template <typename T = uintptr_t> T& LoseTooltipTrigger() {
		return *(T*)((uintptr_t)this + 0x198);
	}
	template <typename T = uintptr_t> T& PowerTooltipTrigger() {
	...
	template <typename T = void> T ShowExistedPortals(uintptr_t account, uintptr_t portal) {
		return ((T (*)(PortalsLobbyWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x157AA14))(this, account, portal);
	}
	template <typename T = void> T ShowCreatePortals(uintptr_t account) {
		return ((T (*)(PortalsLobbyWindow*, uintptr_t))(Il2CppBase() + 0x157A000))(this, account);
	}
	template <typename T = void> T RebuildPlayersInPortal(uintptr_t lobbyEntity) {
		return ((T (*)(PortalsLobbyWindow*, uintptr_t))(Il2CppBase() + 0x157B774))(this, lobbyEntity);
	}
	template <typename T = void> T UpdateButtons(uintptr_t portal, uintptr_t account, uintptr_t state) {
		return ((T (*)(PortalsLobbyWindow*, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x157C308))(this, portal, account, state);
	}
	template <typename T = void> T UpdateTimers(uintptr_t portal) {
		return ((T (*)(PortalsLobbyWindow*, uintptr_t))(Il2CppBase() + 0x157BF00))(this, portal);
	}
	...
	template <typename T = void> T SetCoefText(uintptr_t text, Il2CppVector2 value) {
		return ((T (*)(PortalsLobbyWindow*, uintptr_t, Il2CppVector2))(Il2CppBase() + 0x157C5F0))(this, text, value);
	}
