...
public: 
	...
	template <typename T = uintptr_t> static T& Recommended() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename T = uintptr_t> static T& GlobalLastWeek() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& MainLastWeek() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
