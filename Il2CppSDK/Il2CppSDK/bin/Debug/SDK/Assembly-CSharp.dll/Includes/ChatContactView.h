...
public: 
	...
	template <typename R = ContactsEntity*> R& _entity() {
	 ...
	 Action2ContactsEntity*, bool>*& _onFriendChanged() {
		return *(Action2ContactsEntity*, bool>**)((uintptr_t)this + 0x78);
	}
	 Action2ContactsEntity*, bool>*& _onMuteChanged() {
		return *(Action2ContactsEntity*, bool>**)((uintptr_t)this + 0x80);
	}
	 Action1ContactsEntity*>*& _onSelected() {
		return *(Action1ContactsEntity*>**)((uintptr_t)this + 0x88);
	}
	 Nullable1int32_t>*& _count() {
		return *(Nullable1int32_t>**)((uintptr_t)this + 0x90);
	}
	...
	template <typename R = void> R Initialize(ContactsEntity* entity, Action1ContactsEntity*>* onSelected, Action2ContactsEntity*, bool>* onFavouriteChanged, Action2ContactsEntity*, bool>* onMuteChanged) {
		return ((R (*)(ChatContactView*, ContactsEntity*, Action1ContactsEntity*>*, Action2ContactsEntity*, bool>*, Action2ContactsEntity*, bool>*))(Il2CppBase() + 0x13F1C9C))(this, entity, onSelected, onFavouriteChanged, onMuteChanged);
	}
