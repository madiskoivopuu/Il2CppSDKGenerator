...
public: 
	...
	template <typename T = void*> T& _onFriendChanged() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = void*> T& _onMuteChanged() {
	...
	template <typename T = void> T Initialize(uintptr_t entity, void* onSelected, void* onFavouriteChanged, void* onMuteChanged) {
		return ((T (*)(ChatContactView*, uintptr_t, void*, void*, void*))(Il2CppBase() + 0x13F1C9C))(this, entity, onSelected, onFavouriteChanged, onMuteChanged);
	}
