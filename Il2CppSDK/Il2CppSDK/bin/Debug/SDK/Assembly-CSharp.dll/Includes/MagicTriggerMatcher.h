...
public: 
	...
	template <typename T = void*> static T& _matcherMagicTriggerData() {
	...
	template <typename T = void*> static T& _matcherResetSkipTime() {
	...
	template <typename T = void*> static T get_MagicTriggerData() {
	...
	template <typename T = void*> static T get_ResetSkipTime() {
