...
class GlobalEventWindow: UIWindow1
{
public: 
	...
	template <typename T = void> T QuestClaimClick(uintptr_t view) {
		return ((T (*)(GlobalEventWindow*, uintptr_t))(Il2CppBase() + 0x1774980))(this, view);
	}
	template <typename T = bool> T ShowClaimQuestResult(Il2CppString* questName, uintptr_t result) {
		return ((T (*)(GlobalEventWindow*, Il2CppString*, uintptr_t))(Il2CppBase() + 0x1774B18))(this, questName, result);
	}
