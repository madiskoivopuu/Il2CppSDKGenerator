...
public: 
	...
	template <typename R = void> R Init(Il2CppString* message, Nullable1<float>* lifeTime) {
		return ((R (*)(TextBubble*, Il2CppString*, Nullable1<float>*))(Il2CppBase() + 0x16B6794))(this, message, lifeTime);
	}
