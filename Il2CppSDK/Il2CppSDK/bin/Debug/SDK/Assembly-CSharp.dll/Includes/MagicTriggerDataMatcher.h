...
public: 
	...
	template <typename T = void*> static T& _matcherActionCondition() {
	...
	template <typename T = void*> static T& _matcherActorTriggerConditions() {
	...
	template <typename T = void*> static T& _matcherApplyOwnerMagic() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x50);
	}
	template <typename T = void*> static T& _matcherApplyPlace() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x58);
	}
	template <typename T = void*> static T& _matcherApplyResources() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x60);
	}
	template <typename T = void*> static T& _matcherApplyTargetMagic() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x68);
	}
	template <typename T = void*> static T& _matcherApplyTrigger() {
	...
	template <typename T = void*> static T& _matcherChangeActorCooldown() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x88);
	}
	template <typename T = void*> static T& _matcherChangeDamage() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x90);
	}
	template <typename T = void*> static T& _matcherChangeDurationByLostHp() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x98);
	}
	template <typename T = void*> static T& _matcherChangeHeal() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA0);
	}
	template <typename T = void*> static T& _matcherChangeMagic() {
	...
	template <typename T = void*> static T& _matcherDamageCondition() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xC8);
	}
	template <typename T = void*> static T& _matcherDestroyParentOnEnd() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xD0);
	}
	template <typename T = void*> static T& _matcherDispelFromActor() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xD8);
	}
	template <typename T = void*> static T& _matcherDispelFromTarget() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xE0);
	}
	template <typename T = void*> static T& _matcherDistributeDamage() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xE8);
	}
	template <typename T = void*> static T& _matcherDistributeMagic() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xF0);
	}
	template <typename T = void*> static T& _matcherExecuteGroup() {
	...
	template <typename T = void*> static T& _matcherNeedFilterTargets() {
	...
	template <typename T = void*> static T& _matcherResetSkipCooldown() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x138);
	}
	template <typename T = void*> static T& _matcherSkipCount() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x140);
	}
	template <typename T = void*> static T& _matcherSplash() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x148);
	}
	template <typename T = void*> static T& _matcherSplashDamage() {
	...
	template <typename T = void*> static T& _matcherTargetTriggerConditions() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x168);
	}
	template <typename T = void*> static T& _matcherUseCount() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x170);
	}
	template <typename T = void*> static T& _matcherUseSourceItem() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x178);
	}

	template <typename T = void*> static T get_ActionCondition() {
	...
	template <typename T = void*> static T get_ActorTriggerConditions() {
	...
	template <typename T = void*> static T get_ApplyTrigger() {
	...
	template <typename T = void*> static T get_ChangeActorCooldown() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A4111C))(0);
	}
	template <typename T = void*> static T get_ChangeDamage() {
	...
	template <typename T = void*> static T get_ChangeHeal() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A415F0))(0);
	}
	template <typename T = void*> static T get_ChangeMagic() {
	...
	template <typename T = void*> static T get_DamageCondition() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A41DFC))(0);
	}
	template <typename T = void*> static T get_DestroyParentOnEnd() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A41F98))(0);
	}
	template <typename T = void*> static T get_DispelFromActor() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A42134))(0);
	}
	template <typename T = void*> static T get_DispelFromTarget() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A422D0))(0);
	}
	template <typename T = void*> static T get_DistributeDamage() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A4246C))(0);
	}
	template <typename T = void*> static T get_DistributeMagic() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A42608))(0);
	}
	template <typename T = void*> static T get_ExecuteGroup() {
	...
	template <typename T = void*> static T get_NeedFilterTargets() {
	...
	template <typename T = void*> static T get_ResetSkipCooldown() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A43300))(0);
	}
	template <typename T = void*> static T get_SkipCount() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A434A0))(0);
	}
	template <typename T = void*> static T get_Splash() {
		return ((T (*)(void *))(Il2CppBase() + 0x1A43640))(0);
	}
	template <typename T = void*> static T get_SplashDamage() {
