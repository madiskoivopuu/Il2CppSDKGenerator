...
public: 
	...
	template <typename R = uintptr_t> R& _viewportRectTransform() {
	 ...
	 Il2CppDictionary<PlayerClassType, HashSet1<InventorySlotEntity*>*>*& _classRuneInventories() {
		return *(Il2CppDictionary<PlayerClassType, HashSet1<InventorySlotEntity*>*>**)((uintptr_t)this + 0x148);
	}
	...
	template <typename R = int32_t> R& _currentGhostyRuneInkes() {
	 ...
	 Action1<ClassRuneChangedData>*& OnClassRuneChanged() {
		return *(Action1<ClassRuneChangedData>**)((uintptr_t)this + 0x1A0);
	}
	 Action2<HashSet1<PlayerClassType>*, ClassRuneDeactivatedData>*& OnClassRuneDeactivated() {
		return *(Action2<HashSet1<PlayerClassType>*, ClassRuneDeactivatedData>**)((uintptr_t)this + 0x1A8);
	}

	 Il2CppDictionary<PlayerClassType, HashSet1<InventorySlotEntity*>*>* get_ClassRuneInventories() {
		return ((Il2CppDictionary<PlayerClassType, HashSet1<InventorySlotEntity*>*>* (*)(PlayerClassesWindow*))(Il2CppBase() + 0x1B772B0))(this);
	}
	...
	template <typename R = void> R add_OnClassRuneChanged(Action1<ClassRuneChangedData>* value) {
		return ((R (*)(PlayerClassesWindow*, Action1<ClassRuneChangedData>*))(Il2CppBase() + 0x1B77630))(this, value);
	}
	template <typename R = void> R remove_OnClassRuneChanged(Action1<ClassRuneChangedData>* value) {
		return ((R (*)(PlayerClassesWindow*, Action1<ClassRuneChangedData>*))(Il2CppBase() + 0x1B776D4))(this, value);
	}
	template <typename R = void> R add_OnClassRuneDeactivated(Action2<HashSet1<PlayerClassType>*, ClassRuneDeactivatedData>* value) {
		return ((R (*)(PlayerClassesWindow*, Action2<HashSet1<PlayerClassType>*, ClassRuneDeactivatedData>*))(Il2CppBase() + 0x1B77778))(this, value);
	}
	template <typename R = void> R remove_OnClassRuneDeactivated(Action2<HashSet1<PlayerClassType>*, ClassRuneDeactivatedData>* value) {
		return ((R (*)(PlayerClassesWindow*, Action2<HashSet1<PlayerClassType>*, ClassRuneDeactivatedData>*))(Il2CppBase() + 0x1B7781C))(this, value);
	}
	...
	template <typename R = bool> R CanActivateClass(GameEntity* avatar) {
	 ...
	 ValueTuple2<bool, Il2CppString*>* CanProgressClass(GameEntity* avatar) {
		return ((ValueTuple2<bool, Il2CppString*>* (*)(PlayerClassesWindow*, GameEntity*))(Il2CppBase() + 0x1B7A900))(this, avatar);
	}
	...
	template <typename R = bool> R OnLeftb__83_0(KeyValuePair2<int32_t, IClickable*>* i) {
		return ((R (*)(PlayerClassesWindow*, KeyValuePair2<int32_t, IClickable*>*))(Il2CppBase() + 0x1B7C3EC))(this, i);
	}
	template <typename R = bool> R OnRightb__84_0(KeyValuePair2<int32_t, IClickable*>* i) {
		return ((R (*)(PlayerClassesWindow*, KeyValuePair2<int32_t, IClickable*>*))(Il2CppBase() + 0x1B7C440))(this, i);
	}
