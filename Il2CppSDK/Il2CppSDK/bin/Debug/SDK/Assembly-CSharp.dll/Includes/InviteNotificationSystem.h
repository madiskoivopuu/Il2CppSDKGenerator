...
public: 
	...
	template <typename R = ICommonUnityWorld*> R& _world() {
	 ...
	 ICollector1InviteEntity*>* GetTrigger(IContext1InviteEntity*>* context) {
		return ((ICollector1InviteEntity*>* (*)(InviteNotificationSystem*, IContext1InviteEntity*>*))(Il2CppBase() + 0x12475F8))(this, context);
	}
