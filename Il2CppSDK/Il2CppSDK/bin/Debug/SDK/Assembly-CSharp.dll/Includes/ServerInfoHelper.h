...
public: 
	...
	template <typename T = void> static T Load(ServerInfoContext* context, uintptr_t OnLoad) {
		return ((T (*)(void *, ServerInfoContext*, uintptr_t))(Il2CppBase() + 0x161E8D0))(0, context, OnLoad);
	}
	template <typename T = ServerStatus*> static T ConvertStringToServerStatus(Il2CppString* status) {
		return ((T (*)(void *, Il2CppString*))(Il2CppBase() + 0x161EB38))(0, status);
	}
	template <typename T = ValueTuple2Il2CppString*, Il2CppString*>*> static T GetCurrentRegion() {
