...
public: 
	...
	template <typename T = void> T add_PropertyChanged(uintptr_t value) {
		return ((T (*)(SROptions*, uintptr_t))(Il2CppBase() + 0x1354CD0))(this, value);
	}
	template <typename T = void> T remove_PropertyChanged(uintptr_t value) {
		return ((T (*)(SROptions*, uintptr_t))(Il2CppBase() + 0x1354D70))(this, value);
	}
