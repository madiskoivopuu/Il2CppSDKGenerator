...
public: 
	...
	template <typename R = c*> static R& 9() {
	 ...
	 static Func2bool, Il2CppString*>*& 9__14_0() {
		return *(Func2bool, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 static Func2bool, Il2CppString*>*& 9__14_1() {
		return *(Func2bool, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
