...
public: 
	...
	template <typename T = void> T Put(EmojiActionButton* emojiButton, EmojiSlotElement* oldSlotForCurrent, bool withEvent) {
		return ((T (*)(EmojiSlotElement*, EmojiActionButton*, EmojiSlotElement*, bool))(Il2CppBase() + 0x136C634))(this, emojiButton, oldSlotForCurrent, withEvent);
	}
