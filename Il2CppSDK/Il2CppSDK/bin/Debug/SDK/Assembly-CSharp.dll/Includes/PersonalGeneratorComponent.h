...
public: 
	...
	template <typename T = void> T CopyTo(uintptr_t target) {
		return ((T (*)(PersonalGeneratorComponent*, uintptr_t))(Il2CppBase() + 0x11EAEC8))(this, target);
	}
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(PersonalGeneratorComponent*, uintptr_t))(Il2CppBase() + 0x11EAF8C))(this, blueprintComponent);
	}
