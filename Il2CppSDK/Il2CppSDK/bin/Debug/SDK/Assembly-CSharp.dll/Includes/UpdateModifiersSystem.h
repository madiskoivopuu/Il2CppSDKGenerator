...
public: 
	...
	template <typename R = Il2CppArray<HashSet1GameEntity*>*>*> static R& _sharedBuffer() {
	...
	template <typename R = bool> R Filter(MagicEntity* entity) {
	 ...
	 ICollector1MagicEntity*>* GetTrigger(IContext1MagicEntity*>* context) {
		return ((ICollector1MagicEntity*>* (*)(UpdateModifiersSystem*, IContext1MagicEntity*>*))(Il2CppBase() + 0x153F040))(this, context);
	}
