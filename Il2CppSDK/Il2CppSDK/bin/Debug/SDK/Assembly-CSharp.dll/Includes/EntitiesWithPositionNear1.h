...
public: 
	...
	template <typename T = EntityIndex2uintptr_t, int64_t>*> T& _entityIndex() {
	...
	template <typename T = IEnumerator1uintptr_t>*> T System_Collections_Generic_IEnumerableT_GetEnumerator() {
		return ((T (*)(EntitiesWithPositionNear1*))(Il2CppBase() + 0x0))(this);
	}
