...
public: 
	...
	template <typename T = CurrentWeekRankPointsComponent*> T get_currentWeekRankPoints() {
	...
	template <typename T = GuildLanguageComponent*> T get_guildLanguage() {
	...
	template <typename T = GuildTypeComponent*> T get_guildType() {
	...
	template <typename T = void> T AddGuildType(GuildType* newType) {
		return ((T (*)(GuildEntity*, GuildType*))(Il2CppBase() + 0x12EECCC))(this, newType);
	}
	template <typename T = void> T ReplaceGuildType(GuildType* newType) {
		return ((T (*)(GuildEntity*, GuildType*))(Il2CppBase() + 0x12EEDD0))(this, newType);
	}
	template <typename T = void> T RemoveGuildType() {
		return ((T (*)(GuildEntity*))(Il2CppBase() + 0x12EEED4))(this);
	}
	template <typename T = KilledBosses*> T get_killedBosses() {
	...
	template <typename T = MembersCountComponent*> T get_membersCount() {
	...
	template <typename T = MessageOfTheDayComponent*> T get_messageOfTheDay() {
	...
	template <typename T = void> T AddMessageOfTheDay(uint8_t newType, Il2CppString* newText) {
		return ((T (*)(GuildEntity*, uint8_t, Il2CppString*))(Il2CppBase() + 0x12EF670))(this, newType, newText);
	}
	template <typename T = void> T ReplaceMessageOfTheDay(uint8_t newType, Il2CppString* newText) {
		return ((T (*)(GuildEntity*, uint8_t, Il2CppString*))(Il2CppBase() + 0x12EF78C))(this, newType, newText);
	}
	...
	template <typename T = PreviousWeekRankPointsComponent*> T get_previousWeekRankPoints() {
