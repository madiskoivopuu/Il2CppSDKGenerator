...
public: 
	...
	template <typename R = int32_t> static R GetRangeFromTime(int64_t time, int32_t min, int32_t max) {
	 ...
	 static uintptr_t RandomItem_1(IRandomManager* randomManager, IList1<uintptr_t>* list) {
		return ((uintptr_t (*)(void *, IRandomManager*, IList1<uintptr_t>*))(Il2CppBase() + 0x0))(0, randomManager, list);
	}
	template <typename R = void> static R Shuffle(IRandomManager* randomManager, IList1<uintptr_t>* list) {
		return ((R (*)(void *, IRandomManager*, IList1<uintptr_t>*))(Il2CppBase() + 0x0))(0, randomManager, list);
	}
	template <typename R = void> static R RandomItems(IRandomManager* randomManager, IList1<uintptr_t>* list, int32_t count, IList1<uintptr_t>* resultList) {
		return ((R (*)(void *, IRandomManager*, IList1<uintptr_t>*, int32_t, IList1<uintptr_t>*))(Il2CppBase() + 0x0))(0, randomManager, list, count, resultList);
	}
