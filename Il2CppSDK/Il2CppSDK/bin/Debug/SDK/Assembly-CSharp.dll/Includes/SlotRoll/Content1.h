...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Slot1<TData>*& Slot() {
		return *(Slot1<TData>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = void> R Deinitialize(uintptr_t parent) {
	 ...
	 Slot1<TData>* get_Slot() {
		return ((Slot1<TData>* (*)(Content1*))(Il2CppBase() + 0x0))(this);
	}
	template <typename R = void> R set_Slot(Slot1<TData>* value) {
		return ((R (*)(Content1*, Slot1<TData>*))(Il2CppBase() + 0x0))(this, value);
	}
	template <typename R = void> R SetSlot(Slot1<TData>* slot) {
		return ((R (*)(Content1*, Slot1<TData>*))(Il2CppBase() + 0x0))(this, slot);
	}
