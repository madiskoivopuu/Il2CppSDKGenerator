...
public: 
	...
	template <typename T = Slot1uintptr_t>*> T& Slot() {
	...
	template <typename T = Slot1uintptr_t>*> T get_Slot() {
		return ((T (*)(Content1*))(Il2CppBase() + 0x0))(this);
	}
	template <typename T = void> T set_Slot(Slot1uintptr_t>* value) {
		return ((T (*)(Content1*, Slot1uintptr_t>*))(Il2CppBase() + 0x0))(this, value);
	}
	template <typename T = void> T SetSlot(Slot1uintptr_t>* slot) {
		return ((T (*)(Content1*, Slot1uintptr_t>*))(Il2CppBase() + 0x0))(this, slot);
	}
