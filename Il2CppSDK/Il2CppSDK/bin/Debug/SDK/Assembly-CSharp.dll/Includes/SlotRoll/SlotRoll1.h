...
public: 
	...
	template <typename T = Il2CppList<Slot1uintptr_t>*>*> T& slots() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = Queue1uintptr_t>*> T& pendingContents() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = int32_t> T& addedCount() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	template <typename T = Queue1Content1uintptr_t>*>*> T& removeQueue() {
		return *(T*)((uintptr_t)this + 0x0);
	}
	...
	template <typename T = Il2CppList<Slot1uintptr_t>*>*> T get_Slots() {
		return ((T (*)(SlotRoll1*))(Il2CppBase() + 0x0))(this);
	}
	...
	template <typename T = void> T OnSlotCleared(Content1uintptr_t>* content) {
		return ((T (*)(SlotRoll1*, Content1uintptr_t>*))(Il2CppBase() + 0x0))(this, content);
	}
	template <typename T = bool> T TryToRoll() {
		return ((T (*)(SlotRoll1*))(Il2CppBase() + 0x0))(this);
	}
	template <typename T = void> T OnSlotRolledUp(Content1uintptr_t>* content) {
		return ((T (*)(SlotRoll1*, Content1uintptr_t>*))(Il2CppBase() + 0x0))(this, content);
	}
	...
	template <typename T = void> T OnSlotAdded(Content1uintptr_t>* content) {
		return ((T (*)(SlotRoll1*, Content1uintptr_t>*))(Il2CppBase() + 0x0))(this, content);
	}
