...
public: 
	...
	template <typename R = bool> static R IsCombat(ICommonContexts* world) {
	 ...
	 static Nullable1<int32_t>* GetLocationGrade(ClanEntity* clanEntity, Il2CppString* locationTag) {
		return ((Nullable1<int32_t>* (*)(void *, ClanEntity*, Il2CppString*))(Il2CppBase() + 0x1586314))(0, clanEntity, locationTag);
	}
	 static Nullable1<int32_t>* GetLocationGrade_1(ClanEntity* clanEntity, LocationEntity* location) {
		return ((Nullable1<int32_t>* (*)(void *, ClanEntity*, LocationEntity*))(Il2CppBase() + 0x1586414))(0, clanEntity, location);
	}
