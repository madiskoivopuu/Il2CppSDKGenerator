...
public: 
	...
	template <typename T = LocationMode*> T& Type() {
	...
	template <typename T = Nullable1int32_t>*> T& DifficultyIndex() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = Nullable1int32_t>*> T& LootIndex() {
	...
	template <typename T = void> T CopyTo(Il2CppObject* target) {
		return ((T (*)(LocationModeComponent*, Il2CppObject*))(Il2CppBase() + 0x17BA6F8))(this, target);
	}
