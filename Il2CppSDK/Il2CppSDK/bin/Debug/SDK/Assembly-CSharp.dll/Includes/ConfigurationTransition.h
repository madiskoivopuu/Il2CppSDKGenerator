...
public: 
	...
	template <typename R = int64_t> R& NewWorldId() {
	 ...
	 IEnumerable1ConfigurationVersion*>*& Versions() {
		return *(IEnumerable1ConfigurationVersion*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = int64_t> R get_NewWorldId() {
	 ...
	 IEnumerable1ConfigurationVersion*>* get_Versions() {
		return ((IEnumerable1ConfigurationVersion*>* (*)(ConfigurationTransition*))(Il2CppBase() + 0x15E774C))(this);
	}
