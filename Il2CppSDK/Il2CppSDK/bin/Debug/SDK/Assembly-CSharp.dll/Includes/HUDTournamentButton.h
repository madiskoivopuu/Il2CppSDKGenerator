...
public: 
	...
	template <typename T = VisualElement*> T& _rootVisual() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = VisualElement*> T& _globalVisual() {
		return *(T*)((uintptr_t)this + 0x128);
	}
	template <typename T = VisualElement*> T& _localVisual() {
		return *(T*)((uintptr_t)this + 0x158);
	}
	template <typename T = IGroup1TournamentEntity*>*> T& _globalTournaments() {
	...
	template <typename T = void> T Bind(IHUDWindow* window) {
		return ((T (*)(HUDTournamentButton*, IHUDWindow*))(Il2CppBase() + 0x1282BA0))(this, window);
	}
	...
	template <typename T = TournamentEntity*> T GetGlobalTournament(ICommonClientWorld* world) {
		return ((T (*)(HUDTournamentButton*, ICommonClientWorld*))(Il2CppBase() + 0x1282EF4))(this, world);
	}
	...
	template <typename T = void> T SingleTournamentUpdateDraw(ICommonClientWorld* world, AccountEntity* account, PlayerEntity* ownPlayer, VisualElement* visualElement) {
		return ((T (*)(HUDTournamentButton*, ICommonClientWorld*, AccountEntity*, PlayerEntity*, VisualElement*))(Il2CppBase() + 0x1283E8C))(this, world, account, ownPlayer, visualElement);
	}
	template <typename T = void> T MultyTournamentsUpdateDraw(ICommonClientWorld* world, AccountEntity* account, PlayerEntity* ownPlayer, TournamentEntity* globalTournament) {
		return ((T (*)(HUDTournamentButton*, ICommonClientWorld*, AccountEntity*, PlayerEntity*, TournamentEntity*))(Il2CppBase() + 0x1283A5C))(this, world, account, ownPlayer, globalTournament);
	}
