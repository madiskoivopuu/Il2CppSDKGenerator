...
public: 
	...
	template <typename R = Il2CppString*> static R& DontDismountCDMagic() {
	 ...
	 PrimaryEntityIndex2MagicEntity*, int32_t>*& _idIndex() {
		return *(PrimaryEntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x110);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _actorIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x118);
	}
	 EntityIndex2MagicEntity*, int64_t>*& _ownerIndex() {
		return *(EntityIndex2MagicEntity*, int64_t>**)((uintptr_t)this + 0x120);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _parentIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x128);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _targetIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x130);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _aliveOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x138);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _aliveWithIconOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x140);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _aliveWithItemDescriptionIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x148);
	}
	 EntityIndex2MagicEntity*, IntString*>*& _blueprintOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, IntString*>**)((uintptr_t)this + 0x150);
	}
	 EntityIndex2MagicEntity*, IntInt*>*& _withInventoryIndexOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, IntInt*>**)((uintptr_t)this + 0x158);
	}
	 EntityIndex2MagicEntity*, IntString*>*& _withBlueprintAndActorIndex() {
		return *(EntityIndex2MagicEntity*, IntString*>**)((uintptr_t)this + 0x160);
	}
	 PrimaryEntityIndex2MagicEntity*, IntLong*>*& _withVipOnTargetIndex() {
		return *(PrimaryEntityIndex2MagicEntity*, IntLong*>**)((uintptr_t)this + 0x168);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _sneakOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x170);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _removeOnMoveOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x178);
	}
	 EntityIndex2MagicEntity*, int32_t>*& _permanentOnTargetIndex() {
		return *(EntityIndex2MagicEntity*, int32_t>**)((uintptr_t)this + 0x180);
	}
	...
	template <typename R = MagicDataContext*> R& Data() {
	 ...
	 IGroup1MagicEntity*>*& _aliveWithMagicIcon() {
		return *(IGroup1MagicEntity*>**)((uintptr_t)this + 0x198);
	}
	 IGroup1MagicEntity*>*& _aliveWithLocationPlayerMagic() {
		return *(IGroup1MagicEntity*>**)((uintptr_t)this + 0x1A0);
	}
	 IGroup1MagicEntity*>*& _withRemoveCondition() {
		return *(IGroup1MagicEntity*>**)((uintptr_t)this + 0x1A8);
	}
	 IGroup1MagicEntity*>*& _aliveAuras() {
		return *(IGroup1MagicEntity*>**)((uintptr_t)this + 0x1B0);
	}
	 IGroup1MagicEntity*>*& _aliveWithItemDescription() {
		return *(IGroup1MagicEntity*>**)((uintptr_t)this + 0x1B8);
	}
	...
	template <typename R = MagicEntity*> R GetEntityWithId(int32_t id) {
	 ...
	 HashSet1MagicEntity*>* GetWithParent(int32_t parentId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F5DDC))(this, parentId);
	}
	template <typename R = bool> R HasWithParentOnTarget(int32_t parentId, Il2CppString* name, int32_t targetId) {
	 ...
	 HashSet1MagicEntity*>* GetWithActor(int32_t actorId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F631C))(this, actorId);
	}
	 HashSet1MagicEntity*>* GetWithOwner(int64_t ownerId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int64_t))(Il2CppBase() + 0x11F6684))(this, ownerId);
	}
	 HashSet1MagicEntity*>* GetOnTarget(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F69EC))(this, targetId);
	}
	 HashSet1MagicEntity*>* GetAliveOnTarget(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F6CD4))(this, targetId);
	}
	 HashSet1MagicEntity*>* GetAliveWithMagicIconOnTarget(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F6F28))(this, targetId);
	}
	 HashSet1MagicEntity*>* GetAliveWithItemDescription(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F7304))(this, targetId);
	}
	 HashSet1MagicEntity*>* GetWithBlueprintOnTarget(int32_t targetId, Il2CppString* name) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t, Il2CppString*))(Il2CppBase() + 0x11F76E0))(this, targetId, name);
	}
	 HashSet1MagicEntity*>* GetWithInventoryIndexOnTarget(int32_t targetId, int32_t index) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t, int32_t))(Il2CppBase() + 0x11F7AE0))(this, targetId, index);
	}
	...
	template <typename R = int32_t> R GetAliveWithTagOnTargetCount(int32_t targetId, Il2CppString* tag, bool useStackCount) {
	 ...
	 HashSet1MagicEntity*>* GetWithBlueprintAndActor(int32_t actorId, Il2CppString* name) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t, Il2CppString*))(Il2CppBase() + 0x11F837C))(this, actorId, name);
	}
	template <typename R = MagicEntity*> R GetWithVipOnTarget(int32_t id, VipBonusType* type) {
	 ...
	 HashSet1MagicEntity*>* GetSneakOnTarget(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F8B24))(this, targetId);
	}
	 HashSet1MagicEntity*>* GetRemoveOnMoveOnTarget(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F8E4C))(this, targetId);
	}
	 HashSet1MagicEntity*>* GetPermanentOnTarget(int32_t targetId) {
		return ((HashSet1MagicEntity*>* (*)(MagicContext*, int32_t))(Il2CppBase() + 0x11F9174))(this, targetId);
	}
	 IGroup1MagicEntity*>* GetAliveWithMagicIcon() {
		return ((IGroup1MagicEntity*>* (*)(MagicContext*))(Il2CppBase() + 0x11F7098))(this);
	}
	 IGroup1MagicEntity*>* GetAliveWithLocationPlayerMagic() {
		return ((IGroup1MagicEntity*>* (*)(MagicContext*))(Il2CppBase() + 0x11F949C))(this);
	}
	 IGroup1MagicEntity*>* GetWithRemoveCondition() {
		return ((IGroup1MagicEntity*>* (*)(MagicContext*))(Il2CppBase() + 0x11F9708))(this);
	}
	 IGroup1MagicEntity*>* GetAliveAuras() {
		return ((IGroup1MagicEntity*>* (*)(MagicContext*))(Il2CppBase() + 0x11F9A04))(this);
	}
	 IGroup1MagicEntity*>* GetAliveWithItemDescription_1() {
		return ((IGroup1MagicEntity*>* (*)(MagicContext*))(Il2CppBase() + 0x11F7474))(this);
	}
	template <typename R = MagicEntity*> R UpdateMagic(int64_t updateTime, UpdateMagicData* data) {
	 ...
	 ValueTuple2MagicEntity*, bool>* CreateMagicFromData(int64_t updateTime, CreateMagicData* data) {
		return ((ValueTuple2MagicEntity*, bool>* (*)(MagicContext*, int64_t, CreateMagicData*))(Il2CppBase() + 0x11F9E1C))(this, updateTime, data);
	}
	...
	template <typename R = void> R CreateOrExtendMagic_1(ICommonContexts* world, Il2CppString* magicName, GameEntity* target, Nullable1int64_t>* teamId, Nullable1float>* duration) {
		return ((R (*)(MagicContext*, ICommonContexts*, Il2CppString*, GameEntity*, Nullable1int64_t>*, Nullable1float>*))(Il2CppBase() + 0x11FB198))(this, world, magicName, target, teamId, duration);
	}
	...
	template <typename R = bool> R Remove(HashSet1MagicEntity*>* magics, Predicate1MagicEntity*>* predicate) {
		return ((R (*)(MagicContext*, HashSet1MagicEntity*>*, Predicate1MagicEntity*>*))(Il2CppBase() + 0x11FDDD8))(this, magics, predicate);
	}
