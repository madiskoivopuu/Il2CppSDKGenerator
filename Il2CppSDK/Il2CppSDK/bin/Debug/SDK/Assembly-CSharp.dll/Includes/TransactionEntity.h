...
public: 
	...
	template <typename R = void> R AddCallback(Action2<TransactionEntity*, bool>* newMethod) {
		return ((R (*)(TransactionEntity*, Action2<TransactionEntity*, bool>*))(Il2CppBase() + 0x151793C))(this, newMethod);
	}
	template <typename R = void> R ReplaceCallback(Action2<TransactionEntity*, bool>* newMethod) {
		return ((R (*)(TransactionEntity*, Action2<TransactionEntity*, bool>*))(Il2CppBase() + 0x1517A50))(this, newMethod);
	}
