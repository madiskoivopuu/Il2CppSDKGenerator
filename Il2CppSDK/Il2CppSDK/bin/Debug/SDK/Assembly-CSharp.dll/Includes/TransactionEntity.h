...
public: 
	...
	template <typename T = AnalyticsDataComponent*> T get_analyticsData() {
	...
	template <typename T = void> T AddBattlePassAddLevels(CurrencyType* newCurrencyType, int32_t newAddLevels) {
		return ((T (*)(TransactionEntity*, CurrencyType*, int32_t))(Il2CppBase() + 0x1517720))(this, newCurrencyType, newAddLevels);
	}
	template <typename T = void> T ReplaceBattlePassAddLevels(CurrencyType* newCurrencyType, int32_t newAddLevels) {
		return ((T (*)(TransactionEntity*, CurrencyType*, int32_t))(Il2CppBase() + 0x1517828))(this, newCurrencyType, newAddLevels);
	}
	template <typename T = void> T RemoveBattlePassAddLevels() {
		return ((T (*)(TransactionEntity*))(Il2CppBase() + 0x1517930))(this);
	}
	template <typename T = CallbackComponent*> T get_callback() {
	...
	template <typename T = void> T AddCallback(Action2TransactionEntity*, bool>* newMethod) {
		return ((T (*)(TransactionEntity*, Action2TransactionEntity*, bool>*))(Il2CppBase() + 0x151793C))(this, newMethod);
	}
	template <typename T = void> T ReplaceCallback(Action2TransactionEntity*, bool>* newMethod) {
		return ((T (*)(TransactionEntity*, Action2TransactionEntity*, bool>*))(Il2CppBase() + 0x1517A50))(this, newMethod);
	}
	...
	template <typename T = HuaweiTokenComponent*> T get_huaweiToken() {
	...
	template <typename T = PurchaceErrorComponent*> T get_purchaceError() {
	...
	template <typename T = void> T AddPurchaceError(PurchaceErrorEnum* newValue) {
		return ((T (*)(TransactionEntity*, PurchaceErrorEnum*))(Il2CppBase() + 0x151AEBC))(this, newValue);
	}
	template <typename T = void> T ReplacePurchaceError(PurchaceErrorEnum* newValue) {
		return ((T (*)(TransactionEntity*, PurchaceErrorEnum*))(Il2CppBase() + 0x151AFC0))(this, newValue);
	}
	...
	template <typename T = ReceiptComponent*> T get_receipt() {
	...
	template <typename T = SavingsPackLevelComponent*> T get_savingsPackLevel() {
	...
	template <typename T = StoreComponent*> T get_store() {
	...
	template <typename T = TransactionComponent*> T get_transaction() {
	...
	template <typename T = TransactionTypeComponent*> T get_transactionType() {
	...
	template <typename T = void> T AddTransactionType(TransactionType* newType) {
		return ((T (*)(TransactionEntity*, TransactionType*))(Il2CppBase() + 0x151D0F8))(this, newType);
	}
	template <typename T = void> T ReplaceTransactionType(TransactionType* newType) {
		return ((T (*)(TransactionEntity*, TransactionType*))(Il2CppBase() + 0x151D1FC))(this, newType);
	}
	template <typename T = void> T RemoveTransactionType() {
		return ((T (*)(TransactionEntity*))(Il2CppBase() + 0x151D300))(this);
	}
	template <typename T = USDPriceComponent*> T get_uSDPrice() {
	...
	template <typename T = VipResourcesComponent*> T get_vipResources() {
