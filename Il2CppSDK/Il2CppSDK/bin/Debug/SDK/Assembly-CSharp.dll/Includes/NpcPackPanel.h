...
public: 
	...
	template <typename R = uintptr_t> R& SoldOutText() {
	 ...
	 Action2<int64_t, int32_t>*& _onProductClicked() {
		return *(Action2<int64_t, int32_t>**)((uintptr_t)this + 0xC0);
	}
	...
	template <typename R = void> R Init(Store2Entity* product, Store2DataEntity* data, StoreCategory storeCategory, Action2<int64_t, int32_t>* onProductClicked, bool canBeOneRewardStyle, TooltipView* tooltip) {
		return ((R (*)(NpcPackPanel*, Store2Entity*, Store2DataEntity*, StoreCategory, Action2<int64_t, int32_t>*, bool, TooltipView*))(Il2CppBase() + 0x13C63A0))(this, product, data, storeCategory, onProductClicked, canBeOneRewardStyle, tooltip);
	}
