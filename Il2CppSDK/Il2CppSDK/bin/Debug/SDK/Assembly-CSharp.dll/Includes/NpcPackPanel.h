...
public: 
	...
	template <typename T = uintptr_t> T& SingleTooltipTrigger() {
	...
	template <typename T = void> T Init(uintptr_t product, uintptr_t data, uintptr_t storeCategory, void* onProductClicked, bool canBeOneRewardStyle, uintptr_t tooltip) {
		return ((T (*)(NpcPackPanel*, uintptr_t, uintptr_t, uintptr_t, void*, bool, uintptr_t))(Il2CppBase() + 0x13C63A0))(this, product, data, storeCategory, onProductClicked, canBeOneRewardStyle, tooltip);
	}
