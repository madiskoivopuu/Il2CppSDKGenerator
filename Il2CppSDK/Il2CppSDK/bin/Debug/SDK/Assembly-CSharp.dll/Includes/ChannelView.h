...
public: 
	...
	template <typename R = UIWindow*> R& _window() {
	 ...
	 Action1ChannelView*>*& _onClicked() {
		return *(Action1ChannelView*>**)((uintptr_t)this + 0x58);
	}
	...
	template <typename R = void> R Init(UIWindow* window, ChatRoom* room, ChatChannelData* channelData, bool isSelected, Action1ChannelView*>* onClicked) {
		return ((R (*)(ChannelView*, UIWindow*, ChatRoom*, ChatChannelData*, bool, Action1ChannelView*>*))(Il2CppBase() + 0x13EBDDC))(this, window, room, channelData, isSelected, onClicked);
	}
