...
public: 
	...
	template <typename T = uintptr_t> T& ChannelData() {
	...
	template <typename T = void> T Init(uintptr_t window, uintptr_t room, uintptr_t channelData, bool isSelected, void* onClicked) {
		return ((T (*)(ChannelView*, uintptr_t, uintptr_t, uintptr_t, bool, void*))(Il2CppBase() + 0x13EBDDC))(this, window, room, channelData, isSelected, onClicked);
	}
