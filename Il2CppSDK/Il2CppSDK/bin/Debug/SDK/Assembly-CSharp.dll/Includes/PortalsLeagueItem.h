...
#include "BattlePassItem" 

class PortalsLeagueItem: BattlePassItem
{
public: 
	...
	template <typename T = uintptr_t> T& _tooltipTrigger() {
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t item) {
		return ((T (*)(PortalsLeagueItem*, uintptr_t, uintptr_t))(Il2CppBase() + 0x15779B0))(this, window, item);
	}
	...
	template <typename T = void> T UpdateStepView(uintptr_t item) {
		return ((T (*)(PortalsLeagueItem*, uintptr_t))(Il2CppBase() + 0x1577B54))(this, item);
	}
