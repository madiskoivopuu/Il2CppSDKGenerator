...
public: 
	...
	template <typename T = Il2CppObject*> static T& _threadLock() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, OldComponentLookup*>*> static T& _oldComponentsLookup() {
	...
	template <typename T = OldComponentLookup*> static T GetComponentWithName(Il2CppString* componentKey) {
