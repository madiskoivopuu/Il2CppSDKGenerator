...
public: 
	...
	template <typename T = AdsManager*> static T& _instance() {
	...
	template <typename T = LocalAdState*> T& LocalAdState() {
	...
	template <typename T = AdsActor*> T& _adsActor() {
	...
	template <typename T = AdsManager*> static T get_Instance() {
		return ((T (*)(void *))(Il2CppBase() + 0x12980AC))(0);
	}
	template <typename T = LocalAdState*> T get_LocalAdState() {
		return ((T (*)(AdsManager*))(Il2CppBase() + 0x12981A4))(this);
	}
	template <typename T = void> T set_LocalAdState(LocalAdState* value) {
		return ((T (*)(AdsManager*, LocalAdState*))(Il2CppBase() + 0x12981AC))(this, value);
	}
	...
	template <typename T = void> T ShowAd(AdsActor* adsActor, uintptr_t onComplete, uintptr_t onFailed) {
		return ((T (*)(AdsManager*, AdsActor*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1298A38))(this, adsActor, onComplete, onFailed);
	}
	...
	template <typename T = void> T AdFailedLoad(IronSourceError* obj) {
		return ((T (*)(AdsManager*, IronSourceError*))(Il2CppBase() + 0x129932C))(this, obj);
	}
	template <typename T = void> T UserRewarded(IronSourcePlacement* obj) {
		return ((T (*)(AdsManager*, IronSourcePlacement*))(Il2CppBase() + 0x1299710))(this, obj);
	}
	...
	template <typename T = void> T AdFailedShow(IronSourceError* obj) {
		return ((T (*)(AdsManager*, IronSourceError*))(Il2CppBase() + 0x1299A20))(this, obj);
	}
