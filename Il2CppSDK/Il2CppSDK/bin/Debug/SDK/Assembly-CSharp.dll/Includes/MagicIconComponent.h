...
public: 
	...
	template <typename T = MagicIconShowType*> T& Show() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = bool> T& ShowCount() {
		return *(T*)((uintptr_t)this + 0x19);
	}
	template <typename T = MagicIconViewerType*> T& Viewer() {
	...
	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(MagicIconComponent*, Il2CppObject*))(Il2CppBase() + 0x1AD9EE8))(this, targetObject);
	}
