...
public: 
	...
	template <typename R = uintptr_t> R& Selected() {
	 ...
	 Action1<AccountInfoView*>*& _onSelected() {
		return *(Action1<AccountInfoView*>**)((uintptr_t)this + 0x48);
	}
	...
	template <typename R = void> R Init(int64_t playerId, Action1<AccountInfoView*>* onSelected) {
		return ((R (*)(AccountInfoView*, int64_t, Action1<AccountInfoView*>*))(Il2CppBase() + 0xFD0B48))(this, playerId, onSelected);
	}
