...
public: 
	...
	template <typename T = Action1AccountInfoView*>*> T& _onSelected() {
	...
	template <typename T = void> T Init(int64_t playerId, Action1AccountInfoView*>* onSelected) {
		return ((T (*)(AccountInfoView*, int64_t, Action1AccountInfoView*>*))(Il2CppBase() + 0xFD0B48))(this, playerId, onSelected);
	}
