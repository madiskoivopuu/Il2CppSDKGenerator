...
public: 
	...
	template <typename T = uintptr_t> T& _emulation() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = uintptr_t> T& _windowsManager() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = uintptr_t> T& _notificationsManager() {
	...
	template <typename T = uintptr_t> T& GameLoader() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = uintptr_t> T& ProgressBar() {
		return *(T*)((uintptr_t)this + 0x68);
	}
	template <typename T = uintptr_t> T& LogManager() {
		return *(T*)((uintptr_t)this + 0x70);
	}
	template <typename T = void*> T& OnUpdate() {
		return *(T*)((uintptr_t)this + 0x78);
	}
	template <typename T = void*> static T& OnQualityChanged() {
	...
	template <typename T = uintptr_t> T& _noInternetWindow() {
	...
	template <typename T = uintptr_t> T& ArenaParams() {
		return *(T*)((uintptr_t)this + 0xD0);
	}
	template <typename T = uintptr_t> T& MapParams() {
	...
	template <typename T = void> T set_Analytics(uintptr_t value) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x188ED30))(this, value);
	}
	template <typename T = uintptr_t> static T get_Logger() {
		return ((T (*)(void *))(Il2CppBase() + 0x188ED38))(0);
	}
	template <typename T = void> static T set_Logger(uintptr_t value) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x188ED84))(0, value);
	}
	...
	template <typename T = void> T set_DataContexts(uintptr_t value) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x188EDE0))(this, value);
	}
	...
	template <typename T = void> T set_SharedContexts(uintptr_t value) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x188EDF0))(this, value);
	}
	template <typename T = uintptr_t> T get_GameLoader() {
		return ((T (*)(AppController*))(Il2CppBase() + 0x188EDF8))(this);
	}
	template <typename T = void> T set_GameLoader(uintptr_t value) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x188EE00))(this, value);
	}
	template <typename T = uintptr_t> T get_ProgressBar() {
		return ((T (*)(AppController*))(Il2CppBase() + 0x188EE08))(this);
	}
	template <typename T = void> T set_ProgressBar(uintptr_t value) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x188EE10))(this, value);
	}
	template <typename T = uintptr_t> T get_ChatManager() {
		return ((T (*)(AppController*))(Il2CppBase() + 0x188EE18))(this);
	}
	template <typename T = uintptr_t> T get_LogManager() {
		return ((T (*)(AppController*))(Il2CppBase() + 0x188EE20))(this);
	}
	template <typename T = void> T set_LogManager(uintptr_t value) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x188EE28))(this, value);
	}
	template <typename T = void> T add_OnUpdate(void* value) {
		return ((T (*)(AppController*, void*))(Il2CppBase() + 0x188EE30))(this, value);
	}
	template <typename T = void> T remove_OnUpdate(void* value) {
		return ((T (*)(AppController*, void*))(Il2CppBase() + 0x188EED0))(this, value);
	}
	...
	template <typename T = void> T ShowStartScreenIfNeedb__98_0(uintptr_t w) {
		return ((T (*)(AppController*, uintptr_t))(Il2CppBase() + 0x1892598))(this, w);
	}
