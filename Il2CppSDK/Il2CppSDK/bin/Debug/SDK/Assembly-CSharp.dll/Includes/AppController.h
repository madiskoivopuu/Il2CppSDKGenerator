...
public: 
	...
	template <typename R = LogManager*> R& LogManager() {
	 ...
	 Action1<float>*& OnUpdate() {
		return *(Action1<float>**)((uintptr_t)this + 0x78);
	}
	 static Action1<int32_t>*& OnQualityChanged() {
		return *(Action1<int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	...
	template <typename R = void> R add_OnUpdate(Action1<float>* value) {
		return ((R (*)(AppController*, Action1<float>*))(Il2CppBase() + 0x188EE30))(this, value);
	}
	template <typename R = void> R remove_OnUpdate(Action1<float>* value) {
		return ((R (*)(AppController*, Action1<float>*))(Il2CppBase() + 0x188EED0))(this, value);
	}
