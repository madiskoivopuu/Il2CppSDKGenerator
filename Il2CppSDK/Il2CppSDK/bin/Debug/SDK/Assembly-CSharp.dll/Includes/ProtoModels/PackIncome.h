...
public: 
	...
	template <typename T = MessageParser1PackIncome*>*> static T& _parser() {
	...
	template <typename T = MessageParser1PackIncome*>*> static T get_Parser() {
	...
	template <typename T = PackIncome*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PackIncome*, Il2CppObject*))(Il2CppBase() + 0x11E6DD0))(this, other);
	}
	template <typename T = bool> T Equals_1(PackIncome* other) {
		return ((T (*)(PackIncome*, PackIncome*))(Il2CppBase() + 0x11E6E40))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PackIncome* other) {
		return ((T (*)(PackIncome*, PackIncome*))(Il2CppBase() + 0x11E71E4))(this, other);
	}
