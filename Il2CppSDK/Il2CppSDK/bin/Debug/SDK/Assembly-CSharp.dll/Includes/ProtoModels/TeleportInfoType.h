...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(TeleportInfoType*, uintptr_t))(Il2CppBase() + 0x16ADC3C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(TeleportInfoType*, uintptr_t))(Il2CppBase() + 0x16ADCE8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(TeleportInfoType*, uintptr_t))(Il2CppBase() + 0x16ADFCC))(this, other);
	}
