...
public: 
	...
	template <typename T = MessageParser1TcpTransportRequest*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& CommandFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = TcpCommandEnum*> T& command_() {
	...
	template <typename T = MessageParser1TcpTransportRequest*>*> static T get_Parser() {
	...
	template <typename T = TcpTransportRequest*> T Clone() {
		return ((T (*)(TcpTransportRequest*))(Il2CppBase() + 0x16ACBE0))(this);
	}
	template <typename T = TcpCommandEnum*> T get_Command() {
		return ((T (*)(TcpTransportRequest*))(Il2CppBase() + 0x16ACC3C))(this);
	}
	template <typename T = void> T set_Command(TcpCommandEnum* value) {
		return ((T (*)(TcpTransportRequest*, TcpCommandEnum*))(Il2CppBase() + 0x16ACC44))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(TcpTransportRequest*, Il2CppObject*))(Il2CppBase() + 0x16ACCE4))(this, other);
	}
	template <typename T = bool> T Equals_1(TcpTransportRequest* other) {
		return ((T (*)(TcpTransportRequest*, TcpTransportRequest*))(Il2CppBase() + 0x16ACD54))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(TcpTransportRequest* other) {
		return ((T (*)(TcpTransportRequest*, TcpTransportRequest*))(Il2CppBase() + 0x16AD0E0))(this, other);
	}
