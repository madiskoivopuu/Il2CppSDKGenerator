...
public: 
	...
	template <typename T = MessageParser1VipUser*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1VipUserBonus*>*> static T& _repeated_vipBonuses_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1VipUserBonus*>*> T& vipBonuses_() {
		return *(T*)((uintptr_t)this + 0x18);
	}

	template <typename T = MessageParser1VipUser*>*> static T get_Parser() {
	...
	template <typename T = VipUser*> T Clone() {
	...
	template <typename T = RepeatedField1VipUserBonus*>*> T get_VipBonuses() {
		return ((T (*)(VipUser*))(Il2CppBase() + 0x15CF92C))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(VipUser*, Il2CppObject*))(Il2CppBase() + 0x15CF934))(this, other);
	}
	template <typename T = bool> T Equals_1(VipUser* other) {
		return ((T (*)(VipUser*, VipUser*))(Il2CppBase() + 0x15CF9A4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(VipUser* other) {
		return ((T (*)(VipUser*, VipUser*))(Il2CppBase() + 0x15CFCBC))(this, other);
	}
