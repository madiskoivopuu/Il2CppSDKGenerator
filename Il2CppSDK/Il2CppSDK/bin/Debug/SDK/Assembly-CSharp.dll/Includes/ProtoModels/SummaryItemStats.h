...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::SummaryItemStats*>*& _parser() {
		return *(MessageParser1ProtoModels::SummaryItemStats*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& StatFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static CodecIl2CppString*, int32_t>*& _map_stat_codec() {
		return *(CodecIl2CppString*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2Il2CppString*, int32_t>*& stat_() {
		return *(MapField2Il2CppString*, int32_t>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::SummaryItemStats*>* get_Parser() {
		return ((MessageParser1ProtoModels::SummaryItemStats*>* (*)(void *))(Il2CppBase() + 0x16A1A9C))(0);
	}
	...
	template <typename R = ProtoModels::SummaryItemStats*> R Clone() {
	 ...
	 MapField2Il2CppString*, int32_t>* get_Stat() {
		return ((MapField2Il2CppString*, int32_t>* (*)(SummaryItemStats*))(Il2CppBase() + 0x16A1DD4))(this);
	}
