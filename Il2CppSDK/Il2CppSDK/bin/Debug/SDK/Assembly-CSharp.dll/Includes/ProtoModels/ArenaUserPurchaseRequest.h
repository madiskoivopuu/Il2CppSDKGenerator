...
public: 
	...
	template <typename T = MessageParser1ArenaUserPurchaseRequest*>*> static T& _parser() {
	...
	template <typename T = ArenaThirdPartyTransaction*> T& transaction_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1ArenaUserPurchaseRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUserPurchaseRequest*> T Clone() {
	...
	template <typename T = ArenaThirdPartyTransaction*> T get_Transaction() {
		return ((T (*)(ArenaUserPurchaseRequest*))(Il2CppBase() + 0x2862CC8))(this);
	}
	template <typename T = void> T set_Transaction(ArenaThirdPartyTransaction* value) {
		return ((T (*)(ArenaUserPurchaseRequest*, ArenaThirdPartyTransaction*))(Il2CppBase() + 0x2862CD0))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUserPurchaseRequest*, Il2CppObject*))(Il2CppBase() + 0x2862CD8))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUserPurchaseRequest* other) {
		return ((T (*)(ArenaUserPurchaseRequest*, ArenaUserPurchaseRequest*))(Il2CppBase() + 0x2862D48))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUserPurchaseRequest* other) {
		return ((T (*)(ArenaUserPurchaseRequest*, ArenaUserPurchaseRequest*))(Il2CppBase() + 0x28630BC))(this, other);
	}
