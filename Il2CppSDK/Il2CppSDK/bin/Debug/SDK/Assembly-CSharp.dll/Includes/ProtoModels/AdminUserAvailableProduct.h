...
public: 
	...
	template <typename T = uintptr_t> T& product_() {
	...
	template <typename T = uintptr_t> T get_Product() {
		return ((T (*)(AdminUserAvailableProduct*))(Il2CppBase() + 0x129701C))(this);
	}
	template <typename T = void> T set_Product(uintptr_t value) {
		return ((T (*)(AdminUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0x1297024))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0x129702C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0x129709C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0x129731C))(this, other);
	}
