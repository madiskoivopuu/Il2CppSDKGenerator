...
public: 
	...
	template <typename T = MessageParser1Can*>*> static T& _parser() {
	...
	template <typename T = MessageParser1Can*>*> static T get_Parser() {
	...
	template <typename T = Can*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(Can*, Il2CppObject*))(Il2CppBase() + 0x15B5930))(this, other);
	}
	template <typename T = bool> T Equals_1(Can* other) {
		return ((T (*)(Can*, Can*))(Il2CppBase() + 0x15B59C8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(Can* other) {
		return ((T (*)(Can*, Can*))(Il2CppBase() + 0x15B5B10))(this, other);
	}
