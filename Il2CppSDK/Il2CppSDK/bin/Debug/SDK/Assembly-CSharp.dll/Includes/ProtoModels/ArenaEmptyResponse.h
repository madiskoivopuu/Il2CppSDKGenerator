...
public: 
	...
	template <typename T = MessageParser1ArenaEmptyResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaEmptyResponse*>*> static T get_Parser() {
	...
	template <typename T = ArenaEmptyResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaEmptyResponse*, Il2CppObject*))(Il2CppBase() + 0x1E1DF6C))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaEmptyResponse* other) {
		return ((T (*)(ArenaEmptyResponse*, ArenaEmptyResponse*))(Il2CppBase() + 0x1E1DFDC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaEmptyResponse* other) {
		return ((T (*)(ArenaEmptyResponse*, ArenaEmptyResponse*))(Il2CppBase() + 0x1E1E254))(this, other);
	}
