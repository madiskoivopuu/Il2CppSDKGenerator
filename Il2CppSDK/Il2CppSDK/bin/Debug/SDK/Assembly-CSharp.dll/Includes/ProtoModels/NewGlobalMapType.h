...
public: 
	...
	template <typename T = MessageParser1NewGlobalMapType*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_transport_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& transport_() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = int32_t> static T& NeedLocationFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_needLocation_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& needLocation_() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = int32_t> static T& NeedLocationPointsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_needLocationPoints_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& needLocationPoints_() {
	...
	template <typename T = ArenaPortalInfoData*> T& portalData_() {
		return *(T*)((uintptr_t)this + 0x70);
	}

	template <typename T = MessageParser1NewGlobalMapType*>*> static T get_Parser() {
	...
	template <typename T = NewGlobalMapType*> T Clone() {
	...
	template <typename T = RepeatedField1Il2CppString*>*> T get_Transport() {
		return ((T (*)(NewGlobalMapType*))(Il2CppBase() + 0x13ABFBC))(this);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T get_NeedLocation() {
		return ((T (*)(NewGlobalMapType*))(Il2CppBase() + 0x13ABFC4))(this);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T get_NeedLocationPoints() {
	...
	template <typename T = ArenaPortalInfoData*> T get_PortalData() {
		return ((T (*)(NewGlobalMapType*))(Il2CppBase() + 0x13AC08C))(this);
	}
	template <typename T = void> T set_PortalData(ArenaPortalInfoData* value) {
		return ((T (*)(NewGlobalMapType*, ArenaPortalInfoData*))(Il2CppBase() + 0x13AC094))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(NewGlobalMapType*, Il2CppObject*))(Il2CppBase() + 0x13AC09C))(this, other);
	}
	template <typename T = bool> T Equals_1(NewGlobalMapType* other) {
		return ((T (*)(NewGlobalMapType*, NewGlobalMapType*))(Il2CppBase() + 0x13AC10C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(NewGlobalMapType* other) {
		return ((T (*)(NewGlobalMapType*, NewGlobalMapType*))(Il2CppBase() + 0x13ACBA0))(this, other);
	}
