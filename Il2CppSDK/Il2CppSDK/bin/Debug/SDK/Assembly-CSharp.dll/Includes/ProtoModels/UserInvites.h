...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::UserInvites*>*& _parser() {
		return *(MessageParser1ProtoModels::UserInvites*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& InvitesFieldNumber() {
	 ...
	 RepeatedField1ProtoModels::Invite*>*& invites_() {
		return *(RepeatedField1ProtoModels::Invite*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = Il2CppString*> R& codeMessage_() {
	 ...
	 static MessageParser1ProtoModels::UserInvites*>* get_Parser() {
		return ((MessageParser1ProtoModels::UserInvites*>* (*)(void *))(Il2CppBase() + 0x246D420))(0);
	}
	...
	template <typename R = ProtoModels::UserInvites*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::Invite*>* get_Invites() {
		return ((RepeatedField1ProtoModels::Invite*>* (*)(UserInvites*))(Il2CppBase() + 0x246D794))(this);
	}
