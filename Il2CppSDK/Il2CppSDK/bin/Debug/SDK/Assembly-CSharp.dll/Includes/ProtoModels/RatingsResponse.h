...
public: 
	...
	template <typename T = MessageParser1RatingsResponse*>*> static T& _parser() {
	...
	template <typename T = GuildsRating*> T& guild_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& GlobalTourneyFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = GlobalTourney*> T& globalTourney_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1RatingsResponse*>*> static T get_Parser() {
	...
	template <typename T = RatingsResponse*> T Clone() {
	...
	template <typename T = GuildsRating*> T get_Guild() {
		return ((T (*)(RatingsResponse*))(Il2CppBase() + 0x171BD18))(this);
	}
	template <typename T = void> T set_Guild(GuildsRating* value) {
		return ((T (*)(RatingsResponse*, GuildsRating*))(Il2CppBase() + 0x171BD20))(this, value);
	}
	template <typename T = GlobalTourney*> T get_GlobalTourney() {
		return ((T (*)(RatingsResponse*))(Il2CppBase() + 0x171BD28))(this);
	}
	template <typename T = void> T set_GlobalTourney(GlobalTourney* value) {
		return ((T (*)(RatingsResponse*, GlobalTourney*))(Il2CppBase() + 0x171BD30))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(RatingsResponse*, Il2CppObject*))(Il2CppBase() + 0x171BD38))(this, other);
	}
	template <typename T = bool> T Equals_1(RatingsResponse* other) {
		return ((T (*)(RatingsResponse*, RatingsResponse*))(Il2CppBase() + 0x171BDA8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(RatingsResponse* other) {
		return ((T (*)(RatingsResponse*, RatingsResponse*))(Il2CppBase() + 0x171C15C))(this, other);
	}
