...
public: 
	...
	template <typename T = void> T set_CurrencyType(uintptr_t value) {
		return ((T (*)(ArenaStoreCurrencyPack*, uintptr_t))(Il2CppBase() + 0x271A194))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaStoreCurrencyPack*, uintptr_t))(Il2CppBase() + 0x271A1AC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaStoreCurrencyPack*, uintptr_t))(Il2CppBase() + 0x271A248))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaStoreCurrencyPack*, uintptr_t))(Il2CppBase() + 0x271A490))(this, other);
	}
