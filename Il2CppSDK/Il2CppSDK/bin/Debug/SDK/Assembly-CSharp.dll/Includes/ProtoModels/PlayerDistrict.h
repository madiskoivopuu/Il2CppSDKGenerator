...
public: 
	...
	template <typename T = MessageParser1PlayerDistrict*>*> static T& _parser() {
	...
	template <typename T = MessageParser1PlayerDistrict*>*> static T get_Parser() {
	...
	template <typename T = PlayerDistrict*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PlayerDistrict*, Il2CppObject*))(Il2CppBase() + 0x1563D64))(this, other);
	}
	template <typename T = bool> T Equals_1(PlayerDistrict* other) {
		return ((T (*)(PlayerDistrict*, PlayerDistrict*))(Il2CppBase() + 0x1563DF0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PlayerDistrict* other) {
		return ((T (*)(PlayerDistrict*, PlayerDistrict*))(Il2CppBase() + 0x1563F98))(this, other);
	}
