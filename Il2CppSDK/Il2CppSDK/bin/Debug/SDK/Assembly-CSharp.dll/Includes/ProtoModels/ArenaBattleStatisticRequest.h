...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBattleStatisticRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaBattleStatisticRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& data_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBattleStatisticRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaBattleStatisticRequest*>* (*)(void *))(Il2CppBase() + 0x1A18890))(0);
	}
