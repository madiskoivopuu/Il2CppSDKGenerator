...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaBattleStatisticRequest*, uintptr_t))(Il2CppBase() + 0x1A18C14))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaBattleStatisticRequest*, uintptr_t))(Il2CppBase() + 0x1A18C84))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaBattleStatisticRequest*, uintptr_t))(Il2CppBase() + 0x1A18F98))(this, other);
	}
