...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserProductProgressData*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserProductProgressData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& AditionalFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::UserProductProgressDataItem*>*& _repeated_aditional_codec() {
		return *(FieldCodec1<ProtoModels::UserProductProgressDataItem*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::UserProductProgressDataItem*>*& aditional_() {
		return *(RepeatedField1<ProtoModels::UserProductProgressDataItem*>**)((uintptr_t)this + 0x18);
	}

	 static MessageParser1<ProtoModels::UserProductProgressData*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserProductProgressData*>* (*)(void *))(Il2CppBase() + 0x247104C))(0);
	}
	...
	template <typename R = void> R set_Base(ProtoModels::UserProductProgressDataItem* value) {
	 ...
	 RepeatedField1<ProtoModels::UserProductProgressDataItem*>* get_Aditional() {
		return ((RepeatedField1<ProtoModels::UserProductProgressDataItem*>* (*)(UserProductProgressData*))(Il2CppBase() + 0x247141C))(this);
	}
