...
public: 
	...
	template <typename T = MessageParser1UserPutRequisiteRequest*>*> static T& _parser() {
	...
	template <typename T = Requisite*> T& putRequisite_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1UserPutRequisiteRequest*>*> static T get_Parser() {
	...
	template <typename T = UserPutRequisiteRequest*> T Clone() {
	...
	template <typename T = Requisite*> T get_PutRequisite() {
		return ((T (*)(UserPutRequisiteRequest*))(Il2CppBase() + 0x2474C18))(this);
	}
	template <typename T = void> T set_PutRequisite(Requisite* value) {
		return ((T (*)(UserPutRequisiteRequest*, Requisite*))(Il2CppBase() + 0x2474C20))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserPutRequisiteRequest*, Il2CppObject*))(Il2CppBase() + 0x2474C28))(this, other);
	}
	template <typename T = bool> T Equals_1(UserPutRequisiteRequest* other) {
		return ((T (*)(UserPutRequisiteRequest*, UserPutRequisiteRequest*))(Il2CppBase() + 0x2474C98))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserPutRequisiteRequest* other) {
		return ((T (*)(UserPutRequisiteRequest*, UserPutRequisiteRequest*))(Il2CppBase() + 0x2474F74))(this, other);
	}
