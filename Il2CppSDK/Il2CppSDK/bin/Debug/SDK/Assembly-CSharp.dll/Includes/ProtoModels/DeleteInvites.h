...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::DeleteInvites*>*& _parser() {
		return *(MessageParser1<ProtoModels::DeleteInvites*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& InviteIDsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<int64_t>*& _repeated_inviteIDs_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<int64_t>*& inviteIDs_() {
		return *(RepeatedField1<int64_t>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1<ProtoModels::DeleteInvites*>* get_Parser() {
		return ((MessageParser1<ProtoModels::DeleteInvites*>* (*)(void *))(Il2CppBase() + 0xEB8E38))(0);
	}
	...
	template <typename R = ProtoModels::DeleteInvites*> R Clone() {
	 ...
	 RepeatedField1<int64_t>* get_InviteIDs() {
		return ((RepeatedField1<int64_t>* (*)(DeleteInvites*))(Il2CppBase() + 0xEB9170))(this);
	}
