...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetWorldsRequest*, uintptr_t))(Il2CppBase() + 0x18BACC0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetWorldsRequest*, uintptr_t))(Il2CppBase() + 0x18BAD68))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetWorldsRequest*, uintptr_t))(Il2CppBase() + 0x18BAF9C))(this, other);
	}
