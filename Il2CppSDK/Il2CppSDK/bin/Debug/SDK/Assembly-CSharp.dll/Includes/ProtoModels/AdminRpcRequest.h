...
public: 
	...
	template <typename T = MessageParser1AdminRpcRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1AdminRpcRequest*>*> static T get_Parser() {
	...
	template <typename T = AdminRpcRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminRpcRequest*, Il2CppObject*))(Il2CppBase() + 0x1294954))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminRpcRequest* other) {
		return ((T (*)(AdminRpcRequest*, AdminRpcRequest*))(Il2CppBase() + 0x12949C4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminRpcRequest* other) {
		return ((T (*)(AdminRpcRequest*, AdminRpcRequest*))(Il2CppBase() + 0x1294C3C))(this, other);
	}
