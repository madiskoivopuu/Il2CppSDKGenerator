...
public: 
	...
	template <typename T = MessageParser1UserKillBoss*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserKillBoss*>*> static T get_Parser() {
	...
	template <typename T = UserKillBoss*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserKillBoss*, Il2CppObject*))(Il2CppBase() + 0x246E3AC))(this, other);
	}
	template <typename T = bool> T Equals_1(UserKillBoss* other) {
		return ((T (*)(UserKillBoss*, UserKillBoss*))(Il2CppBase() + 0x246E41C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserKillBoss* other) {
		return ((T (*)(UserKillBoss*, UserKillBoss*))(Il2CppBase() + 0x246E7D0))(this, other);
	}
