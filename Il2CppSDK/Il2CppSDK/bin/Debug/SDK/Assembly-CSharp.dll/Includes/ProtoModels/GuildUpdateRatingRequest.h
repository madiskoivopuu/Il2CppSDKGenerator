...
public: 
	...
	template <typename T = MessageParser1GuildUpdateRatingRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildUpdateRatingRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildUpdateRatingRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildUpdateRatingRequest*, Il2CppObject*))(Il2CppBase() + 0x19465E0))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildUpdateRatingRequest* other) {
		return ((T (*)(GuildUpdateRatingRequest*, GuildUpdateRatingRequest*))(Il2CppBase() + 0x1946650))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildUpdateRatingRequest* other) {
		return ((T (*)(GuildUpdateRatingRequest*, GuildUpdateRatingRequest*))(Il2CppBase() + 0x19469CC))(this, other);
	}
