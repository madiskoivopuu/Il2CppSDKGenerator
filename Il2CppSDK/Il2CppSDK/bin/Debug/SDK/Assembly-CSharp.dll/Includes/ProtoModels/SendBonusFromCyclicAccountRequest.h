...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(SendBonusFromCyclicAccountRequest*, uintptr_t))(Il2CppBase() + 0x13637FC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(SendBonusFromCyclicAccountRequest*, uintptr_t))(Il2CppBase() + 0x136386C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(SendBonusFromCyclicAccountRequest*, uintptr_t))(Il2CppBase() + 0x1363C24))(this, other);
	}
