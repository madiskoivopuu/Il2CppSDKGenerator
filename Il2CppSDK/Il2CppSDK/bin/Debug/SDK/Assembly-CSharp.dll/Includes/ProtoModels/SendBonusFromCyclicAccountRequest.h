...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::SendBonusFromCyclicAccountRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::SendBonusFromCyclicAccountRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& count_() {
	 ...
	 static MessageParser1ProtoModels::SendBonusFromCyclicAccountRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::SendBonusFromCyclicAccountRequest*>* (*)(void *))(Il2CppBase() + 0x136345C))(0);
	}
