...
public: 
	...
	template <typename T = MessageParser1ArenaUserIncomeToMapSlotRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUserIncomeToMapSlotRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUserIncomeToMapSlotRequest*> T Clone() {
	...
	template <typename T = void> T set_Inventory(ArenaUserInventoryData* value) {
		return ((T (*)(ArenaUserIncomeToMapSlotRequest*, ArenaUserInventoryData*))(Il2CppBase() + 0x285C9BC))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUserIncomeToMapSlotRequest*, Il2CppObject*))(Il2CppBase() + 0x285C9F4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUserIncomeToMapSlotRequest* other) {
		return ((T (*)(ArenaUserIncomeToMapSlotRequest*, ArenaUserIncomeToMapSlotRequest*))(Il2CppBase() + 0x285CA64))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUserIncomeToMapSlotRequest* other) {
		return ((T (*)(ArenaUserIncomeToMapSlotRequest*, ArenaUserIncomeToMapSlotRequest*))(Il2CppBase() + 0x285CFB4))(this, other);
	}
