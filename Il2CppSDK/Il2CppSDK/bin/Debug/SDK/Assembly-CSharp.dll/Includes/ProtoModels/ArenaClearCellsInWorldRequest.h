...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClearCellsInWorldRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaClearCellsInWorldRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& CellsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::EmptyCell*>*& _repeated_cells_codec() {
		return *(FieldCodec1<ProtoModels::EmptyCell*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::EmptyCell*>*& cells_() {
		return *(RepeatedField1<ProtoModels::EmptyCell*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::ArenaClearCellsInWorldRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaClearCellsInWorldRequest*>* (*)(void *))(Il2CppBase() + 0x1A1E094))(0);
	}
	...
	template <typename R = void> R set_CallbackID(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::EmptyCell*>* get_Cells() {
		return ((RepeatedField1<ProtoModels::EmptyCell*>* (*)(ArenaClearCellsInWorldRequest*))(Il2CppBase() + 0x1A1E3FC))(this);
	}
