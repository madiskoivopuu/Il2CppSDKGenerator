...
public: 
	...
	template <typename T = MessageParser1ArenaClearCellsInWorldRequest*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1EmptyCell*>*> static T& _repeated_cells_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1EmptyCell*>*> T& cells_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1ArenaClearCellsInWorldRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaClearCellsInWorldRequest*> T Clone() {
	...
	template <typename T = RepeatedField1EmptyCell*>*> T get_Cells() {
		return ((T (*)(ArenaClearCellsInWorldRequest*))(Il2CppBase() + 0x1A1E3FC))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaClearCellsInWorldRequest*, Il2CppObject*))(Il2CppBase() + 0x1A1E404))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaClearCellsInWorldRequest* other) {
		return ((T (*)(ArenaClearCellsInWorldRequest*, ArenaClearCellsInWorldRequest*))(Il2CppBase() + 0x1A1E474))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaClearCellsInWorldRequest* other) {
		return ((T (*)(ArenaClearCellsInWorldRequest*, ArenaClearCellsInWorldRequest*))(Il2CppBase() + 0x1A1E828))(this, other);
	}
