...
public: 
	...
	template <typename T = MessageParser1IncompletePurchaseHistory*>*> static T& _parser() {
	...
	template <typename T = MessageParser1IncompletePurchaseHistory*>*> static T get_Parser() {
	...
	template <typename T = IncompletePurchaseHistory*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(IncompletePurchaseHistory*, Il2CppObject*))(Il2CppBase() + 0x1E3F180))(this, other);
	}
	template <typename T = bool> T Equals_1(IncompletePurchaseHistory* other) {
		return ((T (*)(IncompletePurchaseHistory*, IncompletePurchaseHistory*))(Il2CppBase() + 0x1E3F1F0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(IncompletePurchaseHistory* other) {
		return ((T (*)(IncompletePurchaseHistory*, IncompletePurchaseHistory*))(Il2CppBase() + 0x1E3F48C))(this, other);
	}
