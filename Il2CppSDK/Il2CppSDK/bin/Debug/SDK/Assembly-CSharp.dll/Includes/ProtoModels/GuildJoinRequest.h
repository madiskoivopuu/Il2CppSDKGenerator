...
public: 
	...
	template <typename T = MessageParser1GuildJoinRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildJoinRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildJoinRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildJoinRequest*, Il2CppObject*))(Il2CppBase() + 0x1B33540))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildJoinRequest* other) {
		return ((T (*)(GuildJoinRequest*, GuildJoinRequest*))(Il2CppBase() + 0x1B335EC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildJoinRequest* other) {
		return ((T (*)(GuildJoinRequest*, GuildJoinRequest*))(Il2CppBase() + 0x1B338D0))(this, other);
	}
