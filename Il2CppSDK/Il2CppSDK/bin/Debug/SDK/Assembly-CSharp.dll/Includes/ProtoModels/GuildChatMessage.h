...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GuildChatMessage*>*& _parser() {
		return *(MessageParser1<ProtoModels::GuildChatMessage*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& DataFieldNumber() {
	 ...
	 static Codec<Il2CppString*, Il2CppString*>*& _map_data_codec() {
		return *(Codec<Il2CppString*, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2<Il2CppString*, Il2CppString*>*& data_() {
		return *(MapField2<Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1<ProtoModels::GuildChatMessage*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GuildChatMessage*>* (*)(void *))(Il2CppBase() + 0x12E8A50))(0);
	}
	...
	template <typename R = void> R set_Type(ProtoModels::GuildEventType value) {
	 ...
	 MapField2<Il2CppString*, Il2CppString*>* get_Data() {
		return ((MapField2<Il2CppString*, Il2CppString*>* (*)(GuildChatMessage*))(Il2CppBase() + 0x12E8DD0))(this);
	}
