...
public: 
	...
	template <typename T = MessageParser1GuildChatMessage*>*> static T& _parser() {
	...
	template <typename T = GuildEventType*> T& type_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& DataFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = CodecIl2CppString*, Il2CppString*>*> static T& _map_data_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = MapField2Il2CppString*, Il2CppString*>*> T& data_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1GuildChatMessage*>*> static T get_Parser() {
	...
	template <typename T = GuildChatMessage*> T Clone() {
	...
	template <typename T = GuildEventType*> T get_Type() {
		return ((T (*)(GuildChatMessage*))(Il2CppBase() + 0x12E8DC0))(this);
	}
	template <typename T = void> T set_Type(GuildEventType* value) {
		return ((T (*)(GuildChatMessage*, GuildEventType*))(Il2CppBase() + 0x12E8DC8))(this, value);
	}
	template <typename T = MapField2Il2CppString*, Il2CppString*>*> T get_Data() {
		return ((T (*)(GuildChatMessage*))(Il2CppBase() + 0x12E8DD0))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildChatMessage*, Il2CppObject*))(Il2CppBase() + 0x12E8DD8))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildChatMessage* other) {
		return ((T (*)(GuildChatMessage*, GuildChatMessage*))(Il2CppBase() + 0x12E8E48))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildChatMessage* other) {
		return ((T (*)(GuildChatMessage*, GuildChatMessage*))(Il2CppBase() + 0x12E9294))(this, other);
	}
