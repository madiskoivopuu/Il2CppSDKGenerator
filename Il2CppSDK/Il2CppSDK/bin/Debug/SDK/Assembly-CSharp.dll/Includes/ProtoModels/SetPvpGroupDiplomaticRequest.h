...
public: 
	...
	template <typename T = MessageParser1SetPvpGroupDiplomaticRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1SetPvpGroupDiplomaticRequest*>*> static T get_Parser() {
	...
	template <typename T = SetPvpGroupDiplomaticRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(SetPvpGroupDiplomaticRequest*, Il2CppObject*))(Il2CppBase() + 0x1624C4C))(this, other);
	}
	template <typename T = bool> T Equals_1(SetPvpGroupDiplomaticRequest* other) {
		return ((T (*)(SetPvpGroupDiplomaticRequest*, SetPvpGroupDiplomaticRequest*))(Il2CppBase() + 0x1624CBC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(SetPvpGroupDiplomaticRequest* other) {
		return ((T (*)(SetPvpGroupDiplomaticRequest*, SetPvpGroupDiplomaticRequest*))(Il2CppBase() + 0x1625020))(this, other);
	}
