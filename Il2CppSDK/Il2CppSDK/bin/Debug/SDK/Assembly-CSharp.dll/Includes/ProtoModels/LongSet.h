...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::LongSet*>*& _parser() {
		return *(MessageParser1ProtoModels::LongSet*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ValuesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_values_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1int64_t>*& values_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::LongSet*>* get_Parser() {
		return ((MessageParser1ProtoModels::LongSet*>* (*)(void *))(Il2CppBase() + 0x1732704))(0);
	}
	...
	template <typename R = ProtoModels::LongSet*> R Clone() {
	 ...
	 RepeatedField1int64_t>* get_Values() {
		return ((RepeatedField1int64_t>* (*)(LongSet*))(Il2CppBase() + 0x1732A3C))(this);
	}
