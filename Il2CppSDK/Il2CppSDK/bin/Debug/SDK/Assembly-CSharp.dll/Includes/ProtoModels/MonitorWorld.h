...
public: 
	...
	template <typename T = MessageParser1MonitorWorld*>*> static T& _parser() {
	...
	template <typename T = MessageParser1MonitorWorld*>*> static T get_Parser() {
	...
	template <typename T = MonitorWorld*> T Clone() {
	...
	template <typename T = void> T set_SLevel(ServerLevel* value) {
		return ((T (*)(MonitorWorld*, ServerLevel*))(Il2CppBase() + 0x1EA9E9C))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(MonitorWorld*, Il2CppObject*))(Il2CppBase() + 0x1EA9F54))(this, other);
	}
	template <typename T = bool> T Equals_1(MonitorWorld* other) {
		return ((T (*)(MonitorWorld*, MonitorWorld*))(Il2CppBase() + 0x1EA9FC4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(MonitorWorld* other) {
		return ((T (*)(MonitorWorld*, MonitorWorld*))(Il2CppBase() + 0x1EAA50C))(this, other);
	}
