...
public: 
	...
	template <typename T = MessageParser1WaitMeUserToCoordinatorResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1WaitMeUserToCoordinatorResponse*>*> static T get_Parser() {
	...
	template <typename T = WaitMeUserToCoordinatorResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(WaitMeUserToCoordinatorResponse*, Il2CppObject*))(Il2CppBase() + 0x15D19B4))(this, other);
	}
	template <typename T = bool> T Equals_1(WaitMeUserToCoordinatorResponse* other) {
		return ((T (*)(WaitMeUserToCoordinatorResponse*, WaitMeUserToCoordinatorResponse*))(Il2CppBase() + 0x15D1A24))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(WaitMeUserToCoordinatorResponse* other) {
		return ((T (*)(WaitMeUserToCoordinatorResponse*, WaitMeUserToCoordinatorResponse*))(Il2CppBase() + 0x15D1C9C))(this, other);
	}
