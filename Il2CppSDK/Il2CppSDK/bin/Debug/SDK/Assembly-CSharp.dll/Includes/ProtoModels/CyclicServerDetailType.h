...
public: 
	...
	template <typename T = MessageParser1CyclicServerDetailType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1CyclicServerDetailType*>*> static T get_Parser() {
	...
	template <typename T = CyclicServerDetailType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CyclicServerDetailType*, Il2CppObject*))(Il2CppBase() + 0x1646960))(this, other);
	}
	template <typename T = bool> T Equals_1(CyclicServerDetailType* other) {
		return ((T (*)(CyclicServerDetailType*, CyclicServerDetailType*))(Il2CppBase() + 0x16469D0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CyclicServerDetailType* other) {
		return ((T (*)(CyclicServerDetailType*, CyclicServerDetailType*))(Il2CppBase() + 0x1646C6C))(this, other);
	}
