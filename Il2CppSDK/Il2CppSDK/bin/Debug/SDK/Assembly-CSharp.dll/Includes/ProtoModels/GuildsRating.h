...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::GuildsRating*>*& _parser() {
		return *(MessageParser1ProtoModels::GuildsRating*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& GlobalGuildsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::GlobalGuild*>*& _repeated_globalGuilds_codec() {
		return *(FieldCodec1ProtoModels::GlobalGuild*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::GlobalGuild*>*& globalGuilds_() {
	...
	template <typename R = int32_t> static R& LocalGuildsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::GuildMessageType*>*& _repeated_localGuilds_codec() {
		return *(FieldCodec1ProtoModels::GuildMessageType*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::GuildMessageType*>*& localGuilds_() {
		return *(RepeatedField1ProtoModels::GuildMessageType*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = int32_t> static R& LocalPrevGuildsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::GlobalGuild*>*& _repeated_localPrevGuilds_codec() {
		return *(FieldCodec1ProtoModels::GlobalGuild*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1ProtoModels::GlobalGuild*>*& localPrevGuilds_() {
		return *(RepeatedField1ProtoModels::GlobalGuild*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1ProtoModels::GuildsRating*>* get_Parser() {
		return ((MessageParser1ProtoModels::GuildsRating*>* (*)(void *))(Il2CppBase() + 0x14473B4))(0);
	}
	...
	template <typename R = ProtoModels::GuildsRating*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::GlobalGuild*>* get_GlobalGuilds() {
		return ((RepeatedField1ProtoModels::GlobalGuild*>* (*)(GuildsRating*))(Il2CppBase() + 0x14477FC))(this);
	}
	 RepeatedField1ProtoModels::GuildMessageType*>* get_LocalGuilds() {
		return ((RepeatedField1ProtoModels::GuildMessageType*>* (*)(GuildsRating*))(Il2CppBase() + 0x1447804))(this);
	}
	 RepeatedField1ProtoModels::GlobalGuild*>* get_GlobalPrevGuilds() {
		return ((RepeatedField1ProtoModels::GlobalGuild*>* (*)(GuildsRating*))(Il2CppBase() + 0x144780C))(this);
	}
	 RepeatedField1ProtoModels::GlobalGuild*>* get_LocalPrevGuilds() {
		return ((RepeatedField1ProtoModels::GlobalGuild*>* (*)(GuildsRating*))(Il2CppBase() + 0x1447814))(this);
	}
