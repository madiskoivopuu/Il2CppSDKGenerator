...
public: 
	...
	template <typename T = uintptr_t> T& btype_() {
	...
	template <typename T = uintptr_t> T get_Btype() {
		return ((T (*)(AdminSaveJsonDataRequest*))(Il2CppBase() + 0x1295C8C))(this);
	}
	template <typename T = void> T set_Btype(uintptr_t value) {
		return ((T (*)(AdminSaveJsonDataRequest*, uintptr_t))(Il2CppBase() + 0x1295C94))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminSaveJsonDataRequest*, uintptr_t))(Il2CppBase() + 0x1295D34))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminSaveJsonDataRequest*, uintptr_t))(Il2CppBase() + 0x1295DA4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminSaveJsonDataRequest*, uintptr_t))(Il2CppBase() + 0x12961F0))(this, other);
	}
