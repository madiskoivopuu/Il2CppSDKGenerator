...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AdminSaveJsonDataRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::AdminSaveJsonDataRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& dungeonID_() {
	 ...
	 static MessageParser1<ProtoModels::AdminSaveJsonDataRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AdminSaveJsonDataRequest*>* (*)(void *))(Il2CppBase() + 0x129597C))(0);
	}
