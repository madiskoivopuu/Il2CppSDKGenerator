...
public: 
	...
	template <typename T = MessageParser1GetGuildRequest*>*> static T& _parser() {
	...
	template <typename T = GuildSearchType*> T& searchType_() {
	...
	template <typename T = MessageParser1GetGuildRequest*>*> static T get_Parser() {
	...
	template <typename T = GetGuildRequest*> T Clone() {
	...
	template <typename T = GuildSearchType*> T get_SearchType() {
		return ((T (*)(GetGuildRequest*))(Il2CppBase() + 0x176FEFC))(this);
	}
	template <typename T = void> T set_SearchType(GuildSearchType* value) {
		return ((T (*)(GetGuildRequest*, GuildSearchType*))(Il2CppBase() + 0x176FF04))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GetGuildRequest*, Il2CppObject*))(Il2CppBase() + 0x176FF1C))(this, other);
	}
	template <typename T = bool> T Equals_1(GetGuildRequest* other) {
		return ((T (*)(GetGuildRequest*, GetGuildRequest*))(Il2CppBase() + 0x176FF8C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GetGuildRequest* other) {
		return ((T (*)(GetGuildRequest*, GetGuildRequest*))(Il2CppBase() + 0x1770344))(this, other);
	}
