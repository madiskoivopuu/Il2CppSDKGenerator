...
public: 
	...
	template <typename T = uintptr_t> T& users_() {
	...
	template <typename T = uintptr_t> T get_Users() {
		return ((T (*)(ArenaUnLinkKefirResponse*))(Il2CppBase() + 0xF47328))(this);
	}
	template <typename T = void> T set_Users(uintptr_t value) {
		return ((T (*)(ArenaUnLinkKefirResponse*, uintptr_t))(Il2CppBase() + 0xF47330))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUnLinkKefirResponse*, uintptr_t))(Il2CppBase() + 0xF47338))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUnLinkKefirResponse*, uintptr_t))(Il2CppBase() + 0xF473A8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUnLinkKefirResponse*, uintptr_t))(Il2CppBase() + 0xF477E8))(this, other);
	}
