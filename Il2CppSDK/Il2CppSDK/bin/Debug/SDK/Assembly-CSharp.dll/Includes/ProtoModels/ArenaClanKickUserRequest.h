...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaClanKickUserRequest*, uintptr_t))(Il2CppBase() + 0x1A1C720))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaClanKickUserRequest*, uintptr_t))(Il2CppBase() + 0x1A1C7CC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaClanKickUserRequest*, uintptr_t))(Il2CppBase() + 0x1A1CAB0))(this, other);
	}
