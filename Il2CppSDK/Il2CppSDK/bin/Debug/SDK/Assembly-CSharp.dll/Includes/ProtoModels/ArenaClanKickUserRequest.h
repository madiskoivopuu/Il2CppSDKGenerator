...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaClanKickUserRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaClanKickUserRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& kickUserID_() {
	 ...
	 static MessageParser1ProtoModels::ArenaClanKickUserRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaClanKickUserRequest*>* (*)(void *))(Il2CppBase() + 0x1A1C468))(0);
	}
