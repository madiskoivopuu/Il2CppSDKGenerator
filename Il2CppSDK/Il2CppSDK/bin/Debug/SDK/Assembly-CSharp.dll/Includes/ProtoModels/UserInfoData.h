...
public: 
	...
	template <typename T = MessageParser1UserInfoData*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserInfoData*>*> static T get_Parser() {
	...
	template <typename T = UserInfoData*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserInfoData*, Il2CppObject*))(Il2CppBase() + 0x246CA88))(this, other);
	}
	template <typename T = bool> T Equals_1(UserInfoData* other) {
		return ((T (*)(UserInfoData*, UserInfoData*))(Il2CppBase() + 0x246CAF8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserInfoData* other) {
		return ((T (*)(UserInfoData*, UserInfoData*))(Il2CppBase() + 0x246D10C))(this, other);
	}
