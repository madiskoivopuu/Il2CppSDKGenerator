...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserEmptyResponse*, uintptr_t))(Il2CppBase() + 0x24666B8))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserEmptyResponse*, uintptr_t))(Il2CppBase() + 0x2466728))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserEmptyResponse*, uintptr_t))(Il2CppBase() + 0x24669A0))(this, other);
	}
