...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminLoadJsonDataResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminLoadJsonDataResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& world_() {
	 ...
	 static MessageParser1ProtoModels::AdminLoadJsonDataResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminLoadJsonDataResponse*>* (*)(void *))(Il2CppBase() + 0x1293A58))(0);
	}
