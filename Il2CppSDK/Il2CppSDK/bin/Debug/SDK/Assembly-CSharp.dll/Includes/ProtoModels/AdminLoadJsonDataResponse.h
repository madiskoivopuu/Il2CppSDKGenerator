...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminLoadJsonDataResponse*, uintptr_t))(Il2CppBase() + 0x1293F14))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminLoadJsonDataResponse*, uintptr_t))(Il2CppBase() + 0x1293F84))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminLoadJsonDataResponse*, uintptr_t))(Il2CppBase() + 0x129436C))(this, other);
	}
