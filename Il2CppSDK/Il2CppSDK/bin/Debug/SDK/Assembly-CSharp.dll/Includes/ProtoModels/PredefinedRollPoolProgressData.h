...
public: 
	...
	template <typename T = void*> static T& _repeated_productPositions_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& productPositions_() {
	...
	template <typename T = void*> T get_ProductPositions() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PredefinedRollPoolProgressData*, uintptr_t))(Il2CppBase() + 0x16DDD68))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PredefinedRollPoolProgressData*, uintptr_t))(Il2CppBase() + 0x16DDDD8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PredefinedRollPoolProgressData*, uintptr_t))(Il2CppBase() + 0x16DE0F8))(this, other);
	}
