...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::PredefinedRollPoolProgressData*>*& _parser() {
		return *(MessageParser1<ProtoModels::PredefinedRollPoolProgressData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ProductPositionsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<int32_t>*& _repeated_productPositions_codec() {
		return *(FieldCodec1<int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<int32_t>*& productPositions_() {
	...
	template <typename R = int32_t> R& position_() {
	 ...
	 static MessageParser1<ProtoModels::PredefinedRollPoolProgressData*>* get_Parser() {
		return ((MessageParser1<ProtoModels::PredefinedRollPoolProgressData*>* (*)(void *))(Il2CppBase() + 0x16DDA0C))(0);
	}
	...
	template <typename R = ProtoModels::PredefinedRollPoolProgressData*> R Clone() {
	 ...
	 RepeatedField1<int32_t>* get_ProductPositions() {
		return ((RepeatedField1<int32_t>* (*)(PredefinedRollPoolProgressData*))(Il2CppBase() + 0x16DDD50))(this);
	}
