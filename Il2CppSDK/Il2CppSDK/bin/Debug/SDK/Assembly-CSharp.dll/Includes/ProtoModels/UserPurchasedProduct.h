...
public: 
	...
	template <typename T = MessageParser1UserPurchasedProduct*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserPurchasedProduct*>*> static T get_Parser() {
	...
	template <typename T = UserPurchasedProduct*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserPurchasedProduct*, Il2CppObject*))(Il2CppBase() + 0x2472688))(this, other);
	}
	template <typename T = bool> T Equals_1(UserPurchasedProduct* other) {
		return ((T (*)(UserPurchasedProduct*, UserPurchasedProduct*))(Il2CppBase() + 0x24726F8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserPurchasedProduct* other) {
		return ((T (*)(UserPurchasedProduct*, UserPurchasedProduct*))(Il2CppBase() + 0x2472B94))(this, other);
	}
