...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::GuildStartQuestRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::GuildStartQuestRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PlayerRewardsFieldNumber() {
	 ...
	 RepeatedField1int32_t>*& playerRewards_() {
		return *(RepeatedField1int32_t>**)((uintptr_t)this + 0x38);
	}

	 static MessageParser1ProtoModels::GuildStartQuestRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::GuildStartQuestRequest*>* (*)(void *))(Il2CppBase() + 0x194393C))(0);
	}
	...
	template <typename R = void> R set_MaxGuildRankPoints(int32_t value) {
	 ...
	 RepeatedField1int32_t>* get_PlayerRewards() {
		return ((RepeatedField1int32_t>* (*)(GuildStartQuestRequest*))(Il2CppBase() + 0x1943DC0))(this);
	}
