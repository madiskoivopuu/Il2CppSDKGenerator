...
public: 
	...
	template <typename T = void> T set_Configuration(uintptr_t value) {
		return ((T (*)(ArenaRegisterResponse*, uintptr_t))(Il2CppBase() + 0x1A94984))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaRegisterResponse*, uintptr_t))(Il2CppBase() + 0x1A9498C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaRegisterResponse*, uintptr_t))(Il2CppBase() + 0x1A949FC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaRegisterResponse*, uintptr_t))(Il2CppBase() + 0x1A94D20))(this, other);
	}
