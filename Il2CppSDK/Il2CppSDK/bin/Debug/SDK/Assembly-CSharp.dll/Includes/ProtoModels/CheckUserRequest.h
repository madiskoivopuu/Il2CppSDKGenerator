...
public: 
	...
	template <typename T = MessageParser1CheckUserRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1CheckUserRequest*>*> static T get_Parser() {
	...
	template <typename T = CheckUserRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CheckUserRequest*, Il2CppObject*))(Il2CppBase() + 0x173D8D8))(this, other);
	}
	template <typename T = bool> T Equals_1(CheckUserRequest* other) {
		return ((T (*)(CheckUserRequest*, CheckUserRequest*))(Il2CppBase() + 0x173D948))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CheckUserRequest* other) {
		return ((T (*)(CheckUserRequest*, CheckUserRequest*))(Il2CppBase() + 0x173DD44))(this, other);
	}
