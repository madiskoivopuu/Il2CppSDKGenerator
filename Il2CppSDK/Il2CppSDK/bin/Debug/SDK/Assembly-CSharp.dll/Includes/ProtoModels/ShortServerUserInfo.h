...
public: 
	...
	template <typename T = MessageParser1ShortServerUserInfo*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ShortServerUserInfo*>*> static T get_Parser() {
	...
	template <typename T = ShortServerUserInfo*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ShortServerUserInfo*, Il2CppObject*))(Il2CppBase() + 0x1630F30))(this, other);
	}
	template <typename T = bool> T Equals_1(ShortServerUserInfo* other) {
		return ((T (*)(ShortServerUserInfo*, ShortServerUserInfo*))(Il2CppBase() + 0x1630FA0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ShortServerUserInfo* other) {
		return ((T (*)(ShortServerUserInfo*, ShortServerUserInfo*))(Il2CppBase() + 0x16312F0))(this, other);
	}
