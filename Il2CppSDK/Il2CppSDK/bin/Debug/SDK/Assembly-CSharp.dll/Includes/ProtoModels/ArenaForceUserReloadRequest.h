...
public: 
	...
	template <typename T = MessageParser1ArenaForceUserReloadRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaForceUserReloadRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaForceUserReloadRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaForceUserReloadRequest*, Il2CppObject*))(Il2CppBase() + 0x1E1FBA4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaForceUserReloadRequest* other) {
		return ((T (*)(ArenaForceUserReloadRequest*, ArenaForceUserReloadRequest*))(Il2CppBase() + 0x1E1FC14))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaForceUserReloadRequest* other) {
		return ((T (*)(ArenaForceUserReloadRequest*, ArenaForceUserReloadRequest*))(Il2CppBase() + 0x1E1FFB4))(this, other);
	}
