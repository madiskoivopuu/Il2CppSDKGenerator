...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaForceUserReloadRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaForceUserReloadRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& inGlobalMap_() {
	 ...
	 static MessageParser1ProtoModels::ArenaForceUserReloadRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaForceUserReloadRequest*>* (*)(void *))(Il2CppBase() + 0x1E1F800))(0);
	}
