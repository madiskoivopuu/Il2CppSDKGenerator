...
public: 
	...
	template <typename T = MessageParser1BotCommandUserToArenaRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1BotCommandUserToArenaRequest*>*> static T get_Parser() {
	...
	template <typename T = BotCommandUserToArenaRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(BotCommandUserToArenaRequest*, Il2CppObject*))(Il2CppBase() + 0x16D18EC))(this, other);
	}
	template <typename T = bool> T Equals_1(BotCommandUserToArenaRequest* other) {
		return ((T (*)(BotCommandUserToArenaRequest*, BotCommandUserToArenaRequest*))(Il2CppBase() + 0x16D195C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(BotCommandUserToArenaRequest* other) {
		return ((T (*)(BotCommandUserToArenaRequest*, BotCommandUserToArenaRequest*))(Il2CppBase() + 0x16D1C70))(this, other);
	}
