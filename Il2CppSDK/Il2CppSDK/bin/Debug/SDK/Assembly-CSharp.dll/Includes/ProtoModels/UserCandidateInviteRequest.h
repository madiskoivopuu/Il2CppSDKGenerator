...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserCandidateInviteRequest*, uintptr_t))(Il2CppBase() + 0x2463424))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserCandidateInviteRequest*, uintptr_t))(Il2CppBase() + 0x24634C0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserCandidateInviteRequest*, uintptr_t))(Il2CppBase() + 0x2463708))(this, other);
	}
