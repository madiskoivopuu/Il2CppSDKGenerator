...
public: 
	...
	template <typename T = MessageParser1StoreCategory*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1StoreCategoryEvent*>*> static T& _repeated_events_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1StoreCategoryEvent*>*> T& events_() {
	...
	template <typename T = MessageParser1StoreCategory*>*> static T get_Parser() {
	...
	template <typename T = StoreCategory*> T Clone() {
	...
	template <typename T = RepeatedField1StoreCategoryEvent*>*> T get_Events() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(StoreCategory*, Il2CppObject*))(Il2CppBase() + 0x141D5B4))(this, other);
	}
	template <typename T = bool> T Equals_1(StoreCategory* other) {
		return ((T (*)(StoreCategory*, StoreCategory*))(Il2CppBase() + 0x141D624))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(StoreCategory* other) {
		return ((T (*)(StoreCategory*, StoreCategory*))(Il2CppBase() + 0x141DAA4))(this, other);
	}
