...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::StoreCategory*>*& _parser() {
		return *(MessageParser1<ProtoModels::StoreCategory*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& EventsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::StoreCategoryEvent*>*& _repeated_events_codec() {
		return *(FieldCodec1<ProtoModels::StoreCategoryEvent*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::StoreCategoryEvent*>*& events_() {
		return *(RepeatedField1<ProtoModels::StoreCategoryEvent*>**)((uintptr_t)this + 0x20);
	}
	template <typename R = int32_t> static R& TagsFieldNumber() {
	 ...
	 static MessageParser1<ProtoModels::StoreCategory*>* get_Parser() {
		return ((MessageParser1<ProtoModels::StoreCategory*>* (*)(void *))(Il2CppBase() + 0x141D118))(0);
	}
	...
	template <typename R = void> R set_Name(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::StoreCategoryEvent*>* get_Events() {
		return ((RepeatedField1<ProtoModels::StoreCategoryEvent*>* (*)(StoreCategory*))(Il2CppBase() + 0x141D5A4))(this);
	}
	 RepeatedField1<Il2CppString*>* get_Tags() {
		return ((RepeatedField1<Il2CppString*>* (*)(StoreCategory*))(Il2CppBase() + 0x141D5AC))(this);
	}
