...
public: 
	...
	template <typename T = MessageParser1ArenaUpdateDev2DevUserIDRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUpdateDev2DevUserIDRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUpdateDev2DevUserIDRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUpdateDev2DevUserIDRequest*, Il2CppObject*))(Il2CppBase() + 0xF536F8))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUpdateDev2DevUserIDRequest* other) {
		return ((T (*)(ArenaUpdateDev2DevUserIDRequest*, ArenaUpdateDev2DevUserIDRequest*))(Il2CppBase() + 0xF53768))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUpdateDev2DevUserIDRequest* other) {
		return ((T (*)(ArenaUpdateDev2DevUserIDRequest*, ArenaUpdateDev2DevUserIDRequest*))(Il2CppBase() + 0xF53A88))(this, other);
	}
