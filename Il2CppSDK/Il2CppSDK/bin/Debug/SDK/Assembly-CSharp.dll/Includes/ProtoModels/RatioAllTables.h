...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::RatioAllTables*>*& _parser() {
		return *(MessageParser1ProtoModels::RatioAllTables*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& TablesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::RatioOneTable*>*& _repeated_tables_codec() {
		return *(FieldCodec1ProtoModels::RatioOneTable*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::RatioOneTable*>*& tables_() {
		return *(RepeatedField1ProtoModels::RatioOneTable*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int64_t> R& endTimeUnix_() {
	 ...
	 static MessageParser1ProtoModels::RatioAllTables*>* get_Parser() {
		return ((MessageParser1ProtoModels::RatioAllTables*>* (*)(void *))(Il2CppBase() + 0x171D414))(0);
	}
	...
	template <typename R = ProtoModels::RatioAllTables*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::RatioOneTable*>* get_Tables() {
		return ((RepeatedField1ProtoModels::RatioOneTable*>* (*)(RatioAllTables*))(Il2CppBase() + 0x171D758))(this);
	}
