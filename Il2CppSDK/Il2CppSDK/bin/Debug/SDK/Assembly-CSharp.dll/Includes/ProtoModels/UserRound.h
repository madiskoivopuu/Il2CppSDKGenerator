...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserRound*, uintptr_t))(Il2CppBase() + 0x2477808))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserRound*, uintptr_t))(Il2CppBase() + 0x24778B4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserRound*, uintptr_t))(Il2CppBase() + 0x2477B98))(this, other);
	}
