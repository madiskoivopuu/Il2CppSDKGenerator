...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserAddToGlobalMapRequest*, uintptr_t))(Il2CppBase() + 0xF58688))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserAddToGlobalMapRequest*, uintptr_t))(Il2CppBase() + 0xF586F8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserAddToGlobalMapRequest*, uintptr_t))(Il2CppBase() + 0xF58B2C))(this, other);
	}
