...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaUserAddToGlobalMapRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaUserAddToGlobalMapRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& wasKilled_() {
	 ...
	 static MessageParser1ProtoModels::ArenaUserAddToGlobalMapRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaUserAddToGlobalMapRequest*>* (*)(void *))(Il2CppBase() + 0xF582CC))(0);
	}
