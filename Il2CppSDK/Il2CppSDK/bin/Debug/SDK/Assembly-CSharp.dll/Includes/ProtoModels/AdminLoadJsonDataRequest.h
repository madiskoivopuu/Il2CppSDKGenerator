...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AdminLoadJsonDataRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::AdminLoadJsonDataRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& needWorld_() {
	 ...
	 static MessageParser1<ProtoModels::AdminLoadJsonDataRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AdminLoadJsonDataRequest*>* (*)(void *))(Il2CppBase() + 0x12931A4))(0);
	}
