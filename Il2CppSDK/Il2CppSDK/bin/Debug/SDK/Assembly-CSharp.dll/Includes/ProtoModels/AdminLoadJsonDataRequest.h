...
public: 
	...
	template <typename T = MessageParser1AdminLoadJsonDataRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1AdminLoadJsonDataRequest*>*> static T get_Parser() {
	...
	template <typename T = AdminLoadJsonDataRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminLoadJsonDataRequest*, Il2CppObject*))(Il2CppBase() + 0x129347C))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminLoadJsonDataRequest* other) {
		return ((T (*)(AdminLoadJsonDataRequest*, AdminLoadJsonDataRequest*))(Il2CppBase() + 0x12934EC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminLoadJsonDataRequest* other) {
		return ((T (*)(AdminLoadJsonDataRequest*, AdminLoadJsonDataRequest*))(Il2CppBase() + 0x1293838))(this, other);
	}
