...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClanJoinRequestRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaClanJoinRequestRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& join_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClanJoinRequestRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaClanJoinRequestRequest*>* (*)(void *))(Il2CppBase() + 0x1A1BA64))(0);
	}
