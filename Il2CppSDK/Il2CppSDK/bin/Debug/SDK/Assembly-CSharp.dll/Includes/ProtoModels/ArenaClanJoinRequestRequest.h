...
public: 
	...
	template <typename T = MessageParser1ArenaClanJoinRequestRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaClanJoinRequestRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaClanJoinRequestRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaClanJoinRequestRequest*, Il2CppObject*))(Il2CppBase() + 0x1A1BE08))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaClanJoinRequestRequest* other) {
		return ((T (*)(ArenaClanJoinRequestRequest*, ArenaClanJoinRequestRequest*))(Il2CppBase() + 0x1A1BE78))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaClanJoinRequestRequest* other) {
		return ((T (*)(ArenaClanJoinRequestRequest*, ArenaClanJoinRequestRequest*))(Il2CppBase() + 0x1A1C218))(this, other);
	}
