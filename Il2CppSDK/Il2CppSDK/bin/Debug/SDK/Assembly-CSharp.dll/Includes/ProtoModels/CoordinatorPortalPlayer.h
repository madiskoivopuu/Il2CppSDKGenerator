...
public: 
	...
	template <typename T = MessageParser1CoordinatorPortalPlayer*>*> static T& _parser() {
	...
	template <typename T = MessageParser1CoordinatorPortalPlayer*>*> static T get_Parser() {
	...
	template <typename T = CoordinatorPortalPlayer*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CoordinatorPortalPlayer*, Il2CppObject*))(Il2CppBase() + 0x133C4B8))(this, other);
	}
	template <typename T = bool> T Equals_1(CoordinatorPortalPlayer* other) {
		return ((T (*)(CoordinatorPortalPlayer*, CoordinatorPortalPlayer*))(Il2CppBase() + 0x133C544))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CoordinatorPortalPlayer* other) {
		return ((T (*)(CoordinatorPortalPlayer*, CoordinatorPortalPlayer*))(Il2CppBase() + 0x133C6EC))(this, other);
	}
