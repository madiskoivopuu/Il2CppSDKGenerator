...
public: 
	...
	template <typename T = void> T set_Status(uintptr_t value) {
		return ((T (*)(UserGetUserInfo*, uintptr_t))(Il2CppBase() + 0x246A590))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserGetUserInfo*, uintptr_t))(Il2CppBase() + 0x246A5D0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserGetUserInfo*, uintptr_t))(Il2CppBase() + 0x246A640))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserGetUserInfo*, uintptr_t))(Il2CppBase() + 0x246AB84))(this, other);
	}
