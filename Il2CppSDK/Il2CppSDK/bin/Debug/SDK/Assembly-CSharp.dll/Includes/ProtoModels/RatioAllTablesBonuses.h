...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::RatioAllTablesBonuses*>*& _parser() {
		return *(MessageParser1ProtoModels::RatioAllTablesBonuses*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& TablesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::RatioTableBonuses*>*& _repeated_tables_codec() {
		return *(FieldCodec1ProtoModels::RatioTableBonuses*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::RatioTableBonuses*>*& tables_() {
		return *(RepeatedField1ProtoModels::RatioTableBonuses*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::RatioAllTablesBonuses*>* get_Parser() {
		return ((MessageParser1ProtoModels::RatioAllTablesBonuses*>* (*)(void *))(Il2CppBase() + 0x1389D7C))(0);
	}
	...
	template <typename R = ProtoModels::RatioAllTablesBonuses*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::RatioTableBonuses*>* get_Tables() {
		return ((RepeatedField1ProtoModels::RatioTableBonuses*>* (*)(RatioAllTablesBonuses*))(Il2CppBase() + 0x138A0B4))(this);
	}
