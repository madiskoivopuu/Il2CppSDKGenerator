...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(GuildUpdateMessageOfTheDayRequest*, uintptr_t))(Il2CppBase() + 0x1945CC0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(GuildUpdateMessageOfTheDayRequest*, uintptr_t))(Il2CppBase() + 0x1945D30))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(GuildUpdateMessageOfTheDayRequest*, uintptr_t))(Il2CppBase() + 0x19460DC))(this, other);
	}
