...
public: 
	...
	template <typename T = MessageParser1PvpStartStopResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1PvpStartStopResponse*>*> static T get_Parser() {
	...
	template <typename T = PvpStartStopResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PvpStartStopResponse*, Il2CppObject*))(Il2CppBase() + 0x11C4F04))(this, other);
	}
	template <typename T = bool> T Equals_1(PvpStartStopResponse* other) {
		return ((T (*)(PvpStartStopResponse*, PvpStartStopResponse*))(Il2CppBase() + 0x11C4F74))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PvpStartStopResponse* other) {
		return ((T (*)(PvpStartStopResponse*, PvpStartStopResponse*))(Il2CppBase() + 0x11C5298))(this, other);
	}
