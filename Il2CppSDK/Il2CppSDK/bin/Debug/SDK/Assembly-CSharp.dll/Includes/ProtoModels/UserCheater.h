...
public: 
	...
	template <typename T = MessageParser1UserCheater*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserCheater*>*> static T get_Parser() {
	...
	template <typename T = UserCheater*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserCheater*, Il2CppObject*))(Il2CppBase() + 0x2464748))(this, other);
	}
	template <typename T = bool> T Equals_1(UserCheater* other) {
		return ((T (*)(UserCheater*, UserCheater*))(Il2CppBase() + 0x24647E4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserCheater* other) {
		return ((T (*)(UserCheater*, UserCheater*))(Il2CppBase() + 0x2464A2C))(this, other);
	}
