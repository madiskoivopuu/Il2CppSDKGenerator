...
public: 
	...
	template <typename T = void*> static T& _repeated_messages_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& messages_() {
	...
	template <typename T = void*> T get_Messages() {
		return ((T (*)(ArenaGetClanChatAllMessagesResponse*))(Il2CppBase() + 0x1E21BF4))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGetClanChatAllMessagesResponse*, uintptr_t))(Il2CppBase() + 0x1E21BFC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGetClanChatAllMessagesResponse*, uintptr_t))(Il2CppBase() + 0x1E21C6C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGetClanChatAllMessagesResponse*, uintptr_t))(Il2CppBase() + 0x1E22048))(this, other);
	}
