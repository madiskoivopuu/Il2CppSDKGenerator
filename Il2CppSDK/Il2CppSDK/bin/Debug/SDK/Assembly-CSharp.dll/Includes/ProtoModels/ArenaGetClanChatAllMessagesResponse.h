...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGetClanChatAllMessagesResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaGetClanChatAllMessagesResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& MessagesFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ClanChatMessageBlock*>*& _repeated_messages_codec() {
		return *(FieldCodec1<ProtoModels::ClanChatMessageBlock*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ClanChatMessageBlock*>*& messages_() {
		return *(RepeatedField1<ProtoModels::ClanChatMessageBlock*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::ArenaGetClanChatAllMessagesResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaGetClanChatAllMessagesResponse*>* (*)(void *))(Il2CppBase() + 0x1E217E8))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::ClanChatMessageBlock*>* get_Messages() {
		return ((RepeatedField1<ProtoModels::ClanChatMessageBlock*>* (*)(ArenaGetClanChatAllMessagesResponse*))(Il2CppBase() + 0x1E21BF4))(this);
	}
