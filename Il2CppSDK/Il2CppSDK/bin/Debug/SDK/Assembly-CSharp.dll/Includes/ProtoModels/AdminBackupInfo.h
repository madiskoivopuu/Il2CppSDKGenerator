...
public: 
	...
	template <typename T = void> T set_Btype(uintptr_t value) {
		return ((T (*)(AdminBackupInfo*, uintptr_t))(Il2CppBase() + 0x18B13E4))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminBackupInfo*, uintptr_t))(Il2CppBase() + 0x18B13EC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminBackupInfo*, uintptr_t))(Il2CppBase() + 0x18B145C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminBackupInfo*, uintptr_t))(Il2CppBase() + 0x18B18C0))(this, other);
	}
