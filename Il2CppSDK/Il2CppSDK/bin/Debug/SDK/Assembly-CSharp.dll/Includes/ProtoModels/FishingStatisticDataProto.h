...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::FishingStatisticDataProto*>*& _parser() {
		return *(MessageParser1<ProtoModels::FishingStatisticDataProto*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& pveID_() {
	 ...
	 static MessageParser1<ProtoModels::FishingStatisticDataProto*>* get_Parser() {
		return ((MessageParser1<ProtoModels::FishingStatisticDataProto*>* (*)(void *))(Il2CppBase() + 0x15F53F8))(0);
	}
