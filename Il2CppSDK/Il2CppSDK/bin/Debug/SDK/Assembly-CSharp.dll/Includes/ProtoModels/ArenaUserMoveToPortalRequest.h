...
public: 
	...
	template <typename T = uintptr_t> T& portalInfoData_() {
	...
	template <typename T = void> T set_Inventory(uintptr_t value) {
		return ((T (*)(ArenaUserMoveToPortalRequest*, uintptr_t))(Il2CppBase() + 0x28610BC))(this, value);
	}
	...
	template <typename T = uintptr_t> T get_PortalInfoData() {
		return ((T (*)(ArenaUserMoveToPortalRequest*))(Il2CppBase() + 0x286115C))(this);
	}
	template <typename T = void> T set_PortalInfoData(uintptr_t value) {
		return ((T (*)(ArenaUserMoveToPortalRequest*, uintptr_t))(Il2CppBase() + 0x2861164))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserMoveToPortalRequest*, uintptr_t))(Il2CppBase() + 0x286122C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserMoveToPortalRequest*, uintptr_t))(Il2CppBase() + 0x286129C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserMoveToPortalRequest*, uintptr_t))(Il2CppBase() + 0x2861BA8))(this, other);
	}
