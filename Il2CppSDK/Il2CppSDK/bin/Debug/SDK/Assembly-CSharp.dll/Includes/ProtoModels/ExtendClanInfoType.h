...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ExtendClanInfoType*>*& _parser() {
		return *(MessageParser1ProtoModels::ExtendClanInfoType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& CellLockTimeUnixFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_cellLockTimeUnix_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1int64_t>*& cellLockTimeUnix_() {
	...
	template <typename R = int32_t> static R& ActivePvpUsersFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::UserRound*>*& _repeated_activePvpUsers_codec() {
		return *(FieldCodec1ProtoModels::UserRound*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::UserRound*>*& activePvpUsers_() {
		return *(RepeatedField1ProtoModels::UserRound*>**)((uintptr_t)this + 0x20);
	}
	...
	template <typename R = int32_t> static R& LocationsGradeFieldNumber() {
	 ...
	 MapField2Il2CppString*, int32_t>*& locationsGrade_() {
		return *(MapField2Il2CppString*, int32_t>**)((uintptr_t)this + 0x40);
	}
	...
	template <typename R = int32_t> static R& ClanGameDataFieldNumber() {
	 ...
	 MapField2Il2CppString*, Il2CppString*>*& clanGameData_() {
		return *(MapField2Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0x50);
	}

	 static MessageParser1ProtoModels::ExtendClanInfoType*>* get_Parser() {
		return ((MessageParser1ProtoModels::ExtendClanInfoType*>* (*)(void *))(Il2CppBase() + 0x16862FC))(0);
	}
	...
	template <typename R = ProtoModels::ExtendClanInfoType*> R Clone() {
	 ...
	 RepeatedField1int64_t>* get_CellLockTimeUnix() {
		return ((RepeatedField1int64_t>* (*)(ExtendClanInfoType*))(Il2CppBase() + 0x1686844))(this);
	}
	...
	template <typename R = void> R set_NoPvpTimeUnix(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::UserRound*>* get_ActivePvpUsers() {
		return ((RepeatedField1ProtoModels::UserRound*>* (*)(ExtendClanInfoType*))(Il2CppBase() + 0x168685C))(this);
	}
	...
	template <typename R = void> R set_CanCan(ProtoModels::Can* value) {
	 ...
	 MapField2Il2CppString*, int32_t>* get_LocationsGrade() {
		return ((MapField2Il2CppString*, int32_t>* (*)(ExtendClanInfoType*))(Il2CppBase() + 0x1686894))(this);
	}
	...
	template <typename R = void> R set_RaidMatchingTimeout(int64_t value) {
	 ...
	 MapField2Il2CppString*, Il2CppString*>* get_ClanGameData() {
		return ((MapField2Il2CppString*, Il2CppString*>* (*)(ExtendClanInfoType*))(Il2CppBase() + 0x16868AC))(this);
	}
