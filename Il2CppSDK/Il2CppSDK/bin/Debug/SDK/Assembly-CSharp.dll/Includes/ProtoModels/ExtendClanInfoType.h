...
public: 
	...
	template <typename T = MessageParser1ExtendClanInfoType*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& CellLockTimeUnixFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1int64_t>*> static T& _repeated_cellLockTimeUnix_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1int64_t>*> T& cellLockTimeUnix_() {
	...
	template <typename T = FieldCodec1UserRound*>*> static T& _repeated_activePvpUsers_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1UserRound*>*> T& activePvpUsers_() {
	...
	template <typename T = MessageParser1ExtendClanInfoType*>*> static T get_Parser() {
	...
	template <typename T = ExtendClanInfoType*> T Clone() {
		return ((T (*)(ExtendClanInfoType*))(Il2CppBase() + 0x16867E8))(this);
	}
	template <typename T = RepeatedField1int64_t>*> T get_CellLockTimeUnix() {
	...
	template <typename T = RepeatedField1UserRound*>*> T get_ActivePvpUsers() {
	...
	template <typename T = void> T set_Statue(ClanEventType* value) {
		return ((T (*)(ExtendClanInfoType*, ClanEventType*))(Il2CppBase() + 0x168686C))(this, value);
	}
	...
	template <typename T = void> T set_Scout(ClanEventType* value) {
		return ((T (*)(ExtendClanInfoType*, ClanEventType*))(Il2CppBase() + 0x168687C))(this, value);
	}
	...
	template <typename T = void> T set_CanCan(Can* value) {
		return ((T (*)(ExtendClanInfoType*, Can*))(Il2CppBase() + 0x168688C))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ExtendClanInfoType*, Il2CppObject*))(Il2CppBase() + 0x16868B4))(this, other);
	}
	template <typename T = bool> T Equals_1(ExtendClanInfoType* other) {
		return ((T (*)(ExtendClanInfoType*, ExtendClanInfoType*))(Il2CppBase() + 0x1686924))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ExtendClanInfoType* other) {
		return ((T (*)(ExtendClanInfoType*, ExtendClanInfoType*))(Il2CppBase() + 0x1687144))(this, other);
	}
