...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::StoreCategories*>*& _parser() {
		return *(MessageParser1ProtoModels::StoreCategories*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& CategoriesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::StoreCategory*>*& _repeated_categories_codec() {
		return *(FieldCodec1ProtoModels::StoreCategory*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::StoreCategory*>*& categories_() {
		return *(RepeatedField1ProtoModels::StoreCategory*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::StoreCategories*>* get_Parser() {
		return ((MessageParser1ProtoModels::StoreCategories*>* (*)(void *))(Il2CppBase() + 0x1419A98))(0);
	}
	...
	template <typename R = ProtoModels::StoreCategories*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::StoreCategory*>* get_Categories() {
		return ((RepeatedField1ProtoModels::StoreCategory*>* (*)(StoreCategories*))(Il2CppBase() + 0x1419DD0))(this);
	}
