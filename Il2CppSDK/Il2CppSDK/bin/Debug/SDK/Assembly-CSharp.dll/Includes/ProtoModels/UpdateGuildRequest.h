...
public: 
	...
	template <typename T = MessageParser1UpdateGuildRequest*>*> static T& _parser() {
	...
	template <typename T = Currencies*> T& price_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1UpdateGuildRequest*>*> static T get_Parser() {
	...
	template <typename T = UpdateGuildRequest*> T Clone() {
	...
	template <typename T = void> T set_Guild(GuildMessageType* value) {
		return ((T (*)(UpdateGuildRequest*, GuildMessageType*))(Il2CppBase() + 0x153D9B0))(this, value);
	}
	template <typename T = Currencies*> T get_Price() {
		return ((T (*)(UpdateGuildRequest*))(Il2CppBase() + 0x153D9B8))(this);
	}
	template <typename T = void> T set_Price(Currencies* value) {
		return ((T (*)(UpdateGuildRequest*, Currencies*))(Il2CppBase() + 0x153D9C0))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UpdateGuildRequest*, Il2CppObject*))(Il2CppBase() + 0x153D9C8))(this, other);
	}
	template <typename T = bool> T Equals_1(UpdateGuildRequest* other) {
		return ((T (*)(UpdateGuildRequest*, UpdateGuildRequest*))(Il2CppBase() + 0x153DA38))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UpdateGuildRequest* other) {
		return ((T (*)(UpdateGuildRequest*, UpdateGuildRequest*))(Il2CppBase() + 0x153DDCC))(this, other);
	}
