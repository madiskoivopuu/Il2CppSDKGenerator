...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(WaitMeUserToCoordinatorRequest*, uintptr_t))(Il2CppBase() + 0x15D127C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(WaitMeUserToCoordinatorRequest*, uintptr_t))(Il2CppBase() + 0x15D1308))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(WaitMeUserToCoordinatorRequest*, uintptr_t))(Il2CppBase() + 0x15D14B0))(this, other);
	}
