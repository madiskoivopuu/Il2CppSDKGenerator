...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaRaidClanUnderAttackRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaRaidClanUnderAttackRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& timeStampShieldEnd_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaRaidClanUnderAttackRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaRaidClanUnderAttackRequest*>* (*)(void *))(Il2CppBase() + 0x1A693FC))(0);
	}
