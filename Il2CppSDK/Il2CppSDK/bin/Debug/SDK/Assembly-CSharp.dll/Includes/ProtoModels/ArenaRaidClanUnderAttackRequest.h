...
public: 
	...
	template <typename T = MessageParser1ArenaRaidClanUnderAttackRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaRaidClanUnderAttackRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaRaidClanUnderAttackRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaRaidClanUnderAttackRequest*, Il2CppObject*))(Il2CppBase() + 0x1A696B4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaRaidClanUnderAttackRequest* other) {
		return ((T (*)(ArenaRaidClanUnderAttackRequest*, ArenaRaidClanUnderAttackRequest*))(Il2CppBase() + 0x1A69760))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaRaidClanUnderAttackRequest* other) {
		return ((T (*)(ArenaRaidClanUnderAttackRequest*, ArenaRaidClanUnderAttackRequest*))(Il2CppBase() + 0x1A69A44))(this, other);
	}
