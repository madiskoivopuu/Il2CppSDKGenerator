...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(GetUserFCMTokenRequest*, uintptr_t))(Il2CppBase() + 0x1771310))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(GetUserFCMTokenRequest*, uintptr_t))(Il2CppBase() + 0x17713AC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(GetUserFCMTokenRequest*, uintptr_t))(Il2CppBase() + 0x17715F4))(this, other);
	}
