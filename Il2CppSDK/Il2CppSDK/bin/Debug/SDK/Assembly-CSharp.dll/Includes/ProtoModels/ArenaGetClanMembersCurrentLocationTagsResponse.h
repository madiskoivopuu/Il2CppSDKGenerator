...
public: 
	...
	template <typename T = void*> static T& _map_clanMemberLocDataByUserId_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& clanMemberLocDataByUserId_() {
	...
	template <typename T = void*> T get_ClanMemberLocDataByUserId() {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsResponse*))(Il2CppBase() + 0x1E22F28))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsResponse*, uintptr_t))(Il2CppBase() + 0x1E22F30))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsResponse*, uintptr_t))(Il2CppBase() + 0x1E22FA0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsResponse*, uintptr_t))(Il2CppBase() + 0x1E2336C))(this, other);
	}
