...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGetClanMembersCurrentLocationTagsResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaGetClanMembersCurrentLocationTagsResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ClanMemberLocDataByUserIdFieldNumber() {
	 ...
	 static Codec<int64_t, ProtoModels::ClanMemberLocationData*>*& _map_clanMemberLocDataByUserId_codec() {
		return *(Codec<int64_t, ProtoModels::ClanMemberLocationData*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2<int64_t, ProtoModels::ClanMemberLocationData*>*& clanMemberLocDataByUserId_() {
		return *(MapField2<int64_t, ProtoModels::ClanMemberLocationData*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::ArenaGetClanMembersCurrentLocationTagsResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaGetClanMembersCurrentLocationTagsResponse*>* (*)(void *))(Il2CppBase() + 0x1E22B1C))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 MapField2<int64_t, ProtoModels::ClanMemberLocationData*>* get_ClanMemberLocDataByUserId() {
		return ((MapField2<int64_t, ProtoModels::ClanMemberLocationData*>* (*)(ArenaGetClanMembersCurrentLocationTagsResponse*))(Il2CppBase() + 0x1E22F28))(this);
	}
