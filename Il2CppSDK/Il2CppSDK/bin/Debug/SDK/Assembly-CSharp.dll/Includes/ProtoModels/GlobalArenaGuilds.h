...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GlobalArenaGuilds*>*& _parser() {
		return *(MessageParser1<ProtoModels::GlobalArenaGuilds*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& GlobalPrevGuildsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::GlobalGuild*>*& _repeated_globalPrevGuilds_codec() {
		return *(FieldCodec1<ProtoModels::GlobalGuild*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	...
	template <typename R = int32_t> static R& LocalPrevGuildsFieldNumber() {
	 ...
	 static MessageParser1<ProtoModels::GlobalArenaGuilds*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GlobalArenaGuilds*>* (*)(void *))(Il2CppBase() + 0x17726F8))(0);
	}
	...
	template <typename R = ProtoModels::GlobalArenaGuilds*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::GlobalGuild*>* get_Guilds() {
		return ((RepeatedField1<ProtoModels::GlobalGuild*>* (*)(GlobalArenaGuilds*))(Il2CppBase() + 0x1772ACC))(this);
	}
	...
	template <typename R = void> R set_Update(bool value) {
	 ...
	 RepeatedField1<ProtoModels::GlobalGuild*>* get_GlobalPrevGuilds() {
		return ((RepeatedField1<ProtoModels::GlobalGuild*>* (*)(GlobalArenaGuilds*))(Il2CppBase() + 0x1772AE8))(this);
	}
	 RepeatedField1<ProtoModels::GlobalGuild*>* get_LocalPrevGuilds() {
		return ((RepeatedField1<ProtoModels::GlobalGuild*>* (*)(GlobalArenaGuilds*))(Il2CppBase() + 0x1772AF0))(this);
	}
