...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GlobalTourney*>*& _parser() {
		return *(MessageParser1<ProtoModels::GlobalTourney*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ClansFieldNumber() {
	 ...
	 RepeatedField1<ProtoModels::Clan*>*& clans_() {
		return *(RepeatedField1<ProtoModels::Clan*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int32_t> static R& LeadersFieldNumber() {
	 ...
	 static FieldCodec1<int64_t>*& _repeated_leaders_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<int64_t>*& leaders_() {
		return *(RepeatedField1<int64_t>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::GlobalTourney*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GlobalTourney*>* (*)(void *))(Il2CppBase() + 0x12DDF30))(0);
	}
	...
	template <typename R = ProtoModels::GlobalTourney*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::Clan*>* get_Clans() {
		return ((RepeatedField1<ProtoModels::Clan*>* (*)(GlobalTourney*))(Il2CppBase() + 0x12DE2F4))(this);
	}
	...
	template <typename R = void> R set_Update(bool value) {
	 ...
	 RepeatedField1<int64_t>* get_Leaders() {
		return ((RepeatedField1<int64_t>* (*)(GlobalTourney*))(Il2CppBase() + 0x12DE310))(this);
	}
