...
public: 
	...
	template <typename T = MessageParser1GlobalTourney*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& ClansFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1Clan*>*> static T& _repeated_clans_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1Clan*>*> T& clans_() {
	...
	template <typename T = FieldCodec1int64_t>*> static T& _repeated_leaders_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1int64_t>*> T& leaders_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1GlobalTourney*>*> static T get_Parser() {
	...
	template <typename T = GlobalTourney*> T Clone() {
		return ((T (*)(GlobalTourney*))(Il2CppBase() + 0x12DE298))(this);
	}
	template <typename T = RepeatedField1Clan*>*> T get_Clans() {
	...
	template <typename T = RepeatedField1int64_t>*> T get_Leaders() {
		return ((T (*)(GlobalTourney*))(Il2CppBase() + 0x12DE310))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GlobalTourney*, Il2CppObject*))(Il2CppBase() + 0x12DE318))(this, other);
	}
	template <typename T = bool> T Equals_1(GlobalTourney* other) {
		return ((T (*)(GlobalTourney*, GlobalTourney*))(Il2CppBase() + 0x12DE388))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GlobalTourney* other) {
		return ((T (*)(GlobalTourney*, GlobalTourney*))(Il2CppBase() + 0x12DE75C))(this, other);
	}
