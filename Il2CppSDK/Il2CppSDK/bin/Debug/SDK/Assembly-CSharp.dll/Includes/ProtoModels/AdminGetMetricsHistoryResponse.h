...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminGetMetricsHistoryResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminGetMetricsHistoryResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& MetricValueFieldNumber() {
	 ...
	 static FieldCodec1Il2CppString*>*& _repeated_metricValue_codec() {
		return *(FieldCodec1Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1Il2CppString*>*& metricValue_() {
		return *(RepeatedField1Il2CppString*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1ProtoModels::AdminGetMetricsHistoryResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminGetMetricsHistoryResponse*>* (*)(void *))(Il2CppBase() + 0x18B3708))(0);
	}
	...
	template <typename R = void> R set_MetricName(Il2CppString* value) {
	 ...
	 RepeatedField1Il2CppString*>* get_MetricValue() {
		return ((RepeatedField1Il2CppString*>* (*)(AdminGetMetricsHistoryResponse*))(Il2CppBase() + 0x18B3BBC))(this);
	}
