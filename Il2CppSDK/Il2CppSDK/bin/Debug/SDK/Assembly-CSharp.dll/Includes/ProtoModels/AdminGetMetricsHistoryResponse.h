...
public: 
	...
	template <typename T = MessageParser1AdminGetMetricsHistoryResponse*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_metricValue_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& metricValue_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1AdminGetMetricsHistoryResponse*>*> static T get_Parser() {
	...
	template <typename T = AdminGetMetricsHistoryResponse*> T Clone() {
	...
	template <typename T = RepeatedField1Il2CppString*>*> T get_MetricValue() {
		return ((T (*)(AdminGetMetricsHistoryResponse*))(Il2CppBase() + 0x18B3BBC))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminGetMetricsHistoryResponse*, Il2CppObject*))(Il2CppBase() + 0x18B3BC4))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminGetMetricsHistoryResponse* other) {
		return ((T (*)(AdminGetMetricsHistoryResponse*, AdminGetMetricsHistoryResponse*))(Il2CppBase() + 0x18B3C34))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminGetMetricsHistoryResponse* other) {
		return ((T (*)(AdminGetMetricsHistoryResponse*, AdminGetMetricsHistoryResponse*))(Il2CppBase() + 0x18B40AC))(this, other);
	}
