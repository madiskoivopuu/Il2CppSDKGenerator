...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserProductProgress*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserProductProgress*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& DataFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::UserProductProgressData*>*& _repeated_data_codec() {
		return *(FieldCodec1<ProtoModels::UserProductProgressData*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::UserProductProgressData*>*& data_() {
		return *(RepeatedField1<ProtoModels::UserProductProgressData*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::UserProductProgress*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserProductProgress*>* (*)(void *))(Il2CppBase() + 0x2470468))(0);
	}
	...
	template <typename R = void> R set_RollCount(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::UserProductProgressData*>* get_Data() {
		return ((RepeatedField1<ProtoModels::UserProductProgressData*>* (*)(UserProductProgress*))(Il2CppBase() + 0x2470878))(this);
	}
