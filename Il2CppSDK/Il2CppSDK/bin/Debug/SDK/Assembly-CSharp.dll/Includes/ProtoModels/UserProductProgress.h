...
public: 
	...
	template <typename T = MessageParser1UserProductProgress*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1UserProductProgressData*>*> static T& _repeated_data_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1UserProductProgressData*>*> T& data_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1UserProductProgress*>*> static T get_Parser() {
	...
	template <typename T = UserProductProgress*> T Clone() {
	...
	template <typename T = RepeatedField1UserProductProgressData*>*> T get_Data() {
		return ((T (*)(UserProductProgress*))(Il2CppBase() + 0x2470878))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserProductProgress*, Il2CppObject*))(Il2CppBase() + 0x2470880))(this, other);
	}
	template <typename T = bool> T Equals_1(UserProductProgress* other) {
		return ((T (*)(UserProductProgress*, UserProductProgress*))(Il2CppBase() + 0x24708F0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserProductProgress* other) {
		return ((T (*)(UserProductProgress*, UserProductProgress*))(Il2CppBase() + 0x2470CBC))(this, other);
	}
