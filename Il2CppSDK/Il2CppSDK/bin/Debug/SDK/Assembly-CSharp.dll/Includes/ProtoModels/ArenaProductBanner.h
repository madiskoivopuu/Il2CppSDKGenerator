...
public: 
	...
	template <typename T = void*> static T& _repeated_names_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& names_() {
	...
	template <typename T = void*> T get_Names() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaProductBanner*, uintptr_t))(Il2CppBase() + 0x1E31E40))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaProductBanner*, uintptr_t))(Il2CppBase() + 0x1E31EB0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaProductBanner*, uintptr_t))(Il2CppBase() + 0x1E32344))(this, other);
	}
