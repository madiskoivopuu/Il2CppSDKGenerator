...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGetRatioBonusListRequest*, uintptr_t))(Il2CppBase() + 0x1E2442C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGetRatioBonusListRequest*, uintptr_t))(Il2CppBase() + 0x1E244B8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGetRatioBonusListRequest*, uintptr_t))(Il2CppBase() + 0x1E24660))(this, other);
	}
