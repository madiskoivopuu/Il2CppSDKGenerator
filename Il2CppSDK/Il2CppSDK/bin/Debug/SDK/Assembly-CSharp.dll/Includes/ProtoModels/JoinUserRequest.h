...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::JoinUserRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::JoinUserRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& InvitesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::Invite*>*& _repeated_invites_codec() {
		return *(FieldCodec1ProtoModels::Invite*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::Invite*>*& invites_() {
		return *(RepeatedField1ProtoModels::Invite*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1ProtoModels::JoinUserRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::JoinUserRequest*>* (*)(void *))(Il2CppBase() + 0x14E4160))(0);
	}
	...
	template <typename R = void> R set_ToClan(ProtoModels::Clan* value) {
	 ...
	 RepeatedField1ProtoModels::Invite*>* get_Invites() {
		return ((RepeatedField1ProtoModels::Invite*>* (*)(JoinUserRequest*))(Il2CppBase() + 0x14E4500))(this);
	}
