...
public: 
	...
	template <typename T = MessageParser1ArenaDisbandClanRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaDisbandClanRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaDisbandClanRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaDisbandClanRequest*, Il2CppObject*))(Il2CppBase() + 0x1E1D75C))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaDisbandClanRequest* other) {
		return ((T (*)(ArenaDisbandClanRequest*, ArenaDisbandClanRequest*))(Il2CppBase() + 0x1E1D7F8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaDisbandClanRequest* other) {
		return ((T (*)(ArenaDisbandClanRequest*, ArenaDisbandClanRequest*))(Il2CppBase() + 0x1E1DA40))(this, other);
	}
