...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaUserInventoryData*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaUserInventoryData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& SavingsPackFieldNumber() {
	 ...
	 static Codecint64_t, uint32_t>*& _map_savingsPack_codec() {
		return *(Codecint64_t, uint32_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2int64_t, uint32_t>*& savingsPack_() {
		return *(MapField2int64_t, uint32_t>**)((uintptr_t)this + 0x70);
	}
	...
	template <typename R = int32_t> static R& PersonalEntitiesFieldNumber() {
	 ...
	 static CodecIl2CppString*, Il2CppString*>*& _map_personalEntities_codec() {
		return *(CodecIl2CppString*, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 MapField2Il2CppString*, Il2CppString*>*& personalEntities_() {
		return *(MapField2Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0x88);
	}
	...
	template <typename R = int32_t> static R& PurchaseHistoryFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaIncompletePurchaseHistory*>*& _repeated_purchaseHistory_codec() {
		return *(FieldCodec1ProtoModels::ArenaIncompletePurchaseHistory*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1ProtoModels::ArenaIncompletePurchaseHistory*>*& purchaseHistory_() {
		return *(RepeatedField1ProtoModels::ArenaIncompletePurchaseHistory*>**)((uintptr_t)this + 0xB8);
	}

	 static MessageParser1ProtoModels::ArenaUserInventoryData*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaUserInventoryData*>* (*)(void *))(Il2CppBase() + 0x285D344))(0);
	}
	...
	template <typename R = void> R set_EndTimeMoveUnix(int64_t value) {
	 ...
	 RepeatedField1Il2CppString*>* get_BlockedPushes() {
		return ((RepeatedField1Il2CppString*>* (*)(ArenaUserInventoryData*))(Il2CppBase() + 0x285D850))(this);
	}
	...
	template <typename R = void> R set_DistrictLevel(int32_t value) {
	 ...
	 MapField2int64_t, uint32_t>* get_SavingsPack() {
		return ((MapField2int64_t, uint32_t>* (*)(ArenaUserInventoryData*))(Il2CppBase() + 0x285D898))(this);
	}
	...
	template <typename R = void> R set_InventoryPowerDetail(ProtoModels::InventoryPowerDetailType* value) {
	 ...
	 MapField2Il2CppString*, Il2CppString*>* get_PersonalEntities() {
		return ((MapField2Il2CppString*, Il2CppString*>* (*)(ArenaUserInventoryData*))(Il2CppBase() + 0x285D8C0))(this);
	}
	...
	template <typename R = void> R set_CyclicYmirSoul(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaIncompletePurchaseHistory*>* get_PurchaseHistory() {
		return ((RepeatedField1ProtoModels::ArenaIncompletePurchaseHistory*>* (*)(ArenaUserInventoryData*))(Il2CppBase() + 0x285D968))(this);
	}
