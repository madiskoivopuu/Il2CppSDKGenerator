...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::DiplomaciesResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::DiplomaciesResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& DiplomaciesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::Diplomacy*>*& _repeated_diplomacies_codec() {
		return *(FieldCodec1ProtoModels::Diplomacy*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::Diplomacy*>*& diplomacies_() {
		return *(RepeatedField1ProtoModels::Diplomacy*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1ProtoModels::DiplomaciesResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::DiplomaciesResponse*>* (*)(void *))(Il2CppBase() + 0x12FA71C))(0);
	}
	...
	template <typename R = void> R set_PvpID(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::Diplomacy*>* get_Diplomacies() {
		return ((RepeatedField1ProtoModels::Diplomacy*>* (*)(DiplomaciesResponse*))(Il2CppBase() + 0x12FAB40))(this);
	}
