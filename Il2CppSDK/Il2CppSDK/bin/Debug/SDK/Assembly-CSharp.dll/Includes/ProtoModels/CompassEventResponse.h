...
public: 
	...
	template <typename T = MessageParser1CompassEventResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1CompassEventResponse*>*> static T get_Parser() {
	...
	template <typename T = CompassEventResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CompassEventResponse*, Il2CppObject*))(Il2CppBase() + 0xE2C9C8))(this, other);
	}
	template <typename T = bool> T Equals_1(CompassEventResponse* other) {
		return ((T (*)(CompassEventResponse*, CompassEventResponse*))(Il2CppBase() + 0xE2CA38))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CompassEventResponse* other) {
		return ((T (*)(CompassEventResponse*, CompassEventResponse*))(Il2CppBase() + 0xE2CD74))(this, other);
	}
