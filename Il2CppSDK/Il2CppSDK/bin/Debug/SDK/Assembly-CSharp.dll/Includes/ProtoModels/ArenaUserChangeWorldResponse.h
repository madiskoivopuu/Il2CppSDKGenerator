...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserChangeWorldResponse*, uintptr_t))(Il2CppBase() + 0x285A888))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserChangeWorldResponse*, uintptr_t))(Il2CppBase() + 0x285A8F8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserChangeWorldResponse*, uintptr_t))(Il2CppBase() + 0x285ACB0))(this, other);
	}
