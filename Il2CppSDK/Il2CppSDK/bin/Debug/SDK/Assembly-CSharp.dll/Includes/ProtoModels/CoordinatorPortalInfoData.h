...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::CoordinatorPortalInfoData*>*& _parser() {
		return *(MessageParser1<ProtoModels::CoordinatorPortalInfoData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PlayersFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::CoordinatorPortalPlayer*>*& _repeated_players_codec() {
		return *(FieldCodec1<ProtoModels::CoordinatorPortalPlayer*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::CoordinatorPortalPlayer*>*& players_() {
		return *(RepeatedField1<ProtoModels::CoordinatorPortalPlayer*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = int32_t> R& type_() {
	 ...
	 static MessageParser1<ProtoModels::CoordinatorPortalInfoData*>* get_Parser() {
		return ((MessageParser1<ProtoModels::CoordinatorPortalInfoData*>* (*)(void *))(Il2CppBase() + 0x133B704))(0);
	}
	...
	template <typename R = void> R set_Rank(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::CoordinatorPortalPlayer*>* get_Players() {
		return ((RepeatedField1<ProtoModels::CoordinatorPortalPlayer*>* (*)(CoordinatorPortalInfoData*))(Il2CppBase() + 0x133BA60))(this);
	}
