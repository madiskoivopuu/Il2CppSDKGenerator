...
public: 
	...
	template <typename T = void*> static T& _repeated_positions_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& positions_() {
	...
	template <typename T = void*> T get_Positions() {
		return ((T (*)(BonusPositionType*))(Il2CppBase() + 0x16C7430))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(BonusPositionType*, uintptr_t))(Il2CppBase() + 0x16C7438))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(BonusPositionType*, uintptr_t))(Il2CppBase() + 0x16C74A8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(BonusPositionType*, uintptr_t))(Il2CppBase() + 0x16C76F4))(this, other);
	}
