...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::BonusPositionType*>*& _parser() {
		return *(MessageParser1ProtoModels::BonusPositionType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& PositionsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int32_t>*& _repeated_positions_codec() {
		return *(FieldCodec1int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1int32_t>*& positions_() {
		return *(RepeatedField1int32_t>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::BonusPositionType*>* get_Parser() {
		return ((MessageParser1ProtoModels::BonusPositionType*>* (*)(void *))(Il2CppBase() + 0x16C70F8))(0);
	}
	...
	template <typename R = ProtoModels::BonusPositionType*> R Clone() {
	 ...
	 RepeatedField1int32_t>* get_Positions() {
		return ((RepeatedField1int32_t>* (*)(BonusPositionType*))(Il2CppBase() + 0x16C7430))(this);
	}
