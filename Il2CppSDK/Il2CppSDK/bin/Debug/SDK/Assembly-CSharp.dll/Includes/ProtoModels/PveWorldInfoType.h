...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PveWorldInfoType*, uintptr_t))(Il2CppBase() + 0x11BEED4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PveWorldInfoType*, uintptr_t))(Il2CppBase() + 0x11BEF44))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PveWorldInfoType*, uintptr_t))(Il2CppBase() + 0x11BF348))(this, other);
	}
