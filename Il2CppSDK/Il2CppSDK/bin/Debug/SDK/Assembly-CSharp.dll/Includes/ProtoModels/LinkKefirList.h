...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::LinkKefirList*>*& _parser() {
		return *(MessageParser1ProtoModels::LinkKefirList*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& UsersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::LinkKefirUser*>*& _repeated_users_codec() {
		return *(FieldCodec1ProtoModels::LinkKefirUser*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::LinkKefirUser*>*& users_() {
		return *(RepeatedField1ProtoModels::LinkKefirUser*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::LinkKefirList*>* get_Parser() {
		return ((MessageParser1ProtoModels::LinkKefirList*>* (*)(void *))(Il2CppBase() + 0x142D790))(0);
	}
	...
	template <typename R = ProtoModels::LinkKefirList*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::LinkKefirUser*>* get_Users() {
		return ((RepeatedField1ProtoModels::LinkKefirUser*>* (*)(LinkKefirList*))(Il2CppBase() + 0x142DAC8))(this);
	}
