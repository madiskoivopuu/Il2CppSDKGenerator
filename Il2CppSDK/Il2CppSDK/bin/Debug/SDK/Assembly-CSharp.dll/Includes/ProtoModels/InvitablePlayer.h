...
public: 
	...
	template <typename T = MessageParser1InvitablePlayer*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& PretenderClanFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = Clan*> T& pretenderClan_() {
	...
	template <typename T = MessageParser1InvitablePlayer*>*> static T get_Parser() {
	...
	template <typename T = InvitablePlayer*> T Clone() {
		return ((T (*)(InvitablePlayer*))(Il2CppBase() + 0x1242270))(this);
	}
	template <typename T = Clan*> T get_PretenderClan() {
		return ((T (*)(InvitablePlayer*))(Il2CppBase() + 0x12422CC))(this);
	}
	template <typename T = void> T set_PretenderClan(Clan* value) {
		return ((T (*)(InvitablePlayer*, Clan*))(Il2CppBase() + 0x12422D4))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(InvitablePlayer*, Il2CppObject*))(Il2CppBase() + 0x1242384))(this, other);
	}
	template <typename T = bool> T Equals_1(InvitablePlayer* other) {
		return ((T (*)(InvitablePlayer*, InvitablePlayer*))(Il2CppBase() + 0x12423F4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(InvitablePlayer* other) {
		return ((T (*)(InvitablePlayer*, InvitablePlayer*))(Il2CppBase() + 0x12427A8))(this, other);
	}
