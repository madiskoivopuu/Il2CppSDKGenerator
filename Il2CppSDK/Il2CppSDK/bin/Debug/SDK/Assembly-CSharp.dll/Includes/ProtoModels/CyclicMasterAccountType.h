...
public: 
	...
	template <typename T = MessageParser1CyclicMasterAccountType*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& StatusFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = CyclicMasterAccountStatusType*> T& status_() {
	...
	template <typename T = MessageParser1CyclicMasterAccountType*>*> static T get_Parser() {
	...
	template <typename T = CyclicMasterAccountType*> T Clone() {
		return ((T (*)(CyclicMasterAccountType*))(Il2CppBase() + 0x16452DC))(this);
	}
	template <typename T = CyclicMasterAccountStatusType*> T get_Status() {
		return ((T (*)(CyclicMasterAccountType*))(Il2CppBase() + 0x1645338))(this);
	}
	template <typename T = void> T set_Status(CyclicMasterAccountStatusType* value) {
		return ((T (*)(CyclicMasterAccountType*, CyclicMasterAccountStatusType*))(Il2CppBase() + 0x1645340))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CyclicMasterAccountType*, Il2CppObject*))(Il2CppBase() + 0x1645468))(this, other);
	}
	template <typename T = bool> T Equals_1(CyclicMasterAccountType* other) {
		return ((T (*)(CyclicMasterAccountType*, CyclicMasterAccountType*))(Il2CppBase() + 0x16454D8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CyclicMasterAccountType* other) {
		return ((T (*)(CyclicMasterAccountType*, CyclicMasterAccountType*))(Il2CppBase() + 0x16458A4))(this, other);
	}
