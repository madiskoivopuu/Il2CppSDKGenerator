...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaResetPersonalPoolRequest*, uintptr_t))(Il2CppBase() + 0x270EF84))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaResetPersonalPoolRequest*, uintptr_t))(Il2CppBase() + 0x270EFF4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaResetPersonalPoolRequest*, uintptr_t))(Il2CppBase() + 0x270F458))(this, other);
	}
