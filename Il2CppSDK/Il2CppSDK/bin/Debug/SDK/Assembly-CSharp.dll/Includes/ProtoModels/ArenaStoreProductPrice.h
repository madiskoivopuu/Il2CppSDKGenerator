...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaStoreProductPrice*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaStoreProductPrice*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& productID_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaStoreProductPrice*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaStoreProductPrice*>* (*)(void *))(Il2CppBase() + 0x271F9B4))(0);
	}
