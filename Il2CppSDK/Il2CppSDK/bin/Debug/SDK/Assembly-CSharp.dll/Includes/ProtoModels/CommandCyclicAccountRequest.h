...
public: 
	...
	template <typename T = MessageParser1CommandCyclicAccountRequest*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& CmdFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = CommandCyclicAccountType*> T& cmd_() {
	...
	template <typename T = MessageParser1CommandCyclicAccountRequest*>*> static T get_Parser() {
	...
	template <typename T = CommandCyclicAccountRequest*> T Clone() {
		return ((T (*)(CommandCyclicAccountRequest*))(Il2CppBase() + 0xE27A14))(this);
	}
	template <typename T = CommandCyclicAccountType*> T get_Cmd() {
		return ((T (*)(CommandCyclicAccountRequest*))(Il2CppBase() + 0xE27A70))(this);
	}
	template <typename T = void> T set_Cmd(CommandCyclicAccountType* value) {
		return ((T (*)(CommandCyclicAccountRequest*, CommandCyclicAccountType*))(Il2CppBase() + 0xE27A78))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CommandCyclicAccountRequest*, Il2CppObject*))(Il2CppBase() + 0xE27D48))(this, other);
	}
	template <typename T = bool> T Equals_1(CommandCyclicAccountRequest* other) {
		return ((T (*)(CommandCyclicAccountRequest*, CommandCyclicAccountRequest*))(Il2CppBase() + 0xE27DB8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CommandCyclicAccountRequest* other) {
		return ((T (*)(CommandCyclicAccountRequest*, CommandCyclicAccountRequest*))(Il2CppBase() + 0xE28420))(this, other);
	}
