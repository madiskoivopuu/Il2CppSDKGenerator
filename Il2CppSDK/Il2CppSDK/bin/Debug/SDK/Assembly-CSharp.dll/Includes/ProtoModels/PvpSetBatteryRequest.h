...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PvpSetBatteryRequest*, uintptr_t))(Il2CppBase() + 0x11C3F94))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PvpSetBatteryRequest*, uintptr_t))(Il2CppBase() + 0x11C4030))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PvpSetBatteryRequest*, uintptr_t))(Il2CppBase() + 0x11C4278))(this, other);
	}
