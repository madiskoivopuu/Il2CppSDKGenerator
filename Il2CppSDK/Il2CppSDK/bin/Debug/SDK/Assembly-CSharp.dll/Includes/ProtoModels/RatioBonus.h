...
public: 
	...
	template <typename T = MessageParser1RatioBonus*>*> static T& _parser() {
	...
	template <typename T = MessageParser1RatioBonus*>*> static T get_Parser() {
	...
	template <typename T = RatioBonus*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(RatioBonus*, Il2CppObject*))(Il2CppBase() + 0x138AA0C))(this, other);
	}
	template <typename T = bool> T Equals_1(RatioBonus* other) {
		return ((T (*)(RatioBonus*, RatioBonus*))(Il2CppBase() + 0x138AA7C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(RatioBonus* other) {
		return ((T (*)(RatioBonus*, RatioBonus*))(Il2CppBase() + 0x138AD08))(this, other);
	}
