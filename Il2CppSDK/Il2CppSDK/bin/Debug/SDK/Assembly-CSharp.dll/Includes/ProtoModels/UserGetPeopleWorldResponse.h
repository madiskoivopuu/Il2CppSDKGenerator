...
public: 
	...
	template <typename T = void*> static T& _repeated_info_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& info_() {
	...
	template <typename T = void*> T get_Info() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserGetPeopleWorldResponse*, uintptr_t))(Il2CppBase() + 0x24693B4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserGetPeopleWorldResponse*, uintptr_t))(Il2CppBase() + 0x2469424))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserGetPeopleWorldResponse*, uintptr_t))(Il2CppBase() + 0x24697EC))(this, other);
	}
