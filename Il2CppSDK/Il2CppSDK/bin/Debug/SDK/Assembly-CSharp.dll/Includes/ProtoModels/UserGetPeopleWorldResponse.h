...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::UserGetPeopleWorldResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::UserGetPeopleWorldResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& InfoFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::UserGetPeopleWorldInfo*>*& _repeated_info_codec() {
		return *(FieldCodec1ProtoModels::UserGetPeopleWorldInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::UserGetPeopleWorldInfo*>*& info_() {
		return *(RepeatedField1ProtoModels::UserGetPeopleWorldInfo*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = Il2CppString*> R& codeMessage_() {
	 ...
	 static MessageParser1ProtoModels::UserGetPeopleWorldResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::UserGetPeopleWorldResponse*>* (*)(void *))(Il2CppBase() + 0x2468FA0))(0);
	}
	...
	template <typename R = ProtoModels::UserGetPeopleWorldResponse*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::UserGetPeopleWorldInfo*>* get_Info() {
		return ((RepeatedField1ProtoModels::UserGetPeopleWorldInfo*>* (*)(UserGetPeopleWorldResponse*))(Il2CppBase() + 0x2469314))(this);
	}
