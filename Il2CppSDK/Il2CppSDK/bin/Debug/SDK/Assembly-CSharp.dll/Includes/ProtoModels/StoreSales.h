...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::StoreSales*>*& _parser() {
		return *(MessageParser1ProtoModels::StoreSales*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& SalesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::StoreSale*>*& _repeated_sales_codec() {
		return *(FieldCodec1ProtoModels::StoreSale*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::StoreSale*>*& sales_() {
		return *(RepeatedField1ProtoModels::StoreSale*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::StoreSales*>* get_Parser() {
		return ((MessageParser1ProtoModels::StoreSales*>* (*)(void *))(Il2CppBase() + 0x183D678))(0);
	}
	...
	template <typename R = ProtoModels::StoreSales*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::StoreSale*>* get_Sales() {
		return ((RepeatedField1ProtoModels::StoreSale*>* (*)(StoreSales*))(Il2CppBase() + 0x183D9B0))(this);
	}
