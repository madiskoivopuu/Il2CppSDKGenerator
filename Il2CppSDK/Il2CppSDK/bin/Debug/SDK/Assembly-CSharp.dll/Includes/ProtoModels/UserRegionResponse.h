...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserRegionResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserRegionResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ServersFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ServerInfo*>*& _repeated_servers_codec() {
		return *(FieldCodec1<ProtoModels::ServerInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ServerInfo*>*& servers_() {
		return *(RepeatedField1<ProtoModels::ServerInfo*>**)((uintptr_t)this + 0x30);
	}

	 static MessageParser1<ProtoModels::UserRegionResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserRegionResponse*>* (*)(void *))(Il2CppBase() + 0x2476634))(0);
	}
	...
	template <typename R = void> R set_Region(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::ServerInfo*>* get_Servers() {
		return ((RepeatedField1<ProtoModels::ServerInfo*>* (*)(UserRegionResponse*))(Il2CppBase() + 0x2476B90))(this);
	}
