...
public: 
	...
	template <typename T = MessageParser1PlayerFindByName*>*> static T& _parser() {
	...
	template <typename T = PlayerSearchType*> T& searchType_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1PlayerFindByName*>*> static T get_Parser() {
	...
	template <typename T = PlayerFindByName*> T Clone() {
	...
	template <typename T = PlayerSearchType*> T get_SearchType() {
		return ((T (*)(PlayerFindByName*))(Il2CppBase() + 0x1568148))(this);
	}
	template <typename T = void> T set_SearchType(PlayerSearchType* value) {
		return ((T (*)(PlayerFindByName*, PlayerSearchType*))(Il2CppBase() + 0x1568150))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PlayerFindByName*, Il2CppObject*))(Il2CppBase() + 0x1568158))(this, other);
	}
	template <typename T = bool> T Equals_1(PlayerFindByName* other) {
		return ((T (*)(PlayerFindByName*, PlayerFindByName*))(Il2CppBase() + 0x15681C8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PlayerFindByName* other) {
		return ((T (*)(PlayerFindByName*, PlayerFindByName*))(Il2CppBase() + 0x15684EC))(this, other);
	}
