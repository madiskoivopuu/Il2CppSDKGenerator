...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetArenaStatisticRequest*, uintptr_t))(Il2CppBase() + 0x18B1DE0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetArenaStatisticRequest*, uintptr_t))(Il2CppBase() + 0x18B1E6C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetArenaStatisticRequest*, uintptr_t))(Il2CppBase() + 0x18B2014))(this, other);
	}
