...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::Clan*>*& _parser() {
		return *(MessageParser1<ProtoModels::Clan*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& CellsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::Cell*>*& _repeated_cells_codec() {
		return *(FieldCodec1<ProtoModels::Cell*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<ProtoModels::Cell*>*& cells_() {
		return *(RepeatedField1<ProtoModels::Cell*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = int32_t> static R& LocationsGradeFieldNumber() {
	 ...
	 MapField2<Il2CppString*, int32_t>*& locationsGrade_() {
		return *(MapField2<Il2CppString*, int32_t>**)((uintptr_t)this + 0x78);
	}
	template <typename R = int32_t> static R& ClanGameDataFieldNumber() {
	 ...
	 MapField2<Il2CppString*, Il2CppString*>*& clanGameData_() {
		return *(MapField2<Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0x80);
	}

	 static MessageParser1<ProtoModels::Clan*>* get_Parser() {
		return ((MessageParser1<ProtoModels::Clan*>* (*)(void *))(Il2CppBase() + 0x1747D2C))(0);
	}
	...
	template <typename R = void> R set_LockTimeDiplomacy(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::Player*>* get_Players() {
		return ((RepeatedField1<ProtoModels::Player*>* (*)(Clan*))(Il2CppBase() + 0x17483B4))(this);
	}
	 RepeatedField1<ProtoModels::Cell*>* get_Cells() {
		return ((RepeatedField1<ProtoModels::Cell*>* (*)(Clan*))(Il2CppBase() + 0x17483BC))(this);
	}
	...
	template <typename R = void> R set_CanCan(ProtoModels::Can* value) {
	 ...
	 MapField2<Il2CppString*, int32_t>* get_LocationsGrade() {
		return ((MapField2<Il2CppString*, int32_t>* (*)(Clan*))(Il2CppBase() + 0x1748404))(this);
	}
	 MapField2<Il2CppString*, Il2CppString*>* get_ClanGameData() {
		return ((MapField2<Il2CppString*, Il2CppString*>* (*)(Clan*))(Il2CppBase() + 0x174840C))(this);
	}
