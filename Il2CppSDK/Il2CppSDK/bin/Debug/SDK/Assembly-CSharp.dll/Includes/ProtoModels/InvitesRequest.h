...
public: 
	...
	template <typename T = MessageParser1InvitesRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1InvitesRequest*>*> static T get_Parser() {
	...
	template <typename T = InvitesRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(InvitesRequest*, Il2CppObject*))(Il2CppBase() + 0x12485D4))(this, other);
	}
	template <typename T = bool> T Equals_1(InvitesRequest* other) {
		return ((T (*)(InvitesRequest*, InvitesRequest*))(Il2CppBase() + 0x1248670))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(InvitesRequest* other) {
		return ((T (*)(InvitesRequest*, InvitesRequest*))(Il2CppBase() + 0x12488B8))(this, other);
	}
