...
public: 
	...
	template <typename T = void> T set_State(uintptr_t value) {
		return ((T (*)(Diplomacy*, uintptr_t))(Il2CppBase() + 0x12FB6A8))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(Diplomacy*, uintptr_t))(Il2CppBase() + 0x12FB6B0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(Diplomacy*, uintptr_t))(Il2CppBase() + 0x12FB720))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(Diplomacy*, uintptr_t))(Il2CppBase() + 0x12FBA9C))(this, other);
	}
