...
public: 
	...
	template <typename T = MessageParser1ArenaFrameInfo*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaFrameInfo*>*> static T get_Parser() {
	...
	template <typename T = ArenaFrameInfo*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaFrameInfo*, Il2CppObject*))(Il2CppBase() + 0x1E204A4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaFrameInfo* other) {
		return ((T (*)(ArenaFrameInfo*, ArenaFrameInfo*))(Il2CppBase() + 0x1E20540))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaFrameInfo* other) {
		return ((T (*)(ArenaFrameInfo*, ArenaFrameInfo*))(Il2CppBase() + 0x1E20788))(this, other);
	}
