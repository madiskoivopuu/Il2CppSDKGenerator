...
public: 
	...
	template <typename T = MessageParser1Portal*>*> static T& _parser() {
	...
	template <typename T = MessageParser1Portal*>*> static T get_Parser() {
	...
	template <typename T = Portal*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(Portal*, Il2CppObject*))(Il2CppBase() + 0x1576890))(this, other);
	}
	template <typename T = bool> T Equals_1(Portal* other) {
		return ((T (*)(Portal*, Portal*))(Il2CppBase() + 0x1576900))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(Portal* other) {
		return ((T (*)(Portal*, Portal*))(Il2CppBase() + 0x1576B8C))(this, other);
	}
