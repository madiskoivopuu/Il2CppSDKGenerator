...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaAdminTokenRequest*, uintptr_t))(Il2CppBase() + 0x1A1472C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaAdminTokenRequest*, uintptr_t))(Il2CppBase() + 0x1A1479C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaAdminTokenRequest*, uintptr_t))(Il2CppBase() + 0x1A14A8C))(this, other);
	}
