...
public: 
	...
	template <typename T = MessageParser1Requisite*>*> static T& _parser() {
	...
	template <typename T = MessageParser1Requisite*>*> static T get_Parser() {
	...
	template <typename T = Requisite*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(Requisite*, Il2CppObject*))(Il2CppBase() + 0x1199D60))(this, other);
	}
	template <typename T = bool> T Equals_1(Requisite* other) {
		return ((T (*)(Requisite*, Requisite*))(Il2CppBase() + 0x1199DD0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(Requisite* other) {
		return ((T (*)(Requisite*, Requisite*))(Il2CppBase() + 0x119A2CC))(this, other);
	}
