...
public: 
	...
	template <typename T = MessageParser1GlobalMapEnemyType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GlobalMapEnemyType*>*> static T get_Parser() {
	...
	template <typename T = GlobalMapEnemyType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GlobalMapEnemyType*, Il2CppObject*))(Il2CppBase() + 0x12D7C64))(this, other);
	}
	template <typename T = bool> T Equals_1(GlobalMapEnemyType* other) {
		return ((T (*)(GlobalMapEnemyType*, GlobalMapEnemyType*))(Il2CppBase() + 0x12D7CD4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GlobalMapEnemyType* other) {
		return ((T (*)(GlobalMapEnemyType*, GlobalMapEnemyType*))(Il2CppBase() + 0x12D807C))(this, other);
	}
