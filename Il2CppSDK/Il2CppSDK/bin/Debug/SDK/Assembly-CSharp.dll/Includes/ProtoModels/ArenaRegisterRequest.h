...
public: 
	...
	template <typename T = MessageParser1ArenaRegisterRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaRegisterRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaRegisterRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaRegisterRequest*, Il2CppObject*))(Il2CppBase() + 0x1A93B50))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaRegisterRequest* other) {
		return ((T (*)(ArenaRegisterRequest*, ArenaRegisterRequest*))(Il2CppBase() + 0x1A93BC0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaRegisterRequest* other) {
		return ((T (*)(ArenaRegisterRequest*, ArenaRegisterRequest*))(Il2CppBase() + 0x1A94294))(this, other);
	}
