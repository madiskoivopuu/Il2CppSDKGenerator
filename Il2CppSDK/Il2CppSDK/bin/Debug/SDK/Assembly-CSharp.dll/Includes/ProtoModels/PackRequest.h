...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::PackRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::PackRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& IncomeFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::PackIncome*>*& _repeated_income_codec() {
		return *(FieldCodec1<ProtoModels::PackIncome*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::PackIncome*>*& income_() {
		return *(RepeatedField1<ProtoModels::PackIncome*>**)((uintptr_t)this + 0x18);
	}

	 static MessageParser1<ProtoModels::PackRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::PackRequest*>* (*)(void *))(Il2CppBase() + 0x11E7D5C))(0);
	}
	...
	template <typename R = void> R set_ServerID(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::PackIncome*>* get_Income() {
		return ((RepeatedField1<ProtoModels::PackIncome*>* (*)(PackRequest*))(Il2CppBase() + 0x11E80AC))(this);
	}
