...
public: 
	...
	template <typename T = MessageParser1PackRequest*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1PackIncome*>*> static T& _repeated_income_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1PackIncome*>*> T& income_() {
		return *(T*)((uintptr_t)this + 0x18);
	}

	template <typename T = MessageParser1PackRequest*>*> static T get_Parser() {
	...
	template <typename T = PackRequest*> T Clone() {
	...
	template <typename T = RepeatedField1PackIncome*>*> T get_Income() {
		return ((T (*)(PackRequest*))(Il2CppBase() + 0x11E80AC))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PackRequest*, Il2CppObject*))(Il2CppBase() + 0x11E80B4))(this, other);
	}
	template <typename T = bool> T Equals_1(PackRequest* other) {
		return ((T (*)(PackRequest*, PackRequest*))(Il2CppBase() + 0x11E8124))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PackRequest* other) {
		return ((T (*)(PackRequest*, PackRequest*))(Il2CppBase() + 0x11E844C))(this, other);
	}
