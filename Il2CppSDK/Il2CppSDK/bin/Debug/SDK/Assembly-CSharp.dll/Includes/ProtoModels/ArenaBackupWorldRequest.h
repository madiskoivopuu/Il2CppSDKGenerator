...
public: 
	...
	template <typename T = MessageParser1ArenaBackupWorldRequest*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_worldJson_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& worldJson_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& UserInventoryFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1ArenaBackupUserInventory*>*> static T& _repeated_userInventory_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1ArenaBackupUserInventory*>*> T& userInventory_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1ArenaBackupWorldRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaBackupWorldRequest*> T Clone() {
	...
	template <typename T = RepeatedField1Il2CppString*>*> T get_WorldJson() {
		return ((T (*)(ArenaBackupWorldRequest*))(Il2CppBase() + 0x1A168D8))(this);
	}
	template <typename T = RepeatedField1ArenaBackupUserInventory*>*> T get_UserInventory() {
		return ((T (*)(ArenaBackupWorldRequest*))(Il2CppBase() + 0x1A168E0))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaBackupWorldRequest*, Il2CppObject*))(Il2CppBase() + 0x1A168E8))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaBackupWorldRequest* other) {
		return ((T (*)(ArenaBackupWorldRequest*, ArenaBackupWorldRequest*))(Il2CppBase() + 0x1A16958))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaBackupWorldRequest* other) {
		return ((T (*)(ArenaBackupWorldRequest*, ArenaBackupWorldRequest*))(Il2CppBase() + 0x1A16DC0))(this, other);
	}
