...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBackupWorldRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaBackupWorldRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& WorldJsonFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_worldJson_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<Il2CppString*>*& worldJson_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x20);
	}
	template <typename R = int32_t> static R& UserInventoryFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::ArenaBackupUserInventory*>*& _repeated_userInventory_codec() {
		return *(FieldCodec1<ProtoModels::ArenaBackupUserInventory*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<ProtoModels::ArenaBackupUserInventory*>*& userInventory_() {
		return *(RepeatedField1<ProtoModels::ArenaBackupUserInventory*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1<ProtoModels::ArenaBackupWorldRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaBackupWorldRequest*>* (*)(void *))(Il2CppBase() + 0x1A164F0))(0);
	}
	...
	template <typename R = void> R set_WorldsID(int64_t value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_WorldJson() {
		return ((RepeatedField1<Il2CppString*>* (*)(ArenaBackupWorldRequest*))(Il2CppBase() + 0x1A168D8))(this);
	}
	 RepeatedField1<ProtoModels::ArenaBackupUserInventory*>* get_UserInventory() {
		return ((RepeatedField1<ProtoModels::ArenaBackupUserInventory*>* (*)(ArenaBackupWorldRequest*))(Il2CppBase() + 0x1A168E0))(this);
	}
