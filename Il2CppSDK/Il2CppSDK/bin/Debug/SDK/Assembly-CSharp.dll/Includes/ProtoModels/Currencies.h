...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::Currencies*>*& _parser() {
		return *(MessageParser1<ProtoModels::Currencies*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& Currencies_FieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codec<int32_t, int32_t>*& _map_currencies_codec() {
		return *(Codec<int32_t, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2<int32_t, int32_t>*& currencies_() {
		return *(MapField2<int32_t, int32_t>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1<ProtoModels::Currencies*>* get_Parser() {
		return ((MessageParser1<ProtoModels::Currencies*>* (*)(void *))(Il2CppBase() + 0x1BCE29C))(0);
	}
	...
	template <typename R = ProtoModels::Currencies*> R Clone() {
	 ...
	 MapField2<int32_t, int32_t>* get_Currencies_() {
		return ((MapField2<int32_t, int32_t>* (*)(Currencies*))(Il2CppBase() + 0x1BCE4F4))(this);
	}
