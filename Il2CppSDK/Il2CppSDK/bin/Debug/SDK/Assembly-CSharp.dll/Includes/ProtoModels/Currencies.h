...
public: 
	...
	template <typename T = void*> static T& _map_currencies_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& currencies_() {
	...
	template <typename T = void*> T get_Currencies_() {
		return ((T (*)(Currencies*))(Il2CppBase() + 0x1BCE4F4))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(Currencies*, uintptr_t))(Il2CppBase() + 0x1BCE4FC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(Currencies*, uintptr_t))(Il2CppBase() + 0x1BCE56C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(Currencies*, uintptr_t))(Il2CppBase() + 0x1BCAC14))(this, other);
	}
