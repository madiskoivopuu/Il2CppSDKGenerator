...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AdminGetUsersResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::AdminGetUsersResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& UsersFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::MonitorUser*>*& _repeated_users_codec() {
		return *(FieldCodec1<ProtoModels::MonitorUser*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::MonitorUser*>*& users_() {
		return *(RepeatedField1<ProtoModels::MonitorUser*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::AdminGetUsersResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AdminGetUsersResponse*>* (*)(void *))(Il2CppBase() + 0x18B9E2C))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::MonitorUser*>* get_Users() {
		return ((RepeatedField1<ProtoModels::MonitorUser*>* (*)(AdminGetUsersResponse*))(Il2CppBase() + 0x18BA238))(this);
	}
