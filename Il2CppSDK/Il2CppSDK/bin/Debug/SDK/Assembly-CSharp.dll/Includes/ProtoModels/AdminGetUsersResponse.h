...
public: 
	...
	template <typename T = MessageParser1AdminGetUsersResponse*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1MonitorUser*>*> static T& _repeated_users_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1MonitorUser*>*> T& users_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1AdminGetUsersResponse*>*> static T get_Parser() {
	...
	template <typename T = AdminGetUsersResponse*> T Clone() {
	...
	template <typename T = RepeatedField1MonitorUser*>*> T get_Users() {
		return ((T (*)(AdminGetUsersResponse*))(Il2CppBase() + 0x18BA238))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminGetUsersResponse*, Il2CppObject*))(Il2CppBase() + 0x18BA240))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminGetUsersResponse* other) {
		return ((T (*)(AdminGetUsersResponse*, AdminGetUsersResponse*))(Il2CppBase() + 0x18BA2B0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminGetUsersResponse* other) {
		return ((T (*)(AdminGetUsersResponse*, AdminGetUsersResponse*))(Il2CppBase() + 0x18BA68C))(this, other);
	}
