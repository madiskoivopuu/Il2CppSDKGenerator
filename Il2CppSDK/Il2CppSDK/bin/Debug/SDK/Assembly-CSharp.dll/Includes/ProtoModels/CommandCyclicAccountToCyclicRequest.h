...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::CommandCyclicAccountToCyclicRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::CommandCyclicAccountToCyclicRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::MasterAccountInfoType*> R& masterAccountInfo_() {
	 ...
	 static MessageParser1ProtoModels::CommandCyclicAccountToCyclicRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::CommandCyclicAccountToCyclicRequest*>* (*)(void *))(Il2CppBase() + 0xE2876C))(0);
	}
