...
public: 
	...
	template <typename T = void> T set_Inventory(uintptr_t value) {
		return ((T (*)(ArenaBackupUserInventory*, uintptr_t))(Il2CppBase() + 0x1A15F78))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaBackupUserInventory*, uintptr_t))(Il2CppBase() + 0x1A15F80))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaBackupUserInventory*, uintptr_t))(Il2CppBase() + 0x1A15FF0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaBackupUserInventory*, uintptr_t))(Il2CppBase() + 0x1A16230))(this, other);
	}
