...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBackupUserInventory*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaBackupUserInventory*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::ArenaUserInventoryData*> R& inventory_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBackupUserInventory*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaBackupUserInventory*>* (*)(void *))(Il2CppBase() + 0x1A15CC4))(0);
	}
