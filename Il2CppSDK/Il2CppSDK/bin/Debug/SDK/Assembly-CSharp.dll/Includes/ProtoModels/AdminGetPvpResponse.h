...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminGetPvpResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminGetPvpResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PvpFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::MonitorPvpGroup*>*& _repeated_pvp_codec() {
		return *(FieldCodec1ProtoModels::MonitorPvpGroup*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::MonitorPvpGroup*>*& pvp_() {
		return *(RepeatedField1ProtoModels::MonitorPvpGroup*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1ProtoModels::AdminGetPvpResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminGetPvpResponse*>* (*)(void *))(Il2CppBase() + 0x18B5CB0))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::MonitorPvpGroup*>* get_Pvp() {
		return ((RepeatedField1ProtoModels::MonitorPvpGroup*>* (*)(AdminGetPvpResponse*))(Il2CppBase() + 0x18B60BC))(this);
	}
