...
public: 
	...
	template <typename T = MessageParser1ClanAvatarsType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ClanAvatarsType*>*> static T get_Parser() {
	...
	template <typename T = ClanAvatarsType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ClanAvatarsType*, Il2CppObject*))(Il2CppBase() + 0x174A878))(this, other);
	}
	template <typename T = bool> T Equals_1(ClanAvatarsType* other) {
		return ((T (*)(ClanAvatarsType*, ClanAvatarsType*))(Il2CppBase() + 0x174A8E8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ClanAvatarsType* other) {
		return ((T (*)(ClanAvatarsType*, ClanAvatarsType*))(Il2CppBase() + 0x174AC08))(this, other);
	}
