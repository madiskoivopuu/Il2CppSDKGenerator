...
public: 
	...
	template <typename T = MessageParser1HelloUserToCoordinatorResponse*>*> static T& _parser() {
	...
	template <typename T = ArenaClientProtocolType*> T& protocol_() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = int32_t> static T& ResourcesTypeFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = WorldResourcesType*> T& resourcesType_() {
		return *(T*)((uintptr_t)this + 0x4C);
	}

	template <typename T = MessageParser1HelloUserToCoordinatorResponse*>*> static T get_Parser() {
	...
	template <typename T = HelloUserToCoordinatorResponse*> T Clone() {
	...
	template <typename T = void> T set_WorldStatus(WorldStatusType* value) {
		return ((T (*)(HelloUserToCoordinatorResponse*, WorldStatusType*))(Il2CppBase() + 0x128CB2C))(this, value);
	}
	...
	template <typename T = ArenaClientProtocolType*> T get_Protocol() {
		return ((T (*)(HelloUserToCoordinatorResponse*))(Il2CppBase() + 0x128CB44))(this);
	}
	template <typename T = void> T set_Protocol(ArenaClientProtocolType* value) {
		return ((T (*)(HelloUserToCoordinatorResponse*, ArenaClientProtocolType*))(Il2CppBase() + 0x128CB4C))(this, value);
	}
	template <typename T = WorldResourcesType*> T get_ResourcesType() {
		return ((T (*)(HelloUserToCoordinatorResponse*))(Il2CppBase() + 0x128CB54))(this);
	}
	template <typename T = void> T set_ResourcesType(WorldResourcesType* value) {
		return ((T (*)(HelloUserToCoordinatorResponse*, WorldResourcesType*))(Il2CppBase() + 0x128CB5C))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(HelloUserToCoordinatorResponse*, Il2CppObject*))(Il2CppBase() + 0x128CB64))(this, other);
	}
	template <typename T = bool> T Equals_1(HelloUserToCoordinatorResponse* other) {
		return ((T (*)(HelloUserToCoordinatorResponse*, HelloUserToCoordinatorResponse*))(Il2CppBase() + 0x128CBD4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(HelloUserToCoordinatorResponse* other) {
		return ((T (*)(HelloUserToCoordinatorResponse*, HelloUserToCoordinatorResponse*))(Il2CppBase() + 0x128D28C))(this, other);
	}
