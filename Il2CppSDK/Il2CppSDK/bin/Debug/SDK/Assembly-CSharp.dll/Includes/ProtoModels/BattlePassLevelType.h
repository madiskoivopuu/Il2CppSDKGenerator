...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(BattlePassLevelType*, uintptr_t))(Il2CppBase() + 0x167B36C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(BattlePassLevelType*, uintptr_t))(Il2CppBase() + 0x167B3DC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(BattlePassLevelType*, uintptr_t))(Il2CppBase() + 0x167B668))(this, other);
	}
