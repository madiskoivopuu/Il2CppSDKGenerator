...
public: 
	...
	template <typename T = MessageParser1ArenaVipBonus*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaVipBonus*>*> static T get_Parser() {
	...
	template <typename T = ArenaVipBonus*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaVipBonus*, Il2CppObject*))(Il2CppBase() + 0x286648C))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaVipBonus* other) {
		return ((T (*)(ArenaVipBonus*, ArenaVipBonus*))(Il2CppBase() + 0x28664FC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaVipBonus* other) {
		return ((T (*)(ArenaVipBonus*, ArenaVipBonus*))(Il2CppBase() + 0x28669F4))(this, other);
	}
