...
public: 
	...
	template <typename T = MessageParser1LoginUserResponse*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1ClientConfigurationItem*>*> static T& _repeated_configs_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1ClientConfigurationItem*>*> T& configs_() {
	...
	template <typename T = ShortServerUserInfo*> T& bonusUser_() {
		return *(T*)((uintptr_t)this + 0x90);
	}

	template <typename T = MessageParser1LoginUserResponse*>*> static T get_Parser() {
	...
	template <typename T = LoginUserResponse*> T Clone() {
	...
	template <typename T = RepeatedField1ClientConfigurationItem*>*> T get_Configs() {
	...
	template <typename T = ShortServerUserInfo*> T get_BonusUser() {
		return ((T (*)(LoginUserResponse*))(Il2CppBase() + 0x172EDE0))(this);
	}
	template <typename T = void> T set_BonusUser(ShortServerUserInfo* value) {
		return ((T (*)(LoginUserResponse*, ShortServerUserInfo*))(Il2CppBase() + 0x172EDE8))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(LoginUserResponse*, Il2CppObject*))(Il2CppBase() + 0x172EDF0))(this, other);
	}
	template <typename T = bool> T Equals_1(LoginUserResponse* other) {
		return ((T (*)(LoginUserResponse*, LoginUserResponse*))(Il2CppBase() + 0x172EE60))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(LoginUserResponse* other) {
		return ((T (*)(LoginUserResponse*, LoginUserResponse*))(Il2CppBase() + 0x172FB4C))(this, other);
	}
