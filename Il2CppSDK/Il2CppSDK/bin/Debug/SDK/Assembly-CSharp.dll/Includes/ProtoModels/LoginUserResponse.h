...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::LoginUserResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::LoginUserResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ConfigsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ClientConfigurationItem*>*& _repeated_configs_codec() {
		return *(FieldCodec1<ProtoModels::ClientConfigurationItem*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ClientConfigurationItem*>*& configs_() {
		return *(RepeatedField1<ProtoModels::ClientConfigurationItem*>**)((uintptr_t)this + 0x80);
	}
	...
	template <typename R = ProtoModels::ShortServerUserInfo*> R& bonusUser_() {
	 ...
	 static MessageParser1<ProtoModels::LoginUserResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::LoginUserResponse*>* (*)(void *))(Il2CppBase() + 0x172E400))(0);
	}
	...
	template <typename R = void> R set_BanRule(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::ClientConfigurationItem*>* get_Configs() {
		return ((RepeatedField1<ProtoModels::ClientConfigurationItem*>* (*)(LoginUserResponse*))(Il2CppBase() + 0x172EDC4))(this);
	}
