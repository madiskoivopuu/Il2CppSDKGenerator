...
public: 
	...
	template <typename T = MessageParser1ArenaStatueStartEventRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaStatueStartEventRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaStatueStartEventRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaStatueStartEventRequest*, Il2CppObject*))(Il2CppBase() + 0x2713698))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaStatueStartEventRequest* other) {
		return ((T (*)(ArenaStatueStartEventRequest*, ArenaStatueStartEventRequest*))(Il2CppBase() + 0x2713734))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaStatueStartEventRequest* other) {
		return ((T (*)(ArenaStatueStartEventRequest*, ArenaStatueStartEventRequest*))(Il2CppBase() + 0x271397C))(this, other);
	}
