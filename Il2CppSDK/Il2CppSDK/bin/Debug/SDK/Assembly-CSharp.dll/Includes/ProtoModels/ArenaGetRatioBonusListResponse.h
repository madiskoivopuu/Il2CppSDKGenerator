...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGetRatioBonusListResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaGetRatioBonusListResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::RatioAllTablesBonuses*> R& bonus_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGetRatioBonusListResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaGetRatioBonusListResponse*>* (*)(void *))(Il2CppBase() + 0x1E247F8))(0);
	}
