...
public: 
	...
	template <typename T = uintptr_t> T& bonus_() {
	...
	template <typename T = uintptr_t> T get_Bonus() {
		return ((T (*)(ArenaGetRatioBonusListResponse*))(Il2CppBase() + 0x1E24B8C))(this);
	}
	template <typename T = void> T set_Bonus(uintptr_t value) {
		return ((T (*)(ArenaGetRatioBonusListResponse*, uintptr_t))(Il2CppBase() + 0x1E24B94))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGetRatioBonusListResponse*, uintptr_t))(Il2CppBase() + 0x1E24B9C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGetRatioBonusListResponse*, uintptr_t))(Il2CppBase() + 0x1E24C0C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGetRatioBonusListResponse*, uintptr_t))(Il2CppBase() + 0x1E24F2C))(this, other);
	}
