...
public: 
	...
	template <typename T = void*> static T& _repeated_battery_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& battery_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& ForceOpenWindowFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_forceOpenWindow_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& forceOpenWindow_() {
	...
	template <typename T = void> T set_Friends(uintptr_t value) {
		return ((T (*)(PvpGroupPackData*, uintptr_t))(Il2CppBase() + 0x11C29C4))(this, value);
	}
	...
	template <typename T = void> T set_FriendsCandidate(uintptr_t value) {
		return ((T (*)(PvpGroupPackData*, uintptr_t))(Il2CppBase() + 0x11C29D4))(this, value);
	}
	template <typename T = void*> T get_Battery() {
		return ((T (*)(PvpGroupPackData*))(Il2CppBase() + 0x11C29DC))(this);
	}
	template <typename T = void*> T get_ForceOpenWindow() {
		return ((T (*)(PvpGroupPackData*))(Il2CppBase() + 0x11C29E4))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PvpGroupPackData*, uintptr_t))(Il2CppBase() + 0x11C29EC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PvpGroupPackData*, uintptr_t))(Il2CppBase() + 0x11C2A5C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PvpGroupPackData*, uintptr_t))(Il2CppBase() + 0x11C2E8C))(this, other);
	}
