...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::PvpGroupPackData*>*& _parser() {
		return *(MessageParser1<ProtoModels::PvpGroupPackData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& BatteryFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ClanTime*>*& _repeated_battery_codec() {
		return *(FieldCodec1<ProtoModels::ClanTime*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ClanTime*>*& battery_() {
		return *(RepeatedField1<ProtoModels::ClanTime*>**)((uintptr_t)this + 0x20);
	}
	template <typename R = int32_t> static R& ForceOpenWindowFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::ClanTime*>*& _repeated_forceOpenWindow_codec() {
		return *(FieldCodec1<ProtoModels::ClanTime*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<ProtoModels::ClanTime*>*& forceOpenWindow_() {
		return *(RepeatedField1<ProtoModels::ClanTime*>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1<ProtoModels::PvpGroupPackData*>* get_Parser() {
		return ((MessageParser1<ProtoModels::PvpGroupPackData*>* (*)(void *))(Il2CppBase() + 0x11C25E0))(0);
	}
	...
	template <typename R = void> R set_FriendsCandidate(ProtoModels::FriendPairListType* value) {
	 ...
	 RepeatedField1<ProtoModels::ClanTime*>* get_Battery() {
		return ((RepeatedField1<ProtoModels::ClanTime*>* (*)(PvpGroupPackData*))(Il2CppBase() + 0x11C29DC))(this);
	}
	 RepeatedField1<ProtoModels::ClanTime*>* get_ForceOpenWindow() {
		return ((RepeatedField1<ProtoModels::ClanTime*>* (*)(PvpGroupPackData*))(Il2CppBase() + 0x11C29E4))(this);
	}
