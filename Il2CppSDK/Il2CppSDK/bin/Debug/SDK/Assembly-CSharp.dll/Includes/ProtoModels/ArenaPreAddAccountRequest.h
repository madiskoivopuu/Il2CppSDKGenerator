...
public: 
	...
	template <typename T = MessageParser1ArenaPreAddAccountRequest*>*> static T& _parser() {
	...
	template <typename T = PvpGroup*> T& pvp_() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = int32_t> static T& TourneyFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = Tourney*> T& tourney_() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = int32_t> static T& GuildFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1GuildMessageType*>*> static T& _repeated_guild_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1GuildMessageType*>*> T& guild_() {
		return *(T*)((uintptr_t)this + 0x38);
	}

	template <typename T = MessageParser1ArenaPreAddAccountRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaPreAddAccountRequest*> T Clone() {
	...
	template <typename T = PvpGroup*> T get_Pvp() {
		return ((T (*)(ArenaPreAddAccountRequest*))(Il2CppBase() + 0x1E30588))(this);
	}
	template <typename T = void> T set_Pvp(PvpGroup* value) {
		return ((T (*)(ArenaPreAddAccountRequest*, PvpGroup*))(Il2CppBase() + 0x1E30590))(this, value);
	}
	template <typename T = Tourney*> T get_Tourney() {
		return ((T (*)(ArenaPreAddAccountRequest*))(Il2CppBase() + 0x1E30598))(this);
	}
	template <typename T = void> T set_Tourney(Tourney* value) {
		return ((T (*)(ArenaPreAddAccountRequest*, Tourney*))(Il2CppBase() + 0x1E305A0))(this, value);
	}
	template <typename T = RepeatedField1GuildMessageType*>*> T get_Guild() {
		return ((T (*)(ArenaPreAddAccountRequest*))(Il2CppBase() + 0x1E305A8))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaPreAddAccountRequest*, Il2CppObject*))(Il2CppBase() + 0x1E305B0))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaPreAddAccountRequest* other) {
		return ((T (*)(ArenaPreAddAccountRequest*, ArenaPreAddAccountRequest*))(Il2CppBase() + 0x1E30620))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaPreAddAccountRequest* other) {
		return ((T (*)(ArenaPreAddAccountRequest*, ArenaPreAddAccountRequest*))(Il2CppBase() + 0x1E30B7C))(this, other);
	}
