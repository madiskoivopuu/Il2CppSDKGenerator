...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaPreAddAccountRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaPreAddAccountRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& GuildFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::GuildMessageType*>*& _repeated_guild_codec() {
		return *(FieldCodec1<ProtoModels::GuildMessageType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::GuildMessageType*>*& guild_() {
		return *(RepeatedField1<ProtoModels::GuildMessageType*>**)((uintptr_t)this + 0x38);
	}

	 static MessageParser1<ProtoModels::ArenaPreAddAccountRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaPreAddAccountRequest*>* (*)(void *))(Il2CppBase() + 0x1E301B4))(0);
	}
	...
	template <typename R = void> R set_Tourney(ProtoModels::Tourney* value) {
	 ...
	 RepeatedField1<ProtoModels::GuildMessageType*>* get_Guild() {
		return ((RepeatedField1<ProtoModels::GuildMessageType*>* (*)(ArenaPreAddAccountRequest*))(Il2CppBase() + 0x1E305A8))(this);
	}
