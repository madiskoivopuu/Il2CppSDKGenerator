...
public: 
	...
	template <typename T = uintptr_t> T& toClan_() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = int32_t> static T& FromClanFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& fromClan_() {
	...
	template <typename T = uintptr_t> T get_ToClan() {
		return ((T (*)(KickUserRequest*))(Il2CppBase() + 0x14EC858))(this);
	}
	template <typename T = void> T set_ToClan(uintptr_t value) {
		return ((T (*)(KickUserRequest*, uintptr_t))(Il2CppBase() + 0x14EC860))(this, value);
	}
	template <typename T = uintptr_t> T get_FromClan() {
		return ((T (*)(KickUserRequest*))(Il2CppBase() + 0x14EC868))(this);
	}
	template <typename T = void> T set_FromClan(uintptr_t value) {
		return ((T (*)(KickUserRequest*, uintptr_t))(Il2CppBase() + 0x14EC870))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(KickUserRequest*, uintptr_t))(Il2CppBase() + 0x14EC878))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(KickUserRequest*, uintptr_t))(Il2CppBase() + 0x14EC8E8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(KickUserRequest*, uintptr_t))(Il2CppBase() + 0x14ECBE8))(this, other);
	}
