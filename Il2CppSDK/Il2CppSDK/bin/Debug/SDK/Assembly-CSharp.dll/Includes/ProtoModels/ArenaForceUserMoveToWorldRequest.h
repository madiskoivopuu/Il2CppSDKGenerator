...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaForceUserMoveToWorldRequest*, uintptr_t))(Il2CppBase() + 0x1E1F0A4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaForceUserMoveToWorldRequest*, uintptr_t))(Il2CppBase() + 0x1E1F114))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaForceUserMoveToWorldRequest*, uintptr_t))(Il2CppBase() + 0x1E1F56C))(this, other);
	}
