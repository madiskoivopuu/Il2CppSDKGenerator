...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaForceUserMoveToWorldRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaForceUserMoveToWorldRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& locationName_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaForceUserMoveToWorldRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaForceUserMoveToWorldRequest*>* (*)(void *))(Il2CppBase() + 0x1E1EC5C))(0);
	}
