...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ShortStoreProduct*>*& _parser() {
		return *(MessageParser1<ProtoModels::ShortStoreProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& CategoriesFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ArenaStoreCategory*>*& _repeated_categories_codec() {
		return *(FieldCodec1<ProtoModels::ArenaStoreCategory*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ArenaStoreCategory*>*& categories_() {
		return *(RepeatedField1<ProtoModels::ArenaStoreCategory*>**)((uintptr_t)this + 0x40);
	}
	template <typename R = int32_t> static R& ResourcesFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ArenaStoreResource*>*& _repeated_resources_codec() {
		return *(FieldCodec1<ProtoModels::ArenaStoreResource*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<ProtoModels::ArenaStoreResource*>*& resources_() {
		return *(RepeatedField1<ProtoModels::ArenaStoreResource*>**)((uintptr_t)this + 0x48);
	}
	...
	template <typename R = int32_t> static R& DiscountsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ArenaStoreProductDiscount*>*& _repeated_discounts_codec() {
		return *(FieldCodec1<ProtoModels::ArenaStoreProductDiscount*>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1<ProtoModels::ArenaStoreProductDiscount*>*& discounts_() {
		return *(RepeatedField1<ProtoModels::ArenaStoreProductDiscount*>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = int32_t> R& coinCompensation_() {
	 ...
	 static MessageParser1<ProtoModels::ShortStoreProduct*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ShortStoreProduct*>* (*)(void *))(Il2CppBase() + 0x1631544))(0);
	}
	...
	template <typename R = void> R set_MaxCount(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::ArenaStoreCategory*>* get_Categories() {
		return ((RepeatedField1<ProtoModels::ArenaStoreCategory*>* (*)(ShortStoreProduct*))(Il2CppBase() + 0x1631C58))(this);
	}
	 RepeatedField1<ProtoModels::ArenaStoreResource*>* get_Resources() {
		return ((RepeatedField1<ProtoModels::ArenaStoreResource*>* (*)(ShortStoreProduct*))(Il2CppBase() + 0x1631C60))(this);
	}
	...
	template <typename R = void> R set_EndTime(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::ArenaStoreProductDiscount*>* get_Discounts() {
		return ((RepeatedField1<ProtoModels::ArenaStoreProductDiscount*>* (*)(ShortStoreProduct*))(Il2CppBase() + 0x1631C88))(this);
	}
