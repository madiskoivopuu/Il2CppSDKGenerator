...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaPurchaseRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaPurchaseRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::PurchaseInfoType*> R& purchase_() {
	 ...
	 static MessageParser1ProtoModels::ArenaPurchaseRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaPurchaseRequest*>* (*)(void *))(Il2CppBase() + 0x1A6807C))(0);
	}
