...
public: 
	...
	template <typename T = void> T set_Clan(uintptr_t value) {
		return ((T (*)(PlayerResponse*, uintptr_t))(Il2CppBase() + 0x156DB44))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PlayerResponse*, uintptr_t))(Il2CppBase() + 0x156DB4C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PlayerResponse*, uintptr_t))(Il2CppBase() + 0x156DBBC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PlayerResponse*, uintptr_t))(Il2CppBase() + 0x156DEDC))(this, other);
	}
