...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::PredefinedRollPoolProgress*>*& _parser() {
		return *(MessageParser1ProtoModels::PredefinedRollPoolProgress*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ProgressDataFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::PredefinedRollPoolProgressData*>*& _repeated_progressData_codec() {
		return *(FieldCodec1ProtoModels::PredefinedRollPoolProgressData*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::PredefinedRollPoolProgressData*>*& progressData_() {
		return *(RepeatedField1ProtoModels::PredefinedRollPoolProgressData*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int64_t> R& startTime_() {
	 ...
	 static MessageParser1ProtoModels::PredefinedRollPoolProgress*>* get_Parser() {
		return ((MessageParser1ProtoModels::PredefinedRollPoolProgress*>* (*)(void *))(Il2CppBase() + 0x16DCEF8))(0);
	}
	...
	template <typename R = ProtoModels::PredefinedRollPoolProgress*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::PredefinedRollPoolProgressData*>* get_ProgressData() {
		return ((RepeatedField1ProtoModels::PredefinedRollPoolProgressData*>* (*)(PredefinedRollPoolProgress*))(Il2CppBase() + 0x16DD244))(this);
	}
