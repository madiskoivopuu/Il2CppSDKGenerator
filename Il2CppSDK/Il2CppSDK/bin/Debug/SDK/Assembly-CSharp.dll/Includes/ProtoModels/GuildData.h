...
public: 
	...
	template <typename T = void*> static T& _map_quests_codec() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(GuildData*, uintptr_t))(Il2CppBase() + 0x12ED410))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(GuildData*, uintptr_t))(Il2CppBase() + 0x12ED480))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(GuildData*, uintptr_t))(Il2CppBase() + 0x12ED9C8))(this, other);
	}
