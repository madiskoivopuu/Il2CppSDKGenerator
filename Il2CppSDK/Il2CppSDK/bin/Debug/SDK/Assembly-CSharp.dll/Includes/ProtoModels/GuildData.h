...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GuildData*>*& _parser() {
		return *(MessageParser1<ProtoModels::GuildData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& UsersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::GuildUser*>*& _repeated_users_codec() {
		return *(FieldCodec1<ProtoModels::GuildUser*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::GuildUser*>*& users_() {
		return *(RepeatedField1<ProtoModels::GuildUser*>**)((uintptr_t)this + 0x10);
	}
	template <typename R = int32_t> static R& QuestsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codec<Il2CppString*, ProtoModels::GuildQuest*>*& _map_quests_codec() {
		return *(Codec<Il2CppString*, ProtoModels::GuildQuest*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2<Il2CppString*, ProtoModels::GuildQuest*>*& quests_() {
		return *(MapField2<Il2CppString*, ProtoModels::GuildQuest*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = int32_t> static R& KilledBossesFieldNumber() {
	 ...
	 RepeatedField1<Il2CppString*>*& killedBosses_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x30);
	}

	 static MessageParser1<ProtoModels::GuildData*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GuildData*>* (*)(void *))(Il2CppBase() + 0x12ECF8C))(0);
	}
	...
	template <typename R = ProtoModels::GuildData*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::GuildUser*>* get_Users() {
		return ((RepeatedField1<ProtoModels::GuildUser*>* (*)(GuildData*))(Il2CppBase() + 0x12ED3D8))(this);
	}
	 MapField2<Il2CppString*, ProtoModels::GuildQuest*>* get_Quests() {
		return ((MapField2<Il2CppString*, ProtoModels::GuildQuest*>* (*)(GuildData*))(Il2CppBase() + 0x12ED3E0))(this);
	}
	...
	template <typename R = void> R set_QuestID(int32_t value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_KilledBosses() {
		return ((RepeatedField1<Il2CppString*>* (*)(GuildData*))(Il2CppBase() + 0x12ED408))(this);
	}
