...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::MapSlotEventUsageType*>*& _parser() {
		return *(MessageParser1ProtoModels::MapSlotEventUsageType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& lastTimeLocationReset_() {
	 ...
	 static MessageParser1ProtoModels::MapSlotEventUsageType*>* get_Parser() {
		return ((MessageParser1ProtoModels::MapSlotEventUsageType*>* (*)(void *))(Il2CppBase() + 0x12C4D1C))(0);
	}
