...
public: 
	...
	template <typename T = MessageParser1MapSlotEventUsageType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1MapSlotEventUsageType*>*> static T get_Parser() {
	...
	template <typename T = MapSlotEventUsageType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(MapSlotEventUsageType*, Il2CppObject*))(Il2CppBase() + 0x12C511C))(this, other);
	}
	template <typename T = bool> T Equals_1(MapSlotEventUsageType* other) {
		return ((T (*)(MapSlotEventUsageType*, MapSlotEventUsageType*))(Il2CppBase() + 0x12C518C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(MapSlotEventUsageType* other) {
		return ((T (*)(MapSlotEventUsageType*, MapSlotEventUsageType*))(Il2CppBase() + 0x12C5794))(this, other);
	}
