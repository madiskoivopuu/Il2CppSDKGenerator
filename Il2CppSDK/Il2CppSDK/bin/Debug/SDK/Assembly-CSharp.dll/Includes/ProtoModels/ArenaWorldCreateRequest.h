...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaWorldCreateRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaWorldCreateRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& JsonDataFieldNumber() {
	 ...
	 static FieldCodec1Il2CppString*>*& _repeated_jsonData_codec() {
		return *(FieldCodec1Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1Il2CppString*>*& jsonData_() {
	...
	template <typename R = int32_t> static R& GlobalMapFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::NewGlobalMapType*>*& _repeated_globalMap_codec() {
		return *(FieldCodec1ProtoModels::NewGlobalMapType*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::NewGlobalMapType*>*& globalMap_() {
		return *(RepeatedField1ProtoModels::NewGlobalMapType*>**)((uintptr_t)this + 0x38);
	}
	template <typename R = int32_t> static R& CellOwnerFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_cellOwner_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1int64_t>*& cellOwner_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x40);
	}
	template <typename R = int32_t> static R& ClanAvatarsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::ClanAvatarsType*>*& _repeated_clanAvatars_codec() {
		return *(FieldCodec1ProtoModels::ClanAvatarsType*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1ProtoModels::ClanAvatarsType*>*& clanAvatars_() {
		return *(RepeatedField1ProtoModels::ClanAvatarsType*>**)((uintptr_t)this + 0x48);
	}
	...
	template <typename R = int32_t> static R& OwnersFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::Player*>*& _repeated_owners_codec() {
		return *(FieldCodec1ProtoModels::Player*>**)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	 RepeatedField1ProtoModels::Player*>*& owners_() {
		return *(RepeatedField1ProtoModels::Player*>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = bool> R& getKillMobStats_() {
	 ...
	 static MessageParser1ProtoModels::ArenaWorldCreateRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaWorldCreateRequest*>* (*)(void *))(Il2CppBase() + 0x28694F8))(0);
	}
	...
	template <typename R = void> R set_Name(Il2CppString* value) {
	 ...
	 RepeatedField1Il2CppString*>* get_JsonData() {
		return ((RepeatedField1Il2CppString*>* (*)(ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869B68))(this);
	}
	...
	template <typename R = void> R set_Params(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::NewGlobalMapType*>* get_GlobalMap() {
		return ((RepeatedField1ProtoModels::NewGlobalMapType*>* (*)(ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869C0C))(this);
	}
	 RepeatedField1int64_t>* get_CellOwner() {
		return ((RepeatedField1int64_t>* (*)(ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869C14))(this);
	}
	 RepeatedField1ProtoModels::ClanAvatarsType*>* get_ClanAvatars() {
		return ((RepeatedField1ProtoModels::ClanAvatarsType*>* (*)(ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869C1C))(this);
	}
	...
	template <typename R = void> R set_WorldVariant(ProtoModels::WorldVariantEnum* value) {
	 ...
	 RepeatedField1ProtoModels::Player*>* get_Owners() {
		return ((RepeatedField1ProtoModels::Player*>* (*)(ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869C44))(this);
	}
