...
public: 
	...
	template <typename T = MessageParser1ArenaWorldCreateRequest*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1NewGlobalMapType*>*> static T& _repeated_globalMap_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1NewGlobalMapType*>*> T& globalMap_() {
	...
	template <typename T = FieldCodec1ClanAvatarsType*>*> static T& _repeated_clanAvatars_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = RepeatedField1ClanAvatarsType*>*> T& clanAvatars_() {
	...
	template <typename T = WorldVariantEnum*> T& worldVariant_() {
		return *(T*)((uintptr_t)this + 0x58);
	}
	template <typename T = int32_t> static T& OwnersFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1Player*>*> static T& _repeated_owners_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = RepeatedField1Player*>*> T& owners_() {
	...
	template <typename T = MessageParser1ArenaWorldCreateRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaWorldCreateRequest*> T Clone() {
	...
	template <typename T = RepeatedField1NewGlobalMapType*>*> T get_GlobalMap() {
	...
	template <typename T = RepeatedField1ClanAvatarsType*>*> T get_ClanAvatars() {
	...
	template <typename T = WorldVariantEnum*> T get_WorldVariant() {
		return ((T (*)(ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869C34))(this);
	}
	template <typename T = void> T set_WorldVariant(WorldVariantEnum* value) {
		return ((T (*)(ArenaWorldCreateRequest*, WorldVariantEnum*))(Il2CppBase() + 0x2869C3C))(this, value);
	}
	template <typename T = RepeatedField1Player*>*> T get_Owners() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaWorldCreateRequest*, Il2CppObject*))(Il2CppBase() + 0x2869C84))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaWorldCreateRequest* other) {
		return ((T (*)(ArenaWorldCreateRequest*, ArenaWorldCreateRequest*))(Il2CppBase() + 0x2869CF4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaWorldCreateRequest* other) {
		return ((T (*)(ArenaWorldCreateRequest*, ArenaWorldCreateRequest*))(Il2CppBase() + 0x286A7EC))(this, other);
	}
