...
public: 
	...
	template <typename T = MessageParser1ArenaGameConfiguration*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaGameConfiguration*>*> static T get_Parser() {
	...
	template <typename T = ArenaGameConfiguration*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaGameConfiguration*, Il2CppObject*))(Il2CppBase() + 0x1E20BB4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaGameConfiguration* other) {
		return ((T (*)(ArenaGameConfiguration*, ArenaGameConfiguration*))(Il2CppBase() + 0x1E20C24))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaGameConfiguration* other) {
		return ((T (*)(ArenaGameConfiguration*, ArenaGameConfiguration*))(Il2CppBase() + 0x1E1C724))(this, other);
	}
