...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGameConfiguration*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaGameConfiguration*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = float> R& freyrCupProcSuper_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGameConfiguration*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaGameConfiguration*>* (*)(void *))(Il2CppBase() + 0x1E20948))(0);
	}
