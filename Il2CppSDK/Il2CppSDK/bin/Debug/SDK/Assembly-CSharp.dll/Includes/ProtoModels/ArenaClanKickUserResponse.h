...
public: 
	...
	template <typename T = MessageParser1ArenaClanKickUserResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaClanKickUserResponse*>*> static T get_Parser() {
	...
	template <typename T = ArenaClanKickUserResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaClanKickUserResponse*, Il2CppObject*))(Il2CppBase() + 0x1A1D030))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaClanKickUserResponse* other) {
		return ((T (*)(ArenaClanKickUserResponse*, ArenaClanKickUserResponse*))(Il2CppBase() + 0x1A1D0A0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaClanKickUserResponse* other) {
		return ((T (*)(ArenaClanKickUserResponse*, ArenaClanKickUserResponse*))(Il2CppBase() + 0x1A1D3AC))(this, other);
	}
