...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClanKickUserResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaClanKickUserResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& disband_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClanKickUserResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaClanKickUserResponse*>* (*)(void *))(Il2CppBase() + 0x1A1CCA4))(0);
	}
