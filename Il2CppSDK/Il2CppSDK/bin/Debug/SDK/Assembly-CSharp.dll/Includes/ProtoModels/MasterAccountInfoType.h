...
public: 
	...
	template <typename T = void*> static T& _repeated_customization_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& customization_() {
	...
	template <typename T = void*> T get_Customization() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(MasterAccountInfoType*, uintptr_t))(Il2CppBase() + 0x12CC1E4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(MasterAccountInfoType*, uintptr_t))(Il2CppBase() + 0x12CC254))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(MasterAccountInfoType*, uintptr_t))(Il2CppBase() + 0x12CC8B8))(this, other);
	}
