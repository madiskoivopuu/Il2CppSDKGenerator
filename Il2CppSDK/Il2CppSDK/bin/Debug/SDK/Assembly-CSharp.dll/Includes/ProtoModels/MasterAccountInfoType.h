...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::MasterAccountInfoType*>*& _parser() {
		return *(MessageParser1ProtoModels::MasterAccountInfoType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& CustomizationFieldNumber() {
	 ...
	 static FieldCodec1Il2CppString*>*& _repeated_customization_codec() {
		return *(FieldCodec1Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1Il2CppString*>*& customization_() {
	...
	template <typename R = int32_t> R& gender_() {
	 ...
	 static MessageParser1ProtoModels::MasterAccountInfoType*>* get_Parser() {
		return ((MessageParser1ProtoModels::MasterAccountInfoType*>* (*)(void *))(Il2CppBase() + 0x12CBC48))(0);
	}
	...
	template <typename R = void> R set_UserID(int64_t value) {
	 ...
	 RepeatedField1Il2CppString*>* get_Customization() {
		return ((RepeatedField1Il2CppString*>* (*)(MasterAccountInfoType*))(Il2CppBase() + 0x12CC1CC))(this);
	}
