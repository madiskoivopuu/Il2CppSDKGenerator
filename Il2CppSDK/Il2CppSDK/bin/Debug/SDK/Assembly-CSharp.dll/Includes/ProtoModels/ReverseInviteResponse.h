...
public: 
	...
	template <typename T = MessageParser1ReverseInviteResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ReverseInviteResponse*>*> static T get_Parser() {
	...
	template <typename T = ReverseInviteResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ReverseInviteResponse*, Il2CppObject*))(Il2CppBase() + 0x119FA8C))(this, other);
	}
	template <typename T = bool> T Equals_1(ReverseInviteResponse* other) {
		return ((T (*)(ReverseInviteResponse*, ReverseInviteResponse*))(Il2CppBase() + 0x119FAFC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ReverseInviteResponse* other) {
		return ((T (*)(ReverseInviteResponse*, ReverseInviteResponse*))(Il2CppBase() + 0x119FEB4))(this, other);
	}
