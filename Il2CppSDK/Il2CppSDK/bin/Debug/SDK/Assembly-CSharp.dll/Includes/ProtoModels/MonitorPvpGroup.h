...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::MonitorPvpGroup*>*& _parser() {
		return *(MessageParser1<ProtoModels::MonitorPvpGroup*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ClansFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::MonitorPvpClanInfo*>*& _repeated_clans_codec() {
		return *(FieldCodec1<ProtoModels::MonitorPvpClanInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::MonitorPvpClanInfo*>*& clans_() {
		return *(RepeatedField1<ProtoModels::MonitorPvpClanInfo*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = bool> R& isFakeGroup_() {
	 ...
	 static MessageParser1<ProtoModels::MonitorPvpGroup*>* get_Parser() {
		return ((MessageParser1<ProtoModels::MonitorPvpGroup*>* (*)(void *))(Il2CppBase() + 0x1EA7AAC))(0);
	}
	...
	template <typename R = void> R set_Id(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::MonitorPvpClanInfo*>* get_Clans() {
		return ((RepeatedField1<ProtoModels::MonitorPvpClanInfo*>* (*)(MonitorPvpGroup*))(Il2CppBase() + 0x1EA7E40))(this);
	}
