...
public: 
	...
	template <typename T = MessageParser1MonitorPvpGroup*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1MonitorPvpClanInfo*>*> static T& _repeated_clans_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1MonitorPvpClanInfo*>*> T& clans_() {
	...
	template <typename T = MessageParser1MonitorPvpGroup*>*> static T get_Parser() {
	...
	template <typename T = MonitorPvpGroup*> T Clone() {
	...
	template <typename T = RepeatedField1MonitorPvpClanInfo*>*> T get_Clans() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(MonitorPvpGroup*, Il2CppObject*))(Il2CppBase() + 0x1EA7ECC))(this, other);
	}
	template <typename T = bool> T Equals_1(MonitorPvpGroup* other) {
		return ((T (*)(MonitorPvpGroup*, MonitorPvpGroup*))(Il2CppBase() + 0x1EA7F3C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(MonitorPvpGroup* other) {
		return ((T (*)(MonitorPvpGroup*, MonitorPvpGroup*))(Il2CppBase() + 0x1EA86F8))(this, other);
	}
