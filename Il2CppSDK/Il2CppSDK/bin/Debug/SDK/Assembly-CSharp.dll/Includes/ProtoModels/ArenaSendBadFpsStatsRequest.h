...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaSendBadFpsStatsRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaSendBadFpsStatsRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::ArenaBadFpsStats*> R& data_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaSendBadFpsStatsRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaSendBadFpsStatsRequest*>* (*)(void *))(Il2CppBase() + 0x2710F7C))(0);
	}
