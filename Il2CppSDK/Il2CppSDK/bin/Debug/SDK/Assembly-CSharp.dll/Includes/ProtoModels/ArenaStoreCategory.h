...
public: 
	...
	template <typename T = MessageParser1ArenaStoreCategory*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaStoreCategory*>*> static T get_Parser() {
	...
	template <typename T = ArenaStoreCategory*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaStoreCategory*, Il2CppObject*))(Il2CppBase() + 0x27188DC))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaStoreCategory* other) {
		return ((T (*)(ArenaStoreCategory*, ArenaStoreCategory*))(Il2CppBase() + 0x271894C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaStoreCategory* other) {
		return ((T (*)(ArenaStoreCategory*, ArenaStoreCategory*))(Il2CppBase() + 0x2718E7C))(this, other);
	}
