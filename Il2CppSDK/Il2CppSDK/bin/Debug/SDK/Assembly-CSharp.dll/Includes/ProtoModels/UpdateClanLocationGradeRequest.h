...
public: 
	...
	template <typename T = MessageParser1UpdateClanLocationGradeRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UpdateClanLocationGradeRequest*>*> static T get_Parser() {
	...
	template <typename T = UpdateClanLocationGradeRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UpdateClanLocationGradeRequest*, Il2CppObject*))(Il2CppBase() + 0x153BFDC))(this, other);
	}
	template <typename T = bool> T Equals_1(UpdateClanLocationGradeRequest* other) {
		return ((T (*)(UpdateClanLocationGradeRequest*, UpdateClanLocationGradeRequest*))(Il2CppBase() + 0x153C04C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UpdateClanLocationGradeRequest* other) {
		return ((T (*)(UpdateClanLocationGradeRequest*, UpdateClanLocationGradeRequest*))(Il2CppBase() + 0x153C498))(this, other);
	}
