...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UpdateClanLocationGradeRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::UpdateClanLocationGradeRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& value_() {
	 ...
	 static MessageParser1<ProtoModels::UpdateClanLocationGradeRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UpdateClanLocationGradeRequest*>* (*)(void *))(Il2CppBase() + 0x153BC24))(0);
	}
