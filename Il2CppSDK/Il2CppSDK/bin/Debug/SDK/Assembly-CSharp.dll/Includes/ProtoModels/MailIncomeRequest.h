...
public: 
	...
	template <typename T = MessageParser1MailIncomeRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1MailIncomeRequest*>*> static T get_Parser() {
	...
	template <typename T = MailIncomeRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(MailIncomeRequest*, Il2CppObject*))(Il2CppBase() + 0x125CF10))(this, other);
	}
	template <typename T = bool> T Equals_1(MailIncomeRequest* other) {
		return ((T (*)(MailIncomeRequest*, MailIncomeRequest*))(Il2CppBase() + 0x125CF80))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(MailIncomeRequest* other) {
		return ((T (*)(MailIncomeRequest*, MailIncomeRequest*))(Il2CppBase() + 0x125D298))(this, other);
	}
