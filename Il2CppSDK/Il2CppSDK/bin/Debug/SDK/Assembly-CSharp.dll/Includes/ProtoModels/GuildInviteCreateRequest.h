...
public: 
	...
	template <typename T = MessageParser1GuildInviteCreateRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildInviteCreateRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildInviteCreateRequest*> T Clone() {
	...
	template <typename T = void> T set_Type(GuildInviteType* value) {
		return ((T (*)(GuildInviteCreateRequest*, GuildInviteType*))(Il2CppBase() + 0x1B2CD70))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildInviteCreateRequest*, Il2CppObject*))(Il2CppBase() + 0x1B2CD78))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildInviteCreateRequest* other) {
		return ((T (*)(GuildInviteCreateRequest*, GuildInviteCreateRequest*))(Il2CppBase() + 0x1B2CDE8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildInviteCreateRequest* other) {
		return ((T (*)(GuildInviteCreateRequest*, GuildInviteCreateRequest*))(Il2CppBase() + 0x1B2D234))(this, other);
	}
