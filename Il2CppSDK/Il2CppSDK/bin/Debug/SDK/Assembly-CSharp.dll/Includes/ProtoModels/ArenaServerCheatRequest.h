...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaServerCheatRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaServerCheatRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& IntParamsFieldNumber() {
	 ...
	 static FieldCodec1<int64_t>*& _repeated_intParams_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<int64_t>*& intParams_() {
		return *(RepeatedField1<int64_t>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1<ProtoModels::ArenaServerCheatRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaServerCheatRequest*>* (*)(void *))(Il2CppBase() + 0x2712608))(0);
	}
	...
	template <typename R = void> R set_Command(ProtoModels::ArenaServerCheatCommandType value) {
	 ...
	 RepeatedField1<int64_t>* get_IntParams() {
		return ((RepeatedField1<int64_t>* (*)(ArenaServerCheatRequest*))(Il2CppBase() + 0x2712988))(this);
	}
