...
public: 
	...
	template <typename T = MessageParser1SlackBotConfiguration*>*> static T& _parser() {
	...
	template <typename T = MessageParser1SlackBotConfiguration*>*> static T get_Parser() {
	...
	template <typename T = SlackBotConfiguration*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(SlackBotConfiguration*, Il2CppObject*))(Il2CppBase() + 0x1483BA4))(this, other);
	}
	template <typename T = bool> T Equals_1(SlackBotConfiguration* other) {
		return ((T (*)(SlackBotConfiguration*, SlackBotConfiguration*))(Il2CppBase() + 0x1483C14))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(SlackBotConfiguration* other) {
		return ((T (*)(SlackBotConfiguration*, SlackBotConfiguration*))(Il2CppBase() + 0x1483EB0))(this, other);
	}
