...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAddMapSlotRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaAddMapSlotRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& transactionID_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAddMapSlotRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaAddMapSlotRequest*>* (*)(void *))(Il2CppBase() + 0x1A1384C))(0);
	}
