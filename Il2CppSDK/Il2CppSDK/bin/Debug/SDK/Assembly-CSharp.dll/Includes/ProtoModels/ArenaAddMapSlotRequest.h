...
public: 
	...
	template <typename T = MessageParser1ArenaAddMapSlotRequest*>*> static T& _parser() {
	...
	template <typename T = NewGlobalMapType*> T& mapSlot_() {
	...
	template <typename T = MessageParser1ArenaAddMapSlotRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaAddMapSlotRequest*> T Clone() {
	...
	template <typename T = NewGlobalMapType*> T get_MapSlot() {
		return ((T (*)(ArenaAddMapSlotRequest*))(Il2CppBase() + 0x1A13B64))(this);
	}
	template <typename T = void> T set_MapSlot(NewGlobalMapType* value) {
		return ((T (*)(ArenaAddMapSlotRequest*, NewGlobalMapType*))(Il2CppBase() + 0x1A13B6C))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaAddMapSlotRequest*, Il2CppObject*))(Il2CppBase() + 0x1A13C0C))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaAddMapSlotRequest* other) {
		return ((T (*)(ArenaAddMapSlotRequest*, ArenaAddMapSlotRequest*))(Il2CppBase() + 0x1A13C7C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaAddMapSlotRequest* other) {
		return ((T (*)(ArenaAddMapSlotRequest*, ArenaAddMapSlotRequest*))(Il2CppBase() + 0x1A14030))(this, other);
	}
