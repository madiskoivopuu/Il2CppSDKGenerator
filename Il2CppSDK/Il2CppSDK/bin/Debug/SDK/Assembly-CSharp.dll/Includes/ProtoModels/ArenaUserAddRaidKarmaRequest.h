...
public: 
	...
	template <typename T = MessageParser1ArenaUserAddRaidKarmaRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUserAddRaidKarmaRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUserAddRaidKarmaRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUserAddRaidKarmaRequest*, Il2CppObject*))(Il2CppBase() + 0xF57CC8))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUserAddRaidKarmaRequest* other) {
		return ((T (*)(ArenaUserAddRaidKarmaRequest*, ArenaUserAddRaidKarmaRequest*))(Il2CppBase() + 0xF57D38))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUserAddRaidKarmaRequest* other) {
		return ((T (*)(ArenaUserAddRaidKarmaRequest*, ArenaUserAddRaidKarmaRequest*))(Il2CppBase() + 0xF580B4))(this, other);
	}
