...
public: 
	...
	template <typename T = MessageParser1ArenaPvpConfiguration*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaPvpConfiguration*>*> static T get_Parser() {
	...
	template <typename T = ArenaPvpConfiguration*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaPvpConfiguration*, Il2CppObject*))(Il2CppBase() + 0x1A68BC0))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaPvpConfiguration* other) {
		return ((T (*)(ArenaPvpConfiguration*, ArenaPvpConfiguration*))(Il2CppBase() + 0x1A68C30))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaPvpConfiguration* other) {
		return ((T (*)(ArenaPvpConfiguration*, ArenaPvpConfiguration*))(Il2CppBase() + 0x1A69164))(this, other);
	}
