...
public: 
	...
	template <typename T = MessageParser1UserCandidateInviteResponse*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1InvitablePlayer*>*> static T& _repeated_pretenders_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1InvitablePlayer*>*> T& pretenders_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1UserCandidateInviteResponse*>*> static T get_Parser() {
	...
	template <typename T = UserCandidateInviteResponse*> T Clone() {
	...
	template <typename T = RepeatedField1InvitablePlayer*>*> T get_Pretenders() {
		return ((T (*)(UserCandidateInviteResponse*))(Il2CppBase() + 0x2463CD4))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserCandidateInviteResponse*, Il2CppObject*))(Il2CppBase() + 0x2463CDC))(this, other);
	}
	template <typename T = bool> T Equals_1(UserCandidateInviteResponse* other) {
		return ((T (*)(UserCandidateInviteResponse*, UserCandidateInviteResponse*))(Il2CppBase() + 0x2463D4C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserCandidateInviteResponse* other) {
		return ((T (*)(UserCandidateInviteResponse*, UserCandidateInviteResponse*))(Il2CppBase() + 0x2464118))(this, other);
	}
