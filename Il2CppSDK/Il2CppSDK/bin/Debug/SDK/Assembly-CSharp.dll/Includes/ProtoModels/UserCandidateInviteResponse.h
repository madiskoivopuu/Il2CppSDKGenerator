...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserCandidateInviteResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserCandidateInviteResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PretendersFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::InvitablePlayer*>*& _repeated_pretenders_codec() {
		return *(FieldCodec1<ProtoModels::InvitablePlayer*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::InvitablePlayer*>*& pretenders_() {
		return *(RepeatedField1<ProtoModels::InvitablePlayer*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::UserCandidateInviteResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserCandidateInviteResponse*>* (*)(void *))(Il2CppBase() + 0x24638C8))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::InvitablePlayer*>* get_Pretenders() {
		return ((RepeatedField1<ProtoModels::InvitablePlayer*>* (*)(UserCandidateInviteResponse*))(Il2CppBase() + 0x2463CD4))(this);
	}
