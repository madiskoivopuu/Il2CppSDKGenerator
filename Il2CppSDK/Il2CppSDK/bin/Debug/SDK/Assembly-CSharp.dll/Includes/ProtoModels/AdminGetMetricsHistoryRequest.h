...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetMetricsHistoryRequest*, uintptr_t))(Il2CppBase() + 0x18B3260))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetMetricsHistoryRequest*, uintptr_t))(Il2CppBase() + 0x18B32FC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetMetricsHistoryRequest*, uintptr_t))(Il2CppBase() + 0x18B3548))(this, other);
	}
