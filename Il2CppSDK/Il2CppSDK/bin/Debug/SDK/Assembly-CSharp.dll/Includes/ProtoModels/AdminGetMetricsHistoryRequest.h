...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminGetMetricsHistoryRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminGetMetricsHistoryRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& range_() {
	 ...
	 static MessageParser1ProtoModels::AdminGetMetricsHistoryRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminGetMetricsHistoryRequest*>* (*)(void *))(Il2CppBase() + 0x18B2FC0))(0);
	}
