...
public: 
	...
	template <typename T = MessageParser1CreateGuildRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1CreateGuildRequest*>*> static T get_Parser() {
	...
	template <typename T = CreateGuildRequest*> T Clone() {
	...
	template <typename T = void> T set_Guild(GuildMessageType* value) {
		return ((T (*)(CreateGuildRequest*, GuildMessageType*))(Il2CppBase() + 0x1BCA658))(this, value);
	}
	...
	template <typename T = void> T set_Price(Currencies* value) {
		return ((T (*)(CreateGuildRequest*, Currencies*))(Il2CppBase() + 0x1BCA668))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CreateGuildRequest*, Il2CppObject*))(Il2CppBase() + 0x1BCA670))(this, other);
	}
	template <typename T = bool> T Equals_1(CreateGuildRequest* other) {
		return ((T (*)(CreateGuildRequest*, CreateGuildRequest*))(Il2CppBase() + 0x1BCA6E0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CreateGuildRequest* other) {
		return ((T (*)(CreateGuildRequest*, CreateGuildRequest*))(Il2CppBase() + 0x1BCAA74))(this, other);
	}
