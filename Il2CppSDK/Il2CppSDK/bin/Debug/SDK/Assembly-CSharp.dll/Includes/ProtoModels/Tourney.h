...
public: 
	...
	template <typename T = void> T set_State(uintptr_t value) {
		return ((T (*)(Tourney*, uintptr_t))(Il2CppBase() + 0x150BB4C))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(Tourney*, uintptr_t))(Il2CppBase() + 0x150BB7C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(Tourney*, uintptr_t))(Il2CppBase() + 0x150BBEC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(Tourney*, uintptr_t))(Il2CppBase() + 0x150C2B0))(this, other);
	}
