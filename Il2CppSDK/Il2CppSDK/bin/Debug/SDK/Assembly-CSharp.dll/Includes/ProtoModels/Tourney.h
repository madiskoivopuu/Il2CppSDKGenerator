...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::Tourney*>*& _parser() {
		return *(MessageParser1ProtoModels::Tourney*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PlayersFieldNumber() {
	 ...
	 RepeatedField1ProtoModels::Player*>*& players_() {
		return *(RepeatedField1ProtoModels::Player*>**)((uintptr_t)this + 0x38);
	}
	...
	template <typename R = int32_t> R& fakePlayersCount_() {
	 ...
	 static MessageParser1ProtoModels::Tourney*>* get_Parser() {
		return ((MessageParser1ProtoModels::Tourney*>* (*)(void *))(Il2CppBase() + 0x150B6EC))(0);
	}
	...
	template <typename R = void> R set_State(ProtoModels::TourneyState* value) {
	 ...
	 RepeatedField1ProtoModels::Player*>* get_Players() {
		return ((RepeatedField1ProtoModels::Player*>* (*)(Tourney*))(Il2CppBase() + 0x150BB54))(this);
	}
