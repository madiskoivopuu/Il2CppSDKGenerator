...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserLogoutFromArenaResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserLogoutFromArenaResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& codeMessage_() {
	 ...
	 static MessageParser1<ProtoModels::UserLogoutFromArenaResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserLogoutFromArenaResponse*>* (*)(void *))(Il2CppBase() + 0x246F4F4))(0);
	}
