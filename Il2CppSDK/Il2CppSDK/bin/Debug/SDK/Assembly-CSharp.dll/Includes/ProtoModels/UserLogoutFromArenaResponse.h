...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserLogoutFromArenaResponse*, uintptr_t))(Il2CppBase() + 0x246F860))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserLogoutFromArenaResponse*, uintptr_t))(Il2CppBase() + 0x246F8D0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserLogoutFromArenaResponse*, uintptr_t))(Il2CppBase() + 0x246FB48))(this, other);
	}
