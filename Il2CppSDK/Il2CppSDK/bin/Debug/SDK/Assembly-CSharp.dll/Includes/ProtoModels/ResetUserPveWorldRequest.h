...
public: 
	...
	template <typename T = MessageParser1ResetUserPveWorldRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ResetUserPveWorldRequest*>*> static T get_Parser() {
	...
	template <typename T = ResetUserPveWorldRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ResetUserPveWorldRequest*, Il2CppObject*))(Il2CppBase() + 0x119B1EC))(this, other);
	}
	template <typename T = bool> T Equals_1(ResetUserPveWorldRequest* other) {
		return ((T (*)(ResetUserPveWorldRequest*, ResetUserPveWorldRequest*))(Il2CppBase() + 0x119B25C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ResetUserPveWorldRequest* other) {
		return ((T (*)(ResetUserPveWorldRequest*, ResetUserPveWorldRequest*))(Il2CppBase() + 0x119B5D4))(this, other);
	}
