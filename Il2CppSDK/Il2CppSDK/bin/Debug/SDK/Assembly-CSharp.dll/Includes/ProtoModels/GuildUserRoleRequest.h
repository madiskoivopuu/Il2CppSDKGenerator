...
public: 
	...
	template <typename T = MessageParser1GuildUserRoleRequest*>*> static T& _parser() {
	...
	template <typename T = GuildRole*> T& role_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1GuildUserRoleRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildUserRoleRequest*> T Clone() {
	...
	template <typename T = GuildRole*> T get_Role() {
		return ((T (*)(GuildUserRoleRequest*))(Il2CppBase() + 0x1947508))(this);
	}
	template <typename T = void> T set_Role(GuildRole* value) {
		return ((T (*)(GuildUserRoleRequest*, GuildRole*))(Il2CppBase() + 0x1947510))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildUserRoleRequest*, Il2CppObject*))(Il2CppBase() + 0x1947518))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildUserRoleRequest* other) {
		return ((T (*)(GuildUserRoleRequest*, GuildUserRoleRequest*))(Il2CppBase() + 0x1947588))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildUserRoleRequest* other) {
		return ((T (*)(GuildUserRoleRequest*, GuildUserRoleRequest*))(Il2CppBase() + 0x1947904))(this, other);
	}
