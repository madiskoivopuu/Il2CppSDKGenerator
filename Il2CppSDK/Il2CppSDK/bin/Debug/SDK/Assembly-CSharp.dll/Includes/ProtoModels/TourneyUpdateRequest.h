...
public: 
	...
	template <typename T = MessageParser1TourneyUpdateRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1TourneyUpdateRequest*>*> static T get_Parser() {
	...
	template <typename T = TourneyUpdateRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(TourneyUpdateRequest*, Il2CppObject*))(Il2CppBase() + 0x150DB24))(this, other);
	}
	template <typename T = bool> T Equals_1(TourneyUpdateRequest* other) {
		return ((T (*)(TourneyUpdateRequest*, TourneyUpdateRequest*))(Il2CppBase() + 0x150DBD0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(TourneyUpdateRequest* other) {
		return ((T (*)(TourneyUpdateRequest*, TourneyUpdateRequest*))(Il2CppBase() + 0x150DEB8))(this, other);
	}
