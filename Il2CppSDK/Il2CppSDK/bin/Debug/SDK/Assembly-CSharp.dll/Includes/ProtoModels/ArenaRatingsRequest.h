...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaRatingsRequest*, uintptr_t))(Il2CppBase() + 0x1A69ED0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaRatingsRequest*, uintptr_t))(Il2CppBase() + 0x1A69F5C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaRatingsRequest*, uintptr_t))(Il2CppBase() + 0x1A6A104))(this, other);
	}
