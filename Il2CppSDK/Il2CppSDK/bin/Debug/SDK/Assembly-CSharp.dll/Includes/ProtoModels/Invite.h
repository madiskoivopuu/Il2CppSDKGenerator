...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::Invite*>*& _parser() {
		return *(MessageParser1<ProtoModels::Invite*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ClansFieldNumber() {
	 ...
	 RepeatedField1<ProtoModels::Clan*>*& clans_() {
		return *(RepeatedField1<ProtoModels::Clan*>**)((uintptr_t)this + 0x40);
	}

	 static MessageParser1<ProtoModels::Invite*>* get_Parser() {
		return ((MessageParser1<ProtoModels::Invite*>* (*)(void *))(Il2CppBase() + 0x1242AD8))(0);
	}
	...
	template <typename R = void> R set_Expired(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::Clan*>* get_Clans() {
		return ((RepeatedField1<ProtoModels::Clan*>* (*)(Invite*))(Il2CppBase() + 0x1242F44))(this);
	}
