...
public: 
	...
	template <typename T = MessageParser1Invite*>*> static T& _parser() {
	...
	template <typename T = MessageParser1Invite*>*> static T get_Parser() {
	...
	template <typename T = Invite*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(Invite*, Il2CppObject*))(Il2CppBase() + 0x1242F4C))(this, other);
	}
	template <typename T = bool> T Equals_1(Invite* other) {
		return ((T (*)(Invite*, Invite*))(Il2CppBase() + 0x1242FBC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(Invite* other) {
		return ((T (*)(Invite*, Invite*))(Il2CppBase() + 0x12435DC))(this, other);
	}
