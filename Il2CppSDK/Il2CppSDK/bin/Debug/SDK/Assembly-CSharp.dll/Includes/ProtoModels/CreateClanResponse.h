...
public: 
	...
	template <typename T = MessageParser1CreateClanResponse*>*> static T& _parser() {
	...
	template <typename T = Clan*> T& newClan_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1CreateClanResponse*>*> static T get_Parser() {
	...
	template <typename T = CreateClanResponse*> T Clone() {
	...
	template <typename T = Clan*> T get_NewClan() {
		return ((T (*)(CreateClanResponse*))(Il2CppBase() + 0x134CAA0))(this);
	}
	template <typename T = void> T set_NewClan(Clan* value) {
		return ((T (*)(CreateClanResponse*, Clan*))(Il2CppBase() + 0x134CAA8))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CreateClanResponse*, Il2CppObject*))(Il2CppBase() + 0x134CAB0))(this, other);
	}
	template <typename T = bool> T Equals_1(CreateClanResponse* other) {
		return ((T (*)(CreateClanResponse*, CreateClanResponse*))(Il2CppBase() + 0x134CB20))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CreateClanResponse* other) {
		return ((T (*)(CreateClanResponse*, CreateClanResponse*))(Il2CppBase() + 0x134CE40))(this, other);
	}
