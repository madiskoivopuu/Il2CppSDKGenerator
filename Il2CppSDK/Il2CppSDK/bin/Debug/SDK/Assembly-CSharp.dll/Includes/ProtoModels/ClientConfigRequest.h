...
public: 
	...
	template <typename T = uintptr_t> T& currentConfig_() {
	...
	template <typename T = uintptr_t> T get_CurrentConfig() {
		return ((T (*)(ClientConfigRequest*))(Il2CppBase() + 0xE16A2C))(this);
	}
	template <typename T = void> T set_CurrentConfig(uintptr_t value) {
		return ((T (*)(ClientConfigRequest*, uintptr_t))(Il2CppBase() + 0xE16A34))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ClientConfigRequest*, uintptr_t))(Il2CppBase() + 0xE16AC4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ClientConfigRequest*, uintptr_t))(Il2CppBase() + 0xE16B34))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ClientConfigRequest*, uintptr_t))(Il2CppBase() + 0xE16E58))(this, other);
	}
