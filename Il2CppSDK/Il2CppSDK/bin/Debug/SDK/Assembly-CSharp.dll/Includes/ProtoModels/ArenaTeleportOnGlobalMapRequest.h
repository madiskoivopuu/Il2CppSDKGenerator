...
public: 
	...
	template <typename T = MessageParser1ArenaTeleportOnGlobalMapRequest*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1TeleportInfoType*>*> static T& _repeated_data_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1TeleportInfoType*>*> T& data_() {
		return *(T*)((uintptr_t)this + 0x18);
	}

	template <typename T = MessageParser1ArenaTeleportOnGlobalMapRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaTeleportOnGlobalMapRequest*> T Clone() {
	...
	template <typename T = RepeatedField1TeleportInfoType*>*> T get_Data() {
		return ((T (*)(ArenaTeleportOnGlobalMapRequest*))(Il2CppBase() + 0x27216BC))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaTeleportOnGlobalMapRequest*, Il2CppObject*))(Il2CppBase() + 0x27216C4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaTeleportOnGlobalMapRequest* other) {
		return ((T (*)(ArenaTeleportOnGlobalMapRequest*, ArenaTeleportOnGlobalMapRequest*))(Il2CppBase() + 0x2721734))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaTeleportOnGlobalMapRequest* other) {
		return ((T (*)(ArenaTeleportOnGlobalMapRequest*, ArenaTeleportOnGlobalMapRequest*))(Il2CppBase() + 0x2721A4C))(this, other);
	}
