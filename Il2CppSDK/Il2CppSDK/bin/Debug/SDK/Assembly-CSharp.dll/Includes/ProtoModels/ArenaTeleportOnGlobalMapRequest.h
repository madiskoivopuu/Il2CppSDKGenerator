...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaTeleportOnGlobalMapRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaTeleportOnGlobalMapRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& DataFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::TeleportInfoType*>*& _repeated_data_codec() {
		return *(FieldCodec1ProtoModels::TeleportInfoType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::TeleportInfoType*>*& data_() {
		return *(RepeatedField1ProtoModels::TeleportInfoType*>**)((uintptr_t)this + 0x18);
	}

	 static MessageParser1ProtoModels::ArenaTeleportOnGlobalMapRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaTeleportOnGlobalMapRequest*>* (*)(void *))(Il2CppBase() + 0x272136C))(0);
	}
	...
	template <typename R = void> R set_WorldID(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::TeleportInfoType*>* get_Data() {
		return ((RepeatedField1ProtoModels::TeleportInfoType*>* (*)(ArenaTeleportOnGlobalMapRequest*))(Il2CppBase() + 0x27216BC))(this);
	}
