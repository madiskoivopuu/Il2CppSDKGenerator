...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UpdateUserFCMTokenRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::UpdateUserFCMTokenRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& newFCMToken_() {
	 ...
	 static MessageParser1<ProtoModels::UpdateUserFCMTokenRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UpdateUserFCMTokenRequest*>* (*)(void *))(Il2CppBase() + 0x1540BA4))(0);
	}
