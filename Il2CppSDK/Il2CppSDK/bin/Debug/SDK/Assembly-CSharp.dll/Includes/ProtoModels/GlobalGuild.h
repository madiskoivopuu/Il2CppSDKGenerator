...
public: 
	...
	template <typename T = MessageParser1GlobalGuild*>*> static T& _parser() {
	...
	template <typename T = Player*> T& leader_() {
	...
	template <typename T = MessageParser1GlobalGuild*>*> static T get_Parser() {
	...
	template <typename T = GlobalGuild*> T Clone() {
	...
	template <typename T = Player*> T get_Leader() {
		return ((T (*)(GlobalGuild*))(Il2CppBase() + 0x1775510))(this);
	}
	template <typename T = void> T set_Leader(Player* value) {
		return ((T (*)(GlobalGuild*, Player*))(Il2CppBase() + 0x1775518))(this, value);
	}
	...
	template <typename T = void> T set_Type(GuildType* value) {
		return ((T (*)(GlobalGuild*, GuildType*))(Il2CppBase() + 0x177567C))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GlobalGuild*, Il2CppObject*))(Il2CppBase() + 0x17757B4))(this, other);
	}
	template <typename T = bool> T Equals_1(GlobalGuild* other) {
		return ((T (*)(GlobalGuild*, GlobalGuild*))(Il2CppBase() + 0x1775824))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GlobalGuild* other) {
		return ((T (*)(GlobalGuild*, GlobalGuild*))(Il2CppBase() + 0x17762A0))(this, other);
	}
