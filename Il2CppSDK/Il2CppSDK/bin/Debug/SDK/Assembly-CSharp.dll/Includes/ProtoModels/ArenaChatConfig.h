...
public: 
	...
	template <typename T = MessageParser1ArenaChatConfig*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaChatConfig*>*> static T get_Parser() {
	...
	template <typename T = ArenaChatConfig*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaChatConfig*, Il2CppObject*))(Il2CppBase() + 0x1A1A7A8))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaChatConfig* other) {
		return ((T (*)(ArenaChatConfig*, ArenaChatConfig*))(Il2CppBase() + 0x1A1A818))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaChatConfig* other) {
		return ((T (*)(ArenaChatConfig*, ArenaChatConfig*))(Il2CppBase() + 0x1A1AD5C))(this, other);
	}
