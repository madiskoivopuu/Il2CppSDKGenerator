...
public: 
	...
	template <typename T = MessageParser1ArenaTournamentConfiguration*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaTournamentConfiguration*>*> static T get_Parser() {
	...
	template <typename T = ArenaTournamentConfiguration*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaTournamentConfiguration*, Il2CppObject*))(Il2CppBase() + 0xF4583C))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaTournamentConfiguration* other) {
		return ((T (*)(ArenaTournamentConfiguration*, ArenaTournamentConfiguration*))(Il2CppBase() + 0xF458AC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaTournamentConfiguration* other) {
		return ((T (*)(ArenaTournamentConfiguration*, ArenaTournamentConfiguration*))(Il2CppBase() + 0xF45C24))(this, other);
	}
