...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaTournamentConfiguration*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaTournamentConfiguration*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& tourneysPerDayLimit_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaTournamentConfiguration*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaTournamentConfiguration*>* (*)(void *))(Il2CppBase() + 0xF4556C))(0);
	}
