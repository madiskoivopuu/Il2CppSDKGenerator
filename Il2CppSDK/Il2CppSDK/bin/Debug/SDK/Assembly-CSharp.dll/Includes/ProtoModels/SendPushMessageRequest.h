...
public: 
	...
	template <typename T = MessageParser1SendPushMessageRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1SendPushMessageRequest*>*> static T get_Parser() {
	...
	template <typename T = SendPushMessageRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(SendPushMessageRequest*, Il2CppObject*))(Il2CppBase() + 0x1364C68))(this, other);
	}
	template <typename T = bool> T Equals_1(SendPushMessageRequest* other) {
		return ((T (*)(SendPushMessageRequest*, SendPushMessageRequest*))(Il2CppBase() + 0x1364CD8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(SendPushMessageRequest* other) {
		return ((T (*)(SendPushMessageRequest*, SendPushMessageRequest*))(Il2CppBase() + 0x136515C))(this, other);
	}
