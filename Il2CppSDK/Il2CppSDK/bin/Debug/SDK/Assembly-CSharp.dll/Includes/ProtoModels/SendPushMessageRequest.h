...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::SendPushMessageRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::SendPushMessageRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& TokensFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<Il2CppString*>*& _repeated_tokens_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<Il2CppString*>*& tokens_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int32_t> R& language_() {
	 ...
	 static MessageParser1<ProtoModels::SendPushMessageRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::SendPushMessageRequest*>* (*)(void *))(Il2CppBase() + 0x13647A8))(0);
	}
	...
	template <typename R = ProtoModels::SendPushMessageRequest*> R Clone() {
	 ...
	 RepeatedField1<Il2CppString*>* get_Tokens() {
		return ((RepeatedField1<Il2CppString*>* (*)(SendPushMessageRequest*))(Il2CppBase() + 0x1364B40))(this);
	}
