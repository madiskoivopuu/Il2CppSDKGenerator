...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::PackResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::PackResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& OutcomeFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::PackOutcome*>*& _repeated_outcome_codec() {
		return *(FieldCodec1<ProtoModels::PackOutcome*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::PackOutcome*>*& outcome_() {
		return *(RepeatedField1<ProtoModels::PackOutcome*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::PackResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::PackResponse*>* (*)(void *))(Il2CppBase() + 0x11E8798))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::PackOutcome*>* get_Outcome() {
		return ((RepeatedField1<ProtoModels::PackOutcome*>* (*)(PackResponse*))(Il2CppBase() + 0x11E8BA4))(this);
	}
