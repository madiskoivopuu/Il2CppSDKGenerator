...
public: 
	...
	template <typename T = MessageParser1PackResponse*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1PackOutcome*>*> static T& _repeated_outcome_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1PackOutcome*>*> T& outcome_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1PackResponse*>*> static T get_Parser() {
	...
	template <typename T = PackResponse*> T Clone() {
	...
	template <typename T = RepeatedField1PackOutcome*>*> T get_Outcome() {
		return ((T (*)(PackResponse*))(Il2CppBase() + 0x11E8BA4))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PackResponse*, Il2CppObject*))(Il2CppBase() + 0x11E8BAC))(this, other);
	}
	template <typename T = bool> T Equals_1(PackResponse* other) {
		return ((T (*)(PackResponse*, PackResponse*))(Il2CppBase() + 0x11E8C1C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PackResponse* other) {
		return ((T (*)(PackResponse*, PackResponse*))(Il2CppBase() + 0x11E8FF8))(this, other);
	}
