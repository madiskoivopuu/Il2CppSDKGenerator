...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::PvpGroup*>*& _parser() {
		return *(MessageParser1ProtoModels::PvpGroup*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ClansFieldNumber() {
	 ...
	 RepeatedField1ProtoModels::Clan*>*& clans_() {
		return *(RepeatedField1ProtoModels::Clan*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = int32_t> static R& DiplomaciesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::Diplomacy*>*& _repeated_diplomacies_codec() {
		return *(FieldCodec1ProtoModels::Diplomacy*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::Diplomacy*>*& diplomacies_() {
		return *(RepeatedField1ProtoModels::Diplomacy*>**)((uintptr_t)this + 0x40);
	}

	 static MessageParser1ProtoModels::PvpGroup*>* get_Parser() {
		return ((MessageParser1ProtoModels::PvpGroup*>* (*)(void *))(Il2CppBase() + 0x11BF678))(0);
	}
	...
	template <typename R = void> R set_ID(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::Clan*>* get_Clans() {
		return ((RepeatedField1ProtoModels::Clan*>* (*)(PvpGroup*))(Il2CppBase() + 0x11BFAE4))(this);
	}
	...
	template <typename R = void> R set_SearchDuration(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::Diplomacy*>* get_Diplomacies() {
		return ((RepeatedField1ProtoModels::Diplomacy*>* (*)(PvpGroup*))(Il2CppBase() + 0x11BFB2C))(this);
	}
