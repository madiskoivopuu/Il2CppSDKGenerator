...
public: 
	...
	template <typename T = MessageParser1PvpGroup*>*> static T& _parser() {
	...
	template <typename T = PvpTransition*> T& transition_() {
	...
	template <typename T = MessageParser1PvpGroup*>*> static T get_Parser() {
	...
	template <typename T = PvpGroup*> T Clone() {
	...
	template <typename T = PvpTransition*> T get_Transition() {
		return ((T (*)(PvpGroup*))(Il2CppBase() + 0x11BFAEC))(this);
	}
	template <typename T = void> T set_Transition(PvpTransition* value) {
		return ((T (*)(PvpGroup*, PvpTransition*))(Il2CppBase() + 0x11BFAF4))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PvpGroup*, Il2CppObject*))(Il2CppBase() + 0x11BFB34))(this, other);
	}
	template <typename T = bool> T Equals_1(PvpGroup* other) {
		return ((T (*)(PvpGroup*, PvpGroup*))(Il2CppBase() + 0x11BFBA4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PvpGroup* other) {
		return ((T (*)(PvpGroup*, PvpGroup*))(Il2CppBase() + 0x11C01FC))(this, other);
	}
