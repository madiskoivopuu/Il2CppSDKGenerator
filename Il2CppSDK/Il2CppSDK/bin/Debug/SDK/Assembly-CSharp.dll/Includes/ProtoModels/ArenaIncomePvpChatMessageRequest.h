...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaIncomePvpChatMessageRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaIncomePvpChatMessageRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::ClanChatMessageBlock*> R& message_() {
	 ...
	 static MessageParser1ProtoModels::ArenaIncomePvpChatMessageRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaIncomePvpChatMessageRequest*>* (*)(void *))(Il2CppBase() + 0x1E28E6C))(0);
	}
	...
	template <typename R = ProtoModels::ArenaIncomePvpChatMessageRequest*> R Clone() {
	 ...
	 RepeatedField1int64_t>* get_UserID() {
		return ((RepeatedField1int64_t>* (*)(ArenaIncomePvpChatMessageRequest*))(Il2CppBase() + 0x1E291CC))(this);
	}
