...
public: 
	...
	template <typename T = MessageParser1ArenaIncomePvpChatMessageRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaIncomePvpChatMessageRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaIncomePvpChatMessageRequest*> T Clone() {
	...
	template <typename T = void> T set_Message(ClanChatMessageBlock* value) {
		return ((T (*)(ArenaIncomePvpChatMessageRequest*, ClanChatMessageBlock*))(Il2CppBase() + 0x1E291DC))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaIncomePvpChatMessageRequest*, Il2CppObject*))(Il2CppBase() + 0x1E291E4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaIncomePvpChatMessageRequest* other) {
		return ((T (*)(ArenaIncomePvpChatMessageRequest*, ArenaIncomePvpChatMessageRequest*))(Il2CppBase() + 0x1E29254))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaIncomePvpChatMessageRequest* other) {
		return ((T (*)(ArenaIncomePvpChatMessageRequest*, ArenaIncomePvpChatMessageRequest*))(Il2CppBase() + 0x1E29578))(this, other);
	}
