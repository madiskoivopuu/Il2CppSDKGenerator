...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserSlotsProgress*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserSlotsProgress*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ItemsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::UserProductProgressDataItem*>*& _repeated_items_codec() {
		return *(FieldCodec1<ProtoModels::UserProductProgressDataItem*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::UserProductProgressDataItem*>*& items_() {
		return *(RepeatedField1<ProtoModels::UserProductProgressDataItem*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1<ProtoModels::UserSlotsProgress*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserSlotsProgress*>* (*)(void *))(Il2CppBase() + 0x15B9EF4))(0);
	}
	...
	template <typename R = ProtoModels::UserSlotsProgress*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::UserProductProgressDataItem*>* get_Items() {
		return ((RepeatedField1<ProtoModels::UserProductProgressDataItem*>* (*)(UserSlotsProgress*))(Il2CppBase() + 0x15BA22C))(this);
	}
