...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::UserSearchPvpGroupRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::UserSearchPvpGroupRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& actualLevel_() {
	 ...
	 static MessageParser1ProtoModels::UserSearchPvpGroupRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::UserSearchPvpGroupRequest*>* (*)(void *))(Il2CppBase() + 0x15B8D10))(0);
	}
