...
public: 
	...
	template <typename T = MessageParser1UserSearchPvpGroupRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserSearchPvpGroupRequest*>*> static T get_Parser() {
	...
	template <typename T = UserSearchPvpGroupRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserSearchPvpGroupRequest*, Il2CppObject*))(Il2CppBase() + 0x15B8FE4))(this, other);
	}
	template <typename T = bool> T Equals_1(UserSearchPvpGroupRequest* other) {
		return ((T (*)(UserSearchPvpGroupRequest*, UserSearchPvpGroupRequest*))(Il2CppBase() + 0x15B9054))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserSearchPvpGroupRequest* other) {
		return ((T (*)(UserSearchPvpGroupRequest*, UserSearchPvpGroupRequest*))(Il2CppBase() + 0x15B93C4))(this, other);
	}
