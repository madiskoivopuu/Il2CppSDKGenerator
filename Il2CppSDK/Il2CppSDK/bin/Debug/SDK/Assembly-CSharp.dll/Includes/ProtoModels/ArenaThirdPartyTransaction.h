...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaThirdPartyTransaction*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaThirdPartyTransaction*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& uSDPrice_() {
	 ...
	 static MessageParser1ProtoModels::ArenaThirdPartyTransaction*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaThirdPartyTransaction*>* (*)(void *))(Il2CppBase() + 0xF445B8))(0);
	}
