...
public: 
	...
	template <typename T = void> T set_Shop(uintptr_t value) {
		return ((T (*)(ArenaThirdPartyTransaction*, uintptr_t))(Il2CppBase() + 0xF44AA8))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaThirdPartyTransaction*, uintptr_t))(Il2CppBase() + 0xF44B68))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaThirdPartyTransaction*, uintptr_t))(Il2CppBase() + 0xF44BD8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaThirdPartyTransaction*, uintptr_t))(Il2CppBase() + 0xF45234))(this, other);
	}
