...
public: 
	...
	template <typename T = MessageParser1ArenaAcceptUserResponse*>*> static T& _parser() {
	...
	template <typename T = MigrationCurrencyCoins*> T& coins_() {
	...
	template <typename T = MessageParser1ArenaAcceptUserResponse*>*> static T get_Parser() {
	...
	template <typename T = ArenaAcceptUserResponse*> T Clone() {
	...
	template <typename T = MigrationCurrencyCoins*> T get_Coins() {
		return ((T (*)(ArenaAcceptUserResponse*))(Il2CppBase() + 0x189B950))(this);
	}
	template <typename T = void> T set_Coins(MigrationCurrencyCoins* value) {
		return ((T (*)(ArenaAcceptUserResponse*, MigrationCurrencyCoins*))(Il2CppBase() + 0x189B958))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaAcceptUserResponse*, Il2CppObject*))(Il2CppBase() + 0x189B9E8))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaAcceptUserResponse* other) {
		return ((T (*)(ArenaAcceptUserResponse*, ArenaAcceptUserResponse*))(Il2CppBase() + 0x189BA58))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaAcceptUserResponse* other) {
		return ((T (*)(ArenaAcceptUserResponse*, ArenaAcceptUserResponse*))(Il2CppBase() + 0x189BE28))(this, other);
	}
