...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::RatioOneTable*>*& _parser() {
		return *(MessageParser1ProtoModels::RatioOneTable*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& LinesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::RatioLine*>*& _repeated_lines_codec() {
		return *(FieldCodec1ProtoModels::RatioLine*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::RatioLine*>*& lines_() {
		return *(RepeatedField1ProtoModels::RatioLine*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::RatioOneTable*>* get_Parser() {
		return ((MessageParser1ProtoModels::RatioOneTable*>* (*)(void *))(Il2CppBase() + 0x138BEBC))(0);
	}
	...
	template <typename R = ProtoModels::RatioOneTable*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::RatioLine*>* get_Lines() {
		return ((RepeatedField1ProtoModels::RatioLine*>* (*)(RatioOneTable*))(Il2CppBase() + 0x138C1F4))(this);
	}
