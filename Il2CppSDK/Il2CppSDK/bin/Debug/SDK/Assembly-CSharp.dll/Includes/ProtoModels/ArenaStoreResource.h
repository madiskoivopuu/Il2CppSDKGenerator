...
public: 
	...
	template <typename T = MessageParser1ArenaStoreResource*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaStoreResource*>*> static T get_Parser() {
	...
	template <typename T = ArenaStoreResource*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaStoreResource*, Il2CppObject*))(Il2CppBase() + 0x2720650))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaStoreResource* other) {
		return ((T (*)(ArenaStoreResource*, ArenaStoreResource*))(Il2CppBase() + 0x27206C0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaStoreResource* other) {
		return ((T (*)(ArenaStoreResource*, ArenaStoreResource*))(Il2CppBase() + 0x27209EC))(this, other);
	}
