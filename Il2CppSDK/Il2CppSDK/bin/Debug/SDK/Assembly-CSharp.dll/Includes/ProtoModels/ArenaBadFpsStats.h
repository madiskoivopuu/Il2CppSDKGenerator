...
public: 
	...
	template <typename T = void*> static T& _repeated_frames_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& frames_() {
	...
	template <typename T = void*> T get_Frames() {
		return ((T (*)(ArenaBadFpsStats*))(Il2CppBase() + 0x1A17FD0))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaBadFpsStats*, uintptr_t))(Il2CppBase() + 0x1A17FD8))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaBadFpsStats*, uintptr_t))(Il2CppBase() + 0x1A18048))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaBadFpsStats*, uintptr_t))(Il2CppBase() + 0x1A1841C))(this, other);
	}
