...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBadFpsStats*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaBadFpsStats*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& StatsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ArenaBadFpsStatObject*>*& _repeated_stats_codec() {
		return *(FieldCodec1<ProtoModels::ArenaBadFpsStatObject*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ArenaBadFpsStatObject*>*& stats_() {
		return *(RepeatedField1<ProtoModels::ArenaBadFpsStatObject*>**)((uintptr_t)this + 0x18);
	}
	template <typename R = int32_t> static R& FramesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::ArenaFrameInfo*>*& _repeated_frames_codec() {
		return *(FieldCodec1<ProtoModels::ArenaFrameInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<ProtoModels::ArenaFrameInfo*>*& frames_() {
		return *(RepeatedField1<ProtoModels::ArenaFrameInfo*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::ArenaBadFpsStats*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaBadFpsStats*>* (*)(void *))(Il2CppBase() + 0x1A17BF8))(0);
	}
	...
	template <typename R = void> R set_SumTics(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::ArenaBadFpsStatObject*>* get_Stats() {
		return ((RepeatedField1<ProtoModels::ArenaBadFpsStatObject*>* (*)(ArenaBadFpsStats*))(Il2CppBase() + 0x1A17FC8))(this);
	}
	 RepeatedField1<ProtoModels::ArenaFrameInfo*>* get_Frames() {
		return ((RepeatedField1<ProtoModels::ArenaFrameInfo*>* (*)(ArenaBadFpsStats*))(Il2CppBase() + 0x1A17FD0))(this);
	}
