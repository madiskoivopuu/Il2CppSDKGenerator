...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::Int32ToIntMap*>*& _parser() {
		return *(MessageParser1ProtoModels::Int32ToIntMap*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& InnerMapFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codecint32_t, int32_t>*& _map_innerMap_codec() {
		return *(Codecint32_t, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2int32_t, int32_t>*& innerMap_() {
		return *(MapField2int32_t, int32_t>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::Int32ToIntMap*>* get_Parser() {
		return ((MessageParser1ProtoModels::Int32ToIntMap*>* (*)(void *))(Il2CppBase() + 0x1468670))(0);
	}
	...
	template <typename R = ProtoModels::Int32ToIntMap*> R Clone() {
	 ...
	 MapField2int32_t, int32_t>* get_InnerMap() {
		return ((MapField2int32_t, int32_t>* (*)(Int32ToIntMap*))(Il2CppBase() + 0x14689A8))(this);
	}
