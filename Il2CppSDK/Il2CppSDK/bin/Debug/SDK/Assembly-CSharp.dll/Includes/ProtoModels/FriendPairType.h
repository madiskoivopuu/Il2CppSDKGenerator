...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(FriendPairType*, uintptr_t))(Il2CppBase() + 0x15FDC4C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(FriendPairType*, uintptr_t))(Il2CppBase() + 0x15FDCE8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(FriendPairType*, uintptr_t))(Il2CppBase() + 0x15FDF30))(this, other);
	}
