...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaPlayerKill*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaPlayerKill*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ItemsFieldNumber() {
	 ...
	 static CodecIl2CppString*, int32_t>*& _map_items_codec() {
		return *(CodecIl2CppString*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2Il2CppString*, int32_t>*& items_() {
		return *(MapField2Il2CppString*, int32_t>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = int32_t> static R& BrokenItemsFieldNumber() {
	 ...
	 static CodecIl2CppString*, int32_t>*& _map_brokenItems_codec() {
		return *(CodecIl2CppString*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2Il2CppString*, int32_t>*& brokenItems_() {
		return *(MapField2Il2CppString*, int32_t>**)((uintptr_t)this + 0x38);
	}

	 static MessageParser1ProtoModels::ArenaPlayerKill*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaPlayerKill*>* (*)(void *))(Il2CppBase() + 0x1E2E1D8))(0);
	}
	...
	template <typename R = void> R set_WorldID(int64_t value) {
	 ...
	 MapField2Il2CppString*, int32_t>* get_Items() {
		return ((MapField2Il2CppString*, int32_t>* (*)(ArenaPlayerKill*))(Il2CppBase() + 0x1E2E5B0))(this);
	}
	...
	template <typename R = void> R set_Type(ProtoModels::KillInventoryType* value) {
	 ...
	 MapField2Il2CppString*, int32_t>* get_BrokenItems() {
		return ((MapField2Il2CppString*, int32_t>* (*)(ArenaPlayerKill*))(Il2CppBase() + 0x1E2E5C8))(this);
	}
