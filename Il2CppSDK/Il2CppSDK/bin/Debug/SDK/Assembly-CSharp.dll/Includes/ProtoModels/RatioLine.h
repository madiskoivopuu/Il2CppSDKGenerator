...
public: 
	...
	template <typename T = MessageParser1RatioLine*>*> static T& _parser() {
	...
	template <typename T = MessageParser1RatioLine*>*> static T get_Parser() {
	...
	template <typename T = RatioLine*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(RatioLine*, Il2CppObject*))(Il2CppBase() + 0x138B434))(this, other);
	}
	template <typename T = bool> T Equals_1(RatioLine* other) {
		return ((T (*)(RatioLine*, RatioLine*))(Il2CppBase() + 0x138B4A4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(RatioLine* other) {
		return ((T (*)(RatioLine*, RatioLine*))(Il2CppBase() + 0x138BB70))(this, other);
	}
