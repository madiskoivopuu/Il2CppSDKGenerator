...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsRequest*, uintptr_t))(Il2CppBase() + 0x1E22678))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsRequest*, uintptr_t))(Il2CppBase() + 0x1E22714))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGetClanMembersCurrentLocationTagsRequest*, uintptr_t))(Il2CppBase() + 0x1E2295C))(this, other);
	}
