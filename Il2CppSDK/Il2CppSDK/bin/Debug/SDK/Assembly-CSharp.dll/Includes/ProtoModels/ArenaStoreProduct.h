...
public: 
	...
	template <typename T = uintptr_t> T& description_() {
	...
	template <typename T = void*> static T& _repeated_currencyPack_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& currencyPack_() {
	...
	template <typename T = void*> static T& _repeated_prices_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& prices_() {
	...
	template <typename T = void*> static T& _repeated_categories_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = void*> T& categories_() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = int32_t> static T& ResourcesFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_resources_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = void*> T& resources_() {
		return *(T*)((uintptr_t)this + 0x68);
	}
	template <typename T = int32_t> static T& NeedExpFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_needExp_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = void*> T& needExp_() {
	...
	template <typename T = uintptr_t> T& savingsGroup_() {
	...
	template <typename T = uintptr_t> T& buyAmount_() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = int32_t> static T& PurchaseMoreFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_purchaseMore_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = void*> T& purchaseMore_() {
		return *(T*)((uintptr_t)this + 0xA0);
	}
	template <typename T = int32_t> static T& RaritiesFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_rarities_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> T& rarities_() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = int32_t> static T& HackedTypeFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& hackedType_() {
		return *(T*)((uintptr_t)this + 0xB0);
	}
	template <typename T = int32_t> static T& BattlePassLevelFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& battlePassLevel_() {
	...
	template <typename T = uintptr_t> T& banner_() {
	...
	template <typename T = void*> static T& _repeated_slotsRewards_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = void*> T& slotsRewards_() {
		return *(T*)((uintptr_t)this + 0xF0);
	}
	template <typename T = int32_t> static T& DiscountsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_discounts_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x50);
	}
	template <typename T = void*> T& discounts_() {
	...
	template <typename T = uintptr_t> T& bonusCurrency_() {
	...
	template <typename T = void> T set_Description(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B180))(this, value);
	}
	...
	template <typename T = void*> T get_CurrencyPack() {
	...
	template <typename T = void*> T get_Prices() {
	...
	template <typename T = void*> T get_Resources() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B2D8))(this);
	}
	template <typename T = void*> T get_NeedExp() {
	...
	template <typename T = uintptr_t> T get_SavingsGroup() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B370))(this);
	}
	template <typename T = void> T set_SavingsGroup(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B378))(this, value);
	}
	...
	template <typename T = uintptr_t> T get_BuyAmount() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3A0))(this);
	}
	template <typename T = void> T set_BuyAmount(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B3A8))(this, value);
	}
	template <typename T = void*> T get_PurchaseMore() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3B0))(this);
	}
	template <typename T = void*> T get_Rarities() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3B8))(this);
	}
	template <typename T = uintptr_t> T get_HackedType() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3C0))(this);
	}
	template <typename T = void> T set_HackedType(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B3C8))(this, value);
	}
	template <typename T = uintptr_t> T get_BattlePassLevel() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3D0))(this);
	}
	template <typename T = void> T set_BattlePassLevel(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B3D8))(this, value);
	}
	...
	template <typename T = uintptr_t> T get_Banner() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B588))(this);
	}
	template <typename T = void> T set_Banner(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B590))(this, value);
	}
	...
	template <typename T = void*> T get_SlotsRewards() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B5A8))(this);
	}
	template <typename T = void*> T get_Discounts() {
	...
	template <typename T = uintptr_t> T get_BonusCurrency() {
		return ((T (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B664))(this);
	}
	template <typename T = void> T set_BonusCurrency(uintptr_t value) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B66C))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B720))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271B790))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaStoreProduct*, uintptr_t))(Il2CppBase() + 0x271D1C0))(this, other);
	}
