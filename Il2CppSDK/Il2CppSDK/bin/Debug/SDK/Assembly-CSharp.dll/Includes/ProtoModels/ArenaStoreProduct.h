...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaStoreProduct*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaStoreProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& CurrencyPackFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreCurrencyPack*>*& _repeated_currencyPack_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreCurrencyPack*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ArenaStoreCurrencyPack*>*& currencyPack_() {
		return *(RepeatedField1ProtoModels::ArenaStoreCurrencyPack*>**)((uintptr_t)this + 0x38);
	}
	...
	template <typename R = int32_t> static R& PricesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreProductPrice*>*& _repeated_prices_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreProductPrice*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::ArenaStoreProductPrice*>*& prices_() {
		return *(RepeatedField1ProtoModels::ArenaStoreProductPrice*>**)((uintptr_t)this + 0x48);
	}
	template <typename R = int32_t> static R& TagsFieldNumber() {
	 ...
	 RepeatedField1Il2CppString*>*& tags_() {
		return *(RepeatedField1Il2CppString*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = int32_t> static R& CategoriesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreCategory*>*& _repeated_categories_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreCategory*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1ProtoModels::ArenaStoreCategory*>*& categories_() {
		return *(RepeatedField1ProtoModels::ArenaStoreCategory*>**)((uintptr_t)this + 0x60);
	}
	template <typename R = int32_t> static R& ResourcesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreResource*>*& _repeated_resources_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreResource*>**)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	 RepeatedField1ProtoModels::ArenaStoreResource*>*& resources_() {
		return *(RepeatedField1ProtoModels::ArenaStoreResource*>**)((uintptr_t)this + 0x68);
	}
	template <typename R = int32_t> static R& NeedExpFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_needExp_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	 RepeatedField1int64_t>*& needExp_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x70);
	}
	...
	template <typename R = int32_t> static R& PurchaseMoreFieldNumber() {
	 ...
	 static FieldCodec1Il2CppString*>*& _repeated_purchaseMore_codec() {
		return *(FieldCodec1Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	 RepeatedField1Il2CppString*>*& purchaseMore_() {
		return *(RepeatedField1Il2CppString*>**)((uintptr_t)this + 0xA0);
	}
	template <typename R = int32_t> static R& RaritiesFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int32_t>*& _repeated_rarities_codec() {
		return *(FieldCodec1int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	 RepeatedField1int32_t>*& rarities_() {
		return *(RepeatedField1int32_t>**)((uintptr_t)this + 0xA8);
	}
	...
	template <typename R = int32_t> static R& SlotsRewardsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreResource*>*& _repeated_slotsRewards_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreResource*>**)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	 RepeatedField1ProtoModels::ArenaStoreResource*>*& slotsRewards_() {
		return *(RepeatedField1ProtoModels::ArenaStoreResource*>**)((uintptr_t)this + 0xF0);
	}
	template <typename R = int32_t> static R& DiscountsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreProductDiscount*>*& _repeated_discounts_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreProductDiscount*>**)((uintptr_t)StaticClass()->static_fields + 0x50);
	}
	 RepeatedField1ProtoModels::ArenaStoreProductDiscount*>*& discounts_() {
		return *(RepeatedField1ProtoModels::ArenaStoreProductDiscount*>**)((uintptr_t)this + 0xF8);
	}
	...
	template <typename R = Il2CppString*> R& commingSoonName_() {
	 ...
	 static MessageParser1ProtoModels::ArenaStoreProduct*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaStoreProduct*>* (*)(void *))(Il2CppBase() + 0x271A650))(0);
	}
	...
	template <typename R = void> R set_ExperienceBoosterDuration(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaStoreCurrencyPack*>* get_CurrencyPack() {
		return ((RepeatedField1ProtoModels::ArenaStoreCurrencyPack*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B220))(this);
	}
	...
	template <typename R = void> R set_Count(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaStoreProductPrice*>* get_Prices() {
		return ((RepeatedField1ProtoModels::ArenaStoreProductPrice*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B238))(this);
	}
	 RepeatedField1Il2CppString*>* get_Tags() {
		return ((RepeatedField1Il2CppString*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B240))(this);
	}
	...
	template <typename R = void> R set_UnlockPremiumName(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::ArenaStoreCategory*>* get_Categories() {
		return ((RepeatedField1ProtoModels::ArenaStoreCategory*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B2D0))(this);
	}
	 RepeatedField1ProtoModels::ArenaStoreResource*>* get_Resources() {
		return ((RepeatedField1ProtoModels::ArenaStoreResource*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B2D8))(this);
	}
	 RepeatedField1int64_t>* get_NeedExp() {
		return ((RepeatedField1int64_t>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B2E0))(this);
	}
	...
	template <typename R = void> R set_BuyAmount(ProtoModels::ArenaStoreBuyAmount* value) {
	 ...
	 RepeatedField1Il2CppString*>* get_PurchaseMore() {
		return ((RepeatedField1Il2CppString*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3B0))(this);
	}
	 RepeatedField1int32_t>* get_Rarities() {
		return ((RepeatedField1int32_t>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B3B8))(this);
	}
	...
	template <typename R = void> R set_UnlockSeassonNumber(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaStoreResource*>* get_SlotsRewards() {
		return ((RepeatedField1ProtoModels::ArenaStoreResource*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B5A8))(this);
	}
	 RepeatedField1ProtoModels::ArenaStoreProductDiscount*>* get_Discounts() {
		return ((RepeatedField1ProtoModels::ArenaStoreProductDiscount*>* (*)(ArenaStoreProduct*))(Il2CppBase() + 0x271B5B0))(this);
	}
