...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UpdatePvpGroupInfoRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::UpdatePvpGroupInfoRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::PvpGroupInfo*> R& info_() {
	 ...
	 static MessageParser1<ProtoModels::UpdatePvpGroupInfoRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UpdatePvpGroupInfoRequest*>* (*)(void *))(Il2CppBase() + 0x1540140))(0);
	}
