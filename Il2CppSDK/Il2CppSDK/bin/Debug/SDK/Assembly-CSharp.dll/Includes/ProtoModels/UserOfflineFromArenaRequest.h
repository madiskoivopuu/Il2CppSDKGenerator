...
public: 
	...
	template <typename T = MessageParser1UserOfflineFromArenaRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserOfflineFromArenaRequest*>*> static T get_Parser() {
	...
	template <typename T = UserOfflineFromArenaRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserOfflineFromArenaRequest*, Il2CppObject*))(Il2CppBase() + 0x246FFC4))(this, other);
	}
	template <typename T = bool> T Equals_1(UserOfflineFromArenaRequest* other) {
		return ((T (*)(UserOfflineFromArenaRequest*, UserOfflineFromArenaRequest*))(Il2CppBase() + 0x2470060))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserOfflineFromArenaRequest* other) {
		return ((T (*)(UserOfflineFromArenaRequest*, UserOfflineFromArenaRequest*))(Il2CppBase() + 0x24702A8))(this, other);
	}
