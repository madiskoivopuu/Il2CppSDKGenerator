...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AvailablePurchase*>*& _parser() {
		return *(MessageParser1<ProtoModels::AvailablePurchase*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& FiltersFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_filters_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<Il2CppString*>*& filters_() {
	...
	template <typename R = bool> R& notResettableCount_() {
	 ...
	 static MessageParser1<ProtoModels::AvailablePurchase*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AvailablePurchase*>* (*)(void *))(Il2CppBase() + 0x1A660F8))(0);
	}
	...
	template <typename R = void> R set_StartDelay(int32_t value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_Filters() {
		return ((RepeatedField1<Il2CppString*>* (*)(AvailablePurchase*))(Il2CppBase() + 0x1A66578))(this);
	}
