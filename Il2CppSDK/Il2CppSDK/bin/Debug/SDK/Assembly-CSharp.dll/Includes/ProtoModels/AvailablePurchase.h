...
public: 
	...
	template <typename T = void*> static T& _repeated_filters_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& filters_() {
	...
	template <typename T = void*> T get_Filters() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AvailablePurchase*, uintptr_t))(Il2CppBase() + 0x1A66594))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AvailablePurchase*, uintptr_t))(Il2CppBase() + 0x1A66604))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AvailablePurchase*, uintptr_t))(Il2CppBase() + 0x1A66C98))(this, other);
	}
