...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(GuildResetQuestRequest*, uintptr_t))(Il2CppBase() + 0x1940E68))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(GuildResetQuestRequest*, uintptr_t))(Il2CppBase() + 0x1940F04))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(GuildResetQuestRequest*, uintptr_t))(Il2CppBase() + 0x194114C))(this, other);
	}
