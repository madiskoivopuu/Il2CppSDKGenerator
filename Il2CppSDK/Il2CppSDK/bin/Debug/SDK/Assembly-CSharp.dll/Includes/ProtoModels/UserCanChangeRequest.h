...
public: 
	...
	template <typename T = MessageParser1UserCanChangeRequest*>*> static T& _parser() {
	...
	template <typename T = CanType*> T& can_() {
	...
	template <typename T = MessageParser1UserCanChangeRequest*>*> static T get_Parser() {
	...
	template <typename T = UserCanChangeRequest*> T Clone() {
	...
	template <typename T = CanType*> T get_Can() {
		return ((T (*)(UserCanChangeRequest*))(Il2CppBase() + 0x1542DA8))(this);
	}
	template <typename T = void> T set_Can(CanType* value) {
		return ((T (*)(UserCanChangeRequest*, CanType*))(Il2CppBase() + 0x1542DB0))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserCanChangeRequest*, Il2CppObject*))(Il2CppBase() + 0x1542DCC))(this, other);
	}
	template <typename T = bool> T Equals_1(UserCanChangeRequest* other) {
		return ((T (*)(UserCanChangeRequest*, UserCanChangeRequest*))(Il2CppBase() + 0x1542E3C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserCanChangeRequest* other) {
		return ((T (*)(UserCanChangeRequest*, UserCanChangeRequest*))(Il2CppBase() + 0x15431A4))(this, other);
	}
