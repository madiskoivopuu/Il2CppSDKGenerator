...
public: 
	...
	template <typename T = void> T set_Player(uintptr_t value) {
		return ((T (*)(GuildUserRoleResponse*, uintptr_t))(Il2CppBase() + 0x1947EB8))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(GuildUserRoleResponse*, uintptr_t))(Il2CppBase() + 0x1947EC0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(GuildUserRoleResponse*, uintptr_t))(Il2CppBase() + 0x1947F30))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(GuildUserRoleResponse*, uintptr_t))(Il2CppBase() + 0x1948250))(this, other);
	}
