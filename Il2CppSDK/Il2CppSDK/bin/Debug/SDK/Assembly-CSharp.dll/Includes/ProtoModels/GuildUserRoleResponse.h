...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GuildUserRoleResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::GuildUserRoleResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::Player*> R& player_() {
	 ...
	 static MessageParser1<ProtoModels::GuildUserRoleResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GuildUserRoleResponse*>* (*)(void *))(Il2CppBase() + 0x1947B1C))(0);
	}
