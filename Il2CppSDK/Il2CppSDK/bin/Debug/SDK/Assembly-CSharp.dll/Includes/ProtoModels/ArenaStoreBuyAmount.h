...
public: 
	...
	template <typename T = MessageParser1ArenaStoreBuyAmount*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaStoreBuyAmount*>*> static T get_Parser() {
	...
	template <typename T = ArenaStoreBuyAmount*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaStoreBuyAmount*, Il2CppObject*))(Il2CppBase() + 0x2717E70))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaStoreBuyAmount* other) {
		return ((T (*)(ArenaStoreBuyAmount*, ArenaStoreBuyAmount*))(Il2CppBase() + 0x2717EE0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaStoreBuyAmount* other) {
		return ((T (*)(ArenaStoreBuyAmount*, ArenaStoreBuyAmount*))(Il2CppBase() + 0x271816C))(this, other);
	}
