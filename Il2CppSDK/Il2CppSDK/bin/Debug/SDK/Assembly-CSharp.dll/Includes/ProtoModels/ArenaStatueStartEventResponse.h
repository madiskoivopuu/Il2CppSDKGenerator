...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaStatueStartEventResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaStatueStartEventResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& endTime_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaStatueStartEventResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaStatueStartEventResponse*>* (*)(void *))(Il2CppBase() + 0x2713B3C))(0);
	}
