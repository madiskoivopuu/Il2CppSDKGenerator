...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaStatueStartEventResponse*, uintptr_t))(Il2CppBase() + 0x2713EF4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaStatueStartEventResponse*, uintptr_t))(Il2CppBase() + 0x2713F64))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaStatueStartEventResponse*, uintptr_t))(Il2CppBase() + 0x27143B0))(this, other);
	}
