...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaVipLevels*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaVipLevels*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& VipLevelsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::ArenaVipLevel*>*& _repeated_vipLevels_codec() {
		return *(FieldCodec1ProtoModels::ArenaVipLevel*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ArenaVipLevel*>*& vipLevels_() {
		return *(RepeatedField1ProtoModels::ArenaVipLevel*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = ProtoModels::ArenaVipDefaults*> R& vipDefaults_() {
	 ...
	 static MessageParser1ProtoModels::ArenaVipLevels*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaVipLevels*>* (*)(void *))(Il2CppBase() + 0x28682A8))(0);
	}
	...
	template <typename R = ProtoModels::ArenaVipLevels*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::ArenaVipLevel*>* get_VipLevels() {
		return ((RepeatedField1ProtoModels::ArenaVipLevel*>* (*)(ArenaVipLevels*))(Il2CppBase() + 0x2868604))(this);
	}
