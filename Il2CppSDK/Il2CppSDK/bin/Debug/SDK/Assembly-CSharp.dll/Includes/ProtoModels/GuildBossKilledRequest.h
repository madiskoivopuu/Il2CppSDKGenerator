...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GuildBossKilledRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::GuildBossKilledRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PlayerIdsFieldNumber() {
	 ...
	 static FieldCodec1<int64_t>*& _repeated_playerIds_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<int64_t>*& playerIds_() {
	...
	template <typename R = Il2CppString*> R& bossName_() {
	 ...
	 static MessageParser1<ProtoModels::GuildBossKilledRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GuildBossKilledRequest*>* (*)(void *))(Il2CppBase() + 0x12E64CC))(0);
	}
	...
	template <typename R = void> R set_GuildId(int64_t value) {
	 ...
	 RepeatedField1<int64_t>* get_PlayerIds() {
		return ((RepeatedField1<int64_t>* (*)(GuildBossKilledRequest*))(Il2CppBase() + 0x12E6878))(this);
	}
