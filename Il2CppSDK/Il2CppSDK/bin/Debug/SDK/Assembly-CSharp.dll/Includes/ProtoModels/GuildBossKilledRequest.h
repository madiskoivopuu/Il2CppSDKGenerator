...
public: 
	...
	template <typename T = MessageParser1GuildBossKilledRequest*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1int64_t>*> static T& _repeated_playerIds_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1int64_t>*> T& playerIds_() {
	...
	template <typename T = MessageParser1GuildBossKilledRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildBossKilledRequest*> T Clone() {
	...
	template <typename T = RepeatedField1int64_t>*> T get_PlayerIds() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildBossKilledRequest*, Il2CppObject*))(Il2CppBase() + 0x12E6928))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildBossKilledRequest* other) {
		return ((T (*)(GuildBossKilledRequest*, GuildBossKilledRequest*))(Il2CppBase() + 0x12E6998))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildBossKilledRequest* other) {
		return ((T (*)(GuildBossKilledRequest*, GuildBossKilledRequest*))(Il2CppBase() + 0x12E6F3C))(this, other);
	}
