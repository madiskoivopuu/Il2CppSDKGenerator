...
public: 
	...
	template <typename T = MessageParser1ArenaSaveWorldRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaSaveWorldRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaSaveWorldRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaSaveWorldRequest*, Il2CppObject*))(Il2CppBase() + 0x2710298))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaSaveWorldRequest* other) {
		return ((T (*)(ArenaSaveWorldRequest*, ArenaSaveWorldRequest*))(Il2CppBase() + 0x2710334))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaSaveWorldRequest* other) {
		return ((T (*)(ArenaSaveWorldRequest*, ArenaSaveWorldRequest*))(Il2CppBase() + 0x271057C))(this, other);
	}
