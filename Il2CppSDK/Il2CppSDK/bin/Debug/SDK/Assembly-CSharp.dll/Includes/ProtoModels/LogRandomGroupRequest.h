...
public: 
	...
	template <typename T = MessageParser1LogRandomGroupRequest*>*> static T& _parser() {
	...
	template <typename T = CodecIl2CppString*, int32_t>*> static T& _map_itemStats_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = MapField2Il2CppString*, int32_t>*> T& itemStats_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& MobKillDetailsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1StatMobKillDetail*>*> static T& _repeated_mobKillDetails_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1StatMobKillDetail*>*> T& mobKillDetails_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1LogRandomGroupRequest*>*> static T get_Parser() {
	...
	template <typename T = LogRandomGroupRequest*> T Clone() {
	...
	template <typename T = MapField2Il2CppString*, int32_t>*> T get_ItemStats() {
		return ((T (*)(LogRandomGroupRequest*))(Il2CppBase() + 0x1726954))(this);
	}
	template <typename T = RepeatedField1StatMobKillDetail*>*> T get_MobKillDetails() {
		return ((T (*)(LogRandomGroupRequest*))(Il2CppBase() + 0x172695C))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(LogRandomGroupRequest*, Il2CppObject*))(Il2CppBase() + 0x1726964))(this, other);
	}
	template <typename T = bool> T Equals_1(LogRandomGroupRequest* other) {
		return ((T (*)(LogRandomGroupRequest*, LogRandomGroupRequest*))(Il2CppBase() + 0x17269D4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(LogRandomGroupRequest* other) {
		return ((T (*)(LogRandomGroupRequest*, LogRandomGroupRequest*))(Il2CppBase() + 0x1726E3C))(this, other);
	}
