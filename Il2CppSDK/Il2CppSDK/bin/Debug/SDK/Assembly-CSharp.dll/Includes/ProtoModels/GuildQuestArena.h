...
public: 
	...
	template <typename T = MessageParser1GuildQuestArena*>*> static T& _parser() {
	...
	template <typename T = GuildQuestState*> T& state_() {
		return *(T*)((uintptr_t)this + 0x24);
	}
	template <typename T = int32_t> static T& PlayersFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = Codecint64_t, QuestPlayer*>*> static T& _map_players_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = MapField2int64_t, QuestPlayer*>*> T& players_() {
	...
	template <typename T = MessageParser1GuildQuestArena*>*> static T get_Parser() {
	...
	template <typename T = GuildQuestArena*> T Clone() {
	...
	template <typename T = GuildQuestState*> T get_State() {
		return ((T (*)(GuildQuestArena*))(Il2CppBase() + 0x1930B24))(this);
	}
	template <typename T = void> T set_State(GuildQuestState* value) {
		return ((T (*)(GuildQuestArena*, GuildQuestState*))(Il2CppBase() + 0x1930B2C))(this, value);
	}
	template <typename T = MapField2int64_t, QuestPlayer*>*> T get_Players() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildQuestArena*, Il2CppObject*))(Il2CppBase() + 0x1930B9C))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildQuestArena* other) {
		return ((T (*)(GuildQuestArena*, GuildQuestArena*))(Il2CppBase() + 0x1930C0C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildQuestArena* other) {
		return ((T (*)(GuildQuestArena*, GuildQuestArena*))(Il2CppBase() + 0x193148C))(this, other);
	}
