...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGuildUserQuestProgress*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaGuildUserQuestProgress*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& questID_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaGuildUserQuestProgress*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaGuildUserQuestProgress*>* (*)(void *))(Il2CppBase() + 0x1E27C40))(0);
	}
