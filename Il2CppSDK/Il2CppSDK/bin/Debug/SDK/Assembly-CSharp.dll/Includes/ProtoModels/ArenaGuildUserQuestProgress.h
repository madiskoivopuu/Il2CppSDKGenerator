...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGuildUserQuestProgress*, uintptr_t))(Il2CppBase() + 0x1E27EF8))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGuildUserQuestProgress*, uintptr_t))(Il2CppBase() + 0x1E27FA4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGuildUserQuestProgress*, uintptr_t))(Il2CppBase() + 0x1E2828C))(this, other);
	}
