...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::PvpSetBatteryDurationRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::PvpSetBatteryDurationRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& duration_() {
	 ...
	 static MessageParser1<ProtoModels::PvpSetBatteryDurationRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::PvpSetBatteryDurationRequest*>* (*)(void *))(Il2CppBase() + 0x11C34B8))(0);
	}
