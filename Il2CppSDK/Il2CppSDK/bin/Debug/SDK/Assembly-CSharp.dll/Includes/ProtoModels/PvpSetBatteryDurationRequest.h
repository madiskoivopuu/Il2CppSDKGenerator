...
public: 
	...
	template <typename T = MessageParser1PvpSetBatteryDurationRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1PvpSetBatteryDurationRequest*>*> static T get_Parser() {
	...
	template <typename T = PvpSetBatteryDurationRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PvpSetBatteryDurationRequest*, Il2CppObject*))(Il2CppBase() + 0x11C3770))(this, other);
	}
	template <typename T = bool> T Equals_1(PvpSetBatteryDurationRequest* other) {
		return ((T (*)(PvpSetBatteryDurationRequest*, PvpSetBatteryDurationRequest*))(Il2CppBase() + 0x11C381C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PvpSetBatteryDurationRequest* other) {
		return ((T (*)(PvpSetBatteryDurationRequest*, PvpSetBatteryDurationRequest*))(Il2CppBase() + 0x11C3B00))(this, other);
	}
