...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserGetClanInfoResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserGetClanInfoResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& UsersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::UserGetUserInfo*>*& _repeated_users_codec() {
		return *(FieldCodec1<ProtoModels::UserGetUserInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::UserGetUserInfo*>*& users_() {
		return *(RepeatedField1<ProtoModels::UserGetUserInfo*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int32_t> static R& EnemyFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::EnemyInfo*>*& _repeated_enemy_codec() {
		return *(FieldCodec1<ProtoModels::EnemyInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<ProtoModels::EnemyInfo*>*& enemy_() {
		return *(RepeatedField1<ProtoModels::EnemyInfo*>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = int64_t> R& lockTimeOperation_() {
	 ...
	 static MessageParser1<ProtoModels::UserGetClanInfoResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserGetClanInfoResponse*>* (*)(void *))(Il2CppBase() + 0x2466B7C))(0);
	}
	...
	template <typename R = ProtoModels::UserGetClanInfoResponse*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::UserGetUserInfo*>* get_Users() {
		return ((RepeatedField1<ProtoModels::UserGetUserInfo*>* (*)(UserGetClanInfoResponse*))(Il2CppBase() + 0x246700C))(this);
	}
	...
	template <typename R = void> R set_Language(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::EnemyInfo*>* get_Enemy() {
		return ((RepeatedField1<ProtoModels::EnemyInfo*>* (*)(UserGetClanInfoResponse*))(Il2CppBase() + 0x2467110))(this);
	}
