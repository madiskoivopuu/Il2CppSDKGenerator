...
public: 
	...
	template <typename T = void*> static T& _repeated_enemy_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& enemy_() {
	...
	template <typename T = uintptr_t> T& extendClanInfo_() {
	...
	template <typename T = void*> T get_Enemy() {
	...
	template <typename T = uintptr_t> T get_ExtendClanInfo() {
		return ((T (*)(UserGetClanInfoResponse*))(Il2CppBase() + 0x246712C))(this);
	}
	template <typename T = void> T set_ExtendClanInfo(uintptr_t value) {
		return ((T (*)(UserGetClanInfoResponse*, uintptr_t))(Il2CppBase() + 0x2467134))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserGetClanInfoResponse*, uintptr_t))(Il2CppBase() + 0x246719C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserGetClanInfoResponse*, uintptr_t))(Il2CppBase() + 0x246720C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserGetClanInfoResponse*, uintptr_t))(Il2CppBase() + 0x2467ED0))(this, other);
	}
