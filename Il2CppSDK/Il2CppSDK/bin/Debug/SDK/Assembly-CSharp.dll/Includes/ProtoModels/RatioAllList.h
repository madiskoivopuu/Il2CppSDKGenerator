...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::RatioAllList*>*& _parser() {
		return *(MessageParser1<ProtoModels::RatioAllList*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& RatioFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::RatioSummary*>*& _repeated_ratio_codec() {
		return *(FieldCodec1<ProtoModels::RatioSummary*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::RatioSummary*>*& ratio_() {
		return *(RepeatedField1<ProtoModels::RatioSummary*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int32_t> static R& LastBonusPositionFieldNumber() {
	 ...
	 static Codec<int64_t, ProtoModels::BonusPositionType*>*& _map_lastBonusPosition_codec() {
		return *(Codec<int64_t, ProtoModels::BonusPositionType*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2<int64_t, ProtoModels::BonusPositionType*>*& lastBonusPosition_() {
		return *(MapField2<int64_t, ProtoModels::BonusPositionType*>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = int64_t> R& ratioUpdatePosition_() {
	 ...
	 static MessageParser1<ProtoModels::RatioAllList*>* get_Parser() {
		return ((MessageParser1<ProtoModels::RatioAllList*>* (*)(void *))(Il2CppBase() + 0x171C528))(0);
	}
	...
	template <typename R = ProtoModels::RatioAllList*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::RatioSummary*>* get_Ratio() {
		return ((RepeatedField1<ProtoModels::RatioSummary*>* (*)(RatioAllList*))(Il2CppBase() + 0x171C900))(this);
	}
	...
	template <typename R = void> R set_RatioEndDate(int64_t value) {
	 ...
	 MapField2<int64_t, ProtoModels::BonusPositionType*>* get_LastBonusPosition() {
		return ((MapField2<int64_t, ProtoModels::BonusPositionType*>* (*)(RatioAllList*))(Il2CppBase() + 0x171C928))(this);
	}
