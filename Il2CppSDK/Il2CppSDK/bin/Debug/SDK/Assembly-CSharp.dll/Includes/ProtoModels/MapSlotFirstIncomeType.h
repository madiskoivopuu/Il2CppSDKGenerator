...
public: 
	...
	template <typename T = MessageParser1MapSlotFirstIncomeType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1MapSlotFirstIncomeType*>*> static T get_Parser() {
	...
	template <typename T = MapSlotFirstIncomeType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(MapSlotFirstIncomeType*, Il2CppObject*))(Il2CppBase() + 0x12C5D30))(this, other);
	}
	template <typename T = bool> T Equals_1(MapSlotFirstIncomeType* other) {
		return ((T (*)(MapSlotFirstIncomeType*, MapSlotFirstIncomeType*))(Il2CppBase() + 0x12C5DCC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(MapSlotFirstIncomeType* other) {
		return ((T (*)(MapSlotFirstIncomeType*, MapSlotFirstIncomeType*))(Il2CppBase() + 0x12C6014))(this, other);
	}
