...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminGetWorldsResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminGetWorldsResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& WorldsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::MonitorWorld*>*& _repeated_worlds_codec() {
		return *(FieldCodec1ProtoModels::MonitorWorld*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::MonitorWorld*>*& worlds_() {
		return *(RepeatedField1ProtoModels::MonitorWorld*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1ProtoModels::AdminGetWorldsResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminGetWorldsResponse*>* (*)(void *))(Il2CppBase() + 0x12925B4))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::MonitorWorld*>* get_Worlds() {
		return ((RepeatedField1ProtoModels::MonitorWorld*>* (*)(AdminGetWorldsResponse*))(Il2CppBase() + 0x12929C0))(this);
	}
