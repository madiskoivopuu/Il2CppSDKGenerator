...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaCallBackRequest*, uintptr_t))(Il2CppBase() + 0x1A19E84))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaCallBackRequest*, uintptr_t))(Il2CppBase() + 0x1A19F20))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaCallBackRequest*, uintptr_t))(Il2CppBase() + 0x1A1A168))(this, other);
	}
