...
public: 
	...
	template <typename T = MessageParser1AdminGetPveWorldsRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1AdminGetPveWorldsRequest*>*> static T get_Parser() {
	...
	template <typename T = AdminGetPveWorldsRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminGetPveWorldsRequest*, Il2CppObject*))(Il2CppBase() + 0x18B4690))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminGetPveWorldsRequest* other) {
		return ((T (*)(AdminGetPveWorldsRequest*, AdminGetPveWorldsRequest*))(Il2CppBase() + 0x18B471C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminGetPveWorldsRequest* other) {
		return ((T (*)(AdminGetPveWorldsRequest*, AdminGetPveWorldsRequest*))(Il2CppBase() + 0x18B48C4))(this, other);
	}
