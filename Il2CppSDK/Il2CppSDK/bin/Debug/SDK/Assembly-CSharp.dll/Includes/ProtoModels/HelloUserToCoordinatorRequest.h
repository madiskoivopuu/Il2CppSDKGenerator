...
public: 
	...
	template <typename T = MessageParser1HelloUserToCoordinatorRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1HelloUserToCoordinatorRequest*>*> static T get_Parser() {
	...
	template <typename T = HelloUserToCoordinatorRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(HelloUserToCoordinatorRequest*, Il2CppObject*))(Il2CppBase() + 0x128C218))(this, other);
	}
	template <typename T = bool> T Equals_1(HelloUserToCoordinatorRequest* other) {
		return ((T (*)(HelloUserToCoordinatorRequest*, HelloUserToCoordinatorRequest*))(Il2CppBase() + 0x128C2B4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(HelloUserToCoordinatorRequest* other) {
		return ((T (*)(HelloUserToCoordinatorRequest*, HelloUserToCoordinatorRequest*))(Il2CppBase() + 0x128C4FC))(this, other);
	}
