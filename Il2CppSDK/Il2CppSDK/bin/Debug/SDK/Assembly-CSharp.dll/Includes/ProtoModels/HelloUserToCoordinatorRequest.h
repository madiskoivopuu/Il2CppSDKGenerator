...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::HelloUserToCoordinatorRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::HelloUserToCoordinatorRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& worldID_() {
	 ...
	 static MessageParser1<ProtoModels::HelloUserToCoordinatorRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::HelloUserToCoordinatorRequest*>* (*)(void *))(Il2CppBase() + 0x128BF78))(0);
	}
