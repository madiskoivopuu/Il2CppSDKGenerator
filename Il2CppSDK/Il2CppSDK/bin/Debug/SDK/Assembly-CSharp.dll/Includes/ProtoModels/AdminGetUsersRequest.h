...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetUsersRequest*, uintptr_t))(Il2CppBase() + 0x18B9A60))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetUsersRequest*, uintptr_t))(Il2CppBase() + 0x18B9AEC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetUsersRequest*, uintptr_t))(Il2CppBase() + 0x18B9C94))(this, other);
	}
