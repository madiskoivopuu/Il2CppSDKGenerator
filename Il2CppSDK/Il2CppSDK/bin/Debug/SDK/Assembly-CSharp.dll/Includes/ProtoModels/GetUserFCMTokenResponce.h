...
public: 
	...
	template <typename T = MessageParser1GetUserFCMTokenResponce*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_tokens_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& tokens_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1GetUserFCMTokenResponce*>*> static T get_Parser() {
	...
	template <typename T = GetUserFCMTokenResponce*> T Clone() {
	...
	template <typename T = RepeatedField1Il2CppString*>*> T get_Tokens() {
		return ((T (*)(GetUserFCMTokenResponce*))(Il2CppBase() + 0x1771BC0))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GetUserFCMTokenResponce*, Il2CppObject*))(Il2CppBase() + 0x1771BC8))(this, other);
	}
	template <typename T = bool> T Equals_1(GetUserFCMTokenResponce* other) {
		return ((T (*)(GetUserFCMTokenResponce*, GetUserFCMTokenResponce*))(Il2CppBase() + 0x1771C38))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GetUserFCMTokenResponce* other) {
		return ((T (*)(GetUserFCMTokenResponce*, GetUserFCMTokenResponce*))(Il2CppBase() + 0x1772014))(this, other);
	}
