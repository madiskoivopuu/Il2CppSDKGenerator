...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaPortalInfoData*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaPortalInfoData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PlayersFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaPortalPlayer*>*& _repeated_players_codec() {
		return *(FieldCodec1ProtoModels::ArenaPortalPlayer*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ArenaPortalPlayer*>*& players_() {
		return *(RepeatedField1ProtoModels::ArenaPortalPlayer*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = int32_t> R& type_() {
	 ...
	 static MessageParser1ProtoModels::ArenaPortalInfoData*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaPortalInfoData*>* (*)(void *))(Il2CppBase() + 0x1E2F034))(0);
	}
	...
	template <typename R = void> R set_Rank(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaPortalPlayer*>* get_Players() {
		return ((RepeatedField1ProtoModels::ArenaPortalPlayer*>* (*)(ArenaPortalInfoData*))(Il2CppBase() + 0x1E2F390))(this);
	}
