...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ClanAddGameDictionaryRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ClanAddGameDictionaryRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& value_() {
	 ...
	 static MessageParser1<ProtoModels::ClanAddGameDictionaryRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ClanAddGameDictionaryRequest*>* (*)(void *))(Il2CppBase() + 0x17499CC))(0);
	}
