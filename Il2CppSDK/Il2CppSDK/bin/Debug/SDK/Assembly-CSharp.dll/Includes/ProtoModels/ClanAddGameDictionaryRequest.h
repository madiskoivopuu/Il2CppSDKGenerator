...
public: 
	...
	template <typename T = MessageParser1ClanAddGameDictionaryRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ClanAddGameDictionaryRequest*>*> static T get_Parser() {
	...
	template <typename T = ClanAddGameDictionaryRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ClanAddGameDictionaryRequest*, Il2CppObject*))(Il2CppBase() + 0x1749DF8))(this, other);
	}
	template <typename T = bool> T Equals_1(ClanAddGameDictionaryRequest* other) {
		return ((T (*)(ClanAddGameDictionaryRequest*, ClanAddGameDictionaryRequest*))(Il2CppBase() + 0x1749E68))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ClanAddGameDictionaryRequest* other) {
		return ((T (*)(ClanAddGameDictionaryRequest*, ClanAddGameDictionaryRequest*))(Il2CppBase() + 0x174A238))(this, other);
	}
