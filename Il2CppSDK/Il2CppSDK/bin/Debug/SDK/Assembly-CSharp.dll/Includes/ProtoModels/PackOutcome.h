...
public: 
	...
	template <typename T = MessageParser1PackOutcome*>*> static T& _parser() {
	...
	template <typename T = MessageParser1PackOutcome*>*> static T get_Parser() {
	...
	template <typename T = PackOutcome*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PackOutcome*, Il2CppObject*))(Il2CppBase() + 0x11E77F8))(this, other);
	}
	template <typename T = bool> T Equals_1(PackOutcome* other) {
		return ((T (*)(PackOutcome*, PackOutcome*))(Il2CppBase() + 0x11E7868))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PackOutcome* other) {
		return ((T (*)(PackOutcome*, PackOutcome*))(Il2CppBase() + 0x11E7B58))(this, other);
	}
