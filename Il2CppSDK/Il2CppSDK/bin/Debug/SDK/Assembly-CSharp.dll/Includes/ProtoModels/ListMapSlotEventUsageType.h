...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ListMapSlotEventUsageType*>*& _parser() {
		return *(MessageParser1ProtoModels::ListMapSlotEventUsageType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& SlotFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::MapSlotEventUsageType*>*& _repeated_slot_codec() {
		return *(FieldCodec1ProtoModels::MapSlotEventUsageType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::MapSlotEventUsageType*>*& slot_() {
		return *(RepeatedField1ProtoModels::MapSlotEventUsageType*>**)((uintptr_t)this + 0x10);
	}
	template <typename R = int32_t> static R& FirstIncomeFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::MapSlotFirstIncomeType*>*& _repeated_firstIncome_codec() {
		return *(FieldCodec1ProtoModels::MapSlotFirstIncomeType*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::MapSlotFirstIncomeType*>*& firstIncome_() {
		return *(RepeatedField1ProtoModels::MapSlotFirstIncomeType*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = int32_t> static R& CountBonusMailFieldNumber() {
	 ...
	 static CodecIl2CppString*, int32_t>*& _map_countBonusMail_codec() {
		return *(CodecIl2CppString*, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 MapField2Il2CppString*, int32_t>*& countBonusMail_() {
		return *(MapField2Il2CppString*, int32_t>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = int32_t> static R& LastBonusMailFieldNumber() {
	 ...
	 static CodecIl2CppString*, int64_t>*& _map_lastBonusMail_codec() {
		return *(CodecIl2CppString*, int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 MapField2Il2CppString*, int64_t>*& lastBonusMail_() {
		return *(MapField2Il2CppString*, int64_t>**)((uintptr_t)this + 0x80);
	}

	 static MessageParser1ProtoModels::ListMapSlotEventUsageType*>* get_Parser() {
		return ((MessageParser1ProtoModels::ListMapSlotEventUsageType*>* (*)(void *))(Il2CppBase() + 0x142F2F0))(0);
	}
	...
	template <typename R = ProtoModels::ListMapSlotEventUsageType*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::MapSlotEventUsageType*>* get_Slot() {
		return ((RepeatedField1ProtoModels::MapSlotEventUsageType*>* (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F860))(this);
	}
	 RepeatedField1ProtoModels::MapSlotFirstIncomeType*>* get_FirstIncome() {
		return ((RepeatedField1ProtoModels::MapSlotFirstIncomeType*>* (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F868))(this);
	}
	...
	template <typename R = void> R set_FirstClass(Il2CppString* value) {
	 ...
	 MapField2Il2CppString*, int32_t>* get_CountBonusMail() {
		return ((MapField2Il2CppString*, int32_t>* (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F97C))(this);
	}
	...
	template <typename R = void> R set_PveCoolDownTimeUnix(int64_t value) {
	 ...
	 MapField2Il2CppString*, int64_t>* get_LastBonusMail() {
		return ((MapField2Il2CppString*, int64_t>* (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F9B4))(this);
	}
