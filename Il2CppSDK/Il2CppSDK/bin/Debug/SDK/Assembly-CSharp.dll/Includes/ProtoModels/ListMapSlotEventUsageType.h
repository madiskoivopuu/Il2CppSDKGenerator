...
public: 
	...
	template <typename T = MessageParser1ListMapSlotEventUsageType*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& SlotFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1MapSlotEventUsageType*>*> static T& _repeated_slot_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1MapSlotEventUsageType*>*> T& slot_() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = int32_t> static T& FirstIncomeFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1MapSlotFirstIncomeType*>*> static T& _repeated_firstIncome_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1MapSlotFirstIncomeType*>*> T& firstIncome_() {
	...
	template <typename T = TourneyCoolDownType*> T& tourneyCoolDown_() {
	...
	template <typename T = CodecIl2CppString*, int32_t>*> static T& _map_countBonusMail_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = MapField2Il2CppString*, int32_t>*> T& countBonusMail_() {
	...
	template <typename T = CodecIl2CppString*, int64_t>*> static T& _map_lastBonusMail_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = MapField2Il2CppString*, int64_t>*> T& lastBonusMail_() {
		return *(T*)((uintptr_t)this + 0x80);
	}

	template <typename T = MessageParser1ListMapSlotEventUsageType*>*> static T get_Parser() {
	...
	template <typename T = ListMapSlotEventUsageType*> T Clone() {
		return ((T (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F804))(this);
	}
	template <typename T = RepeatedField1MapSlotEventUsageType*>*> T get_Slot() {
		return ((T (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F860))(this);
	}
	template <typename T = RepeatedField1MapSlotFirstIncomeType*>*> T get_FirstIncome() {
	...
	template <typename T = TourneyCoolDownType*> T get_TourneyCoolDown() {
		return ((T (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F8E4))(this);
	}
	template <typename T = void> T set_TourneyCoolDown(TourneyCoolDownType* value) {
		return ((T (*)(ListMapSlotEventUsageType*, TourneyCoolDownType*))(Il2CppBase() + 0x142F8EC))(this, value);
	}
	...
	template <typename T = MapField2Il2CppString*, int32_t>*> T get_CountBonusMail() {
	...
	template <typename T = MapField2Il2CppString*, int64_t>*> T get_LastBonusMail() {
		return ((T (*)(ListMapSlotEventUsageType*))(Il2CppBase() + 0x142F9B4))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ListMapSlotEventUsageType*, Il2CppObject*))(Il2CppBase() + 0x142F9BC))(this, other);
	}
	template <typename T = bool> T Equals_1(ListMapSlotEventUsageType* other) {
		return ((T (*)(ListMapSlotEventUsageType*, ListMapSlotEventUsageType*))(Il2CppBase() + 0x142FA2C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ListMapSlotEventUsageType* other) {
		return ((T (*)(ListMapSlotEventUsageType*, ListMapSlotEventUsageType*))(Il2CppBase() + 0x1430624))(this, other);
	}
