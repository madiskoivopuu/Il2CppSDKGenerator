...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetUserBackupRequest*, uintptr_t))(Il2CppBase() + 0x18B8734))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetUserBackupRequest*, uintptr_t))(Il2CppBase() + 0x18B87D0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetUserBackupRequest*, uintptr_t))(Il2CppBase() + 0x18B8A18))(this, other);
	}
