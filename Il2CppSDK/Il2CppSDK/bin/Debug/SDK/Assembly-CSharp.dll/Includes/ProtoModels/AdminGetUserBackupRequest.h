...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AdminGetUserBackupRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::AdminGetUserBackupRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& accountID_() {
	 ...
	 static MessageParser1<ProtoModels::AdminGetUserBackupRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AdminGetUserBackupRequest*>* (*)(void *))(Il2CppBase() + 0x18B8494))(0);
	}
