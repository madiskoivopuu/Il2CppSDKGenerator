...
public: 
	...
	template <typename T = MessageParser1PlayerTourney*>*> static T& _parser() {
	...
	template <typename T = MessageParser1PlayerTourney*>*> static T get_Parser() {
	...
	template <typename T = PlayerTourney*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PlayerTourney*, Il2CppObject*))(Il2CppBase() + 0x1573C94))(this, other);
	}
	template <typename T = bool> T Equals_1(PlayerTourney* other) {
		return ((T (*)(PlayerTourney*, PlayerTourney*))(Il2CppBase() + 0x1573D04))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PlayerTourney* other) {
		return ((T (*)(PlayerTourney*, PlayerTourney*))(Il2CppBase() + 0x1574114))(this, other);
	}
