...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaStatusResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaStatusResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& SpectreWorldsFieldNumber() {
	 ...
	 static FieldCodec1int64_t>*& _repeated_spectreWorlds_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1int64_t>*& spectreWorlds_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x40);
	}
	template <typename R = int32_t> static R& SpectreUsersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_spectreUsers_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1int64_t>*& spectreUsers_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x48);
	}
	template <typename R = int32_t> static R& SpectreGmapsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_spectreGmaps_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1int64_t>*& spectreGmaps_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x50);
	}
	template <typename R = int32_t> static R& CheatersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::UserCheater*>*& _repeated_cheaters_codec() {
		return *(FieldCodec1ProtoModels::UserCheater*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1ProtoModels::UserCheater*>*& cheaters_() {
		return *(RepeatedField1ProtoModels::UserCheater*>**)((uintptr_t)this + 0x58);
	}
	template <typename R = int32_t> static R& NotFoundUsersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1int64_t>*& _repeated_notFoundUsers_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	 RepeatedField1int64_t>*& notFoundUsers_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x60);
	}
	template <typename R = int32_t> static R& QuestProgressFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::ArenaGuildUserQuestProgress*>*& _repeated_questProgress_codec() {
		return *(FieldCodec1ProtoModels::ArenaGuildUserQuestProgress*>**)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	 RepeatedField1ProtoModels::ArenaGuildUserQuestProgress*>*& questProgress_() {
		return *(RepeatedField1ProtoModels::ArenaGuildUserQuestProgress*>**)((uintptr_t)this + 0x68);
	}

	 static MessageParser1ProtoModels::ArenaStatusResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaStatusResponse*>* (*)(void *))(Il2CppBase() + 0x27155D0))(0);
	}
	...
	template <typename R = void> R set_SetFps(int32_t value) {
	 ...
	 RepeatedField1int64_t>* get_SpectreWorlds() {
		return ((RepeatedField1int64_t>* (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C70))(this);
	}
	 RepeatedField1int64_t>* get_SpectreUsers() {
		return ((RepeatedField1int64_t>* (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C78))(this);
	}
	 RepeatedField1int64_t>* get_SpectreGmaps() {
		return ((RepeatedField1int64_t>* (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C80))(this);
	}
	 RepeatedField1ProtoModels::UserCheater*>* get_Cheaters() {
		return ((RepeatedField1ProtoModels::UserCheater*>* (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C88))(this);
	}
	 RepeatedField1int64_t>* get_NotFoundUsers() {
		return ((RepeatedField1int64_t>* (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C90))(this);
	}
	 RepeatedField1ProtoModels::ArenaGuildUserQuestProgress*>* get_QuestProgress() {
		return ((RepeatedField1ProtoModels::ArenaGuildUserQuestProgress*>* (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C98))(this);
	}
