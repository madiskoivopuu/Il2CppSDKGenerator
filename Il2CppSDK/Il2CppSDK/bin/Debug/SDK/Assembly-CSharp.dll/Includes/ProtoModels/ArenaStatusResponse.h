...
public: 
	...
	template <typename T = void*> static T& _repeated_spectreWorlds_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& spectreWorlds_() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = int32_t> static T& SpectreUsersFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_spectreUsers_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& spectreUsers_() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = int32_t> static T& SpectreGmapsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_spectreGmaps_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> T& spectreGmaps_() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = int32_t> static T& CheatersFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_cheaters_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = void*> T& cheaters_() {
		return *(T*)((uintptr_t)this + 0x58);
	}
	template <typename T = int32_t> static T& NotFoundUsersFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_notFoundUsers_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = void*> T& notFoundUsers_() {
		return *(T*)((uintptr_t)this + 0x60);
	}
	template <typename T = int32_t> static T& QuestProgressFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_questProgress_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = void*> T& questProgress_() {
	...
	template <typename T = void*> T get_SpectreWorlds() {
		return ((T (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C70))(this);
	}
	template <typename T = void*> T get_SpectreUsers() {
		return ((T (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C78))(this);
	}
	template <typename T = void*> T get_SpectreGmaps() {
		return ((T (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C80))(this);
	}
	template <typename T = void*> T get_Cheaters() {
		return ((T (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C88))(this);
	}
	template <typename T = void*> T get_NotFoundUsers() {
		return ((T (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C90))(this);
	}
	template <typename T = void*> T get_QuestProgress() {
		return ((T (*)(ArenaStatusResponse*))(Il2CppBase() + 0x2715C98))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaStatusResponse*, uintptr_t))(Il2CppBase() + 0x2715CA0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaStatusResponse*, uintptr_t))(Il2CppBase() + 0x2715D10))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaStatusResponse*, uintptr_t))(Il2CppBase() + 0x27168AC))(this, other);
	}
