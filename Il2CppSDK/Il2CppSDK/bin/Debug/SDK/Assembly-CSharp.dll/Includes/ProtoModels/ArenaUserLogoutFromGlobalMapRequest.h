...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserLogoutFromGlobalMapRequest*, uintptr_t))(Il2CppBase() + 0x2860710))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserLogoutFromGlobalMapRequest*, uintptr_t))(Il2CppBase() + 0x28607AC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserLogoutFromGlobalMapRequest*, uintptr_t))(Il2CppBase() + 0x28609F4))(this, other);
	}
