...
public: 
	...
	template <typename T = void*> static T& _repeated_devToDevUrl_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& devToDevUrl_() {
	...
	template <typename T = uintptr_t> T& analytics_() {
		return *(T*)((uintptr_t)this + 0x58);
	}
	template <typename T = int32_t> static T& ChatFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& chat_() {
	...
	template <typename T = uintptr_t> T& slack_() {
	...
	template <typename T = void*> static T& _map_dungeonSavePeriod_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& dungeonSavePeriod_() {
	...
	template <typename T = void*> static T& _repeated_enableListPveIDs_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> T& enableListPveIDs_() {
	...
	template <typename T = void*> T get_DevToDevUrl() {
	...
	template <typename T = void> T set_Analytics(uintptr_t value) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x136725C))(this, value);
	}
	...
	template <typename T = void> T set_Chat(uintptr_t value) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x136726C))(this, value);
	}
	...
	template <typename T = void> T set_Protocol(uintptr_t value) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x136727C))(this, value);
	}
	template <typename T = uintptr_t> T get_Slack() {
		return ((T (*)(ServerConfiguration*))(Il2CppBase() + 0x1367284))(this);
	}
	template <typename T = void> T set_Slack(uintptr_t value) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x136728C))(this, value);
	}
	...
	template <typename T = void*> T get_DungeonSavePeriod() {
	...
	template <typename T = void*> T get_EnableListPveIDs() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x136749C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x136750C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ServerConfiguration*, uintptr_t))(Il2CppBase() + 0x13685D0))(this, other);
	}
