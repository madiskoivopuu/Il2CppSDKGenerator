...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(EmptyCell*, uintptr_t))(Il2CppBase() + 0x136FE38))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(EmptyCell*, uintptr_t))(Il2CppBase() + 0x136FEA8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(EmptyCell*, uintptr_t))(Il2CppBase() + 0x1370120))(this, other);
	}
