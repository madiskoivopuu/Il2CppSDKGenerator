...
public: 
	...
	template <typename T = void*> static T& _repeated_guilds_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& guilds_() {
	...
	template <typename T = void*> T get_Guilds() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(GuildMainTopRequest*, uintptr_t))(Il2CppBase() + 0x1B34918))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(GuildMainTopRequest*, uintptr_t))(Il2CppBase() + 0x1B34988))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(GuildMainTopRequest*, uintptr_t))(Il2CppBase() + 0x1B34C78))(this, other);
	}
