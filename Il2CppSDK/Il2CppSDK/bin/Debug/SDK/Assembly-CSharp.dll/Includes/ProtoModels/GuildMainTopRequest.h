...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::GuildMainTopRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::GuildMainTopRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& GuildsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::GuildMessageType*>*& _repeated_guilds_codec() {
		return *(FieldCodec1ProtoModels::GuildMessageType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::GuildMessageType*>*& guilds_() {
		return *(RepeatedField1ProtoModels::GuildMessageType*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = bool> R& update_() {
	 ...
	 static MessageParser1ProtoModels::GuildMainTopRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::GuildMainTopRequest*>* (*)(void *))(Il2CppBase() + 0x1B345B8))(0);
	}
	...
	template <typename R = ProtoModels::GuildMainTopRequest*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::GuildMessageType*>* get_Guilds() {
		return ((RepeatedField1ProtoModels::GuildMessageType*>* (*)(GuildMainTopRequest*))(Il2CppBase() + 0x1B348FC))(this);
	}
