...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::IntToInt32ToIntMap*>*& _parser() {
		return *(MessageParser1ProtoModels::IntToInt32ToIntMap*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& OuterMapFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codecint32_t, ProtoModels::Int32ToIntMap*>*& _map_outerMap_codec() {
		return *(Codecint32_t, ProtoModels::Int32ToIntMap*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2int32_t, ProtoModels::Int32ToIntMap*>*& outerMap_() {
		return *(MapField2int32_t, ProtoModels::Int32ToIntMap*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::IntToInt32ToIntMap*>* get_Parser() {
		return ((MessageParser1ProtoModels::IntToInt32ToIntMap*>* (*)(void *))(Il2CppBase() + 0x14699F4))(0);
	}
	...
	template <typename R = ProtoModels::IntToInt32ToIntMap*> R Clone() {
	 ...
	 MapField2int32_t, ProtoModels::Int32ToIntMap*>* get_OuterMap() {
		return ((MapField2int32_t, ProtoModels::Int32ToIntMap*>* (*)(IntToInt32ToIntMap*))(Il2CppBase() + 0x1469D2C))(this);
	}
