...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaDeleteMapSlotRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaDeleteMapSlotRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& transactionID_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaDeleteMapSlotRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaDeleteMapSlotRequest*>* (*)(void *))(Il2CppBase() + 0x1E1CC80))(0);
	}
