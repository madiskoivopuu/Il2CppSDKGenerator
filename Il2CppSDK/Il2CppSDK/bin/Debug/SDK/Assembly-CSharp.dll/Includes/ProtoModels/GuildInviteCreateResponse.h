...
public: 
	...
	template <typename T = MessageParser1GuildInviteCreateResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildInviteCreateResponse*>*> static T get_Parser() {
	...
	template <typename T = GuildInviteCreateResponse*> T Clone() {
	...
	template <typename T = void> T set_Guild(GuildMessageType* value) {
		return ((T (*)(GuildInviteCreateResponse*, GuildMessageType*))(Il2CppBase() + 0x1B2D8A8))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildInviteCreateResponse*, Il2CppObject*))(Il2CppBase() + 0x1B2D8C0))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildInviteCreateResponse* other) {
		return ((T (*)(GuildInviteCreateResponse*, GuildInviteCreateResponse*))(Il2CppBase() + 0x1B2D930))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildInviteCreateResponse* other) {
		return ((T (*)(GuildInviteCreateResponse*, GuildInviteCreateResponse*))(Il2CppBase() + 0x1B2DCE8))(this, other);
	}
