...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GuildInviteCreateResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::GuildInviteCreateResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& lockTime_() {
	 ...
	 static MessageParser1<ProtoModels::GuildInviteCreateResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GuildInviteCreateResponse*>* (*)(void *))(Il2CppBase() + 0x1B2D4A8))(0);
	}
