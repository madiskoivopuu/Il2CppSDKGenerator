...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetArenaStatisticResponse*, uintptr_t))(Il2CppBase() + 0x18B26B0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetArenaStatisticResponse*, uintptr_t))(Il2CppBase() + 0x18B2720))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetArenaStatisticResponse*, uintptr_t))(Il2CppBase() + 0x18B2CC4))(this, other);
	}
