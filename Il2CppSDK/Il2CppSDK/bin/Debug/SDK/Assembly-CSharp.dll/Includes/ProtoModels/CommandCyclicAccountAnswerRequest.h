...
public: 
	...
	template <typename T = MessageParser1CommandCyclicAccountAnswerRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1CommandCyclicAccountAnswerRequest*>*> static T get_Parser() {
	...
	template <typename T = CommandCyclicAccountAnswerRequest*> T Clone() {
	...
	template <typename T = void> T set_MasterAccount(CyclicMasterAccountType* value) {
		return ((T (*)(CommandCyclicAccountAnswerRequest*, CyclicMasterAccountType*))(Il2CppBase() + 0xE25C98))(this, value);
	}
	...
	template <typename T = void> T set_CyclicAccount(CyclicMasterAccountType* value) {
		return ((T (*)(CommandCyclicAccountAnswerRequest*, CyclicMasterAccountType*))(Il2CppBase() + 0xE25CA8))(this, value);
	}
	...
	template <typename T = void> T set_ServerDetail(CyclicServerDetailType* value) {
		return ((T (*)(CommandCyclicAccountAnswerRequest*, CyclicServerDetailType*))(Il2CppBase() + 0xE25CB8))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(CommandCyclicAccountAnswerRequest*, Il2CppObject*))(Il2CppBase() + 0xE25CD0))(this, other);
	}
	template <typename T = bool> T Equals_1(CommandCyclicAccountAnswerRequest* other) {
		return ((T (*)(CommandCyclicAccountAnswerRequest*, CommandCyclicAccountAnswerRequest*))(Il2CppBase() + 0xE25D40))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(CommandCyclicAccountAnswerRequest* other) {
		return ((T (*)(CommandCyclicAccountAnswerRequest*, CommandCyclicAccountAnswerRequest*))(Il2CppBase() + 0xE262B4))(this, other);
	}
