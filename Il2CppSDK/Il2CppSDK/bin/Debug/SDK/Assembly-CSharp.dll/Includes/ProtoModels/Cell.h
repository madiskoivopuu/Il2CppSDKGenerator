...
public: 
	...
	template <typename T = MessageParser1Cell*>*> static T& _parser() {
	...
	template <typename T = MessageParser1Cell*>*> static T get_Parser() {
	...
	template <typename T = Cell*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(Cell*, Il2CppObject*))(Il2CppBase() + 0x13E934C))(this, other);
	}
	template <typename T = bool> T Equals_1(Cell* other) {
		return ((T (*)(Cell*, Cell*))(Il2CppBase() + 0x13E93E8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(Cell* other) {
		return ((T (*)(Cell*, Cell*))(Il2CppBase() + 0x13E9630))(this, other);
	}
