...
public: 
	...
	template <typename T = void*> static T& _repeated_backups_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& backups_() {
	...
	template <typename T = void*> T get_Backups() {
		return ((T (*)(AdminGetUserBackupResponse*))(Il2CppBase() + 0x18B8FE4))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetUserBackupResponse*, uintptr_t))(Il2CppBase() + 0x18B8FEC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetUserBackupResponse*, uintptr_t))(Il2CppBase() + 0x18B905C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetUserBackupResponse*, uintptr_t))(Il2CppBase() + 0x18B9438))(this, other);
	}
