...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminGetUserBackupResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminGetUserBackupResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& BackupsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::AdminBackupInfo*>*& _repeated_backups_codec() {
		return *(FieldCodec1ProtoModels::AdminBackupInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::AdminBackupInfo*>*& backups_() {
		return *(RepeatedField1ProtoModels::AdminBackupInfo*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1ProtoModels::AdminGetUserBackupResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminGetUserBackupResponse*>* (*)(void *))(Il2CppBase() + 0x18B8BD8))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::AdminBackupInfo*>* get_Backups() {
		return ((RepeatedField1ProtoModels::AdminBackupInfo*>* (*)(AdminGetUserBackupResponse*))(Il2CppBase() + 0x18B8FE4))(this);
	}
