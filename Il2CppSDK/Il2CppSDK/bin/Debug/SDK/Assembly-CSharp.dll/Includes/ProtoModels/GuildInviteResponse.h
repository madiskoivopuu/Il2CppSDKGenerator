...
public: 
	...
	template <typename T = MessageParser1GuildInviteResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildInviteResponse*>*> static T get_Parser() {
	...
	template <typename T = GuildInviteResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildInviteResponse*, Il2CppObject*))(Il2CppBase() + 0x1B319B0))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildInviteResponse* other) {
		return ((T (*)(GuildInviteResponse*, GuildInviteResponse*))(Il2CppBase() + 0x1B31A20))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildInviteResponse* other) {
		return ((T (*)(GuildInviteResponse*, GuildInviteResponse*))(Il2CppBase() + 0x1B31D44))(this, other);
	}
