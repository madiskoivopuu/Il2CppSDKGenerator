...
public: 
	...
	template <typename T = void*> static T& _repeated_usersID_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& usersID_() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = int32_t> static T& WorldIDFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_worldID_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& worldID_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& GmapsIDFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_gmapsID_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> T& gmapsID_() {
	...
	template <typename T = void*> T get_UsersID() {
		return ((T (*)(ArenaStatusRequest*))(Il2CppBase() + 0x2714B14))(this);
	}
	template <typename T = void*> T get_WorldID() {
		return ((T (*)(ArenaStatusRequest*))(Il2CppBase() + 0x2714B1C))(this);
	}
	template <typename T = void*> T get_GmapsID() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaStatusRequest*, uintptr_t))(Il2CppBase() + 0x2714B4C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaStatusRequest*, uintptr_t))(Il2CppBase() + 0x2714BBC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaStatusRequest*, uintptr_t))(Il2CppBase() + 0x2715188))(this, other);
	}
