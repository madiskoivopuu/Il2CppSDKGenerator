...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaStatusRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaStatusRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& cyclicPriceVipForVip_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaStatusRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaStatusRequest*>* (*)(void *))(Il2CppBase() + 0x2714624))(0);
	}
	...
	template <typename R = void> R set_Salt(uintptr_t value) {
	 ...
	 RepeatedField1<int64_t>* get_UsersID() {
		return ((RepeatedField1<int64_t>* (*)(ArenaStatusRequest*))(Il2CppBase() + 0x2714B14))(this);
	}
	 RepeatedField1<int64_t>* get_WorldID() {
		return ((RepeatedField1<int64_t>* (*)(ArenaStatusRequest*))(Il2CppBase() + 0x2714B1C))(this);
	}
	 RepeatedField1<int64_t>* get_GmapsID() {
		return ((RepeatedField1<int64_t>* (*)(ArenaStatusRequest*))(Il2CppBase() + 0x2714B24))(this);
	}
