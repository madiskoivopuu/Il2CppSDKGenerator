...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::GuildMessageType*>*& _parser() {
		return *(MessageParser1ProtoModels::GuildMessageType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& InvitesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::GuildInvite*>*& _repeated_invites_codec() {
		return *(FieldCodec1ProtoModels::GuildInvite*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::GuildInvite*>*& invites_() {
		return *(RepeatedField1ProtoModels::GuildInvite*>**)((uintptr_t)this + 0x50);
	}
	template <typename R = int32_t> static R& QuestsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::GuildQuestArena*>*& _repeated_quests_codec() {
		return *(FieldCodec1ProtoModels::GuildQuestArena*>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1ProtoModels::GuildQuestArena*>*& quests_() {
		return *(RepeatedField1ProtoModels::GuildQuestArena*>**)((uintptr_t)this + 0x58);
	}
	...
	template <typename R = int32_t> static R& KilledBossesFieldNumber() {
	 ...
	 static FieldCodec1Il2CppString*>*& _repeated_killedBosses_codec() {
		return *(FieldCodec1Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1Il2CppString*>*& killedBosses_() {
		return *(RepeatedField1Il2CppString*>**)((uintptr_t)this + 0x78);
	}

	 static MessageParser1ProtoModels::GuildMessageType*>* get_Parser() {
		return ((MessageParser1ProtoModels::GuildMessageType*>* (*)(void *))(Il2CppBase() + 0x1B39500))(0);
	}
	...
	template <typename R = void> R set_Size(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::Player*>* get_Players() {
		return ((RepeatedField1ProtoModels::Player*>* (*)(GuildMessageType*))(Il2CppBase() + 0x1B39A70))(this);
	}
	 RepeatedField1ProtoModels::GuildInvite*>* get_Invites() {
		return ((RepeatedField1ProtoModels::GuildInvite*>* (*)(GuildMessageType*))(Il2CppBase() + 0x1B39A78))(this);
	}
	 RepeatedField1ProtoModels::GuildQuestArena*>* get_Quests() {
		return ((RepeatedField1ProtoModels::GuildQuestArena*>* (*)(GuildMessageType*))(Il2CppBase() + 0x1B39A80))(this);
	}
	...
	template <typename R = void> R set_PrevWeekRankPoints(int32_t value) {
	 ...
	 RepeatedField1Il2CppString*>* get_KilledBosses() {
		return ((RepeatedField1Il2CppString*>* (*)(GuildMessageType*))(Il2CppBase() + 0x1B39B30))(this);
	}
