...
public: 
	...
	template <typename T = MessageParser1ArenaKillWorldResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaKillWorldResponse*>*> static T get_Parser() {
	...
	template <typename T = ArenaKillWorldResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaKillWorldResponse*, Il2CppObject*))(Il2CppBase() + 0x1E2BE80))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaKillWorldResponse* other) {
		return ((T (*)(ArenaKillWorldResponse*, ArenaKillWorldResponse*))(Il2CppBase() + 0x1E2BEF0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaKillWorldResponse* other) {
		return ((T (*)(ArenaKillWorldResponse*, ArenaKillWorldResponse*))(Il2CppBase() + 0x1E2C168))(this, other);
	}
