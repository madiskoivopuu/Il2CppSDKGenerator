...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaKillWorldResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaKillWorldResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& codeMessage_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaKillWorldResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaKillWorldResponse*>* (*)(void *))(Il2CppBase() + 0x1E2BB14))(0);
	}
