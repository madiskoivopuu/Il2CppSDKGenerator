...
public: 
	...
	template <typename T = MessageParser1AdminUpdateTagsRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1AdminUpdateTagsRequest*>*> static T get_Parser() {
	...
	template <typename T = AdminUpdateTagsRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminUpdateTagsRequest*, Il2CppObject*))(Il2CppBase() + 0x129671C))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminUpdateTagsRequest* other) {
		return ((T (*)(AdminUpdateTagsRequest*, AdminUpdateTagsRequest*))(Il2CppBase() + 0x12967C8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminUpdateTagsRequest* other) {
		return ((T (*)(AdminUpdateTagsRequest*, AdminUpdateTagsRequest*))(Il2CppBase() + 0x1296AAC))(this, other);
	}
