...
public: 
	...
	template <typename T = MessageParser1GlobalMapClanSaveDataType*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& PVEFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1GlobalMapPveSaveType*>*> static T& _repeated_pVE_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1GlobalMapPveSaveType*>*> T& pVE_() {
	...
	template <typename T = MessageParser1GlobalMapClanSaveDataType*>*> static T get_Parser() {
	...
	template <typename T = GlobalMapClanSaveDataType*> T Clone() {
		return ((T (*)(GlobalMapClanSaveDataType*))(Il2CppBase() + 0x12D6214))(this);
	}
	template <typename T = RepeatedField1GlobalMapPveSaveType*>*> T get_PVE() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GlobalMapClanSaveDataType*, Il2CppObject*))(Il2CppBase() + 0x12D6280))(this, other);
	}
	template <typename T = bool> T Equals_1(GlobalMapClanSaveDataType* other) {
		return ((T (*)(GlobalMapClanSaveDataType*, GlobalMapClanSaveDataType*))(Il2CppBase() + 0x12D62F0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GlobalMapClanSaveDataType* other) {
		return ((T (*)(GlobalMapClanSaveDataType*, GlobalMapClanSaveDataType*))(Il2CppBase() + 0x12D6610))(this, other);
	}
