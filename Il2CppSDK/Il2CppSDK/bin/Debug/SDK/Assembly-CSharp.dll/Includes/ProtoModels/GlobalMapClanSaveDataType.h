...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::GlobalMapClanSaveDataType*>*& _parser() {
		return *(MessageParser1<ProtoModels::GlobalMapClanSaveDataType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& PVEFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::GlobalMapPveSaveType*>*& _repeated_pVE_codec() {
		return *(FieldCodec1<ProtoModels::GlobalMapPveSaveType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::GlobalMapPveSaveType*>*& pVE_() {
		return *(RepeatedField1<ProtoModels::GlobalMapPveSaveType*>**)((uintptr_t)this + 0x10);
	}
	template <typename R = int32_t> static R& TimeLocationResetFieldNumber() {
	 ...
	 static Codec<int64_t, int64_t>*& _map_timeLocationReset_codec() {
		return *(Codec<int64_t, int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2<int64_t, int64_t>*& timeLocationReset_() {
		return *(MapField2<int64_t, int64_t>**)((uintptr_t)this + 0x18);
	}

	 static MessageParser1<ProtoModels::GlobalMapClanSaveDataType*>* get_Parser() {
		return ((MessageParser1<ProtoModels::GlobalMapClanSaveDataType*>* (*)(void *))(Il2CppBase() + 0x12D5EB8))(0);
	}
	...
	template <typename R = ProtoModels::GlobalMapClanSaveDataType*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::GlobalMapPveSaveType*>* get_PVE() {
		return ((RepeatedField1<ProtoModels::GlobalMapPveSaveType*>* (*)(GlobalMapClanSaveDataType*))(Il2CppBase() + 0x12D6270))(this);
	}
	 MapField2<int64_t, int64_t>* get_TimeLocationReset() {
		return ((MapField2<int64_t, int64_t>* (*)(GlobalMapClanSaveDataType*))(Il2CppBase() + 0x12D6278))(this);
	}
