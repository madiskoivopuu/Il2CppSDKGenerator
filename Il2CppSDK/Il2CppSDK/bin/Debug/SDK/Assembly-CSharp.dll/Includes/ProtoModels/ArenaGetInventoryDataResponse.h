...
public: 
	...
	template <typename T = uintptr_t> T& userInventory_() {
	...
	template <typename T = uintptr_t> T get_UserInventory() {
		return ((T (*)(ArenaGetInventoryDataResponse*))(Il2CppBase() + 0x1E23AF0))(this);
	}
	template <typename T = void> T set_UserInventory(uintptr_t value) {
		return ((T (*)(ArenaGetInventoryDataResponse*, uintptr_t))(Il2CppBase() + 0x1E23AF8))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaGetInventoryDataResponse*, uintptr_t))(Il2CppBase() + 0x1E23B00))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaGetInventoryDataResponse*, uintptr_t))(Il2CppBase() + 0x1E23B70))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaGetInventoryDataResponse*, uintptr_t))(Il2CppBase() + 0x1E23E90))(this, other);
	}
