...
public: 
	...
	template <typename T = MessageParser1Mail*>*> static T& _parser() {
	...
	template <typename T = MessageParser1Mail*>*> static T get_Parser() {
	...
	template <typename T = Mail*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(Mail*, Il2CppObject*))(Il2CppBase() + 0x1A49D08))(this, other);
	}
	template <typename T = bool> T Equals_1(Mail* other) {
		return ((T (*)(Mail*, Mail*))(Il2CppBase() + 0x1A49D78))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(Mail* other) {
		return ((T (*)(Mail*, Mail*))(Il2CppBase() + 0x1A4A9B4))(this, other);
	}
