...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ResetUserPveWorldResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::ResetUserPveWorldResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& reseted_() {
	 ...
	 static MessageParser1<ProtoModels::ResetUserPveWorldResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ResetUserPveWorldResponse*>* (*)(void *))(Il2CppBase() + 0x119B7EC))(0);
	}
