...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ResetUserPveWorldResponse*, uintptr_t))(Il2CppBase() + 0x119BC20))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ResetUserPveWorldResponse*, uintptr_t))(Il2CppBase() + 0x119BC90))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ResetUserPveWorldResponse*, uintptr_t))(Il2CppBase() + 0x119C048))(this, other);
	}
