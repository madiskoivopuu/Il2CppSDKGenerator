...
public: 
	...
	template <typename T = void*> static T& _repeated_members_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& members_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& FriendsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& friends_() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = int32_t> static T& FriendsCandidateFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& friendsCandidate_() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = int32_t> static T& LockPeacePairsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& lockPeacePairs_() {
	...
	template <typename T = void*> static T& _repeated_protectTime_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> T& protectTime_() {
	...
	template <typename T = void*> static T& _map_realSearchLongSecond_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = void*> T& realSearchLongSecond_() {
	...
	template <typename T = uintptr_t> T get_Friends() {
		return ((T (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0EA4))(this);
	}
	template <typename T = void> T set_Friends(uintptr_t value) {
		return ((T (*)(PvpGroupInfo*, uintptr_t))(Il2CppBase() + 0x11C0EAC))(this, value);
	}
	template <typename T = uintptr_t> T get_FriendsCandidate() {
		return ((T (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0EB4))(this);
	}
	template <typename T = void> T set_FriendsCandidate(uintptr_t value) {
		return ((T (*)(PvpGroupInfo*, uintptr_t))(Il2CppBase() + 0x11C0EBC))(this, value);
	}
	template <typename T = uintptr_t> T get_LockPeacePairs() {
		return ((T (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0EC4))(this);
	}
	template <typename T = void> T set_LockPeacePairs(uintptr_t value) {
		return ((T (*)(PvpGroupInfo*, uintptr_t))(Il2CppBase() + 0x11C0ECC))(this, value);
	}
	...
	template <typename T = void*> T get_ProtectTime() {
	...
	template <typename T = void*> T get_RealSearchLongSecond() {
		return ((T (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0F60))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PvpGroupInfo*, uintptr_t))(Il2CppBase() + 0x11C0F68))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PvpGroupInfo*, uintptr_t))(Il2CppBase() + 0x11C0FD8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PvpGroupInfo*, uintptr_t))(Il2CppBase() + 0x11C1BD4))(this, other);
	}
