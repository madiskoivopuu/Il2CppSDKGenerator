...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::PvpGroupInfo*>*& _parser() {
		return *(MessageParser1ProtoModels::PvpGroupInfo*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ClansFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ClanInfoData*>*& _repeated_clans_codec() {
		return *(FieldCodec1ProtoModels::ClanInfoData*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ClanInfoData*>*& clans_() {
		return *(RepeatedField1ProtoModels::ClanInfoData*>**)((uintptr_t)this + 0x18);
	}
	template <typename R = int32_t> static R& MembersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::UserInfoData*>*& _repeated_members_codec() {
		return *(FieldCodec1ProtoModels::UserInfoData*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::UserInfoData*>*& members_() {
		return *(RepeatedField1ProtoModels::UserInfoData*>**)((uintptr_t)this + 0x20);
	}
	...
	template <typename R = int32_t> static R& ProtectTimeFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ClanTime*>*& _repeated_protectTime_codec() {
		return *(FieldCodec1ProtoModels::ClanTime*>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1ProtoModels::ClanTime*>*& protectTime_() {
		return *(RepeatedField1ProtoModels::ClanTime*>**)((uintptr_t)this + 0x68);
	}
	...
	template <typename R = int32_t> static R& RealSearchLongSecondFieldNumber() {
	 ...
	 static Codecint64_t, int32_t>*& _map_realSearchLongSecond_codec() {
		return *(Codecint64_t, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 MapField2int64_t, int32_t>*& realSearchLongSecond_() {
		return *(MapField2int64_t, int32_t>**)((uintptr_t)this + 0x78);
	}

	 static MessageParser1ProtoModels::PvpGroupInfo*>* get_Parser() {
		return ((MessageParser1ProtoModels::PvpGroupInfo*>* (*)(void *))(Il2CppBase() + 0x11C0904))(0);
	}
	...
	template <typename R = void> R set_PvpID(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::ClanInfoData*>* get_Clans() {
		return ((RepeatedField1ProtoModels::ClanInfoData*>* (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0E94))(this);
	}
	 RepeatedField1ProtoModels::UserInfoData*>* get_Members() {
		return ((RepeatedField1ProtoModels::UserInfoData*>* (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0E9C))(this);
	}
	...
	template <typename R = void> R set_MaxProtectSecond(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ClanTime*>* get_ProtectTime() {
		return ((RepeatedField1ProtoModels::ClanTime*>* (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0F44))(this);
	}
	...
	template <typename R = void> R set_IsFakeGroup(bool value) {
	 ...
	 MapField2int64_t, int32_t>* get_RealSearchLongSecond() {
		return ((MapField2int64_t, int32_t>* (*)(PvpGroupInfo*))(Il2CppBase() + 0x11C0F60))(this);
	}
