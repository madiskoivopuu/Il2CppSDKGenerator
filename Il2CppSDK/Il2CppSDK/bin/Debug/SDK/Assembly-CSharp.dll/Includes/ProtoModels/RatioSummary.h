...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::RatioSummary*>*& _parser() {
		return *(MessageParser1ProtoModels::RatioSummary*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& RatioListFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::RatioValue*>*& _repeated_ratioList_codec() {
		return *(FieldCodec1ProtoModels::RatioValue*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::RatioValue*>*& ratioList_() {
		return *(RepeatedField1ProtoModels::RatioValue*>**)((uintptr_t)this + 0x10);
	}
	template <typename R = int32_t> static R& PreviousPositionFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codecint64_t, int32_t>*& _map_previousPosition_codec() {
		return *(Codecint64_t, int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2int64_t, int32_t>*& previousPosition_() {
		return *(MapField2int64_t, int32_t>**)((uintptr_t)this + 0x18);
	}

	 static MessageParser1ProtoModels::RatioSummary*>* get_Parser() {
		return ((MessageParser1ProtoModels::RatioSummary*>* (*)(void *))(Il2CppBase() + 0x138C7DC))(0);
	}
	...
	template <typename R = ProtoModels::RatioSummary*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::RatioValue*>* get_RatioList() {
		return ((RepeatedField1ProtoModels::RatioValue*>* (*)(RatioSummary*))(Il2CppBase() + 0x138CB94))(this);
	}
	 MapField2int64_t, int32_t>* get_PreviousPosition() {
		return ((MapField2int64_t, int32_t>* (*)(RatioSummary*))(Il2CppBase() + 0x138CB9C))(this);
	}
