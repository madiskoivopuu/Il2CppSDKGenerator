...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAllRatioTablesRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaAllRatioTablesRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::RatioAllTables*> R& tables_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAllRatioTablesRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaAllRatioTablesRequest*>* (*)(void *))(Il2CppBase() + 0x1A14C90))(0);
	}
