...
public: 
	...
	template <typename T = uintptr_t> T& tables_() {
	...
	template <typename T = uintptr_t> T get_Tables() {
		return ((T (*)(ArenaAllRatioTablesRequest*))(Il2CppBase() + 0x1A14F28))(this);
	}
	template <typename T = void> T set_Tables(uintptr_t value) {
		return ((T (*)(ArenaAllRatioTablesRequest*, uintptr_t))(Il2CppBase() + 0x1A14F30))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaAllRatioTablesRequest*, uintptr_t))(Il2CppBase() + 0x1A14F38))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaAllRatioTablesRequest*, uintptr_t))(Il2CppBase() + 0x1A14FCC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaAllRatioTablesRequest*, uintptr_t))(Il2CppBase() + 0x1A15160))(this, other);
	}
