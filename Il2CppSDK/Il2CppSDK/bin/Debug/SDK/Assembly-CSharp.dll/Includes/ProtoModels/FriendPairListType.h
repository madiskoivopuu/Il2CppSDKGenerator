...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::FriendPairListType*>*& _parser() {
		return *(MessageParser1ProtoModels::FriendPairListType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& FriendsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::FriendPairType*>*& _repeated_friends_codec() {
		return *(FieldCodec1ProtoModels::FriendPairType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::FriendPairType*>*& friends_() {
		return *(RepeatedField1ProtoModels::FriendPairType*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::FriendPairListType*>* get_Parser() {
		return ((MessageParser1ProtoModels::FriendPairListType*>* (*)(void *))(Il2CppBase() + 0x15FD08C))(0);
	}
	...
	template <typename R = ProtoModels::FriendPairListType*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::FriendPairType*>* get_Friends() {
		return ((RepeatedField1ProtoModels::FriendPairType*>* (*)(FriendPairListType*))(Il2CppBase() + 0x15FD3C4))(this);
	}
