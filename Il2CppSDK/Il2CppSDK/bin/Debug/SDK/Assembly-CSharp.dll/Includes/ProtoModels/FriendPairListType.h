...
public: 
	...
	template <typename T = void*> static T& _repeated_friends_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& friends_() {
	...
	template <typename T = void*> T get_Friends() {
		return ((T (*)(FriendPairListType*))(Il2CppBase() + 0x15FD3C4))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(FriendPairListType*, uintptr_t))(Il2CppBase() + 0x15FD3CC))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(FriendPairListType*, uintptr_t))(Il2CppBase() + 0x15FD43C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(FriendPairListType*, uintptr_t))(Il2CppBase() + 0x15FD688))(this, other);
	}
