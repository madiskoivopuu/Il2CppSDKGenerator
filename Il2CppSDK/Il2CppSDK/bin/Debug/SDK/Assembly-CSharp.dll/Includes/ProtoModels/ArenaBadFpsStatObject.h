...
public: 
	...
	template <typename T = MessageParser1ArenaBadFpsStatObject*>*> static T& _parser() {
	...
	template <typename T = BadFpsStatsEnum*> T& infoType_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1ArenaBadFpsStatObject*>*> static T get_Parser() {
	...
	template <typename T = ArenaBadFpsStatObject*> T Clone() {
	...
	template <typename T = BadFpsStatsEnum*> T get_InfoType() {
		return ((T (*)(ArenaBadFpsStatObject*))(Il2CppBase() + 0x1A17574))(this);
	}
	template <typename T = void> T set_InfoType(BadFpsStatsEnum* value) {
		return ((T (*)(ArenaBadFpsStatObject*, BadFpsStatsEnum*))(Il2CppBase() + 0x1A1757C))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaBadFpsStatObject*, Il2CppObject*))(Il2CppBase() + 0x1A17584))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaBadFpsStatObject* other) {
		return ((T (*)(ArenaBadFpsStatObject*, ArenaBadFpsStatObject*))(Il2CppBase() + 0x1A175F4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaBadFpsStatObject* other) {
		return ((T (*)(ArenaBadFpsStatObject*, ArenaBadFpsStatObject*))(Il2CppBase() + 0x1A179AC))(this, other);
	}
