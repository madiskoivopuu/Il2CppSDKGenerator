...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBadFpsStatObject*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaBadFpsStatObject*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::BadFpsStatsEnum> R& infoType_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBadFpsStatObject*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaBadFpsStatObject*>* (*)(void *))(Il2CppBase() + 0x1A171E4))(0);
	}
