...
public: 
	...
	template <typename T = MessageParser1DisbandGuildResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1DisbandGuildResponse*>*> static T get_Parser() {
	...
	template <typename T = DisbandGuildResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(DisbandGuildResponse*, Il2CppObject*))(Il2CppBase() + 0x1301C94))(this, other);
	}
	template <typename T = bool> T Equals_1(DisbandGuildResponse* other) {
		return ((T (*)(DisbandGuildResponse*, DisbandGuildResponse*))(Il2CppBase() + 0x1301D04))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(DisbandGuildResponse* other) {
		return ((T (*)(DisbandGuildResponse*, DisbandGuildResponse*))(Il2CppBase() + 0x1302024))(this, other);
	}
