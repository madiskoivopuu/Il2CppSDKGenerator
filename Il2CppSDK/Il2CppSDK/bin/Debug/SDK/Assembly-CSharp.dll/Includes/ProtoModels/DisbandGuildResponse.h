...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::DisbandGuildResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::DisbandGuildResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& PlayersFieldNumber() {
	 ...
	 RepeatedField1<ProtoModels::Player*>*& players_() {
		return *(RepeatedField1<ProtoModels::Player*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = int32_t> R& code_() {
	 ...
	 static MessageParser1<ProtoModels::DisbandGuildResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::DisbandGuildResponse*>* (*)(void *))(Il2CppBase() + 0x1301938))(0);
	}
	...
	template <typename R = ProtoModels::DisbandGuildResponse*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::Player*>* get_Players() {
		return ((RepeatedField1<ProtoModels::Player*>* (*)(DisbandGuildResponse*))(Il2CppBase() + 0x1301C7C))(this);
	}
