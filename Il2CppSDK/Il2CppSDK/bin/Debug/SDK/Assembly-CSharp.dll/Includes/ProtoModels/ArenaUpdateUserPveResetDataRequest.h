...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaUpdateUserPveResetDataRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaUpdateUserPveResetDataRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& price_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaUpdateUserPveResetDataRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaUpdateUserPveResetDataRequest*>* (*)(void *))(Il2CppBase() + 0xF56528))(0);
	}
