...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaIncompletePurchaseHistory*, uintptr_t))(Il2CppBase() + 0x1E2A750))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaIncompletePurchaseHistory*, uintptr_t))(Il2CppBase() + 0x1E2A7C0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaIncompletePurchaseHistory*, uintptr_t))(Il2CppBase() + 0x1E2AA5C))(this, other);
	}
