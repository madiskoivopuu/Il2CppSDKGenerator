...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaIncompletePurchaseHistory*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaIncompletePurchaseHistory*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& productID_() {
	 ...
	 static MessageParser1ProtoModels::ArenaIncompletePurchaseHistory*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaIncompletePurchaseHistory*>* (*)(void *))(Il2CppBase() + 0x1E2A354))(0);
	}
