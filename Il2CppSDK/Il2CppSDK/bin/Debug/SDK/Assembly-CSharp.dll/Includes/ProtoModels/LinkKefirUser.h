...
public: 
	...
	template <typename T = MessageParser1LinkKefirUser*>*> static T& _parser() {
	...
	template <typename T = MessageParser1LinkKefirUser*>*> static T get_Parser() {
	...
	template <typename T = LinkKefirUser*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(LinkKefirUser*, Il2CppObject*))(Il2CppBase() + 0x142E58C))(this, other);
	}
	template <typename T = bool> T Equals_1(LinkKefirUser* other) {
		return ((T (*)(LinkKefirUser*, LinkKefirUser*))(Il2CppBase() + 0x142E5FC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(LinkKefirUser* other) {
		return ((T (*)(LinkKefirUser*, LinkKefirUser*))(Il2CppBase() + 0x142EA60))(this, other);
	}
