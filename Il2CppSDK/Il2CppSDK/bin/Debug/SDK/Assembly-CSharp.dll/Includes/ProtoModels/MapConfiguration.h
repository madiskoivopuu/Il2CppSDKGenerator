...
public: 
	...
	template <typename T = void*> static T& _map_mapSlots_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& mapSlots_() {
		return *(T*)((uintptr_t)this + 0x10);
	}
	template <typename T = int32_t> static T& LocationsJsonsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _map_locationsJsons_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& locationsJsons_() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = int32_t> static T& EnemyMapSlotsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_enemyMapSlots_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> T& enemyMapSlots_() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = int32_t> static T& EnemySpectreMapSlotsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_enemySpectreMapSlots_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	template <typename T = void*> T& enemySpectreMapSlots_() {
	...
	template <typename T = void*> T get_MapSlots() {
		return ((T (*)(MapConfiguration*))(Il2CppBase() + 0x126B6D0))(this);
	}
	template <typename T = void*> T get_LocationsJsons() {
		return ((T (*)(MapConfiguration*))(Il2CppBase() + 0x126B6D8))(this);
	}
	template <typename T = void*> T get_EnemyMapSlots() {
		return ((T (*)(MapConfiguration*))(Il2CppBase() + 0x126B6E0))(this);
	}
	template <typename T = void*> T get_EnemySpectreMapSlots() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(MapConfiguration*, uintptr_t))(Il2CppBase() + 0x126B710))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(MapConfiguration*, uintptr_t))(Il2CppBase() + 0x126B780))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(MapConfiguration*, uintptr_t))(Il2CppBase() + 0x126BD00))(this, other);
	}
