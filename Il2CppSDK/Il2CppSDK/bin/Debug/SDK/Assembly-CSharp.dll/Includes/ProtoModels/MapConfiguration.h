...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::MapConfiguration*>*& _parser() {
		return *(MessageParser1<ProtoModels::MapConfiguration*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& MapSlotsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codec<int64_t, Il2CppString*>*& _map_mapSlots_codec() {
		return *(Codec<int64_t, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2<int64_t, Il2CppString*>*& mapSlots_() {
		return *(MapField2<int64_t, Il2CppString*>**)((uintptr_t)this + 0x10);
	}
	template <typename R = int32_t> static R& LocationsJsonsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codec<int64_t, Il2CppString*>*& _map_locationsJsons_codec() {
		return *(Codec<int64_t, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 MapField2<int64_t, Il2CppString*>*& locationsJsons_() {
		return *(MapField2<int64_t, Il2CppString*>**)((uintptr_t)this + 0x18);
	}
	template <typename R = int32_t> static R& EnemyMapSlotsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<int64_t>*& _repeated_enemyMapSlots_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1<int64_t>*& enemyMapSlots_() {
		return *(RepeatedField1<int64_t>**)((uintptr_t)this + 0x20);
	}
	template <typename R = int32_t> static R& EnemySpectreMapSlotsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<int64_t>*& _repeated_enemySpectreMapSlots_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1<int64_t>*& enemySpectreMapSlots_() {
		return *(RepeatedField1<int64_t>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = int64_t> R& tutorEnemyMapSlot_() {
	 ...
	 static MessageParser1<ProtoModels::MapConfiguration*>* get_Parser() {
		return ((MessageParser1<ProtoModels::MapConfiguration*>* (*)(void *))(Il2CppBase() + 0x126B274))(0);
	}
	...
	template <typename R = ProtoModels::MapConfiguration*> R Clone() {
	 ...
	 MapField2<int64_t, Il2CppString*>* get_MapSlots() {
		return ((MapField2<int64_t, Il2CppString*>* (*)(MapConfiguration*))(Il2CppBase() + 0x126B6D0))(this);
	}
	 MapField2<int64_t, Il2CppString*>* get_LocationsJsons() {
		return ((MapField2<int64_t, Il2CppString*>* (*)(MapConfiguration*))(Il2CppBase() + 0x126B6D8))(this);
	}
	 RepeatedField1<int64_t>* get_EnemyMapSlots() {
		return ((RepeatedField1<int64_t>* (*)(MapConfiguration*))(Il2CppBase() + 0x126B6E0))(this);
	}
	 RepeatedField1<int64_t>* get_EnemySpectreMapSlots() {
		return ((RepeatedField1<int64_t>* (*)(MapConfiguration*))(Il2CppBase() + 0x126B6E8))(this);
	}
