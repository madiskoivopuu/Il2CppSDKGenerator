...
public: 
	...
	template <typename T = MessageParser1ArenaStore*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& ProductsFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = FieldCodec1ArenaStoreProduct*>*> static T& _repeated_products_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1ArenaStoreProduct*>*> T& products_() {
	...
	template <typename T = MessageParser1ArenaStore*>*> static T get_Parser() {
	...
	template <typename T = ArenaStore*> T Clone() {
		return ((T (*)(ArenaStore*))(Il2CppBase() + 0x27173E4))(this);
	}
	template <typename T = RepeatedField1ArenaStoreProduct*>*> T get_Products() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaStore*, Il2CppObject*))(Il2CppBase() + 0x271745C))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaStore* other) {
		return ((T (*)(ArenaStore*, ArenaStore*))(Il2CppBase() + 0x27174CC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaStore* other) {
		return ((T (*)(ArenaStore*, ArenaStore*))(Il2CppBase() + 0x27177BC))(this, other);
	}
