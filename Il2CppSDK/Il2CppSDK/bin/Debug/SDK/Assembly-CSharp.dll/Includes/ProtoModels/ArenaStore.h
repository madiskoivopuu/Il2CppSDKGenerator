...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaStore*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaStore*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ProductsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::ArenaStoreProduct*>*& _repeated_products_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ArenaStoreProduct*>*& products_() {
		return *(RepeatedField1ProtoModels::ArenaStoreProduct*>**)((uintptr_t)this + 0x10);
	}
	...
	template <typename R = bool> R& vipEnabled_() {
	 ...
	 static MessageParser1ProtoModels::ArenaStore*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaStore*>* (*)(void *))(Il2CppBase() + 0x27170FC))(0);
	}
	...
	template <typename R = ProtoModels::ArenaStore*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::ArenaStoreProduct*>* get_Products() {
		return ((RepeatedField1ProtoModels::ArenaStoreProduct*>* (*)(ArenaStore*))(Il2CppBase() + 0x2717440))(this);
	}
