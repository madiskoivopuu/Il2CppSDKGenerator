...
public: 
	...
	template <typename T = MessageParser1ArenaUpdateIconUserRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUpdateIconUserRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUpdateIconUserRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUpdateIconUserRequest*, Il2CppObject*))(Il2CppBase() + 0xF54034))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUpdateIconUserRequest* other) {
		return ((T (*)(ArenaUpdateIconUserRequest*, ArenaUpdateIconUserRequest*))(Il2CppBase() + 0xF540A4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUpdateIconUserRequest* other) {
		return ((T (*)(ArenaUpdateIconUserRequest*, ArenaUpdateIconUserRequest*))(Il2CppBase() + 0xF543C4))(this, other);
	}
