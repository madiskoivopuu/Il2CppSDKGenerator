...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ChatMessageParam*>*& _parser() {
		return *(MessageParser1<ProtoModels::ChatMessageParam*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ParametersFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_parameters_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<Il2CppString*>*& parameters_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::ChatMessageParam*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ChatMessageParam*>* (*)(void *))(Il2CppBase() + 0x140394C))(0);
	}
	...
	template <typename R = void> R set_ParamType(ProtoModels::ChatMessageParamType value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_Parameters() {
		return ((RepeatedField1<Il2CppString*>* (*)(ChatMessageParam*))(Il2CppBase() + 0x1403D5C))(this);
	}
