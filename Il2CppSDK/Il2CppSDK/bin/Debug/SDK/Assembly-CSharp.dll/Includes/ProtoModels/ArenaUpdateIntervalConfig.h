...
public: 
	...
	template <typename T = MessageParser1ArenaUpdateIntervalConfig*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUpdateIntervalConfig*>*> static T get_Parser() {
	...
	template <typename T = ArenaUpdateIntervalConfig*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUpdateIntervalConfig*, Il2CppObject*))(Il2CppBase() + 0xF548BC))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUpdateIntervalConfig* other) {
		return ((T (*)(ArenaUpdateIntervalConfig*, ArenaUpdateIntervalConfig*))(Il2CppBase() + 0xF5492C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUpdateIntervalConfig* other) {
		return ((T (*)(ArenaUpdateIntervalConfig*, ArenaUpdateIntervalConfig*))(Il2CppBase() + 0xF54C8C))(this, other);
	}
