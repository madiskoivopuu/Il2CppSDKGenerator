...
public: 
	...
	template <typename T = MessageParser1UserPutRequisiteResponse*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserPutRequisiteResponse*>*> static T get_Parser() {
	...
	template <typename T = UserPutRequisiteResponse*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserPutRequisiteResponse*, Il2CppObject*))(Il2CppBase() + 0x24755E8))(this, other);
	}
	template <typename T = bool> T Equals_1(UserPutRequisiteResponse* other) {
		return ((T (*)(UserPutRequisiteResponse*, UserPutRequisiteResponse*))(Il2CppBase() + 0x2475658))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserPutRequisiteResponse* other) {
		return ((T (*)(UserPutRequisiteResponse*, UserPutRequisiteResponse*))(Il2CppBase() + 0x2475970))(this, other);
	}
