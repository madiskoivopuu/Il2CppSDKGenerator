...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserPutRequisiteResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserPutRequisiteResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& codeMessage_() {
	 ...
	 static MessageParser1<ProtoModels::UserPutRequisiteResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserPutRequisiteResponse*>* (*)(void *))(Il2CppBase() + 0x2475264))(0);
	}
