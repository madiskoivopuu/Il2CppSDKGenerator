...
public: 
	...
	template <typename T = uintptr_t> T& conflictClan_() {
	...
	template <typename T = uintptr_t> T get_ConflictClan() {
		return ((T (*)(UserGoogleLinkResponse*))(Il2CppBase() + 0x246BE7C))(this);
	}
	template <typename T = void> T set_ConflictClan(uintptr_t value) {
		return ((T (*)(UserGoogleLinkResponse*, uintptr_t))(Il2CppBase() + 0x246BE84))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserGoogleLinkResponse*, uintptr_t))(Il2CppBase() + 0x246BE9C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserGoogleLinkResponse*, uintptr_t))(Il2CppBase() + 0x246BF0C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserGoogleLinkResponse*, uintptr_t))(Il2CppBase() + 0x246C2C4))(this, other);
	}
