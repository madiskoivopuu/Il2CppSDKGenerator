...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserGoogleLinkResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserGoogleLinkResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& conflictUserID_() {
	 ...
	 static MessageParser1<ProtoModels::UserGoogleLinkResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserGoogleLinkResponse*>* (*)(void *))(Il2CppBase() + 0x246BADC))(0);
	}
