...
public: 
	...
	template <typename T = MessageParser1ArenaKillWorldRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaKillWorldRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaKillWorldRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaKillWorldRequest*, Il2CppObject*))(Il2CppBase() + 0x1E2B674))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaKillWorldRequest* other) {
		return ((T (*)(ArenaKillWorldRequest*, ArenaKillWorldRequest*))(Il2CppBase() + 0x1E2B71C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaKillWorldRequest* other) {
		return ((T (*)(ArenaKillWorldRequest*, ArenaKillWorldRequest*))(Il2CppBase() + 0x1E2B950))(this, other);
	}
