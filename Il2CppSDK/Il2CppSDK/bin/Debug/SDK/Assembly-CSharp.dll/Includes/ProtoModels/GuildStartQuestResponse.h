...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::GuildStartQuestResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::GuildStartQuestResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::GuildQuestArena*> R& activeQuest_() {
	 ...
	 static MessageParser1ProtoModels::GuildStartQuestResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::GuildStartQuestResponse*>* (*)(void *))(Il2CppBase() + 0x19448DC))(0);
	}
