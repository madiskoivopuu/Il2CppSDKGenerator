...
public: 
	...
	template <typename T = MessageParser1GuildStartQuestResponse*>*> static T& _parser() {
	...
	template <typename T = GuildQuestArena*> T& activeQuest_() {
		return *(T*)((uintptr_t)this + 0x28);
	}

	template <typename T = MessageParser1GuildStartQuestResponse*>*> static T get_Parser() {
	...
	template <typename T = GuildStartQuestResponse*> T Clone() {
	...
	template <typename T = GuildQuestArena*> T get_ActiveQuest() {
		return ((T (*)(GuildStartQuestResponse*))(Il2CppBase() + 0x1944C84))(this);
	}
	template <typename T = void> T set_ActiveQuest(GuildQuestArena* value) {
		return ((T (*)(GuildStartQuestResponse*, GuildQuestArena*))(Il2CppBase() + 0x1944C8C))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildStartQuestResponse*, Il2CppObject*))(Il2CppBase() + 0x1944C94))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildStartQuestResponse* other) {
		return ((T (*)(GuildStartQuestResponse*, GuildStartQuestResponse*))(Il2CppBase() + 0x1944D04))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildStartQuestResponse* other) {
		return ((T (*)(GuildStartQuestResponse*, GuildStartQuestResponse*))(Il2CppBase() + 0x19450BC))(this, other);
	}
