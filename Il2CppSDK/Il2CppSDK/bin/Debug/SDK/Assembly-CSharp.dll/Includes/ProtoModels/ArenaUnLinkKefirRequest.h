...
public: 
	...
	template <typename T = MessageParser1ArenaUnLinkKefirRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUnLinkKefirRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUnLinkKefirRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUnLinkKefirRequest*, Il2CppObject*))(Il2CppBase() + 0xF46ABC))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUnLinkKefirRequest* other) {
		return ((T (*)(ArenaUnLinkKefirRequest*, ArenaUnLinkKefirRequest*))(Il2CppBase() + 0xF46B58))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUnLinkKefirRequest* other) {
		return ((T (*)(ArenaUnLinkKefirRequest*, ArenaUnLinkKefirRequest*))(Il2CppBase() + 0xF46DA0))(this, other);
	}
