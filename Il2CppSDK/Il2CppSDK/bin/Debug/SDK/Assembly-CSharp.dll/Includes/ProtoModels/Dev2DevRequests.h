...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::Dev2DevRequests*>*& _parser() {
		return *(MessageParser1ProtoModels::Dev2DevRequests*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& RequestsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::Dev2DevRequest*>*& _repeated_requests_codec() {
		return *(FieldCodec1ProtoModels::Dev2DevRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::Dev2DevRequest*>*& requests_() {
		return *(RepeatedField1ProtoModels::Dev2DevRequest*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::Dev2DevRequests*>* get_Parser() {
		return ((MessageParser1ProtoModels::Dev2DevRequests*>* (*)(void *))(Il2CppBase() + 0xEC0C44))(0);
	}
	...
	template <typename R = ProtoModels::Dev2DevRequests*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::Dev2DevRequest*>* get_Requests() {
		return ((RepeatedField1ProtoModels::Dev2DevRequest*>* (*)(Dev2DevRequests*))(Il2CppBase() + 0xEC0F7C))(this);
	}
