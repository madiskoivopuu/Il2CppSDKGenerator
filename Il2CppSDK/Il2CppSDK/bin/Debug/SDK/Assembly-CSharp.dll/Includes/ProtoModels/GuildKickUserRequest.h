...
public: 
	...
	template <typename T = MessageParser1GuildKickUserRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildKickUserRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildKickUserRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildKickUserRequest*, Il2CppObject*))(Il2CppBase() + 0x1B34024))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildKickUserRequest* other) {
		return ((T (*)(GuildKickUserRequest*, GuildKickUserRequest*))(Il2CppBase() + 0x1B340D0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildKickUserRequest* other) {
		return ((T (*)(GuildKickUserRequest*, GuildKickUserRequest*))(Il2CppBase() + 0x1B343B4))(this, other);
	}
