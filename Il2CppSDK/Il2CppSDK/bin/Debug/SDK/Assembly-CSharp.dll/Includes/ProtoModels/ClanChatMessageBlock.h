...
public: 
	...
	template <typename T = void*> static T& _repeated_param_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& param_() {
	...
	template <typename T = void*> T get_Param() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ClanChatMessageBlock*, uintptr_t))(Il2CppBase() + 0x174B9D8))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ClanChatMessageBlock*, uintptr_t))(Il2CppBase() + 0x174BA48))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ClanChatMessageBlock*, uintptr_t))(Il2CppBase() + 0x174C074))(this, other);
	}
