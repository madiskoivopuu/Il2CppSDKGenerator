...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ClanChatMessageBlock*>*& _parser() {
		return *(MessageParser1<ProtoModels::ClanChatMessageBlock*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ParamFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ChatMessageParam*>*& _repeated_param_codec() {
		return *(FieldCodec1<ProtoModels::ChatMessageParam*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ChatMessageParam*>*& param_() {
		return *(RepeatedField1<ProtoModels::ChatMessageParam*>**)((uintptr_t)this + 0x38);
	}
	...
	template <typename R = bool> R& sendNotification_() {
	 ...
	 static MessageParser1<ProtoModels::ClanChatMessageBlock*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ClanChatMessageBlock*>* (*)(void *))(Il2CppBase() + 0x174B4CC))(0);
	}
	...
	template <typename R = void> R set_ClanID(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::ChatMessageParam*>* get_Param() {
		return ((RepeatedField1<ProtoModels::ChatMessageParam*>* (*)(ClanChatMessageBlock*))(Il2CppBase() + 0x174B9BC))(this);
	}
