...
public: 
	...
	template <typename T = MessageParser1ArenaChestLootedRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaChestLootedRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaChestLootedRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaChestLootedRequest*, Il2CppObject*))(Il2CppBase() + 0x1A1B3F0))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaChestLootedRequest* other) {
		return ((T (*)(ArenaChestLootedRequest*, ArenaChestLootedRequest*))(Il2CppBase() + 0x1A1B460))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaChestLootedRequest* other) {
		return ((T (*)(ArenaChestLootedRequest*, ArenaChestLootedRequest*))(Il2CppBase() + 0x1A1B818))(this, other);
	}
