...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaUserResetPurchasedProduct*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaUserResetPurchasedProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ProductIDsFieldNumber() {
	 ...
	 static FieldCodec1int64_t>*& _repeated_productIDs_codec() {
		return *(FieldCodec1int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1int64_t>*& productIDs_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1ProtoModels::ArenaUserResetPurchasedProduct*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaUserResetPurchasedProduct*>* (*)(void *))(Il2CppBase() + 0x2864CC4))(0);
	}
	...
	template <typename R = void> R set_UserID(int64_t value) {
	 ...
	 RepeatedField1int64_t>* get_ProductIDs() {
		return ((RepeatedField1int64_t>* (*)(ArenaUserResetPurchasedProduct*))(Il2CppBase() + 0x286502C))(this);
	}
