...
public: 
	...
	template <typename T = void*> static T& _repeated_productIDs_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& productIDs_() {
	...
	template <typename T = void*> T get_ProductIDs() {
		return ((T (*)(ArenaUserResetPurchasedProduct*))(Il2CppBase() + 0x286502C))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserResetPurchasedProduct*, uintptr_t))(Il2CppBase() + 0x2865034))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserResetPurchasedProduct*, uintptr_t))(Il2CppBase() + 0x28650A4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserResetPurchasedProduct*, uintptr_t))(Il2CppBase() + 0x2865458))(this, other);
	}
