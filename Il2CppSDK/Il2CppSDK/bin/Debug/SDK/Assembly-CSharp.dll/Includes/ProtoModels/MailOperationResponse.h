...
public: 
	...
	template <typename T = uintptr_t> T& mail_() {
	...
	template <typename T = void> T set_Mail(uintptr_t value) {
		return ((T (*)(MailOperationResponse*, uintptr_t))(Il2CppBase() + 0x125EE30))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(MailOperationResponse*, uintptr_t))(Il2CppBase() + 0x125EE48))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(MailOperationResponse*, uintptr_t))(Il2CppBase() + 0x125EEB8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(MailOperationResponse*, uintptr_t))(Il2CppBase() + 0x125F270))(this, other);
	}
