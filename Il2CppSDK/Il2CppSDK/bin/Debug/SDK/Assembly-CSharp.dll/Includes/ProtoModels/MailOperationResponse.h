...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::MailOperationResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::MailOperationResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& mailID_() {
	 ...
	 static MessageParser1ProtoModels::MailOperationResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::MailOperationResponse*>* (*)(void *))(Il2CppBase() + 0x125EA88))(0);
	}
