...
public: 
	...
	template <typename T = MessageParser1SubstructMailRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1SubstructMailRequest*>*> static T get_Parser() {
	...
	template <typename T = SubstructMailRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(SubstructMailRequest*, Il2CppObject*))(Il2CppBase() + 0x16A1508))(this, other);
	}
	template <typename T = bool> T Equals_1(SubstructMailRequest* other) {
		return ((T (*)(SubstructMailRequest*, SubstructMailRequest*))(Il2CppBase() + 0x16A15B4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(SubstructMailRequest* other) {
		return ((T (*)(SubstructMailRequest*, SubstructMailRequest*))(Il2CppBase() + 0x16A1898))(this, other);
	}
