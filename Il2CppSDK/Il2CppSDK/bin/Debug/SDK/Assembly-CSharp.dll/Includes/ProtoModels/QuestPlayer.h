...
public: 
	...
	template <typename T = MessageParser1QuestPlayer*>*> static T& _parser() {
	...
	template <typename T = MessageParser1QuestPlayer*>*> static T get_Parser() {
	...
	template <typename T = QuestPlayer*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(QuestPlayer*, Il2CppObject*))(Il2CppBase() + 0x1C3A100))(this, other);
	}
	template <typename T = bool> T Equals_1(QuestPlayer* other) {
		return ((T (*)(QuestPlayer*, QuestPlayer*))(Il2CppBase() + 0x1C3A170))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(QuestPlayer* other) {
		return ((T (*)(QuestPlayer*, QuestPlayer*))(Il2CppBase() + 0x1C3A5BC))(this, other);
	}
