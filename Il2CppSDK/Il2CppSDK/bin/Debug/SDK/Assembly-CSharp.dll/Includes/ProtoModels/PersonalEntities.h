...
public: 
	...
	template <typename T = void*> static T& _map_entities_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& entities_() {
	...
	template <typename T = void*> T get_Entities() {
		return ((T (*)(PersonalEntities*))(Il2CppBase() + 0x11EA85C))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PersonalEntities*, uintptr_t))(Il2CppBase() + 0x11EA864))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PersonalEntities*, uintptr_t))(Il2CppBase() + 0x11EA8D4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PersonalEntities*, uintptr_t))(Il2CppBase() + 0x11EAB20))(this, other);
	}
