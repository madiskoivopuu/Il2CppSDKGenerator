...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaVipLevel*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaVipLevel*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& VipBonusesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaVipBonus*>*& _repeated_vipBonuses_codec() {
		return *(FieldCodec1ProtoModels::ArenaVipBonus*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ArenaVipBonus*>*& vipBonuses_() {
		return *(RepeatedField1ProtoModels::ArenaVipBonus*>**)((uintptr_t)this + 0x20);
	}
	...
	template <typename R = Il2CppString*> R& linkToProductName_() {
	 ...
	 static MessageParser1ProtoModels::ArenaVipLevel*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaVipLevel*>* (*)(void *))(Il2CppBase() + 0x28674F8))(0);
	}
	...
	template <typename R = void> R set_VipPoints(int32_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaVipBonus*>* get_VipBonuses() {
		return ((RepeatedField1ProtoModels::ArenaVipBonus*>* (*)(ArenaVipLevel*))(Il2CppBase() + 0x28678AC))(this);
	}
