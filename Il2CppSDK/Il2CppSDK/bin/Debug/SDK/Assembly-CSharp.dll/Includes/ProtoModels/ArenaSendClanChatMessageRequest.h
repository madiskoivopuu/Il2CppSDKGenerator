...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaSendClanChatMessageRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaSendClanChatMessageRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ParamsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ChatMessageParam*>*& _repeated_params_codec() {
		return *(FieldCodec1ProtoModels::ChatMessageParam*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ChatMessageParam*>*& params_() {
		return *(RepeatedField1ProtoModels::ChatMessageParam*>**)((uintptr_t)this + 0x30);
	}
	...
	template <typename R = bool> R& sendNotification_() {
	 ...
	 static MessageParser1ProtoModels::ArenaSendClanChatMessageRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaSendClanChatMessageRequest*>* (*)(void *))(Il2CppBase() + 0x27117A8))(0);
	}
	...
	template <typename R = void> R set_Message(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::ChatMessageParam*>* get_Params() {
		return ((RepeatedField1ProtoModels::ChatMessageParam*>* (*)(ArenaSendClanChatMessageRequest*))(Il2CppBase() + 0x2711BF0))(this);
	}
