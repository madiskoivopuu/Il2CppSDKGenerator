...
public: 
	...
	template <typename T = void*> static T& _repeated_params_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& params_() {
	...
	template <typename T = void*> T get_Params() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaSendClanChatMessageRequest*, uintptr_t))(Il2CppBase() + 0x2711C0C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaSendClanChatMessageRequest*, uintptr_t))(Il2CppBase() + 0x2711C7C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaSendClanChatMessageRequest*, uintptr_t))(Il2CppBase() + 0x27121FC))(this, other);
	}
