...
public: 
	...
	template <typename T = MessageParser1UserGetPeopleWorldsRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserGetPeopleWorldsRequest*>*> static T get_Parser() {
	...
	template <typename T = UserGetPeopleWorldsRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserGetPeopleWorldsRequest*, Il2CppObject*))(Il2CppBase() + 0x2469E14))(this, other);
	}
	template <typename T = bool> T Equals_1(UserGetPeopleWorldsRequest* other) {
		return ((T (*)(UserGetPeopleWorldsRequest*, UserGetPeopleWorldsRequest*))(Il2CppBase() + 0x2469EA0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserGetPeopleWorldsRequest* other) {
		return ((T (*)(UserGetPeopleWorldsRequest*, UserGetPeopleWorldsRequest*))(Il2CppBase() + 0x246A048))(this, other);
	}
