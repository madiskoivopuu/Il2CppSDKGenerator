...
public: 
	...
	template <typename T = void*> static T& _repeated_availableProduct_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& availableProduct_() {
	...
	template <typename T = uintptr_t> T& purchaceError_() {
	...
	template <typename T = void> T set_Currencies(uintptr_t value) {
		return ((T (*)(ArenaUserPurchaseResponse*, uintptr_t))(Il2CppBase() + 0x286389C))(this, value);
	}
	template <typename T = void*> T get_Mails() {
		return ((T (*)(ArenaUserPurchaseResponse*))(Il2CppBase() + 0x28638A4))(this);
	}
	template <typename T = void*> T get_AvailableProduct() {
	...
	template <typename T = void> T set_PurchaceError(uintptr_t value) {
		return ((T (*)(ArenaUserPurchaseResponse*, uintptr_t))(Il2CppBase() + 0x28639DC))(this, value);
	}
	...
	template <typename T = void> T set_Vip(uintptr_t value) {
		return ((T (*)(ArenaUserPurchaseResponse*, uintptr_t))(Il2CppBase() + 0x2863A20))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserPurchaseResponse*, uintptr_t))(Il2CppBase() + 0x2863A48))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserPurchaseResponse*, uintptr_t))(Il2CppBase() + 0x2863AB8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserPurchaseResponse*, uintptr_t))(Il2CppBase() + 0x2864518))(this, other);
	}
