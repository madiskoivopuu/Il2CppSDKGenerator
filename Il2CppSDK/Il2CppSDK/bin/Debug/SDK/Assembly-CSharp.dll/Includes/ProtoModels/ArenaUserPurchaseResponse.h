...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaUserPurchaseResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaUserPurchaseResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& MailsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::Mail*>*& _repeated_mails_codec() {
		return *(FieldCodec1ProtoModels::Mail*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::Mail*>*& mails_() {
		return *(RepeatedField1ProtoModels::Mail*>**)((uintptr_t)this + 0x20);
	}
	template <typename R = int32_t> static R& AvailableProductFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::ArenaUserAvailableProduct*>*& _repeated_availableProduct_codec() {
		return *(FieldCodec1ProtoModels::ArenaUserAvailableProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1ProtoModels::ArenaUserAvailableProduct*>*& availableProduct_() {
		return *(RepeatedField1ProtoModels::ArenaUserAvailableProduct*>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = int32_t> R& saviorPoints_() {
	 ...
	 static MessageParser1ProtoModels::ArenaUserPurchaseResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaUserPurchaseResponse*>* (*)(void *))(Il2CppBase() + 0x28633E0))(0);
	}
	...
	template <typename R = void> R set_Currencies(ProtoModels::Currencies* value) {
	 ...
	 RepeatedField1ProtoModels::Mail*>* get_Mails() {
		return ((RepeatedField1ProtoModels::Mail*>* (*)(ArenaUserPurchaseResponse*))(Il2CppBase() + 0x28638A4))(this);
	}
	 RepeatedField1ProtoModels::ArenaUserAvailableProduct*>* get_AvailableProduct() {
		return ((RepeatedField1ProtoModels::ArenaUserAvailableProduct*>* (*)(ArenaUserPurchaseResponse*))(Il2CppBase() + 0x28638AC))(this);
	}
