...
public: 
	...
	template <typename T = MessageParser1UserRegionRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserRegionRequest*>*> static T get_Parser() {
	...
	template <typename T = UserRegionRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserRegionRequest*, Il2CppObject*))(Il2CppBase() + 0x2476020))(this, other);
	}
	template <typename T = bool> T Equals_1(UserRegionRequest* other) {
		return ((T (*)(UserRegionRequest*, UserRegionRequest*))(Il2CppBase() + 0x2476090))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserRegionRequest* other) {
		return ((T (*)(UserRegionRequest*, UserRegionRequest*))(Il2CppBase() + 0x24763E0))(this, other);
	}
