...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaTourneys*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaTourneys*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& TourneysFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1<ProtoModels::Tourney*>*& _repeated_tourneys_codec() {
		return *(FieldCodec1<ProtoModels::Tourney*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::Tourney*>*& tourneys_() {
		return *(RepeatedField1<ProtoModels::Tourney*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1<ProtoModels::ArenaTourneys*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaTourneys*>* (*)(void *))(Il2CppBase() + 0xF45E3C))(0);
	}
	...
	template <typename R = ProtoModels::ArenaTourneys*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::Tourney*>* get_Tourneys() {
		return ((RepeatedField1<ProtoModels::Tourney*>* (*)(ArenaTourneys*))(Il2CppBase() + 0xF46174))(this);
	}
