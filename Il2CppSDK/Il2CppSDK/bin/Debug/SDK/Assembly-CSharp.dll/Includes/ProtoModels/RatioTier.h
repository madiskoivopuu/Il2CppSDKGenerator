...
public: 
	...
	template <typename T = MessageParser1RatioTier*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1RatioBonus*>*> static T& _repeated_bonuses_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1RatioBonus*>*> T& bonuses_() {
	...
	template <typename T = MessageParser1RatioTier*>*> static T get_Parser() {
	...
	template <typename T = RatioTier*> T Clone() {
	...
	template <typename T = RepeatedField1RatioBonus*>*> T get_Bonuses() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(RatioTier*, Il2CppObject*))(Il2CppBase() + 0x138E0A8))(this, other);
	}
	template <typename T = bool> T Equals_1(RatioTier* other) {
		return ((T (*)(RatioTier*, RatioTier*))(Il2CppBase() + 0x138E118))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(RatioTier* other) {
		return ((T (*)(RatioTier*, RatioTier*))(Il2CppBase() + 0x138E594))(this, other);
	}
