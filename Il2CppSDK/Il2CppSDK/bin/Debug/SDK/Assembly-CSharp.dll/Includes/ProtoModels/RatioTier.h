...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::RatioTier*>*& _parser() {
		return *(MessageParser1<ProtoModels::RatioTier*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& BonusesFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::RatioBonus*>*& _repeated_bonuses_codec() {
		return *(FieldCodec1<ProtoModels::RatioBonus*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::RatioBonus*>*& bonuses_() {
		return *(RepeatedField1<ProtoModels::RatioBonus*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = Il2CppString*> R& iconName_() {
	 ...
	 static MessageParser1<ProtoModels::RatioTier*>* get_Parser() {
		return ((MessageParser1<ProtoModels::RatioTier*>* (*)(void *))(Il2CppBase() + 0x138DC7C))(0);
	}
	...
	template <typename R = void> R set_MaxPosition(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::RatioBonus*>* get_Bonuses() {
		return ((RepeatedField1<ProtoModels::RatioBonus*>* (*)(RatioTier*))(Il2CppBase() + 0x138E018))(this);
	}
