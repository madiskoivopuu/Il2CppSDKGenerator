...
public: 
	...
	template <typename T = MessageParser1PurchaseInfoType*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1PurchaseItemType*>*> static T& _repeated_items_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1PurchaseItemType*>*> T& items_() {
	...
	template <typename T = CurrencyOperation*> T& operation_() {
	...
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_reasons_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& reasons_() {
	...
	template <typename T = MessageParser1PurchaseInfoType*>*> static T get_Parser() {
	...
	template <typename T = PurchaseInfoType*> T Clone() {
	...
	template <typename T = RepeatedField1PurchaseItemType*>*> T get_Items() {
	...
	template <typename T = void> T set_Shop(PurchaseProvider* value) {
		return ((T (*)(PurchaseInfoType*, PurchaseProvider*))(Il2CppBase() + 0x11B82F4))(this, value);
	}
	...
	template <typename T = void> T set_CurrencyType(CurrencyTypeEnum* value) {
		return ((T (*)(PurchaseInfoType*, CurrencyTypeEnum*))(Il2CppBase() + 0x11B8304))(this, value);
	}
	...
	template <typename T = CurrencyOperation*> T get_Operation() {
		return ((T (*)(PurchaseInfoType*))(Il2CppBase() + 0x11B831C))(this);
	}
	template <typename T = void> T set_Operation(CurrencyOperation* value) {
		return ((T (*)(PurchaseInfoType*, CurrencyOperation*))(Il2CppBase() + 0x11B8324))(this, value);
	}
	...
	template <typename T = RepeatedField1Il2CppString*>*> T get_Reasons() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(PurchaseInfoType*, Il2CppObject*))(Il2CppBase() + 0x11B8378))(this, other);
	}
	template <typename T = bool> T Equals_1(PurchaseInfoType* other) {
		return ((T (*)(PurchaseInfoType*, PurchaseInfoType*))(Il2CppBase() + 0x11B83E8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(PurchaseInfoType* other) {
		return ((T (*)(PurchaseInfoType*, PurchaseInfoType*))(Il2CppBase() + 0x11B8DE8))(this, other);
	}
