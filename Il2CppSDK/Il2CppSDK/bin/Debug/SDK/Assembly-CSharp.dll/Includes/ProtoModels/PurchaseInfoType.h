...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::PurchaseInfoType*>*& _parser() {
		return *(MessageParser1ProtoModels::PurchaseInfoType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ItemsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::PurchaseItemType*>*& _repeated_items_codec() {
		return *(FieldCodec1ProtoModels::PurchaseItemType*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::PurchaseItemType*>*& items_() {
		return *(RepeatedField1ProtoModels::PurchaseItemType*>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = int32_t> static R& ReasonsFieldNumber() {
	 ...
	 static FieldCodec1Il2CppString*>*& _repeated_reasons_codec() {
		return *(FieldCodec1Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1Il2CppString*>*& reasons_() {
	...
	template <typename R = int32_t> R& bpType_() {
	 ...
	 static MessageParser1ProtoModels::PurchaseInfoType*>* get_Parser() {
		return ((MessageParser1ProtoModels::PurchaseInfoType*>* (*)(void *))(Il2CppBase() + 0x11B7D68))(0);
	}
	...
	template <typename R = void> R set_Payload(Il2CppString* value) {
	 ...
	 RepeatedField1ProtoModels::PurchaseItemType*>* get_Items() {
		return ((RepeatedField1ProtoModels::PurchaseItemType*>* (*)(PurchaseInfoType*))(Il2CppBase() + 0x11B82E4))(this);
	}
	...
	template <typename R = void> R set_HasBattlePassPremium(bool value) {
	 ...
	 RepeatedField1Il2CppString*>* get_Reasons() {
		return ((RepeatedField1Il2CppString*>* (*)(PurchaseInfoType*))(Il2CppBase() + 0x11B8360))(this);
	}
