...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(CreateClanRequest*, uintptr_t))(Il2CppBase() + 0x134C268))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(CreateClanRequest*, uintptr_t))(Il2CppBase() + 0x134C304))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(CreateClanRequest*, uintptr_t))(Il2CppBase() + 0x134C54C))(this, other);
	}
