...
public: 
	...
	template <typename T = MessageParser1ArenaUserProcessInviteRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUserProcessInviteRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUserProcessInviteRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUserProcessInviteRequest*, Il2CppObject*))(Il2CppBase() + 0x28623FC))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUserProcessInviteRequest* other) {
		return ((T (*)(ArenaUserProcessInviteRequest*, ArenaUserProcessInviteRequest*))(Il2CppBase() + 0x286246C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUserProcessInviteRequest* other) {
		return ((T (*)(ArenaUserProcessInviteRequest*, ArenaUserProcessInviteRequest*))(Il2CppBase() + 0x28627D0))(this, other);
	}
