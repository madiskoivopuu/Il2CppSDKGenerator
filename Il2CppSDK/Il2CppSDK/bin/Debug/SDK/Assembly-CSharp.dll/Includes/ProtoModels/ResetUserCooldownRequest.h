...
public: 
	...
	template <typename T = MessageParser1ResetUserCooldownRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ResetUserCooldownRequest*>*> static T get_Parser() {
	...
	template <typename T = ResetUserCooldownRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ResetUserCooldownRequest*, Il2CppObject*))(Il2CppBase() + 0x119AA78))(this, other);
	}
	template <typename T = bool> T Equals_1(ResetUserCooldownRequest* other) {
		return ((T (*)(ResetUserCooldownRequest*, ResetUserCooldownRequest*))(Il2CppBase() + 0x119AB14))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ResetUserCooldownRequest* other) {
		return ((T (*)(ResetUserCooldownRequest*, ResetUserCooldownRequest*))(Il2CppBase() + 0x119AD5C))(this, other);
	}
