...
public: 
	...
	template <typename T = uintptr_t> T& userDead_() {
	...
	template <typename T = uintptr_t> T get_UserDead() {
		return ((T (*)(ArenaUserKilledRequest*))(Il2CppBase() + 0x285F8F0))(this);
	}
	template <typename T = void> T set_UserDead(uintptr_t value) {
		return ((T (*)(ArenaUserKilledRequest*, uintptr_t))(Il2CppBase() + 0x285F8F8))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserKilledRequest*, uintptr_t))(Il2CppBase() + 0x285FA24))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserKilledRequest*, uintptr_t))(Il2CppBase() + 0x285FA94))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserKilledRequest*, uintptr_t))(Il2CppBase() + 0x2860134))(this, other);
	}
