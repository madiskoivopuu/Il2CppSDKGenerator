...
public: 
	...
	template <typename T = MessageParser1ArenaWorldCrashedRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaWorldCrashedRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaWorldCrashedRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaWorldCrashedRequest*, Il2CppObject*))(Il2CppBase() + 0x2869054))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaWorldCrashedRequest* other) {
		return ((T (*)(ArenaWorldCrashedRequest*, ArenaWorldCrashedRequest*))(Il2CppBase() + 0x28690F0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaWorldCrashedRequest* other) {
		return ((T (*)(ArenaWorldCrashedRequest*, ArenaWorldCrashedRequest*))(Il2CppBase() + 0x2869338))(this, other);
	}
