...
public: 
	...
	template <typename T = MessageParser1UserGoogleLinkRequest*>*> static T& _parser() {
	...
	template <typename T = LinkUserType*> T& linkType_() {
		return *(T*)((uintptr_t)this + 0x38);
	}

	template <typename T = MessageParser1UserGoogleLinkRequest*>*> static T get_Parser() {
	...
	template <typename T = UserGoogleLinkRequest*> T Clone() {
	...
	template <typename T = LinkUserType*> T get_LinkType() {
		return ((T (*)(UserGoogleLinkRequest*))(Il2CppBase() + 0x246B238))(this);
	}
	template <typename T = void> T set_LinkType(LinkUserType* value) {
		return ((T (*)(UserGoogleLinkRequest*, LinkUserType*))(Il2CppBase() + 0x246B240))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserGoogleLinkRequest*, Il2CppObject*))(Il2CppBase() + 0x246B248))(this, other);
	}
	template <typename T = bool> T Equals_1(UserGoogleLinkRequest* other) {
		return ((T (*)(UserGoogleLinkRequest*, UserGoogleLinkRequest*))(Il2CppBase() + 0x246B2B8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserGoogleLinkRequest* other) {
		return ((T (*)(UserGoogleLinkRequest*, UserGoogleLinkRequest*))(Il2CppBase() + 0x246B808))(this, other);
	}
