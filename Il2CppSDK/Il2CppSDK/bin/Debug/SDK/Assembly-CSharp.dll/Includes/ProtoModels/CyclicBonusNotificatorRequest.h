...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::CyclicBonusNotificatorRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::CyclicBonusNotificatorRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& UserIDsFieldNumber() {
	 ...
	 static FieldCodec1<int64_t>*& _repeated_userIDs_codec() {
		return *(FieldCodec1<int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<int64_t>*& userIDs_() {
		return *(RepeatedField1<int64_t>**)((uintptr_t)this + 0x28);
	}

	 static MessageParser1<ProtoModels::CyclicBonusNotificatorRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::CyclicBonusNotificatorRequest*>* (*)(void *))(Il2CppBase() + 0x1640388))(0);
	}
	...
	template <typename R = void> R set_Count(int32_t value) {
	 ...
	 RepeatedField1<int64_t>* get_UserIDs() {
		return ((RepeatedField1<int64_t>* (*)(CyclicBonusNotificatorRequest*))(Il2CppBase() + 0x16407AC))(this);
	}
