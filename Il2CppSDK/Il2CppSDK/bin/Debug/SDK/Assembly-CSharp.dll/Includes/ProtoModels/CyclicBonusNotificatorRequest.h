...
public: 
	...
	template <typename T = void*> static T& _repeated_userIDs_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& userIDs_() {
	...
	template <typename T = void*> T get_UserIDs() {
		return ((T (*)(CyclicBonusNotificatorRequest*))(Il2CppBase() + 0x16407AC))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(CyclicBonusNotificatorRequest*, uintptr_t))(Il2CppBase() + 0x16407B4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(CyclicBonusNotificatorRequest*, uintptr_t))(Il2CppBase() + 0x1640824))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(CyclicBonusNotificatorRequest*, uintptr_t))(Il2CppBase() + 0x1640C88))(this, other);
	}
