...
public: 
	...
	template <typename T = void> T set_Inventory(uintptr_t value) {
		return ((T (*)(ArenaUserExitToGlobalmapRequest*, uintptr_t))(Il2CppBase() + 0x285B22C))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserExitToGlobalmapRequest*, uintptr_t))(Il2CppBase() + 0x285B244))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserExitToGlobalmapRequest*, uintptr_t))(Il2CppBase() + 0x285B2B4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserExitToGlobalmapRequest*, uintptr_t))(Il2CppBase() + 0x285B648))(this, other);
	}
