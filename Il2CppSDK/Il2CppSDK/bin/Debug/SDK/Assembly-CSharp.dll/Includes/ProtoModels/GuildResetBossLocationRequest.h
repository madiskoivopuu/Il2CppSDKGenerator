...
public: 
	...
	template <typename T = MessageParser1GuildResetBossLocationRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildResetBossLocationRequest*>*> static T get_Parser() {
	...
	template <typename T = GuildResetBossLocationRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildResetBossLocationRequest*, Il2CppObject*))(Il2CppBase() + 0x194057C))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildResetBossLocationRequest* other) {
		return ((T (*)(GuildResetBossLocationRequest*, GuildResetBossLocationRequest*))(Il2CppBase() + 0x19405EC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildResetBossLocationRequest* other) {
		return ((T (*)(GuildResetBossLocationRequest*, GuildResetBossLocationRequest*))(Il2CppBase() + 0x1940994))(this, other);
	}
