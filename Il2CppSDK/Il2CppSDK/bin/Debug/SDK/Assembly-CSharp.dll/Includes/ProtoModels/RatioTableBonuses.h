...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::RatioTableBonuses*>*& _parser() {
		return *(MessageParser1ProtoModels::RatioTableBonuses*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& TiersFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::RatioTier*>*& _repeated_tiers_codec() {
		return *(FieldCodec1ProtoModels::RatioTier*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::RatioTier*>*& tiers_() {
		return *(RepeatedField1ProtoModels::RatioTier*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::RatioTableBonuses*>* get_Parser() {
		return ((MessageParser1ProtoModels::RatioTableBonuses*>* (*)(void *))(Il2CppBase() + 0x138D35C))(0);
	}
	...
	template <typename R = ProtoModels::RatioTableBonuses*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::RatioTier*>* get_Tiers() {
		return ((RepeatedField1ProtoModels::RatioTier*>* (*)(RatioTableBonuses*))(Il2CppBase() + 0x138D694))(this);
	}
