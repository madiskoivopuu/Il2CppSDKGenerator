...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserProductProgressDataItem*, uintptr_t))(Il2CppBase() + 0x2471EE0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserProductProgressDataItem*, uintptr_t))(Il2CppBase() + 0x2471F50))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserProductProgressDataItem*, uintptr_t))(Il2CppBase() + 0x24718CC))(this, other);
	}
