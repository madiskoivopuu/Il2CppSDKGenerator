...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UserProductProgressDataItem*>*& _parser() {
		return *(MessageParser1<ProtoModels::UserProductProgressDataItem*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& count_() {
	 ...
	 static MessageParser1<ProtoModels::UserProductProgressDataItem*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UserProductProgressDataItem*>* (*)(void *))(Il2CppBase() + 0x2471C28))(0);
	}
