...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaClearCellInWorldRequest*, uintptr_t))(Il2CppBase() + 0x1A1D988))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaClearCellInWorldRequest*, uintptr_t))(Il2CppBase() + 0x1A1D9F8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaClearCellInWorldRequest*, uintptr_t))(Il2CppBase() + 0x1A1DE38))(this, other);
	}
