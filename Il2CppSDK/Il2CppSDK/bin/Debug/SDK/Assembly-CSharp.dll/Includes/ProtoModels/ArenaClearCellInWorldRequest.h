...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClearCellInWorldRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaClearCellInWorldRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& emptyCellJson_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaClearCellInWorldRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaClearCellInWorldRequest*>* (*)(void *))(Il2CppBase() + 0x1A1D5D4))(0);
	}
