...
public: 
	...
	template <typename T = MessageParser1GuildQuest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GuildQuest*>*> static T get_Parser() {
	...
	template <typename T = GuildQuest*> T Clone() {
	...
	template <typename T = void> T set_State(GuildQuestState* value) {
		return ((T (*)(GuildQuest*, GuildQuestState*))(Il2CppBase() + 0x1B3D074))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GuildQuest*, Il2CppObject*))(Il2CppBase() + 0x1B3D10C))(this, other);
	}
	template <typename T = bool> T Equals_1(GuildQuest* other) {
		return ((T (*)(GuildQuest*, GuildQuest*))(Il2CppBase() + 0x1B3D17C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GuildQuest* other) {
		return ((T (*)(GuildQuest*, GuildQuest*))(Il2CppBase() + 0x1B3DC08))(this, other);
	}
