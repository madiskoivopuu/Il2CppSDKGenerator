...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::GuildQuest*>*& _parser() {
		return *(MessageParser1ProtoModels::GuildQuest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& PlayersFieldNumber() {
	 ...
	 static Codecint64_t, ProtoModels::QuestPlayer*>*& _map_players_codec() {
		return *(Codecint64_t, ProtoModels::QuestPlayer*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 MapField2int64_t, ProtoModels::QuestPlayer*>*& players_() {
		return *(MapField2int64_t, ProtoModels::QuestPlayer*>**)((uintptr_t)this + 0x28);
	}
	...
	template <typename R = int32_t> static R& PlayerRewardsFieldNumber() {
	 ...
	 static FieldCodec1int32_t>*& _repeated_playerRewards_codec() {
		return *(FieldCodec1int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1int32_t>*& playerRewards_() {
		return *(RepeatedField1int32_t>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = int32_t> R& bonusReward_() {
	 ...
	 static MessageParser1ProtoModels::GuildQuest*>* get_Parser() {
		return ((MessageParser1ProtoModels::GuildQuest*>* (*)(void *))(Il2CppBase() + 0x1B3CB74))(0);
	}
	...
	template <typename R = void> R set_State(ProtoModels::GuildQuestState* value) {
	 ...
	 MapField2int64_t, ProtoModels::QuestPlayer*>* get_Players() {
		return ((MapField2int64_t, ProtoModels::QuestPlayer*>* (*)(GuildQuest*))(Il2CppBase() + 0x1B3D07C))(this);
	}
	...
	template <typename R = void> R set_MaxGuildRankPoints(int32_t value) {
	 ...
	 RepeatedField1int32_t>* get_PlayerRewards() {
		return ((RepeatedField1int32_t>* (*)(GuildQuest*))(Il2CppBase() + 0x1B3D0F4))(this);
	}
