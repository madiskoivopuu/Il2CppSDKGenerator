...
public: 
	...
	template <typename T = MessageParser1AdminRpcResponse*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1Il2CppString*>*> static T& _repeated_answer_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1Il2CppString*>*> T& answer_() {
		return *(T*)((uintptr_t)this + 0x20);
	}

	template <typename T = MessageParser1AdminRpcResponse*>*> static T get_Parser() {
	...
	template <typename T = AdminRpcResponse*> T Clone() {
	...
	template <typename T = RepeatedField1Il2CppString*>*> T get_Answer() {
		return ((T (*)(AdminRpcResponse*))(Il2CppBase() + 0x1295224))(this);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminRpcResponse*, Il2CppObject*))(Il2CppBase() + 0x129522C))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminRpcResponse* other) {
		return ((T (*)(AdminRpcResponse*, AdminRpcResponse*))(Il2CppBase() + 0x129529C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminRpcResponse* other) {
		return ((T (*)(AdminRpcResponse*, AdminRpcResponse*))(Il2CppBase() + 0x1295678))(this, other);
	}
