...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AdminRpcResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::AdminRpcResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& AnswerFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_answer_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<Il2CppString*>*& answer_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::AdminRpcResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AdminRpcResponse*>* (*)(void *))(Il2CppBase() + 0x1294E18))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_Answer() {
		return ((RepeatedField1<Il2CppString*>* (*)(AdminRpcResponse*))(Il2CppBase() + 0x1295224))(this);
	}
