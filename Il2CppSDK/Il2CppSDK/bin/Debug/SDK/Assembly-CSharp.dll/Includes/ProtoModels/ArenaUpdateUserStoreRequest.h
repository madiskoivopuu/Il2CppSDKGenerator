...
public: 
	...
	template <typename T = MessageParser1ArenaUpdateUserStoreRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUpdateUserStoreRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUpdateUserStoreRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUpdateUserStoreRequest*, Il2CppObject*))(Il2CppBase() + 0xF57468))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUpdateUserStoreRequest* other) {
		return ((T (*)(ArenaUpdateUserStoreRequest*, ArenaUpdateUserStoreRequest*))(Il2CppBase() + 0xF574D8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUpdateUserStoreRequest* other) {
		return ((T (*)(ArenaUpdateUserStoreRequest*, ArenaUpdateUserStoreRequest*))(Il2CppBase() + 0xF577EC))(this, other);
	}
