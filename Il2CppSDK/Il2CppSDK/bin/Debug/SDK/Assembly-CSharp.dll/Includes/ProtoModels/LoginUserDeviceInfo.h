...
public: 
	...
	template <typename T = void> T set_Platform(uintptr_t value) {
		return ((T (*)(LoginUserDeviceInfo*, uintptr_t))(Il2CppBase() + 0x172C3F0))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(LoginUserDeviceInfo*, uintptr_t))(Il2CppBase() + 0x172C410))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(LoginUserDeviceInfo*, uintptr_t))(Il2CppBase() + 0x172C480))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(LoginUserDeviceInfo*, uintptr_t))(Il2CppBase() + 0x172CC84))(this, other);
	}
