...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::UpdatePlayersRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::UpdatePlayersRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& PlayersFieldNumber() {
	 ...
	 static MessageParser1<ProtoModels::UpdatePlayersRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::UpdatePlayersRequest*>* (*)(void *))(Il2CppBase() + 0x153F820))(0);
	}
	...
	template <typename R = ProtoModels::UpdatePlayersRequest*> R Clone() {
	 ...
	 RepeatedField1<ProtoModels::Player*>* get_Players() {
		return ((RepeatedField1<ProtoModels::Player*>* (*)(UpdatePlayersRequest*))(Il2CppBase() + 0x153FB58))(this);
	}
