...
public: 
	...
	template <typename T = MessageParser1UpdatePlayersRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UpdatePlayersRequest*>*> static T get_Parser() {
	...
	template <typename T = UpdatePlayersRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UpdatePlayersRequest*, Il2CppObject*))(Il2CppBase() + 0x153FB60))(this, other);
	}
	template <typename T = bool> T Equals_1(UpdatePlayersRequest* other) {
		return ((T (*)(UpdatePlayersRequest*, UpdatePlayersRequest*))(Il2CppBase() + 0x153FBD0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UpdatePlayersRequest* other) {
		return ((T (*)(UpdatePlayersRequest*, UpdatePlayersRequest*))(Il2CppBase() + 0x153FE1C))(this, other);
	}
