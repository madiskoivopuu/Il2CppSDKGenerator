...
public: 
	...
	template <typename T = MessageParser1AdminGetStatisticRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1AdminGetStatisticRequest*>*> static T get_Parser() {
	...
	template <typename T = AdminGetStatisticRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminGetStatisticRequest*, Il2CppObject*))(Il2CppBase() + 0x18B6B38))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminGetStatisticRequest* other) {
		return ((T (*)(AdminGetStatisticRequest*, AdminGetStatisticRequest*))(Il2CppBase() + 0x18B6BC4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminGetStatisticRequest* other) {
		return ((T (*)(AdminGetStatisticRequest*, AdminGetStatisticRequest*))(Il2CppBase() + 0x18B6D6C))(this, other);
	}
