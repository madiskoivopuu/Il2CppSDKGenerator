...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::SetRaidMatchingTimeoutRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::SetRaidMatchingTimeoutRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int64_t> R& endDateTime_() {
	 ...
	 static MessageParser1<ProtoModels::SetRaidMatchingTimeoutRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::SetRaidMatchingTimeoutRequest*>* (*)(void *))(Il2CppBase() + 0x162523C))(0);
	}
