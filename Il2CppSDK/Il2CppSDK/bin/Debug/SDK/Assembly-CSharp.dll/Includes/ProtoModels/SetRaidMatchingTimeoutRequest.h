...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(SetRaidMatchingTimeoutRequest*, uintptr_t))(Il2CppBase() + 0x16254F4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(SetRaidMatchingTimeoutRequest*, uintptr_t))(Il2CppBase() + 0x16255A0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(SetRaidMatchingTimeoutRequest*, uintptr_t))(Il2CppBase() + 0x1625884))(this, other);
	}
