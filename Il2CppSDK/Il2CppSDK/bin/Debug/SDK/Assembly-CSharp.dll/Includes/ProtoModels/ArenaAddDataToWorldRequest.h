...
public: 
	...
	template <typename T = MessageParser1ArenaAddDataToWorldRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaAddDataToWorldRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaAddDataToWorldRequest*> T Clone() {
	...
	template <typename T = void> T set_Clan(Clan* value) {
		return ((T (*)(ArenaAddDataToWorldRequest*, Clan*))(Il2CppBase() + 0x189D01C))(this, value);
	}
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaAddDataToWorldRequest*, Il2CppObject*))(Il2CppBase() + 0x189D024))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaAddDataToWorldRequest* other) {
		return ((T (*)(ArenaAddDataToWorldRequest*, ArenaAddDataToWorldRequest*))(Il2CppBase() + 0x189D094))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaAddDataToWorldRequest* other) {
		return ((T (*)(ArenaAddDataToWorldRequest*, ArenaAddDataToWorldRequest*))(Il2CppBase() + 0x189D574))(this, other);
	}
