...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAddDataToWorldRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaAddDataToWorldRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::Clan*> R& clan_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAddDataToWorldRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaAddDataToWorldRequest*>* (*)(void *))(Il2CppBase() + 0x189CC38))(0);
	}
