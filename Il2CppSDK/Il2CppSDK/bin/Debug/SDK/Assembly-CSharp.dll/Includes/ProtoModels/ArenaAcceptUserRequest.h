...
public: 
	...
	template <typename T = uintptr_t> T& activePortal_() {
	...
	template <typename T = void*> static T& _repeated_fcmTokens_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& fcmTokens_() {
	...
	template <typename T = void*> static T& _repeated_lastRatioPosition_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> T& lastRatioPosition_() {
	...
	template <typename T = void*> static T& _repeated_invites_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> T& invites_() {
		return *(T*)((uintptr_t)this + 0xA8);
	}
	template <typename T = int32_t> static T& CurrenciesFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> T& currencies_() {
	...
	template <typename T = void*> static T& _repeated_availableProducts_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	template <typename T = void*> T& availableProducts_() {
	...
	template <typename T = void*> static T& _repeated_userMarkTags_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = void*> T& userMarkTags_() {
	...
	template <typename T = uintptr_t> T& platform_() {
		return *(T*)((uintptr_t)this + 0xEC);
	}
	template <typename T = int32_t> static T& PersonalEntitiesFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _map_personalEntities_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = void*> T& personalEntities_() {
	...
	template <typename T = uintptr_t> T& storeCategories_() {
	...
	template <typename T = uintptr_t> T& storeSales_() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = int32_t> static T& BlockedPushesFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _repeated_blockedPushes_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> T& blockedPushes_() {
	...
	template <typename T = void*> static T& _repeated_purchaseHistory_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = void*> T& purchaseHistory_() {
	...
	template <typename T = void> T set_WorldStatus(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x1897FD0))(this, value);
	}
	...
	template <typename T = uintptr_t> T get_ActivePortal() {
		return ((T (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x1898060))(this);
	}
	template <typename T = void> T set_ActivePortal(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x1898068))(this, value);
	}
	...
	template <typename T = void*> T get_FcmTokens() {
	...
	template <typename T = void*> T get_LastRatioPosition() {
	...
	template <typename T = void*> T get_Invites() {
		return ((T (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x189811C))(this);
	}
	template <typename T = uintptr_t> T get_Currencies() {
		return ((T (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x1898124))(this);
	}
	template <typename T = void> T set_Currencies(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x189812C))(this, value);
	}
	...
	template <typename T = void*> T get_AvailableProducts() {
	...
	template <typename T = void*> T get_UserMarkTags() {
	...
	template <typename T = void> T set_Platform(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x1898284))(this, value);
	}
	template <typename T = void*> T get_PersonalEntities() {
	...
	template <typename T = void> T set_StoreCategories(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x18982B0))(this, value);
	}
	...
	template <typename T = void> T set_Vip(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x18982C8))(this, value);
	}
	...
	template <typename T = void> T set_StoreSales(uintptr_t value) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x18982E0))(this, value);
	}
	template <typename T = void*> T get_BlockedPushes() {
	...
	template <typename T = void*> T get_PurchaseHistory() {
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x18984A8))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x1898518))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaAcceptUserRequest*, uintptr_t))(Il2CppBase() + 0x189A290))(this, other);
	}
