...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAcceptUserRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaAcceptUserRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& FcmTokensFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_fcmTokens_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<Il2CppString*>*& fcmTokens_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x88);
	}
	...
	template <typename R = int32_t> static R& LastRatioPositionFieldNumber() {
	 ...
	 static FieldCodec1<int32_t>*& _repeated_lastRatioPosition_codec() {
		return *(FieldCodec1<int32_t>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	 RepeatedField1<int32_t>*& lastRatioPosition_() {
		return *(RepeatedField1<int32_t>**)((uintptr_t)this + 0x98);
	}
	...
	template <typename R = int32_t> static R& InvitesFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::Invite*>*& _repeated_invites_codec() {
		return *(FieldCodec1<ProtoModels::Invite*>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1<ProtoModels::Invite*>*& invites_() {
		return *(RepeatedField1<ProtoModels::Invite*>**)((uintptr_t)this + 0xA8);
	}
	...
	template <typename R = int32_t> static R& MailsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::Mail*>*& _repeated_mails_codec() {
		return *(FieldCodec1<ProtoModels::Mail*>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 RepeatedField1<ProtoModels::Mail*>*& mails_() {
		return *(RepeatedField1<ProtoModels::Mail*>**)((uintptr_t)this + 0xB8);
	}
	...
	template <typename R = int32_t> static R& AvailableProductsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ArenaUserAvailableProduct*>*& _repeated_availableProducts_codec() {
		return *(FieldCodec1<ProtoModels::ArenaUserAvailableProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	 RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>*& availableProducts_() {
		return *(RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>**)((uintptr_t)this + 0xD0);
	}
	...
	template <typename R = int32_t> static R& UserMarkTagsFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_userMarkTags_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	 RepeatedField1<Il2CppString*>*& userMarkTags_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0xE0);
	}
	...
	template <typename R = int32_t> static R& PersonalEntitiesFieldNumber() {
	 ...
	 static Codec<Il2CppString*, Il2CppString*>*& _map_personalEntities_codec() {
		return *(Codec<Il2CppString*, Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	 MapField2<Il2CppString*, Il2CppString*>*& personalEntities_() {
		return *(MapField2<Il2CppString*, Il2CppString*>**)((uintptr_t)this + 0xF0);
	}
	...
	template <typename R = int32_t> static R& BlockedPushesFieldNumber() {
	 ...
	 static FieldCodec1<Il2CppString*>*& _repeated_blockedPushes_codec() {
		return *(FieldCodec1<Il2CppString*>**)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	 RepeatedField1<Il2CppString*>*& blockedPushes_() {
		return *(RepeatedField1<Il2CppString*>**)((uintptr_t)this + 0x118);
	}
	...
	template <typename R = int32_t> static R& PurchaseHistoryFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::IncompletePurchaseHistory*>*& _repeated_purchaseHistory_codec() {
		return *(FieldCodec1<ProtoModels::IncompletePurchaseHistory*>**)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	 RepeatedField1<ProtoModels::IncompletePurchaseHistory*>*& purchaseHistory_() {
		return *(RepeatedField1<ProtoModels::IncompletePurchaseHistory*>**)((uintptr_t)this + 0x138);
	}
	...
	template <typename R = Il2CppString*> R& kefirID_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaAcceptUserRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaAcceptUserRequest*>* (*)(void *))(Il2CppBase() + 0x1897404))(0);
	}
	...
	template <typename R = void> R set_SelectorAB(int32_t value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_FcmTokens() {
		return ((RepeatedField1<Il2CppString*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x18980E8))(this);
	}
	...
	template <typename R = void> R set_WasKickedFromClan(bool value) {
	 ...
	 RepeatedField1<int32_t>* get_LastRatioPosition() {
		return ((RepeatedField1<int32_t>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x1898104))(this);
	}
	...
	template <typename R = void> R set_SessionID(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::Invite*>* get_Invites() {
		return ((RepeatedField1<ProtoModels::Invite*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x189811C))(this);
	}
	...
	template <typename R = void> R set_Currencies(ProtoModels::Currencies* value) {
	 ...
	 RepeatedField1<ProtoModels::Mail*>* get_Mails() {
		return ((RepeatedField1<ProtoModels::Mail*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x1898134))(this);
	}
	...
	template <typename R = void> R set_Occupation(int32_t value) {
	 ...
	 RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>* get_AvailableProducts() {
		return ((RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x18981D4))(this);
	}
	...
	template <typename R = void> R set_FirstClass(Il2CppString* value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_UserMarkTags() {
		return ((RepeatedField1<Il2CppString*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x1898264))(this);
	}
	...
	template <typename R = void> R set_Platform(ProtoModels::PlatformType value) {
	 ...
	 MapField2<Il2CppString*, Il2CppString*>* get_PersonalEntities() {
		return ((MapField2<Il2CppString*, Il2CppString*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x189828C))(this);
	}
	...
	template <typename R = void> R set_StoreSales(ProtoModels::StoreSales* value) {
	 ...
	 RepeatedField1<Il2CppString*>* get_BlockedPushes() {
		return ((RepeatedField1<Il2CppString*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x18982F0))(this);
	}
	...
	template <typename R = void> R set_MasterAccountName(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::IncompletePurchaseHistory*>* get_PurchaseHistory() {
		return ((RepeatedField1<ProtoModels::IncompletePurchaseHistory*>* (*)(ArenaAcceptUserRequest*))(Il2CppBase() + 0x1898418))(this);
	}
