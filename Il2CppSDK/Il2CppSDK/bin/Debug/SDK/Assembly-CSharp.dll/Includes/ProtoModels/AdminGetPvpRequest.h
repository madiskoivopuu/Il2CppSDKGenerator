...
public: 
	...
	template <typename T = MessageParser1AdminGetPvpRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1AdminGetPvpRequest*>*> static T get_Parser() {
	...
	template <typename T = AdminGetPvpRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(AdminGetPvpRequest*, Il2CppObject*))(Il2CppBase() + 0x18B58E4))(this, other);
	}
	template <typename T = bool> T Equals_1(AdminGetPvpRequest* other) {
		return ((T (*)(AdminGetPvpRequest*, AdminGetPvpRequest*))(Il2CppBase() + 0x18B5970))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(AdminGetPvpRequest* other) {
		return ((T (*)(AdminGetPvpRequest*, AdminGetPvpRequest*))(Il2CppBase() + 0x18B5B18))(this, other);
	}
