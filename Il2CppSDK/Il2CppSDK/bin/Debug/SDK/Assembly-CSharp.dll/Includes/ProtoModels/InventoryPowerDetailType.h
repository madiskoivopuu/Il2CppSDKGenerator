...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::InventoryPowerDetailType*>*& _parser() {
		return *(MessageParser1ProtoModels::InventoryPowerDetailType*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& summaryPower_() {
	 ...
	 static MessageParser1ProtoModels::InventoryPowerDetailType*>* get_Parser() {
		return ((MessageParser1ProtoModels::InventoryPowerDetailType*>* (*)(void *))(Il2CppBase() + 0x1232B5C))(0);
	}
