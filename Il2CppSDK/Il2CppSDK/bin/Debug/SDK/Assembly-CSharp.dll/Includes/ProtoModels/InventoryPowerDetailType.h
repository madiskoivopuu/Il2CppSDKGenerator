...
public: 
	...
	template <typename T = MessageParser1InventoryPowerDetailType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1InventoryPowerDetailType*>*> static T get_Parser() {
	...
	template <typename T = InventoryPowerDetailType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(InventoryPowerDetailType*, Il2CppObject*))(Il2CppBase() + 0x1232E74))(this, other);
	}
	template <typename T = bool> T Equals_1(InventoryPowerDetailType* other) {
		return ((T (*)(InventoryPowerDetailType*, InventoryPowerDetailType*))(Il2CppBase() + 0x1232EE4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(InventoryPowerDetailType* other) {
		return ((T (*)(InventoryPowerDetailType*, InventoryPowerDetailType*))(Il2CppBase() + 0x1233418))(this, other);
	}
