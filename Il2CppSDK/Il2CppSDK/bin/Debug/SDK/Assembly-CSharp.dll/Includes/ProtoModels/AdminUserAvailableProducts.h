...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminUserAvailableProducts*, uintptr_t))(Il2CppBase() + 0x1297930))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminUserAvailableProducts*, uintptr_t))(Il2CppBase() + 0x12979A0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminUserAvailableProducts*, uintptr_t))(Il2CppBase() + 0x1297BEC))(this, other);
	}
