...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::AdminUserAvailableProducts*>*& _parser() {
		return *(MessageParser1ProtoModels::AdminUserAvailableProducts*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename R = int32_t> static R& ProductsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::AdminUserAvailableProduct*>*& _repeated_products_codec() {
		return *(FieldCodec1ProtoModels::AdminUserAvailableProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::AdminUserAvailableProduct*>*& products_() {
		return *(RepeatedField1ProtoModels::AdminUserAvailableProduct*>**)((uintptr_t)this + 0x10);
	}

	 static MessageParser1ProtoModels::AdminUserAvailableProducts*>* get_Parser() {
		return ((MessageParser1ProtoModels::AdminUserAvailableProducts*>* (*)(void *))(Il2CppBase() + 0x12975F0))(0);
	}
	...
	template <typename R = ProtoModels::AdminUserAvailableProducts*> R Clone() {
	 ...
	 RepeatedField1ProtoModels::AdminUserAvailableProduct*>* get_Products() {
		return ((RepeatedField1ProtoModels::AdminUserAvailableProduct*>* (*)(AdminUserAvailableProducts*))(Il2CppBase() + 0x1297928))(this);
	}
