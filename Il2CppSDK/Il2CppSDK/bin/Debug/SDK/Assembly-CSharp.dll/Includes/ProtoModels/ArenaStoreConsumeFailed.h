...
public: 
	...
	template <typename T = uintptr_t> T& resoon_() {
	...
	template <typename T = uintptr_t> T get_Resoon() {
		return ((T (*)(ArenaStoreConsumeFailed*))(Il2CppBase() + 0x2719508))(this);
	}
	template <typename T = void> T set_Resoon(uintptr_t value) {
		return ((T (*)(ArenaStoreConsumeFailed*, uintptr_t))(Il2CppBase() + 0x2719510))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaStoreConsumeFailed*, uintptr_t))(Il2CppBase() + 0x27195A0))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaStoreConsumeFailed*, uintptr_t))(Il2CppBase() + 0x2719610))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaStoreConsumeFailed*, uintptr_t))(Il2CppBase() + 0x2719B20))(this, other);
	}
