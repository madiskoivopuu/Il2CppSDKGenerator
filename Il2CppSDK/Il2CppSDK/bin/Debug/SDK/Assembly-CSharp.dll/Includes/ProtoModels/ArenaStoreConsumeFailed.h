...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaStoreConsumeFailed*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaStoreConsumeFailed*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ResourcesFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::ArenaStoreResource*>*& _repeated_resources_codec() {
		return *(FieldCodec1ProtoModels::ArenaStoreResource*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1ProtoModels::ArenaStoreResource*>*& resources_() {
		return *(RepeatedField1ProtoModels::ArenaStoreResource*>**)((uintptr_t)this + 0x20);
	}
	...
	template <typename R = Il2CppString*> R& storeDataName_() {
	 ...
	 static MessageParser1ProtoModels::ArenaStoreConsumeFailed*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaStoreConsumeFailed*>* (*)(void *))(Il2CppBase() + 0x271915C))(0);
	}
	...
	template <typename R = void> R set_UserID(int64_t value) {
	 ...
	 RepeatedField1ProtoModels::ArenaStoreResource*>* get_Resources() {
		return ((RepeatedField1ProtoModels::ArenaStoreResource*>* (*)(ArenaStoreConsumeFailed*))(Il2CppBase() + 0x2719500))(this);
	}
