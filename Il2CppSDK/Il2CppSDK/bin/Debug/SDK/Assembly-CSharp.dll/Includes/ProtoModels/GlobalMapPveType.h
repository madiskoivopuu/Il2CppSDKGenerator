...
public: 
	...
	template <typename T = MessageParser1GlobalMapPveType*>*> static T& _parser() {
	...
	template <typename T = MessageParser1GlobalMapPveType*>*> static T get_Parser() {
	...
	template <typename T = GlobalMapPveType*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(GlobalMapPveType*, Il2CppObject*))(Il2CppBase() + 0x12D99FC))(this, other);
	}
	template <typename T = bool> T Equals_1(GlobalMapPveType* other) {
		return ((T (*)(GlobalMapPveType*, GlobalMapPveType*))(Il2CppBase() + 0x12D9A6C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(GlobalMapPveType* other) {
		return ((T (*)(GlobalMapPveType*, GlobalMapPveType*))(Il2CppBase() + 0x12DA3E0))(this, other);
	}
