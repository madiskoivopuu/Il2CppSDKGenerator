...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(PurchaseItemType*, uintptr_t))(Il2CppBase() + 0x11B971C))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(PurchaseItemType*, uintptr_t))(Il2CppBase() + 0x11B978C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(PurchaseItemType*, uintptr_t))(Il2CppBase() + 0x11B9A18))(this, other);
	}
