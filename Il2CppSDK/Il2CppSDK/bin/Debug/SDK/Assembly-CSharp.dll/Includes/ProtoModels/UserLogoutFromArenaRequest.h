...
public: 
	...
	template <typename T = void> T set_Inventory(uintptr_t value) {
		return ((T (*)(UserLogoutFromArenaRequest*, uintptr_t))(Il2CppBase() + 0x246ED0C))(this, value);
	}
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(UserLogoutFromArenaRequest*, uintptr_t))(Il2CppBase() + 0x246ED28))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(UserLogoutFromArenaRequest*, uintptr_t))(Il2CppBase() + 0x246ED98))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(UserLogoutFromArenaRequest*, uintptr_t))(Il2CppBase() + 0x246F1AC))(this, other);
	}
