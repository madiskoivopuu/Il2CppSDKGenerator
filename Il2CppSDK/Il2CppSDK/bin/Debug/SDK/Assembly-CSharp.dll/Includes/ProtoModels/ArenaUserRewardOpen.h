...
public: 
	...
	template <typename T = MessageParser1ArenaUserRewardOpen*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUserRewardOpen*>*> static T get_Parser() {
	...
	template <typename T = ArenaUserRewardOpen*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUserRewardOpen*, Il2CppObject*))(Il2CppBase() + 0x2865A10))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUserRewardOpen* other) {
		return ((T (*)(ArenaUserRewardOpen*, ArenaUserRewardOpen*))(Il2CppBase() + 0x2865ABC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUserRewardOpen* other) {
		return ((T (*)(ArenaUserRewardOpen*, ArenaUserRewardOpen*))(Il2CppBase() + 0x2865DA4))(this, other);
	}
