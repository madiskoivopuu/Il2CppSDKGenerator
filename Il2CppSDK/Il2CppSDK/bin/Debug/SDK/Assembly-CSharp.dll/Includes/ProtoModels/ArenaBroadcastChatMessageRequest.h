...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBroadcastChatMessageRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaBroadcastChatMessageRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& channel_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaBroadcastChatMessageRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaBroadcastChatMessageRequest*>* (*)(void *))(Il2CppBase() + 0x1A191A4))(0);
	}
