...
public: 
	...
	template <typename T = MessageParser1ArenaBroadcastChatMessageRequest*>*> static T& _parser() {
	...
	template <typename T = ClanChatMessageBlock*> T& block_() {
	...
	template <typename T = MessageParser1ArenaBroadcastChatMessageRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaBroadcastChatMessageRequest*> T Clone() {
	...
	template <typename T = ClanChatMessageBlock*> T get_Block() {
		return ((T (*)(ArenaBroadcastChatMessageRequest*))(Il2CppBase() + 0x1A194B0))(this);
	}
	template <typename T = void> T set_Block(ClanChatMessageBlock* value) {
		return ((T (*)(ArenaBroadcastChatMessageRequest*, ClanChatMessageBlock*))(Il2CppBase() + 0x1A194B8))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaBroadcastChatMessageRequest*, Il2CppObject*))(Il2CppBase() + 0x1A19548))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaBroadcastChatMessageRequest* other) {
		return ((T (*)(ArenaBroadcastChatMessageRequest*, ArenaBroadcastChatMessageRequest*))(Il2CppBase() + 0x1A195B8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaBroadcastChatMessageRequest* other) {
		return ((T (*)(ArenaBroadcastChatMessageRequest*, ArenaBroadcastChatMessageRequest*))(Il2CppBase() + 0x1A198DC))(this, other);
	}
