...
public: 
	...
	template <typename T = MessageParser1TourneyStartSearchRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1TourneyStartSearchRequest*>*> static T get_Parser() {
	...
	template <typename T = TourneyStartSearchRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(TourneyStartSearchRequest*, Il2CppObject*))(Il2CppBase() + 0x150D2DC))(this, other);
	}
	template <typename T = bool> T Equals_1(TourneyStartSearchRequest* other) {
		return ((T (*)(TourneyStartSearchRequest*, TourneyStartSearchRequest*))(Il2CppBase() + 0x150D34C))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(TourneyStartSearchRequest* other) {
		return ((T (*)(TourneyStartSearchRequest*, TourneyStartSearchRequest*))(Il2CppBase() + 0x150D660))(this, other);
	}
