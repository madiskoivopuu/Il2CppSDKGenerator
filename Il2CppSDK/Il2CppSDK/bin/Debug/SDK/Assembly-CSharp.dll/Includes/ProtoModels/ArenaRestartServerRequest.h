...
public: 
	...
	template <typename T = MessageParser1ArenaRestartServerRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaRestartServerRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaRestartServerRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaRestartServerRequest*, Il2CppObject*))(Il2CppBase() + 0x270FAB4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaRestartServerRequest* other) {
		return ((T (*)(ArenaRestartServerRequest*, ArenaRestartServerRequest*))(Il2CppBase() + 0x270FB24))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaRestartServerRequest* other) {
		return ((T (*)(ArenaRestartServerRequest*, ArenaRestartServerRequest*))(Il2CppBase() + 0x270FDF8))(this, other);
	}
