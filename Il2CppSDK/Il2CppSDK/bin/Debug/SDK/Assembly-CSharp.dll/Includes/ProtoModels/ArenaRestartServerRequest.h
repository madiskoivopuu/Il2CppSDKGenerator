...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaRestartServerRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaRestartServerRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = bool> R& restart_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaRestartServerRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaRestartServerRequest*>* (*)(void *))(Il2CppBase() + 0x270F6E0))(0);
	}
