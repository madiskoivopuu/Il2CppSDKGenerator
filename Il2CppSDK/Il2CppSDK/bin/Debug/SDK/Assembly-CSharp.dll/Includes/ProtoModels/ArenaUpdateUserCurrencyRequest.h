...
public: 
	...
	template <typename T = MessageParser1ArenaUpdateUserCurrencyRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaUpdateUserCurrencyRequest*>*> static T get_Parser() {
	...
	template <typename T = ArenaUpdateUserCurrencyRequest*> T Clone() {
	...
	template <typename T = void> T set_CurrencyType(CurrencyTypeEnum* value) {
		return ((T (*)(ArenaUpdateUserCurrencyRequest*, CurrencyTypeEnum*))(Il2CppBase() + 0xF55E58))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUpdateUserCurrencyRequest*, Il2CppObject*))(Il2CppBase() + 0xF55E70))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUpdateUserCurrencyRequest* other) {
		return ((T (*)(ArenaUpdateUserCurrencyRequest*, ArenaUpdateUserCurrencyRequest*))(Il2CppBase() + 0xF55EE0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUpdateUserCurrencyRequest* other) {
		return ((T (*)(ArenaUpdateUserCurrencyRequest*, ArenaUpdateUserCurrencyRequest*))(Il2CppBase() + 0xF562E4))(this, other);
	}
