...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaUpdateUserCurrencyRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaUpdateUserCurrencyRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> R& value_() {
	 ...
	 static MessageParser1ProtoModels::ArenaUpdateUserCurrencyRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaUpdateUserCurrencyRequest*>* (*)(void *))(Il2CppBase() + 0xF55B84))(0);
	}
