...
public: 
	...
	template <typename T = MessageParser1UserStoreExpirenceRequest*>*> static T& _parser() {
	...
	template <typename T = MessageParser1UserStoreExpirenceRequest*>*> static T get_Parser() {
	...
	template <typename T = UserStoreExpirenceRequest*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(UserStoreExpirenceRequest*, Il2CppObject*))(Il2CppBase() + 0x15BAAE4))(this, other);
	}
	template <typename T = bool> T Equals_1(UserStoreExpirenceRequest* other) {
		return ((T (*)(UserStoreExpirenceRequest*, UserStoreExpirenceRequest*))(Il2CppBase() + 0x15BAB54))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(UserStoreExpirenceRequest* other) {
		return ((T (*)(UserStoreExpirenceRequest*, UserStoreExpirenceRequest*))(Il2CppBase() + 0x15BAED0))(this, other);
	}
