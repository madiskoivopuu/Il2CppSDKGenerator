...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::UserStoreExpirenceRequest*>*& _parser() {
		return *(MessageParser1ProtoModels::UserStoreExpirenceRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = uint32_t> R& totalExp_() {
	 ...
	 static MessageParser1ProtoModels::UserStoreExpirenceRequest*>* get_Parser() {
		return ((MessageParser1ProtoModels::UserStoreExpirenceRequest*>* (*)(void *))(Il2CppBase() + 0x15BA814))(0);
	}
