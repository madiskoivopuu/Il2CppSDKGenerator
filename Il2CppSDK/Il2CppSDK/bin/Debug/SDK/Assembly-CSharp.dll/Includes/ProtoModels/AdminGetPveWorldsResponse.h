...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::AdminGetPveWorldsResponse*>*& _parser() {
		return *(MessageParser1<ProtoModels::AdminGetPveWorldsResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& WorldsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::MonitorPveWorld*>*& _repeated_worlds_codec() {
		return *(FieldCodec1<ProtoModels::MonitorPveWorld*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::MonitorPveWorld*>*& worlds_() {
		return *(RepeatedField1<ProtoModels::MonitorPveWorld*>**)((uintptr_t)this + 0x20);
	}

	 static MessageParser1<ProtoModels::AdminGetPveWorldsResponse*>* get_Parser() {
		return ((MessageParser1<ProtoModels::AdminGetPveWorldsResponse*>* (*)(void *))(Il2CppBase() + 0x18B4A5C))(0);
	}
	...
	template <typename R = void> R set_CodeMessage(Il2CppString* value) {
	 ...
	 RepeatedField1<ProtoModels::MonitorPveWorld*>* get_Worlds() {
		return ((RepeatedField1<ProtoModels::MonitorPveWorld*>* (*)(AdminGetPveWorldsResponse*))(Il2CppBase() + 0x18B4E68))(this);
	}
