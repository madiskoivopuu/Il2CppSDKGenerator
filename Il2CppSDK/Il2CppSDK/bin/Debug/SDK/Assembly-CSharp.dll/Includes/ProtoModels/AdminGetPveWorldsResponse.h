...
public: 
	...
	template <typename T = void*> static T& _repeated_worlds_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> T& worlds_() {
	...
	template <typename T = void*> T get_Worlds() {
		return ((T (*)(AdminGetPveWorldsResponse*))(Il2CppBase() + 0x18B4E68))(this);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(AdminGetPveWorldsResponse*, uintptr_t))(Il2CppBase() + 0x18B4E70))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(AdminGetPveWorldsResponse*, uintptr_t))(Il2CppBase() + 0x18B4EE0))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(AdminGetPveWorldsResponse*, uintptr_t))(Il2CppBase() + 0x18B52BC))(this, other);
	}
