...
public: 
	...
	template <typename T = MessageParser1ArenaStoreProductDescription*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ArenaStoreProductDescription*>*> static T get_Parser() {
	...
	template <typename T = ArenaStoreProductDescription*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaStoreProductDescription*, Il2CppObject*))(Il2CppBase() + 0x271E954))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaStoreProductDescription* other) {
		return ((T (*)(ArenaStoreProductDescription*, ArenaStoreProductDescription*))(Il2CppBase() + 0x271E9C4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaStoreProductDescription* other) {
		return ((T (*)(ArenaStoreProductDescription*, ArenaStoreProductDescription*))(Il2CppBase() + 0x271D72C))(this, other);
	}
