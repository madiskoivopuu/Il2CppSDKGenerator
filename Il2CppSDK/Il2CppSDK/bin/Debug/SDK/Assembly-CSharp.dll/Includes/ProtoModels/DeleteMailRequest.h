...
public: 
	...
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(DeleteMailRequest*, uintptr_t))(Il2CppBase() + 0xEB99A4))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(DeleteMailRequest*, uintptr_t))(Il2CppBase() + 0xEB9A14))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(DeleteMailRequest*, uintptr_t))(Il2CppBase() + 0xEB9D90))(this, other);
	}
