...
public: 
	...
	template <typename T = MessageParser1ClanMemberLocationData*>*> static T& _parser() {
	...
	template <typename T = MessageParser1ClanMemberLocationData*>*> static T get_Parser() {
	...
	template <typename T = ClanMemberLocationData*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ClanMemberLocationData*, Il2CppObject*))(Il2CppBase() + 0x1596B00))(this, other);
	}
	template <typename T = bool> T Equals_1(ClanMemberLocationData* other) {
		return ((T (*)(ClanMemberLocationData*, ClanMemberLocationData*))(Il2CppBase() + 0x1596B70))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ClanMemberLocationData* other) {
		return ((T (*)(ClanMemberLocationData*, ClanMemberLocationData*))(Il2CppBase() + 0x1596E84))(this, other);
	}
