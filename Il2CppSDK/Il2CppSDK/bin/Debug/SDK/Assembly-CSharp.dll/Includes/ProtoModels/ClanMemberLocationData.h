...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ClanMemberLocationData*>*& _parser() {
		return *(MessageParser1<ProtoModels::ClanMemberLocationData*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = Il2CppString*> R& playerName_() {
	 ...
	 static MessageParser1<ProtoModels::ClanMemberLocationData*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ClanMemberLocationData*>* (*)(void *))(Il2CppBase() + 0x159677C))(0);
	}
