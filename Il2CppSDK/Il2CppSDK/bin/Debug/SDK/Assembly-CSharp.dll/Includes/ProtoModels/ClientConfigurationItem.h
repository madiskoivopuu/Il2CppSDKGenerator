...
public: 
	...
	template <typename T = MessageParser1ClientConfigurationItem*>*> static T& _parser() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = int32_t> static T& TypeFieldNumber() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = ClientConfigurationType*> T& type_() {
	...
	template <typename T = MessageParser1ClientConfigurationItem*>*> static T get_Parser() {
	...
	template <typename T = ClientConfigurationItem*> T Clone() {
		return ((T (*)(ClientConfigurationItem*))(Il2CppBase() + 0xE16964))(this);
	}
	template <typename T = ClientConfigurationType*> T get_Type() {
		return ((T (*)(ClientConfigurationItem*))(Il2CppBase() + 0xE173B8))(this);
	}
	template <typename T = void> T set_Type(ClientConfigurationType* value) {
		return ((T (*)(ClientConfigurationItem*, ClientConfigurationType*))(Il2CppBase() + 0xE173C0))(this, value);
	}
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ClientConfigurationItem*, Il2CppObject*))(Il2CppBase() + 0xE173D8))(this, other);
	}
	template <typename T = bool> T Equals_1(ClientConfigurationItem* other) {
		return ((T (*)(ClientConfigurationItem*, ClientConfigurationItem*))(Il2CppBase() + 0xE17474))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ClientConfigurationItem* other) {
		return ((T (*)(ClientConfigurationItem*, ClientConfigurationItem*))(Il2CppBase() + 0xE16F48))(this, other);
	}
