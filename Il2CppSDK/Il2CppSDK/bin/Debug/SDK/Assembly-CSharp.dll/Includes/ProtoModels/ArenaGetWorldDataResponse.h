...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1ProtoModels::ArenaGetWorldDataResponse*>*& _parser() {
		return *(MessageParser1ProtoModels::ArenaGetWorldDataResponse*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& CellOwnerFieldNumber() {
	 ...
	 RepeatedField1int64_t>*& cellOwner_() {
		return *(RepeatedField1int64_t>**)((uintptr_t)this + 0x30);
	}
	...
	template <typename R = int32_t> static R& StatsFieldNumber() {
	 ...
	 static FieldCodec1ProtoModels::SummaryItemStats*>*& _repeated_stats_codec() {
		return *(FieldCodec1ProtoModels::SummaryItemStats*>**)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	 RepeatedField1ProtoModels::SummaryItemStats*>*& stats_() {
		return *(RepeatedField1ProtoModels::SummaryItemStats*>**)((uintptr_t)this + 0x40);
	}
	template <typename R = int32_t> static R& MountEndTimeUnixFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static Codecint64_t, int64_t>*& _map_mountEndTimeUnix_codec() {
		return *(Codecint64_t, int64_t>**)((uintptr_t)StaticClass()->static_fields + 0x20);
	}
	 MapField2int64_t, int64_t>*& mountEndTimeUnix_() {
		return *(MapField2int64_t, int64_t>**)((uintptr_t)this + 0x48);
	}
	template <typename R = int32_t> static R& OwnerStatsFieldNumber() {
		return *(R*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static FieldCodec1ProtoModels::SummaryOwnerStats*>*& _repeated_ownerStats_codec() {
		return *(FieldCodec1ProtoModels::SummaryOwnerStats*>**)((uintptr_t)StaticClass()->static_fields + 0x28);
	}
	 RepeatedField1ProtoModels::SummaryOwnerStats*>*& ownerStats_() {
		return *(RepeatedField1ProtoModels::SummaryOwnerStats*>**)((uintptr_t)this + 0x50);
	}

	 static MessageParser1ProtoModels::ArenaGetWorldDataResponse*>* get_Parser() {
		return ((MessageParser1ProtoModels::ArenaGetWorldDataResponse*>* (*)(void *))(Il2CppBase() + 0x1E25974))(0);
	}
	...
	template <typename R = void> R set_WasChanges(bool value) {
	 ...
	 RepeatedField1Il2CppString*>* get_JsonData() {
		return ((RepeatedField1Il2CppString*>* (*)(ArenaGetWorldDataResponse*))(Il2CppBase() + 0x1E25FA8))(this);
	}
	 RepeatedField1int64_t>* get_CellOwner() {
		return ((RepeatedField1int64_t>* (*)(ArenaGetWorldDataResponse*))(Il2CppBase() + 0x1E25FB0))(this);
	}
	...
	template <typename R = void> R set_CellOwnerSupport(bool value) {
	 ...
	 RepeatedField1ProtoModels::SummaryItemStats*>* get_Stats() {
		return ((RepeatedField1ProtoModels::SummaryItemStats*>* (*)(ArenaGetWorldDataResponse*))(Il2CppBase() + 0x1E25FCC))(this);
	}
	 MapField2int64_t, int64_t>* get_MountEndTimeUnix() {
		return ((MapField2int64_t, int64_t>* (*)(ArenaGetWorldDataResponse*))(Il2CppBase() + 0x1E25FD4))(this);
	}
	 RepeatedField1ProtoModels::SummaryOwnerStats*>* get_OwnerStats() {
		return ((RepeatedField1ProtoModels::SummaryOwnerStats*>* (*)(ArenaGetWorldDataResponse*))(Il2CppBase() + 0x1E25FDC))(this);
	}
