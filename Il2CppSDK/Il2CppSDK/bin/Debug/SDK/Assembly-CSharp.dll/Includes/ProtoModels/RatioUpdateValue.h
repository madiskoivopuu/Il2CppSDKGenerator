...
public: 
	...
	template <typename T = MessageParser1RatioUpdateValue*>*> static T& _parser() {
	...
	template <typename T = MessageParser1RatioUpdateValue*>*> static T get_Parser() {
	...
	template <typename T = RatioUpdateValue*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(RatioUpdateValue*, Il2CppObject*))(Il2CppBase() + 0x138EC10))(this, other);
	}
	template <typename T = bool> T Equals_1(RatioUpdateValue* other) {
		return ((T (*)(RatioUpdateValue*, RatioUpdateValue*))(Il2CppBase() + 0x138ECBC))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(RatioUpdateValue* other) {
		return ((T (*)(RatioUpdateValue*, RatioUpdateValue*))(Il2CppBase() + 0x138EFA4))(this, other);
	}
