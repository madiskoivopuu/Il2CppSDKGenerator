...
public: 
	...
	template <typename T = MessageParser1RatioValue*>*> static T& _parser() {
	...
	template <typename T = MessageParser1RatioValue*>*> static T get_Parser() {
	...
	template <typename T = RatioValue*> T Clone() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(RatioValue*, Il2CppObject*))(Il2CppBase() + 0x138F438))(this, other);
	}
	template <typename T = bool> T Equals_1(RatioValue* other) {
		return ((T (*)(RatioValue*, RatioValue*))(Il2CppBase() + 0x138F4D4))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(RatioValue* other) {
		return ((T (*)(RatioValue*, RatioValue*))(Il2CppBase() + 0x138F720))(this, other);
	}
