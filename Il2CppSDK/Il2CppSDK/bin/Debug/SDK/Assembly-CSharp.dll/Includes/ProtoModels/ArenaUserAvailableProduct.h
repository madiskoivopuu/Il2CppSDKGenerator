...
public: 
	...
	template <typename T = uintptr_t> T& productProgres_() {
	...
	template <typename T = uintptr_t> T& action_() {
	...
	template <typename T = uintptr_t> T& slotsProgress_() {
	...
	template <typename T = uintptr_t> T get_ProductProgres() {
		return ((T (*)(ArenaUserAvailableProduct*))(Il2CppBase() + 0xF591C8))(this);
	}
	template <typename T = void> T set_ProductProgres(uintptr_t value) {
		return ((T (*)(ArenaUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0xF591D0))(this, value);
	}
	...
	template <typename T = void> T set_Action(uintptr_t value) {
		return ((T (*)(ArenaUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0xF59210))(this, value);
	}
	...
	template <typename T = uintptr_t> T get_SlotsProgress() {
		return ((T (*)(ArenaUserAvailableProduct*))(Il2CppBase() + 0xF59228))(this);
	}
	template <typename T = void> T set_SlotsProgress(uintptr_t value) {
		return ((T (*)(ArenaUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0xF59230))(this, value);
	}
	template <typename T = bool> T Equals(uintptr_t other) {
		return ((T (*)(ArenaUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0xF59238))(this, other);
	}
	template <typename T = bool> T Equals_1(uintptr_t other) {
		return ((T (*)(ArenaUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0xF592A8))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(uintptr_t other) {
		return ((T (*)(ArenaUserAvailableProduct*, uintptr_t))(Il2CppBase() + 0xF59A60))(this, other);
	}
