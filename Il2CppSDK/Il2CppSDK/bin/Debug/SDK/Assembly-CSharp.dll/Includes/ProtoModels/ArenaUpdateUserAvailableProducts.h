...
public: 
	...
	template <typename T = MessageParser1ArenaUpdateUserAvailableProducts*>*> static T& _parser() {
	...
	template <typename T = FieldCodec1ArenaUserAvailableProduct*>*> static T& _repeated_products_codec() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = RepeatedField1ArenaUserAvailableProduct*>*> T& products_() {
	...
	template <typename T = MessageParser1ArenaUpdateUserAvailableProducts*>*> static T get_Parser() {
	...
	template <typename T = ArenaUpdateUserAvailableProducts*> T Clone() {
	...
	template <typename T = RepeatedField1ArenaUserAvailableProduct*>*> T get_Products() {
	...
	template <typename T = bool> T Equals(Il2CppObject* other) {
		return ((T (*)(ArenaUpdateUserAvailableProducts*, Il2CppObject*))(Il2CppBase() + 0xF552D4))(this, other);
	}
	template <typename T = bool> T Equals_1(ArenaUpdateUserAvailableProducts* other) {
		return ((T (*)(ArenaUpdateUserAvailableProducts*, ArenaUpdateUserAvailableProducts*))(Il2CppBase() + 0xF55344))(this, other);
	}
	...
	template <typename T = void> T MergeFrom(ArenaUpdateUserAvailableProducts* other) {
		return ((T (*)(ArenaUpdateUserAvailableProducts*, ArenaUpdateUserAvailableProducts*))(Il2CppBase() + 0xF557C0))(this, other);
	}
