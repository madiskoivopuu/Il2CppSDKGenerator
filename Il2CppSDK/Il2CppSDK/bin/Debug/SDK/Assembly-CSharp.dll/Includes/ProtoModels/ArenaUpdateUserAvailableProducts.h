...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaUpdateUserAvailableProducts*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaUpdateUserAvailableProducts*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = int32_t> static R& ProductsFieldNumber() {
	 ...
	 static FieldCodec1<ProtoModels::ArenaUserAvailableProduct*>*& _repeated_products_codec() {
		return *(FieldCodec1<ProtoModels::ArenaUserAvailableProduct*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	 RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>*& products_() {
		return *(RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>**)((uintptr_t)this + 0x18);
	}
	...
	template <typename R = Il2CppString*> R& codeMessage_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaUpdateUserAvailableProducts*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaUpdateUserAvailableProducts*>* (*)(void *))(Il2CppBase() + 0xF54EA8))(0);
	}
	...
	template <typename R = void> R set_UserID(int64_t value) {
	 ...
	 RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>* get_Products() {
		return ((RepeatedField1<ProtoModels::ArenaUserAvailableProduct*>* (*)(ArenaUpdateUserAvailableProducts*))(Il2CppBase() + 0xF55234))(this);
	}
