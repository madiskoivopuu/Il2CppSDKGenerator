...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaUpdateConfigRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaUpdateConfigRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::ArenaConfiguration*> R& configuration_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaUpdateConfigRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaUpdateConfigRequest*>* (*)(void *))(Il2CppBase() + 0xF52C10))(0);
	}
