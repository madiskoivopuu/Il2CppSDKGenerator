...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static MessageParser1<ProtoModels::ArenaFishingStatisticRequest*>*& _parser() {
		return *(MessageParser1<ProtoModels::ArenaFishingStatisticRequest*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	...
	template <typename R = ProtoModels::FishingStatisticDataProto*> R& data_() {
	 ...
	 static MessageParser1<ProtoModels::ArenaFishingStatisticRequest*>* get_Parser() {
		return ((MessageParser1<ProtoModels::ArenaFishingStatisticRequest*>* (*)(void *))(Il2CppBase() + 0x1E1E430))(0);
	}
