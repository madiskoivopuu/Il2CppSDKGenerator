...
public: 
	...
	template <typename T = AutoStartComponent*> static T& autoStartComponent() {
	...
	template <typename T = ApproveTimeComponent*> T get_approveTime() {
	...
	template <typename T = DamageStepComponent*> T get_damageStep() {
	...
	template <typename T = DifficultyStepsComponent*> T get_difficultySteps() {
	...
	template <typename T = EnterQuestComponent*> T get_enterQuest() {
	...
	template <typename T = HealthStepComponent*> T get_healthStep() {
	...
	template <typename T = LobbyActiveTimeComponent*> T get_lobbyActiveTime() {
	...
	template <typename T = LobbyIdComponent*> T get_lobbyId() {
	...
	template <typename T = LobbyPlayersComponent*> T get_lobbyPlayers() {
	...
	template <typename T = void> T AddLobbyType(LobbyType* newType) {
		return ((T (*)(LobbyEntity*, LobbyType*))(Il2CppBase() + 0x143CD20))(this, newType);
	}
	template <typename T = void> T ReplaceLobbyType(LobbyType* newType) {
		return ((T (*)(LobbyEntity*, LobbyType*))(Il2CppBase() + 0x143CE24))(this, newType);
	}
	template <typename T = void> T RemoveLobbyType() {
		return ((T (*)(LobbyEntity*))(Il2CppBase() + 0x143CF28))(this);
	}
	template <typename T = LobbyWorldComponent*> T get_lobbyWorld() {
	...
	template <typename T = OverhaulDamageCoefComponent*> T get_overhaulDamageCoef() {
	...
	template <typename T = OverhaulHealthCoefComponent*> T get_overhaulHealthCoef() {
	...
	template <typename T = WorldsList*> T get_worldsList() {
