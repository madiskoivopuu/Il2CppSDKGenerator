...
public: 
	...
	template <typename R = bool> R& _isPurchaseInProgress() {
	 ...
	 Action1TransactionEntity*>*& _callback() {
		return *(Action1TransactionEntity*>**)((uintptr_t)this + 0x40);
	}
	 Action1uintptr_t>*& _onPlatformStoreFail() {
		return *(Action1uintptr_t>**)((uintptr_t)this + 0x48);
	}
	 Queue1uintptr_t>*& _pendingPurchases() {
		return *(Queue1uintptr_t>**)((uintptr_t)this + 0x50);
	}
	...
	template <typename R = void> R BuyProduct(Store2DataEntity* entity, Action1TransactionEntity*>* callback, Action1uintptr_t>* onPlatformStoreFail) {
		return ((R (*)(IAPManager*, Store2DataEntity*, Action1TransactionEntity*>*, Action1uintptr_t>*))(Il2CppBase() + 0x1E39A2C))(this, entity, callback, onPlatformStoreFail);
	}
