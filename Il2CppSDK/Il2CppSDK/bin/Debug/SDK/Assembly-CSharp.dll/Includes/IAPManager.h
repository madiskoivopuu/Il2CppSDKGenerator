...
public: 
	...
	template <typename T = IAPManager*> static T& _instance() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = bool> T& _isPurchaseInProgress() {
		return *(T*)((uintptr_t)this + 0x3A);
	}
	template <typename T = Action1TransactionEntity*>*> T& _callback() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = Action1uintptr_t>*> T& _onPlatformStoreFail() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = Queue1uintptr_t>*> T& _pendingPurchases() {
		return *(T*)((uintptr_t)this + 0x50);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, StubProduct*>*> T& _stub_products() {
	...
	template <typename T = IAPManager*> static T get_Instance() {
	...
	template <typename T = ICommonLogger*> T get__logger() {
	...
	template <typename T = void> T BuyProduct(Store2DataEntity* entity, Action1TransactionEntity*>* callback, Action1uintptr_t>* onPlatformStoreFail) {
		return ((T (*)(IAPManager*, Store2DataEntity*, Action1TransactionEntity*>*, Action1uintptr_t>*))(Il2CppBase() + 0x1E39A2C))(this, entity, callback, onPlatformStoreFail);
	}
	...
	template <typename T = void> T OnProductValidated(BaseClientWorld* world, TransactionEntity* transaction) {
		return ((T (*)(IAPManager*, BaseClientWorld*, TransactionEntity*))(Il2CppBase() + 0x1E3B96C))(this, world, transaction);
	}
