...
public: 
	...
	template <typename T = void> T Bind(uintptr_t window) {
		return ((T (*)(ClanManagementPanel*, uintptr_t))(Il2CppBase() + 0x1592278))(this, window);
	}
	...
	template <typename T = void> T OnClanUserClicked(unsigned char cellIndex) {
		return ((T (*)(ClanManagementPanel*, unsigned char))(Il2CppBase() + 0x1590B84))(this, cellIndex);
	}
