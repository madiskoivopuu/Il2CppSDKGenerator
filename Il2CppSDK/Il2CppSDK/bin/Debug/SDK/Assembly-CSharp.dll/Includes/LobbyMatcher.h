...
public: 
	...
	template <typename T = void*> static T& _matcherApproveTime() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _matcherAutoStart() {
	...
	template <typename T = void*> static T& _matcherDamageStep() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x30);
	}
	template <typename T = void*> static T& _matcherDifficultySteps() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = void*> static T& _matcherEnterQuest() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> static T& _matcherHealthStep() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = void*> static T& _matcherLobbyActiveTime() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x50);
	}
	template <typename T = void*> static T& _matcherLobbyId() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x58);
	}
	template <typename T = void*> static T& _matcherLobbyPlayers() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x60);
	}
	template <typename T = void*> static T& _matcherLobbyType() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x68);
	}
	template <typename T = void*> static T& _matcherLobbyWorld() {
	...
	template <typename T = void*> static T& _matcherOverhaulDamageCoef() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x90);
	}
	template <typename T = void*> static T& _matcherOverhaulHealthCoef() {
	...
	template <typename T = void*> static T& _matcherWorldsList() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xD0);
	}

	template <typename T = void*> static T get_ApproveTime() {
		return ((T (*)(void *))(Il2CppBase() + 0x143F1B8))(0);
	}
	template <typename T = void*> static T get_AutoStart() {
	...
	template <typename T = void*> static T get_DamageStep() {
		return ((T (*)(void *))(Il2CppBase() + 0x143F9A8))(0);
	}
	template <typename T = void*> static T get_DifficultySteps() {
		return ((T (*)(void *))(Il2CppBase() + 0x143FB44))(0);
	}
	template <typename T = void*> static T get_EnterQuest() {
		return ((T (*)(void *))(Il2CppBase() + 0x143FCE0))(0);
	}
	template <typename T = void*> static T get_HealthStep() {
		return ((T (*)(void *))(Il2CppBase() + 0x143FE7C))(0);
	}
	template <typename T = void*> static T get_LobbyActiveTime() {
		return ((T (*)(void *))(Il2CppBase() + 0x1440018))(0);
	}
	template <typename T = void*> static T get_LobbyId() {
		return ((T (*)(void *))(Il2CppBase() + 0x1438224))(0);
	}
	template <typename T = void*> static T get_LobbyPlayers() {
		return ((T (*)(void *))(Il2CppBase() + 0x14401B4))(0);
	}
	template <typename T = void*> static T get_LobbyType() {
		return ((T (*)(void *))(Il2CppBase() + 0x143A798))(0);
	}
	template <typename T = void*> static T get_LobbyWorld() {
	...
	template <typename T = void*> static T get_OverhaulDamageCoef() {
		return ((T (*)(void *))(Il2CppBase() + 0x14409C0))(0);
	}
	template <typename T = void*> static T get_OverhaulHealthCoef() {
	...
	template <typename T = void*> static T get_WorldsList() {
