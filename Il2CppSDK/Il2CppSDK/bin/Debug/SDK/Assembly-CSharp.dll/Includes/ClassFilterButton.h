...
public: 
	...
	template <typename T = Action1ClassFilterButton*>*> T& OnButtonClick() {
	...
	template <typename T = void> T add_OnButtonClick(Action1ClassFilterButton*>* value) {
		return ((T (*)(ClassFilterButton*, Action1ClassFilterButton*>*))(Il2CppBase() + 0x1599680))(this, value);
	}
	template <typename T = void> T remove_OnButtonClick(Action1ClassFilterButton*>* value) {
		return ((T (*)(ClassFilterButton*, Action1ClassFilterButton*>*))(Il2CppBase() + 0x1599720))(this, value);
	}
