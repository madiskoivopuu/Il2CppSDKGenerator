...
public: 
	...
	template <typename R = int32_t> R& _notSeenCount() {
	 ...
	 Action1ClassFilterButton*>*& OnButtonClick() {
		return *(Action1ClassFilterButton*>**)((uintptr_t)this + 0x68);
	}
	...
	template <typename R = void> R add_OnButtonClick(Action1ClassFilterButton*>* value) {
		return ((R (*)(ClassFilterButton*, Action1ClassFilterButton*>*))(Il2CppBase() + 0x1599680))(this, value);
	}
	template <typename R = void> R remove_OnButtonClick(Action1ClassFilterButton*>* value) {
		return ((R (*)(ClassFilterButton*, Action1ClassFilterButton*>*))(Il2CppBase() + 0x1599720))(this, value);
	}
