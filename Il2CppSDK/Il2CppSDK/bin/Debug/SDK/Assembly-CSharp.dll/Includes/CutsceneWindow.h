...
public: 
	...
	template <typename T = CutsceneController*> T& _controller() {
	...
	template <typename T = void> T SetupPlayer(HideHelper* player) {
		return ((T (*)(CutsceneWindow*, HideHelper*))(Il2CppBase() + 0x163EFA0))(this, player);
	}
