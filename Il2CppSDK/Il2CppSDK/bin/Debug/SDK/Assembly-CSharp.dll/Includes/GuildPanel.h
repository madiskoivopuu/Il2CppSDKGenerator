...
public: 
	...
	template <typename T = StandartButton*> T& MessageEditButton() {
	...
	template <typename T = GuildNewsView*> T& GuildNewsViewPrefab() {
	...
	template <typename T = void> T Bind(UIWindow* window) {
		return ((T (*)(GuildPanel*, UIWindow*))(Il2CppBase() + 0x1B3B9C8))(this, window);
	}
	...
	template <typename T = void> T OnReceiveGuildEvent(ChatEntity* entity) {
		return ((T (*)(GuildPanel*, ChatEntity*))(Il2CppBase() + 0x1B3BF54))(this, entity);
	}
