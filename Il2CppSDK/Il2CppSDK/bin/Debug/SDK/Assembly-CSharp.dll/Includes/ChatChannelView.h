...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 IGroup1<ChatEntity*>*& _unreadMessages() {
		return *(IGroup1<ChatEntity*>**)((uintptr_t)this + 0x60);
	}
	...
	template <typename R = void> R Init(UIWindow* window, ChatRoom* room, ChatChannelData* channelData, bool isSelected, Action1<ChannelView*>* onClicked) {
		return ((R (*)(ChatChannelView*, UIWindow*, ChatRoom*, ChatChannelData*, bool, Action1<ChannelView*>*))(Il2CppBase() + 0x13EFC1C))(this, window, room, channelData, isSelected, onClicked);
	}
