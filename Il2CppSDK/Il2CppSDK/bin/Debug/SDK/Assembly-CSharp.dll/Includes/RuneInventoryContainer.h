...
public: 
	...
	template <typename T = Il2CppList<InventorySlotEntity*>*> T& _sortedList() {
		return *(T*)((uintptr_t)this + 0x120);
	}
	template <typename T = Il2CppDictionary<int32_t, RuneItem*>*> T& _items() {
	...
	template <typename T = Il2CppDictionary<int32_t, RuneItem*>*> T get_Items() {
		return ((T (*)(RuneInventoryContainer*))(Il2CppBase() + 0x11AC028))(this);
	}
	template <typename T = ButtonWithSliderOnHold*> T get_SplitButton() {
	...
	template <typename T = RuneItemSplit*> T get_ToSplitingItem() {
	...
	template <typename T = void> T Bind(IRuneInventoryPanel* runePanel, uintptr_t onDelete, uintptr_t onMerge) {
		return ((T (*)(RuneInventoryContainer*, IRuneInventoryPanel*, uintptr_t, uintptr_t))(Il2CppBase() + 0x11AC2EC))(this, runePanel, onDelete, onMerge);
	}
	template <typename T = void> T OnItemAdded(RuneItem* item) {
		return ((T (*)(RuneInventoryContainer*, RuneItem*))(Il2CppBase() + 0x11AE3A0))(this, item);
	}
	template <typename T = void> T OnItemRemove(RuneItem* item) {
		return ((T (*)(RuneInventoryContainer*, RuneItem*))(Il2CppBase() + 0x11AE474))(this, item);
	}
	...
	template <typename T = Il2CppList<InventorySlotEntity*>*> T Sort(uintptr_t collection) {
		return ((T (*)(RuneInventoryContainer*, uintptr_t))(Il2CppBase() + 0x0))(this, collection);
	}
	template <typename T = ValueTuple3int32_t, int32_t, int32_t>*> T AddSlotsItemIfNeed(int32_t notEmptySlotsCount, bool extend) {
		return ((T (*)(RuneInventoryContainer*, int32_t, bool))(Il2CppBase() + 0x11AD420))(this, notEmptySlotsCount, extend);
	}
	template <typename T = void> T SetItem(GameEntity* parentEntity, InventorySlot* slot, int32_t itemIndex, int32_t index) {
		return ((T (*)(RuneInventoryContainer*, GameEntity*, InventorySlot*, int32_t, int32_t))(Il2CppBase() + 0x11ADDD0))(this, parentEntity, slot, itemIndex, index);
	}
	...
	template <typename T = void> T OnBeginScrollingEvent(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(RuneInventoryContainer*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x11AEF64))(this, item, eventData);
	}
	template <typename T = void> T OnScrollingEvent(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(RuneInventoryContainer*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x11AEF8C))(this, item, eventData);
	}
	template <typename T = void> T OnEndScrollingEvent(IInventoryItem* item, uintptr_t eventData) {
		return ((T (*)(RuneInventoryContainer*, IInventoryItem*, uintptr_t))(Il2CppBase() + 0x11AEFB4))(this, item, eventData);
	}
	template <typename T = void> T OnUpdateDraw(float deltaTime) {
		return ((T (*)(RuneInventoryContainer*, float))(Il2CppBase() + 0x11AEFDC))(this, deltaTime);
	}
	template <typename T = RuneItem*> T GetFirstEmptySlot() {
		return ((T (*)(RuneInventoryContainer*))(Il2CppBase() + 0x11AF260))(this);
	}
	template <typename T = RuneItem*> T GetFirstNotEmptySlot(Il2CppString* runeBluprint) {
