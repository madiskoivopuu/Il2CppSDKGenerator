...
public: 
	...
	template <typename R = void> R UpdateCounter() {
	 ...
	 ValueTuple3int32_t, int32_t, int32_t>* AddSlotsItemIfNeed(int32_t notEmptySlotsCount, bool extend) {
		return ((ValueTuple3int32_t, int32_t, int32_t>* (*)(RuneInventoryContainer*, int32_t, bool))(Il2CppBase() + 0x11AD420))(this, notEmptySlotsCount, extend);
	}
	...
	template <typename R = IInventoryItem*> R GetItemById(int32_t id) {
	 ...
	 ValueTuple2bool, IInventoryItem*>* IsInventoryEmpty() {
		return ((ValueTuple2bool, IInventoryItem*>* (*)(RuneInventoryContainer*))(Il2CppBase() + 0x11AED70))(this);
	}
