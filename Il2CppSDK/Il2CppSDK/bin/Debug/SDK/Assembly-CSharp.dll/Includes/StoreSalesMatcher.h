...
public: 
	...
	template <typename T = void*> static T& _matcherCategoryType() {
	...
	template <typename T = void*> static T& _matcherStoreSalesId() {
	...
	template <typename T = void*> static T& _matcherWindowFrame() {
	...
	template <typename T = void*> static T get_CategoryType() {
	...
	template <typename T = void*> static T get_StoreSalesId() {
	...
	template <typename T = void*> static T get_WindowFrame() {
