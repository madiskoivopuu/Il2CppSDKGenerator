...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 static Il2CppDictionary<int32_t, ValueTuple2int32_t, int32_t>*>*& MountsSlotsAndPriceByGrade() {
		return *(Il2CppDictionary<int32_t, ValueTuple2int32_t, int32_t>*>**)((uintptr_t)StaticClass()->static_fields + 0x10);
	}

	 static ValueTuple3bool, int32_t, int32_t>* GetMountsInventorySlotsAndPriceByGrade(int32_t grade) {
		return ((ValueTuple3bool, int32_t, int32_t>* (*)(void *, int32_t))(Il2CppBase() + 0x15433C0))(0, grade);
	}
	...
	template <typename R = float> static R CalcMountSpeed(ItemEntity* mount, ICommonContexts* world) {
	 ...
	 static ValueTuple3float, float, int32_t>* CalcMountParams(ItemEntity* mount, ICommonContexts* world) {
		return ((ValueTuple3float, float, int32_t>* (*)(void *, ItemEntity*, ICommonContexts*))(Il2CppBase() + 0x154452C))(0, mount, world);
	}
	template <typename R = ItemEntity*> static R GetMountFromInventory(GameEntity* entity, ICommonContexts* world) {
	 ...
	 static ValueTuple3bool, int32_t, int32_t>* CanReplaceMount(GameEntity* entity, ICommonContexts* world, ItemEntity* newMount) {
		return ((ValueTuple3bool, int32_t, int32_t>* (*)(void *, GameEntity*, ICommonContexts*, ItemEntity*))(Il2CppBase() + 0x15447DC))(0, entity, world, newMount);
	}
