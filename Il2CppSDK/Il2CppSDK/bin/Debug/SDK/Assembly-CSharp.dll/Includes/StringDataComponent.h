...
#include "TypeDataComponent`1" 

class StringDataComponent: TypeDataComponent1
{
public: 
	...
	template <typename T = bool> T IsEqualsDefault(uintptr_t blueprintComponent) {
		return ((T (*)(StringDataComponent*, uintptr_t))(Il2CppBase() + 0x169EF14))(this, blueprintComponent);
	}
