...
public: 
	...
	template <typename T = uintptr_t> T BeginInvoke(uintptr_t e, uintptr_t c, uintptr_t* key, uintptr_t callback, uintptr_t object) {
		return ((T (*)(TryGetKeyDelegate2*, uintptr_t, uintptr_t, uintptr_t*, uintptr_t, uintptr_t))(Il2CppBase() + 0x0))(this, e, c, key, callback, object);
	}
