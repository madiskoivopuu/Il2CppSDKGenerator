...
public: 
	...
	template <typename T = void*> static T& _matcherAnalyticEvent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = void*> static T& _matcherAvatar() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = void*> static T& _matcherBanner() {
	...
	template <typename T = void*> static T& _matcherFoundPlayers() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x38);
	}
	template <typename T = void*> static T& _matcherGeneratedPositionRewards() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> static T& _matcherGuaranteedRewards() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = void*> static T& _matcherHistoryTempBuff() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x50);
	}
	template <typename T = void*> static T& _matcherIcon() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x58);
	}
	template <typename T = void*> static T& _matcherMaxPlayers() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x60);
	}
	template <typename T = void*> static T& _matcherMinPointsToReward() {
	...
	template <typename T = void*> static T& _matcherPositionRewards() {
	...
	template <typename T = void*> static T& _matcherTempBuff() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x98);
	}
	template <typename T = void*> static T& _matcherTournament() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA0);
	}
	template <typename T = void*> static T& _matcherTournamentState() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA8);
	}

	template <typename T = void*> static T get_AnalyticEvent() {
		return ((T (*)(void *))(Il2CppBase() + 0x15074E4))(0);
	}
	template <typename T = void*> static T get_Avatar() {
		return ((T (*)(void *))(Il2CppBase() + 0x14FEDB0))(0);
	}
	template <typename T = void*> static T get_Banner() {
	...
	template <typename T = void*> static T get_FoundPlayers() {
		return ((T (*)(void *))(Il2CppBase() + 0x1507CD4))(0);
	}
	template <typename T = void*> static T get_GeneratedPositionRewards() {
		return ((T (*)(void *))(Il2CppBase() + 0x1507E70))(0);
	}
	template <typename T = void*> static T get_GuaranteedRewards() {
		return ((T (*)(void *))(Il2CppBase() + 0x150800C))(0);
	}
	template <typename T = void*> static T get_HistoryTempBuff() {
		return ((T (*)(void *))(Il2CppBase() + 0x14FF5BC))(0);
	}
	template <typename T = void*> static T get_Icon() {
		return ((T (*)(void *))(Il2CppBase() + 0x15081A8))(0);
	}
	template <typename T = void*> static T get_MaxPlayers() {
		return ((T (*)(void *))(Il2CppBase() + 0x1508344))(0);
	}
	template <typename T = void*> static T get_MinPointsToReward() {
	...
	template <typename T = void*> static T get_PositionRewards() {
