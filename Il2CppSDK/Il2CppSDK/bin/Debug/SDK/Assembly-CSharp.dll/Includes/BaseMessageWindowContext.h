...
public: 
	...
	template <typename R = Il2CppString*> R& Button1() {
	 ...
	 Action1<int32_t>*& OnClose() {
		return *(Action1<int32_t>**)((uintptr_t)this + 0x30);
	}
	...
	template <typename R = Il2CppString*> R get_Button1() {
	 ...
	 Action1<int32_t>* get_OnClose() {
		return ((Action1<int32_t>* (*)(BaseMessageWindowContext*))(Il2CppBase() + 0x166F480))(this);
	}
