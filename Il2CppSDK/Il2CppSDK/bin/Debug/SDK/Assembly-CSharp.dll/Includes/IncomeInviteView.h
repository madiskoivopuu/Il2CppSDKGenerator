...
public: 
	...
	template <typename R = int64_t> R& _inviteId() {
	 ...
	 Action1IncomeInviteView*>*& _onIncomeInviteClicked() {
		return *(Action1IncomeInviteView*>**)((uintptr_t)this + 0x68);
	}
	...
	template <typename R = void> R Init(int64_t inviteId, Action1IncomeInviteView*>* onIncomeInviteClicked) {
		return ((R (*)(IncomeInviteView*, int64_t, Action1IncomeInviteView*>*))(Il2CppBase() + 0x1E3E188))(this, inviteId, onIncomeInviteClicked);
	}
