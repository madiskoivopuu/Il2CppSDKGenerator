...
public: 
	...
	template <typename T = void*> T& _onIncomeInviteClicked() {
	...
	template <typename T = void> T Init(int64_t inviteId, void* onIncomeInviteClicked) {
		return ((T (*)(IncomeInviteView*, int64_t, void*))(Il2CppBase() + 0x1E3E188))(this, inviteId, onIncomeInviteClicked);
	}
