...
public: 
	...
	template <typename T = void> T Show(uintptr_t screenPos, uintptr_t closeAction, Il2CppArray<uintptr_t>* actions) {
		return ((T (*)(ContextMenuView*, uintptr_t, uintptr_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x15F2954))(this, screenPos, closeAction, actions);
	}
	template <typename T = void> T Show_1(uintptr_t screenPos, Il2CppArray<uintptr_t>* actions) {
		return ((T (*)(ContextMenuView*, uintptr_t, Il2CppArray<uintptr_t>*))(Il2CppBase() + 0x15F2C7C))(this, screenPos, actions);
	}
	...
	template <typename T = uintptr_t> T GetAdjustedPosition(uintptr_t position) {
		return ((T (*)(ContextMenuView*, uintptr_t))(Il2CppBase() + 0x15F2A80))(this, position);
	}
