...
public: 
	...
	template <typename T = StandartButton*> T& TakeAllButton() {
		return *(T*)((uintptr_t)this + 0xB8);
	}
	template <typename T = Il2CppList<Prize*>*> T& _prizes() {
	...
	template <typename T = bool> T OnShowb__13_2(Reward* r) {
		return ((T (*)(ResultTournamentWindow*, Reward*))(Il2CppBase() + 0x119F414))(this, r);
	}
