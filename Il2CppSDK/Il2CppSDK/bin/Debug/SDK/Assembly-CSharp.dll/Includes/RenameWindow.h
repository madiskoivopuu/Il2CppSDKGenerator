...
public: 
	...
	template <typename T = void> T OnClanRenamed(uintptr_t errorCode) {
		return ((T (*)(RenameWindow*, uintptr_t))(Il2CppBase() + 0x13A2354))(this, errorCode);
	}
	template <typename T = void> T OnPlayerRenamed(uintptr_t errorCode) {
		return ((T (*)(RenameWindow*, uintptr_t))(Il2CppBase() + 0x13A259C))(this, errorCode);
	}
	template <typename T = void> T OnCloseClick() {
		return ((T (*)(RenameWindow*))(Il2CppBase() + 0x13A27E4))(this);
	}
	template <typename T = Il2CppString*> static T OnApplyClickg__getLocalizedNameError|15_0(uintptr_t ne) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x13A1B94))(0, ne);
	}
