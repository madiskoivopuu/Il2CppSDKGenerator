...
public: 
	...
	template <typename T = UIFXRarityController*> T& _cyclicItemMarkInstance() {
	...
	template <typename T = Action3Il2CppString*, int32_t, bool>*> T& OnClaimed() {
	...
	template <typename T = void> T set_TooltipView(TooltipView* value) {
		return ((T (*)(RewardResourceView*, TooltipView*))(Il2CppBase() + 0x11A03B8))(this, value);
	}
	...
	template <typename T = void> T set_Item(ItemEntity* value) {
		return ((T (*)(RewardResourceView*, ItemEntity*))(Il2CppBase() + 0x11A0D64))(this, value);
	}
	...
	template <typename T = void> T add_OnClaimed(Action3Il2CppString*, int32_t, bool>* value) {
		return ((T (*)(RewardResourceView*, Action3Il2CppString*, int32_t, bool>*))(Il2CppBase() + 0x11A0DC0))(this, value);
	}
	template <typename T = void> T remove_OnClaimed(Action3Il2CppString*, int32_t, bool>* value) {
		return ((T (*)(RewardResourceView*, Action3Il2CppString*, int32_t, bool>*))(Il2CppBase() + 0x11A0E60))(this, value);
	}
	template <typename T = void> T add_OnClick(Action1Il2CppString*>* value) {
		return ((T (*)(RewardResourceView*, Action1Il2CppString*>*))(Il2CppBase() + 0x11A0F00))(this, value);
	}
	template <typename T = void> T remove_OnClick(Action1Il2CppString*>* value) {
		return ((T (*)(RewardResourceView*, Action1Il2CppString*>*))(Il2CppBase() + 0x11A0FA0))(this, value);
	}
	...
	template <typename T = void> T Show(ItemEntity* item, int32_t count, bool premium, TooltipView* tooltipView) {
		return ((T (*)(RewardResourceView*, ItemEntity*, int32_t, bool, TooltipView*))(Il2CppBase() + 0x11991BC))(this, item, count, premium, tooltipView);
	}
	template <typename T = void> T Show_1(ItemEntity* item, int32_t count, bool premium) {
		return ((T (*)(RewardResourceView*, ItemEntity*, int32_t, bool))(Il2CppBase() + 0x119E7C8))(this, item, count, premium);
	}
