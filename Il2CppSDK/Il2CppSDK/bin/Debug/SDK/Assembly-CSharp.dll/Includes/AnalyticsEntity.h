...
public: 
	...
	template <typename T = uintptr_t> static T& firstTimeComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& oftenComponent() {
	...
	template <typename T = uintptr_t> T get_analyticsSystem() {
	...
	template <typename T = void> T AddAnalyticsSystem(uintptr_t newType) {
		return ((T (*)(AnalyticsEntity*, uintptr_t))(Il2CppBase() + 0x12A0C8C))(this, newType);
	}
	template <typename T = void> T ReplaceAnalyticsSystem(uintptr_t newType) {
		return ((T (*)(AnalyticsEntity*, uintptr_t))(Il2CppBase() + 0x12A0D90))(this, newType);
	}
	...
	template <typename T = uintptr_t> T get_eventName() {
	...
	template <typename T = uintptr_t> T get_playerLevel() {
	...
	template <typename T = uintptr_t> T get_sublabel() {
	...
	template <typename T = uintptr_t> T get_valueTwo() {
