...
public: 
	...
	template <typename T = uintptr_t> T BeginInvoke(float val, uintptr_t callback, uintptr_t object) {
		return ((T (*)(EndSliderDragEventHandler*, float, uintptr_t, uintptr_t))(Il2CppBase() + 0x13708C0))(this, val, callback, object);
	}
