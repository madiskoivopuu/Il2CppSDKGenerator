...
public: 
	...
	template <typename T = PremiumAsOneTimeRewardComponent*> static T& premiumAsOneTimeRewardComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = ResetCurrencyComponent*> static T& resetCurrencyComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	template <typename T = ShowInHUDComponent*> static T& showInHUDComponent() {
	...
	template <typename T = BattlePassViewComponent*> T get_battlePassView() {
	...
	template <typename T = ClaimRewardOffsetComponent*> T get_claimRewardOffset() {
	...
	template <typename T = void> T AddCurrencyType(CurrencyType* newType) {
		return ((T (*)(BattlePassEntity*, CurrencyType*))(Il2CppBase() + 0x16765F4))(this, newType);
	}
	template <typename T = void> T ReplaceCurrencyType(CurrencyType* newType) {
		return ((T (*)(BattlePassEntity*, CurrencyType*))(Il2CppBase() + 0x16766F8))(this, newType);
	}
	...
	template <typename T = ResetComponent*> T get_reset() {
	...
	template <typename T = void> T AddReset(int32_t newCircleDuration, int32_t newOffset, int32_t newReverseOffset, bool newRewardAfterActivity, bool newManual, ResetType* newResetTo) {
		return ((T (*)(BattlePassEntity*, int32_t, int32_t, int32_t, bool, bool, ResetType*))(Il2CppBase() + 0x1676F30))(this, newCircleDuration, newOffset, newReverseOffset, newRewardAfterActivity, newManual, newResetTo);
	}
	template <typename T = void> T ReplaceReset(int32_t newCircleDuration, int32_t newOffset, int32_t newReverseOffset, bool newRewardAfterActivity, bool newManual, ResetType* newResetTo) {
		return ((T (*)(BattlePassEntity*, int32_t, int32_t, int32_t, bool, bool, ResetType*))(Il2CppBase() + 0x1677070))(this, newCircleDuration, newOffset, newReverseOffset, newRewardAfterActivity, newManual, newResetTo);
	}
	...
	template <typename T = void> T AddTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, CyclicTime* newCyclic) {
		return ((T (*)(BattlePassEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, CyclicTime*))(Il2CppBase() + 0x167748C))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
	template <typename T = void> T ReplaceTemporary(int64_t newStartTime, int64_t newEndTime, int64_t newOBTStartTime, int64_t newOBTEndTime, int64_t newQAStartTime, int64_t newQAEndTime, CyclicTime* newCyclic) {
		return ((T (*)(BattlePassEntity*, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, CyclicTime*))(Il2CppBase() + 0x16775D8))(this, newStartTime, newEndTime, newOBTStartTime, newOBTEndTime, newQAStartTime, newQAEndTime, newCyclic);
	}
