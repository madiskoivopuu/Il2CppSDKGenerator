...
public: 
	...
	template <typename T = ExtendedDropdown*> T& bugTypeDropdown() {
	...
	template <typename T = bool> T HaveAvailableBugReport(AccountEntity* account) {
		return ((T (*)(BugReportWindow*, AccountEntity*))(Il2CppBase() + 0x15A21DC))(this, account);
	}
	template <typename T = Il2CppString*> T GetButtonTime(AccountEntity* account) {
		return ((T (*)(BugReportWindow*, AccountEntity*))(Il2CppBase() + 0x15A23AC))(this, account);
	}
	template <typename T = Il2CppString*> T GetFileName() {
		return ((T (*)(BugReportWindow*))(Il2CppBase() + 0x15A2638))(this);
	}
	template <typename T = BugReport*> T GetReportData(Il2CppString* fileName) {
	...
	template <typename T = void> T SendJson(Il2CppString* url, Il2CppString* json, UnityCommonLogger* logger) {
		return ((T (*)(BugReportWindow*, Il2CppString*, Il2CppString*, UnityCommonLogger*))(Il2CppBase() + 0x15A3D2C))(this, url, json, logger);
	}
	template <typename T = void> T SendData(Il2CppString* url, Il2CppString* json, Il2CppArray<uintptr_t>* logData, Il2CppString* fileName, UnityCommonLogger* logger) {
		return ((T (*)(BugReportWindow*, Il2CppString*, Il2CppString*, Il2CppArray<uintptr_t>*, Il2CppString*, UnityCommonLogger*))(Il2CppBase() + 0x15A3E54))(this, url, json, logData, fileName, logger);
	}
