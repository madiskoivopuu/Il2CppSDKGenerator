...
public: 
	...
	template <typename T = void> T set_SlotEntity(InventorySlotEntity* value) {
		return ((T (*)(RuneItemDragged*, InventorySlotEntity*))(Il2CppBase() + 0x1352978))(this, value);
	}
	...
	template <typename T = void> T set_RuneItemState(RuneItemState* value) {
		return ((T (*)(RuneItemDragged*, RuneItemState*))(Il2CppBase() + 0x1352CE0))(this, value);
	}
	template <typename T = void> T Bind(IRuneInventoryPanel* runePanel, Il2CppString* blueprint, int32_t index, bool isRuneItem) {
		return ((T (*)(RuneItemDragged*, IRuneInventoryPanel*, Il2CppString*, int32_t, bool))(Il2CppBase() + 0x1352CE8))(this, runePanel, blueprint, index, isRuneItem);
	}
