...
public: 
	...
	template <typename R = ICommonUnityWorld*> R& _world() {
	 ...
	 ICollector1ContactsEntity*>* GetTrigger(IContext1ContactsEntity*>* context) {
		return ((ICollector1ContactsEntity*>* (*)(OnContactChangeSystem*, IContext1ContactsEntity*>*))(Il2CppBase() + 0x11DC310))(this, context);
	}
