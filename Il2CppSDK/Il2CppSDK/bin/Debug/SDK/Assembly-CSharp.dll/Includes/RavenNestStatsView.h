...
public: 
	...
	template <typename T = Stat*> T& _stat() {
	...
	template <typename T = void> T ShowStat(Stat* stat) {
		return ((T (*)(RavenNestStatsView*, Stat*))(Il2CppBase() + 0x13906E4))(this, stat);
	}
	...
	template <typename T = Il2CppString*> T GetDestroyText(ItemCount* item) {
		return ((T (*)(RavenNestStatsView*, ItemCount*))(Il2CppBase() + 0x1391988))(this, item);
	}
	template <typename T = Il2CppString*> T GetKillText(ItemCount* item) {
		return ((T (*)(RavenNestStatsView*, ItemCount*))(Il2CppBase() + 0x1391CB8))(this, item);
	}
	template <typename T = Il2CppString*> T GetDeathText(ItemCount* item) {
		return ((T (*)(RavenNestStatsView*, ItemCount*))(Il2CppBase() + 0x13922CC))(this, item);
	}
	template <typename T = Il2CppString*> T GetStolenText(ItemCount* item) {
		return ((T (*)(RavenNestStatsView*, ItemCount*))(Il2CppBase() + 0x1391F24))(this, item);
	}
