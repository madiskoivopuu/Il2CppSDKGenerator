...
public: 
	...
	template <typename R = uint8_t> R& _cellId() {
	 ...
	 Nullable1<int32_t>*& _treesCount() {
		return *(Nullable1<int32_t>**)((uintptr_t)this + 0x1C0);
	}
	 Nullable1<Status>*& _status() {
		return *(Nullable1<Status>**)((uintptr_t)this + 0x1C8);
	}
	 HashSet1<Il2CppString*>*& _needResources() {
		return *(HashSet1<Il2CppString*>**)((uintptr_t)this + 0x1D0);
	}
	...
	template <typename R = void> R Awake() {
	 ...
	 HashSet1<Il2CppString*>* GetNeedResources() {
		return ((HashSet1<Il2CppString*>* (*)(TreePlantWindow*))(Il2CppBase() + 0x1523074))(this);
	}
	...
	template <typename R = void> R OnSkipClick() {
	 ...
	 ValueTuple2<bool, int32_t>* CanSkip(GameEntity* target) {
		return ((ValueTuple2<bool, int32_t>* (*)(TreePlantWindow*, GameEntity*))(Il2CppBase() + 0x1524D74))(this, target);
	}
