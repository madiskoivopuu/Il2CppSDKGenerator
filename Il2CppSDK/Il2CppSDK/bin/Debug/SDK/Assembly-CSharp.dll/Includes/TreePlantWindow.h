...
public: 
	...
	template <typename T = PrerequisiteContainer*> T& GardenContainer() {
	...
	template <typename T = GameDataEntity*> T& _treeData() {
	...
	template <typename T = Nullable1int32_t>*> T& _treesCount() {
		return *(T*)((uintptr_t)this + 0x1C0);
	}
	template <typename T = Nullable1Status*>*> T& _status() {
	...
	template <typename T = void> T OnDrop(IInventoryItem* item) {
		return ((T (*)(TreePlantWindow*, IInventoryItem*))(Il2CppBase() + 0x1524174))(this, item);
	}
	template <typename T = void> T NotifyServerAndClose() {
		return ((T (*)(TreePlantWindow*))(Il2CppBase() + 0x1524648))(this);
	}
	template <typename T = int32_t> T GetTreesCount(GameEntity* target) {
		return ((T (*)(TreePlantWindow*, GameEntity*))(Il2CppBase() + 0x15248B0))(this, target);
	}
	template <typename T = void> T OnSkipClick() {
		return ((T (*)(TreePlantWindow*))(Il2CppBase() + 0x1524B4C))(this);
	}
	template <typename T = ValueTuple2bool, int32_t>*> T CanSkip(GameEntity* target) {
		return ((T (*)(TreePlantWindow*, GameEntity*))(Il2CppBase() + 0x1524D74))(this, target);
	}
	template <typename T = Status*> T GetStatus(GameEntity* target, int32_t count, int64_t now) {
		return ((T (*)(TreePlantWindow*, GameEntity*, int32_t, int64_t))(Il2CppBase() + 0x1524FD0))(this, target, count, now);
	}
	template <typename T = void> T UpdateStatus(GameEntity* target) {
		return ((T (*)(TreePlantWindow*, GameEntity*))(Il2CppBase() + 0x1523A44))(this, target);
	}
	template <typename T = void> T OnUpdateDraw(float deltaTime) {
		return ((T (*)(TreePlantWindow*, float))(Il2CppBase() + 0x1525054))(this, deltaTime);
	}
	template <typename T = bool> T GetTreesCountb__26_0(GameEntity* e) {
		return ((T (*)(TreePlantWindow*, GameEntity*))(Il2CppBase() + 0x15251B0))(this, e);
	}
	template <typename T = bool> T GetTreesCountb__26_1(GameEntity* e) {
		return ((T (*)(TreePlantWindow*, GameEntity*))(Il2CppBase() + 0x1525228))(this, e);
	}
