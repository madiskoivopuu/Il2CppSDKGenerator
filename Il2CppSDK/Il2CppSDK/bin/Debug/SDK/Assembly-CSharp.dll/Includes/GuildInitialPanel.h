...
public: 
	...
	template <typename T = StandartButton*> T& CreateGuildButton() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = StandartButton*> T& SearchGuildButton() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = StandartButton*> T& StopSearchGuildButton() {
	...
	template <typename T = void> T Bind(UIWindow* window) {
		return ((T (*)(GuildInitialPanel*, UIWindow*))(Il2CppBase() + 0x1B2825C))(this, window);
	}
