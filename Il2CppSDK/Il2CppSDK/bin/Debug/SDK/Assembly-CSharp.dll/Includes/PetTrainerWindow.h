...
public: 
	...
	template <typename T = StandartButton*> T& _gradeUpBtn() {
	...
	template <typename T = InventorySlotEntity*> T& _currentPetSlot() {
		return *(T*)((uintptr_t)this + 0x188);
	}
	template <typename T = ItemEntity*> T& _currentPet() {
	...
	template <typename T = void> T SelectPet(InventorySlotEntity* petSlot) {
		return ((T (*)(PetTrainerWindow*, InventorySlotEntity*))(Il2CppBase() + 0x16EEC80))(this, petSlot);
	}
	template <typename T = void> T SelectSkill(int32_t index) {
		return ((T (*)(PetTrainerWindow*, int32_t))(Il2CppBase() + 0x16EF240))(this, index);
	}
	template <typename T = void> T UpdateResources(Il2CppArray<uintptr_t>* resources, GameEntity* avatar) {
		return ((T (*)(PetTrainerWindow*, Il2CppArray<uintptr_t>*, GameEntity*))(Il2CppBase() + 0x16EF75C))(this, resources, avatar);
	}
	template <typename T = void> T OnSelect(IInventoryItem* item) {
		return ((T (*)(PetTrainerWindow*, IInventoryItem*))(Il2CppBase() + 0x16F0018))(this, item);
	}
	...
	template <typename T = void> T OnGradeUpSkillResult(GradeUpPetSkillDataResult* data) {
		return ((T (*)(PetTrainerWindow*, GradeUpPetSkillDataResult*))(Il2CppBase() + 0x16F0A38))(this, data);
	}
