...
public: 
	...
	template <typename T = PrimaryEntityIndex2PlayerEntity*, int64_t>*> T& _playerIdIndex() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = EntityIndex2PlayerEntity*, int64_t>*> T& _clanIdIndex() {
		return *(T*)((uintptr_t)this + 0x100);
	}
	template <typename T = EntityIndex2PlayerEntity*, int64_t>*> T& _guildIdIndex() {
		return *(T*)((uintptr_t)this + 0x108);
	}
	template <typename T = EntityIndex2PlayerEntity*, int64_t>*> T& _tournamentIdIndex() {
	...
	template <typename T = PlayerEntity*> T GetEntityWithPlayerId(int64_t value) {
		return ((T (*)(PlayerContext*, int64_t))(Il2CppBase() + 0x1562364))(this, value);
	}
	template <typename T = HashSet1PlayerEntity*>*> T GetEntitiesWithClanId(int64_t value) {
		return ((T (*)(PlayerContext*, int64_t))(Il2CppBase() + 0x15623C8))(this, value);
	}
	template <typename T = HashSet1PlayerEntity*>*> T GetEntitiesWithGuildId(int64_t value) {
		return ((T (*)(PlayerContext*, int64_t))(Il2CppBase() + 0x156242C))(this, value);
	}
	template <typename T = PlayerEntity*> T GetEntityWithClanIdInCell(int64_t clanId, uint8_t cellId) {
		return ((T (*)(PlayerContext*, int64_t, uint8_t))(Il2CppBase() + 0x1562490))(this, clanId, cellId);
	}
	template <typename T = HashSet1PlayerEntity*>*> T GetEntitiesWithTournamentId(int64_t Value) {
	...
	template <typename T = PlayerEntity*> T get_avatarEntity() {
