...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 PrimaryEntityIndex2<PlayerEntity*, int64_t>*& _playerIdIndex() {
		return *(PrimaryEntityIndex2<PlayerEntity*, int64_t>**)((uintptr_t)this + 0xF8);
	}
	 EntityIndex2<PlayerEntity*, int64_t>*& _clanIdIndex() {
		return *(EntityIndex2<PlayerEntity*, int64_t>**)((uintptr_t)this + 0x100);
	}
	 EntityIndex2<PlayerEntity*, int64_t>*& _guildIdIndex() {
		return *(EntityIndex2<PlayerEntity*, int64_t>**)((uintptr_t)this + 0x108);
	}
	 EntityIndex2<PlayerEntity*, int64_t>*& _tournamentIdIndex() {
		return *(EntityIndex2<PlayerEntity*, int64_t>**)((uintptr_t)this + 0x110);
	}
	...
	template <typename R = PlayerEntity*> R GetEntityWithPlayerId(int64_t value) {
	 ...
	 HashSet1<PlayerEntity*>* GetEntitiesWithClanId(int64_t value) {
		return ((HashSet1<PlayerEntity*>* (*)(PlayerContext*, int64_t))(Il2CppBase() + 0x15623C8))(this, value);
	}
	 HashSet1<PlayerEntity*>* GetEntitiesWithGuildId(int64_t value) {
		return ((HashSet1<PlayerEntity*>* (*)(PlayerContext*, int64_t))(Il2CppBase() + 0x156242C))(this, value);
	}
	template <typename R = PlayerEntity*> R GetEntityWithClanIdInCell(int64_t clanId, uint8_t cellId) {
	 ...
	 HashSet1<PlayerEntity*>* GetEntitiesWithTournamentId(int64_t Value) {
		return ((HashSet1<PlayerEntity*>* (*)(PlayerContext*, int64_t))(Il2CppBase() + 0x15626B0))(this, Value);
	}
