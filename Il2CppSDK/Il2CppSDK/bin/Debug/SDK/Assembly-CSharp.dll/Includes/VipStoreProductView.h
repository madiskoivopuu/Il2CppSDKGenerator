...
public: 
	...
	template <typename T = void> T Init(Il2CppString* blueprintName, uintptr_t tooltipView) {
		return ((T (*)(VipStoreProductView*, Il2CppString*, uintptr_t))(Il2CppBase() + 0x15CE4F4))(this, blueprintName, tooltipView);
	}
