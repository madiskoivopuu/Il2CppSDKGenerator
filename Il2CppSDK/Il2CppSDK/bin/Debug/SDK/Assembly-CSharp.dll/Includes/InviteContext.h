...
public: 
	...
	template <typename R = InviteEntity*> R GetEntityWithId(int64_t id) {
	 ...
	 HashSet1InviteEntity*>* GetEntitiesWithFromPlayerId(int64_t fromPlayerId) {
		return ((HashSet1InviteEntity*>* (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245970))(this, fromPlayerId);
	}
	...
	template <typename R = InviteEntity*> R GetReverseEntity(int64_t toPlayerId) {
	 ...
	 HashSet1InviteEntity*>* GetIncomeEntities(int64_t toPlayerId) {
		return ((HashSet1InviteEntity*>* (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245C1C))(this, toPlayerId);
	}
	 HashSet1InviteEntity*>* GetOutcomeEntities(int64_t fromPlayerId) {
		return ((HashSet1InviteEntity*>* (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245CDC))(this, fromPlayerId);
	}
