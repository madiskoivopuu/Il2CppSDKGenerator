...
public: 
	...
	template <typename T = InviteEntity*> T GetEntityWithId(int64_t id) {
		return ((T (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245894))(this, id);
	}
	template <typename T = HashSet1InviteEntity*>*> T GetEntitiesWithFromPlayerId(int64_t fromPlayerId) {
		return ((T (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245970))(this, fromPlayerId);
	}
	template <typename T = InviteEntity*> T GetEntityWithFromPlayerIdInCell(int64_t fromPlayerId, uint8_t cellId) {
		return ((T (*)(InviteContext*, int64_t, uint8_t))(Il2CppBase() + 0x1245A30))(this, fromPlayerId, cellId);
	}
	template <typename T = InviteEntity*> T GetReverseEntity(int64_t toPlayerId) {
		return ((T (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245B40))(this, toPlayerId);
	}
	template <typename T = HashSet1InviteEntity*>*> T GetIncomeEntities(int64_t toPlayerId) {
		return ((T (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245C1C))(this, toPlayerId);
	}
	template <typename T = HashSet1InviteEntity*>*> T GetOutcomeEntities(int64_t fromPlayerId) {
		return ((T (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245CDC))(this, fromPlayerId);
	}
	template <typename T = InviteEntity*> T get_Item(int64_t id) {
		return ((T (*)(InviteContext*, int64_t))(Il2CppBase() + 0x1245D9C))(this, id);
	}
	template <typename T = InviteEntity*> T CreateEntityWithId(int64_t id) {
