...
public: 
	...
	template <typename T = bool> T Equals(StringString* other) {
		return ((T (*)(StringString*, StringString*))(Il2CppBase() + 0x16A0944))(this, other);
	}
	template <typename T = bool> T Equals_1(Il2CppObject* obj) {
		return ((T (*)(StringString*, Il2CppObject*))(Il2CppBase() + 0x16A0990))(this, obj);
	}
