...
public: 
	...
	template <typename T = uintptr_t> static T& showToNewPlayersComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x8);
	}

	template <typename T = uintptr_t> T get_availablePlatform() {
	...
	template <typename T = void> T AddAvailablePlatform(uintptr_t newType) {
		return ((T (*)(NewsEntity*, uintptr_t))(Il2CppBase() + 0x13AE868))(this, newType);
	}
	template <typename T = void> T ReplaceAvailablePlatform(uintptr_t newType) {
		return ((T (*)(NewsEntity*, uintptr_t))(Il2CppBase() + 0x13AE96C))(this, newType);
	}
	...
	template <typename T = uintptr_t> T get_invalidationDate() {
