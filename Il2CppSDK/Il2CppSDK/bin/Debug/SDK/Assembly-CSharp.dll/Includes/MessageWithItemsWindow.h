...
public: 
	...
	template <typename R = void> R OnHold(Il2CppString* blueprint, Nullable1int64_t>* showGhostyEndTime) {
		return ((R (*)(MessageWithItemsWindow*, Il2CppString*, Nullable1int64_t>*))(Il2CppBase() + 0x12D0328))(this, blueprint, showGhostyEndTime);
	}
