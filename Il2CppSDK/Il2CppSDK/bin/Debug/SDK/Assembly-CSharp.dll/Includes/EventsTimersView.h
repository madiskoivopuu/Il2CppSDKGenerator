...
public: 
	...
	template <typename T = bool> T AddITemporaryEntityIfNeeded(Il2CppString* blueprint, uintptr_t icon, int64_t selectedTime, int64_t startTime, int64_t endTime, Il2CppString* prefix, int32_t itemIndex) {
		return ((T (*)(EventsTimersView*, Il2CppString*, uintptr_t, int64_t, int64_t, int64_t, Il2CppString*, int32_t))(Il2CppBase() + 0x1794184))(this, blueprint, icon, selectedTime, startTime, endTime, prefix, itemIndex);
	}
