...
public: 
	...
	template <typename R = ActionDataContext*> R& Data() {
	 ...
	 PrimaryEntityIndex2<ActionEntity*, int32_t>*& _idIndex() {
		return *(PrimaryEntityIndex2<ActionEntity*, int32_t>**)((uintptr_t)this + 0x118);
	}
	 PrimaryEntityIndex2<ActionEntity*, int32_t>*& _currentForActorIndex() {
		return *(PrimaryEntityIndex2<ActionEntity*, int32_t>**)((uintptr_t)this + 0x120);
	}
	 PrimaryEntityIndex2<ActionEntity*, int32_t>*& _moveToTargetForActorIndex() {
		return *(PrimaryEntityIndex2<ActionEntity*, int32_t>**)((uintptr_t)this + 0x128);
	}
	 EntityIndex2<ActionEntity*, int32_t>*& _actorIndex() {
		return *(EntityIndex2<ActionEntity*, int32_t>**)((uintptr_t)this + 0x130);
	}
	 EntityIndex2<ActionEntity*, int32_t>*& _targetIndex() {
		return *(EntityIndex2<ActionEntity*, int32_t>**)((uintptr_t)this + 0x138);
	}
	 EntityIndex2<ActionEntity*, int32_t>*& _inventoryItemIndex() {
		return *(EntityIndex2<ActionEntity*, int32_t>**)((uintptr_t)this + 0x140);
	}
	...
	template <typename R = ActionEntity*> R GetEntityWithId(int32_t id) {
	 ...
	 HashSet1<ActionEntity*>* GetEntitiesWithSlotId(int32_t slotId) {
		return ((HashSet1<ActionEntity*>* (*)(ActionContext*, int32_t))(Il2CppBase() + 0x1DBEBD8))(this, slotId);
	}
	...
	template <typename R = ActionEntity*> R GetCurrentMoveToTargetForActor(int32_t actorId) {
	 ...
	 HashSet1<ActionEntity*>* GetForActor(int32_t actorId) {
		return ((HashSet1<ActionEntity*>* (*)(ActionContext*, int32_t))(Il2CppBase() + 0x1DBED80))(this, actorId);
	}
	 HashSet1<ActionEntity*>* GetWithTarget(int32_t targetId) {
		return ((HashSet1<ActionEntity*>* (*)(ActionContext*, int32_t))(Il2CppBase() + 0x1DBEDE4))(this, targetId);
	}
