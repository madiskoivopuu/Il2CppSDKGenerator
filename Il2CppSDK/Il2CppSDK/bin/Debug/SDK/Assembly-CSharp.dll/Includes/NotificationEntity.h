...
public: 
	...
	template <typename T = NotificationTypeComponent*> T get_notificationType() {
	...
	template <typename T = void> T AddNotificationType(ServerNotificationType* newType) {
		return ((T (*)(NotificationEntity*, ServerNotificationType*))(Il2CppBase() + 0x13B92E0))(this, newType);
	}
	template <typename T = void> T ReplaceNotificationType(ServerNotificationType* newType) {
		return ((T (*)(NotificationEntity*, ServerNotificationType*))(Il2CppBase() + 0x13B93E4))(this, newType);
	}
