...
public: 
	...
	template <typename T = void> T Bind(uintptr_t window, uintptr_t storeDataEntity, void* onBuyButtonClick) {
		return ((T (*)(PremiumBPItem*, uintptr_t, uintptr_t, void*))(Il2CppBase() + 0x16DF924))(this, window, storeDataEntity, onBuyButtonClick);
	}
