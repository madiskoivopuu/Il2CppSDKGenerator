...
public: 
	...
	template <typename R = UIWindow*> R& _window() {
	 ...
	 Action1Il2CppString*>*& OnButtonClick() {
		return *(Action1Il2CppString*>**)((uintptr_t)this + 0x98);
	}

	template <typename R = void> R Bind(UIWindow* window, Store2DataEntity* storeDataEntity, Action1Il2CppString*>* onBuyButtonClick) {
		return ((R (*)(PremiumBPItem*, UIWindow*, Store2DataEntity*, Action1Il2CppString*>*))(Il2CppBase() + 0x16DF924))(this, window, storeDataEntity, onBuyButtonClick);
	}
