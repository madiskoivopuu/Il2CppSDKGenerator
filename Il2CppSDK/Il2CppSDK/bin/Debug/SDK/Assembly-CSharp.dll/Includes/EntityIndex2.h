...
public: 
	...
	static Il2CppClass *StaticClass() {
	 ...
	 Il2CppDictionary<TKey, HashSet1<TEntity>*>*& _index() {
		return *(Il2CppDictionary<TKey, HashSet1<TEntity>*>**)((uintptr_t)this + 0x0);
	}
	...
	template <typename R = void> R Activate() {
	 ...
	 HashSet1<TEntity>* GetEntities(TKey key) {
		return ((HashSet1<TEntity>* (*)(EntityIndex2*, TKey))(Il2CppBase() + 0x0))(this, key);
	}
