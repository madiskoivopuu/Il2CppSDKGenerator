...
public: 
	...
	template <typename R = void> R Init(UIWindow* window, ContactsPanel* contactsPanel, ChatRoom* room, ChatChannelData* channelData, Action1ChannelView*>* onClicked) {
		return ((R (*)(ContactsChannelView*, UIWindow*, ContactsPanel*, ChatRoom*, ChatChannelData*, Action1ChannelView*>*))(Il2CppBase() + 0x15EBA1C))(this, window, contactsPanel, room, channelData, onClicked);
	}
