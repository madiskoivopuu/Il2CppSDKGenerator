...
public: 
	...
	template <typename R = ICommonLogger*> R& Logger() {
	 ...
	 Action1uintptr_t>*& OnDisconnectHandler() {
		return *(Action1uintptr_t>**)((uintptr_t)this + 0x30);
	}
	template <typename R = bool> R& PollEventsPaused() {
		return *(R*)((uintptr_t)this + 0x38);
	}
	 Queue1ValueTuple2uintptr_t, uintptr_t>*>*& _bufferedEvents() {
		return *(Queue1ValueTuple2uintptr_t, uintptr_t>*>**)((uintptr_t)this + 0x40);
	}
