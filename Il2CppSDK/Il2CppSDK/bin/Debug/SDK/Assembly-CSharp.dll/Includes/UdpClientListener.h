...
public: 
	...
	template <typename T = UdpClientConfig*> T& Config() {
		return *(T*)((uintptr_t)this + 0x20);
	}
	template <typename T = ICommonLogger*> T& Logger() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = Action1uintptr_t>*> T& OnDisconnectHandler() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = bool> T& PollEventsPaused() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = Queue1ValueTuple2uintptr_t, uintptr_t>*>*> T& _bufferedEvents() {
	...
	template <typename T = void> T OnNetworkReceive(uintptr_t peer, uintptr_t reader, uint8_t channelId, uintptr_t deliveryMethod) {
		return ((T (*)(UdpClientListener*, uintptr_t, uintptr_t, uint8_t, uintptr_t))(Il2CppBase() + 0x15366E8))(this, peer, reader, channelId, deliveryMethod);
	}
