...
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> T& _steps() {
	...
	template <typename T = void> T AddStep(uintptr_t step) {
		return ((T (*)(GameLoader*, uintptr_t))(Il2CppBase() + 0x174E704))(this, step);
	}
