...
public: 
	...
	template <typename T = uintptr_t> T& _beginDragItem() {
	...
	template <typename T = void> T Bind(uintptr_t window) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145BC94))(this, window);
	}
	template <typename T = void> T OnBeginDrag(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t, uintptr_t))(Il2CppBase() + 0x145C19C))(this, item, eventData);
	}
	template <typename T = void> T OnDrag(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t, uintptr_t))(Il2CppBase() + 0x145C1CC))(this, item, eventData);
	}
	template <typename T = void> T OnDrop(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145C3A8))(this, item);
	}
	template <typename T = void> T OnEndDrag(uintptr_t item, uintptr_t eventData) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t, uintptr_t))(Il2CppBase() + 0x145C3AC))(this, item, eventData);
	}
	template <typename T = void> T OnHold(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145C3C8))(this, item);
	}
	template <typename T = void> T OnRelease(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145C4CC))(this, item);
	}
	template <typename T = void> T OnDoubleClick(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145CB98))(this, item);
	}
	template <typename T = void> T OnSelect(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145CE70))(this, item);
	}
	template <typename T = void> T EquipItem(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145CB9C))(this, item);
	}
	template <typename T = void> T UseItem(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145C6C8))(this, item);
	}
	...
	template <typename T = void> T CheckItemIsLocked(uintptr_t item) {
		return ((T (*)(HUDInventoryPanel*, uintptr_t))(Il2CppBase() + 0x145CED8))(this, item);
	}
