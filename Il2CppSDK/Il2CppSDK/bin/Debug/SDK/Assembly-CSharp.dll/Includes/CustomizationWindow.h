...
public: 
	...
	template <typename T = CosmeticItemView*> T& _slotViewPrefab() {
		return *(T*)((uintptr_t)this + 0xE8);
	}
	template <typename T = Il2CppList<CosmeticItemView*>*> T& _slotViews() {
		return *(T*)((uintptr_t)this + 0xF0);
	}
	template <typename T = uintptr_t> T& _itemsContainer() {
		return *(T*)((uintptr_t)this + 0xF8);
	}
	template <typename T = CosmeticItemView*> T& _itemViewPrefab() {
		return *(T*)((uintptr_t)this + 0x100);
	}
	template <typename T = Il2CppList<CosmeticItemView*>*> T& _itemViews() {
		return *(T*)((uintptr_t)this + 0x108);
	}
	template <typename T = Il2CppDictionary<Il2CppString*, bool>*> T& _availableCosmetics() {
		return *(T*)((uintptr_t)this + 0x110);
	}
	template <typename T = CosmeticItemView*> T& _currentSlotView() {
		return *(T*)((uintptr_t)this + 0x118);
	}
	template <typename T = CosmeticItemView*> T& _currentItemView() {
	...
	template <typename T = void> T SetupCosmeticsSlots(GameEntity* puppet) {
		return ((T (*)(CustomizationWindow*, GameEntity*))(Il2CppBase() + 0x163C6EC))(this, puppet);
	}
	template <typename T = bool> T HasNew(EquipmentType* equipmentType) {
		return ((T (*)(CustomizationWindow*, EquipmentType*))(Il2CppBase() + 0x163CC68))(this, equipmentType);
	}
	template <typename T = void> T OnUpdateDraw(float deltaTime) {
		return ((T (*)(CustomizationWindow*, float))(Il2CppBase() + 0x163D664))(this, deltaTime);
	}
	template <typename T = void> T CosmeticSlot_OnClick(CosmeticItemView* slotView) {
		return ((T (*)(CustomizationWindow*, CosmeticItemView*))(Il2CppBase() + 0x163DB2C))(this, slotView);
	}
	template <typename T = void> T SetCurrentCosmeticSlot(CosmeticItemView* slotView) {
		return ((T (*)(CustomizationWindow*, CosmeticItemView*))(Il2CppBase() + 0x163CE40))(this, slotView);
	}
	template <typename T = void> T CosmeticItem_OnClick(CosmeticItemView* item) {
		return ((T (*)(CustomizationWindow*, CosmeticItemView*))(Il2CppBase() + 0x163DFCC))(this, item);
	}
	template <typename T = void> T SetCurrentCosmeticItem(CosmeticItemView* item) {
		return ((T (*)(CustomizationWindow*, CosmeticItemView*))(Il2CppBase() + 0x163DBC4))(this, item);
	}
	...
	template <typename T = void> T SetupGender(Gender* gender) {
		return ((T (*)(CustomizationWindow*, Gender*))(Il2CppBase() + 0x163C20C))(this, gender);
	}
	...
	template <typename T = bool> T SetCurrentCosmeticSlotb__30_0(ItemEntity* c) {
		return ((T (*)(CustomizationWindow*, ItemEntity*))(Il2CppBase() + 0x163E874))(this, c);
	}
