...
public: 
	...
	template <typename R = bool> static R IsFirstClass(ItemEntity* classEntity) {
	 ...
	 static ValueTuple3<bool, int32_t, int32_t>* IsInfinityBattlePassStep(ItemEntity* bpEntity, int32_t currentCurrencyValue) {
		return ((ValueTuple3<bool, int32_t, int32_t>* (*)(void *, ItemEntity*, int32_t))(Il2CppBase() + 0x14CA190))(0, bpEntity, currentCurrencyValue);
	}
	...
	template <typename R = void> static R FillEquipMagics(ItemEntity* item, ICommonContexts* world, Il2CppList<MagicDataEntity*>* buffer, Predicate1<MagicDataEntity*>* predicate) {
		return ((R (*)(void *, ItemEntity*, ICommonContexts*, Il2CppList<MagicDataEntity*>*, Predicate1<MagicDataEntity*>*))(Il2CppBase() + 0x14CAB6C))(0, item, world, buffer, predicate);
	}
