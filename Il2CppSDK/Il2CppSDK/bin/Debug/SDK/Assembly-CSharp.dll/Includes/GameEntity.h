...
public: 
	...
	template <typename R = void> R AddInteractTarget(int32_t newId, Nullable1<Vec2>* newPosition) {
		return ((R (*)(GameEntity*, int32_t, Nullable1<Vec2>*))(Il2CppBase() + 0xF9CCA8))(this, newId, newPosition);
	}
	template <typename R = void> R ReplaceInteractTarget(int32_t newId, Nullable1<Vec2>* newPosition) {
		return ((R (*)(GameEntity*, int32_t, Nullable1<Vec2>*))(Il2CppBase() + 0xF9CDC4))(this, newId, newPosition);
	}
	...
	template <typename R = void> R AddOnEmptyWorld(Nullable1<bool>* newActive, bool newRestore, bool newDestroy) {
		return ((R (*)(GameEntity*, Nullable1<bool>*, bool, bool))(Il2CppBase() + 0xFA4130))(this, newActive, newRestore, newDestroy);
	}
	template <typename R = void> R ReplaceOnEmptyWorld(Nullable1<bool>* newActive, bool newRestore, bool newDestroy) {
		return ((R (*)(GameEntity*, Nullable1<bool>*, bool, bool))(Il2CppBase() + 0xFA4254))(this, newActive, newRestore, newDestroy);
	}
	...
	template <typename R = void> R AddTeam(uint8_t newId, bool newSource, Il2CppString* newRandomByTag, HashSet1<int64_t>* newClanIds) {
		return ((R (*)(GameEntity*, uint8_t, bool, Il2CppString*, HashSet1<int64_t>*))(Il2CppBase() + 0xFAF7E8))(this, newId, newSource, newRandomByTag, newClanIds);
	}
	template <typename R = void> R ReplaceTeam(uint8_t newId, bool newSource, Il2CppString* newRandomByTag, HashSet1<int64_t>* newClanIds) {
		return ((R (*)(GameEntity*, uint8_t, bool, Il2CppString*, HashSet1<int64_t>*))(Il2CppBase() + 0xFAF92C))(this, newId, newSource, newRandomByTag, newClanIds);
	}
