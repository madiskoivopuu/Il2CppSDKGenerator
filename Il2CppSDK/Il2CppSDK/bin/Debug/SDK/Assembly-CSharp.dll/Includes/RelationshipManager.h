...
public: 
	...
	template <typename R = RelationshipRules> R& Rule() {
	 ...
	 static HashSet1<GameEntity*>*& _emptyGameEntitySet() {
		return *(HashSet1<GameEntity*>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	 static HashSet1<AccountEntity*>*& _emptyAccountEntitySet() {
		return *(HashSet1<AccountEntity*>**)((uintptr_t)StaticClass()->static_fields + 0x8);
	}
	...
	template <typename R = void> R SetTeamId(IClanGuildEntity* entity, int64_t teamId) {
	 ...
	 HashSet1<AccountEntity*>* GetTeamAccounts(IClanGuildEntity* forEntity) {
		return ((HashSet1<AccountEntity*>* (*)(RelationshipManager*, IClanGuildEntity*))(Il2CppBase() + 0x139F700))(this, forEntity);
	}
	 HashSet1<GameEntity*>* GetTeamAvatars(IClanGuildEntity* forEntity) {
		return ((HashSet1<GameEntity*>* (*)(RelationshipManager*, IClanGuildEntity*))(Il2CppBase() + 0x139FB24))(this, forEntity);
	}
