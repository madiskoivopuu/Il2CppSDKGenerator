...
public: 
	...
	template <typename R = Il2CppString*> R& _blueprint() {
	 ...
	 Action1PlayerClassMenuBtn*>*& SelectedEvent() {
		return *(Action1PlayerClassMenuBtn*>**)((uintptr_t)this + 0x80);
	}
	 Action1PlayerClassMenuBtn*>*& DeselectedEvent() {
		return *(Action1PlayerClassMenuBtn*>**)((uintptr_t)this + 0x88);
	}

	template <typename R = ItemEntity*> R get_ClassEntity() {
		return ((R (*)(PlayerClassMenuBtn*))(Il2CppBase() + 0x1B678B4))(this);
	}
	template <typename R = void> R add_SelectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((R (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B679B8))(this, value);
	}
	template <typename R = void> R remove_SelectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((R (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B67A58))(this, value);
	}
	template <typename R = void> R add_DeselectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((R (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B67AF8))(this, value);
	}
	template <typename R = void> R remove_DeselectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((R (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B67B98))(this, value);
	}
