...
public: 
	...
	template <typename T = Action1PlayerClassMenuBtn*>*> T& SelectedEvent() {
		return *(T*)((uintptr_t)this + 0x80);
	}
	template <typename T = Action1PlayerClassMenuBtn*>*> T& DeselectedEvent() {
	...
	template <typename T = void> T add_SelectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((T (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B679B8))(this, value);
	}
	template <typename T = void> T remove_SelectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((T (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B67A58))(this, value);
	}
	template <typename T = void> T add_DeselectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((T (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B67AF8))(this, value);
	}
	template <typename T = void> T remove_DeselectedEvent(Action1PlayerClassMenuBtn*>* value) {
		return ((T (*)(PlayerClassMenuBtn*, Action1PlayerClassMenuBtn*>*))(Il2CppBase() + 0x1B67B98))(this, value);
	}
	template <typename T = void> T Awake() {
		return ((T (*)(PlayerClassMenuBtn*))(Il2CppBase() + 0x1B67C38))(this);
	}
	template <typename T = void> T Init(ItemEntity* classEntity, bool available) {
		return ((T (*)(PlayerClassMenuBtn*, ItemEntity*, bool))(Il2CppBase() + 0x1B67EA8))(this, classEntity, available);
	}
