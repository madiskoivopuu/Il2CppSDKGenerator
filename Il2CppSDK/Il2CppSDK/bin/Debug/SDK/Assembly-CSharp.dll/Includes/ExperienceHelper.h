...
public: 
	...
	template <typename T = int32_t> static T GetTotalLevelCap(uintptr_t account) {
		return ((T (*)(void *, uintptr_t))(Il2CppBase() + 0x16850F0))(0, account);
	}
	template <typename T = void*> static T GetProgress(Il2CppArray<uintptr_t>* levels, float level) {
		return ((T (*)(void *, Il2CppArray<uintptr_t>*, float))(Il2CppBase() + 0x1685270))(0, levels, level);
	}
	template <typename T = void*> static T GetConvertProgress(float level) {
