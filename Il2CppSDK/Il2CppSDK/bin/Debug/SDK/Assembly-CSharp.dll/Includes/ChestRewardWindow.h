...
public: 
	...
	template <typename T = TooltipTrigger*> T& GuildCoinsTooltipTrigger() {
	...
	template <typename T = StoreProductContentSlotView*> T& RewardView() {
	...
	template <typename T = StandartButton*> T& RollButton() {
	...
	template <typename T = SpriteEffectHelper*> T& RewardEffectPrefab() {
	...
	template <typename T = void> T OnReceivedRollGuildRewardResponse(RollChestRewardResponse* data) {
		return ((T (*)(ChestRewardWindow*, RollChestRewardResponse*))(Il2CppBase() + 0x17420C4))(this, data);
	}
