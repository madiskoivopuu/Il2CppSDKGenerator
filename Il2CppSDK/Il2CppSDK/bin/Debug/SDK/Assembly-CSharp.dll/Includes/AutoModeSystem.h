...
public: 
	...
	template <typename R = float> static R& AggroRadius() {
	 ...
	 IGroup1<GameEntity*>*& _miningTargets() {
	...
	template <typename R = GameEntity*> R SelectAttackTarget(GameEntity* entity, EntitiesWithPositionNear1<GameEntity*>* entitiesNear) {
		return ((R (*)(AutoModeSystem*, GameEntity*, EntitiesWithPositionNear1<GameEntity*>*))(Il2CppBase() + 0x1A64B64))(this, entity, entitiesNear);
	}
	 ValueTuple2<CantCollectReason, GameEntity*>* SelectResourceTarget(GameEntity* entity) {
		return ((ValueTuple2<CantCollectReason, GameEntity*>* (*)(AutoModeSystem*, GameEntity*))(Il2CppBase() + 0x1A650B4))(this, entity);
	}
