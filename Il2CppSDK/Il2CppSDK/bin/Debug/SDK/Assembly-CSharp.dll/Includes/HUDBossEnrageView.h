...
public: 
	...
	template <typename T = EnrageTracker*> T& _tracker() {
		return *(T*)((uintptr_t)this + 0x30);
	}

	template <typename T = void> T UpdateView(int64_t startBattle, EnrageTracker* tracker) {
		return ((T (*)(HUDBossEnrageView*, int64_t, EnrageTracker*))(Il2CppBase() + 0x144BF18))(this, startBattle, tracker);
	}
