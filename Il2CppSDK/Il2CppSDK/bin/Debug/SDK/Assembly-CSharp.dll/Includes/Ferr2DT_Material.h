...
public: 
	...
	template <typename T = uintptr_t> T GetDescriptor(uintptr_t aDirection) {
		return ((T (*)(Ferr2DTMaterial*, uintptr_t))(Il2CppBase() + 0x1692BA8))(this, aDirection);
	}
	template <typename T = bool> T Has(uintptr_t aDirection) {
		return ((T (*)(Ferr2DTMaterial*, uintptr_t))(Il2CppBase() + 0x1692DC4))(this, aDirection);
	}
	template <typename T = void> T Set(uintptr_t aDirection, bool aActive) {
		return ((T (*)(Ferr2DTMaterial*, uintptr_t, bool))(Il2CppBase() + 0x1692E34))(this, aDirection, aActive);
	}
	template <typename T = Il2CppRect> T ToUV(Il2CppRect aNativeRect) {
		return ((T (*)(Ferr2DTMaterial*, Il2CppRect))(Il2CppBase() + 0x1692FAC))(this, aNativeRect);
	}
	template <typename T = Il2CppRect> T ToScreen(Il2CppRect aNativeRect) {
		return ((T (*)(Ferr2DTMaterial*, Il2CppRect))(Il2CppBase() + 0x16930C8))(this, aNativeRect);
	}
	template <typename T = Il2CppRect> T GetBody(uintptr_t aDirection, int32_t aBodyID) {
		return ((T (*)(Ferr2DTMaterial*, uintptr_t, int32_t))(Il2CppBase() + 0x1693168))(this, aDirection, aBodyID);
	}
	...
	template <typename T = Il2CppRect> T ToNative(Il2CppRect aPixelRect) {
		return ((T (*)(Ferr2DTMaterial*, Il2CppRect))(Il2CppBase() + 0x16931C0))(this, aPixelRect);
	}
	template <typename T = Il2CppRect> T ToPixels(Il2CppRect aNativeRect) {
		return ((T (*)(Ferr2DTMaterial*, Il2CppRect))(Il2CppBase() + 0x16933BC))(this, aNativeRect);
	}
