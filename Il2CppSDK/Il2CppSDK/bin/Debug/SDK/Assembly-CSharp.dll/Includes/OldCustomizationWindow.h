...
public: 
	...
	template <typename T = void> T UpdateCurrent(uintptr_t current, Il2CppList<ItemEntity*>* list, int32_t slotIndex) {
		return ((T (*)(OldCustomizationWindow*, uintptr_t, Il2CppList<ItemEntity*>*, int32_t))(Il2CppBase() + 0x11DA8E0))(this, current, list, slotIndex);
	}
	...
	template <typename T = void> T OnNext(uintptr_t current, IList1ItemEntity*>* list, int32_t slotIndex) {
		return ((T (*)(OldCustomizationWindow*, uintptr_t, IList1ItemEntity*>*, int32_t))(Il2CppBase() + 0x11DBA50))(this, current, list, slotIndex);
	}
	template <typename T = void> T OnPrev(uintptr_t current, Il2CppList<ItemEntity*>* list, int32_t slotIndex) {
		return ((T (*)(OldCustomizationWindow*, uintptr_t, Il2CppList<ItemEntity*>*, int32_t))(Il2CppBase() + 0x11DBD18))(this, current, list, slotIndex);
	}
