...
public: 
	...
	template <typename T = bool> static T CanTrackingManual(QuestEntity* questEntity) {
		return ((T (*)(void *, QuestEntity*))(Il2CppBase() + 0xE1B470))(0, questEntity);
	}
	template <typename T = bool> static T IsManualTracked(QuestEntity* questEntity) {
		return ((T (*)(void *, QuestEntity*))(Il2CppBase() + 0xE1B5D8))(0, questEntity);
	}
	template <typename T = void> static T SwitchManualTracking(QuestEntity* questEntity, int64_t playerId) {
		return ((T (*)(void *, QuestEntity*, int64_t))(Il2CppBase() + 0xE1B62C))(0, questEntity, playerId);
	}
	template <typename T = void> static T TrackManual(QuestEntity* questEntity, int64_t playerId) {
		return ((T (*)(void *, QuestEntity*, int64_t))(Il2CppBase() + 0xE1B9D0))(0, questEntity, playerId);
	}
	template <typename T = void> static T UntrackManual(QuestEntity* questEntity, int64_t playerId) {
		return ((T (*)(void *, QuestEntity*, int64_t))(Il2CppBase() + 0xE1B760))(0, questEntity, playerId);
	}
