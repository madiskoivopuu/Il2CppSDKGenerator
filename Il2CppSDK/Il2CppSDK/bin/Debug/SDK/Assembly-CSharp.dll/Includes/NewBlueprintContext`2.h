...
class NewBlueprintContext2: BaseContext1
{
public: 
	...
	template <typename T = void> T set_Data(void* value) {
		return ((T (*)(NewBlueprintContext2*, void*))(Il2CppBase() + 0x0))(this, value);
	}
	...
	template <typename T = uintptr_t> T CreateUsingBlueprint(Il2CppString* entityName, uintptr_t entityData) {
		return ((T (*)(NewBlueprintContext2*, Il2CppString*, uintptr_t))(Il2CppBase() + 0x0))(this, entityName, entityData);
	}
