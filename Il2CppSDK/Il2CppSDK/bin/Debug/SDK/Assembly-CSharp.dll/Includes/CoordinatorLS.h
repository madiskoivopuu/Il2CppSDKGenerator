...
public: 
	...
	template <typename R = bool> R& _isConnectProcessing() {
	 ...
	 Action1<ProtoTools::ErrorCodes>*& OnConnectionError() {
		return *(Action1<ProtoTools::ErrorCodes>**)((uintptr_t)this + 0xC8);
	}
	 static Action7<bool, UdpClientConfig*, int64_t, int64_t, int64_t, Il2CppString*, ProtoModels::WorldResourcesType>*& OnConnectedToCoordinator() {
		return *(Action7<bool, UdpClientConfig*, int64_t, int64_t, int64_t, Il2CppString*, ProtoModels::WorldResourcesType>**)((uintptr_t)StaticClass()->static_fields + 0x0);
	}

	template <typename R = void> R add_OnConnectionError(Action1<ProtoTools::ErrorCodes>* value) {
		return ((R (*)(CoordinatorLS*, Action1<ProtoTools::ErrorCodes>*))(Il2CppBase() + 0x133ABA0))(this, value);
	}
	template <typename R = void> R remove_OnConnectionError(Action1<ProtoTools::ErrorCodes>* value) {
		return ((R (*)(CoordinatorLS*, Action1<ProtoTools::ErrorCodes>*))(Il2CppBase() + 0x133AC40))(this, value);
	}
	template <typename R = void> static R add_OnConnectedToCoordinator(Action7<bool, UdpClientConfig*, int64_t, int64_t, int64_t, Il2CppString*, ProtoModels::WorldResourcesType>* value) {
		return ((R (*)(void *, Action7<bool, UdpClientConfig*, int64_t, int64_t, int64_t, Il2CppString*, ProtoModels::WorldResourcesType>*))(Il2CppBase() + 0x133ACE0))(0, value);
	}
	template <typename R = void> static R remove_OnConnectedToCoordinator(Action7<bool, UdpClientConfig*, int64_t, int64_t, int64_t, Il2CppString*, ProtoModels::WorldResourcesType>* value) {
		return ((R (*)(void *, Action7<bool, UdpClientConfig*, int64_t, int64_t, int64_t, Il2CppString*, ProtoModels::WorldResourcesType>*))(Il2CppBase() + 0x133AD9C))(0, value);
	}
	...
	template <typename R = void> R OnUserLogged(Il2CppString* adress, Il2CppString* coordinatorAddress, IEnumerable1<ConfigurationVersion*>* cfgVersions, int64_t userID, Il2CppArray<uint8_t>* token) {
		return ((R (*)(CoordinatorLS*, Il2CppString*, Il2CppString*, IEnumerable1<ConfigurationVersion*>*, int64_t, Il2CppArray<uint8_t>*))(Il2CppBase() + 0x133B070))(this, adress, coordinatorAddress, cfgVersions, userID, token);
	}
