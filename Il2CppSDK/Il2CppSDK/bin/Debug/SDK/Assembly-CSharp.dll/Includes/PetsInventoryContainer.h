...
public: 
	...
	template <typename R = int32_t> R& _petCount() {
	 ...
	 Action1InventorySlot*>*& OnSortButtonClick() {
		return *(Action1InventorySlot*>**)((uintptr_t)this + 0xC8);
	}
	...
	template <typename R = void> R add_OnSortButtonClick(Action1InventorySlot*>* value) {
		return ((R (*)(PetsInventoryContainer*, Action1InventorySlot*>*))(Il2CppBase() + 0x16F26F0))(this, value);
	}
	template <typename R = void> R remove_OnSortButtonClick(Action1InventorySlot*>* value) {
		return ((R (*)(PetsInventoryContainer*, Action1InventorySlot*>*))(Il2CppBase() + 0x16F2790))(this, value);
	}
	template <typename R = void> R Bind(IPetsInventoryWindow* window, GameEntity* parentEntity, Action1InventorySlot*>* onSort) {
		return ((R (*)(PetsInventoryContainer*, IPetsInventoryWindow*, GameEntity*, Action1InventorySlot*>*))(Il2CppBase() + 0x16F2830))(this, window, parentEntity, onSort);
	}
	...
	template <typename R = IInventoryItem*> R GetItemById(int32_t id) {
	 ...
	 ValueTuple3bool, IInventoryItem*, int32_t>* IsInventoryEmpty() {
		return ((ValueTuple3bool, IInventoryItem*, int32_t>* (*)(PetsInventoryContainer*))(Il2CppBase() + 0x16EE9C0))(this);
	}
