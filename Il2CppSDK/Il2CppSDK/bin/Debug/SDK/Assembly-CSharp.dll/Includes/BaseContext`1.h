...
public: 
	...
	template <typename T = uintptr_t> T CreateEntityFromBlueprint(uintptr_t entityData) {
		return ((T (*)(BaseContext1*, uintptr_t))(Il2CppBase() + 0x0))(this, entityData);
	}
	template <typename T = void> T DestroyEntities(void* group) {
		return ((T (*)(BaseContext1*, void*))(Il2CppBase() + 0x0))(this, group);
	}
	template <typename T = void> T DestroyEntities_1(void* matcher) {
		return ((T (*)(BaseContext1*, void*))(Il2CppBase() + 0x0))(this, matcher);
	}
	template <typename T = bool> T DestroyEntities_2(void* entities, void* predicate) {
		return ((T (*)(BaseContext1*, void*, void*))(Il2CppBase() + 0x0))(this, entities, predicate);
	}
