...
public: 
	...
	template <typename R = uintptr_t> static R ColorFromHEX(int64_t value) {
	 ...
	 static Nullable1uintptr_t>* ToColor(Il2CppString* hexStr, Nullable1uintptr_t>* defaultValue) {
		return ((Nullable1uintptr_t>* (*)(void *, Il2CppString*, Nullable1uintptr_t>*))(Il2CppBase() + 0x102F2D0))(0, hexStr, defaultValue);
	}
