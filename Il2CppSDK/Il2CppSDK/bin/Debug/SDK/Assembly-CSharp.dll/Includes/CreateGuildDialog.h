...
class CreateGuildDialog: UIWindow1
{
public: 
	...
	template <typename T = void> T OnCreateGuildResponse(uintptr_t errorCode) {
		return ((T (*)(CreateGuildDialog*, uintptr_t))(Il2CppBase() + 0x134EE7C))(this, errorCode);
	}
