...
public: 
	...
	template <typename R = Il2CppArray<Info*>*> static R& _data() {
	 ...
	 static Nullable1<float>* GetStatValue(GameEntity* player, ICommonContexts* world, PlayerStatType type) {
		return ((Nullable1<float>* (*)(void *, GameEntity*, ICommonContexts*, PlayerStatType))(Il2CppBase() + 0x156EB10))(0, player, world, type);
	}
