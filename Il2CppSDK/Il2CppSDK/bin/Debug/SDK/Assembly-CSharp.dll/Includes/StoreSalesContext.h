...
public: 
	...
	template <typename R = StoreSalesEntity*> R GetEntityWithStoreSalesId(int64_t id) {
	 ...
	 HashSet1<StoreSalesEntity*>* GetEntitiesForPlayer(int64_t playerId) {
		return ((HashSet1<StoreSalesEntity*>* (*)(StoreSalesContext*, int64_t))(Il2CppBase() + 0x183F684))(this, playerId);
	}
