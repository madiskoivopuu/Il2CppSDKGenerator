...
public: 
	...
	template <typename T = void*> static T& _matcherActorPlayerId() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x10);
	}
	template <typename T = void*> static T& _matcherBattleId() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x18);
	}
	template <typename T = void*> static T& _matcherBattleStatistic() {
	...
	template <typename T = void*> static T& _matcherDamageSum() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x40);
	}
	template <typename T = void*> static T& _matcherDuration() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x48);
	}
	template <typename T = void*> static T& _matcherFishingStatistic() {
	...
	template <typename T = void*> static T& _matcherKilled() {
	...
	template <typename T = void*> static T& _matcherTargetPlayerId() {
	...
	template <typename T = void*> static T get_Killed() {
	...
	template <typename T = void*> static T get_TargetPlayerId() {
