...
class ChestWindow: BaseInventoryWindow1
{
public: 
	...
	template <typename T = uintptr_t> T& ChestContainer() {
	...
	template <typename T = uintptr_t> T& _showChestMarker() {
	...
	template <typename T = void> T UpdateAliveTimer(uintptr_t target) {
		return ((T (*)(ChestWindow*, uintptr_t))(Il2CppBase() + 0x17444CC))(this, target);
	}
	template <typename T = void> T UpdateCloseTimer(uintptr_t target) {
		return ((T (*)(ChestWindow*, uintptr_t))(Il2CppBase() + 0x17448B0))(this, target);
	}
	template <typename T = void> T OnShowWarningHook(uintptr_t data, uintptr_t hooked) {
		return ((T (*)(ChestWindow*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1744D90))(this, data, hooked);
	}
	...
	template <typename T = void> T OnUpgradeb__44_1(uintptr_t w) {
		return ((T (*)(ChestWindow*, uintptr_t))(Il2CppBase() + 0x17467E8))(this, w);
	}
