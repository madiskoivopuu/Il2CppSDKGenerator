...
public: 
	...
	template <typename T = AppsflyerManager*> static T& _instance() {
	...
	template <typename T = NativeTextShare*> T& _textShare() {
	...
	template <typename T = AppsflyerManager*> static T get_Instance() {
