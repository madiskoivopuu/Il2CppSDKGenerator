...
class HUDCustomizationButton: HUDUncustomizable
{
public: 
	...
	template <typename T = void> T Bind(uintptr_t hudWindow, uintptr_t onClick, uintptr_t onHold) {
		return ((T (*)(HUDCustomizationButton*, uintptr_t, uintptr_t, uintptr_t))(Il2CppBase() + 0x1450F5C))(this, hudWindow, onClick, onHold);
	}
