...
public: 
	...
	template <typename R = bool> R& _init() {
	 ...
	 Nullable1<int32_t>*& _newCount() {
		return *(Nullable1<int32_t>**)((uintptr_t)this + 0x64);
	}
	template <typename R = ItemEntity*> R& PetEntity() {
		return *(R*)((uintptr_t)this + 0x70);
	}
	 Action1<PlayerPetSlot*>*& ClickEvent() {
		return *(Action1<PlayerPetSlot*>**)((uintptr_t)this + 0x78);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1<PlayerPetSlot*>* value) {
		return ((R (*)(PlayerPetSlot*, Action1<PlayerPetSlot*>*))(Il2CppBase() + 0x156CDBC))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1<PlayerPetSlot*>* value) {
		return ((R (*)(PlayerPetSlot*, Action1<PlayerPetSlot*>*))(Il2CppBase() + 0x156CE5C))(this, value);
	}
