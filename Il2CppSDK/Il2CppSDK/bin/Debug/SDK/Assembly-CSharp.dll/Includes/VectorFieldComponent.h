...
public: 
	...
	template <typename T = VectorCell*> static T& CellOut() {
	...
	template <typename T = Il2CppArray<uintptr_t>*> T& _field() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = Queue1Coord*>*> T& _next() {
	...
	template <typename T = void> T SetCell(int32_t x, int32_t y, VectorCell* cell) {
		return ((T (*)(VectorFieldComponent*, int32_t, int32_t, VectorCell*))(Il2CppBase() + 0x15C445C))(this, x, y, cell);
	}
	template <typename T = Queue1Coord*>*> T get_Next() {
	...
	template <typename T = uintptr_t> T get_Item_1(Coord* coord) {
		return ((T (*)(VectorFieldComponent*, Coord*))(Il2CppBase() + 0x15C477C))(this, coord);
	}
