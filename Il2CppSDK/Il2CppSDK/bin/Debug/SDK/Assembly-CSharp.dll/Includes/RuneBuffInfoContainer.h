...
public: 
	...
	template <typename R = void> R OnClassRuneDeactivated(HashSet1PlayerClassType*>* playerClasses, ClassRuneDeactivatedData* data) {
		return ((R (*)(RuneBuffInfoContainer*, HashSet1PlayerClassType*>*, ClassRuneDeactivatedData*))(Il2CppBase() + 0x11A8144))(this, playerClasses, data);
	}
