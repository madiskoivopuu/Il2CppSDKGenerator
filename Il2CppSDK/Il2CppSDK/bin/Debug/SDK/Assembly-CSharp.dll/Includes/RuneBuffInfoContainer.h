...
public: 
	...
	template <typename T = Il2CppList<RuneBuffInfoItem*>*> T& _buffs() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = RuneBuffInfoItem*> T& _buffPrefab() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = Il2CppList<RuneBuffInfoItem*>*> T& _flyingBuffs() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = PlayerClassesWindow*> T& _window() {
	...
	template <typename T = void> T Bind(IRuneInventoryPanel* runePanel) {
		return ((T (*)(RuneBuffInfoContainer*, IRuneInventoryPanel*))(Il2CppBase() + 0x11A7600))(this, runePanel);
	}
	...
	template <typename T = void> T OnClassRuneChanged(ClassRuneChangedData* data) {
		return ((T (*)(RuneBuffInfoContainer*, ClassRuneChangedData*))(Il2CppBase() + 0x11A813C))(this, data);
	}
	template <typename T = void> T OnClassRuneDeactivated(HashSet1PlayerClassType*>* playerClasses, ClassRuneDeactivatedData* data) {
		return ((T (*)(RuneBuffInfoContainer*, HashSet1PlayerClassType*>*, ClassRuneDeactivatedData*))(Il2CppBase() + 0x11A8144))(this, playerClasses, data);
	}
