...
public: 
	...
	template <typename T = void> T OnMessageReceived(uintptr_t sender, uintptr_t e) {
		return ((T (*)(FirebaseNotificationsService*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1699450))(this, sender, e);
	}
	template <typename T = void> T OnTokenReceived(uintptr_t sender, uintptr_t e) {
		return ((T (*)(FirebaseNotificationsService*, uintptr_t, uintptr_t))(Il2CppBase() + 0x16994F4))(this, sender, e);
	}
