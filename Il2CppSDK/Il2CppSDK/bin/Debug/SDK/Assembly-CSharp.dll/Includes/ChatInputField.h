...
public: 
	...
	template <typename T = void*> T& Message() {
		return *(T*)((uintptr_t)this + 0x28);
	}
	template <typename T = void*> T& FocuseChanged() {
		return *(T*)((uintptr_t)this + 0x30);
	}
	template <typename T = Il2CppVector2> T& _InitialInputFieldSize() {
	...
	template <typename T = void> T add_Message(void* value) {
		return ((T (*)(ChatInputField*, void*))(Il2CppBase() + 0x13F9390))(this, value);
	}
	template <typename T = void> T remove_Message(void* value) {
		return ((T (*)(ChatInputField*, void*))(Il2CppBase() + 0x13F9430))(this, value);
	}
	template <typename T = void> T add_FocuseChanged(void* value) {
		return ((T (*)(ChatInputField*, void*))(Il2CppBase() + 0x13F94D0))(this, value);
	}
	template <typename T = void> T remove_FocuseChanged(void* value) {
		return ((T (*)(ChatInputField*, void*))(Il2CppBase() + 0x13F9570))(this, value);
	}
