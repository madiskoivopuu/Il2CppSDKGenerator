...
public: 
	...
	template <typename R = Vec2> static R GetDirectionToEntity(IArenaWorld* world, GameEntity* entity, Vec2 entityPos, GameEntity* target, Vec2 targetPos, bool ignoreDoor, Nullable1<float>* minDistance) {
		return ((R (*)(void *, IArenaWorld*, GameEntity*, Vec2, GameEntity*, Vec2, bool, Nullable1<float>*))(Il2CppBase() + 0x155D468))(0, world, entity, entityPos, target, targetPos, ignoreDoor, minDistance);
	}
	template <typename R = bool> static R MoveToEntity(IArenaWorld* world, GameEntity* entity, GameEntity* target, int64_t now, bool ignoreDoor, Nullable1<float>* minDistance) {
		return ((R (*)(void *, IArenaWorld*, GameEntity*, GameEntity*, int64_t, bool, Nullable1<float>*))(Il2CppBase() + 0x155E74C))(0, world, entity, target, now, ignoreDoor, minDistance);
	}
	 static ValueTuple3<Vec2, Vec2, bool>* GetMoveToEntity(IArenaWorld* world, GameEntity* entity, int64_t entityTick, Vec2 entityPosition, float entitySpeed, Vec2 entityVelocity, GameEntity* target, Vec2 targetPosition, int64_t now, bool ignoreDoor, Nullable1<float>* minDistance) {
		return ((ValueTuple3<Vec2, Vec2, bool>* (*)(void *, IArenaWorld*, GameEntity*, int64_t, Vec2, float, Vec2, GameEntity*, Vec2, int64_t, bool, Nullable1<float>*))(Il2CppBase() + 0x155EA5C))(0, world, entity, entityTick, entityPosition, entitySpeed, entityVelocity, target, targetPosition, now, ignoreDoor, minDistance);
	}
