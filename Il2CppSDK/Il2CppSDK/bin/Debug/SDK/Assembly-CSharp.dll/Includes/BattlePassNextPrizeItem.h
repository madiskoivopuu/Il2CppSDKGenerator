...
public: 
	...
	template <typename T = BattlePassItem*> T& BattlePassItem() {
	...
	template <typename T = void> T Bind(uintptr_t placeholder, BattlePassWindow* window, int32_t fromPoints, int32_t currentPoints, int32_t nextPoints, bool nextIsInfinity) {
		return ((T (*)(BattlePassNextPrizeItem*, uintptr_t, BattlePassWindow*, int32_t, int32_t, int32_t, bool))(Il2CppBase() + 0x167CA50))(this, placeholder, window, fromPoints, currentPoints, nextPoints, nextIsInfinity);
	}
