...
public: 
	...
	template <typename T = uintptr_t> T& _tabRefab() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& _tabs() {
		return *(T*)((uintptr_t)this + 0x48);
	}
	template <typename T = uintptr_t> T& _actQuestsWindow() {
	...
	template <typename T = void> T Init(uintptr_t actQuestsWindow, int64_t playerId) {
		return ((T (*)(ActTabsController*, uintptr_t, int64_t))(Il2CppBase() + 0x1DB7CC8))(this, actQuestsWindow, playerId);
	}
	template <typename T = void> T OnActTabClick(uintptr_t tab) {
		return ((T (*)(ActTabsController*, uintptr_t))(Il2CppBase() + 0x1DB8700))(this, tab);
	}
	...
	template <typename T = void> T ShowTab(uintptr_t activeTab) {
		return ((T (*)(ActTabsController*, uintptr_t))(Il2CppBase() + 0x1DB879C))(this, activeTab);
	}
