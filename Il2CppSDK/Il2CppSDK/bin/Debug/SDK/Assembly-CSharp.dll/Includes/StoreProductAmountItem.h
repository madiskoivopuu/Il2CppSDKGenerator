...
public: 
	...
	template <typename T = void> T Init(Store2Entity* parentEntity, Store2DataEntity* data, TooltipView* tooltip, uintptr_t onBuySuccess, uintptr_t onBuyFail) {
		return ((T (*)(StoreProductAmountItem*, Store2Entity*, Store2DataEntity*, TooltipView*, uintptr_t, uintptr_t))(Il2CppBase() + 0x182F040))(this, parentEntity, data, tooltip, onBuySuccess, onBuyFail);
	}
