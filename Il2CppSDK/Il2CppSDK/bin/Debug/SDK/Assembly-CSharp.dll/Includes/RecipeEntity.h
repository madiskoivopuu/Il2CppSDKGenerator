...
public: 
	...
	template <typename T = void> T AddPrefab(Il2CppString* newName, Il2CppString* newFemaleName, bool newHidden, uintptr_t newResourceType) {
		return ((T (*)(RecipeEntity*, Il2CppString*, Il2CppString*, bool, uintptr_t))(Il2CppBase() + 0x139813C))(this, newName, newFemaleName, newHidden, newResourceType);
	}
	template <typename T = void> T ReplacePrefab(Il2CppString* newName, Il2CppString* newFemaleName, bool newHidden, uintptr_t newResourceType) {
		return ((T (*)(RecipeEntity*, Il2CppString*, Il2CppString*, bool, uintptr_t))(Il2CppBase() + 0x1398280))(this, newName, newFemaleName, newHidden, newResourceType);
	}
	...
	template <typename T = uintptr_t> T get_requiredCondition() {
	...
	template <typename T = uintptr_t> T get_sorting() {
	...
	template <typename T = void> T AddSorting(uintptr_t newValue) {
		return ((T (*)(RecipeEntity*, uintptr_t))(Il2CppBase() + 0x1398C9C))(this, newValue);
	}
	template <typename T = void> T ReplaceSorting(uintptr_t newValue) {
		return ((T (*)(RecipeEntity*, uintptr_t))(Il2CppBase() + 0x1398DA0))(this, newValue);
	}
