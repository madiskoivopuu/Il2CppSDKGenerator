...
public: 
	...
	template <typename T = Nullable1bool>*> T& TargetSneaked() {
		return *(T*)((uintptr_t)this + 0x38);
	}
	template <typename T = Il2CppString*> T& TargetHasntMagic() {
		return *(T*)((uintptr_t)this + 0x40);
	}
	template <typename T = Nullable1bool>*> T& TargetRiding() {
	...
	template <typename T = void> T CopyTo(Il2CppObject* target) {
		return ((T (*)(RemoveConditionComponent*, Il2CppObject*))(Il2CppBase() + 0x13A02A8))(this, target);
	}
