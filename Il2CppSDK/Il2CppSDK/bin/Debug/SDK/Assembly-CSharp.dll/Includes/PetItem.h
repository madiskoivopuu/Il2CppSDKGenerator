...
public: 
	...
	template <typename T = Nullable1float>*> T& _expCoef() {
	...
	template <typename T = void> T add_OnArming(Action1IInventoryItem*>* value) {
		return ((T (*)(PetItem*, Action1IInventoryItem*>*))(Il2CppBase() + 0x11EEB48))(this, value);
	}
	template <typename T = void> T remove_OnArming(Action1IInventoryItem*>* value) {
		return ((T (*)(PetItem*, Action1IInventoryItem*>*))(Il2CppBase() + 0x11EEBE8))(this, value);
	}
	template <typename T = void> T Bind(IPetsInventoryWindow* window, GameEntity* entity, int32_t index, InventorySlot* slot, Action1IInventoryItem*>* onArming) {
		return ((T (*)(PetItem*, IPetsInventoryWindow*, GameEntity*, int32_t, InventorySlot*, Action1IInventoryItem*>*))(Il2CppBase() + 0x11EEC88))(this, window, entity, index, slot, onArming);
	}
	...
	template <typename T = void> T ChangeSlot(InventorySlot* slot) {
		return ((T (*)(PetItem*, InventorySlot*))(Il2CppBase() + 0x11F0028))(this, slot);
	}
