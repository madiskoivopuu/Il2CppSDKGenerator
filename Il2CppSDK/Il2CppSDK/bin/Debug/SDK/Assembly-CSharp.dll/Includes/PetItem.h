...
public: 
	...
	template <typename R = Il2CppString*> R& _petBlueprint() {
	 ...
	 Nullable1float>*& _expCoef() {
		return *(Nullable1float>**)((uintptr_t)this + 0xB8);
	}
	...
	template <typename R = bool> R& _forceUpdate() {
	 ...
	 Action1IInventoryItem*>*& OnArming() {
		return *(Action1IInventoryItem*>**)((uintptr_t)this + 0xE0);
	}
	...
	template <typename R = void> R add_OnArming(Action1IInventoryItem*>* value) {
		return ((R (*)(PetItem*, Action1IInventoryItem*>*))(Il2CppBase() + 0x11EEB48))(this, value);
	}
	template <typename R = void> R remove_OnArming(Action1IInventoryItem*>* value) {
		return ((R (*)(PetItem*, Action1IInventoryItem*>*))(Il2CppBase() + 0x11EEBE8))(this, value);
	}
	template <typename R = void> R Bind(IPetsInventoryWindow* window, GameEntity* entity, int32_t index, InventorySlot* slot, Action1IInventoryItem*>* onArming) {
		return ((R (*)(PetItem*, IPetsInventoryWindow*, GameEntity*, int32_t, InventorySlot*, Action1IInventoryItem*>*))(Il2CppBase() + 0x11EEC88))(this, window, entity, index, slot, onArming);
	}
