...
public: 
	...
	template <typename T = Il2CppList<MapEventLocationElement*>*> T& _locationElements() {
	...
	template <typename T = HashSet1int32_t>*> T& _addedPoints() {
	...
	template <typename T = void> T Bind(UIWindow* window) {
		return ((T (*)(MapEventLocationsWindow*, UIWindow*))(Il2CppBase() + 0x126D2D8))(this, window);
	}
	...
	template <typename T = void> T AddPointToPanel(GameEntity* pointEntity) {
		return ((T (*)(MapEventLocationsWindow*, GameEntity*))(Il2CppBase() + 0x126DD54))(this, pointEntity);
	}
