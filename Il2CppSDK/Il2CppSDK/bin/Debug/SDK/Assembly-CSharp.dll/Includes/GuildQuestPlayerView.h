...
public: 
	...
	template <typename T = void*> T& _role() {
	...
	template <typename T = void*> T& _online() {
	...
	template <typename T = void> T Init(Il2CppArray<uintptr_t>* rewards, uintptr_t tooltipView) {
		return ((T (*)(GuildQuestPlayerView*, Il2CppArray<uintptr_t>*, uintptr_t))(Il2CppBase() + 0x1937750))(this, rewards, tooltipView);
	}
	template <typename T = void> T UpdateView(uintptr_t player, int32_t rank, int32_t points) {
		return ((T (*)(GuildQuestPlayerView*, uintptr_t, int32_t, int32_t))(Il2CppBase() + 0x1937888))(this, player, rank, points);
	}
	...
	template <typename T = void> T UpdateView_2(int64_t playerId, Il2CppString* playerName, uintptr_t role, bool online, int32_t rank, int32_t points) {
		return ((T (*)(GuildQuestPlayerView*, int64_t, Il2CppString*, uintptr_t, bool, int32_t, int32_t))(Il2CppBase() + 0x1937974))(this, playerId, playerName, role, online, rank, points);
	}
