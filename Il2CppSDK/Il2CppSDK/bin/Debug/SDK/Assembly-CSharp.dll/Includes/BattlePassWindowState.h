...
public: 
	...
	template <typename T = uintptr_t> T& BattlePassView() {
	...
	template <typename T = uintptr_t> T& StoreCategory() {
		return *(T*)((uintptr_t)this + 0x94);
	}
	template <typename T = Il2CppList<void*>*> T& Prioritized() {
		return *(T*)((uintptr_t)this + 0x98);
	}
	template <typename T = void*> T& CurrentClaimedSteps() {
	...
	template <typename T = uintptr_t> T& CurrencyItem() {
		return *(T*)((uintptr_t)this + 0xD0);
	}
	template <typename T = int32_t> T& BestRewardsWindowId() {
		return *(T*)((uintptr_t)this + 0xD8);
	}
	template <typename T = Il2CppList<uintptr_t>*> T& BestBpItems() {
		return *(T*)((uintptr_t)this + 0xE0);
	}

	template <typename T = bool> T UpdateActive(uintptr_t window, uintptr_t account) {
		return ((T (*)(BattlePassWindowState*, uintptr_t, uintptr_t))(Il2CppBase() + 0xEEACA0))(this, window, account);
	}
