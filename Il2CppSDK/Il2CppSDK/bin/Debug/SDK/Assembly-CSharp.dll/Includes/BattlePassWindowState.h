...
public: 
	...
	template <typename R = StoreCategory> R& StoreCategory() {
	 ...
	 Il2CppList<ValueTuple2<Store2Entity*, Store2DataEntity*>*>*& Prioritized() {
		return *(Il2CppList<ValueTuple2<Store2Entity*, Store2DataEntity*>*>**)((uintptr_t)this + 0x98);
	}
	 ValueTuple2<int32_t, int32_t>*& CurrentClaimedSteps() {
		return *(ValueTuple2<int32_t, int32_t>**)((uintptr_t)this + 0xA0);
	}
