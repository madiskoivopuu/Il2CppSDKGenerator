...
public: 
	...
	template <typename T = void*> T GetEntitiesForChannel(Il2CppString* channelName) {
	...
	template <typename T = void*> T GetEntitiesByJid(Il2CppString* jid) {
