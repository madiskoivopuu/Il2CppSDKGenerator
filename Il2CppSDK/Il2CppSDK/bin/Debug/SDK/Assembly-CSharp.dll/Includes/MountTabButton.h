...
public: 
	...
	template <typename R = ItemEntity*> R& MountData() {
	 ...
	 Action1MountTabButton*>*& ClickEvent() {
		return *(Action1MountTabButton*>**)((uintptr_t)this + 0x40);
	}
	...
	template <typename R = void> R add_ClickEvent(Action1MountTabButton*>* value) {
		return ((R (*)(MountTabButton*, Action1MountTabButton*>*))(Il2CppBase() + 0x154938C))(this, value);
	}
	template <typename R = void> R remove_ClickEvent(Action1MountTabButton*>* value) {
		return ((R (*)(MountTabButton*, Action1MountTabButton*>*))(Il2CppBase() + 0x154942C))(this, value);
	}
