...
public: 
	...
	template <typename R = void> R AddApplyCharge(float newSpeed, float newInteractRadius, Nullable1float>* newMaxDuration) {
		return ((R (*)(ActionEntity*, float, float, Nullable1float>*))(Il2CppBase() + 0x1DC22A8))(this, newSpeed, newInteractRadius, newMaxDuration);
	}
	template <typename R = void> R ReplaceApplyCharge(float newSpeed, float newInteractRadius, Nullable1float>* newMaxDuration) {
		return ((R (*)(ActionEntity*, float, float, Nullable1float>*))(Il2CppBase() + 0x1DC23C0))(this, newSpeed, newInteractRadius, newMaxDuration);
	}
	...
	template <typename R = void> R AddApplySwitchActive(Il2CppString* newTag, Nullable1bool>* newSetActive, Il2CppString* newOnEffectName, Il2CppString* newOffEffectName) {
		return ((R (*)(ActionEntity*, Il2CppString*, Nullable1bool>*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1DC7618))(this, newTag, newSetActive, newOnEffectName, newOffEffectName);
	}
	template <typename R = void> R ReplaceApplySwitchActive(Il2CppString* newTag, Nullable1bool>* newSetActive, Il2CppString* newOnEffectName, Il2CppString* newOffEffectName) {
		return ((R (*)(ActionEntity*, Il2CppString*, Nullable1bool>*, Il2CppString*, Il2CppString*))(Il2CppBase() + 0x1DC7764))(this, newTag, newSetActive, newOnEffectName, newOffEffectName);
	}
	...
	template <typename R = void> R AddTargets(HashSet1int32_t>* newIds) {
		return ((R (*)(ActionEntity*, HashSet1int32_t>*))(Il2CppBase() + 0x1DD1CD8))(this, newIds);
	}
	template <typename R = void> R ReplaceTargets(HashSet1int32_t>* newIds) {
		return ((R (*)(ActionEntity*, HashSet1int32_t>*))(Il2CppBase() + 0x1DD1DEC))(this, newIds);
	}
