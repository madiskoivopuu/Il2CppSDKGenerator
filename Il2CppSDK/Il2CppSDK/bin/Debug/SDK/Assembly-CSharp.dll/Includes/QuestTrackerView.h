...
public: 
	...
	template <typename R = Il2CppString*> R& QuestName() {
	 ...
	 Action1QuestTrackerView*>*& OnClickEvent() {
		return *(Action1QuestTrackerView*>**)((uintptr_t)this + 0x78);
	}
	template <typename R = int32_t> R& _progress() {
		return *(R*)((uintptr_t)this + 0x80);
	}
	 Nullable1bool>*& _completed() {
		return *(Nullable1bool>**)((uintptr_t)this + 0x84);
	}
	...
	template <typename R = void> R add_OnClickEvent(Action1QuestTrackerView*>* value) {
		return ((R (*)(QuestTrackerView*, Action1QuestTrackerView*>*))(Il2CppBase() + 0x1705998))(this, value);
	}
	template <typename R = void> R remove_OnClickEvent(Action1QuestTrackerView*>* value) {
		return ((R (*)(QuestTrackerView*, Action1QuestTrackerView*>*))(Il2CppBase() + 0x1705A38))(this, value);
	}
