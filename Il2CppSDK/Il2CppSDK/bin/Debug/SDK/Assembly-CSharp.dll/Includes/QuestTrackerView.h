...
public: 
	...
	template <typename T = void> T add_OnClickEvent(void* value) {
		return ((T (*)(QuestTrackerView*, void*))(Il2CppBase() + 0x1705998))(this, value);
	}
	template <typename T = void> T remove_OnClickEvent(void* value) {
		return ((T (*)(QuestTrackerView*, void*))(Il2CppBase() + 0x1705A38))(this, value);
	}
	...
	template <typename T = void> T UpdateView(uintptr_t quest, int64_t now) {
		return ((T (*)(QuestTrackerView*, uintptr_t, int64_t))(Il2CppBase() + 0x1705E04))(this, quest, now);
	}
