...
public: 
	...
	template <typename T = uintptr_t> static T& currentServerComponent() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
	template <typename T = uintptr_t> static T& selectedServerComponent() {
	...
	template <typename T = uintptr_t> T get_chatServer() {
	...
	template <typename T = uintptr_t> T get_population() {
	...
	template <typename T = uintptr_t> T get_serverView() {
	...
	template <typename T = void> T AddServerView(uintptr_t newView) {
		return ((T (*)(ServerInfoEntity*, uintptr_t))(Il2CppBase() + 0x161DCCC))(this, newView);
	}
	template <typename T = void> T ReplaceServerView(uintptr_t newView) {
		return ((T (*)(ServerInfoEntity*, uintptr_t))(Il2CppBase() + 0x161DDE0))(this, newView);
	}
	...
	template <typename T = void> T AddStatus(uintptr_t newValue) {
		return ((T (*)(ServerInfoEntity*, uintptr_t))(Il2CppBase() + 0x161DF94))(this, newValue);
	}
	template <typename T = void> T ReplaceStatus(uintptr_t newValue) {
		return ((T (*)(ServerInfoEntity*, uintptr_t))(Il2CppBase() + 0x161E098))(this, newValue);
	}
	template <typename T = void> T RemoveStatus() {
		return ((T (*)(ServerInfoEntity*))(Il2CppBase() + 0x161E19C))(this);
	}
	template <typename T = uintptr_t> T get_subregion() {
