...
public: 
	...
	template <typename T = Il2CppList<ChatRoom*>*> T& Rooms() {
	...
	template <typename T = ChatRoom*> T GetRoom(Il2CppString* name) {
		return ((T (*)(ChatDataComponent*, Il2CppString*))(Il2CppBase() + 0x13F2D60))(this, name);
	}
	template <typename T = ChatRoom*> T GetRoomByType(Il2CppString* type) {
	...
	template <typename T = void> T CopyTo(Il2CppObject* targetObject) {
		return ((T (*)(ChatDataComponent*, Il2CppObject*))(Il2CppBase() + 0x13F3478))(this, targetObject);
	}
