...
public: 
	...
	template <typename T = void> T set_Durability(void* value) {
		return ((T (*)(HistoryEntryView*, void*))(Il2CppBase() + 0x1C52094))(this, value);
	}
	...
	template <typename T = void> T Bind(uintptr_t data, uintptr_t onCheatButtonClicked) {
		return ((T (*)(HistoryEntryView*, uintptr_t, uintptr_t))(Il2CppBase() + 0x1C51F90))(this, data, onCheatButtonClicked);
	}
