...
public: 
	...
	template <typename R = IIdManager*> R& _idManager() {
	 ...
	 PrimaryEntityIndex2<MagicTriggerEntity*, int32_t>*& _idIndex() {
		return *(PrimaryEntityIndex2<MagicTriggerEntity*, int32_t>**)((uintptr_t)this + 0x120);
	}
	 EntityIndex2<MagicTriggerEntity*, int32_t>*& _parentIndex() {
		return *(EntityIndex2<MagicTriggerEntity*, int32_t>**)((uintptr_t)this + 0x128);
	}
	 PrimaryEntityIndex2<MagicTriggerEntity*, IntString>*& _withBlueprintParentIndex() {
		return *(PrimaryEntityIndex2<MagicTriggerEntity*, IntString>**)((uintptr_t)this + 0x130);
	}
	 EntityIndex2<MagicTriggerEntity*, int32_t>*& _targetIndex() {
		return *(EntityIndex2<MagicTriggerEntity*, int32_t>**)((uintptr_t)this + 0x138);
	}
	 EntityIndex2<MagicTriggerEntity*, IntString>*& _withBlueprintOnTargetIndex() {
		return *(EntityIndex2<MagicTriggerEntity*, IntString>**)((uintptr_t)this + 0x140);
	}
	...
	template <typename R = MagicTriggerEntity*> R GetEntityWithId(int32_t id) {
	 ...
	 HashSet1<MagicTriggerEntity*>* GetWithParent(int32_t parentId) {
		return ((HashSet1<MagicTriggerEntity*>* (*)(MagicTriggerContext*, int32_t))(Il2CppBase() + 0x1A30BB4))(this, parentId);
	}
	template <typename R = MagicTriggerEntity*> R GetWithBlueprintParent(int32_t parentId, Il2CppString* name) {
	 ...
	 HashSet1<MagicTriggerEntity*>* GetOnTarget(int32_t targetId) {
		return ((HashSet1<MagicTriggerEntity*>* (*)(MagicTriggerContext*, int32_t))(Il2CppBase() + 0x1A31470))(this, targetId);
	}
	 HashSet1<MagicTriggerEntity*>* GetWithBlueprintOnTarget(int32_t targetId, Il2CppString* name) {
		return ((HashSet1<MagicTriggerEntity*>* (*)(MagicTriggerContext*, int32_t, Il2CppString*))(Il2CppBase() + 0x1A3179C))(this, targetId, name);
	}
	...
	template <typename R = MagicTriggerEntity*> R CreateFromMagic(MagicEntity* magic, Il2CppString* name, Nullable1<int32_t>* id) {
		return ((R (*)(MagicTriggerContext*, MagicEntity*, Il2CppString*, Nullable1<int32_t>*))(Il2CppBase() + 0x1A31B60))(this, magic, name, id);
	}
