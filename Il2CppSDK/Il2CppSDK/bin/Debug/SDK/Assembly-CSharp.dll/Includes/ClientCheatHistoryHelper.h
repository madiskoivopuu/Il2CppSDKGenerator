...
public: 
	...
	template <typename R = void> static R SaveToHistorySendCheatAddResource(Il2CppString* resourceName, int32_t count, Nullable1float>* durability) {
		return ((R (*)(void *, Il2CppString*, int32_t, Nullable1float>*))(Il2CppBase() + 0x1913AAC))(0, resourceName, count, durability);
	}
