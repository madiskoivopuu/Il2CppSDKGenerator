...
public: 
	...
	template <typename T = Il2CppList<uintptr_t>*> static T LoadCheatHistory() {
	...
	template <typename T = void> static T SaveToHistorySendCheatAddResource(Il2CppString* resourceName, int32_t count, void* durability) {
		return ((T (*)(void *, Il2CppString*, int32_t, void*))(Il2CppBase() + 0x1913AAC))(0, resourceName, count, durability);
	}
