...
public: 
	...
	template <typename T = BugReportType*> T& BugType() {
		return *(T*)((uintptr_t)this + 0x18);
	}
	template <typename T = BugReportPriority*> T& BugPriority() {
	...
	template <typename T = BugReportType*> T get_BugType() {
		return ((T (*)(WindowContext*))(Il2CppBase() + 0xEEEC0C))(this);
	}
	template <typename T = BugReportPriority*> T get_BugPriority() {
