...
class SkillMountTradeStep: BaseMountTradeStep
{
public: 
	...
	template <typename T = uintptr_t> T& _resultSkillItem() {
	...
	template <typename T = void> T Bind(uintptr_t window, int32_t step) {
		return ((T (*)(SkillMountTradeStep*, uintptr_t, int32_t))(Il2CppBase() + 0x14811C8))(this, window, step);
	}
