...
public: 
	...
	template <typename T = Nullable1float>*> static T ToNullInvariantFloatOrDefault(Il2CppString* str, Nullable1float>* defaultValue) {
		return ((T (*)(void *, Il2CppString*, Nullable1float>*))(Il2CppBase() + 0x169F2CC))(0, str, defaultValue);
	}
