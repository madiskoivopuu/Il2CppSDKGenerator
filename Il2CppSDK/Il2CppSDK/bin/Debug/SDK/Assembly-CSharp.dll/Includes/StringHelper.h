...
public: 
	...
	template <typename R = float> static R ToInvariantFloatOrDefault(Il2CppString* str, float defaultValue) {
	 ...
	 static Nullable1float>* ToNullInvariantFloatOrDefault(Il2CppString* str, Nullable1float>* defaultValue) {
		return ((Nullable1float>* (*)(void *, Il2CppString*, Nullable1float>*))(Il2CppBase() + 0x169F2CC))(0, str, defaultValue);
	}
