...
public: 
	...
	template <typename T = IToolTipSource*> T& _source() {
	...
	template <typename T = void> T Bind(IToolTipSource* source, Il2CppString* blueprint) {
		return ((T (*)(ToolTipViewBase*, IToolTipSource*, Il2CppString*))(Il2CppBase() + 0x14F2D60))(this, source, blueprint);
	}
