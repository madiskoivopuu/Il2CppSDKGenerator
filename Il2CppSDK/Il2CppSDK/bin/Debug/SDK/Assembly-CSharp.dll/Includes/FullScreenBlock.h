...
public: 
	...
	template <typename T = UIWindowsManager*> T& _hud() {
	...
	template <typename T = void> T SetHud(UIWindowsManager* hud) {
		return ((T (*)(FullScreenBlock*, UIWindowsManager*))(Il2CppBase() + 0x15FF0C4))(this, hud);
	}
