...
public: 
	...
	template <typename R = bool> static R IsSpamMessage(IEnumerable1<ChatEntity*>* ownMessages, Il2CppString* newMessage, int64_t currentWorldTimeInTicks) {
		return ((R (*)(void *, IEnumerable1<ChatEntity*>*, Il2CppString*, int64_t))(Il2CppBase() + 0x13F783C))(0, ownMessages, newMessage, currentWorldTimeInTicks);
	}
	template <typename R = bool> static R IsOftenMessage(IEnumerable1<ChatEntity*>* ownMessages, int64_t currentWorldTimeInTicks) {
		return ((R (*)(void *, IEnumerable1<ChatEntity*>*, int64_t))(Il2CppBase() + 0x13F7748))(0, ownMessages, currentWorldTimeInTicks);
	}
