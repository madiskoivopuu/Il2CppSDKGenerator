...
public: 
	...
	template <typename R = Il2CppArray<CurrencyType*>*> static R GetCurrencyTypes(uintptr_t entity) {
	 ...
	 static Nullable1CurrencyType*>* GetCurrencyType(uintptr_t entity) {
		return ((Nullable1CurrencyType*>* (*)(void *, uintptr_t))(Il2CppBase() + 0x0))(0, entity);
	}
	 static Nullable1CurrencyType*>* GetCurrencyTypeByAny(uintptr_t entity) {
		return ((Nullable1CurrencyType*>* (*)(void *, uintptr_t))(Il2CppBase() + 0x0))(0, entity);
	}
