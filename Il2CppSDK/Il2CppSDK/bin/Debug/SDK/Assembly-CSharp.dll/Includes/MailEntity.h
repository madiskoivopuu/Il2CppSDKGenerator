...
public: 
	...
	template <typename T = uintptr_t> static T& fromCyclicComponent() {
	...
	template <typename T = uintptr_t> T get_guildJoinResult() {
	...
	template <typename T = void> T AddStack(Il2CppString* newResource, int32_t newCount, void* newSignature) {
		return ((T (*)(MailEntity*, Il2CppString*, int32_t, void*))(Il2CppBase() + 0x1A4E28C))(this, newResource, newCount, newSignature);
	}
	template <typename T = void> T ReplaceStack(Il2CppString* newResource, int32_t newCount, void* newSignature) {
		return ((T (*)(MailEntity*, Il2CppString*, int32_t, void*))(Il2CppBase() + 0x1A4E3BC))(this, newResource, newCount, newSignature);
	}
	template <typename T = void> T RemoveStack() {
		return ((T (*)(MailEntity*))(Il2CppBase() + 0x1A4E4EC))(this);
	}
	template <typename T = uintptr_t> T get_supportMessage() {
	...
	template <typename T = uintptr_t> T get_tournamentPosition() {
	...
	template <typename T = uintptr_t> T get_windowData() {
