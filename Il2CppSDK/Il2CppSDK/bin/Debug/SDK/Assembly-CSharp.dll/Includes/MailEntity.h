...
public: 
	...
	template <typename R = void> R AddStack(Il2CppString* newResource, int32_t newCount, Nullable1<int64_t>* newSignature) {
		return ((R (*)(MailEntity*, Il2CppString*, int32_t, Nullable1<int64_t>*))(Il2CppBase() + 0x1A4E28C))(this, newResource, newCount, newSignature);
	}
	template <typename R = void> R ReplaceStack(Il2CppString* newResource, int32_t newCount, Nullable1<int64_t>* newSignature) {
		return ((R (*)(MailEntity*, Il2CppString*, int32_t, Nullable1<int64_t>*))(Il2CppBase() + 0x1A4E3BC))(this, newResource, newCount, newSignature);
	}
