...
public: 
	...
	template <typename T = void*> static T& _matcherAddedResources() {
	...
	template <typename T = void*> static T& _matcherApplyBuild() {
	...
	template <typename T = void*> static T& _matcherApplyMoveBuild() {
	...
	template <typename T = void*> static T& _matcherApplyRemoveBuild() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x90);
	}
	template <typename T = void*> static T& _matcherApplyResurrect() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x98);
	}
	template <typename T = void*> static T& _matcherApplyTakeBuild() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA0);
	}
	template <typename T = void*> static T& _matcherApplyTenacityRegeneration() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xA8);
	}
	template <typename T = void*> static T& _matcherApplyUpgradeBuild() {
	...
	template <typename T = void*> static T& _matcherCraftBluenprint() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xF0);
	}
	template <typename T = void*> static T& _matcherCraftResult() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0xF8);
	}
	template <typename T = void*> static T& _matcherCreationTime() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x100);
	}
	template <typename T = void*> static T& _matcherCurrencyChanged() {
	...
	template <typename T = void*> static T& _matcherDamageConfig() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x140);
	}
	template <typename T = void*> static T& _matcherDamageReflect() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x148);
	}
	template <typename T = void*> static T& _matcherDamageResult() {
	...
	template <typename T = void*> static T& _matcherHealResult() {
	...
	template <typename T = void*> static T& _matcherInventoryChanged() {
	...
	template <typename T = void*> static T& _matcherNew() {
	...
	template <typename T = void*> static T& _matcherPlace() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x268);
	}
	template <typename T = void*> static T& _matcherPlayerEnter() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x270);
	}
	template <typename T = void*> static T& _matcherPlayerGuildChanged() {
	...
	template <typename T = void*> static T& _matcherQuestsChanged() {
	...
	template <typename T = void*> static T& _matcherTargetResult() {
	...
	template <typename T = void*> static T& _matcherVipChanged() {
	...
	template <typename T = void*> static T get_AddedResources() {
	...
	template <typename T = void*> static T get_ApplyBuild() {
	...
	template <typename T = void*> static T get_ApplyMoveBuild() {
	...
	template <typename T = void*> static T get_ApplyRemoveBuild() {
	...
	template <typename T = void*> static T get_ApplyTakeBuild() {
	...
	template <typename T = void*> static T get_ApplyUpgradeBuild() {
	...
	template <typename T = void*> static T get_CraftBluenprint() {
		return ((T (*)(void *))(Il2CppBase() + 0x178A8B4))(0);
	}
	template <typename T = void*> static T get_CraftResult() {
	...
	template <typename T = void*> static T get_CurrencyChanged() {
	...
	template <typename T = void*> static T get_DamageConfig() {
	...
	template <typename T = void*> static T get_DamageResult() {
	...
	template <typename T = void*> static T get_HealResult() {
	...
	template <typename T = void*> static T get_InventoryChanged() {
	...
	template <typename T = void*> static T get_New() {
	...
	template <typename T = void*> static T get_Place() {
		return ((T (*)(void *))(Il2CppBase() + 0x178F50C))(0);
	}
	template <typename T = void*> static T get_PlayerEnter() {
		return ((T (*)(void *))(Il2CppBase() + 0x178F6AC))(0);
	}
	template <typename T = void*> static T get_PlayerGuildChanged() {
	...
	template <typename T = void*> static T get_QuestsChanged() {
	...
	template <typename T = void*> static T get_TargetResult() {
	...
	template <typename T = void*> static T get_VipChanged() {
